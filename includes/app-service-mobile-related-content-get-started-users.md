...
ms.locfileid: "66755614"
---
* [L’authentification App Service / vue d’ensemble de l’autorisation](../articles/app-service/overview-authentication-authorization.md).
* Ajout de l’authentification à votre application Mobile : [iOS][ios-get-started-users], [Android][android-get-started-users], [Windows universel] [ windows-get-started-users], [Xamarin.Android][xamarin-android-get-started-users], [Xamarin.iOS][xamarin-ios-get-started-users], [Xamarin.Forms] [ xamarin-forms-get-started-users], [Cordova][cordova-get-started-users].  
