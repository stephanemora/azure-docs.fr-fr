...
ms.locfileid: "111901897"
---
Azure RBAC fournit un nombre de rôles intégrés Azure pour autoriser l’accès au blob et aux données de file d’attente avec Azure AD et OAuth. Voici quelques exemples de rôles qui fournissent des autorisations aux ressources de données dans Stockage Azure :
