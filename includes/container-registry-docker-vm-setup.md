...
Suivez les étapes de la section [Installer Azure CLI avec apt](/cli/azure/install-azure-cli-apt) pour installer Azure CLI sur votre machine virtuelle Ubuntu. Par exemple :
