...
ms.locfileid: "85603267"
---
## <a name="create-an-azure-resource"></a>Créer une ressource Azure

Commencez à utiliser l’API Recherche d’images Bing en créant une des ressources Azure suivantes.

### <a name="bing-search-v7-resource"></a>[Ressource Recherche Bing v7](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSearch-v7)
