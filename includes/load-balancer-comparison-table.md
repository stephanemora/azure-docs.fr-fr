...
| [Règles de trafic sortant](../articles/load-balancer/load-balancer-outbound-rules-overview.md) | Configuration déclarative de règles NAT de trafic sortant, utilisant des adresses IP publiques, des préfixes d’adresse IP publics ou les deux, le délai d’inactivité du trafic sortant configurable(4-120 minutes), l’allocation de port SNAT personnalisé | Non disponible |
