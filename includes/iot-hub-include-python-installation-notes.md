...
* Le cas échéant, installez le package [azure-iot-device](https://pypi.org/project/azure-iot-device/) à l’aide de la commande `pip install azure-iot-device`
