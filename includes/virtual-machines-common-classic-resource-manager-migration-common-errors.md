...
| Le réseau virtuel {virtual-network-name} n’existe pas. |Cela peut se produire si vous avez créé le réseau virtuel dans le nouveau Portail Azure. Le nom de réseau virtuel réel suit le modèle « groupe * \<nom du réseau virtuel > » |
