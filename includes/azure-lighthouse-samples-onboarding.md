...
| [rg-delegated-resource-management](https://github.com/Azure/Azure-Lighthouse-samples/tree/master/templates/delegated-resource-management/rg) | Intègre un ou plusieurs groupes de ressources d’un client à Azure Lighthouse. Utilisez **rgDelegatedResourceManagement** pour un groupe de ressources, ou **multipleRgDelegatedResourceManagement** pour intégrer plusieurs groupes de ressources dans le même abonnement. |
