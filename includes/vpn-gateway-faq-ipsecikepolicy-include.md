...
> [!IMPORTANT]
> *  DHGroup2048 et PFS2048 sont identiques en tant que groupe Diffie-Hellman **14** dans IKE et IPsec PFS. Voir [Groupes Diffie-Hellman](#DH) pour accéder aux mappages complets.
> * Pour les algorithmes GCMAES, vous devez spécifier le même algorithme GCMAES et la longueur de clé pour le chiffrement IPsec et l’intégrité IPsec.
> * La durée de vie de l’AS en mode principal IKEv2 est fixée à 28 800 secondes pour les passerelles VPN Azure.
> * Les durées de vie de l’AS en mode rapide sont des paramètres facultatifs. Si rien n’a été spécifié, les valeurs par défaut de 27 000 secondes (7,5 heures) et de 102 400 000 kilo-octets (102 Go) sont utilisées.
> * UsePolicyBasedTrafficSelector est un paramètre d’option sur la connexion. Consultez le point suivant de la FAQ pour « UsePolicyBasedTrafficSelectors ».
