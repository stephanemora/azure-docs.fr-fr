...
- **Client natif** : une interaction de l’utilisateur lors de l’authentification se produit lorsque le code s’exécute sur un appareil côté utilisateur. L’appareil peut être une application mobile qui s’exécute dans un système d’exploitation natif, comme Android et iOS.
