...
### <a name="list-all-management-group-ancestors-for-a-specified-management-group"></a>Lister tous les ancêtres du groupe d’administration spécifié

Fournit les détails de la hiérarchie du groupe d’administration spécifié dans l’[étendue de la requête](../../../../articles/governance/resource-graph/concepts/query-language.md#query-scope). Dans cet exemple, le groupe d’administration s’appelle **Application**.
...
### <a name="list-all-management-group-ancestors-for-a-specified-subscription"></a>Lister tous les ancêtres du groupe d’administration dans l’abonnement spécifié

Fournit les détails de la hiérarchie de groupe d’administration de l’abonnement spécifié dans l’[étendue de la requête](../../../../articles/governance/resource-graph/concepts/query-language.md#query-scope). Dans cet exemple, le GUID de l’abonnement est **11111111-1111-1111-1111-111111111111**.
...
### <a name="list-all-subscriptions-under-a-specified-management-group"></a>Lister tous les abonnements sous un groupe d’administration spécifié

Fournit le nom et l’ID d’abonnement de tous les abonnements sous le groupe d’administration spécifié dans l’[étendue de la requête](../../../../articles/governance/resource-graph/concepts/query-language.md#query-scope). Dans cet exemple, le groupe d’administration s’appelle **Application**.
...
- Portail Azure : <a href="https://portal.azure.com/?feature.customportal=false#blade/HubsExtension/ArgQueryBlade/query/ResourceContainers%0a%7c%20where%20type%20%3d%7e%20%27microsoft.resources%2fsubscriptions%27%0a%7c%20project%20subscriptionId%2c%20name" target="_blank">portal.azure.com</a>
- Portail Azure Government : <a href="https://portal.azure.us/?feature.customportal=false#blade/HubsExtension/ArgQueryBlade/query/ResourceContainers%0a%7c%20where%20type%20%3d%7e%20%27microsoft.resources%2fsubscriptions%27%0a%7c%20project%20subscriptionId%2c%20name" target="_blank">portal.azure.us</a>
- Portail Azure China 21Vianet : <a href="https://portal.azure.cn/?feature.customportal=false#blade/HubsExtension/ArgQueryBlade/query/ResourceContainers%0a%7c%20where%20type%20%3d%7e%20%27microsoft.resources%2fsubscriptions%27%0a%7c%20project%20subscriptionId%2c%20name" target="_blank">portal.azure.cn</a>

---

### <a name="secure-score-per-management-group"></a>Degré de sécurisation par groupe d’administration

Retourne le degré de sécurisation par groupe d’administration.
