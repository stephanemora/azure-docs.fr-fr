...
4. **Téléchargez le programme d’installation de l’agent Azure File Sync le plus récent à partir du [Centre de téléchargement Microsoft](https://go.microsoft.com/fwlink/?linkid=858257). Le téléchargement du programme d’installation est un package Microsoft Installer ou un fichier exécutable .msi.**  
