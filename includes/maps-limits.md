...
Le tableau suivant présente la limite de taille relative aux données pour Azure Maps. Le service de données Azure Maps est uniquement disponible au niveau tarifaire S1.
