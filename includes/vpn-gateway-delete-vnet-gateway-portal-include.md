...
---
### <a name="step-1-navigate-to-the-virtual-network-gateway"></a>Étape 1 : Accéder à la passerelle de réseau virtuel
...
### <a name="step-2-delete-connections"></a>Étape 2 : Supprimer les connexions
