...
2. Dans **Choisir une cible de publication**, utilisez les options de publication spécifiées dans le tableau suivant : 
    ...
    | Option      | Description                                |
    | ------------ |  -------------------------------------------------- |
    | **Application Azure Function** | Créer une application de fonction dans un environnement cloud Azure. | 
...
4. Dans **Azure App Service : Créer**, utilisez les valeurs spécifiées dans le tableau suivant :
