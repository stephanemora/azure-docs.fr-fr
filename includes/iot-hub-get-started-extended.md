...
|----------------------------------------------------------- |------------------------------------|
| [Gérer les messages IoT Hub](../articles/iot-hub/iot-hub-vscode-iot-toolkit-cloud-device-messaging.md)                  | Extension du kit de ressources Azure IoT Hub pour VS Code|
...
| [Gérer votre appareil IoT](../articles/iot-hub/iot-hub-device-management-iot-toolkit.md)                | Extension du kit de ressources Azure IoT Hub pour VS Code|
