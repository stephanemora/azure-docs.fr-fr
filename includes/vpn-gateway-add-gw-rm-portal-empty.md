...
1. Dans la page **Passerelle de réseau virtuel**, sélectionnez **+ Ajouter**. La page **Créer une passerelle de réseau virtuel** s’ouvre.
   ...
   :::image type="content" source="./media/vpn-gateway-add-gw-rm-portal-empty/add.png" alt-text="Page Passerelles de réseau virtuel":::
1. Dans l’onglet **Informations de base**, renseignez les valeurs de la passerelle de réseau virtuel.

   :::image type="content" source="./media/vpn-gateway-add-gw-rm-portal-empty/gateway.png" alt-text="Champs concernant la passerelle":::

   :::image type="content" source="./media/vpn-gateway-add-gw-rm-portal-empty/gateway-vnet.png" alt-text="Champs supplémentaires concernant la passerelle":::
