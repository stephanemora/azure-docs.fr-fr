...
ms.locfileid: "93124836"
---
Pour authentifier toutes les ressources utilisées dans cet article, vous devez configurer une **inscription d’application** [Azure Active Directory (Azure AD)](../articles/active-directory/fundamentals/active-directory-whatis.md). Suivez les instructions fournies dans [*Procédure : Créez une inscription d’application*](../articles/digital-twins/how-to-create-app-registration.md) pour configurer cela. 
