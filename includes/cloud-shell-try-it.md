...
| Sélectionnez le bouton **Cloud Shell** du menu situé en haut à droite du [portail Azure](https://portal.azure.com). |    ![Cloud Shell dans le portail](./media/cloud-shell-try-it/cloud-shell-menu.png) |
|  |  |
