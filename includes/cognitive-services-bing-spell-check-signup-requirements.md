...
* [Créez une ressource d’essai](https://azure.microsoft.com/try/cognitive-services/?api=spellcheck-api-v7) :
...
* [Créez une ressource Vérification orthographique Bing](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSpellCheck-v7) :
    ...
    * L’API Vérification orthographique Bing est aussi proposée à certains niveaux de la [ressource Recherche Bing v7](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSearch-v7).
