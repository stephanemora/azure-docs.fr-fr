...
| --- | --- | --- |
| Nombre maximal d’unités de diffusion en continu par abonnement par région |200 |Pour demander une augmentation du nombre d’unités de diffusion en continu au-delà de 200 dans le cadre de votre abonnement, contactez le [Support technique Microsoft](https://support.microsoft.com/en-us). |
...
| Objet blob de données de référence Mo | 300 | Un objet blob de données de référence ne peut pas avoir une taille supérieure à 300 Mo. |
