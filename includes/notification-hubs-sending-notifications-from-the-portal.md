...
* ASP.NET : [Utilisation de Notification Hubs pour envoyer des notifications Push aux utilisateurs](../articles/notification-hubs/notification-hubs-aspnet-backend-ios-apple-apns-notification.md).
* Kit SDK Java pour Azure Notification Hubs : consultez [Utilisation de Notification Hubs à partir de Java](../articles/notification-hubs/notification-hubs-java-push-notification-tutorial.md) pour envoyer des notifications depuis Java. Il a été testé dans Eclipse pour le développement Android.
