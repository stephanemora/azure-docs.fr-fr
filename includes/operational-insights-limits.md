...
| Nombre d’espaces de travail payants par abonnement | S.O. | Vous êtes limité par le nombre de ressources au sein d’un groupe de ressources et le nombre de groupes de ressources par abonnement. | 
