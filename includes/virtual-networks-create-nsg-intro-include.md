...
Pour plus d’informations sur les groupes de sécurité réseau, consultez la page [Présentation d’un groupe de sécurité réseau](../articles/virtual-network/security-overview.md).
