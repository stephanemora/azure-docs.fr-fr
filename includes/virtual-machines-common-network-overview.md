...
| [Azure CLI](../articles/virtual-machines/linux/create-cli-complete.md) | Créez et connectez une machine virtuelle à un réseau virtuel, un sous-réseau et une carte réseau selon différentes étapes. |
