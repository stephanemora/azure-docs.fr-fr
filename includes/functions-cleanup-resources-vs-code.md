...
1. Sous l’onglet **Vue d’ensemble**, sélectionnez le lien nommé sous **Groupe de ressources**.
    ...
    ![Sélectionnez le groupe de ressources à supprimer dans la page d’application de fonction.](./media/functions-cleanup-resources-vs-code/functions-app-delete-resource-group.png)
