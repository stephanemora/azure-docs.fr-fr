...
3. Dans la page **Créer un compte Azure Cosmos DB**, entrez les paramètres du nouveau compte Azure Cosmos DB. 
   ...
   | Version | Choisir la version de serveur requise | L’API Azure Cosmos DB pour MongoDB est compatible avec les versions serveur 4.0, 3.6 et 3.2. Vous pouvez [mettre à niveau ou rétrograder](../articles/cosmos-db/mongodb-version-upgrade.md) un compte après sa création. |
