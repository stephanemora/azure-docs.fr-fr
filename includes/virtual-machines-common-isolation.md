...
| 14 février 2020  | Dernier jour pour acheter l’instance réservée 1 an D/DS15i_v2 | 
| 15 février 2020   | Garantie d’isolation D/DS15_v2 retirée | 
...
**R** : Si vous êtes un client D/DS15_v2 actif et que vous souhaitez utiliser les nouvelles tailles D/DS15i_v2, remplissez ce [formulaire](https://forms.office.com/Pages/ResponsePage.aspx?id=v4j5cvGGr0GRqy180BHbR0FTPNXHdWpJlO27GE-bHitUNU1XUkhZWkNXQUFMNEJWUk9VWkRRVUJPMy4u)
...
**R** : Si vous n’avez pas besoin d’isolation, vous n’avez aucune action à effectuer et vous ne verrez aucun temps d’arrêt.
