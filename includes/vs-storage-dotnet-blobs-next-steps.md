...
* Pour plus d’informations sur les API disponibles, consultez la documentation de référence du service BLOB dans la [Bibliothèque cliente Azure Storage pour .NET](/dotnet/api/overview/azure/storage) .
