...
|----------------------|----------------|---------------|
|Développement local - Bibliothèque de classes C#       | [Installer le package](../articles/azure-functions/functions-triggers-bindings.md#c-class-library-with-visual-studio-2017). |
|Développement local - Script C#, JavaScript, F# |[Enregistrer l’extension](../articles/azure-functions/functions-triggers-bindings.md#local-development-azure-functions-core-tools)         |
