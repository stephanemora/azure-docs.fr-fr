...
Pour définir une balise sur une valeur datetime, utilisez la [fonction utcNow](../articles/azure-resource-manager/resource-group-template-functions-string.md#utcnow).
