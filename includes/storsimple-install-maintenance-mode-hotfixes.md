...
6. Une fois les correctifs logiciels appliqués, quittez le mode Maintenance. Pour obtenir des instructions, consultez l'[Étape 4 : Quitter le mode Maintenance](../articles/storsimple/storsimple-update-device.md#step4) pour obtenir des instructions.
