...
4. Si vous n'avez pas téléchargé le fichier **google-services.json** dans le dossier **app** de votre projet Android Studio, vous pouvez le faire sur cette page. 
