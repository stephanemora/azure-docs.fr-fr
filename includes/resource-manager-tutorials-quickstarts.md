...
- Démarrages rapides
    ...
    |------|-----|
    |[Utilisation du portail Azure](../articles/azure-resource-manager/resource-manager-quickstart-create-templates-use-the-portal.md)|Générez un modèle à l’aide du portail et comprenez le processus de modification et de déploiement du modèle.|
...
- Tutoriels
    ...
    |[Didacticiel : Résoudre les problèmes liés aux déploiements de modèles Resource Manager](../articles/azure-resource-manager/resource-manager-tutorial-troubleshoot.md)|Résoudre les problèmes de déploiement de modèles.|
