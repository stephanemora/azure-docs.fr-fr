...
| Source | Nom de l’instance Azure Digital Twins. | `source = '<host-name>'`| Les valeurs de nom d’hôte possibles sont les suivantes : <br> **Pour les notifications** : `<yourDigitalTwinInstance>.api.<yourRegion>.digitaltwins.azure.net` <br> **Pour la télémétrie** : `<yourDigitalTwinInstance>.api.<yourRegion>.digitaltwins.azure.net/<twinId>`|
