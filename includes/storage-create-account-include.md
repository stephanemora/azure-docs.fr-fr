...
Vous pouvez également créer un compte de stockage Azure à l’aide d’[Azure PowerShell](/powershell/module/az.storage/), de l’[interface de ligne de commande Azure](../articles/storage/blobs/storage-quickstart-blobs-cli.md) ou du [fournisseur de ressources de stockage Azure pour .NET](https://azure.microsoft.com/resources/samples/storage-dotnet-resource-provider-getting-started/).
