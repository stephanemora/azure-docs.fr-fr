...
Cela différencie les tâches de réplication des tâches d’agrégation (généralement associées à un état). Celles-ci relèvent du domaine des infrastructures et services d’analyse tels qu’[Azure Stream Analytics](/azure/stream-analytics/stream-analytics-introduction).
...
Dans Azure Functions, une tâche de réplication est implémentée à l’aide d’un [déclencheur](/azure/azure-functions/functions-triggers-bindings) qui acquiert un ou plusieurs messages d’entrée à partir d’une source configurée, et d’une [liaison de sortie](/azure/azure-functions/functions-triggers-bindings#binding-direction) qui transfère les messages copiés de la source vers une cible configurée. 

| Déclencheur  | Output |
|----------|--------|
| [Déclencheur Azure Event Hubs](https://docs.microsoft.com/azure/azure-functions/functions-bindings-event-hubs-trigger?tabs=csharp) | [Liaison de sortie Azure Event Hubs](https://docs.microsoft.com/azure/azure-functions/functions-bindings-event-hubs-output?tabs=csharp) |
| [Déclencheur Azure Service Bus](https://docs.microsoft.com/azure/azure-functions/functions-bindings-service-bus-trigger?tabs=csharp) | [Liaison de sortie Azure Service Bus](https://docs.microsoft.com/azure/azure-functions/functions-bindings-service-bus-output?tabs=csharp)
| [Déclencheur Azure IoT Hub](https://docs.microsoft.com/azure/azure-functions/functions-bindings-event-iot-trigger?tabs=csharp) | [Liaison de sortie Azure IoT Hub](https://docs.microsoft.com/azure/azure-functions/functions-bindings-event-iot-output?tabs=csharp)
| [Déclencheur Azure Event Grid](https://docs.microsoft.com/azure/azure-functions/functions-bindings-event-grid-trigger?tabs=csharp) | [Liaison de sortie Azure Event Grid](https://docs.microsoft.com/azure/azure-functions/functions-bindings-event-grid-output?tabs=csharp)
| [Déclencheur Stockage File d’attente Azure](https://docs.microsoft.com/azure/azure-functions/functions-bindings-storage-queue-trigger?tabs=csharp) | [Liaison de sortie Stockage File d’attente Azure](https://docs.microsoft.com/azure/azure-functions/functions-bindings-storage-queue-output?tabs=csharp)
...
| | [Liaison de sortie Azure Notification Hubs](https://docs.microsoft.com/azure/azure-functions/functions-bindings-notification-hubs)
||[Liaison de sortie Azure SignalR Service](https://docs.microsoft.com/azure/azure-functions/functions-bindings-signalr-service-output?tabs=csharp)
||[Liaison de sortie Twilio SendGrid](https://docs.microsoft.com/azure/azure-functions/functions-bindings-sendgrid?tabs=csharp)
...
Pour plus d’informations sur la surveillance de votre application de réplication, reportez-vous à la section [Surveillance](https://docs.microsoft.com/azure/azure-functions/configure-monitoring) de la documentation d’Azure Functions.

Un outil visuel particulièrement utile pour la surveillance des tâches de réplication est la [cartographie d’application](https://docs.microsoft.com/azure/azure-monitor/app/app-map) d’Application Insights. Celle-ci est générée automatiquement à partir des informations de surveillance capturées et permet d’explorer la fiabilité et les performances des transferts source et cible de la tâche de réplication.

Pour consulter des informations de diagnostic immédiates, vous pouvez utiliser l’outil de portail [Métriques temps réel](https://docs.microsoft.com/azure/azure-monitor/app/live-stream). Celui-ci fournit une visualisation à faible latence des détails des journaux.

## <a name="next-steps"></a>Étapes suivantes

* [Déploiements d’Azure Functions](/azure/azure-functions/functions-deployment-technologies)
* [Diagnostics d’Azure Functions](/azure/azure-functions/functions-diagnostics)
* [Options de mise en réseau d’Azure Functions](/azure/azure-functions/functions-networking-options)
