...
1. Exécutez [az extension add](/cli/azure/extension#az_extension_add) pour installer ou mettre à niveau l’extension *azure-iot* vers la version actuelle.
