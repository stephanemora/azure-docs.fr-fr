...
* **Nom d’hôte** de l’instance. Vous pouvez trouver cette valeur dans le portail Azure ([instructions](../articles/digital-twins/how-to-set-up-instance-portal.md#verify-success-and-collect-important-values)).
