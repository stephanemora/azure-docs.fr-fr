...
* Pour plus d’informations sur les API disponibles, consultez la documentation de référence sur le service de File d’attente dans la [bibliothèque cliente Azure Storage pour .NET](https://go.microsoft.com/fwlink/?LinkID=390731) .
