---
title: Pour installer et déployer Linux C# agent de ASC pour IoT Preview | Microsoft Docs
description: Découvrez comment installer l’ASC pour l’agent IoT sur Linux 32 bits et 64 bits.
services: ascforiot
...
---
# <a name="deploy-asc-for-iot-c-based-security-agent-for-linux"></a>Déployer ASC pour IoT C#-en fonction de l’agent de sécurité pour Linux
...
Ce guide explique comment installer et déployer l’ASC pour IoT C#-en fonction de la sécurité de l’agent sur Linux.
