---
title: Prise en main du service d'intégration IoT Hub intégré à Azure Security Center pour IoT | Microsoft Docs
description: Prise en main du flux de travail intégré du service Azure Security Center pour IoT.
...
ms.locfileid: "68600300"
---
# <a name="get-started-with-built-in-iot-hub-integration"></a>Prise en main de l’intégration IoT Hub intégrée 

Cette option permet d’utiliser le service sans recourir aux agents de sécurité Azure Security Center pour IoT.
...
Félicitations ! Vous avez activé le service Azure Security Center pour IoT sur votre IoT Hub. 
