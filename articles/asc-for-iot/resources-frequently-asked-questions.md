---
title: Questions fréquentes sur Azure Security Center pour IoT | Microsoft Docs
...
2. Créez votre propre agent et implémentez le schéma de message de sécurité Microsoft Azure Security Center pour IoT. Cette option permet l’utilisation des outils d’analyse de Microsoft Azure Security Center pour IoT en plus de l’agent de sécurité de votre appareil.
...
Vous trouverez des informations détaillées sur l’installation et le déploiement de l’agent sur GitHub : https://github.com/Azure/Azure-Security-IoT.
...
3. Vérifiez que l’appareil est [configuré dans IoT Hub avec le module Azure Security Center pour IoT](quickstart-create-security-twin.md).  
