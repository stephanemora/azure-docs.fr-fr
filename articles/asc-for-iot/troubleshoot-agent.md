...
1. La commande de récupération des erreurs de l’agent de sécurité récupère tous les journaux créés par l’agent Azure Security Center pour IoT. Utilisez le tableau suivant pour comprendre les erreurs et prendre les mesures appropriées pour la correction.
...
1. Si nécessaire, répétez les processus précédents pour forcer l’arrêt de l’agent et récupérer les erreurs si l’agent continue à faire échouer le processus de démarrage.
