---
title: Configurer Sentinel (préversion)
...
> Cette fonctionnalité est fournie sans contrat de niveau de service et est déconseillée pour les charges de travail de production. Certaines fonctionnalités peuvent être limitées ou non prises en charge.
...
1. Cliquez sur **Se connecter** à côté de chaque abonnement IoT Hub dont vous souhaitez diffuser les alertes et les alertes d’appareil dans Azure Sentinel.
    - Si Azure Security Center pour IoT n'est pas activé sur ce hub, un message d'avertissement contenant un lien Activer s'affiche. Cliquez sur le lien **Activer** pour démarrer et activer le service.
...
1. Filtrez les résultats pour afficher uniquement les alertes générées par Azure Security Center pour IoT à l’aide du filtre kql suivant :
