...
Vous pouvez aussi utiliser Azure CLI pour déployer des ressources à l’aide de modèles Resource Manager. Pour plus d’informations, consultez [Déployer des ressources à l’aide de modèles Resource Manager et d’Azure CLI](../azure-resource-manager/resource-group-template-deploy-cli.md).
...
- Les modèles Resource Manager ne peuvent pas faire référence à la plupart des ressources existantes. Ils peuvent uniquement créer des ressources. Si vous disposez de modèles Resource Manager que vous utilisez en dehors de DevTest Labs et qui font référence à des ressources existantes, vous ne pouvez pas les utiliser dans DevTest Labs. La seule exception est que vous pouvez faire référence à un réseau virtuel existant. 
