...
Le script suivant s’applique à l’artefact spécifié à la machine virtuelle spécifiée. Le [Invoke-AzureRmResourceAction](/powershell/module/azurerm.resources/invoke-azurermresourceaction?view=azurermps-6.13.0) commande est celui qui effectue l’opération.  
