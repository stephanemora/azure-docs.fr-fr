...
description: Découvrez comment créer une fabrique d’images personnalisées à l’aide d’exemples de scripts disponibles dans le référentiel Git.
