...
Une fois votre serveur de licences configuré, vous devez [appairer le réseau virtuel](./how-to-connect-peer-virtual-network.md) avec votre [compte Lab](./tutorial-setup-lab-account.md). Le peering du réseau doit être effectué _avant* de créer le labo pour permettre aux machines virtuelles du labo d’accéder au serveur de licences et inversement.
...
De même, lisez l’article expliquant [comment configurer un serveur de licences en tant que ressource partagée](./how-to-create-a-lab-with-shared-resource.md) pour plus d’informations.
...
1. Dans votre environnement physique, créez l’image pour le cours.
    ...
    c.  [Installez et configurez Windows Update](./how-to-prepare-windows-template.md#install-and-configure-updates).

1.  Chargez l’image personnalisée sur l’instance [Shared Image Gallery qui est rattachée à votre compte Lab](./how-to-attach-detach-shared-image-gallery.md).
