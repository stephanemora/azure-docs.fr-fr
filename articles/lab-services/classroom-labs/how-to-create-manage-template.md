...
3. **Arrêtez** le modèle de machine virtuelle en sélectionnant **Arrêter le modèle**. 
4. Suivez les étapes de la section suivante pour **publier** le modèle de machine virtuelle mis à jour. 
...
4. Vous pouvez voir le statut du processus de publication dans la page Modèle. Attendez que l’état du modèle passe à **Publié**. 
