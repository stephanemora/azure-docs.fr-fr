...
1. Une fois le laboratoire créé, sélectionnez **Accéder à mon laboratoire**. 

    ![Accéder à mon laboratoire](../media/tutorial-setup-classroom-lab/go-to-my-lab.png)
