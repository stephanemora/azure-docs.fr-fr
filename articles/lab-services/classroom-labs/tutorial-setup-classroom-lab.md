...
4. Dans la fenêtre **New Lab** (Nouveau laboratoire), effectuez les actions suivantes : 
    ...
    2. Dans la page **Informations d’identification de machine virtuelle**, spécifiez les informations d’identification par défaut pour toutes les machines virtuelles du labo. Spécifiez le **nom** et le **mot de passe** pour l’utilisateur, puis sélectionnez **Suivant**.  
    ...
    3. Dans la page **Stratégies du labo**, entrez le nombre d’heures alloué à chaque utilisateur (le **quota pour chaque utilisateur**) en dehors des heures planifiées pour le labo, puis sélectionnez **Terminer**. 
