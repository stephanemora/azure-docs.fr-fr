...
Cet article explique comment vous (en tant que propriétaire de compte lab) pouvez spécifier les informations du support que les créateurs et les utilisateurs (étudiants) du laboratoire peuvent utiliser pour obtenir de l’aide s’ils rencontrent des problèmes techniques liés à l’utilisation du compte Lab ou du laboratoire. 
