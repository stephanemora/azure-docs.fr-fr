...
---
# <a name="compare-managed-and-custom-labs-in-azure-lab-services"></a>Comparer les laboratoires gérés et personnalisés dans Azure Lab Services
...
## <a name="custom-labs"></a>Laboratoires personnalisés
...
Voici quelques **cas d’usage des laboratoires personnalisés** : 
...
## <a name="managed-labs-vs-custom-labs"></a>Comparaison entre les laboratoires gérés et les laboratoires personnalisés
Le tableau suivant compare les deux types de laboratoires pris en charge par Azure Lab Services : 

| Caractéristiques | Laboratoires gérés | Laboratoires personnalisés |
| -------- | ----------------  | ---------- |
