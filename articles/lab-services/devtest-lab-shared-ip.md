...
- **Utilisateurs Windows :** Sélectionnez le bouton **Se connecter** sur le Portail Azure pour télécharger un fichier RDP préconfiguré et accéder à la machine virtuelle.
