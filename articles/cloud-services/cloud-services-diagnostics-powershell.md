...
* Le [schéma de configuration des diagnostics](../azure-monitor/agents/diagnostics-extension-schema-windows.md) explique les différentes options de configuration xml pour l’extension de diagnostics.
