...
ms.locfileid: "113093694"
---
# <a name="build-and-deploy-a-nodejs-application-to-an-azure-cloud-service-classic"></a>Créer et déployer une application Node.js dans Azure Cloud Services (classique)
