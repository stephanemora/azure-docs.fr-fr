...
![Capture d’écran du volet des paramètres avec l’option Règles d’alerte et l’option Ajouter une alerte mises en évidence et encadrées en rouge.](./media/cloud-services-how-to-configure-portal/cs-alerts.png)
