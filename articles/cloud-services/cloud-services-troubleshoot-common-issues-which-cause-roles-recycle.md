...
Affichez d’autres scénarios de recyclage des rôles dans la [série du blog de Kevin Williamson](https://blogs.msdn.com/b/kwill/archive/2013/08/09/windows-azure-paas-compute-diagnostics-data.aspx).
