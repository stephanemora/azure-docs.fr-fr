---
title: Utilisation des diagnostics (.NET) Azure avec Cloud Services (classique) | Microsoft Docs
...
## <a name="configuration-file-schema"></a>Schéma des fichiers de configuration
