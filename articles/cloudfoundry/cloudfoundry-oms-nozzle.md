...
Vous pouvez créer l’espace de travail Log Analytics manuellement ou à l’aide d’un modèle. Le modèle déploiera un ensemble de vues et d’alertes KPI préconfigurées pour la console Log Analytics. 
