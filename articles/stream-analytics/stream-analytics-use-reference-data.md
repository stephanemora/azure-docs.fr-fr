...
|Base de données|Base de données SQL Azure qui contient vos données de référence.|
|Nom d’utilisateur|Nom d’utilisateur associé à votre base de données SQL Azure.|
|Mot de passe|Mot de passe associé à votre base de données SQL Azure.|
