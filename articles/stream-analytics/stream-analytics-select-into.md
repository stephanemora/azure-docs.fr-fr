---
title: Déboguer les requêtes Azure Stream Analytics à l’aide de SELECT INTO
description: Cet article décrit comment échantillonner des données de requête intermédiaire dans une tâche Azure Stream Analytics à l’aide des instructions SELECT INTO dans la syntaxe de requête.
