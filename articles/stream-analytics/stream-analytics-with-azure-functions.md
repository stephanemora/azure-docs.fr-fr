...
1. Consultez la section [Créer une application de fonction](../azure-functions/functions-get-started.md) de la documentation Functions. Cette section vous explique comment créer une application de fonction et une [fonction déclenchée par HTTP dans Azure Functions](../azure-functions/functions-get-started.md) en utilisant le langage C#.  
