...
* **Cause** : Le travail Stream Analytics n'a pas l'autorisation nécessaire pour effectuer certaines actions.

## <a name="kafkainvalidconfiguration"></a>KafkaInvalidConfiguration

* **Cause** : Certaines configurations sur l'adaptateur Kafka ne sont pas valides.

## <a name="kafkainvalidtimestamptype"></a>KafkaInvalidTimestampType

* **Cause** : Le type timestamp utilisé par Kafka n’est pas valide.
