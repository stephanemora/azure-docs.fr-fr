...
* [Tutoriel : Déployer un travail Azure Stream Analytique avec CI/CD à l’aide d’Azure DevOps](stream-analytics-tools-visual-studio-cicd-vsts.md)
