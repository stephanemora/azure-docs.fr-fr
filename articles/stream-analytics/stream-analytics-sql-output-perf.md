...
* Créer un INSTEAD OF [déclencheur](/sql/t-sql/statements/create-trigger-transact-sql) à utiliser l’instruction insert simple pour chaque ligne.
