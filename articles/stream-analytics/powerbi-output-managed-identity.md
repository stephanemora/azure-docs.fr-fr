...
### <a name="use-a-service-principal-to-grant-permission-for-an-asa-jobs-managed-identity"></a>Utiliser un principal de service pour accorder l’autorisation d’identité gérée d’une tâche ASA
