...
description: Découvrez comment envoyer un e-mail avec le service e-mail SendGrid dans Azure. Code samples written in C# and use the .NET API.
services: ''
