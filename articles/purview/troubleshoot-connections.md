...
- [Plusieurs sources Azure](register-scan-azure-multiple-sources.md#authentication-for-registration)
...
- [Explorateur de données Azure](register-scan-azure-data-explorer.md#authentication-for-registration)
