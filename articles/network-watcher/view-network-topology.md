...
La topologie Network Watcher prend en charge un ensemble limité de ressources. Il existe un réseau virtuel, un sous-réseau, une interface réseau, un groupe de sécurité réseau, un équilibreur de charge, une sonde d’intégrité de l’équilibreur de charge, une adresse IP publique, une homologation de réseau virtuel, une passerelle de réseau virtuel, une connexion de passerelle VPN, une machine virtuelle et un groupe de machines virtuelles identiques.
