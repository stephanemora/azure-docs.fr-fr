...
Cette modification prendra effet à partir du **15 septembre 2018** dans la région USA Centre-Ouest. Le déploiement de la modification dans les régions de cloud public se terminera le 31 novembre 2018, après quoi seulement des journaux d’activité de la version 2 seront disponibles.
...
La version 2 des journaux d’activité présente l’état du flux. L’état du flux *B* est enregistré lorsqu’un flux est lancé. L’état du flux *C* et l’état du flux *E* sont les états qui marquent respectivement la continuation d’un flux et son arrêt. Les deux états *C* et *E* contiennent des informations sur la bande passante du trafic.
...
## <a name="can-i-control-the-version-format-i-receive"></a>Puis-je contrôler le format de version que je reçois ?
 ...
 Non. L’activation et la désactivation des journaux de flux n’affecteront pas le format de sortie des journaux d’activité. Le passage de la version 1 à la version 2 des journaux d’activité se fera région par région. Lorsqu’une région est mise à niveau de la version 1 vers la version 2, vous pouvez voir les journaux de flux NSG dans les deux formats. Une fois le déploiement terminé, seuls les journaux d’activité de la version 2 seront disponibles.
