...
L’analytique du trafic est mesurée. Les mesures sont basées sur le traitement des données de journal de flux par le service et sur le stockage des journaux améliorés résultants dans un espace de travail Log Analytics. Pour plus d’informations, consultez la [page des tarifs](https://azure.microsoft.com/en-us/pricing/details/network-watcher/). 
