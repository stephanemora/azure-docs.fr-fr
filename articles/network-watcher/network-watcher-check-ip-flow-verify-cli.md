...
Exécutez l’applet de commande `az network watcher test-ip-flow` pour tester le trafic. Dans cet exemple, la première adresse IP sur la première carte réseau est utilisée.
