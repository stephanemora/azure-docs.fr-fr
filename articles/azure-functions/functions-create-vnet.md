...
> [!NOTE]  
> Ce tutoriel crée une application de fonction sur le plan Premium. Ce plan d'hébergement est actuellement en préversion. Pour plus d’informations, consultez [Plan Premium].
