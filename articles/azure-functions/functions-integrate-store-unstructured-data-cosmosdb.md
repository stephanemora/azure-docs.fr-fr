...
1. Sélectionnez **Exécuter** et vérifiez que l’état 200 est renvoyé.
    ...
    :::image type="content" source="./media/functions-integrate-store-unstructured-data-cosmosdb/functions-test-function-output.png" alt-text="Testez la fonction." border="true":::
