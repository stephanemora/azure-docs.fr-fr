...
2. Recherchez la référence de package NuGet suivante à l’aide de *Gérer les packages NuGet* et ajoutez-la au projet Microsoft.Azure.WebJobs.Extensions.DurableTask v1.6.2
