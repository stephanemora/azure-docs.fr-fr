...
Par exemple, vous pouvez ajouter [AppSetting](https://docs.microsoft.com/azure/azure-functions/functions-how-to-use-azure-function-app-settings), avec le nom `testAppSetting` et la valeur `testAppSettingValue` :
