...
#### <a name="the-python-interpreter-mismatches-os-architecture"></a>L’interpréteur Python est mal incompatible l’architecture du système d’exploitation
