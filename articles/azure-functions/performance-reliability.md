---
title: Améliorer les performances et la fiabilité d’Azure Functions
description: Découvrez comment optimiser les performances et la fiabilité de l’exécution de vos fonctions dans Azure.
ms.topic: conceptual
ms.date: 08/25/2021
...
ms.locfileid: "128700702"
---
# <a name="improve-the-performance-and-reliability-of-azure-functions"></a>Améliorer les performances et de la fiabilité d’Azure Functions

Cet article fournit des instructions pour améliorer les performances et la fiabilité de vos applications de fonction [sans serveur](https://azure.microsoft.com/solutions/serverless/). Pour obtenir un ensemble plus général des bonnes pratiques Azure Functions, consultez [Bonnes pratiques Azure Functions](functions-best-practices.md).
