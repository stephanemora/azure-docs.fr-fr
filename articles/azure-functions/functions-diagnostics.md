...
Vous pouvez poser des questions ou envoyer vos retours sur les diagnostics Azure Functions sur [UserVoice](https://feedback.azure.com/d365community/forum/9df02822-f224-ec11-b6e6-000d3a4f0da0). Incluez `[Diag]` dans le titre de vos commentaires.
