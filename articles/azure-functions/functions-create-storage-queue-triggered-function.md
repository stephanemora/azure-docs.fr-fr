...
1. Sélectionnez **Ajouter un message**, puis tapez « Hello World ! » dans **Texte du message**. Sélectionnez **OK**.
    ...
    :::image type="content" source="./media/functions-create-storage-queue-triggered-function/functions-storage-queue-test.png" alt-text="Capture d’écran montrant le bouton Ajouter un message sélectionné et le champ texte Message mis en surbrillance." border="true":::
