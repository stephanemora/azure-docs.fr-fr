...
Cet article explique comment utiliser un déclencheur [Azure Event Hubs](../event-hubs/event-hubs-what-is-event-hubs.md) pour Azure Functions. Azure Functions prend en charge les liaisons de déclencheur et les [liaisons de sortie](functions-bindings-event-hubs-output.md) relatives à Event Hubs.
