---
title: Tutoriel de développement d’applications Java avec Azure Cosmos DB
...
1. Tout d’abord, nous allons définir l’objet TodoItem dans TodoItem.java :
    ...
    Dans ce projet, vous utilisez [Project Lombok](https://projectlombok.org/) pour générer le constructeur, les accesseurs get, les méthodes setter et un générateur. Vous pouvez également écrire ce code manuellement ou faire en sorte que l'IDE le génère.
...
5. De même que les collections et les bases de données Azure Cosmos, les documents sont référencés par des liens réflexifs. La fonction d'assistance suivante permet d'extraire les documents à l'aide d'un autre attribut (« id », par exemple) que le lien réflexif :
...
6. Dans l’écran **Dépôt Git source**, dans la zone **URI**, entrez https://github.com/Azure-Samples/documentdb-java-todo-app.git, puis cliquez sur **Suivant**.
