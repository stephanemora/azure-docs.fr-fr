...
ms.locfileid: "83659463"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-cosmos-db"></a>Définitions de stratégie intégrées d’Azure Policy pour Azure Cosmos DB

Cette page est un index des définitions de stratégie intégrées d’[Azure Policy](../governance/policy/overview.md) pour Azure Cosmos DB. Pour obtenir des éléments intégrés supplémentaires d’Azure Policy pour d’autres services, consultez [Définitions intégrées d’Azure Policy](../governance/policy/samples/built-in-policies.md).
