...
La [commande CQL COPY](http://cassandra.apache.org/doc/latest/tools/cqlsh.html#cqlsh) est utilisée pour copier des données locales vers le compte d’API Cassandra dans Azure Cosmos DB. Pour copier des données, effectuez les étapes suivantes :
