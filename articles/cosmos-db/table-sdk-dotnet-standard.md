...
---
# <a name="azure-cosmos-db-table-net-standard-api-download-and-release-notes"></a>API .NET Standard Table d’Azure Cosmos DB : Téléchargement et notes de publication
