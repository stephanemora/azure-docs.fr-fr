...
Cet article explique les différentes façons de créer un conteneur dans l’API SQL Azure Cosmos DB. Si vous utilisez une autre API, consultez les articles [API pour MongoDB](../mongodb/how-to-create-container-mongodb.md), [API Cassandra](../cassandra/how-to-create-container-cassandra.md), [API Gremlin](../graph/how-to-create-container-gremlin.md) et [API Table](../table/how-to-create-container.md) pour créer le conteneur.
