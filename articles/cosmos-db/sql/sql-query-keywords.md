...
Il existe certaines restrictions supplémentaires concernant les requêtes comportant une fonction système d’agrégation et une sous-requête avec `DISTINCT`. Les requêtes ci-dessous ne sont pas prises en charge :
