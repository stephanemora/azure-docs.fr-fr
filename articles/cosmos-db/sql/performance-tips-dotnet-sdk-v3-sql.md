...
Un problème de performances courant dans les applications utilisant le kit SDK Cosmos DB est lié aux appels bloquants qui pourraient être asynchrones. De nombreux appels bloquants synchrones conduisent à une [défaillance du pool de threads](/archive/blogs/vancem/diagnosing-net-core-threadpool-starvation-with-perfview-why-my-service-is-not-saturating-all-cores-or-seems-to-stall) et à des temps de réponse qui se dégradent.
