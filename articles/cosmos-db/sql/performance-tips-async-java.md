...
> [!IMPORTANT]  
> Le 31 août 2024, le kit de développement logiciel (SDK) Java Async Azure Cosmos DB v2.x sera supprimé. Le SDK et toutes les applications qui l’utilisent **continueront à fonctionner**. Azure Cosmos DB cessera simplement de fournir une maintenance et un support pour ce SDK.
