...
> [!TIP]
> La cohérence ne peut être que **souple** au niveau de l'instance du Kit de développement logiciel (SDK) ou de la requête. Pour passer d’une cohérence plus faible à une cohérence renforcée, mettez à jour la cohérence par défaut du compte Cosmos.
