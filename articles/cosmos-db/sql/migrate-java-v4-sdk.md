...
|-------|------|-----------|-----------|--------------|-------------|---------------------------|--------|
| Async 2.x.x  | Juin 2018    | Async(RxJava)  | `com.microsoft.azure::azure-cosmosdb` | `com.microsoft.azure.cosmosdb.rx` | [API](https://azure.github.io/azure-cosmosdb-java/2.0.0/) | [Notes de publication](sql-api-sdk-async-java.md) | 31 août 2024 |
...
| 3.x.x    | Juillet 2019    | Async(Reactor)/Sync  | `com.microsoft.azure::azure-cosmos`  | `com.azure.data.cosmos` | [API](https://azure.github.io/azure-cosmosdb-java/3.0.0/) | - | 31 août 2024 |
| 4.0   | Juin 2020   | Async(Reactor)/Sync  | `com.azure::azure-cosmos` | `com.azure.cosmos`   | [API](/java/api/overview/azure/cosmosdb) | - | - |
...
# <a name="java-sdk-2xx-async-api"></a>[API Async kit SDK Java 2.x.x](#tab/java-v2-async)
...
* Cette fonctionnalité n’est pas prise en charge dans l’API Async Java SDK v2. 
