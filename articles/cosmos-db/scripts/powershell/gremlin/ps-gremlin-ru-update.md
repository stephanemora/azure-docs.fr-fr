---
title: Script PowerShell pour mettre à jour le débit (RU/s) pour l’API Gremlin Azure Cosmos DB
...
| [Set-AzCosmosDBGremlinDatabase](https://docs.microsoft.com/powershell/module/az.cosmosdb/get-azcosmosdbgremlingraph) | Obtient un graphe d’API Gremlin. |
