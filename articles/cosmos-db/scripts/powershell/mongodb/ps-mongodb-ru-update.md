---
title: Script PowerShell pour mettre à jour le débit (RU/s) pour l’API d’Azure Cosmos DB pour MongoDB
...
|---|---|
|**Azure Cosmos DB**| |
| [Get-AzCosmosDBMongoDBCollectionThroughput](https://docs.microsoft.com/powershell/module/az.cosmosdb/get-azcosmosdbmongodbcollectionthroughput) | Obtient la valeur de débit de la collection d’API MongoDB. |
| [Update-AzCosmosDBMongoDBCollectionThroughput](https://docs.microsoft.com/powershell/module/az.cosmosdb/update-azcosmosdbmongodbcollectionthroughput) | Met à jour la valeur de débit de la collection d’API MongoDB. |
