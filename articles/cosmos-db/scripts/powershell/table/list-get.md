...
| [Get-AzCosmosDBTable](/powershell/module/az.cosmosdb/get-azcosmosdbtable) | Liste les tables d’API Table d’un compte ou obtient une table d’API Table spécifiée d’un compte. |
