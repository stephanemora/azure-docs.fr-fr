---
title: Script Azure PowerShell - Azure Cosmos DB créer la table et l’espace de clés de l’API Cassandra
description: Script Azure PowerShell - Azure Cosmos DB créer la table et l’espace de clés de l’API Cassandra
author: markjbrown
