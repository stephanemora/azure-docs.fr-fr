---
title: Script Azure PowerShell - supprimer une base de données dans un compte Azure Cosmos
description: Exemple de script Azure PowerShell - supprimer une base de données dans un compte Azure Cosmos
author: markjbrown
...
ms.locfileid: "65077724"
---
# <a name="delete-a-database-in-an-azure-cosmos-account-in-an-azure-cosmos-account-using-powershell"></a>Supprimer une base de données dans un compte Azure Cosmos dans un compte Azure Cosmos à l’aide de PowerShell
