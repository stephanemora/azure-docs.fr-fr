---
title: Script Azure PowerShell - Créer un compte d’API MongoDB Azure Cosmos DB | Microsoft Docs
description: Exemple de script Azure PowerShell - Créer un compte d’API MongoDB Azure Cosmos DB
services: cosmos-db
...
ms.locfileid: "34795684"
---
# <a name="azure-cosmos-db-create-a-mongodb-api-account-using-powershell"></a>Azure Cosmos DB : Créer un compte d’API MongoDB avec PowerShell

Cet exemple de script PowerShell crée un compte d’API MongoDB Azure Cosmos DB. 
