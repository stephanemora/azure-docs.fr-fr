...
| [az cosmosdb list-keys](https://docs.microsoft.com/cli/azure/cosmosdb#az-cosmosdb-list-keys) | Crée un serveur logique qui héberge l’instance SQL Database. |
