---
title: Script Azure PowerShell - Créer un compte d’API Azure Cosmos DB Cassandra | Microsoft Docs
description: Exemple de script Azure PowerShell - Créer un compte d’API Azure Cosmos DB Cassandra
services: cosmos-db
