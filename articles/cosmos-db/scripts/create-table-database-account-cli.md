---
title: Script Azure CLI - Créer un compte, une base de données et une table d’API Table Azure Cosmos DB
description: Exemple de script Azure CLI - Créer un compte, une base de données et une table d’API Table Azure Cosmos DB
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "54035319"
---
# <a name="azure-cosmos-db-create-a-table-api-account-using-azure-cli"></a>Azure Cosmos DB : Créer un compte d’API Table avec Azure CLI

Cet exemple de script CLI crée un compte, une base de données et une table d’API Table Azure Cosmos DB.
...
| [az cosmosdb collection create](/cli/azure/cosmosdb/collection#az-cosmosdb-collection-create) | Crée une table Azure Cosmos DB. |
