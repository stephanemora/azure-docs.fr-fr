...
| 449 | Yes | Erreur temporaire qui se produit uniquement lors des opérations d’écriture, et qui peut faire suite à une nouvelle tentative sans problème. Cela peut pointer un problème de conception où un trop grand nombre d’opérations simultanées tentent de mettre à jour le même objet dans Cosmos DB. |
...
| 503 | Oui | [Service indisponible](troubleshoot-service-unavailable-java-sdk-v4-sql.md). |
...
mvn dependency:tree
```
Pour en savoir plus, consultez le [guide d’arborescence des dépendances maven](https://maven.apache.org/plugins-archives/maven-dependency-plugin-2.10/examples/resolving-conflicts-using-the-dependency-tree.html).
