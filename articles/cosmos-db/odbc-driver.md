...
1. Ouvrez l’application **Administrateur de sources de données ODBC** sur votre ordinateur ; pour cela, tapez **Sources de données ODBC** dans la fenêtre de recherche Windows. 
...
1. Dans la fenêtre **Azure Cosmos DB ODBC Driver SDN Setup (Configuration DSN du pilote ODBC Azure Cosmos DB)**, répondez aux questions suivantes : 
