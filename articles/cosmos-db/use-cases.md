...
:::image type="content" source="./media/use-cases/apps-with-global-reach.png" alt-text="Diagramme montrant l’architecture de référence des applications web Azure Cosmos DB." border="false":::
