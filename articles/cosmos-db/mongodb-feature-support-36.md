...
> [!NOTE]
> Cet article concerne l’API Azure Cosmos DB pour MongoDB 3.6. Pour la version 4.0 de MongoDB, consultez [Fonctionnalités et syntaxe prises en charge avec MongoDB 4.0](mongodb-feature-support-40.md).
