...
> [!NOTE]
> Dans Azure Cosmos DB, les jointures sont délimitées à un seul élément. Les jointures inter-éléments et inter-conteneurs ne sont pas prises en charge. Dans les bases de données NoSQL comme Azure Cosmos DB, une bonne [modélisation des données](modeling-data.md) peut vous éviter d’avoir besoin de jointures inter-éléments et inter-conteneurs.
