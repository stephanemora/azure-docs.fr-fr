...
## <a name="create-azure-cosmos-account-keyspace-and-table"></a>Créer un compte, un espace de clés et une table Azure Cosmos <a id="create-resource"></a>
