...
>[!Note]
> Azure Cosmos DB n’héberge pas le moteur MongoDB. Il fournit une implémentation du [protocole filaire version 4.0](feature-support-40.md) et [3.6](feature-support-36.md), et la prise en charge héritée pour le [protocole filaire version 3.2](feature-support-32.md) de MongoDB. Par conséquent, certaines de ces erreurs se trouvent uniquement dans l’API Azure Cosmos DB pour MongoDB.
