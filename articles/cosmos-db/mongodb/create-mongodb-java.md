...
Vous pouvez maintenant utiliser [Robomongo](connect-using-robomongo.md) / [Studio 3T](connect-using-mongochef.md) pour interroger ces nouvelles données, pour les modifier, et pour travailler avec elles.
