...
## <a name="scaling-change-streams"></a>Mise à l’échelle des flux de modification
Lorsque vous utilisez des flux de modification à grande échelle, il est préférable de répartir uniformément la charge. Utilisez la [commande personnalisée GetChangeStreamTokens](../mongodb/custom-commands.md) pour répartir la charge sur les partitions/étendues physiques.
