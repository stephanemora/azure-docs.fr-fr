...
## <a name="step-5-create-a-collection"></a><a id="CreateColl"></a>Étape 5 : créer une collection
> [!WARNING]
...
## <a name="step-6-create-json-documents"></a><a id="CreateDoc"></a>Étape 6 : Création de documents JSON
...
## <a name="step-11-run-your-java-console-application-all-together"></a><a id="Run"></a>Étape 11 : exécuter votre application console C#
