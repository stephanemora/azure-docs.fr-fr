...
* [Kit de développement logiciel Java (JDK) 7+](/java/azure/jdk/?view=azure-java-stable)
...
## <a name="step-2-clone-the-github-project"></a><a id="GitClone"></a>Étape 2 : Cloner le projet GitHub
...
## <a name="step-5-create-a-collection"></a><a id="CreateColl"></a>Étape 5 : Création d'une collection
> [!WARNING]
...
## <a name="step-6-create-json-documents"></a><a id="CreateDoc"></a>Étape 6 : Créer des documents JSON
...
## <a name="step-8-replace-json-document"></a><a id="ReplaceDocument"></a>Étape 8 : Remplacer le document JSON
...
## <a name="step-9-delete-json-document"></a><a id="DeleteDocument"></a>Étape 9 : Supprimer le document JSON
...
## <a name="step-11-run-your-java-console-application-all-together"></a><a id="Run"></a>Étape 11 : Exécuter l’ensemble de votre application console Java
