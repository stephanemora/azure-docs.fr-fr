...
L’exception suivante est levée si le kit de développement logiciel (SDK) n’est pas en mesure de communiquer avec l’instance Cosmos DB. Celle-ci pointe normalement vers un protocole de sécurité tel qu’une règle de pare-feu bloquant les requêtes.
