---
title: Présence d’Azure Cosmos DB dans les régions
description: Cet article décrit la présence régionale d’Azure Cosmos DB et les différents environnements cloud disponibles.
author: rimman
