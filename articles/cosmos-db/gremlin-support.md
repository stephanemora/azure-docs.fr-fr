...
| `by` | Modulateur d’étapes utilisé avec `group` et `order` | [Étape by](https://tinkerpop.apache.org/docs/current/reference/#by-step) |
...
| `repeat` | Répète l’étape le nombre de fois spécifié. Permet d’effectuer des boucles | [Étape repeat](https://tinkerpop.apache.org/docs/current/reference/#repeat-step) |
