---
title: Répertorier les comptes de base de données pouvant être restaurés à l’aide de l’API REST Azure Cosmos DB
description: Répertorie tous les comptes de base de données Azure Cosmos DB restaurables et disponibles sous un abonnement.
author: kanshiG
...
ms.locfileid: "99537575"
---
# <a name="list-restorable-database-accounts-using-azure-cosmos-db-rest-api"></a>Répertorier les comptes de base de données pouvant être restaurés à l’aide de l’API REST Azure Cosmos DB
...
* [Comptes de base de données restaurables – Liste par emplacement.](restorable-database-accounts-list-by-location.md)
