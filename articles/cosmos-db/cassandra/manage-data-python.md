...
1. Utilisez le bouton :::image type="icon" source="./media/manage-data-python/copy.png"::: à droite de l’écran pour copier la valeur supérieure, c’est-à-dire le POINT DE CONTACT. 

   :::image type="content" source="./media/manage-data-python/keys.png" alt-text="Afficher et copier un nom d’utilisateur, un mot de passe et un point de contact dans le panneau de chaîne de connexion du portail Azure":::
...
1. Copiez les détails du certificat racine Baltimore CyberTrust depuis [https://baltimore-cybertrust-root.chain-demos.digicert.com/info/index.html](https://baltimore-cybertrust-root.chain-demos.digicert.com/info/index.html) dans un fichier texte. Enregistrez le fichier avec l’extension de fichier *.cer*.
...
3. Vérifiez que les résultats sont corrects à partir de la ligne de commande.
    ...
    :::image type="content" source="./media/manage-data-python/output.png" alt-text="Afficher et vérifier la sortie":::
    
4. Dans le portail Azure, ouvrez **l’Explorateur de données** pour interroger, modifier et utiliser ces nouvelles données. 

    :::image type="content" source="./media/manage-data-python/data-explorer.png" alt-text="Afficher les données dans l’Explorateur de données":::
