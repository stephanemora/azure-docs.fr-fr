...
:::image type="content" source="./media/apache-cassandra-consistency-mapping/account.png" alt-text="Mappage du niveau de compte de cohérence Cassandra" lightbox="./media/apache-cassandra-consistency-mapping/account.png" :::

:::image type="content" source="./media/apache-cassandra-consistency-mapping/dynamic.png" alt-text="Mappage dynamique de cohérence Cassandra" lightbox="./media/apache-cassandra-consistency-mapping/dynamic.png" :::
