...
1. Utilisez le bouton :::image type="icon" source="./media/manage-data-nodejs/copy.png"::: à droite de l’écran pour copier la valeur supérieure, c’est-à-dire le POINT DE CONTACT.

    :::image type="content" source="./media/manage-data-nodejs/keys.png" alt-text="Afficher et copier les valeurs de POINT DE CONTACT, NOM D’UTILISATEUR et MOT DE PASSE à partir de la page de chaîne de connexion du portail Azure":::
...
4. Vérifiez que les résultats sont corrects à partir de la ligne de commande.
    ...
    :::image type="content" source="./media/manage-data-nodejs/output.png" alt-text="Afficher et vérifier la sortie":::
...
5. Dans le portail Azure, ouvrez **l’Explorateur de données** pour interroger, modifier et utiliser ces nouvelles données. 
    ...
    :::image type="content" source="./media/manage-data-nodejs/data-explorer.png" alt-text="Afficher les données dans l’Explorateur de données"::: 
