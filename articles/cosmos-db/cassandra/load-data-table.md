...
* Cet article appartient à un tutoriel en plusieurs parties. Avant de commencer avec ce document, veillez à [créer le compte, l’espace de clés et la table de l’API Cassandra](create-account-java.md).   
...
> [Interroger des données à partir du compte de l’API Cassandra](query-data.md)
