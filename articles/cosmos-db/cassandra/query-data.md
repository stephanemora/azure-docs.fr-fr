...
* Cet article appartient à un tutoriel en plusieurs parties. Avant de commencer, veillez à effectuer les étapes précédentes pour créer un compte, un espace de clés et une table d’API Cassandra, puis pour [charger des exemples de données dans la table](load-data-table.md). 
...
> [Migrer des données vers un compte d’API Cassandra](migrate-data.md)
