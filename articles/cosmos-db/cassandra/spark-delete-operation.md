---
title: Supprimer des opérations sur l’API Cassandra Azure Cosmos DB à partir de Spark
...
### <a name="delete-rows-that-match-a-condition"></a>Supprimer des lignes qui satisfont à une condition
...
### <a name="delete-all-the-rows-in-the-table"></a>Supprimer toutes les lignes de la table
...
### <a name="delete-specific-columns"></a>Supprimer des colonnes spécifiques
