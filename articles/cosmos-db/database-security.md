...
|Serveurs corrigés|En tant que base de données managée, Azure Cosmos DB ne nécessite aucune gestion ou correction des serveurs. Tout est fait automatiquement.|
