...
description: Découvrez plus d’informations sur la géoréplication à l’échelle de la planète, le basculement et la récupération des données à l’aide de bases de données mondiales à partir d’Azure Cosmos DB, un service de base de données multimodèle distribué mondialement.
services: cosmos-db
author: SnehaGunda
manager: kfile
