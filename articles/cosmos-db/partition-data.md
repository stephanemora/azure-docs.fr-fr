...
* Découvrez comment [approvisionner le débit dans un conteneur Azure Cosmos DB](how-to-provision-container-throughput.md).
* Découvrez comment [approvisionner le débit dans une base de données Azure Cosmos DB](how-to-provision-database-throughput.md).
