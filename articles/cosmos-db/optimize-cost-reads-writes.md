...
ms.locfileid: "53263224"
---
# <a name="optimize-the-cost-required-to-read-and-write-data-from-azure-cosmos-db"></a>Optimiser les coûts de lecture et d’écriture des données à partir d’Azure Cosmos DB
