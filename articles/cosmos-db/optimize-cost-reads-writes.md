...
L’insertion d’un élément de 1 ko sans indexation coûte environ 5,5 RU. Le remplacement d’un élément coûte deux fois les frais requis pour insérer le même élément.
