...
ms.locfileid: "53081487"
---
# <a name="azure-cosmos-db-create-a-graph-database-using-python-and-the-azure-portal"></a>Azure Cosmos DB : Créer une base de données de graphe avec Python et le portail Azure
