...
Pour obtenir la liste de tous les comptes pouvant être restaurés, consultez les articles [Comptes de base de données restaurables – Liste](restorable-database-accounts-list.md) ou [Comptes de base de données restaurables – Liste par emplacement](restorable-database-accounts-list-by-location.md).
...
Pour obtenir la liste de toutes les mutations de base de données, consultez l’article [Bases de données SQL restaurables – Liste](restorable-sql-databases-list.md).
...
Pour obtenir la liste de toutes les mutations de conteneur sous la même base de données, consultez l’article [Conteneurs SQL récupérables– Liste](restorable-sql-containers-list.md).
...
Pour obtenir la liste de toutes les combinaisons de bases de données et conteneur SQL qui existent sur le compte à l’heure et à l’emplacement donnés, consultez l’article [Ressources SQL récupérables – Liste](restorable-sql-resources-list.md).
...
Pour obtenir la liste de toutes les mutations de base de données, consultez l’article [Bases de données MongoDB restaurables – Liste](restorable-mongodb-databases-list.md).
...
Pour obtenir la liste de toutes les mutations de conteneur sous la même base de données, consultez l’article [Collections MongoDB récupérables– Liste](restorable-mongodb-collections-list.md).
...
Pour obtenir la liste de toutes les combinaisons de bases de données et collections MongoDB qui existent sur le compte à l’heure et à l’emplacement donnés, consultez l’article [Ressources MongoDB récupérables – Liste](restorable-mongodb-resources-list.md).
