...
:::image type="content" source="./media/create-sql-api-xamarin-dotnet/android-todo-screen.png" alt-text="Application de liste de tâches Xamarin s’exécutant sur iOS":::
