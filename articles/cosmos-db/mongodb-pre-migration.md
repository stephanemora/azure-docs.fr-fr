...
## <a id="considerations"></a>Considérations relatives à l’utilisation de l’API Azure Cosmos DB pour MongoDB
...
## <a id="options"></a>Options de migration pour l’API Azure Cosmos DB pour MongoDB
