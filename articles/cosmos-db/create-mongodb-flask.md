...
ms.locfileid: "53792247"
---
# <a name="build-a-flask-app-using-azure-cosmos-dbs-api-for-mongodb"></a>Générer une application Flask en utilisant l’API d’Azure Cosmos DB pour MongoDB
