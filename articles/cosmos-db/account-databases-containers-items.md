...
:::image type="content" source="./media/account-databases-containers-items/cosmos-entities.png" alt-text="Hiérarchie d’un compte Azure Cosmos" border="false":::
