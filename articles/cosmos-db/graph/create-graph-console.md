...
> * [Console Gremlin](create-graph-console.md)
...
:::image type="content" source="./media/create-graph-console/gremlin-console.png" alt-text="Azure Cosmos DB à partir de la console Apache Gremlin":::
...
2. Renseignez vos configurations *host*, *port*, *username*, *password*, *connectionPool* et *serializer* telles que définies dans le tableau suivant :
   ...
   :::image type="content" source="./media/create-graph-console/gremlin-uri.png" alt-text="Afficher et copier la valeur d’URI Gremlin sur la page Vue d’ensemble du portail Azure":::

   Pour la valeur du mot de passe, copiez la **Clé principale** depuis la page **Clés** :

   :::image type="content" source="./media/create-graph-console/keys.png" alt-text="Afficher et copier votre clé principale dans le portail Azure, page Clés":::
