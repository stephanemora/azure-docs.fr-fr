...
- [Python 3.6 ou supérieur](https://www.python.org/downloads/) avec le programme d’installation de package [pip](https://pip.pypa.io/en/stable/installing/).
