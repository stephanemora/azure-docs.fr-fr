...
Si vous utilisez une autre API, consultez les articles [API SQL](../how-to-provision-container-throughput.md), [API Cassandra](../cassandra/how-to-provision-throughput-cassandra.md), [API pour MongoDB](../mongodb/how-to-provision-throughput-mongodb.md) pour approvisionner le débit.
