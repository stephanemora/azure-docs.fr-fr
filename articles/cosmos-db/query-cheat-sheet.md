...
Les **aide-mémoires pour les requêtes Azure Cosmos DB** vous permettent d’écrire rapidement des requêtes pour vos données en affichant des requêtes de base de données courantes, des opérations, des fonctions et des opérateurs sur des feuilles de référence en version PDF facile à imprimer. Les aide-mémoires présentent des informations de référence pour les API SQL, MongoDB, Table et Gremlin. 
...
![Aide-mémoires pour les requêtes Azure Cosmos DB : format A3 avec les fonctions et requêtes JavaScript et des API SQL, MongoDB, Gremlin et Table](./media/query-cheat-sheet/azure-cosmos-db-cheat-sheet-a3.png)
