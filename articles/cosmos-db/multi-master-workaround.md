---
title: Permettre les lectures et les écritures dans plusieurs régions en choisissant la clé de partitionnement appropriée | Microsoft Docs
description: Découvrez comment concevoir des architectures d’application avec les lectures et écritures locales dans plusieurs régions géographiques avec Azure Cosmos DB en choisissant une clé de partitionnement.
services: cosmos-db
author: SnehaGunda
manager: kfile
...
ms.locfileid: "34850359"
---
# <a name="perform-multi-region-writes-and-reads-by-choosing-the-right-partitioning-key"></a>Permettre les lectures et les écritures dans plusieurs régions en choisissant la clé de partitionnement appropriée
...
![Architecture à multiples maîtres Azure Cosmos DB](./media/multi-master-workaround/multi-master.png)
