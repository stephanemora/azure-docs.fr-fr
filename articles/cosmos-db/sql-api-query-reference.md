...
Visitez le [Playground de test de requêtes](https://www.documentdb.com/sql/demo), qui vous permet d’essayer Cosmos DB et d’exécuter des requêtes SQL sur notre jeu de données.  
