...
Ces exemples utilisent un exemple de [jeu de données d’alimentation](https://github.com/AzureCosmosDB/labs/blob/master/dotnet/setup/NutritionData.json).

Voici une requête qui retourne le nombre total d’éléments dans chaque foodGroup :
