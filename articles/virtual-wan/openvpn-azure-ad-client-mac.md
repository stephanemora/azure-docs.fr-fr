...
description: 'Préversion : apprenez à configurer un client VPN macOS pour qu’il se connecte à un réseau virtuel à l’aide d’un VPN point à site et de l’authentification Azure Active Directory.'
