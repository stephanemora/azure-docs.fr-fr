---
title: Évaluer les serveurs VMware pour les migrer vers des machines virtuelles Azure dans Azure Migrate
description: Découvrez comment évaluer les serveurs VMware pour les migrer vers des machines virtuelles Azure avec Azure Migrate.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
Cet article explique comment évaluer les serveurs découverts à partir de votre environnement VMware en vue de leur migration vers des machines virtuelles Azure, en utilisant l’outil Azure Migrate : découverte et évaluation.
