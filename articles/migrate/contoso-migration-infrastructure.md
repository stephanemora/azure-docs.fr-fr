...
2. Dans **Ajouter des autorisations** > **Rôle**> **Contributeur**, ils sélectionnent le groupe AD **ContosoCobRG** dans la liste. Le groupe apparaît alors dans la liste **Membres sélectionnés**. 
