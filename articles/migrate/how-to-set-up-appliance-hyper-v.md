...
Vérifiez la dernière valeur du code de hachage en comparant le résultat de la commande ci-dessus à la valeur documentée [ici](./tutorial-discover-hyper-v.md#verify-security)
