---
title: Évaluer des instances AWS en vue de leur migration vers Azure avec Azure Migrate
description: Découvrez comment évaluer des instances AWS en vue de leur migration vers Azure avec Azure Migrate.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
Cet article explique comment évaluer des instances AWS en vue de leur migration vers Azure, avec l’outil Azure Migrate : découverte et évaluation.
...
- Vérifiez que les instances AWS n’exécutent pas Windows Server 2003 ni SUSE Linux. L’évaluation n’est pas prise en charge pour ces serveurs.
