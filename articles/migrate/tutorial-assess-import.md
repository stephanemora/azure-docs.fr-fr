...
**Total des opérations de lecture sur les disques** | Non | Opérations de lecture par seconde pour tous les disques combinés. <br/> Utilisez ce champ si vous n’êtes pas en mesure de fournir des données au niveau du disque. 
**Total des opérations d’écriture sur les disques** | Non | Opérations d’écriture par seconde pour tous les disques combinés. <br/> Utilisez ce champ si vous n’êtes pas en mesure de fournir des données au niveau du disque.
**Total du débit de lecture sur les disques** | Non | Données lues à partir de tous les disques, en Mo par seconde. <br/> Utilisez ce champ si vous n’êtes pas en mesure de fournir des données au niveau du disque. 
**Total du débit d’écriture sur les disques** | Non | Données écrites sur tous les disques, en Mo par seconde. <br/> Utilisez ce champ si vous n’êtes pas en mesure de fournir des données au niveau du disque.
...
Si vous n’êtes pas en mesure de fournir des données au niveau du disque, vous pouvez fournir des données de performances de disque par serveur à l’aide des champs suivants. Pour plus d’informations sur chaque champ, consultez [cette section](#add-server-information).
- Total des opérations de lecture sur les disques
- Total des opérations d’écriture sur les disques
- Total du débit de lecture sur les disques
- Total du débit d’écriture sur les disques
