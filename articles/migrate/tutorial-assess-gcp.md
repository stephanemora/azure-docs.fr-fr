---
title: Évaluer des instances de machine virtuelle GCP en vue de leur migration vers Azure avec Azure Migrate
description: Explique comment évaluer des instances de machines virtuelles GVP en vue de leur migration vers Azure avec Azure Migrate.
author: rashi-ms
ms.author: rajosh
ms.manager: abhemraj
ms.topic: tutorial
...
Cet article vous montre comment évaluer des instances de machines virtuelles Google Cloud Platform (GCP) en vue de leur migration vers Azure avec l’outil Azure Migrate : découverte et évaluation.
...
Déterminez si votre évaluation doit s’appuyer sur des critères de dimensionnement basés sur les données/métadonnées de configuration de serveurs collectées localement en l’état ou sur des données de performances.
