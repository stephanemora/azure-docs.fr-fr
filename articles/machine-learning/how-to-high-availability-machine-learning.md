...
* Gérez les configurations en tant que code.
    * Évitez les références codées en dur à l’espace de travail. Au lieu de cela, configurez une référence à l’instance de l’espace de travail à l’aide d’un [fichier de configuration](how-to-configure-environment.md#workspace) et utilisez [Workspace.from_config()](https://docs.microsoft.com/python/api/azureml-core/azureml.core.workspace.workspace#remarks) pour initialiser l’espace de travail. Pour automatiser le processus, utilisez la commande [az ml folder attach](https://docs.microsoft.com/cli/azure/ext/azure-cli-ml/ml/folder#ext_azure_cli_ml_az_ml_folder_attach) de l’[extension Azure CLI pour Machine Learning](reference-azure-machine-learning-cli.md).
    * Utilisez des assistants d’envoi d’exécution, tels que [ScriptRunConfig](https://docs.microsoft.com/python/api/azureml-core/azureml.core.scriptrunconfig) et [Pipeline](https://docs.microsoft.com/python/api/azureml-pipeline-core/azureml.pipeline.core.pipeline(class)).
    * Utilisez [Environments.save_to_directory()](https://docs.microsoft.com/python/api/azureml-core/azureml.core.environment(class)#save-to-directory-path--overwrite-false-) pour enregistrer vos définitions d’environnement.
    * Utilisez un Dockerfile si vous utilisez des images Docker personnalisées.
    * Utilisez la classe [Dataset](https://docs.microsoft.com/python/api/azureml-core/azureml.core.dataset(class)) pour définir la collection de [chemins d’accès](https://docs.microsoft.com/python/api/azureml-core/azureml.data.datapath) aux données utilisée par votre solution.
    * Utilisez la classe [Inferenceconfig](https://docs.microsoft.com/python/api/azureml-core/azureml.core.model.inferenceconfig) pour déployer des modèles en tant que points de terminaison d’inférence.
