...
* Suivez les étapes pour créer un espace de travail [Azure Machine Learning](./how-to-manage-workspace.md) et [créer votre premier pipeline](./how-to-create-machine-learning-pipelines.md)
...
Ajoutez un PythonScriptStep à votre pipeline Azure ML. Configurez votre [RunConfiguration](/python/api/azureml-core/azureml.core.runconfiguration) avec la dépendance définie sur opencensus-ext-azure. Configurez la variable d’environnement `APPLICATIONINSIGHTS_CONNECTION_STRING`.
