...
La valeur du paramètre `--name  -n`, « my_triton_model » dans l’exemple, est le nom du modèle connu pour l’espace de travail Azure Machine Learning. 
