...
- Instances Data Science Virtual Machine (Windows et Linux Ubuntu)
...
Azure Machine Learning est notre plateforme principale recommandée pour le développement de la science des données.  Cette solution PaaS (Platform as a Service) fournit un fonctionnement autonome ou une intégration avec les autres plateformes et outils mentionnés sur cette page web. [Azure Machine Learning](../overview-what-is-azure-ml.md) (AzureML) est une plateforme de bout en bout qui englobe :
...
L’instance DSVM fournie sur Windows et Linux par Microsoft contient des outils couramment utilisés dans le cadre des activités de modélisation et de développement de la science des données. 
...
Data Science Virtual Machine est fourni avec les outils de science des données les plus utiles préinstallés.  Consultez [Outils inclus dans Data Science Virtual Machine](/azure/machine-learning/data-science-virtual-machine/tools-included) pour obtenir la liste la plus récente des outils et des versions.

La machine virtuelle DSVM est disponible sur les systèmes d’exploitation **Windows** et **Linux Ubuntu**. Déterminez la taille de votre machine virtuelle DSVM (nombre de cœurs de processeur et quantité de mémoire) en fonction des exigences des projets de science des données que vous prévoyez d’exécuter sur cette instance. 
