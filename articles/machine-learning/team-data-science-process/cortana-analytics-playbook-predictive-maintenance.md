...
Les entreprises ont besoin d’un équipement critique pour fonctionner avec une efficacité et un rendement maximaux et réaliser leur retour sur les investissements en capitaux. Ces équipements peuvent être des moteurs d’avions, des turbines, des ascenseurs ou des refroidisseurs industriels, qui coûtent des millions, ou des appareils électronménagers de tous les jours, telles que les photocopieurs, les machines à café ou les refroidisseurs d’eau.
...
|:---------|---------------------------|
|_Retards et annulations de vols_ | Informations sur les itinéraires de vol sous la forme d’étapes de vol et de journaux. Les données des étapes de vol contiennent des détails tels que la date de départ/d’arrivée, l’heure, l’aéroport, les escales, etc. Les journaux incluent une série de codes d’erreur et de maintenance enregistrés par le personnel de maintenance au sol.|
...
|_Défaillances de disjoncteurs_ | Journaux de maintenance qui incluent des actions correctives, prévention et systématiques. Données opérationnelles qui incluent des commandes automatiques et manuelles envoyées à des disjoncteurs, par exemple, pour l’ouverture et la fermeture. Métadonnées du dispositif, telles que la date de fabrication, l’emplacement, le modèle, etc. Spécifications des disjoncteurs, telles que les niveaux de tension, la géolocalisation, les conditions ambiantes.|
...
- _Données temporelles_ : télémétrie opérationnelle, état de la machine, type d’ordre de travail, codes de priorité dotés d’horodatages à l’heure de l’enregistrement. L’historique des défaillances, des maintenance/réparations et de l’utilisation aura également des horodatages associés à chaque événement.
...
- _Défaillances des portes de métros_ : nombre d’événements le jour précédent, la semaine précédente, les deux semaines précédentes, etc.
- _Défaillances des disjoncteurs_ : nombre de défaillances la semaine précédente, l’année précédente, les trois années précédentes, etc.
...
- _Retards de vols_ : X peut être choisi comme représentant 1 jour pour prédire des retards dans les prochaines 24 heures. Tous les vols programmés dans les 24 heures avant les défaillances sont étiquetés 1.
...
- _Défaillances des disjoncteurs_ : l’objectif peut être de prédire la prochaine défaillance de la commande du disjoncteur. Dans ce cas, X est choisi pour être une commande ultérieure.
- _Défaillances des portes de trains_ : X peut être choisi pour représenter deux jours.
- _Défaillances des éoliennes_ : X peut être choisi pour représenter deux mois.
...
| 2 | [Échantillon de solution de maintenance prédictive Azure](https://github.com/Azure/AI-PredictiveMaintenance) | Une infrastructure de bout en bout pour illustrer plusieurs scénarios de PdM. Ce modèle présente deux scénarios : le premier est un nouveau cas d’usage de la classification de conditions de défaillance en temps réel. Le second scénario est simplement une intégration de la solution [1] dans ce modèle de solution. Il montre comment réutiliser la même infrastructure déployée pour ajouter d’autres scénarios, nouveaux ou existants.|
...
| [LearnAI@MS](http://learnanalytics.microsoft.com) | Pour les partenaires Microsoft |
| [Microsoft Partner Network](http://learningportal.microsoft.com) | Pour les partenaires Microsoft |
