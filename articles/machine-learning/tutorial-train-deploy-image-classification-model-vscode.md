...
- CLI (v2) (préversion). Pour obtenir des instructions d’installation, consultez [Installer, configurer et utiliser l’interface CLI (v2) (préversion)](how-to-configure-cli.md)
