---
title: 'Tutoriel : Entraîner et déployer un modèle à l’aide de l’extension Visual Studio Code'
...
1. Entrez ce qui suit dans la zone d’entrée pour spécifier les packages requis.
