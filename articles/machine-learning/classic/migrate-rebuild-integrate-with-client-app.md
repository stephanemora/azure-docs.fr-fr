...
Dans cet article, vous allez apprendre à intégrer des applications clientes à des points de terminaison [Azure Machine Learning](../index.yml). Pour plus d’informations sur l’écriture de code d’application, consultez [Consommer un point de terminaison Azure Machine Learning](../how-to-consume-web-service.md).
