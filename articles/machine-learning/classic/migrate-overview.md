...
ms.locfileid: "112580527"
---
# <a name="migrate-to-azure-machine-learning"></a>Migrer vers Azure Machine Learning 

Dans cet article, vous allez apprendre à migrer des ressources Machine Learning Studio (classique) vers [Azure Machine Learning](../index.yml). Pour l’instant, pour migrer les ressources, vous devez reconstruire manuellement vos expériences.
...
> * Étape 5 : Nettoyer les ressources ML Studio (classique)
