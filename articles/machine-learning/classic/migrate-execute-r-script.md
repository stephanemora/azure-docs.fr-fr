...
Dans cet article, vous allez apprendre à reconstruire un module **Exécuter un script R** de Studio (classique) dans [Azure Machine Learning](../index.yml).
...
1. [Intégrer un service web Machine Learning à des applications clientes](migrate-rebuild-integrate-with-client-app.md).
