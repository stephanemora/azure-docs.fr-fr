...
La valeur d’une entrée `PipelineData` est le chemin d’accès à la sortie précédente. Si, comme indiqué précédemment, la première étape a écrit un seul fichier, sa consommation peut ressembler à ceci : 
