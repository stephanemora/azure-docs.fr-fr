---
title: Exemples de données pour le concepteur
titleSuffix: Azure Machine Learning
description: Découvrez les exemples de jeux de données disponibles avec le concepteur Azure Machine Learning.
...
ms.locfileid: "81256975"
---
# <a name="sample-datasets-in-azure-machine-learning-designer-preview"></a>Exemples de jeux de données dans le concepteur Azure Machine Learning (préversion)
