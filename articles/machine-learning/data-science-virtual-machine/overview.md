...
description: Vue d’ensemble d’Azure Data Science Virtual Machine, machine virtuelle facile à créer et à utiliser sur la plateforme cloud Azure avec des bibliothèques et des outils préinstallés et configurés pour la science des données et le développement d’applications intelligentes.
...
Les éditions Windows de la DSVM sont préinstallées avec les pilotes GPU, les frameworks et les versions GPU des frameworks de deep learning. Sur l’édition Linux, le deep learning sur GPU est activé sur les DSVM Ubuntu. 
