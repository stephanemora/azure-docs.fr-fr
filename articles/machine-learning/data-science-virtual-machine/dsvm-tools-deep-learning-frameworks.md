...
> [!NOTE]
> Les deux images de machine virtuelle suivantes sont désormais déconseillées :
>
> * Image DSVM Windows Server 2016
> * Image DSVM Ubuntu 16.04 
>
> Ces images de machine virtuelle sont uniquement disponibles pour les clients existants qui utilisent des déploiements ARM. Ces images continueront de recevoir des correctifs de sécurité critiques jusqu’à leur date de suppression, mais elles ne seront plus désormais mises à jour avec les derniers outils de science des données.
> 
> Consultez la [page sur les images DSVM déconseillées](./reference-deprecation.md).
...
| Éditions DSVM prises en charge      | Ubuntu 16.04 (déconseillé)    |
...
| Éditions DSVM prises en charge      | Windows Server 2019<br>Ubuntu 18.04<br> Windows 2016 (déconseillé)<br> Ubuntu 16.04 (déconseillé)  |
...
| Éditions DSVM prises en charge      | Ubuntu 18.04<br> Ubuntu 16.04 (déconseillé)   |
...
| Éditions DSVM prises en charge      | Windows 2016 (déconseillé)<br> Ubuntu 16.04 (déconseillé)   |
...
| Éditions DSVM prises en charge      | Windows Server 2019<br>Ubuntu 18.04<br> Ubuntu 16.04 (déconseillé) |
