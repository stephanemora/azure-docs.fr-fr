...
Dans cet article, vous allez apprendre à reconstruire un service Web ML Studio (classique) en tant que **point de terminaison** dans Azure Machine Learning.
