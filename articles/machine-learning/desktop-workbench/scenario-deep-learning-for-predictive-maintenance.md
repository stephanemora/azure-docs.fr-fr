...
La galerie Cortana Intelligence pour le didacticiel PM est un dépôt GitHub public ([https://github.com/Azure/MachineLearningSamples-DeepLearningforPredictiveMaintenance](https://github.com/Azure/MachineLearningSamples-DeepLearningforPredictiveMaintenance)) dans lequel vous pouvez signaler des problèmes et contribuer.
...
* [Scénarios réels de maintenance prédictive](https://docs.microsoft.com/en-us/azure/machine-learning/desktop-workbench/scenario-predictive-maintenance)
