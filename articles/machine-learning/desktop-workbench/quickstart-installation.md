---
title: Démarrage rapide pour installer le service Azure Machine Learning | Microsoft Docs
...
Dans le cadre du portefeuille Microsoft Azure, le service Azure Machine Learning nécessite un abonnement Azure. Si vous n’avez pas d’abonnement Azure, créez un [compte gratuit](https://azure.microsoft.com/free/?WT.mc_id=A261C142F) avant de commencer.
...
## <a name="create-azure-machine-learning-service-accounts"></a>Créer des comptes de service Azure Machine Learning
...
L’interface de ligne de commande Azure Machine Learning est également installée. Elle vous permet d’accéder à votre service Azure Machine Learning et d’interagir avec celui-ci à l’aide des commandes `az` pour effectuer toutes les tâches nécessaires à un workflow de science des données de bout en bout. [En savoir plus.](../desktop-workbench/tutorial-iris-azure-cli.md)
