...
Créez un compte Expérimentation Machine Learning et installez l’application Azure Machine Learning Workbench. Pour plus d’informations, consultez le [guide de démarrage rapide d’installation et de création](../service/quickstart-installation.md).
