...
* Conda Python à l’intérieur d’un conteneur Docker sur une machine Linux distante, par exemple, une [machine virtuelle DSVM Ubuntu sur Azure] (https://azuremarketplace.microsoft.com/marketplace/apps/microsoft-ads.linux-data-science-vm-ubuntu)
