...
> [!NOTE]
> Les instances de calcul (préversion) sont uniquement disponibles pour les espaces de travail des régions **USA Centre Nord**, ** USA Est 2**, **Europe Nord** ou **Royaume-Uni Sud**.
