...
description: Découvrez comment utiliser le module Appliquer une transformation SQL dans Azure Machine Learning Service afin d’exécuter une requête SQLite sur des jeux de données d’entrée pour transformer les données.
