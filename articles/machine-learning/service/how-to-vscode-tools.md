...
1. Choisissez de créer un espace de travail Azure ML *nouveau*.
...
[![Exécuter une expérience localement](./media/vscode-tools-for-ai/run-experiment.gif)](./media/vscode-tools-for-ai/run-experiment.gif#lightbox)
