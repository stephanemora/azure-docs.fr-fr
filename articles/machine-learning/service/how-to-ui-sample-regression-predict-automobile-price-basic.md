...
4. Sélectionnez le bouton **Ouvrir** pour l’échantillon de pipeline 1 :

    ![Ouvrir le pipeline](media/how-to-ui-sample-regression-predict-automobile-price-basic/open-sample1.png)
