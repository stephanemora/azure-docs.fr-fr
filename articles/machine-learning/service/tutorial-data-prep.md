...
* Après avoir lancé Jupyter Notebook Dashboard, ouvrez le notebook **tutorials/regression-part1-data-prep.ipynb**.

Vous trouverez également ce tutoriel sur [GitHub](https://github.com/Azure/MachineLearningNotebooks/tree/master/tutorials) si vous souhaitez l’utiliser dans votre propre [environnement local](how-to-configure-environment.md#local).  Vérifiez que vous avez installé le package `azureml-dataprep` du SDK Azure Machine Learning.
