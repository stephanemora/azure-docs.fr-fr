...
| OperationName | Nom de l’opération associée à l’événement de journal |
...
| Publisher | Éditeur du type de cluster |
...
| Publisher | Éditeur de l’image de machine virtuelle (exemple : microsoft-dsvm) |
...
Les tableaux suivants listent les métriques de plateforme collectées pour Azure Machine Learning. Toutes sont stockées dans l’espace de noms **Espace de travail Azure Machine Learning service**.
