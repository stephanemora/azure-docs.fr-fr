...
Cet exemple utilise une machine virtuelle de notebooks Azure Machine Learning pour entraîner le modèle. Pour créer une machine virtuelle de notebooks, utilisez la commande suivante :
