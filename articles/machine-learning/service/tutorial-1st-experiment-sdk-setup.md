---
title: 'Didacticiel : Créer votre première expérience ML'
...
1. S’il n’existe aucune machine virtuelle, sélectionnez **+ Add VM** (Ajouter une machine virtuelle) pour en créer une. 
