...
Vous pouvez créer des modèles ONNX à partir de la plupart des infrastructures, notamment PyTorch, Chainer, MXNet, ML.Net, TensorFlow, Keras, SciKit-Learn, Microsoft Cognitive Toolkit et bien plus encore.
...
[![ODiagramme de flux NNX montrant la formation, les convertisseurs et déploiement](media/concept-onnx/onnx.png)](./media/concept-onnx/onnx.png#lightbox)
...
|TensorFlow|[convertisseur de tensorflow-onnx](https://github.com/onnx/tensorflow-onnx)|
...
3. Créez une image avec le modèle et les dépendances.
   ...
   > [!TIP]
   > L’exemple précédent utilise l’image par défaut fournie par le service Azure Machine Learning. Vous pouvez également utiliser une image personnalisée. Pour plus d’informations, consultez la section consacrée à la configuration et à l’inscription d’une image dans l’article [Déployer des modèles](how-to-deploy-and-where.md#configureimage).
...
+ [Référentiel GitHub de Runtime ONNX](https://github.com/Microsoft/onnxruntime)
