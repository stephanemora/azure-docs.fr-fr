---
titre : Complément Excel pour services web - titleSuffix : Description d'Azure Machine Learning Studio : Comment utiliser les services web Azure Machine Learning directement dans Excel sans écrire de code.
