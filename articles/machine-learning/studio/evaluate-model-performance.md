...
description: Cet article explique comment évaluer les performances d’un modèle dans Azure Machine Learning Studio (classique) et décrit brièvement les métriques disponibles pour cette opération.
