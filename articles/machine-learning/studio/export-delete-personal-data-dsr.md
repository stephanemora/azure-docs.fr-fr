...
Pour obtenir une documentation portant sur les services web et la tarification du plan d’engagement, consultez [Informations de référence sur l’API REST d’Azure Machine Learning](https://docs.microsoft.com/en-us/rest/api/machinelearning/). 
