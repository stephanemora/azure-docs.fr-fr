...
| **17.** |Mises à jour |Si vous voyez l’erreur code : 2359302 (hex 0 x 240006) lorsque vous tentez d’installer un correctif logiciel via l’interface utilisateur locale, cela implique que le correctif est déjà installé sur votre appareil.   | |
