...
| 2 |Réinitialisation aux paramètres d’usine |Dans certains cas, lorsque vous avez effectué une réinitialisation des paramètres, l’appareil StorSimple se bloquait et affichait le message : **Rétablir la fabrique est en cours (phase 8)**. Cela se produisait si vous appuyiez sur les touches CTRL + C lors de l’exécution de l’applet de commande. Ce bogue a été corrigé. |Update 1 |Oui |Non  |
