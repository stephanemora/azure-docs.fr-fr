...
* **Améliorations de la mise à jour** : dans Update 1.2 et versions antérieures, la gamme 8000 StorSimple a été mis à jour via deux canaux : Mise à jour de Windows pour le clustering, iSCSI et ainsi de suite et Microsoft Update pour les fichiers binaires et du microprogramme.
...
* **Mises à jour de microprogramme** : les mises à jour de microprogramme suivantes sont incluses :
  ...
  * SSD uniquement (aucune mise à jour du disque dur) : XMGG, XGEG, KZ50, F6C2, and VR08
