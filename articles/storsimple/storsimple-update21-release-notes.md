...
| 7 |Windows Management Instrumentation (WMI) |Dans les versions précédentes du logiciel, il existait plusieurs instances de l’échec du proxy web avec l’exception «\<ManagementException > Échec du chargement du fournisseur ». Ce bogue a été attribué à une fuite de mémoire WMI et est maintenant résolu. |Oui |Non  |
