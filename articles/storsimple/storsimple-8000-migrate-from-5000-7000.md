...
Téléchargez les instructions pas à pas relatives à la [migration de données d’un appareil StorSimple 5000-7000 vers un appareil 8000](https://databoxbuilds.blob.core.windows.net/storsimpledocs/MicrosoftAzureStorSimple_Migration_Guide_20171115.pdf).
