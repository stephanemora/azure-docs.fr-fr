...
3. Connectez-vous au portail Azure à l’aide de l’ID d’abonnement utilisé dans l’étape précédente.
4. Effectuez au moins une série de tests des points mentionnés ci-dessous dans le portail Azure :
...
Si vous êtes satisfait des résultats, vous pouvez passer à la phase finale de publication de l’offre, **Étape 4** :  [Déployer votre offre sur la Place de marché](marketplace-publishing-push-to-production.md). Sinon, apportez les modifications nécessaires à votre offre et effectuez de nouveau une demande de certification.
