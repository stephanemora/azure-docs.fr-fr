...
Choisissez les modules de votre solution avant de compléter votre modèle de solution sur le portail de publication. Voici des liens vers les documents qui peuvent vous aider dans le processus :

1. [Création de modèles Azure Resource Manager](../azure-resource-manager/resource-group-authoring-templates.md)
2. Modèles de démarrage rapide Microsoft Azure :
