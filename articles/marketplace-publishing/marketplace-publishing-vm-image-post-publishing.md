...
* **Références SKU** : dans le Portail de publication, accédez à **Machines virtuelles**, puis sélectionnez votre offre. Cliquez ensuite sur **Références (SKU)** > **Ajouter une référence (SKU)**.
...
Une fois qu’une offre ou une référence (SKU) figure sur la [Place de marché](https://azure.microsoft.com/marketplace), vous ne pouvez plus modifier les zones de texte suivantes :
...
4. Cliquez sur le bouton **Modifier** pour rétablir le modèle de facturation. Dans la fenêtre qui s’ouvre, cochez ou décochez la case **La facturation et la gestion des licences sont traitées à l’extérieur d’Azure (apportez votre propre licence)**.
...
* [Prise en main : Publier une offre dans la Place de marché Microsoft Azure](marketplace-publishing-getting-started.md)
