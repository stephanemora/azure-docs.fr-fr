---
title: Créer une zone privée Azure DNS à l’aide du portail Azure
description: Dans ce tutoriel, vous pourrez créer et tester une zone DNS privée et faire un enregistrement dans Azure DNS. Il s’agit d’un guide pas à pas pour la création et la gestion de votre zone et de votre enregistrement DNS à l’aide du portail Azure.
services: dns
author: vhorne
ms.service: dns
ms.topic: tutorial
...
ms.locfileid: "67147824"
---
# <a name="tutorial-create-an-azure-dns-private-zone-using-the-azure-portal"></a>Didacticiel : Créer une zone privée Azure DNS à l’aide du portail Azure

Ce didacticiel vous indique la procédure à suivre pour créer votre première zone et votre premier enregistrement DNS privé à l’aide du portail Azure.
...
Si vous préférez, vous pouvez effectuer ce tutoriel en utilisant [Azure PowerShell](private-dns-getstarted-powershell.md) ou [Azure CLI](private-dns-getstarted-cli.md).
