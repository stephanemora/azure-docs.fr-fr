---
title: Déléguer un sous-domaine d’Azure DNS à l’aide d’Azure PowerShell
description: Découvrez comment déléguer un sous-domaine d’Azure DNS à l’aide d’Azure PowerShell.
services: dns
author: vhorne
ms.service: dns
ms.topic: article
