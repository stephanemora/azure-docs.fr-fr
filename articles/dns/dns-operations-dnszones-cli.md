...
Cet article explique comment gérer les zones DNS avec l'interface Azure CLI multiplateforme. Azure CLI est disponible pour Windows, Mac et Linux. Vous pouvez également gérer vos zones DNS à l’aide [d’Azure PowerShell](dns-operations-dnszones.md) ou du portail Azure.
...
Ouvrez une fenêtre de console et procédez à l’authentification à l’aide de vos informations d’identification. Pour plus d'informations, consultez [Se connecter à Azure à partir d'Azure CLI](/cli/azure/authenticate-azure-cli).
