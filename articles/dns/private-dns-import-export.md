---
title: Importer et exporter un fichier de zone de domaine pour Azure Private DNS - Azure CLI
titleSuffix: Azure DNS
description: Découvrez comment importer et exporter un fichier de zone DNS vers Azure Private DNS à l’aide d’Azure CLI.
services: dns
author: duongau
ms.service: dns
ms.date: 03/16/2021
...
ms.locfileid: "106450692"
---
# <a name="import-and-export-a-private-dns-zone-file-for-azure-private-dns"></a>Importer et exporter un fichier de zone DNS privée pour un Azure Private DNS
...
Azure Private DNS prend en charge l’importation et l’exportation de fichiers de zone à l’aide de l’interface de ligne de commande (CLI) Azure. L’importation de fichier de zone n’est actuellement **pas** prise en charge via Azure PowerShell ou le portail Azure.
...
## <a name="import-a-dns-zone-file-into-azure-private-dns"></a>Importer un fichier de zone DNS dans Azure Private DNS
...
* Découvrez comment [gérer des jeux d’enregistrements et des enregistrements](./private-dns-getstarted-cli.md) dans votre zone DNS.
