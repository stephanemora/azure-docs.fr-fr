# [Documentation Multi-Factor Authentication](index.md)
...
## [Conseils de sécurité](../active-directory/authentication/multi-factor-authentication-security-best-practices.md)
...
## Azure MFA
### [Déployer une authentification multifacteur sur le cloud](../active-directory/authentication/howto-mfa-getstarted.md)
...
#### [Adaptateur Windows Server 2016 AD FS](https://docs.microsoft.com/windows-server/identity/ad-fs/operations/configure-ad-fs-and-azure-mfa)
...
## Serveur MFA
### [Déployer MFA en local](../active-directory/authentication/howto-mfaserver-deploy.md)
...
### [Collecte de données](../active-directory/authentication/howto-mfa-reporting-datacollection.md)

## [Guide d’utilisation MFA](../active-directory/authentication/end-user/current/multi-factor-authentication-end-user.md)
