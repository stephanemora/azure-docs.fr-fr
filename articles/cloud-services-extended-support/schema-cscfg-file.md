---
title: Schéma de définition d’Azure Cloud Services (support étendu) (fichier .cscfg) | Microsoft Docs
description: Informations relatives au schéma de définition pour les services cloud (support étendu)
ms.topic: article
...
ms.locfileid: "98743914"
---
# <a name="azure-cloud-services-extended-support-config-schema-cscfg-file"></a>Schéma de configuration d’Azure Cloud Services (support étendu) (fichier cscfg)
...
Le modèle de service est décrit par le [Schéma de définition de service cloud (support étendu)](schema-csdef-file.md).
...
Pour plus d’informations sur la configuration des rôles dans un service, consultez [Qu’est-ce que le modèle Cloud Service ?](../cloud-services/cloud-services-model-and-package.md)
...
[Schéma de définition d’Azure Cloud Services (support étendu) (fichier csdef)](schema-csdef-file.md)