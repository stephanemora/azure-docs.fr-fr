---
title: Définition d’Azure Cloud Services (support étendu) Schéma LoadBalancerProbe | Microsoft Docs
description: Informations relatives au schéma de la sonde d’intégrité de l’équilibreur de charge pour Azure Cloud Services (support étendu)
ms.topic: article
...
ms.locfileid: "98743941"
---
# <a name="azure-cloud-services-extended-support-definition-loadbalancerprobe-schema"></a>Schéma LoadBalancerProbe de définition d’Azure Cloud Services (support étendu)
