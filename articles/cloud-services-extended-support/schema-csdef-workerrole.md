---
title: Définition d’Azure Cloud Services (support étendu). d’Azure Cloud Services | Microsoft Docs
description: Informations relatives au schéma de rôle de travail pour Cloud Services (support étendu)
ms.topic: article
...
ms.locfileid: "98743925"
---
# <a name="azure-cloud-services-extended-support-definition-workerrole-schema"></a>Schéma WorkerRole de définition d’Azure Cloud Services (support étendu)
