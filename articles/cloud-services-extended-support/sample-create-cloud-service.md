...
## <a name="create-new-cloud-service-with-single-role-and-certificate-from-key-vault"></a>Créer un service cloud avec un seul rôle et un certificat issu d’un coffre de clés
