...
![Provisionner un appareil simulé](./media/iot-accelerators-remote-monitoring-manage/devicesprovision.png)
...
![Provisionner un appareil de moteur simulé](./media/iot-accelerators-remote-monitoring-manage/devicesprovisionengine.png)

Pour découvrir comment provisionner un appareil *physique*, consultez [Connecter votre appareil à l’accélérateur de solution de surveillance à distance](iot-accelerators-connecting-devices-node.md).
...
![Afficher le nouvel appareil de moteur simulé](./media/iot-accelerators-remote-monitoring-manage/devicesviewnew.png)
...
![Sélectionner un flux de données de télémétrie à afficher](./media/iot-accelerators-remote-monitoring-manage/devicesvibration.png)
...
![Méthodes de moteur](./media/iot-accelerators-remote-monitoring-manage/devicesmethods.png)

Choisissez **FillTank**, attribuez au travail le nom de **FillEngineTank**, puis choisissez **Appliquer** :

![Planifier la méthode de redémarrage](./media/iot-accelerators-remote-monitoring-manage/devicesrestartengine.png)

Pour suivre l’état du travail dans la page **Maintenance**, choisissez **Travaux** :

![Travail de surveillance des planifications](./media/iot-accelerators-remote-monitoring-manage/maintenancerestart.png)
...
![Reconfigurer un appareil](./media/iot-accelerators-remote-monitoring-manage/devicesreconfigure.png)
...
![Mettre à jour une valeur de propriété d’appareil](./media/iot-accelerators-remote-monitoring-manage/devicesreconfigurephysical.png)
...
* [Connecter votre appareil à l’accélérateur de solution de surveillance à distance](iot-accelerators-connecting-devices-node.md)
