...
1. Dans la section **Surveillance**, choisissez **Métriques**. Vérifiez qu’il y a deux **Appareils connectés** :
    ...
    ![Nombre d’appareils connectés](./media/iot-accelerators-remote-monitoring-test/connecteddevices.png)
...
1. Dans votre navigateur, accédez au **Tableau de bord** de votre solution de surveillance à distance. Dans le panneau de télémétrie sur le **Tableau de bord**, sélectionnez **temperature**. La température de tous vos appareils simulés s’affiche sur le graphique :
    ...
    ![Données de télémétrie de température](./media/iot-accelerators-remote-monitoring-test/telemetry.png)
...
![Afficher la liste des simulations disponibles](./media/iot-accelerators-remote-monitoring-test/devicesmodellist.png)

Vous pouvez afficher les données de télémétrie de l’appareil simulé :

![Afficher les données de télémétrie de l’appareil d’éclairage](./media/iot-accelerators-remote-monitoring-test/devicestelemetry.png)

Vous pouvez appeler les méthodes **SwitchOn** et **SwitchOff** sur votre appareil :

![Appeler les méthodes de l’appareil d’éclairage](./media/iot-accelerators-remote-monitoring-test/devicesmethods.png)
...
![Ajouter un refroidisseur mis à jour](./media/iot-accelerators-remote-monitoring-test/devicesupdatedchiller.png)
...
Vous savez maintenant comment personnaliser le service de simulation d’appareil. Nous vous suggérons à présent de découvrir comment [connecter un appareil physique à votre solution de surveillance à distance](iot-accelerators-connecting-devices-node.md).
