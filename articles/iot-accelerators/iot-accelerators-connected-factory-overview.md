...
> [!NOTE]
> Si vous rencontrez des problèmes lors du déploiement de l’accélérateur de solution, consultez les articles [Autorisations sur le site azureiotsuite.com][lnk-permissions] et le [FAQ sur l’usine connectée](iot-accelerators-faq-cf.md). Si les problèmes persistent, créez un ticket de service sur le [Portail][lnk-portal].
