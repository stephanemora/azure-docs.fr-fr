...
* Si vous avez choisi un locataire AAD dans une liste de locataires, redémarrez le script et choisissez un autre locataire dans la liste.
* Vous pouvez aussi déployer un locataire AAD privé dans un autre abonnement, redémarrer le script et choisir de l’utiliser.
