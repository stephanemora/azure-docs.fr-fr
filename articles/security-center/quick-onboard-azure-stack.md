...
## <a name="add-an-azure-stack-virtual-machine"></a>Ajouter une machine virtuelle Azure Stack
...
> [Didacticiel : Définir et évaluer les stratégies de sécurité](tutorial-security-policy.md)
