...
> [!NOTE]
> L’intégration avec Microsoft Defender - PACM prend en charge uniquement Windows Server 2012 R2 et Windows Server 2016.
...
- Découvrez comment [Security Center collecte des données et le Log Analytics Agent](security-center-enable-data-collection.md).
