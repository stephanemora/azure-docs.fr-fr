...
* **Protection contre les menaces pour les ressources de données Azure** : SQL Database et Azure Synapse Analytics (anciennement SQL Data Warehouse), Stockage Azure et Azure Cosmos DB
...
## <a name="threat-protection-for-sql-database-and-azure-synapse-analytics-formerly-sql-data-warehouse"></a>Protection contre les menaces pour SQL Database et Azure Synapse Analytics (anciennement SQL Data Warehouse) <a name="data-sql"></a>
...
* [Liste des alertes de protection contre les menaces pour SQL Database et Azure Synapse Analytics (anciennement SQL Data Warehouse)](alerts-reference.md#alerts-sql-db-and-warehouse)
