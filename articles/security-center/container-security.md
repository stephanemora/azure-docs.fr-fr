---
title: Sécurité des conteneurs avec Azure Security Center et Azure Defender
description: Découvrir les fonctionnalités de sécurité des conteneurs d’Azure Security Center
author: memildin
manager: rkarlin
