...
> [!NOTE]
> Microsoft Monitoring Agent est l’agent utilisé par le service Log Analytics et System Center Operations Management (SCOM).
>
>
...
## <a name="existing-log-analytics-customers"></a>Clients Log Analytics existants
