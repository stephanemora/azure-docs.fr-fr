...
| Mettre à jour la version du système d’exploitation|Recommande de mettre à jour la version du système d’exploitation de votre service Cloud vers la version la plus récente disponible pour votre famille de systèmes d’exploitation.  Pour en savoir plus sur Cloud Services, consultez Vue d’ensemble de Cloud Services. |
