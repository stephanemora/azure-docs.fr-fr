...
Les alertes sont générées en cas de détection de tentatives d’accès ou d’exploitation inhabituelles et potentiellement dangereuses des machines SQL. Ces événements peuvent déclencher des alertes affichées dans la [section Alertes pour SQL Database et SQL Data Warehouse de la page de référence des alertes](alerts-reference.md#alerts-sql-db-and-warehouse).
...
- [Alertes de sécurité pour SQL Database et SQL Data Warehouse](alerts-reference.md#alerts-sql-db-and-warehouse)
