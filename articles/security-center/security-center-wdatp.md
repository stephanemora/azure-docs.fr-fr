...
Windows Defender ATP dans Security Center prend en charge la détection sur les systèmes d’exploitation Windows Server 2016, 2012 R2 et 2008 R2 SP1 appartenant à un abonnement de service Standard.
