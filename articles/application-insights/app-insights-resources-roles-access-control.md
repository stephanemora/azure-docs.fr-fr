...
![Capture d’écran du bouton Contrôle d'accès dans le portail Azure](./media/app-insights-resources-roles-access-control/0001-access-control.png)

Sélectionnez **Ajouter une attribution de rôle**.

![Capture d’écran du menu Contrôle d’accès avec le bouton Ajouter encadré en rouge](./media/app-insights-resources-roles-access-control/0002-add.png)
...
![Capture d’écran de la liste des rôles d’utilisateur de contrôle d’accès](./media/app-insights-resources-roles-access-control/0003-user-roles.png)
