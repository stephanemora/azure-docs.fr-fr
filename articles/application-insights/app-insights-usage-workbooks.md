...
![Capture d’écran de navigation jusqu’aux classeurs](./media/app-insights-usage-workbooks/001-workbooks.png)

Une galerie de classeurs s’affiche avec plusieurs modèles de classeur prédéfinis que vous pouvez utiliser.

![Capture d’écran de la galerie de classeurs](./media/app-insights-usage-workbooks/002-workbook-gallery.png)

Nous allons commencer par le **modèle par défaut** qui se trouve sous le titre **Démarrage rapide**.

![Capture d’écran de la galerie de classeurs](./media/app-insights-usage-workbooks/003-default-template.png)
...
Chaque section a ses propres paramètres avancés, accessibles via l’icône de paramètres ![Commandes d’édition de la section Workbooks d’Application Insights](./media/app-insights-usage-workbooks/005-settings.png) située à droite du bouton **Ajouter des paramètres**.

![Commandes d’édition de la section Workbooks d’Application Insights](./media/app-insights-usage-workbooks/0006-settings-expanded.png)
...
![Commandes d’édition de la section Workbooks d’Application Insights](./media/app-insights-usage-workbooks/009-time-range.png)
