...
- Configurez le suivi des dépendances personnalisé pour [.NET](app-insights-asp-net-dependencies.md).
- Configurez le suivi des dépendances personnalisé pour [Java](app-insights-java-agent.md).
