...
L’utilisation de l’exportation continue peut entraîner des frais supplémentaires. Consultez votre [modèle de tarification](https://azure.microsoft.com/pricing/details/application-insights/).
