...
## <a name="can-power-bi-workspace-collections-be-used-to-create-internal-applications"></a>Est-il possible d’utiliser les Collections d’espaces de travail Power BI pour créer des applications internes ?
Non, les Collections d’espaces de travail Power BI sont uniquement destinées à un usage par des utilisateurs externes. Elles ne doivent pas être utilisées dans des applications métier internes. Pour incorporer et utiliser du contenu Power BI dans des applications professionnelles internes, vous devez utiliser le service Power BI, et toutes les personnes utilisant ce contenu doivent avoir une licence d’abonnement utilisateur valide à Power BI Gratuit ou à Power BI Pro. Pour plus d’informations sur l’intégration d’applications internes au service Power BI, voir [https://dev.powerbi.com](https://dev.powerbi.com).

## <a name="is-this-service-available-globally"></a>Ce service est-il disponible partout dans le monde ?
Le service Collections d’espaces de travail Power BI est désormais disponible dans la plupart des centres de données. Vous pouvez vérifier les dernières disponibilités [ici](https://azure.microsoft.com/status/).

## <a name="what-is-the-available-sla-for-the-service"></a>Quel est le contrat SLA disponible pour le service ?
Les Collections d’espaces de travail Power BI sont proposées avec le contrat SLA standard Azure. Pour plus d’informations, consultez la page [Contrats de niveau de service](https://azure.microsoft.com/support/legal/sla/) .

## <a name="what-is-a-report-session-and-how-is-it-billed"></a>Qu’est-ce qu’une session de rapport et comment est-elle facturée ?
Une session est un ensemble d’interactions entre un utilisateur final et un rapport Collections d’espaces de travail Power BI. À chaque fois qu’un rapport Collections d’espaces de travail Power BI est affiché par un utilisateur, une session est lancée et facturée au détenteur de l’abonnement. Les sessions sont facturées sur une base forfaitaire, indépendamment du nombre d’éléments visuels du rapport ou de la fréquence d’actualisation du contenu du rapport. Une session se termine lorsque l’utilisateur ferme le rapport ou lorsque la session expire après une heure.
...
## <a name="do-i-need-a-power-bi-subscription-in-order-to-develop-applications-with-power-bi-workspace-collections-how-do-i-get-started"></a>Ai-je besoin d’un abonnement Power BI pour développer des applications avec les Collections d’espaces de travail Power BI ? Comment faire pour démarrer ?
...
Consultez notre documentation sur le service Collections d’espaces de travail Power BI pour en savoir plus sur son utilisation.

## <a name="i-have-an-azure-subscription-can-i-use-power-bi-workspace-collections-using-my-existing-subscription"></a>J’ai un abonnement Azure. Puis-je utiliser les Collections d’espaces de travail Power BI dans le cadre de cet abonnement ?
...
[Nouveautés du service Collections d’espaces de travail Power BI](what-are-power-bi-workspace-collections.md)
[Bien démarrer avec le service Collections d’espaces de travail Power BI](get-started.md)
