...
* Les éditeurs de logiciels indépendants et les entreprises qui conçoivent des applications orientées client peuvent utiliser le service **Power BI Workspace Collections** et le Kit SDK Power BI pour incorporer des rapports interactifs. Pour en savoir plus, consultez [Bien démarrer avec Microsoft Power BI Workspace Collections](get-started.md).
