---
title: Configurer des règles et gérer des alertes dans Azure FarmBeats
...
ms.locfileid: "73797490"
---
# <a name="configure-rules-and-manage-alerts-in-farmbeats"></a>Configurer des règles et gérer des alertes dans FarmBeats
...
2. Sélectionnez **New Rule**. La fenêtre New Rule s’affiche.
    ...
    ![Projet FarmBeats](./media/configure-rules-and-alerts/new-rule-1.png)
...
4. Tapez le nom de votre ferme pour la sélectionner. La section **Conditions** s’affiche dans la même fenêtre.  
    ...
    ![Projet FarmBeats](./media/configure-rules-and-alerts/new-rule-condition-1.png)
...
9. Sous **Action**, activez le bouton bascule **Email enabled** pour activer les alertes par e-mail.
    ...
    ![Projet FarmBeats](./media/configure-rules-and-alerts/new-rule-email-1.png)
...
La page **Farm** présente la liste des règles disponibles. Sélectionnez le nom d’une règle sous **Rule Name**. Une fenêtre affiche les informations suivantes, applicables à la règle sélectionnée :
 ...
 - Nombre d’appareils affectés par la règle
    ...
    ![Projet FarmBeats](./media/configure-rules-and-alerts/view-rule-1.png)
...
2. Sélectionnez la règle que vous souhaitez modifier.
    ...
    ![Projet FarmBeats](./media/configure-rules-and-alerts/edit-rule-action-bar-1.png)

3. Sélectionnez **Edit** dans la barre d’action. La fenêtre **Edit Rule** s’affiche.

    ![Projet FarmBeats](./media/configure-rules-and-alerts/edit-rule-one-1.png)
...
8. Sélectionnez **+Add Condition** pour ajouter des conditions aux règles ou pour en modifier.
    ...
    ![Projet FarmBeats](./media/configure-rules-and-alerts/edit-rule-two-1.png)
...
2. Sélectionnez la règle dont vous souhaitez modifier l’état.
    ...
    ![Projet FarmBeats](./media/configure-rules-and-alerts/change-status-rule-action-bar-1.png)

3. Sélectionnez **Change Status** dans la barre d’action. La fenêtre **Change Status** s’affiche.

    ![Projet FarmBeats](./media/configure-rules-and-alerts/rule-change-status-1.png)
...
2. Sélectionnez la règle que vous souhaitez supprimer.
    ...
    ![Projet FarmBeats](./media/configure-rules-and-alerts/delete-rule-action-bar-1.png)

3. Sélectionnez **Delete** dans la barre d’action.

    ![Projet FarmBeats](./media/configure-rules-and-alerts/delete-rule-1.png)
