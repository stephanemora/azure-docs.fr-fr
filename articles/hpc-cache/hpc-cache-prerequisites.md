...
Pour en savoir plus sur l’utilisation de cibles de stockage ADLS-NFS avec Azure HPC cache, voir [Utilisation du stockage BLOB monté sur NFS avec Azure HPC Cache](nfs-blob-considerations.md).
