---
title: Ingestion de données Azure HPC Cache (préversion) - msrsync
...
ms.locfileid: "72255286"
---
# <a name="azure-hpc-cache-preview-data-ingest---msrsync-method"></a>Ingestion de données Azure HPC Cache (préversion) - msrsync
