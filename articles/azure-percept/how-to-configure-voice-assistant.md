...
1. Ouvrez le [portail Azure](https://portal.azure.com/?feature.canmodifystamps=true&Microsoft_Azure_Iothub=aduprod&microsoft_azure_marketplace_ItemHideKey=Microsoft_Azure_ADUHidden#home) et tapez **IoT Hub** dans la barre de recherche. Cliquez sur l’icône pour ouvrir la page IoT Hub.
...
1. Cliquez sur l’onglet **Paramètres du module**. Vérifiez la configuration suivante :
    ...
    |---------|--------------|--------------|
    |azureedgedevices.azurecr.io/azureearspeechclientmodule:preload-devkit |toujours|exécution en cours|
...
1. Cliquez sur l’onglet **Options de création de conteneur**. Vérifiez que vos paramètres **HostConfig** correspondent à ceux indiqués ci-dessous. S’ils ne correspondent pas, mettez à jour vos paramètres.
