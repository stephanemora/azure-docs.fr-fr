---
title: 'Tutoriel : Configurer un cluster dans Azure HDInsight à l’aide d’Ansible | Microsoft Docs'
description: Découvrez comment utiliser Ansible pour créer et redimensionner un cluster Azure HDInsight
