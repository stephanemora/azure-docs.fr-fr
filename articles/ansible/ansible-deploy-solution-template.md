...
## <a name="deploy-the-ansible-solution-template-from-the-azure-marketplace"></a>Déployer le modèle de solution Ansible à partir de la Place de marché Azure
...
1. Sous l’onglet **Paramètres d’intégration Ansible**, spécifiez le type d’authentification. Pour plus d’informations sur la sécurisation des ressources Azure, consultez [Que sont les identités managées pour les ressources Azure ?](/azure/active-directory/managed-identities-azure-resources/overview).
    ...
    ![Onglet du portail Azure pour les paramètres d’intégration Ansible](./media/ansible-deploy-solution-template/portal-ansible-setup-tab-3.png)
...
> [Créer une machine virtuelle Linux dans Azure à l’aide d’Ansible](/azure/virtual-machines/linux/ansible-create-vm)
