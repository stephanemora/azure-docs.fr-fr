...
description: Conseils de base pour l’utilisation des tables temporaires dans Azure SQL Data Warehouse et mise en évidence des principes des tables temporaires au niveau de la session.
