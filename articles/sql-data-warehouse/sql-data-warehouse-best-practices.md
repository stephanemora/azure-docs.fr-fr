...
Voir également [Chargement de données][Load data], [Guide for using PolyBase][Guide for using PolyBase], [Modèles et stratégies de chargement Azure SQL Data Warehouse][Modèles et stratégies de chargement Azure SQL Data Warehouse], [Chargement de données avec Azure Data Factory][Load Data with Azure Data Factory], [Move data with Azure Data Factory][Move data with Azure Data Factory], [CRÉATION D’UN FORMAT DE FICHIER EXTERNE][CRÉATION D’UN FORMAT DE FICHIER EXTERNE], [Create Table As Select (CTAS)][Create table as select (CTAS)]
...
Voir également [Tables temporaires][Temporary tables], [CREATE TABLE][CREATE TABLE], [CREATE TABLE AS SELECT][CREATE TABLE AS SELECT]
...
[sys.dm_pdw_dms_workers]: https://msdn.microsoft.com/library/mt203878.aspx  Adding your requests or up-voting other requests really helps us prioritize features.
...
<bpt id="p1">[</bpt>sys.dm_pdw_dms_workers<ept id="p1">]: https://msdn.microsoft.com/library/mt203878.aspx</ept>
