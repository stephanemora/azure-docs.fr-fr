---
title: Créer et interroger un entrepôt de données SQL Azure - Portail Azure | Microsoft Docs
description: Créez un Azure SQL Data Warehouse dans le portail Azure, puis interrogez-le.
