...
description: Azure SQL Data Warehouse réduit la mémoire requise ou augmente la mémoire disponible afin d’optimiser le nombre de lignes compressées par un index columnstore dans chaque rowgroup.
