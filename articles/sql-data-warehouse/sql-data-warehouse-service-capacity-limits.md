...
| Table de charge de travail |Taille maximale | Pour les tables columnstore, il n'y a pas de limite supérieure. <br/><br/>Pour les tables rowstore, 60 To compressés sur disque |
