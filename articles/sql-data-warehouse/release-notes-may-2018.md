...
### <a name="select-into-with-order-by"></a>SELECT INTO avec ORDER BY
...
### <a name="set-parseonly-on-query-status"></a>État de la requête SET PARSEONLY ON
