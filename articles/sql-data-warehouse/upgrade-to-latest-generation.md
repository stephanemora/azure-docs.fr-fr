...
1. Ouvrez votre entrepôt de données de niveau Gen1 optimisé pour le calcul dans le portail Azure, puis cliquez sur **Mettre à niveau vers Gen2** : ![Upgrade_1](./media/sql-data-warehouse-upgrade-to-latest-generation/Upgrade_to_Gen2_1.png)
