...
description: Répertorie les partenaires décisionnels tiers proposant des solutions qui prennent en charge Azure SQL Data Warehouse.
...
| ------- | ----------- | -------------------- |
| ![Birst][1] |**Birst**<br>Birst connecte toute l’organisation par le biais d’un réseau d’instances BI virtualisées imbriquées sur une structure analytique commune partagée|[Page du produit][birst_website]<br>[Azure Marketplace][birst_marketplace]<br> |
