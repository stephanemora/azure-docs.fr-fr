...
**Important : Si le pourcentage d’accès au cache ou le pourcentage de cache utilisé n’est pas mis à jour après une nouvelle exécution de votre charge de travail, votre jeu de travail peut déjà être résider dans la mémoire. Notez que seules les tables columnstore du cluster sont mises en cache.**
