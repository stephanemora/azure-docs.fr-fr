...
description: Créer des connexions à SQL Server sur site et à Azure SQL Database dans le cloud à partir d’Azure Logic Apps
services: logic-apps
documentationcenter: ''
author: ecfan
manager: cfowler
