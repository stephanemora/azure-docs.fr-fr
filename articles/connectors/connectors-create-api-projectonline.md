...
| --- | --- | --- |
| par jeton |OUI |Fournir des informations d’identification ProjectOnline |
...
Consultez l’ensemble des déclencheurs et actions définis dans le swagger, ainsi que les éventuelles limites dans les [détails des connecteurs](/connectors/projectonline/).
