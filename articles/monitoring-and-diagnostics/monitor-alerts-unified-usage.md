...
7. *Alertes de métrique* : si le signal est une métrique, une fenêtre d’alerte peut être filtrée à l’aide de plusieurs points de données ou dimensions pour cette ressource Azure. 
