---
title: Utiliser les alertes de journal d’activité dans la nouvelle expérience d’alertes Azure Monitor
description: Comment créer des alertes de journal d’activité avec l’onglet Alertes (préversion) sous Azure Monitor. Il décrit en détail la nouvelle expérience utilisateur de cette fonctionnalité.
