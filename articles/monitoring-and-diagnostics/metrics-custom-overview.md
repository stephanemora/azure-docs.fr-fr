...
- Installer l’extension Microsoft Azure Diagnostics (WAD) sur votre [machine virtuelle Azure](metrics-store-custom-guestos-resource-manager-vm.md), votre [groupe de machines virtuelles identiques](metrics-store-custom-guestos-resource-manager-vmss.md), votre [machine virtuelle classique](metrics-store-custom-guestos-classic-vm.md) ou votre [instance Cloud Services classique](metrics-store-custom-guestos-classic-cloud-service.md), et envoyer des compteurs de performances à Azure Monitor 
- Installer [l’agent InfluxData Telegraf](metrics-store-custom-linux-telegraf.md) sur votre machine virtuelle Linux Azure et envoyer les métriques à l’aide du plug-in de sortie Azure Monitor
...
Vous pouvez utiliser les métriques personnalisées à partir de différents services : 
 - [Machines virtuelles](metrics-store-custom-guestos-resource-manager-vm.md)
 - [Groupe de machines virtuelles identiques](metrics-store-custom-guestos-resource-manager-vmss.md)
 - [Machines virtuelles Azure (Classic)](metrics-store-custom-guestos-classic-vm.md)
 ...
 - [Services cloud (classiques)](metrics-store-custom-guestos-classic-cloud-service.md)
