...
* Elle affectera les types de données suivants :
  ...
  * [Métriques de ressources Azure en cours d’exportation par les paramètres de diagnostic](./monitoring-overview-of-diagnostic-logs.md#diagnostic-settings)
