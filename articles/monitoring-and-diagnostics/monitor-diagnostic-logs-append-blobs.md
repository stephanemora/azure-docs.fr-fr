...
* Elle affectera les types de données suivants :
  * [Journaux de diagnostics de ressources Azure](./monitoring-archive-diagnostic-logs.md) ([voir la liste des ressources ici](./monitoring-diagnostic-logs-schema.md))
  * [Métriques de ressources Azure en cours d’exportation par les paramètres de diagnostic](./monitoring-overview-of-diagnostic-logs.md#resource-diagnostic-settings)
  * [Données des journaux d’activité Azure en cours d’exportation par les profils de journaux](./monitoring-archive-activity-log.md)
...
![Panneau des paramètres de diagnostics Azure Monitor](./media/monitor-diagnostic-logs-append-blobs\portal-diag-settings.png)
...
![Compte de stockage actif](./media/monitor-diagnostic-logs-append-blobs\portal-storage-enabled.png)
...
* En savoir plus sur [l’archivage des journaux de diagnostic de ressources dans un compte de stockage](./monitoring-archive-diagnostic-logs.md)
* En savoir plus sur [l’archivage des données de journal d’activité dans un compte de stockage](./monitoring-archive-activity-log.md)
