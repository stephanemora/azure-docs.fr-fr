...
Suivez les [instructions](https://docs.microsoft.com/azure/machine-learning/service/setup-create-workspace#portal) pour créer un espace de travail via le portail Azure, si vous n’en avez pas. Lorsque c'est chose faite, notez le nom de votre espace de travail, le nom du groupe de ressources et l’ID d’abonnement.
