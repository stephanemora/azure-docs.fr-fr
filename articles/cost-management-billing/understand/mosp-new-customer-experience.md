...
**Aucune modification apportée aux ressources Azure** L’accès aux ressources Azure définies à l’aide d’Azure RBAC (contrôle d’accès en fonction du rôle) n’est pas affecté par la mise à jour.
