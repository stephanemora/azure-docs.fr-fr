...
1. Dans le panneau **Vue d’ensemble**, cliquez sur l’onglet *Résumé*.
    ...
    ![capture d’écran montrant l’onglet Résumé](./media/pay-bill/billing-account-overview.png)
...
1. Cliquez sur le bouton **Payer maintenant** bleu.
    ...
    ![capture d’écran illustrant le bouton Payer maintenant](./media/pay-bill/paynow-button-overview.png)
