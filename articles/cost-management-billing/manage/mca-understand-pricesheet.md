...
| Produit  | Nom du produit à l’origine des frais. Par exemple : Base de données SQL De base ou Base de données SQL Standard.  |
...
| serviceFamily  | Type de service Azure. Par exemple : Calcul, Analyse, Sécurité |
