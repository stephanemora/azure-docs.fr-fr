...
Les réservations Azure ne suivent pas automatiquement les abonnements. Vous pouvez conserver la réservation ou [annuler et racheter la réservation](https://docs.microsoft.com/azure/cost-management-billing/reservations/exchange-and-refund-azure-reservations) dans le fournisseur de solutions cloud. 
