...
ms.locfileid: "77200878"
---
# <a name="create-services-included-with-azure-free-account"></a>Créer des services inclus avec un compte gratuit Azure

Votre compte gratuit Azure inclut une quantité limitée de services gratuits pendant 12 mois. Dans ce cadre, le compte gratuit Azure apporte une certaine flexibilité en vous permettant d’utiliser différentes configurations en fonction de vos besoins.

## <a name="create-free-services-in-the-azure-portal"></a>Créer des services gratuits dans le portail Azure
Nous vous recommandons d’utiliser le lien vers la [page des services gratuits](https://go.microsoft.com/fwlink/?linkid=859151) afin de créer des services. Vous pouvez également vous connecter au [portail Azure](https://portal.azure.com) et rechercher des **services gratuits**. Lorsque vous créez des services dans la page des services gratuits, la plupart des champs sont présélectionnés pour vous permettre de créer facilement ces services.
