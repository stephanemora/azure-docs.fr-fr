...
## <a name="how-do-i-configure-my-load-balancer-with-an-azure-firewall"></a>Comment configurer mon équilibreur de charge avec un Pare-feu Azure ?
Suivez ces [instructions](https://docs.microsoft.com/azure/firewall/integrate-lb) pour configurer votre équilibreur de charge avec un Pare-feu Azure.

## <a name="what-are-best-practices-with-respect-to-outbound-connectivity"></a>Quelles sont les meilleures pratiques en matière de connectivité sortante ?
...
L’utilisation de règles de trafic sortant vous permet un contrôle précis de tous les aspects de la connectivité sortante.
 ...
 ## <a name="how-can-i-view-the-traffic-from-my-configured-health-probes"></a><a name="probes"></a> Comment puis-je afficher le trafic à partir de mes sondes d’intégrité configurées ?
