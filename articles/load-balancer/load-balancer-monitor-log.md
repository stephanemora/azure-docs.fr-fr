...
Une fois l’option **AllMetrics** activée dans les paramètres de diagnostic de Standard Load Balancer, si vous utilisez un hub d’événements ou un espace de travail Log Analytics, ces journaux sont renseignés dans la table **AzureMetrics**. 
