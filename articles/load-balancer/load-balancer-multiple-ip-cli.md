...
1. [Installez et configurez l’interface Azure CLI](/cli/azure/install-azure-cli) en suivant les étapes de l’article lié, puis connectez-vous au compte Azure.
...
- Pour savoir comment gérer et dépanner l’équilibrage de charge à l’aide de différents types de journaux d’activité dans Azure, consultez [Log Analytics pour Azure Load Balancer](./monitor-load-balancer.md).