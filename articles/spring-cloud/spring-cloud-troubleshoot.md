...
Si *toutes les instances* connaissent une utilisation élevée de l’UC ou de la mémoire, vous devez monter en charge l’application ou monter en puissance l’utilisation de l’UC ou de la mémoire. Pour plus d’informations, consultez [Tutoriel : Mettre à l’échelle une application dans Azure Spring Cloud](spring-cloud-tutorial-scale-manual.md).
