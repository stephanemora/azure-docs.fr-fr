...
### <a name="configure-rewrite-set"></a>Configurer un jeu de réécriture

1. Sélectionnez **Réécritures** puis **Jeu de réécriture** pour ajouter un jeu de réécriture.
1. Sélectionnez les règles de routage qui acheminent les demandes vers des points de terminaison publics Azure Spring Cloud.
1. Sous l’onglet **Configuration de règle de réécriture**, sélectionnez **Ajouter une règle de réécriture**.
1. **Type de réécriture** : sélectionnez **En-tête de demande**
1. **Type d’action** : sélectionnez **supprimer**
1. **Nom d’en-tête** : sélectionnez **En-tête commun**
1. **En-tête commun** : sélectionnez **X-Forwarded-proto**
...
Procédez comme suit pour effectuer une intégration au service Azure Spring Cloud et configurer le pool de back-ends :
