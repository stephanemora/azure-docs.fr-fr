...
* Activez l’agent In-process Java à partir du [guide de l’agent In-process Java pour Application Insights](https://docs.microsoft.com/azure/spring-cloud/spring-cloud-howto-application-insights#enable-java-in-process-agent-for-application-insights). 

* Activez la collecte de dimensions pour les métriques Resilience4J à partir du [guide Application Insights](https://docs.microsoft.com/azure/azure-monitor/app/pre-aggregated-metrics-log-metrics#custom-metrics-dimensions-and-pre-aggregation).
...
* [Traçage distribué](spring-cloud-tutorial-distributed-tracing.md)
