...
> [!TIP]
> Si vous utilisez un dépôt privé pour le serveur de configuration, reportez-vous à notre [tutoriel sur la configuration de l’authentification](./spring-cloud-tutorial-config-server.md).
