...
Azure Spring Cloud vous permet d’exécuter facilement une application de microservices basée sur Spring Boot sur Azure.  Avant d’exécuter cet exemple, vous pouvez essayer le [guide de démarrage rapide de base](spring-cloud-quickstart.md).
...
3. Accédez à l’URL fournie par la commande précédente pour exécuter l’application PiggyMetrics.
    ![PiggyMetrics en cours d’exécution](media/spring-cloud-quickstart-launch-app-cli/launch-app.png)
...
3. Sélectionner **passerelle**
    ...
    ![PiggyMetrics - Navigation](media/spring-cloud-quickstart-launch-app-cli/navigate-app1.png)
    
4. Recherchez l’URL dans la page **Vue d’ensemble de gateway**![PiggyMetrics - Navigation 2](media/spring-cloud-quickstart-launch-app-cli/navigate-app2-url.png)
