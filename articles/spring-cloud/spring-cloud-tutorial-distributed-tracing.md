...
1. Dans la méthode `ConfigureServices`, appelez les méthode `AddDistributedTracing` et `AddZipkinExporter`.
...
1. Dans la méthode `Configure`, appelez la méthode `UseTracingExporter`.
