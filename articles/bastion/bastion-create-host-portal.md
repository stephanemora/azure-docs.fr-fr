...
description: Cet article explique comment créer un hôte Azure Bastion qui fournit une connectivité RDP/SSH à toutes les machines virtuelles d’un réseau virtuel.
services: bastion
author: cherylmc
ms.service: bastion
ms.topic: how-to
