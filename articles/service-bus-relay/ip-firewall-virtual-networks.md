...
1. Accédez à votre **espace de noms Relay** sur le [Portail Azure](https://portal.azure.com).
...
Le modèle Resource Manager suivant permet d’ajouter une règle de filtre IP à un espace de noms Relay.
...
Pour en savoir plus sur les autres fonctionnalités liées à la sécurité réseau, consultez [Sécurité réseau](network-security.md).
