...
|Azure Data Lake Store<sup>[1](#tab1400a)</sup>     |   Oui       |    Non       |
...
<a name="databricks">3</a> Azure Databricks connecteur Spark n’est actuellement pas pris en charge.
