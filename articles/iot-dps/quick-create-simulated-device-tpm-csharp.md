...
description: Démarrage rapide - Créer et provisionner un appareil TPM simulé à l’aide du kit C# device SDK pour le service Azure IoT Hub Device Provisioning. Ce démarrage rapide utilise des inscriptions individuelles.
author: wesmc7777
ms.author: wesmc
ms.date: 11/08/2018
ms.topic: quickstart
