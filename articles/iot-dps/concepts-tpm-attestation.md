...
![L’appareil rétablit la connexion au service Device Provisioning pour valider la possession de la paire de clés de type EK](./media/concepts-tpm-attestation/step-three-validation.png)
