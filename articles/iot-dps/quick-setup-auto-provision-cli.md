...
Créez un service Device Provisioning avec la commande [az iot dps create](/cli/azure/iot/dps#az_iot_dps_create). 
...
> [Démarrage rapide pour créer un appareil simulé](./quick-create-simulated-device-tpm.md)
