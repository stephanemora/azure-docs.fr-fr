...
Vous aurez besoin d’un abonnement Azure pour commencer à suivre cet article. Si vous ne l’avez pas déjà fait, vous pouvez créer un [compte gratuit](https://azure.microsoft.com/free/?WT.mc_id=A261C142F).
