...
description: Décrit les concepts d’approvisionnement de sécurité pour les appareils avec le service Device Provisioning (DPS) et IoT Hub
author: nberdy
ms.author: nberdy
ms.date: 04/04/2019
ms.topic: conceptual
...
L’attestation de module de plateforme sécurisée (TPM) repose sur une stimulation nonce qui utilise la clé racine de stockage et la paire de clés de type EK pour présenter un jeton de signature d’accès partagé (SAP).
