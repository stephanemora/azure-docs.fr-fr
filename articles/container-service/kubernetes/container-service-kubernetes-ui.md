...
> [!TIP]
> Pour obtenir la version mise à jour de cet article qui utilise Azure Kubernetes Service, consultez la page [Accéder au tableau de bord web Kubernetes dans Azure Kubernetes Service (AKS)](../../aks/kubernetes-dashboard.md).
