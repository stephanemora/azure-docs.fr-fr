...
1. Accédez à l’interface utilisateur de votre DC/OS via `http://localhost:80/`. Une fois dans l’interface utilisateur de DC/OS, accédez à l’onglet **Univers**, puis recherchez **Dynatrace**.
