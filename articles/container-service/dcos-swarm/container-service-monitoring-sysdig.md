...
Accédez à l’IU DC/OS via `http://localhost:80/`. Une fois dans l’IU DC/OS, accédez à Universe (Univers) en bas à gauche de la page, puis recherchez « Sysdig ».
