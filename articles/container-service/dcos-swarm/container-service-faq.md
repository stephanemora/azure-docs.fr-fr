...
Une prise en charge est disponible pour CD/OS open source, Docker Swarm et Kubernetes. Pour plus d'informations, consultez la [Vue d’ensemble](../kubernetes/container-service-intro-kubernetes.md).
 
