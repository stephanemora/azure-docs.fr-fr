...
![Liste des ressources Blockchain Workbench](media/blockchain-workbench-database-firewall/list-database-resources.png)
...
2. Dans la barre de menus, sélectionnez **Définir le pare-feu du serveur**.
   ...
   ![Définir le pare-feu du serveur](media/blockchain-workbench-database-firewall/configure-server-firewall.png)
...
3. Pour créer une règle pour votre organisation :
   ...
   * Dans la plage d’adresses, entrez une adresse IP pour **ADRESSE IP DE FIN**.
   ...
   ![Créer une règle de pare-feu](media/blockchain-workbench-database-firewall/create-firewall-rule.png)
