...
![Vue d’ensemble des leaders autonomes et de consortium](./media/ethereum-deployment-guide/leader-overview.png)

### <a name="joining-consortium-member-overview"></a>Vue d’ensemble de la jointure d’un membre de consortium

![Vue d’ensemble de la jointure d’un membre de consortium](./media/ethereum-deployment-guide/member-overview.png)
...
![Concepts de base](./media/ethereum-deployment-guide/sample-deployment.png)
...
![Création d’une instance OMS](./media/ethereum-deployment-guide/new-oms.png)
...
![Régions de déploiement](./media/ethereum-deployment-guide/deployment-regions.png)

Nom du paramètre| Description| Valeurs autorisées |Valeurs par défaut
---|---|---|---
Nombre de régions| Nombre de régions dans lesquelles déployer le réseau de consortium|1, 2, 3, 4, 5| 2
Première région| Première région dans laquelle déployer le réseau de consortium|Toutes les régions sont autorisées.| États-Unis de l’Ouest
Deuxième région |Autre région dans laquelle déployer le réseau de consortium (visible uniquement lorsque le nombre de régions sélectionné est 2).|Toutes les régions sont autorisées.| Est des États-Unis
Troisième région| Troisième région dans laquelle déployer le réseau de consortium (visible uniquement lorsque le nombre de régions sélectionné est 3).|Toutes les régions sont autorisées.| Centre des États-Unis
Quatrième région| Quatrième région dans laquelle déployer le réseau de consortium (visible uniquement lorsque le nombre de régions sélectionné est 4).|Toutes les régions sont autorisées.| Est des États-Unis 2
Cinquième région| Cinquième région dans laquelle déployer le réseau de consortium (visible uniquement lorsque le nombre de régions sélectionné est 5).|Toutes les régions sont autorisées.| Ouest des États-Unis 2
...
![Taille et performances du réseau](./media/ethereum-deployment-guide/network-size-performance.png)
...
Taille de machine virtuelle du nœud d’exploration de données|Taille de machine virtuelle utilisée pour les nœuds d’exploration de données.|Standard A, <br />Standard D, <br />Standard D-v2, <br />série Standard F, <br />Standard DS, <br />et Standard FS|Standard D1v2
...
Taille de machine virtuelle du nœud de transaction|Taille de machine virtuelle utilisée pour les nœuds de transaction.|Standard A, <br />Standard D, <br />Standard D-v2, <br />série Standard F, <br />Standard DS, <br />et Standard FS|Standard D1v2
...
![Paramètres Ethereum](./media/ethereum-deployment-guide/standalone-leader-deployment.png)
...
Clé partagée pour la connexion|Clé partagée pour la connexion entre les passerelles de réseau virtuel.| Au moins 12 caractères|N/D
...
![Résumé](./media/ethereum-deployment-guide/summary.png)
...
![Vue d’ensemble du groupe de ressources](./media/ethereum-deployment-guide/resource-overview.png)
...
![Déploiements de ressources](./media/ethereum-deployment-guide/resource-deployments.png)

![Sortie du déploiement](./media/ethereum-deployment-guide/deployment-output.png)
...
![État du nœud](./media/ethereum-deployment-guide/node-status.png)
...
![Ressource OMS](./media/ethereum-deployment-guide/oms-resource.png)

Le portail affiche tout d’abord les statistiques réseau de haut niveau comme une vue d’ensemble.

![Vue d’ensemble OMS](./media/ethereum-deployment-guide/oms-overview.png)

Cliquez sur la vue d’ensemble pour accéder à un portail affichant des statistiques par nœud.

![Statistiques par nœud](./media/ethereum-deployment-guide/per-node-stats.png)
...
![Architecture leader/membre](./media/ethereum-deployment-guide/leader-member.png)
...
![Nœud de transaction](./media/ethereum-deployment-guide/transaction-node.png)
...
![Extension MetaMask](./media/ethereum-deployment-guide/metamask-extension.png)
...
![Paramètres MetaMask](./media/ethereum-deployment-guide/metamask-settings.png)
...
![Création de compte MetaMask](./media/ethereum-deployment-guide/metamask-create-account.png)
...
![Nœud de transaction](./media/ethereum-deployment-guide/transaction-node-mined.png)
...
![État du nœud](./media/ethereum-deployment-guide/node-status2.png)
...
![Transfert MetaMask](./media/ethereum-deployment-guide/metamask-transfer.png)
...
![Envoi de transaction MetaMask](./media/ethereum-deployment-guide/metamask-send.png)
...
![Portefeuille 1](./media/ethereum-deployment-guide/wallet1.png)

![Portefeuille 2](./media/ethereum-deployment-guide/wallet2.png)
