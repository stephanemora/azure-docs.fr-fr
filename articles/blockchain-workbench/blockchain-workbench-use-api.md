...
ms.locfileid: "34257901"
---
# <a name="using-the-azure-blockchain-workbench-rest-api"></a>Utilisation de l’API REST Azure Blockchain Workbench 

L’API REST Azure Blockchain Workbench permet aux développeurs et aux professionnels de l’information pour créer des intégrations riches aux applications blockchain. Ce document vous guide dans l’utilisation de l’API REST Workbench à l’aide de plusieurs méthodes clés. Imaginons un scénario dans lequel un développeur souhaite créer un client blockchain personnalisé pour permettre aux utilisateurs connectés d’afficher les applications blockchain qui leur sont attribuées et d’interagir avec elles. Ce client permet aux utilisateurs d’afficher les instances du contrat et d’intervenir sur les contrats intelligents. Il utilise l’API REST Workbench dans le contexte de l’utilisateur connecté pour effectuer les opérations suivantes :
...
La réponse recense toutes les applications blockchain auxquelles un utilisateur a accès dans Blockchain Workbench. Les administrateurs Blockchain Workbench obtiennent toutes les applications blockchain, à la différence des administrateurs non-Workbench qui obtiennent tous les blockchains pour lesquels ils disposent au moins d’un rôle d’application associé ou pour lesquels ils sont associés à un rôle d’instance de contrat intelligent.
...
Une fois qu’un utilisateur sélectionne l’application blockchain applicable (dans ce cas, **Asset Transfer**), le client blockchain récupère tous les flux de travail correspondants. Les utilisateurs peuvent alors sélectionner le flux de travail applicable avant de se voir proposer toutes les instances de contrat intelligent pour ce flux. Chaque application blockchain possède un ou plusieurs flux de travail, et chaque flux de travail possède zéro instance de contrat ou des instances de contrat intelligent. Au moment de la création d’applications clientes blockchain, nous recommandons d’ignorer le flux d’expérience utilisateur. En effet, cela permet aux utilisateurs de sélectionner le flux de travail approprié lorsqu’il existe uniquement un flux de travail pour l’application blockchain. Dans ce cas, **Asset Transfer** n’a qu’un seul flux de travail, également appelé **Asset Transfer**.
...
La réponse recense tous les flux de travail de l’application blockchain spécifiée auxquels un utilisateur a accès dans Blockchain Workbench. Les administrateurs Blockchain Workbench obtiennent tous les flux de travail blockchain, à la différence des administrateurs non-Workbench qui obtiennent tous les flux de travail pour lesquels ils disposent au moins d’un rôle d’application associé ou pour lesquels ils sont associés à un rôle d’instance de contrat intelligent.
...
La réponse recense toutes les instances de contrat intelligent du flux de travail spécifié. Les administrateurs Workbench obtiennent toutes les instances de contrat intelligent, à la différence des administrateurs non-Workbench qui obtiennent toutes les instances de contrat intelligent pour lesquelles ils disposent au moins d’un rôle d’application associé ou pour lesquelles ils sont associés à un rôle d’instance de contrat intelligent.
...
Une fois qu’un utilisateur a décidé d’approfondir l’un des contrats, le client blockchain peut alors lui présenter toutes les actions disponibles compte tenu de l’état de ce contrat. Dans cet exemple, l’utilisateur recherche toutes les actions disponibles pour un nouveau contrat intelligent créé :

* Modifier : permet à l’utilisateur de modifier la description et le prix d’une ressource.
* Terminer : permet à l’utilisateur de mettre un terme au contrat de la ressource.

Utilisez [l’API Contract Action GET](https://docs.microsoft.com/rest/api/azure-blockchain-workbench/contracts/contractactionget) :
...
Un utilisateur peut ensuite décider d’intervenir pour l’instance de contrat intelligent spécifiée. Dans ce cas, imaginons qu’un utilisateur souhaite modifier la description et le prix d’une ressource pour les éléments suivants :

* Description : "My updated car"
* Prix : 54321

Utilisez [l’API Contract Action POST](https://docs.microsoft.com/rest/api/azure-blockchain-workbench/contracts/contractactionpost) :
