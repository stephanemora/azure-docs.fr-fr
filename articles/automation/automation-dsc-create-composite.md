...
Si vous souhaitez partager ce travail avec d’autres personnes, la meilleure solution consiste à empaqueter la configuration sous forme de [ressource composite](/powershell/dsc/resources/authoringresourcecomposite).
