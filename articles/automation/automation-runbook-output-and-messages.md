...
> [!NOTE]
> Une fois que vous avez entré une valeur dans la zone **Type de sortie** dans le volet **Propriétés d’entrée et de sortie**, vous devez cliquer à l’extérieur du contrôle afin que votre entrée puisse être reconnue par le contrôle.
