...
Planifiez un déploiement des mises à jour en suivant les instructions dans [Gérer les mises à jour et les correctifs pour vos machines virtuelles](manage-updates-for-vm.md).
