...
Créez un crochet de service dans Azure DevOps pour les archivages dans le dossier qui déclenche ce webhook lors de l’archivage de code. Sélectionnez **Raccordements web** comme service à intégrer quand vous créez un abonnement. Pour plus d’informations sur les crochets de service, consultez la [documentation sur les crochets de service Azure DevOps](https://www.visualstudio.com/en-us/docs/marketplace/integrate/service-hooks/get-started).
