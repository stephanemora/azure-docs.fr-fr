...
### <a name="diagnostic-logging"></a>Scénario : L’intégration échoue avec le message : Échec de la configuration du compte Automation pour la journalisation des diagnostics
...
### <a name="unlink"></a>Scénario : Erreurs lors de la tentative de dissociation d’un espace de travail
