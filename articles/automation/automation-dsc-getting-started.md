...
1. Sur la page **Compte Automation**, sélectionnez **Configurations DSC** sous **Gestion de la configuration**.
1. Sur la page **Configurations DSC**, cliquez sur **+ Ajouter une configuration**.
...
1. Sur la gauche, cliquez sur **Toutes les ressources**, puis sur le nom de votre compte Automation.
1. Sur la page **Compte Automation**, sélectionnez **Configurations DSC** sous **Gestion de la configuration**.
1. Sur la page **Configurations DSC**, cliquez sur **TestConfig** (il s’agit du nom de la configuration que vous avez importée dans la procédure précédente).
...
1. Connectez-vous au [Portail Azure](https://portal.azure.com).
1. Dans le menu Hub, cliquez sur **Toutes les ressources** , puis sur le nom de votre compte Automation.
1. Dans le panneau **Compte Automation**, cliquez sur **Configurations de nœuds DSC**.
...
1. Connectez-vous au [Portail Azure](https://portal.azure.com).
1. Sur la gauche, cliquez sur **Toutes les ressources**, puis sur le nom de votre compte Automation.
1. Sur la page **Compte Automation**, cliquez sur **Nœuds DSC** sous **Gestion de la configuration**.
1. Sur la page **Nœuds DSC**, cliquez sur **Ajouter une machine virtuelle Azure**.
...
1. Sur la page Machines virtuelles, sélectionnez votre machine virtuelle. Sur la page **Ajouter des machines virtuelles Azure**, cliquez sur **Sélectionner les machines virtuelles à intégrer**.
