...
Généralement, il n'est pas nécessaire de créer la ressource de connexion car celle-ci est générée au moment où vous créez le [compte RunAs](manage-runas-account.md).
