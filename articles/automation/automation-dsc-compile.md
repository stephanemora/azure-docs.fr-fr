...
Pour savoir comment signer des configurations de nœuds, consultez le site https://msdn.microsoft.com/powershell/wmf/5.1/dsc-improvements#how-to-sign-configuration-and-module.
