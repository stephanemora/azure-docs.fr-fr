...
* Seuls les modules `Azure` et `AzureRM.*` sont actuellement pris en charge. Les nouveaux [modules Azure PowerShell Az](/powershell/azure/new-azureps-module-az) ne sont pas encore pris en charge.
