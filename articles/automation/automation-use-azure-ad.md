...
>[!NOTE]
>Pour installer le module MSOnline, vous devez avoir un rôle Administrateur Office 365. Voir [À propos des rôles Administrateur](/microsoft-365/admin/add-users/about-admin-roles?view=o365-worldwide).
