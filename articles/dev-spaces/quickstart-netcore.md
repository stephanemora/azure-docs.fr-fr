...
ms.locfileid: "34361575"
---
# <a name="quickstart-create-a-kubernetes-development-environment-with-azure-dev-spaces-net-core-and-vs-code"></a>Démarrage rapide : créer un environnement de développement Kubernetes avec Azure Dev Spaces (.NET Core et Visual Studio Code)
