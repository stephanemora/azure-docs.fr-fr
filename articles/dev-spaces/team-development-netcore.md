---
title: Développement en équipe à l’aide de .NET Core et Visual Studio Code
...
![Diagramme montrant un espace de développement simple.](media/common/ci-cd-space-setup.png)
