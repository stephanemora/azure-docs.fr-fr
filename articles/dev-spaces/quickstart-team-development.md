---
title: Développement en équipe sur Kubernetes en utilisant Azure Dev Spaces
...
- [Helm 2.13 ou version ultérieure installé](https://github.com/helm/helm/blob/master/docs/install.md).
