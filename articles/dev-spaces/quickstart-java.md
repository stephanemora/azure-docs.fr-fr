...
- Un cluster Kubernetes, qui exécute Kubernetes 1.10.3 ou ultérieure dans les régions EastUS, CentralUS, WestUS2, WestEurope, CanadaCentral ou CanadaEast, avec le **routage d’application HTTP** activé.
