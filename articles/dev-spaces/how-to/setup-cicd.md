...
* [Organisation Azure DevOps avec un projet](/azure/devops/user-guide/sign-up-invite-teammates)
...
Dans la branche _azds_updates_, nous avons inclus un simple [pipeline YAML Azure](/azure/devops/pipelines/yaml-schema?tabs=schema) qui définit les étapes de génération nécessaires pour *mywebapi* et *webfrontend*.
