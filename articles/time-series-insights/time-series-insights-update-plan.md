...
- Découvrez-en plus sur l’[ingestion de données](./concepts-ingestion-overview.md).
- Consulter l’article sur le [stockage de données](./concepts-storage.md)
- Renseignez-vous sur la [modélisation des données](./concepts-model-overview.md) dans Azure Time Series Insights en préversion.
