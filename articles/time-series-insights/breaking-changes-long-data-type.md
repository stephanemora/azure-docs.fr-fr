...
* Voir [types de données prises en charge](concepts-supported-data-types.md) pour afficher la liste complète des types de données pris en charge, consultez cet article.
