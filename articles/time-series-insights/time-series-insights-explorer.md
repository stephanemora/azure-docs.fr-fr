...
### <a name="in-this-video-we-cover-querying-data-using-the-time-series-insights-explorer-br"></a>Dans cette vidéo, nous abordons l’interrogation des données avec l’explorateur Time Series Insights. </br>
...
1. Vous pouvez également actualiser la disponibilité automatiquement toutes les minutes, en sélectionnant le **Activer automatiquement**.  Notez que le bouton « Activer automatiquement » s’applique uniquement au graphique de disponibilité, pas au contenu de la visualisation principale.
