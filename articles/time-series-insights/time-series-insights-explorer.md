...
- [Fournissez l’accès](./concepts-access-policies.md) à votre compte dans l’environnement.
- Ajoutez-y une source [hub IoT](./how-to-ingest-data-iot-hub.md) ou un [hub d’événement](./how-to-ingest-data-event-hub.md).
