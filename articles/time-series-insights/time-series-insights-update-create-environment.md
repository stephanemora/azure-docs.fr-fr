...
En savoir plus sur l’ingestion Azure Time Series Insights :

> [!div class="nextstepaction"]
> [Présentation de l’ingestion de données Azure Time Series Insights](./concepts-ingestion-overview.md)

En savoir plus sur les modèles Time Series :

> [!div class="nextstepaction"]
> [Azure Time Series Insights (préversion) - Modélisation de données](./concepts-model-overview.md)
