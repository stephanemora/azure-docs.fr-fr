...
Time Series Insights prend en charge les ressources suivantes :
   ...
   | --- | --- |
   | Environnement | Un environnement Time Series Insights est un regroupement logique d’événements lus à partir de répartiteurs, stockés et rendus interrogeables. Pour plus d’informations, consultez [Planifier votre environnement Azure Time Series Insights](time-series-insights-environment-planning.md) |
...
- Pour plus d’informations sur la gestion programmatique des ressources Time Series Insights avec les API REST, consultez [Gestion de Time Series Insights](https://docs.microsoft.com/rest/api/time-series-insights-management/).
