---
title: Cas d’usage de la préversion – Azure Time Series Insights | Microsoft Docs
description: Découvrez des cas d’usage d’Azure Time Series Insights (préversion).
author: deepakpalled
ms.author: dpalled
manager: cshankar
...
[![Vue d’ensemble](media/v2-update-use-cases/overview.png)](media/v2-update-use-cases/overview.png#lightbox)
