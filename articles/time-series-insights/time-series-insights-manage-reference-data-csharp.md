---
title: Données de référence C# Azure Time Series Insights – Gérer les données de référence dans un environnement Azure Time Series Insights à l’aide de C# | Microsoft Docs
