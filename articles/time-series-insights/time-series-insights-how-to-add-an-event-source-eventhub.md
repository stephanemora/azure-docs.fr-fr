...
1. Sous **Nom de la source de l’événement**, indiquez une valeur unique pour cet environnement Time Series Insights, comme `Contoso-TSI-GA-Event-Hub-ES`.
