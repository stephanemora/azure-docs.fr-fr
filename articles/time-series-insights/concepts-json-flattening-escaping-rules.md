...
### <a name="how-do-i-know-if-my-array-of-objects-will-produce-multiple-events"></a>Comment savoir si mon tableau d’objets produira plusieurs événements ?
...
ID de la série chronologique au niveau de la racine de l’objet et de l’horodateur imbriqué<br/>
**ID de série chronologique de l’environnement :** `"id"`<br/>
**Horodateur de la source de l’événement :** `"values.time"`<br/>
**Charge utile JSON :**
...
ID de série chronologique composite avec une propriété imbriquée<br/> 
**ID de série chronologique de l’environnement :** `"plantId"` et `"telemetry.tagId"`<br/>
**Horodateur de la source de l’événement :** `"timestamp"`<br/>
**Charge utile JSON :**
...
L’ID et l’horodateur de la série chronologique se trouvent à la racine de l’objet<br/> 
**ID de série chronologique de l’environnement :** `"id"`<br/>
**Horodateur de la source de l’événement :** `"timestamp"`<br/>
**Charge utile JSON :**
