...
> [!TIP]
> Passez en revue [les limites et la planification](time-series-insights-update-plan.md) dans Azure Time Series Insights version préliminaire.
