...
ms.locfileid: "47585626"
---
# <a name="connect-to-azure-stack-development-kit"></a>Se connecter au Kit de développement Azure Stack
...
Pour tester la connexion avec le portail, ouvrez un navigateur web, puis accédez au portail utilisateur (https://portal.local.azurestack.external/) ou au portail l’opérateur (https://adminportal.local.azurestack.external/). Connectez-vous et créez un groupe de ressources.  
