...
- Un cluster de serveurs de fichiers Windows
- Un serveur de fichiers non Windows
- Un cluster de serveurs de fichiers non Windows
- un périphérique NAS (Network Attached Storage)

Pour plus d’informations, consultez la rubrique [Approvisionner un serveur de fichiers](azure-stack-app-service-before-you-get-started.md#prepare-the-file-server).
