...
description: Apprenez à préparer l’hôte d’extension qui est automatiquement activé grâce à un futur package de mise à jour Azure Stack.
...
ms.locfileid: "42888998"
---
# <a name="prepare-for-extension-host-for-azure-stack"></a>Préparer l’hôte d’extension pour Azure Stack

Vous pouvez utiliser l’hôte d’extension pour sécuriser Azure Stack en réduisant le nombre de ports TCP/IP requis. Cet article passe en revue la préparation d’Azure Stack pour l’hôte d’extension. Ce dernier est automatiquement activé via un package de mise à jour Azure Stack après la mise à jour 1808.
...
> [!Note]  
> Vous pouvez ignorer cette étape en fonction de votre demande de certificats SSL.
...
5. Importez le certificat pour le point de terminaison d’hébergement d’administration.
