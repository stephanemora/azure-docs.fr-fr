...
5. Ajoutez vos paramètres de test communs. Pour plus d’informations, consultez la section [Ajouter des paramètres de test communs](#add-common-test-parameters).
