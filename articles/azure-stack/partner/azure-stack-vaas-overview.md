...
Pour plus d’informations, consultez [Schedule your first test](azure-stack-vaas-schedule-test-pass.md) (Planifier votre premier test).

## <a name="next-steps"></a>Étapes suivantes

- [Tutorial: Set up resources for Validation as a Service](azure-stack-vaas-set-up-resources.md) (Didacticiel : Configurer les ressources de la validation en tant que service)
