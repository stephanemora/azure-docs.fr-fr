...
L’utilisation des licences existantes évite la génération de compteurs d’utilisation. Les licences Windows Server existantes peuvent être utilisées dans Azure Stack, comme décrit dans la section relative à « l’utilisation de logiciels existants avec Azure Stack » du [Guide de gestion des licences Azure Stack](https://go.microsoft.com/fwlink/?LinkId=851536). Les clients doivent déployer leurs machines virtuelles Windows Server comme décrit dans l’article [Hybrid Benefit pour la licence Windows Server](../virtual-machines/windows/hybrid-use-benefit-licensing.md) pour pouvoir utiliser leurs licences existantes.
