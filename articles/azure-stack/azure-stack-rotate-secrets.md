...
4.  Ouvrez une console PowerShell ISE sur la machine virtuelle ERCS à l’aide du compte **CloudAdmin**.  Accédez à votre partage de fichiers. 
...
Pour effectuer la rotation des clés internes et externes :
