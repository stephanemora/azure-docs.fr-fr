...
1. Accédez à [http://aka.ms/AzureStackGitHub](https://aka.ms/AzureStackGitHub) et recherchez le modèle **101-simple-windows-vm**. Enregistrez le modèle à cet emplacement : C:\\templates\\azuredeploy-101-simple-windows-vm.json.
