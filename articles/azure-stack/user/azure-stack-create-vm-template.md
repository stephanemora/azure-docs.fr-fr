...
Pour découvrir plus d’informations sur le dépôt GitHub et savoir comment y contribuer, consultez le [fichier Lisez-moi](https://github.com/Azure/AzureStack-QuickStart-Templates/blob/master/README.md). 
...
> [!IMPORTANT]
> L’image de la machine virtuelle Ubuntu (Ubuntu Server 16.04 LTS dans notre exemple) doit avoir déjà été ajoutée au marketplace Azure Stack avant de commencer à suivre ces étapes.

1.  Cliquez sur **+ Créer une ressource** > **Personnalisé** > **Déploiement de modèle**.
