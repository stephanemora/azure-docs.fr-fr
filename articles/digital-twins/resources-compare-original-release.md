...
* Découvrez en détail comment utiliser la version actuelle dans le guide de démarrage rapide : [Démarrage rapide : Bien démarrer avec Azure Digital Twins Explorer](quickstart-azure-digital-twins-explorer.md).
