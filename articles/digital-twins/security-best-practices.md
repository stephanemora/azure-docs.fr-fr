...
## <a name="iot-security-best-practices"></a>Bonnes pratiques de sécurité IoT
...
> * Utilisation potentielle du filtrage des adresses IP d’appareil
...
> * Utiliser un certificat émis par des [autorités de certification](https://docs.microsoft.com/azure/active-directory/authentication/active-directory-certificate-based-authentication-get-started) approuvées, plutôt que d’utiliser des secrets d’application devant s’authentifier.
