...
:::image type="content" source="media/how-to-create-app-registration/app-important-values.png" alt-text="Capture d’écran de la vue du portail Azure montrant les valeurs importantes pour l’inscription de l’application":::
