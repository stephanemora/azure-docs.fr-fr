...
## <a name="converting-industry-standard-models"></a>Conversion de modèles standard

Si vous avez des modèles existants en dehors d’Azure Digital Twins qui sont basés sur une norme du secteur, comme RDF ou OWL, vous devez **les convertir en DTDL** afin de les utiliser avec Azure Digital Twins. La version DTDL devient alors la source de vérité pour le modèle dans Azure Digital Twins.

Pour plus d’informations sur ce processus, consultez [*Guide pratique pour convertir des modèles standard*](how-to-convert-models.md).
