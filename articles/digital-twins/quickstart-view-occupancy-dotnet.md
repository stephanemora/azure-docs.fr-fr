...
1. Ouvrez une invite de commandes. Accédez au dossier dans lequel vos fichiers digital-twins-samples-csharp-master.zip ont été extraits.
...
1. Exécutez `dotnet restore`.
1. Modifiez **appsettings.json** pour actualiser **DeviceConnectionString** avec la `ConnectionString` précédente.
