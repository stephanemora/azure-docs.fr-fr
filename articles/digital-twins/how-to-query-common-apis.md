...
- Obtenir les espaces dont le parent est l’ID d’espace donné, et inclure les dépendances 
...
## <a name="queries-for-device-management"></a>Requêtes concernant la gestion des appareils
...
- Obtenir la chaîne de connexion de hub IoT pour un appareil particulier
