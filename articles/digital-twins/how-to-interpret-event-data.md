...
Le corps est la charge utile d’une relation, et se présente au format JSON. Il utilise le même format qu’une requête `GET` pour une relation via l’[API DigitalTwins](how-to-use-apis-sdks.md). 
