...
> [!NOTE]
> Les serveurs SQL Server ne peuvent pas être supprimées à partir du portail et doivent être supprimées à partir de la page de propriétés de la ressource.
