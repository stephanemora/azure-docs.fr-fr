...
ms.locfileid: "58000843"
---
# <a name="tutorial-create-on-premises-virtual-network-with-terraform-in-azure"></a>Tutoriel : Créer un réseau virtuel local avec Terraform dans Azure
