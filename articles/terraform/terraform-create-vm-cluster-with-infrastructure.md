...
description: Dans ce tutoriel, vous allez utiliser Terraform et HCL pour créer un cluster de machines virtuelles Linux avec un équilibreur de charge dans Azure
keywords: cluster devops terraform vm machine virtuelle cluster
ms.topic: tutorial
ms.date: 03/09/2020
