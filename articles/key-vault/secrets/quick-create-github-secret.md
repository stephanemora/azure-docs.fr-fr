...
- Une application Azure connectée à un dépôt GitHub. Cet exemple utilise [Déployer des conteneurs sur Azure App Service](/azure/developer/javascript/tutorial-vscode-docker-node-01). 
