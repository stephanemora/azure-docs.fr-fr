...
Créez une identité attribuée par le système pour la machine virtuelle avec la commande Azure CLI [az vm identity assign](/cli/azure/vm/identity#az_vm_identity_assign) :
