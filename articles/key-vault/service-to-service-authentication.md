...
- Apprenez-en davantage sur les [scénarios d’authentification Azure AD](/azure/active-directory/develop/active-directory-authentication-scenarios).
