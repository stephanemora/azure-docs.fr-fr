...
|AES 128 bits, 256 bits <br/>(HSM managé uniquement)| AES-KW<br>AES-GCM<br>AES-CBC| N/D| 
|||
...
##  <a name="symmetric-key-algorithms-managed-hsm-only"></a>Algorithmes de clé symétrique (HSM managé uniquement)
