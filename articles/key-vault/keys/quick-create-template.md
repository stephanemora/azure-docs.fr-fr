...
description: Guide de démarrage rapide montrant comment créer des coffres de clés Azure et leur ajouter une clé à l’aide d’un modèle Azure Resource Manager.
services: key-vault
author: sebansal
