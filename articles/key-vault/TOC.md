...
## [Lecture à partir d’un coffre de clés : Node.js](quick-create-node.md)
# Didacticiels
...
## Node.js
### [Gestion de coffre](https://docs.microsoft.com/javascript/api/azure-arm-keyvault/)
### [Bibliothèque de client de coffre](https://docs.microsoft.com/javascript/api/azure-keyvault/)
## Développement
