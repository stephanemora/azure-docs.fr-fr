...
>  ```
> 
Pour en savoir plus sur les paramètres, consultez [az keyvault certificate](/cli/azure/keyvault/certificate?view=azure-cli-latest#az-keyvault-certificate-set-attributes).
