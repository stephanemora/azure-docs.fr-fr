...
Pour plus d’informations, consultez [Exemples et définitions de paramètres](/cli/azure/keyvault/certificate#az-keyvault-certificate-download).
...
Pour plus d’informations, consultez [Définitions de paramètres](/cli/azure/keyvault/secret#az-keyvault-secret-download).
