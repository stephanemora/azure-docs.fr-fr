...
Pour plus d’informations, consultez [Exemples et définitions de paramètres](/cli/azure/keyvault/certificate#az_keyvault_certificate_download).
...
Pour plus d’informations, consultez [Définitions de paramètres](/cli/azure/keyvault/secret#az_keyvault_secret_download).
...
Pour plus d’informations sur la commande et les paramètres de **Get-AzKeyVaultCertificate**, consultez [Get-AzKeyVaultCertificate - Exemple 2](/powershell/module/az.keyvault/Get-AzKeyVaultCertificate).
