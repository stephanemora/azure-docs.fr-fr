...
|`imageType`|Chaîne|Méthode de déploiement de l'image. Valeurs prises en charge : `virtualMachineConfiguration` ou `cloudServiceConfiguration`|
...
|`nodeAgentId`|Chaîne|Référence (SKU) de l’agent du nœud Batch configuré sur le nœud de calcul.|
