...
Créez et utilisez des modèles de fichier avec Azure CLI pour créer des pools, travaux et tâches Batch. Chargez facilement les fichiers d’entrée des travaux dans le compte de stockage associé au compte Batch, et téléchargez les fichiers de sortie de travaux.
...
Installez une extension Azure Batch CLI pour utiliser les fonctionnalités de transfert de fichiers et de modèles.

Pour obtenir des instructions sur l’installation d’Azure CLI, consultez [Installer Azure CLI 2.0](/cli/azure/install-azure-cli).

Dès que l’interface Azure CLI est installée, procédez à l’installation de la dernière version de l’extension Batch en exécutant la commande CLI suivante :
...
Voici un exemple de modèle qui crée un travail de transcodage de fichiers vidéo MP4 avec ffmpeg dans une des deux résolutions inférieures. Il crée une tâche par fichier vidéo source :
...
- Consultez l’article du blog au sujet des modèles de lot : [Exécution des travaux Azure Batch à l’aide de l’interface de ligne de commande Azure - aucun code requis](https://azure.microsoft.com/blog/running-azure-batch-jobs-using-the-azure-cli-no-code-required/).
