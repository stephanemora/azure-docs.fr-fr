---
title: Surveiller Azure Batch avec Azure Application Insights | Microsoft Docs
...
* [IDE de Visual Studio](https://www.visualstudio.com/vs) (Visual Studio 2015 ou version plus récente).
...
L’exemple dans TopNWords.cs utilise les [appels d’instrumentation](../application-insights/app-insights-api-custom-events-metrics.md) suivants de l’API Application Insights :
