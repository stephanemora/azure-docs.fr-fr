...
- [Ressource Application Insights](../azure-monitor/app/create-new-resource.md). Utilisez le portail Azure pour créer une *ressource* Application Insights. Sélectionnez le **Type d’application** *Général*.
- Copiez la [clé d’instrumentation](../azure-monitor/app/create-new-resource.md#copy-the-instrumentation-key) à partir du Portail Azure. Vous aurez besoin de cette valeur ultérieurement.
...
![Capture d’écran des données de nœud de calcul en flux temps réel.](./media/monitor-application-insights/applicationinsightslivestream.png)
...
![Capture d’écran montrant les journaux pour une seule trace.](./media/monitor-application-insights/tracelogsfortask.png)

### <a name="view-unhandled-exceptions"></a>Afficher les exceptions non prises en charge

Application Insights journalise les exceptions générées par votre application. Dans ce cas, quelques secondes après la génération de l’exception par l’application, vous pouvez analyser une exception et diagnostiquer le problème.

![Capture d’écran montrant des exceptions non gérées.](./media/monitor-application-insights/exception.png)
...
1. Cliquez sur **Modifier** sur le graphique ajouté.
1. Mettez à jour les détails du graphique comme suit :
...
![Capture d’écran d’un graphique montrant le temps de téléchargement d’un objet blob par nœud.](./media/monitor-application-insights/blobdownloadtime.png)
...
- Pour la prise en charge d’Application Insights dans d’autres langages, consultez [Documentation sur les langages, plateformes et intégrations](../azure-monitor/app/platforms.md).
