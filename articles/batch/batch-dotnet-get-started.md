...
* **Compte de stockage** : pour plus d’options de compte de stockage dans Batch, consultez [l’Aperçu des fonctionnalités d’Azure Batch](batch-api-basics.md#azure-storage-account).
