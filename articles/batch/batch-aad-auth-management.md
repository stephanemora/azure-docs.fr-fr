...
description: Les applications créées avec Azure Resource Manager et le fournisseur de ressources Batch s’authentifier auprès d’Azure AD.
services: batch
