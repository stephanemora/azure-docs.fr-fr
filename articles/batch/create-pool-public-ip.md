...
L’exemple ci-dessous montre comment utiliser l’[API REST du service Azure Batch](https://docs.microsoft.com/rest/api/batchservice/pool/add) pour créer un pool qui utilise des adresses IP publiques.
