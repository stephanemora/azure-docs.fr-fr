...
:::image type="content" source="media/batch-application-packages/app_pkg_02.png" alt-text="Capture d’écran de l’élément de menu Applications dans le portail Azure.":::
