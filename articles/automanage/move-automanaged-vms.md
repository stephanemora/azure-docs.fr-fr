...
* Vérifiez que la région de votre espace de travail Log Analytics, celle de votre compte Automation et votre région cible sont toutes prises en charge par les mappages de régions disponibles [ici](https://docs.microsoft.com/azure/automation/how-to/region-mappings).
...
Pour plus d’informations sur le déplacement de machines virtuelles, consultez cet [article](https://docs.microsoft.com/azure/resource-mover/tutorial-move-region-virtual-machines).
