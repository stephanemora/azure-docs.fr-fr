...
ms.date: 02/22/2021
ms.author: deanwe
ms.openlocfilehash: d751fe3bb41ed90f6a05844fc3d8d3c2ee0a089a
ms.sourcegitcommit: a5dd9799fa93c175b4644c9fe1509e9f97506cc6
ms.translationtype: HT
ms.contentlocale: fr-FR
ms.lasthandoff: 04/28/2021
ms.locfileid: "108209538"
---
...
|-----------|---------------|----------------------|-------------------------|
|[Surveillance des insights de machine virtuelle](../azure-monitor/vm/vminsights-overview.md)    |Azure Monitor pour machines virtuelles surveille les performances et l’intégrité de vos machines virtuelles, y compris de leurs processus en cours d’exécution et de leurs dépendances vis-à-vis d’autres ressources. En savoir [plus](../azure-monitor/vm/vminsights-overview.md).    |Production    |Non    |
