---
title: Migrer les stratégies WAF pour Azure Application Gateway
description: Découvrez comment migrer des stratégies de pare-feu d’applications web Azure à l’aide d’Azure PowerShell.
...
## <a name="to-migrate-to-waf-policy-using-the-migration-script"></a>Pour migrer vers une stratégie WAF à l’aide du script de migration

Pour exécuter le script de migration, procédez comme suit : 

1. Ouvrez la fenêtre Cloud Shell suivante ou ouvrez-en une à partir du portail.
