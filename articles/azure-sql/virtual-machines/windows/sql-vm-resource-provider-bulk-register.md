...
- Les informations d’identification du client utilisées pour enregistrer les machines virtuelles existent dans chacun des rôles RBAC suivants : **Contributeur de machine virtuelle**, **Contributeur** ou **Propriétaire**. 
...
## <a name="resister-all-vms-in-a-resource-group"></a>Inscrire toutes les machines virtuelles dans un groupe de ressources
