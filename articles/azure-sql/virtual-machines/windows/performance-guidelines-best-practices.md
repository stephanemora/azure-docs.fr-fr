...
Cet article donne des conseils pour optimiser les performances de SQL Server dans la machine virtuelle Microsoft Azure.
...
Le lecteur de stockage temporaire, désigné par la lettre **D**, n’est pas persistant dans Stockage Blob Azure. Ne stockez pas vos fichiers de base de données utilisateur ou vos fichiers journaux des transactions utilisateur sur le lecteur **D**:.
