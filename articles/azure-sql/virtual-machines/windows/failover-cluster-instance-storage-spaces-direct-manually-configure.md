...
![La solution complète](./media/failover-cluster-instance-storage-spaces-direct-manually-configure/00-sql-fci-s2d-complete-solution.png)
...
1. Si vous utilisez l’une des images de machine virtuelle basée sur SQL Server, supprimez l’instance SQL Server.
   ...
   1. Supprimer toutes les fonctionnalités sous **Services Moteur de base de données**. Ne supprimez pas les **Fonctionnalités partagées**. Vous devez voir quelque chose de similaire à la capture d’écran suivante :
      ...
      ![Sélectionner les fonctionnalités](./media/failover-cluster-instance-storage-spaces-direct-manually-configure/03-remove-features.png)
...
1. Ajoutez du stockage à la machine virtuelle. Pour plus d’informations, consultez [Ajouter du stockage](../../../virtual-machines/linux/disks-types.md).
...
1. [Créez un volume](https://technet.microsoft.com/windows-server-docs/storage/storage-spaces/hyper-converged-solution-using-storage-spaces-direct#step-36-create-volumes).
   ...
   ![Volume partagé de cluster](./media/failover-cluster-instance-storage-spaces-direct-manually-configure/15-cluster-shared-volume.png)
...
1. Configurez l’équilibrage de charge avec :
 ...
 La capture d’écran suivante montre l’interface utilisateur **Créer un équilibreur de charge** :
   ...
   ![Configurer l’équilibreur de charge](./media/failover-cluster-instance-storage-spaces-direct-manually-configure/30-load-balancer-create.png)
