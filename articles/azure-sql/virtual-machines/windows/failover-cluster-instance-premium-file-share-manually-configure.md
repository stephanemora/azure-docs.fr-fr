...
Si vous ne l’avez pas déjà fait, configurez la connectivité à votre ICF avec un nom de réseau virtuel [et un équilibrage de charge Azure](hadr-vnn-azure-load-balancer-configure.md) ou [le nom de réseau distribué (DNN)](hadr-distributed-network-name-dnn-configure.md). 
