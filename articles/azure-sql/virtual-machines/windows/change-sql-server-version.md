...
- Les mises à niveau de version doivent suivre les [chemins de mise à niveau de support](/sql/database-engine/install-windows/supported-version-and-edition-upgrades-version-15).
