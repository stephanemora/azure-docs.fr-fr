...
- Une [machine virtuelle SQL Server](./create-sql-vm-portal.md) inscrite auprès du [fournisseur de ressources de machine virtuelle SQL](sql-vm-resource-provider-register.md).
