---
title: 'PowerShell : Synchroniser des données entre SQL Database et SQL Server'
description: Utilisez un exemple de script Azure PowerShell pour synchroniser des données entre Azure SQL Database et SQL Server.
...
ms.locfileid: "110693450"
---
# <a name="use-powershell-to-sync-data-between-sql-database-and-sql-server"></a>Utiliser PowerShell pour synchroniser des données entre SQL Database et SQL Server

[!INCLUDE[appliesto-sqldb](../../includes/appliesto-sqldb.md)]

Cet exemple Azure PowerShell configure SQL Data Sync pour synchroniser des données entre Azure SQL Database et SQL Server. 
...
- Créer une base de données dans une instance de SQL Server comme base de données membre
...
- Configurer Data Sync
    - Utiliser le portail Azure - [Tutoriel : Configurer SQL Data Sync pour synchroniser des données entre une base de données dans Azure SQL Database et une base de données SQL Server locale](../sql-data-sync-sql-server-configure.md)
    - Utiliser PowerShell - [Utiliser PowerShell pour synchroniser des données entre plusieurs bases de données dans Azure SQL Database](sql-data-sync-sync-data-between-sql-databases.md)
