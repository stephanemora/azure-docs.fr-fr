...
Utilisez le modèle [Créer ou mettre à jour](/rest/api/sql/syncgroups/createorupdate) pour créer un groupe de synchronisation.
...
Utilisez le modèle [Créer ou mettre à jour](/rest/api/sql/syncmembers/createorupdate) pour créer un membre de synchronisation.
...
Utilisez le modèle [Actualiser le schéma du hub](/rest/api/sql/syncgroups/refreshhubschema) pour actualiser le schéma de la base de données Hub. 
...
Utilisez le modèle [Lister les schémas du hub](/rest/api/sql/syncgroups/listhubschemas) pour lister le schéma de la base de données Hub. 

Utilisez le modèle [Actualiser le schéma du membre](/rest/api/sql/syncmembers/refreshmemberschema) pour actualiser le schéma de la base de données membre. 

Utilisez le modèle [Lister le schéma du membre](/rest/api/sql/syncmembers/listmemberschemas) pour lister le schéma de la base de données membre. 
...
Utilisez le modèle [Créer ou mettre à jour](/rest/api/sql/syncgroups/createorupdate) pour mettre à jour votre groupe de synchronisation.
...
Utilisez le modèle [Créer ou mettre à jour](/rest/api/sql/syncmembers/createorupdate) pour mettre à jour votre membre de synchronisation.
...
Utilisez le modèle [Déclencher une synchronisation](/rest/api/sql/syncgroups/triggersync) pour déclencher une opération de synchronisation.
