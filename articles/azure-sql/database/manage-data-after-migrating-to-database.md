...
|Avez des services de niveau intermédiaire qui doivent se connecter à SQL Database ou SQL Data Warehouse|Utilisez l’[authentification intégrée Azure AD](authentication-aad-configure.md).|
|||
