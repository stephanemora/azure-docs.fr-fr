...
- Pour plus d’informations sur le réglage des charges de travail de requête afin de réduire l’utilisation des ressources, consultez [Surveillance et réglage](monitoring-tuning-index.yml) et [Surveillance et réglage des performances](./monitor-tune-overview.md).
