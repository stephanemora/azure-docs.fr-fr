...
![Tableau de surveillance Data Sync](./media/sql-data-sync-monitor-sync/sync-monitoring-dashboard.png)
...
![Notifications Data Sync par e-mail](./media/sql-data-sync-monitor-sync/sync-email-notifications.png)
...
-   [Vue d’ensemble des bases de données SQL](../../sql-database/sql-database-technical-overview.md)
