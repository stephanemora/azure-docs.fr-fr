...
- [Déployer l’exemple d’application autonome SaaS Wingtip Tickets](../../sql-database/saas-standaloneapp-get-started-deploy.md)
- [Déployer l’application de base de données Wingtip Tickets SaaS par client](../../sql-database/saas-dbpertenant-get-started-deploy.md)
- [Déployer l’application de base de données multilocataire Wingtip Tickets SaaS](../../sql-database/saas-multitenantdb-get-started-deploy.md)
