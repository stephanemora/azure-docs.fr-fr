...
Découvrez-en plus sur l’[API de base de données unique Azure CLI](single-database-manage.md#azure-cli).
...
Découvrez-en plus sur l’[API SQL Managed Instance Azure CLI](../managed-instance/api-references-create-manage-instance.md#azure-cli-create-and-manage-managed-instances).
