...
Pour plus d’informations sur la manière d’utiliser des journaux Azure Monitor pour interroger et définir des alertes, consultez [Utiliser des règles d’alerte dans les journaux Azure Monitor](../../azure-monitor/alerts/alerts-metric.md).
