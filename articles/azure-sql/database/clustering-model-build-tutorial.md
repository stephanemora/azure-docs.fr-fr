...
* La deuxième partie de ce didacticiel part du principe que vous avez suivi la [**première partie**](clustering-model-prepare-data-tutorial.md) et ses conditions préalables.
...
![Graphique coudé](./media/clustering-model-build-tutorial/elbow-graph.png)
...
Les moyennes des quatre clusters sont fournies à partir des variables définies dans la [première partie](clustering-model-prepare-data-tutorial.md#separate-customers) :
...
> [Tutoriel : Déployer un modèle de clustering en R avec Azure SQL Database Machine Learning Services (préversion)](clustering-model-deploy-tutorial.md)
