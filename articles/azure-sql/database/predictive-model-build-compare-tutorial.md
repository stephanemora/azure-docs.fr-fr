...
* La deuxième partie de ce didacticiel part du principe que vous avez suivi la [**première partie**](predictive-model-prepare-data-tutorial.md) et ses conditions préalables.
...
![Comparaison des deux modèles](./media/predictive-model-build-compare-tutorial/compare-models.png)
...
> [Tutoriel : Déployer un modèle prédictif en R avec le moteur Machine Learning Services (préversion) d’Azure SQL Database](predictive-model-deploy-tutorial.md)
