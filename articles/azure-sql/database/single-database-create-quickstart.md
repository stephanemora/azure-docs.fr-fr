...
description: Créez une base de données unique dans Azure SQL Database à l’aide du portail Azure, de PowerShell ou de l’interface Azure CLI. Interrogez la base de données avec l’éditeur de requête dans le portail Azure.
