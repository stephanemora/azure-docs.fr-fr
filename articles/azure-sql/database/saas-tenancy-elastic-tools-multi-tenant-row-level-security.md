...
- [Modèles de conception pour les applications SaaS multilocataires avec Azure SQL Database](../../sql-database/saas-tenancy-app-design-patterns.md)
