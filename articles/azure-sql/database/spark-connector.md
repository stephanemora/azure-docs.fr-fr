...
Pour commencer, téléchargez le connecteur Spark depuis le [référentiel azure-sqldb-spark](https://github.com/microsoft/sql-spark-connector) sur GitHub.
