...
* La troisième partie de cette série de tutoriels suppose que vous avez préalablement effectué dans leur intégralité la [**première partie**](clustering-model-prepare-data-tutorial.md) et la [**deuxième partie**](clustering-model-build-tutorial.md).
...
Une fois ce tutoriel terminé, supprimez la base de données tpcxbb_1gb de votre serveur.
...
* [Tutoriel : Préparer des données pour entraîner un modèle prédictif en R avec Azure SQL Database Machine Learning Services (préversion)](predictive-model-prepare-data-tutorial.md)
