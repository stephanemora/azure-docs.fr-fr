...
Ce guide de démarrage rapide montre comment utiliser le [.NET Framework](https://dotnet.microsoft.com) et le code C# dans Visual Studio pour interroger une base de données dans Azure SQL ou Synapse SQL avec des instructions Transact-SQL.
