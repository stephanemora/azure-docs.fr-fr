...
Pour télécharger l’Agent de synchronisation des données, accédez à [Agent de synchronisation des données SQL](https://www.microsoft.com/download/details.aspx?id=27693).
