...
>
> Pour des limites de pool SQL dédiées Azure Synapse Analytics, consultez [Limites de capacité](/azure/synapse-analytics/sql-data-warehouse/sql-data-warehouse-service-capacity-limits) et [Limites de mémoire et de concurrence](/azure/synapse-analytics/sql-data-warehouse/memory-concurrency-limits).
