...
Spécifiez la propriété timezoneId dans votre [modèle Resource Manager](./create-template-quickstart.md) pour régler le fuseau horaire lors de la création de l'instance.
