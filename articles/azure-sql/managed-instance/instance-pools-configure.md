...
> [!NOTE]
> Pour vérifier les limites de nombre de bases de données par pool d’instances et d’instances gérées déployées dans le pool, consultez la section [Limites de ressources du pool d’instances](instance-pools-overview.md#resource-limitations).
