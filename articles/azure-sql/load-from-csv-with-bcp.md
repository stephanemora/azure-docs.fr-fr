...
Vous pouvez télécharger les utilitaires bcp et sqlcmd à partir de la [documentation sqlcmd Microsoft][https://docs.microsoft.com/sql/tools/sqlcmd-utility?view=sql-server-ver15 ].
