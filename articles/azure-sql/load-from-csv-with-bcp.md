...
Vous pouvez télécharger les utilitaires bcp et sqlcmd à partir de la [Documentation sqlcmd Microsoft](/sql/tools/sqlcmd-utility?view=sql-server-ver15&preserve-view=true).
