...
||Modèle d’achat vCore|[Modèle d’achat vCore](database/service-tiers-sql-database-vcore.md)|
...
|Niveau de service|De base, Standard, Premium, Usage général, Hyperscale, Critique pour l'entreprise|Pour les niveaux de service du modèle vCore, consultez [Niveaux de service SQL Database](database/service-tiers-sql-database-vcore.md#service-tiers). Pour les niveaux de service du modèle DTU, consultez [Modèle DTU](database/service-tiers-dtu.md#compare-the-dtu-based-service-tiers).|
|Niveau de calcul|Calcul serverless|[Calcul serverless](database/service-tiers-sql-database-vcore.md#compute-tiers)
||Calcul provisionné|[Calcul provisionné](database/service-tiers-sql-database-vcore.md#compute-tiers)
|Génération de calcul|Gen5, Série M, Série Fsv2, Série DC|[Génération du matériel](database/service-tiers-sql-database-vcore.md#hardware-generations)
...
|Modèle d'achat|Modèle d’achat vCore|[Modèle d’achat vCore](managed-instance/service-tiers-managed-instance-vcore.md)|
...
|Niveau de calcul|Calcul provisionné|[Calcul provisionné](managed-instance/service-tiers-managed-instance-vcore.md#compute-tiers)|
|Génération de calcul|Gen5|[Génération du matériel](managed-instance/service-tiers-managed-instance-vcore.md#hardware-generations)
