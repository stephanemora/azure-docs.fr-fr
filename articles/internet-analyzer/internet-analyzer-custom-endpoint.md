...
2. Dans votre application web personnalisée, déployez l’image de test dans un chemin d’accès accessible publiquement. Le chemin d’accès doit fonctionner sur HTTPS. 
