...
Vous pouvez modifier la taille du pool de capacité de 1 TIO incrémente ou décrémente. Toutefois, la taille de pool de capacité ne peut pas être inférieure à 4 To. Le redimensionnement du pool de capacités change la capacité Azure NetApp Files achetée.
