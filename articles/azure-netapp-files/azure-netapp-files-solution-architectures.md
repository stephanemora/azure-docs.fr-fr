...
## <a name="azure-high-performance-computing-hpc-solutions"></a>Solutions de calcul haute performance (HPC) Azure
...
## <a name="azure-kubernetes-service-aks-solutions"></a>Solutions Azure Kubernetes Service (AKS)

* [Intégration de Azure NetApp Files à AKS](https://github.com/andyzhangx/demo/tree/master/linux/nfs)
* [Intégrer Azure NetApp Files à Azure Kubernetes Service](https://docs.microsoft.com/azure/aks/azure-netapp-files)

## <a name="oracle-database-solutions"></a>Solutions de base de données Oracle
...
* [Avantages de l’utilisation d’Azure NetApp Files avec Oracle Database](https://docs.microsoft.com/azure/azure-netapp-files/solutions-benefits-azure-netapp-files-oracle-database)

## <a name="sap-application-solutions"></a>Solutions d’application SAP 
...
## <a name="global-file-caching-solutions"></a>Solutions globales de mise en cache de fichiers
...
## <a name="windows-virtual-desktopvdi-solutions"></a>Windows Virtual Desktop/solutions VDI
