...
L’exemple de script suivant crée un espace de travail et configure plusieurs sources de données. Ces sources de données sont requises uniquement si vous analysez des machines virtuelles à l’aide de l’[agent Log Analytics](../agents/log-analytics-agent.md).
