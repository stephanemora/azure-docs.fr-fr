...
* Utiliser des [recherches de journal dans Log Analytics](../../log-analytics/log-analytics-queries.md) pour afficher des données détaillées de Surface Hub.
