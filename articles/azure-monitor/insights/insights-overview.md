...
Voir [Vue d’ensemble d’Azure Monitor pour conteneurs](./container-insights-overview.md).
...
Voir [Surveiller les groupes de ressources avec Azure Monitor (préversion)](./resource-group-insights.md).
