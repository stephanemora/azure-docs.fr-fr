...
- **Microsoft Monitoring Agent** : agent utilisé sur Windows et Linux pour exécuter le pack d’administration à partir de Microsoft System Center - Operations Manager (OM) et les solutions de supervision à partir d’Azure. Dans cette configuration, l’agent est connecté directement à Azure Monitor, sans être connecté à un groupe d’administration Operations Manager. 
...
-  **Stockage Azure** : solution recueillant des données à partir d’un compte Stockage Azure. 
...
| [Suivi des modifications](../../automation/change-tracking.md) | Windows |&#8226; |&#8226; | | |&#8226; |[varie](../../automation/change-tracking.md#change-tracking-and-inventory-data-collection) |
| [Suivi des modifications](../../automation/change-tracking.md) |Linux |&#8226; | | | | |[varie](../../automation/change-tracking.md#change-tracking-and-inventory-data-collection) |
...
| [Gestion des mises à jour](../../automation/automation-update-management.md) |  Windows |&#8226; |&#8226; | | |&#8226; |Au moins deux fois par jour et 15 minutes après l’installation d’une mise à jour |
