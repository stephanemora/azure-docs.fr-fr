...
Cet article décrit les détails de l’intégration et de l’utilisation de Service Map. Pour plus d’informations sur la configuration de la solution Service Map et l’intégration d’agents, consultez [Configuration de la solution Service Map dans Azure]( service-map-configure.md).
...
Consultez la [section Résolution des problèmes du document Configuration de la solution Carte de service]( service-map-configure.md#troubleshooting).
