...
- Vous êtes membre de la **[propriétaire](https://docs.microsoft.com/en-us/azure/role-based-access-control/built-in-role.md#owner)** rôle sur la ressource de cluster AKS. 
