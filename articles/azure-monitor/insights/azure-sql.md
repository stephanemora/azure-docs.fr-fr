...
### <a name="configure-azure-sql-databases-to-stream-diagnostics-telemetry"></a>Configurer des bases de données Azure SQL pour diffuser en continu la télémétrie de diagnostic
