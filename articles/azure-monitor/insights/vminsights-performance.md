...
- Les métriques sont uniquement disponibles pour les disques de données sur des machines virtuelles Linux utilisant la famille de systèmes de fichiers EXT (EXT2, EXT3, EXT4).
