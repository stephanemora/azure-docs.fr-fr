...
La solution Office 365 ne récupère pas de données des [agents Log Analytics](../../azure-monitor/platform/agent-data-sources.md).  Il récupère les données directement à partir d’Office 365.
