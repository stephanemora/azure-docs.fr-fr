...
* Génération d’alertes sur l’ensemble des compteurs de performances envoyés à Azure Monitor via la nouvelle [expérience d’alerte unifiée](../alerts/alerts-overview.md) dans Azure Monitor.
