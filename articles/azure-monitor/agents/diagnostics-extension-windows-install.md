...
6. Dans l’onglet **Journaux**, sélectionnez les journaux à collecter sur la machine virtuelle. Les journaux peuvent être envoyés au stockage ou à des Event Hubs, mais pas à Azure Monitor. Utilisez l’[agent Log Analytics ](../agents/log-analytics-agent.md) pour collecter des journaux d’invité et les envoyer à Azure Monitor.
