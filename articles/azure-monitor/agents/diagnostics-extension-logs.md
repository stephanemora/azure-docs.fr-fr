...
* [Collecter les journaux d’activité et les indicateurs de performance des services Azure](../essentials/resource-logs.md#send-to-log-analytics-workspace) pour les services pris en charge par Azure.
