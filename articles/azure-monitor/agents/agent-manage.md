...
Pour permettre à l’agent de communiquer avec le service via un serveur proxy ou une [passerelle Log Analytics](../platform/gateway.md) après le déploiement, utilisez l’une des méthodes suivantes.
