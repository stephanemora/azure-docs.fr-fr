...
![Requête simple](media/tutorial-viewdata/log-analytics-portal-eventlist-01.png)
...
![Filtrer](media/tutorial-viewdata/log-analytics-portal-eventlist-02.png)
...
![Menu Ajouter au filtre](media/tutorial-viewdata/log-analytics-portal-eventlist-03.png)
...
![Regrouper par ordinateur](media/tutorial-viewdata/log-analytics-portal-eventlist-04.png)
...
![Vue Table](media/tutorial-viewdata/log-search-portal-table-01.png)

Cliquez sur la flèche en regard d’un enregistrement pour afficher les détails de cet enregistrement.

![Trier les résultats](media/tutorial-viewdata/log-search-portal-table-02.png)

Pour trier sur un champ, cliquez sur son en-tête de colonne.

![Trier les résultats](media/tutorial-viewdata/log-search-portal-table-03.png)
...
![Filtrer les résultats](media/tutorial-viewdata/log-search-portal-table-04.png)
...
![Regrouper les résultats](media/tutorial-viewdata/log-search-portal-table-05.png)
...
![Données de performances](media/tutorial-viewdata/log-analytics-portal-perfsearch-01.png)
...
![Utilisation des processeurs](media/tutorial-viewdata/log-analytics-portal-perfsearch-02.png)
...
![Graphique de données de performances](media/tutorial-viewdata/log-analytics-portal-perfsearch-03.png)
...
![Graphique en courbes](media/tutorial-viewdata/log-analytics-portal-linechart-01.png)
...
> [Créer et partager des tableaux de bord Log Analytics](tutorial-logs-dashboards.md)
