...
2. Dans le volet **Vue d’ensemble**, cliquez sur l’icône de punaise pour ajouter la vignette au dernier tableau de bord que vous consultiez.  

    ![Épingler la chronologie d'ensemble](media/tutorial-app-dashboards/3overview.png)
...
2. Un graphique vide a déjà été créé, et vous êtes invité à ajouter une métrique.  Ajoutez une métrique au graphique, et éventuellement un filtre et un regroupement.  L’exemple ci-dessous présente le nombre de demandes de serveur regroupées par réussite.  Cela produit une vue dynamique des requêtes ayant réussi ou échoué.
    ...
    ![Ajouter une métrique](media/tutorial-app-dashboards/5sumserverrequests.png)
...
4. Sélectionnez **Épingler au tableau de bord** sur la droite. Cela a pour effet d’ajouter l’affichage au dernier tableau de bord que vous avez utilisé.
    ...
    ![Épingler un graphique de métrique](media/tutorial-app-dashboards/6sumserverrequests-pin.png)
...
4. Cette vignette est désormais ajoutée à votre tableau de bord. Sélectionnez **Modifier** pour modifier le positionnement de la vignette. Cliquez sur la vignette et faites-la glisser à sa position, puis cliquez sur **Personnalisation terminée**.
    ...
    ![Tableau de bord avec des mesures](media/tutorial-app-dashboards/7dashboard-edit2.png)
...
2. Cliquez sur **Analytics** en haut de l’écran pour ouvrir le portail Azure Log Analytics.
    ...
    ![Démarrer Azure Log Analytics](media/tutorial-app-dashboards/9analytics.png)
...
5. Cliquez sur l’icône d’épingle, puis sélectionnez le nom de votre tableau de bord. La raison pour laquelle vous devez sélectionner un tableau de bord contrairement aux étapes précédentes où le dernier tableau de bord était utilisé, est que la console Analytics est un service distinct qui doit opérer une sélection parmi tous les tableaux de bord partagés disponibles.
    ...
    ![Épingler une requête Analytics](media/tutorial-app-dashboards/10query.png)
...
6. Sélectionnez **Graphique**, puis choisissez l’option **Anneau** pour visualiser la sortie.
    ...
    ![Graphique Analytics](media/tutorial-app-dashboards/11querychart.png)
...
5. Sélectionnez l’icône de crayon sur chaque titre afin de leur donner un titre descriptif.

    ![Tableau de bord avec Analytics](media/tutorial-app-dashboards/12edit-title.png)
