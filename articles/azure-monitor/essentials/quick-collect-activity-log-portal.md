...
![Capture d’écran du portail Azure, montrant « espaces de travail log analytics » dans la zone de recherche et les espaces de travail Log Analytics sélectionnés sous Services.](../logs/media/quick-create-workspace/azure-portal-01.png)
