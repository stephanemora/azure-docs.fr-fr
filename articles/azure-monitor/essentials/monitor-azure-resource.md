...
Les ressources dans Azure génèrent les [journaux](../platform/data-platform-logs.md) et [métriques](../essentials/data-platform-metrics.md) affichés dans le schéma suivant. Reportez-vous à la documentation de chaque service Azure pour obtenir les données spécifiques qu’il génère et les autres solutions ou insights qu’il fournit.
