...
* Application Insights Web Auto 2.5.0-BETA ou version ultérieure
* Micrometer Azure Registry version 1.1.0 ou ultérieure
* [Ressource Application Insights](../../azure-monitor/app/create-new-resource.md )
...
2. Placer le fichier `ApplicationInsights.xml` dans le dossier Resources
