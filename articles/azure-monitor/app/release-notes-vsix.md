...
![Tendances Application Insights](./media/release-notes-vsix/Trends.png)
...
![Exceptions dans CodeLens](./media/release-notes-vsix/ExceptionsCodeLens.png)
...
![Prise en charge d’ASP.NET Core](./media/release-notes-vsix/NetCoreSupport.png)
...
![Prise en charge des outils de diagnostic](./media/release-notes-vsix/DiagnosticTools.png)
...
![Menu contextuel du projet pour les applications Windows universelles](./media/release-notes-vsix/UniversalContextMenu.png)
...
![Boîte de dialogue de chargement pour les applications Windows universelles](./media/release-notes-vsix/UniversalUploadDialog.png)
...
![Notification de chargement terminé](./media/release-notes-vsix/UploadComplete.png)
...
![Portail HockeyApp](./media/release-notes-vsix/HockeyAppPortal.png)

Pour plus d’informations sur la gestion des applications, voir la [Base de connaissances HockeyApp](https://support.hockeyapp.net/kb/app-management-2) .
...
![Menu contextuel du projet pour les applications Windows Forms](./media/release-notes-vsix/WinFormContextMenu.png)
...
![Boîte de dialogue de chargement pour les applications Windows Forms](./media/release-notes-vsix/WinFormsUploadDialog.png)
...
![Chargement terminé](./media/release-notes-vsix/LocalSearch.png)
...
![Notification de journalisation](./media/release-notes-vsix/LoggingToast.png)
...
![Rechercher une correspondance](./media/release-notes-vsix/FindMatch.png)
...
![Fenêtre Recherche](./media/release-notes-vsix/SearchWindow.png)
...
![Éléments connexes](./media/release-notes-vsix/RelatedItems.png)
...
![Retour](./media/release-notes-vsix/GoBAck.png)
...
![Cliquer sur les détails de l’exception](./media/release-notes-vsix/jumptocode.png)
...
![Rechercher dans l’Explorateur de solutions](./media/release-notes-vsix/searchentry.png)
...
![Notification de publication terminée](./media/release-notes-vsix/publishtoast.png)
...
![Fenêtre Recherche](./media/release-notes-vsix/search.png)
...
![Page Outils de diagnostic](./media/release-notes-vsix/diagtools.png)
...
![Boîte de dialogue Nouveau projet](./media/release-notes-vsix/newproject.png)
