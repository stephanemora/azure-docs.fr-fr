...
Vous pouvez automatiser la configuration des [alertes](../../azure-monitor/platform/alerts-log.md) dans [Application Insights](../../azure-monitor/app/app-insights-overview.md).
