...
Vous pouvez automatiser la configuration des [alertes](../../azure-monitor/app/alerts.md) dans [Application Insights](../../application-insights/app-insights-overview.md).
