...
Si vous ne disposez pas déjà d’un espace de travail Log Analytics, [consultez la documentation relative à la création d’un espace de travail Log Analytics](https://docs.microsoft.com/azure/azure-monitor/learn/quick-create-workspace).
...
- [Tâches en arrière-plan et applications console modernes (.NET/.NET Core)](https://docs.microsoft.com/azure/azure-monitor/app/worker-service)
- [Applications console classiques (.NET)](https://docs.microsoft.com/azure/azure-monitor/app/console) 
...
Pour obtenir la documentation Azure CLI complète pour cette commande, consultez la [documentation Azure CLI](https://docs.microsoft.com/cli/azure/ext/application-insights/monitor/app-insights/component?view=azure-cli-latest#ext-application-insights-az-monitor-app-insights-component-create).
