---
title: Exploration des journaux d’activité de trace Java dans Azure Application Insights (2.5.0-BETA) | Microsoft Docs
description: Recherche de suivi Log4J ou Logback dans Application Insights (2.5.0-BETA)
...
ms.locfileid: "68298193"
---
# <a name="explore-java-trace-logs-in-application-insights-250-beta"></a>Exploration du suivi des journaux d’activité Java dans Application Insights (2.5.0-BETA)
...
## <a name="note-if-you-are-using-the-application-insights-java-agent"></a>Remarque : Si vous utilisez l’agent Java Application Insights
