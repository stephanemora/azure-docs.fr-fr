...
2. Créez une ressource Application Insights et paramétrez le type d’application sur application web Java.
    ...
    ![Indiquez le nom, choisissez l’application web Java, puis cliquez sur Créer.](./media/java-live/02-create.png)
...
4. Ouvrez la nouvelle ressource et obtenez sa clé d’instrumentation. Vous devrez la coller rapidement dans le code de votre projet.
    ...
    ![Dans la nouvelle vue d'ensemble des ressources, cliquez sur Propriétés et copiez la clé d'instrumentation.](./media/java-live/03-key.png)
...
Vous devrez peut-être [définir des exceptions pour envoyer les données sortantes](../../azure-monitor/app/ip-addresses.md).
...
![Exemples de données](./media/java-live/5-results.png)
...
[En savoir plus sur les mesures.](../../azure-monitor/app/metrics-explorer.md)

## <a name="next-steps"></a>Étapes suivantes
* [Ajoutez la télémétrie à vos pages web](javascript.md) pour surveiller les affichages de pages et les mesures relatives à l’utilisateur.
* [Configurez les tests web](../../azure-monitor/app/monitor-web-app-availability.md) pour vous assurer que votre application est bien active.
* [Capture le suivi des journaux](java-trace-logs.md)
* [Recherchez les événements et les journaux](../../azure-monitor/app/diagnostic-search.md) pour diagnostiquer les problèmes.
