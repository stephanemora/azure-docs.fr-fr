---
title: Analytique d’une application web Java avec Azure Application Insights (2.5.0-BETA) | Microsoft Docs
description: 'Analyse des performances des applications pour les applications web Java à l’aide d’Application Insights (2.5.0-BETA). '
...
ms.locfileid: "68494467"
---
# <a name="get-started-with-application-insights-in-a-java-web-project-250-beta"></a>Prise en main d’Application Insights dans un projet web Java (2.5.0-BETA)
...
[Installez l’agent Java](java-agent-25-beta.md) pour capturer les appels HTTP sortants, les requêtes JDBC, la journalisation des applications et une meilleure appelation des opérations.
