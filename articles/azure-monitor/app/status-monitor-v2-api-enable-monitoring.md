...
---
# <a name="status-monitor-v2-api-enable-applicationinsightsmonitoring-v021-alpha"></a>API Status Monitor v2 : Enable-ApplicationInsightsMonitoring (v0.2.1-alpha)
