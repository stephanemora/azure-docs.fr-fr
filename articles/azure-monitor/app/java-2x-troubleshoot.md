...
* Avez-vous configuré l’agent Java en suivant les instructions de la section [Configure Java Agent](java-2x-agent.md) (Configurer l’agent Java) ?
...
Pour activer la journalisation de l’Agent JVM, mettez à jour le [fichier AI-Agent.xml](java-2x-agent.md) :
