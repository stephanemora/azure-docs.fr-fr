...
Vous pouvez configurer [Application Insights](../../azure-monitor/app/app-insights-overview.md) pour analyser un large éventail d’applications ou de rôles d’applications, de composants ou de microservices. Pour les services et applications web, Visual Studio permet un [configuration en une seule étape](../../azure-monitor/app/asp-net.md). Pour les autres types d’application .NET, telles que les rôles de serveur principal ou les applications de bureau, vous pouvez configurer Application Insights manuellement.

![Exemples de graphiques d’analyse des performances](./media/windows-services/10-perf.png)
...
![Cliquez sur Nouveau > Application Insights](./media/windows-services/01-new-asp.png)
...
![Cliquez sur Propriétés, sélectionnez la clé et appuyez sur Ctrl + C](./media/windows-services/02-props-asp.png)
...
1. Dans Visual Studio, cliquez avec le bouton droit sur votre projet et choisissez **Gérer les packages NuGet**.
    ...
    ![Cliquez avec le bouton droit sur le projet et sélectionnez Gérer les packages NuGet](./media/windows-services/03-nuget.png)
2. Installez le package Application Insights pour applications Windows server, « Microsoft.ApplicationInsights.WindowsServer ».
   
    ![Recherchez « Application Insights »](./media/windows-services/04-ai-nuget.png)
...
Ile est utile de définir la clé d’instrumentation dans le code si vous voulez [changer la clé pour différentes configurations de build](../../azure-monitor/app/separate-resources.md). Si vous définissez la clé dans le code, vous n’êtes pas obligé de la définir dans le fichier `.config`.
...
![Nombre d’événements dans Visual Studio](./media/windows-services/appinsights-09eventcount.png)
...
![Cliquez sur d'autres éléments pour afficher plus de données](./media/windows-services/12-first-perf.png)

Cliquez sur un des graphiques pour afficher des mesures plus détaillées. [En savoir plus sur les mesures.](../../azure-monitor/app/web-monitor-performance.md)
...
* Consultez la rubrique [Résolution des problèmes](../../azure-monitor/app/troubleshoot-faq.md).
...
![Publier votre application à l’aide de Visual Studio](./media/windows-services/15-publish.png)
