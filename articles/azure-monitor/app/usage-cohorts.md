---
title: Cohortes d’utilisation Application Insights | Microsoft Docs
...
:::image type="content" source="./media/usage-cohorts/cohort-2.png" alt-text="Capture d’écran de la liste déroulante Afficher, affichant une cohorte.":::
...
1. Ouvrez l’outil Cohortes, sélectionnez l’onglet **Galerie des modèles**, puis sélectionnez **Cohorte d’utilisateurs vide**.
   ...
   :::image type="content" source="./media/usage-cohorts/cohort.png" alt-text="Capture d’écran de la Galerie de modèles pour les cohortes." lightbox="./media/usage-cohorts/cohort.png":::
   ...
   * Une section de requête que vous utilisez pour définir la cohorte à l’aide d’une requête analytique.
     ...
     > [!NOTE]
     > Si la requête n’apparaît pas, essayez de redimensionner la section pour l’agrandir et afficher la requête. 
