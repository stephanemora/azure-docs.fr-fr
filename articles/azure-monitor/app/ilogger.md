...
*5. Quel type de données de télémétrie Application Insights est généré à partir de `ILogger` journaux ? ou où puis-je voir `ILogger` journaux dans Application Insights ?*
