...
Vous pouvez interroger la liste des adresses IP utilisées par les groupes d’actions à l’aide de la [commande PowerShell Get-AzNetworkServiceTag](https://docs.microsoft.com/powershell/module/az.network/Get-AzNetworkServiceTag).
