...
6. Définissez une valeur égale ou supérieure à 3 pour les emplacements incorrects. Créez un [groupe d’actions](../alerts/action-groups.md) pour configurer les personnes à informer si votre seuil d’alerte est dépassé.
