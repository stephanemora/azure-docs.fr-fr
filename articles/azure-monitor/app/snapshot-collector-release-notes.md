...
- Correction du bogue qui provoquait le blocage de SnapshotUploader.exe, l’empêchant de charger les captures instantanées pour les applications .NET Core.
