...
[Ce](/aspnet/core/fundamentals/host/hosted-services?tabs=visual-studio&view=aspnetcore-2.2) document décrit la façon de créer des tâches en arrière-plan dans une application ASP.NET Core 2.1/2.2.
