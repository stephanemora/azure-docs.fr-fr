---
title: Surveillance des performances des applications web Java dans Azure Application Insights (2.5.0-BETA) | Microsoft Docs
description: Surveillance étendue des performances et de l’utilisation de votre site web Java avec Application Insights (2.5.0-BETA).
...
Clé : Valeur `JAVA_OPTS` : `-javaagent:D:/home/site/wwwroot/applicationinsights-agent-2.5.0-BETA.jar`
