...
5. **Modifier le tableau de bord** : Pointez sur une vignette, puis utilisez sa barre supérieure pour déplacer, personnaliser ou supprimer la vignette.
...
* Intervalle de temps jusqu’à 1 heure : actualiser toutes les 5 minutes
* Intervalle de temps entre 1 et 24 heures : actualiser toutes les 15 minutes
...
* [**Metrics Explorer**](../../azure-monitor/app/metrics-explorer.md) : créez vos propres graphiques sur les performances et l’utilisation.
...
* [**Script d’automatisation**](../../azure-monitor/app/powershell.md) : exportez une définition de la ressource Azure afin de l’utiliser comme modèle pour créer d’autres ressources.
...
|  |  |
| --- | --- |
| [Metrics Explorer](../../azure-monitor/app/metrics-explorer.md)<br/>Filtrez et segmentez les mesures. |![Exemple de recherche](./media/app-insights-dashboards/64.png) |
| [Recherche de diagnostic](../../azure-monitor/app/diagnostic-search.md)<br/>Recherchez et examinez des événements, ainsi que les événements associés, et créez des bogues. |![Exemple de recherche](./media/app-insights-dashboards/61.png) |
| [Analytics](../../azure-monitor/app/analytics.md)<br/>Tirez parti d’un puissant langage de requête. |![Exemple de recherche](./media/app-insights-dashboards/63.png) |
