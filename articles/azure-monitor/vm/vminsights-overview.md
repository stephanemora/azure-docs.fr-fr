...
- [Création d’un espace de travail Log Analytics](../insights/vminsights-configure-workspace.md#create-log-analytics-workspace)
- [Ajout de la solution VMInsights à l’espace de travail](../insights/vminsights-configure-workspace.md#add-vminsights-solution-to-workspace)
- [Installation des agents sur la machine virtuelle et le groupe de machines virtuelles identiques à superviser](../insights/vminsights-enable-overview.md)



## <a name="next-steps"></a>Étapes suivantes

- Pour connaître les exigences et les méthodes permettant la supervision des machines virtuelles, consultez [Déploiement d’Azure Monitor pour machines virtuelles](../insights/vminsights-enable-overview.md).
