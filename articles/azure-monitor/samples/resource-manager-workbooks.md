...
Les classeurs pouvant être complexes, une stratégie classique consiste à créer le classeur dans le portail Azure puis à générer un modèle Resource Manager. Consultez les détails de cette méthode dans [Modèle Azure Resource Manager pour le déploiement de classeurs](../platform/workbooks-automate.md).
...
* [En savoir plus sur les groupes d’actions](../platform/workbooks-overview.md).
