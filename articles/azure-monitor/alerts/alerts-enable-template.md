---
title: 'Modèle Resource Manager : créer une alerte de métrique'
...
* [Ajout de paramètres de diagnostic](../essentials/resource-manager-diagnostic-settings.md) à votre modèle Resource Manager
