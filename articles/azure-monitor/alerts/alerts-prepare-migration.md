...
1. Utilisez le modèle « Azure Monitor - Metrics Alert Handler ». Ce modèle comporte un déclencheur de **requête HTTP** avec le schéma approprié défini.
    ...
    ![Capture d’écran montrant deux boutons, Application logique vide et Azure Monitor – Metrics Alert Handler.](media/alerts-prepare-migration/logic-app-template.png "Modèle d’alerte de métrique")
