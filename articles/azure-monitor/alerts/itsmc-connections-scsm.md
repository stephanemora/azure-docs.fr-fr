...
2. Sous **SOURCES DE DONNÉES DE L’ESPACE DE TRAVAIL** dans le volet gauche, cliquez sur **Connexions ITSM**.
    ...
    ![Nouvelle connexion](media/itsmc-connections-scsm/add-new-itsm-connection.png)
...
![Connexion Service Manager](media/itsmc-connections-scsm/service-manager-connection.png)
...
3. Sous **Connexions hybrides**, cliquez sur **Configurer vos points de terminaison de connexion hybride**.
    ...
    ![Mise en réseau de connexions hybrides](media/itsmc-connections-scsm/itsmc-hybrid-connection-networking-and-end-points.png)
4. Dans le panneau **Connexions hybrides**, cliquez sur **Ajouter une connexion hybride**.

    ![Ajout d’une connexion hybride](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-add.png)

5. Dans le panneau **Ajouter des connexions hybrides**, cliquez sur **Créer une connexion hybride**.

    ![Nouvelle connexion hybride](media/itsmc-connections-scsm/itsmc-create-new-hybrid-connection.png)
...
6. Tapez les valeurs suivantes :
   ...
   - **Name** : Spécifiez un nom pour le Servicebus si vous le créez.
     ...
     ![Valeurs de connexion hybride](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-values.png)
...
7. Une fois la connexion hybride créée, sélectionnez-la, puis cliquez sur **Ajouter la connexion hybride sélectionnée**.
    ...
    ![Nouvelle connexion hybride](media/itsmc-connections-scsm/itsmc-new-hybrid-connection-added.png)
...
![Connexion hybride réussie](media/itsmc-connections-scsm/itsmc-hybrid-connection-listener-set-up-successful.png)
> [!NOTE]
> 
...
![Test de connexion hybride](media/itsmc-connections-scsm/itsmc-hybrid-connection-test.png)
