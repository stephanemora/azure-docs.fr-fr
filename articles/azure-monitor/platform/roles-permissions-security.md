...
* Requête de mesures avec l’[API REST Azure Monitor](https://msdn.microsoft.com/library/azure/dn931930.aspx), les [applets de commande PowerShell](../../monitoring-and-diagnostics/insights-powershell-samples.md) ou le [CLI multiplateforme](../../azure-monitor/platform/cli-samples.md).
...
* Afficher le [profil de journalisation](../../monitoring-and-diagnostics/monitoring-overview-activity-logs.md#export-the-activity-log-with-a-log-profile) pour un abonnement.
...
* Définir le [profil de journal](../../monitoring-and-diagnostics/monitoring-overview-activity-logs.md#export-the-activity-log-with-a-log-profile) pour un abonnement.*
