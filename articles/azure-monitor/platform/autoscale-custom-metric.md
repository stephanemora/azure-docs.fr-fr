...
l’environnement de service d’intégration et aux [services Gestion des API](https://docs.microsoft.com/azure/api-management/api-management-key-concepts).
