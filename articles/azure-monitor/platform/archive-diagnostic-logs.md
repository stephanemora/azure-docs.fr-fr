...
| Catégorie |Non |Liste séparée par des virgules des catégories de journaux à activer. |
...
| RetentionInDays |Non |Nombre de jours pendant lesquels les événements doivent être conservés, compris entre 1 et 365. Une valeur de zéro signifie que les journaux d’activité seront stockés pour une durée indéfinie. |
...
* [Archive Azure Active Directory logs with Azure Monitor](../../active-directory/reports-monitoring/quickstart-azure-monitor-route-logs-to-storage-account.md) (Archivage des journaux d’activité Azure Active Directory avec Azure Monitor)
