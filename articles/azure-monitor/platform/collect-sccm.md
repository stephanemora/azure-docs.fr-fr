...
7. Dans Log Analytics, affichez les données de Configuration Manager en tant que [groupes d’ordinateurs](../../azure-monitor/platform/computer-groups.md).
...
1. Dans le portail Azure, cliquez sur **Tous les services** en haut à gauche. Dans la liste de ressources, saisissez **Log Analytics**. Au fur et à mesure de la saisie, la liste est filtrée. Sélectionnez **Log Analytics**.<br><br> ![Portail Azure](media/collect-sccm/azure-portal-01.png)<br><br>  
...
3. Sélectionnez **Paramètres avancés**.<br><br> ![Paramètres avancés de Log Analytics](media/collect-sccm/log-analytics-advanced-settings-01.png)<br><br>  
