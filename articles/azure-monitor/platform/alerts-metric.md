...
- [Comprendre le schéma des webhooks pour les alertes de métrique](../../monitoring-and-diagnostics/monitoring-near-real-time-metric-alerts.md#payload-schema)
