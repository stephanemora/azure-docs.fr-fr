...
Vous pouvez récupérer les enregistrements d’alerte de Nagios et Zabbix à l’aide des [recherches dans les journaux](../../log-analytics/log-analytics-queries.md) dans Log Analytics.
