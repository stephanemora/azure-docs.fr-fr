...
Coût d’exportation : Payé comme indiqué dans la section Journaux de plateforme de la [page Tarification Azure Monitor](https://azure.microsoft.com/pricing/details/monitor/). 
