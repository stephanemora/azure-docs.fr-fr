...
| Données | Description |
|:---|:---|
| Diagnostics de ressources | Configurer les paramètres de diagnostic pour écrire des données de diagnostic, dont des métriques, dans un espace de travail Log Analytics. Voir [Diffuser en continu les journaux de diagnostic Azure vers Log Analytics](diagnostic-logs-stream-log-store.md). |
