...
1. Dans le portail, cliquez sur le lien **Journal d’activité** dans le volet de navigation de gauche. Si vous ne voyez pas de lien pour le journal d’activité, cliquez d’abord sur le lien **Tous les services**.
    ...
    ![Accéder au panneau Journal d’activité](media/archive-activity-log/activity-logs-portal-navigate-v2.png)
2. En haut du panneau, cliquez sur **Exporter vers Event Hub**.
   
    ![Cliquer sur le bouton Exporter](media/archive-activity-log/activity-logs-portal-export-v2.png)
3. Dans le panneau qui s’affiche, cochez la case pour **exporter vers un compte de stockage** et sélectionnez un compte de stockage.
    ...
    ![Créer un compte de stockage](media/archive-activity-log/act-log-portal-export-blade.png)
...
| RetentionInDays |Non  |Nombre de jours pour les événements doivent être conservés, compris entre 1 et 365. Une valeur de zéro signifie que les journaux seront stockés pour une durée indéfinie (pour toujours). |
...
| days |Oui |Nombre de jours pour les événements doivent être conservés, compris entre 1 et 365. Une valeur de zéro signifie que les journaux seront stockés pour une durée indéfinie (pour toujours).  Si zéro est spécifié, le paramètre activé doit être défini sur true. |
...
* [Transférer le journal d’activité vers Event Hubs](../../azure-monitor/platform/activity-logs-stream-event-hubs.md)
