...
ms.locfileid: "77658725"
---
# <a name="view-designer-conversion-examples"></a>Concepteur de vues - Exemples de conversions en classeurs

Pour répliquer le classeur à onglets du concepteur de vues, copiez et collez le code suivant dans l'éditeur avancé, signalé par le symbole </> dans la barre d'outils

![Barre d'outils de l'éditeur avancé](media/view-designer-conversion-examples/toolbar.png)

Les utilisateurs devront peut-être mettre à jour leurs paramètres de requête et leurs abonnements en fonction de leurs ressources accessibles.
