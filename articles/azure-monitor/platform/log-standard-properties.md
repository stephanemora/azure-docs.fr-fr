...
- En savoir plus sur le stockage des [données Log Analytics](../log-query/log-query-overview.md).
- Obtenez une leçon sur l’[écriture de requêtes dans Log Analytics](../../azure-monitor/log-query/get-started-queries.md).
- Obtenez une leçon sur l’[association de tables dans Log Analytics](../../azure-monitor/log-query/joins.md).
