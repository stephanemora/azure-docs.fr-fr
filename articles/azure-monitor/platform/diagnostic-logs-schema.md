...
| Base de données SQL | [Journalisation d’Azure SQL Database](../../sql-database/sql-database-metrics-diag-logging.md) |
...
|Microsoft.Databricks/workspaces|bloc-notes|Databricks Notebook|
...
* [En savoir plus sur les journaux de ressources](../../azure-monitor/platform/resource-logs-overview.md)
