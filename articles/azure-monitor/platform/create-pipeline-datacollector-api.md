...
En savoir plus sur [l’API Collecte de données](../../azure-monitor/platform/data-collector-api.md) pour écrire des données dans Log Analytics à partir de n’importe quel client API REST.
