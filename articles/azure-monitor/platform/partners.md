...
![Logo de AppDynamics](./media/partners/appdynamics.png)
...
![Logo d’Atlassian](./media/partners/atlassian.png)
...
![Logo de Circonus](./media/partners/circonus.png)
...
![Logo de CloudHealth](./media/partners/cloudhealth.png)
...
![Logo de DataDog](./media/partners/datadog.png)
...
![Logo élastique](./media/partners/elastic.png)
...
![Logo de Grafana](./media/partners/grafana.png)
...
![Logo d’analyse logique](./media/partners/logicmonitor.png)
...
![Logo de NewRelic](./media/partners/newrelic.png)
...
![Logo de PagerDuty](./media/partners/pagerduty.png)
...
![Logo de ScienceLogic](./media/partners/sciencelogic.png)
...
![Logo de Serverless360](./media/partners/serverless360.png)

Serverless360 est un outil d’une plateforme à exploiter, gérer et surveiller les composants sans serveur Azure. La facilité de gestion est un des principaux défis avec des implémentations sans serveur. Des centaines de petits services discrets sans serveur sont répartis dans divers emplacements : gestion et d’exploitation de telles solutions sont complexe. Serverless360 résout ces problèmes avec un riche ensemble d’outils sophistiqués. Il peut surveiller les services sans serveur comme Azure Functions, Logic Apps, grilles d’événements, files d’attente de Service Bus, rubriques, relais, Event Hubs, stockage files d’attente, fichiers, objets blob et tables. Serverless360 est disponible dans la place de marché Azure. Ces fonctionnalités sont disponibles sur SaaS et hébergement privé (hébergé sur votre propre environnement).  
...
![Logo de Splunk](./media/partners/splunk.png)
...
![Logo de Turbonomic](./media/partners/Turbonomic.png)
...
[influxdata-doc]: ./../../azure-monitor/platform/collect-custom-metrics-linux-telegraf.md "Données d’analyse afflux Azure Telegraf intégration."
...
[serverless360-doc]: https://docs.serverless360.com/docs/associating-service-principals "Documentation de Serverless360."
