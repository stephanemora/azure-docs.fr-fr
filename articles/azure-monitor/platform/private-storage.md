...
- A explicitement autorisé Log Analytics à lire les journaux à partir du compte de stockage en sélectionnant *Autoriser les services MS approuvés à accéder à ce compte de stockage*.
...
## <a name="api-request-values"></a>Valeurs de requête d’API
...
## <a name="get-current-links"></a>Obtenir les liaisons actuelles
...
### <a name="get-all-linked-storage-accounts"></a>Obtenir tous les comptes de stockage liés
