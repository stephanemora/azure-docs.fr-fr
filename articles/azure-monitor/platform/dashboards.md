...
![Exemple de tableau de bord](./media/dashboards/oms-dashboards-example-dash.png)
...
* [Application mobile OMS de la Boutique Microsoft ](https://www.windowsphone.com/store/app/operational-insights/4823b935-83ce-466c-82bb-bd0a3f58d865)
* [Application mobile OMS d’Apple iTunes](https://itunes.apple.com/app/microsoft-operations-management/id1042424859?mt=8)

![Tableau de bord mobile](./media/dashboards/oms-search-mobile.png)
...
![Vue d’ensemble](./media/dashboards/oms-dashboards-overview.png)
...
![Représentation graphique](./media/dashboards/oms-dashboards-pictorial01.png)
...
![Ajout de vignettes 1](./media/dashboards/oms-dashboards-pictorial02.png)

Lorsque vous cliquez sur le signe **plus**, une nouvelle vignette s’affiche dans la vue Mon tableau de bord.

![Ajout de vignettes 2](./media/dashboards/oms-dashboards-pictorial03.png)
...
![Modification d'une vignette](./media/dashboards/oms-dashboards-pictorial04.png)

![Modification d'une vignette](./media/dashboards/oms-dashboards-pictorial05.png)
...
| --- | --- |
| ![Graphique à barres](./media/dashboards/oms-dashboards-bar-chart.png) |Affiche une chronologie des résultats de vos recherches de journal enregistrées sous forme de graphique à barres, ou une liste de résultats en fonction d’un champ, selon que votre recherche de journal regroupe les résultats par champ ou non. |
| ![métrique](./media/dashboards/oms-dashboards-metric.png) |Affiche le nombre total d'accès à vos résultats de recherche de journal sous la forme d'un nombre dans une vignette. Les vignettes de métrique vous permettent de définir un seuil qui met en surbrillance la vignette lorsque ce seuil est atteint. |
| ![line](./media/dashboards/oms-dashboards-line.png) |Affiche une chronologie de vos résultats de recherche journal enregistrés, avec des valeurs représentées sous la forme d’un graphique en courbes. |
...
![Organisation de votre tableau de bord](./media/dashboards/oms-dashboards-organize.png)
...
![Suppression d'une vignette](./media/dashboards/oms-dashboards-remove-tile.png)

## <a name="next-steps"></a>Étapes suivantes
* Créez des [alertes](../../azure-monitor/platform/alerts-overview.md) dans Log Analytics pour générer des notifications et corriger les problèmes.
