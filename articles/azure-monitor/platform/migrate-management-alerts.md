...
> [!WARNING]
> Les alertes pour les événements de gestion seront désactivées à partir du 1er octobre 2017. Utilisez les instructions ci-dessous pour déterminer si vous avez ce type d’alertes et migrez-les le cas échéant.
...
* En exécutant le cmdlet Add-AzLogAlertRule PowerShell
