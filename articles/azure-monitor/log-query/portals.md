...
![Portail Analytics avancé](media/portals/advanced-analytics-portal.png)
...
![Page Recherche dans les journaux](media/portals/log-search-portal.png)


## <a name="next-steps"></a>Étapes suivantes

- Pour en savoir plus sur la façon de créer des requêtes à l’aide du langage de requête, lisez un didacticiel sur l’utilisation de la page [Recherche dans les journaux](../../azure-monitor/learn/tutorial-viewdata.md)
- Passez en revue une [leçon utilisant le portail Analytics avancé](../../azure-monitor/log-query/get-started-portal.md), qui fournit la même expérience que la page Log Analytics.
