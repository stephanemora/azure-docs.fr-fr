---
title: Configurer et approuver l’accès juste à temps pour les applications managées Azure
...
1. Recherchez une entrée de Place de marché pour une application managée avec JAT activé. Sélectionnez **Créer**.
