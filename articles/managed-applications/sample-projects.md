...
| [Application web managée (IaaS) avec services de gestion Azure et coffre de clés](https://github.com/Azure/azure-managedapp-samples/tree/master/samples/201-managed-web-app-using-keyvault) | Déploie une machine virtuelle qui héberge une application web. Il référence un coffre de clés pour le mot de passe d’administrateur. |
