---
title: Référence d’artefact du modèle d’application managée Azure
...
ms.locfileid: "72528938"
---
# <a name="reference-deployment-template-artifact"></a>Référence : Artefact de modèle de déploiement

Cet article est une référence pour un artefact *mainTemplate.json* dans des applications managées Azure. Pour plus d’informations sur la création du modèle de déploiement, consultez [Modèles Azure Resource Manager](../azure-resource-manager/resource-group-authoring-templates.md).
