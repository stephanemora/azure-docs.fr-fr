---
title: Déployer des associations pour un fournisseur personnalisé Azure avec une stratégie
...
![Attribuer une stratégie intégrée](media/builtin-policy/assign-builtin-policy-customprovider.png)
