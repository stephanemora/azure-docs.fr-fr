...
# <a name="azure-clitabazurecli-interactive"></a>[Interface de ligne de commande Azure](#tab/azurecli-interactive)
...
2. Dans le **Centre d’applications managées**, choisissez **Définition d’application du catalogue de services**, puis cliquez sur **Ajouter**. 
    ...
    ![Ajouter un catalogue de services](./media/managed-application-with-custom-providers/service-catalog-managed-application.png)
...
3. Fournissez des valeurs pour créer une définition de catalogue de services :
    ...
    * Pour **URI du fichier de package** , indiquez le chemin du fichier zip que vous avez créé à l’étape précédente.
    ...
    ![Fournir des valeurs](./media/managed-application-with-custom-providers/add-service-catalog-managed-application.png)

4. Lorsque vous accédez à la section Authentification et niveau de verrouillage, sélectionnez **Ajouter une autorisation**.

    ![Ajouter une autorisation](./media/managed-application-with-custom-providers/add-authorization.png)

5. Choisissez un groupe Azure Active Directory pour gérer les ressources, puis sélectionnez **OK**.

   ![Ajouter un groupe d’autorisations](./media/managed-application-with-custom-providers/add-auth-group.png)

6. Après avoir fourni toutes les valeurs, sélectionnez **Créer**.

   ![Créer la définition d’application gérée](./media/managed-application-with-custom-providers/create-service-catalog-definition.png)
...
2. Dans le **Centre d’applications managées**, choisissez **Applications du catalogue de services**, puis cliquez sur **Ajouter**. 
    ...
    ![Ajouter l’application managée](./media/managed-application-with-custom-providers/add-managed-application.png)
...
3. Dans la page **Applications du catalogue de services**, tapez le nom complet de la définition du catalogue de services dans la zone de recherche. Sélectionnez la définition créée à l’étape précédente, puis cliquez sur **Créer**.
    ...
    ![Sélectionner Catalogue de services](./media/managed-application-with-custom-providers/select-service-catalog-definition.png)
...
4. Fournissez des valeurs pour créer une instance d’application managée à partir de la définition du catalogue de services :
    ...
    * Spécifiez un nom de fonction Azure unique et un nom de compte Stockage Azure.
    ...
    ![Paramètres de l’application](./media/managed-application-with-custom-providers/application-settings.png)

5. Quand la validation a réussi, cliquez sur **OK** pour déployer une instance d’une application managée. 
    
    ![Déployer une application managée](./media/managed-application-with-custom-providers/deploy-managed-application.png)
...
![Groupes de ressources d’application](./media/managed-application-with-custom-providers/application-resource-groups.png)
...
![Effectuer une action personnalisée](./media/managed-application-with-custom-providers/perform-custom-action.png)
...
![Créer une ressource personnalisée](./media/managed-application-with-custom-providers/create-custom-resource.png)

* Accédez à la page « Users », sélectionnez une ressource « users » et cliquez sur « Custom Context Action » :

![Créer une ressource personnalisée](./media/managed-application-with-custom-providers/perform-custom-resource-action.png)
