---
title: Intégration des ressources des fournisseurs personnalisés Azure
...
L’intégration des ressources des fournisseurs personnalisés Azure est un modèle d’extensibilité pour les types de ressources Azure. Elle vous permet d’appliquer des opérations ou une gestion à des ressources Azure existantes à l’échelle. Pour plus d’informations, consultez [Comment les fournisseurs personnalisés Azure peuvent étendre Azure](./custom-providers-overview.md). Cet article aborde les points suivants :
