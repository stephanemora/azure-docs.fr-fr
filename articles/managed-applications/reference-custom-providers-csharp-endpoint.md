...
Cet article est une référence de base sur le point de terminaison RESTful C# de fournisseur personnalisé. Si vous ne savez pas encore ce qu’est un fournisseur personnalisé Azure, consultez la [vue d’ensemble des fournisseurs de ressources personnalisés](./custom-providers-overview.md).

## <a name="azure-function-restful-endpoint"></a>Point de terminaison Azure RESTful (fonction)

Le code suivant fonctionne avec une fonction Azure. Pour savoir comment configurer une fonction Azure pour travailler avec des fournisseurs personnalisés, consultez [configuration de Azure Functions pour les fournisseurs personnalisés Azure](./tutorial-custom-providers-function-setup.md)
