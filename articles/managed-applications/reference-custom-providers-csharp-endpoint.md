...
Cet article est une référence de base sur le point de terminaison RESTful C# de fournisseur personnalisé. Si vous ne savez pas encore ce qu’est un fournisseur personnalisé Azure, consultez la [présentation des fournisseurs de ressources personnalisés](./custom-providers-overview.md).
