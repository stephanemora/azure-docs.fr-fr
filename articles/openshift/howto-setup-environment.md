...
> Si vous avez des questions, [n'hésitez pas à nous contacter](mailto:arofeedback@microsoft.com).
...
Voici les instructions pour [installer Azure CLI](/cli/azure/install-azure-cli) si une nouvelle installation ou une mise à niveau est nécessaire.
