...
> [!NOTE]
> Pour utiliser le modèle `httpd-example`, vous devez déployer votre cluster ARO avec le secret d’extraction activé. Pour plus d’informations, reportez-vous à [Obtenir un secret d’extraction Red Hat](tutorial-create-cluster.md#get-a-red-hat-pull-secret-optional).
