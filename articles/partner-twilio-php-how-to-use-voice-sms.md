...
* **Remarque** : Pour détecter les erreurs de validation de certificat TLS/SSL, consultez [http://readthedocs.org/docs/twilio-php/en/latest/usage/rest.html][ssl_validation] 
