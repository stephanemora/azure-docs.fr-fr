...
### <a name="get-acount-information"></a>Obtenir des informations sur le compte
...
### <a name="change-a-firewall-rule"></a>Modifier une règle de pare-feu
...
### <a name="allow-azure-ip-addresses"></a>Autorisez des adresses IP Azure.
