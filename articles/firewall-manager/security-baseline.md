...
- [Interface CLI pour la stratégie de pare-feu Azure](https://docs.microsoft.com/cli/azure/ext/azure-firewall/network/firewall/policy?view=azure-cli-latest&amp;preserve-view=true)
