...
- Pour Linux : [Double chiffrement au repos](./linux/disk-encryption.md#double-encryption-at-rest)
- Pour Windows : [Double chiffrement au repos](./windows/disk-encryption.md#double-encryption-at-rest)
