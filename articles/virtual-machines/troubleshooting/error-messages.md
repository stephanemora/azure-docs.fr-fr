...
|  DiskEncryptionKeySecretUnwrapFailed  |  Le déchiffrement de la valeur {0} du secret à l'aide de la clé {1} a échoué.  |
|  DiskImageNotReady  |  L’image de disque {0} a l’état {1}. Réessayez lorsque l’image est prête.  |
