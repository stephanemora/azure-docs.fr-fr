...
## <a name="step-1-access-application-from-target-vm"></a>Étape 1 : Application de l’accès à partir de la machine virtuelle cible
...
## <a id="step2"></a>Étape 2 : Application de l’accès à partir d’une autre machine virtuelle dans le même réseau virtuel
...
## <a id="step3"></a>Étape 3 : Application d’accès à partir de l’extérieur du réseau virtuel
...
* Pour les machines virtuelles créées à l’aide du modèle de déploiement Classic :
  ...
  * Pour plus d’informations, consultez [Configuration des points de terminaison sur une machine virtuelle](../windows/classic/setup-endpoints.md).
* Pour les machines virtuelles créées à l’aide du modèle de déploiement Resource Manager :
  ...
  * Pour plus d’informations, consultez l’article de [présentation des groupes de sécurité réseau](../../virtual-network/security-overview.md).
