---
title: Résoudre les erreurs de démarrage dans Machines virtuelles Azure | Microsoft Docs
...
Cet article liste les erreurs de démarrage courantes que vous pouvez recevoir quand vous démarrez une machine virtuelle Windows dans Microsoft Azure. Pour plus d’informations sur les erreurs, consultez les articles de la section **Erreurs de démarrage et solutions**.
