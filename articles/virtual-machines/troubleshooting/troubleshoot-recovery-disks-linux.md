...
> [!Important]
> Les scripts dans cet article s’appliquent uniquement aux machines virtuelles qui utilisent [Disque managé](../linux/managed-disks-overview.md). 
