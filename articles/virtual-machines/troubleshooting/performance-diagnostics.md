...
Les diagnostics de performances installent une extension de machine virtuelle qui exécute un outil de diagnostics nommé [PerfInsights](https://aka.ms/perfinsights). Pour installer et exécuter les diagnostics de performances, effectuez les étapes suivantes :
...
*   Un fichier compressé (.zip) de sortie (nommé **PerformanceDiagnostics_aaaa-MM-jj_hh-mm-ss-fff.zip**) qui contient les fichiers journaux
*   Un rapport HTML
...
### <a name="how-do-i-capture-the-diagnostics-data-at-the-correct-time"></a>Comment capturer les données de diagnostic au moment approprié ?
