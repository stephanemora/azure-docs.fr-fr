...
* [Vue d’ensemble de la migration prise en charge par la plateforme de ressources IaaS Classic vers Azure Resource Manager](./linux/migration-classic-resource-manager-overview.md)
