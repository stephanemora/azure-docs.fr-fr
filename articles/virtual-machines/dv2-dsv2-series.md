...
[Performances réseau accélérées](../virtual-network/create-vm-accelerated-networking-cli.md) : pris en charge (*requiert au moins 2 processeurs virtuels*)<br>
