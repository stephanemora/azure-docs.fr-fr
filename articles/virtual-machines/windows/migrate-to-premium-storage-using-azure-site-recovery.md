...
2. Sélectionnez **Créer une ressource** > **Gestion** > **Backup and Site Recovery (OMS)** . Vous pouvez aussi sélectionner **Parcourir** > **Coffre Recovery Services** > **Ajouter**.
   >[!NOTE]
   >Sauvegarde et Site Recovery faisaient précédemment partie intégrante de la [suite OMS](../../azure-monitor/terminology.md#april-2018---retirement-of-operations-management-suite-brand).
