...
Cet article explique comment inscrire en bloc votre machine virtuelle SQL Server dans Azure auprès du fournisseur de ressources de machine virtuelle SQL à l’aide de l’applet de commande PowerShell `Register-SqlVMs`.
...
- Un [abonnement Azure](https://azure.microsoft.com/free/) qui a été [inscrit auprès du fournisseur de ressources](virtual-machines-windows-sql-register-with-resource-provider.md#register-subscription-with-rp) et contient des machines virtuelles SQL Server non inscrites. 
...
### <a name="import-script"></a>Importation du script
...
## <a name="all-vms-in-list-of-subscriptions"></a>Toutes les machines virtuelles dans la liste des abonnements 
...
## <a name="specific-vms-in-single-resource-group"></a>Machines virtuelles spécifiques dans un seul groupe de ressources
...
## <a name="specific-vm"></a>Machine virtuelle spécifique
