...
| **Mise en miroir de bases de données** |Serveurs principal et miroir s’exécutant dans des centres de données différents pour la récupération d’urgence. Vous devez déployer à l’aide de certificats de serveur. Mise en miroir de base de données SQL Server n’est pas pris en charge pour SQL Server 2008 ni SQL Server 2008 R2 sur une machine virtuelle Azure. <br/>![Mise en miroir de bases de données](./media/virtual-machines-windows-sql-high-availability-dr/azure_only_dr_dbmirroring.gif) |
