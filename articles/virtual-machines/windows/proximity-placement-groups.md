...
Vous pouvez également utiliser l’[interface de ligne de commande Azure](../linux/proximity-placement-groups.md) pour créer des groupes de placements de proximité.
