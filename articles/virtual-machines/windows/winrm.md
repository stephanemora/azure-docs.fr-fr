...
Vous trouverez un exemple de modèle pour machine virtuelle dans [vm-winrm-keyvault-windows](https://azure.microsoft.com/resources/templates/vm-winrm-keyvault-windows/)
