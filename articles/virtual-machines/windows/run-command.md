...
L’exemple suivant utilise la commande [az vm run-command](/cli/azure/vm/run-command#az_vm_run_command_invoke) pour exécuter un script d’interpréteur de commandes sur une machine virtuelle Windows Azure.
