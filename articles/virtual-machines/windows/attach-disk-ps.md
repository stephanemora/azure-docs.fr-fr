...
Vous pouvez également déployer des disques managés à l’aide de modèles. Pour plus d’informations, consultez [Utilisation de disques managés dans les modèles Azure Resource Manager](../using-managed-disks-template-deployments.md) ou le [modèle de démarrage rapide](https://github.com/Azure/azure-quickstart-templates/tree/master/quickstarts/microsoft.compute/vm-multiple-data-disk) consacré au déploiement de plusieurs disques de données.