...
Installez la dernière [version d’Azure PowerShell](/powershell/azure/install-az-ps) et connectez-vous à un compte Azure à l’aide de [Connect-AzAccount](/powershell/module/az.accounts/connect-azaccount).
