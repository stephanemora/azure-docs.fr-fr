...
Vérifiez que vous avez installé le dernier module Azure PowerShell installé et que vous êtes connecté à un compte Azure avec `Connect-AzAccount`. 
