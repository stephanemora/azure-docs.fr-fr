...
> [!NOTE]
> Pour les définitions d’images qui contiennent des images provenant d’images tierces, les informations de plan doivent correspondre exactement aux informations de plan de l’image tierce. Incluez les informations de plan dans la définition d’image en ajoutant `-PurchasePlanName`, `-PurchasePlanProduct` et `-PurchasePlanPublisher` au moment de la création de la définition d’image.
>
