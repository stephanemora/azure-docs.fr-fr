...
Pour la version 2.2.x, utilisez : Au préalable, vous devrez peut-être installer le package `setuptools` -- voir [setuptools](https://pypi.python.org/pypi/setuptools). Ensuite, exécutez :
