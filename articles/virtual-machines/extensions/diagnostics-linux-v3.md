---
title: Calcul Azure - Extension de diagnostic Linux 3.0
...
```
#### <a name="azure-cli-sample-for-installing-lad-30-extension-on-the-virtual-machine-scale-set-instance"></a>Exemple Azure CLI pour l’installation de l’extension de diagnostic Linux 3.0 sur l’instance du groupe de machines virtuelles identiques
...
> [!NOTE]
> Si vous utilisez le portail Azure au lieu de JSON, la forme de champ de condition correcte est Nom='/mnt'
