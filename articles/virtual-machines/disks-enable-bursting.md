...
Les cmdlets de bursting à la demande sont disponibles dans la version 2.19.0 et les versions ultérieures du [module Azure CLI](https://docs.microsoft.com/cli/azure/install-azure-cli). Vous pouvez également utiliser [Azure Cloud Shell](https://shell.azure.com/).
