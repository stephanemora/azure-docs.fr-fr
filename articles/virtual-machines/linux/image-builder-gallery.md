...
## <a name="create-a-user-assigned-identity-and-set-permissions-on-the-resource-group"></a>Créer une identité attribuée par l’utilisateur et définir des autorisations sur le groupe de ressources
