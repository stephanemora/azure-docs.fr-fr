---
title: Déployer les hôtes dédiés à l’aide du portail Azure | Microsoft Docs
...
1. Pour la taille, sélectionnez **Mdifier la taille**. Dans la liste des tailles disponibles, choisissez-en une dans la série Esv3, par exemple **Standard E2s v3**. Vous devrez peut-être effacer le filtre afin d’afficher toutes les tailles disponibles.
