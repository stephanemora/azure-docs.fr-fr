...
Si ce n’est déjà fait, suivez les instructions permettant de [réinitialiser un mot de passe pour les machines virtuelles Linux](reset-password.md).
