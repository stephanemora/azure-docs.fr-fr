...
- [Azure CLI 2.0](create-cli-complete-nodejs.md) : notre interface Azure CLI nouvelle génération pour le modèle de déploiement Resource Manager
