---
title: Disque managé d’un fichier VHD dans le même compte (Windows) – Exemple d’interface CLI
...
ms.locfileid: "87069250"
---
# <a name="create-a-managed-disk-from-a-vhd-file-in-a-storage-account-in-the-same-subscription-with-cli-windows"></a>Créer un disque managé à partir d’un fichier VHD dans un compte de stockage dans le même abonnement avec l’interface CLI (Windows)
