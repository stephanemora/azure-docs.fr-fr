---
title: Copier une capture instantanée dans un compte de stockage appartenant à une autre région - Exemple d’interface de ligne de commande Linux
