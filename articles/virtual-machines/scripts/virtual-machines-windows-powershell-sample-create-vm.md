---
title: Exemple de script Azure PowerShell - Créer une machine virtuelle Windows entièrement configurée
description: Exemple de script Azure PowerShell - Créer une machine virtuelle Windows entièrement configurée
