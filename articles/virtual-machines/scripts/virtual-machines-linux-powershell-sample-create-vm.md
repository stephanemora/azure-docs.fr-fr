...
| [Set-AzVMOperatingSystem](/powershell/module/az.compute/set-azvmoperatingsystem) | Définit les propriétés de système d’exploitation d’une machine virtuelle. |
| [Set-AzVMSourceImage](/powershell/module/az.compute/set-azvmsourceimage) | Spécifie l’image d’une machine virtuelle. |
| [Add-AzVMNetworkInterface](/powershell/module/az.compute/add-azvmnetworkinterface) | Ajoute une interface réseau à une machine virtuelle. |
