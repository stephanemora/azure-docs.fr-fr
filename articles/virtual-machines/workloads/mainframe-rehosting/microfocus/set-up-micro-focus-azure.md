...
-   Obtenez la documentation sur [Enterprise Server et Enterprise Developer](https://www.microfocus.com/documentation/enterprise-developer/ed50/).
    ...
    > -   Un tunnel de [réseau privé virtuel (VPN) site à site](https://docs.microsoft.com/azure/vpn-gateway/vpn-gateway-tutorial-vpnconnection-powershell).
...
2.  Sélectionnez **Start** (Démarrer) \> **Micro Focus License Manager** (Gestionnaire des licences Micro Focus) \> **License Administration** (Gestion des Licences), puis cliquez sur l’onglet **Install** (Installer). Choisissez le type de format de licence à charger : un fichier de licence ou un code de licence de 16 caractères. Par exemple, pour un fichier, dans **License file** (Fichier de licence), accédez au fichier **mflic** précédemment chargé dans la machine virtuelle, puis sélectionnez **Install Licenses** (Installer les licences).
...
-   [Configurer l’application Bank Demo](https://docs.microsoft.com/azure/virtual-machines/workloads/mainframe-rehosting/microfocus/demo)

-   [Exécuter Enterprise Server dans des conteneurs Docker](https://docs.microsoft.com/azure/virtual-machines/workloads/mainframe-rehosting/microfocus/run-enterprise-server-container)
