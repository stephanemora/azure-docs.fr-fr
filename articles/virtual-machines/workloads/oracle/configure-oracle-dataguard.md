...
Connectez-vous à votre abonnement Azure avec la commande [az login](/cli/azure/reference-index), puis suivez les instructions à l’écran.
...
Créez des journaux d’activité de rétablissement de secours :
