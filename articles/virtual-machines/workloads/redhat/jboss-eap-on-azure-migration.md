...
* Déployez vos applications sur votre cluster JBoss migré avec Azure DevOps. Pour plus d’informations, reportez-vous à la [documentation Bien démarrer avec Azure DevOps](/azure/devops/get-started).
