...
- Testez vos connaissances avec un [module d’apprentissage sur l’optimisation des applications HPC dans Azure](https://docs.microsoft.com/learn/modules/optimize-tightly-coupled-hpc-apps/).
