...
| Délimitation Azure | Délimitation Azure ou isolation SBD (hautement recommandée). La méthode permettant d’éviter les situations de Split-Brain est interdite. |
...
#  <a name="masterslave-set-msldb2db2ptrptr-rscdb2db2ptrptr"></a>Ensemble maître/esclave : msl_Db2_db2ptr_PTR [rsc_Db2_db2ptr_PTR]
