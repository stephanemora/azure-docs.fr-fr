...
| Référence de la machine virtuelle | Nombre de disques avec Accélérateur des écritures | IOPS d’Accélérateur des écritures par machine virtuelle |
| --- | --- | --- |
| M128ms | 16 | 8000 |
| M128s | 16 | 8000 |
| M64ms | 8 | 4000 |
