...
- Reportez-vous à la [procédure d’intégration](./azure-monitor-sap-quickstart.md) et créez votre première ressource Azure Monitor pour les solutions SAP.
