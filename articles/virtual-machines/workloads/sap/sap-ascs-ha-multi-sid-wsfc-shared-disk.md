---
title: Haute disponibilité multi-SID de SAP ASCS/SCS avec WSFC et disque partagé sur Azure | Microsoft Docs
...
## <a name="prepare-the-infrastructure-for-an-sap-multi-sid-scenario"></a><a name="25e358f8-92e5-4e8d-a1e5-df7580a39cb0"></a> Préparer l’infrastructure pour un scénario multi-SID SAP
...
2. [Modifier le profil SAP de l’instance ASCS/SCS][sap-high-availability-installation-wsfc-shared-disk-modify-ascs-profile].

3. [Configurer un port de sonde][sap-high-availability-installation-wsfc-shared-disk-add-probe-port].  
