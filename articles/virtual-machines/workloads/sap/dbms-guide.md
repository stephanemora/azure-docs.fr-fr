...
[comment]: <> (Installation d’Always On préconfiguré via la galerie Azure <https://blogs.technet.com/b/dataplatforminsider/archive/2014/08/25/sql-server-alwayson-offering-in-microsoft-azure-portal-gallery.aspx>)
...
[comment]: <> (Ancien blog TODO)
[comment]: <> (La configuration de groupes de disponibilité SQL Server Always On dans ce type de scénario est décrite ici : <https://blogs.technet.com/b/dataplatforminsider/archive/2014/06/19/sql-server-alwayson-availability-groups-supported-between-microsoft-azure-regions.aspx>.) 
