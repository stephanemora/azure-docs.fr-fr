---
title: Gérer les paramètres et les préférences du portail Azure (version antérieure)
description: Vous pouvez changer les paramètres par défaut du portail Azure pour appliquer vos propres préférences. Ce document décrit la version antérieure de l’expérience des paramètres.
ms.date: 06/17/2021
ms.topic: how-to
...
ms.locfileid: "112372190"
---
# <a name="manage-azure-portal-settings-and-preferences-older-version"></a>Gérer les paramètres et les préférences du portail Azure (version antérieure)

Vous pouvez changer les paramètres par défaut du portail Azure pour appliquer vos propres préférences. 

> [!IMPORTANT]
> Nous migrons actuellement tous les utilisateurs Azure vers une expérience plus récente. Cette rubrique décrit l’expérience antérieure. Pour obtenir les informations les plus récentes, consultez [Gérer les paramètres et les préférences du portail Azure](set-preferences.md).

La plupart des paramètres sont disponibles dans le menu **Paramètres** de l’en-tête de page global.

![Capture d’écran montrant les icônes de l’en-tête de page global avec mise en évidence des paramètres](./media/original-preferences/header-settings.png)
...
:::image type="content" source="media/original-preferences/filter-subscription-default-view.png" alt-text="Filtrez la liste des ressources par abonnement.":::
...
1. Sélectionnez les abonnements que vous souhaitez en tant qu’abonnements par défaut lorsque vous lancez le portail. 
    ...
    :::image type="content" source="media/original-preferences/default-directory-subscription-filter.png" alt-text="Sélectionnez les abonnements que vous souhaitez en tant qu’abonnements par défaut lorsque vous lancez le portail."::: 
...
![Capture d’écran montrant les paramètres du portail Azure avec mise en évidence de la vue par défaut](./media/original-preferences/default-view.png)
...
![Capture d’écran montrant comment définir le mode par défaut pour le menu du portail.](./media/original-preferences/menu-mode.png)
...
![Capture d’écran montrant les paramètres du portail Azure avec mise en évidence des thèmes](./media/original-preferences/theme.png)
...
![Capture d’écran montrant les paramètres du portail Azure avec mise en évidence des notifications contextuelles](./media/original-preferences/pop-up-notifications.png)

Pour lire toutes les notifications reçues pendant votre session active, sélectionnez **Notifications** dans l’en-tête global.

![Capture d’écran montrant l’en-tête global du portail Azure avec mise en évidence des notifications](./media/original-preferences/read-notifications.png)
...
![Capture d’écran montrant les paramètres du portail avec mise en évidence des paramètres de délai d’inactivité](./media/original-preferences/inactive-sign-out-user.png)
...
![Capture d’écran montrant les paramètres du portail avec mise en évidence du paramètre Remplacer la stratégie de délai d’inactivité du répertoire](./media/original-preferences/inactive-sign-out-override.png)
...
1. Sélectionnez le texte du lien **Configurer le délai d’inactivité au niveau du répertoire**.
    ...
    ![Capture d’écran montrant les paramètres du portail avec mise en évidence du texte de lien](./media/original-preferences/settings-admin.png)
...
1. Sélectionnez **Appliquer**.
    ...
    ![Capture d’écran montrant la page permettant de définir un délai d’inactivité au niveau du répertoire](./media/original-preferences/configure.png)
...
![Capture d’écran montrant un message de notification de réussite pour le délai d’inactivité au niveau du répertoire](./media/original-preferences/confirmation.png)
...
![Capture d’écran montrant la restauration des paramètres par défaut](./media/original-preferences/useful-links-restore-defaults.png)
...
![Capture d’écran montrant l’exportation des paramètres](./media/original-preferences/useful-links-export-settings.png)
...
![Capture d’écran montrant la suppression des paramètres](./media/original-preferences/useful-links-delete-settings.png)
...
Sélectionnez **Appliquer** pour mettre à jour vos paramètres de langue et de format de région.
   ...
   ![Capture d’écran montrant les paramètres de langue et de format de région](./media/original-preferences/language.png)
