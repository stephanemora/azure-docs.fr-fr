...
description: Vous pouvez utiliser un tableau de bord dans le portail Azure comme modèle pour créer par programmation des tableaux de bord Azure. Comprend une référence JSON.
