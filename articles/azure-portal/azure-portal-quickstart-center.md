...
* **Guides de configuration** : Nos guides, destinés à l’administrateur informatique et à l’architecte cloud, présentent les concepts clés pour l’adoption d’Azure. Les étapes structurées vous permettent d’agir à mesure de l’apprentissage, en appliquant les bonnes pratiques recommandées par Microsoft. Le guide de migration vous aidera à évaluer la préparation et la planification à mesure que vous vous préparez à passer à Azure.

* **Démarrer un projet** : Si vous êtes prêt à créer une ressource, cette section vous permet d’en savoir plus sur vos choix avant de valider une option de service. Vous allez en apprendre davantage sur le service et la raison pour laquelle vous devez l’utiliser, explorer les coûts et identifier les prérequis. Une fois votre choix effectué, vous pouvez passer directement à la création.
