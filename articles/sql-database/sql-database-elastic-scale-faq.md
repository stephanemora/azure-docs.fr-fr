...
Consultez [Ajout d'une partition à une application à l'aide de la bibliothèque de client de bases de données élastiques](sql-database-elastic-scale-add-a-shard.md).
