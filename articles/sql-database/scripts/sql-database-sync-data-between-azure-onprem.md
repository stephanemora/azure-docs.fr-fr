...
Cet exemple PowerShell configure SQL Data Sync (préversion) pour effectuer une synchronisation entre une base de données Azure SQL et une base de données locale SQL Server. 
