...
ms.locfileid: "80061906"
---
# <a name="use-cli-to-add-an-azure-sql-database-into-a-failover-group"></a>Utiliser CLI pour ajouter une base de données Azure SQL Database à un groupe de basculement

Cet exemple de script Azure CLI crée une base de données unique, crée un groupe de basculement, y ajoute la base de données et teste le basculement.
