...
Cet exemple suppose que vous avez [créé un environnement réseau valide](../sql-database-managed-instance-create-vnet-subnet.md) ou [modifié un réseau virtuel existant](../sql-database-managed-instance-configure-vnet-subnet.md) pour votre instance gérée. L’exemple utilise les applets de commande [New-AzureRmResourceGroupDeployment](https://docs.microsoft.com/powershell/module/azurerm.resources/new-azurermresourcegroupdeployment) et [Get-AzureRmVirtualNetwork](https://docs.microsoft.com/powershell/module/azurerm.network/get-azurermvirtualnetwork). Vérifiez que vous avez installé les modules PowerShell suivants :
