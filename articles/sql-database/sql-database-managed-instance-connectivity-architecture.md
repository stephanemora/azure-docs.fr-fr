...
| Nom       |Port          |Protocol|Source           |Destination|Action|
|------------|--------------|--------|-----------------|-----------|------|
|gestion  |443, 12000    |TCP     |SOUS-RÉSEAU MI        |AzureCloud |AUTORISER |
|mi_subnet   |Quelconque           |Quelconque     |SOUS-RÉSEAU MI        |SOUS-RÉSEAU MI  |AUTORISER |
...
## <a name="service-aided-subnet-configuration-public-preview-in-east-us-and-west-us"></a>Configuration de sous-réseau assisté par service (préversion publique dans les régions USA Est et USA Ouest)
...
### <a name="network-requirements-with-service-aided-subnet-configuration"></a>Configuration réseau requise avec la configuration de sous-réseau assistée par le service 
...
| Nom       |Port                        |Protocol|Source           |Destination|Action|
|------------|----------------------------|--------|-----------------|-----------|------|
|gestion  |9000, 9003, 1438, 1440, 1452|TCP     |SqlManagement    |SOUS-RÉSEAU MI  |AUTORISER |
|            |9000, 9003                  |TCP     |CorpNetSaw       |SOUS-RÉSEAU MI  |AUTORISER |
|            |9000, 9003                  |TCP     |65.55.188.0/24, 167.220.0.0/16, 131.107.0.0/16|SOUS-RÉSEAU MI  |AUTORISER |
|mi_subnet   |Quelconque                         |Quelconque     |SOUS-RÉSEAU MI        |SOUS-RÉSEAU MI  |AUTORISER |
|health_probe|Quelconque                         |Quelconque     |AzureLoadBalancer|SOUS-RÉSEAU MI  |AUTORISER |
