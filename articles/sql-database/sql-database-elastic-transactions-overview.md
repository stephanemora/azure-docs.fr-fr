...
Pour toute question, contactez-nous via la [page de questions Microsoft Q&R sur SQL Database](https://docs.microsoft.com/answers/topics/azure-sql-database.html) et, pour vos demandes de fonctionnalités, formulez-les sur le [forum de commentaires de Base de données SQL](https://feedback.azure.com/forums/217321-sql-database/).
