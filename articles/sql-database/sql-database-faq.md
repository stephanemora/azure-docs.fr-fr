...
Pour en savoir plus, consultez [Tarification Azure SQL Database](https://azure.microsoft.com/pricing/details/sql-database/) et [Quels sont les niveaux de service Azure SQL Database ?](sql-database-service-tiers.md).
