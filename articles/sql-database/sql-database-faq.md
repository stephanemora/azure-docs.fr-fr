...
## <a name="do-the-new-vcore-based-service-tiers-offer-the-compute-sizes-compatible-with-all-existing-compute-sizes"></a>Les nouveaux niveaux de service basés sur vCore offrent-ils des tailles de calcul compatibles avec toutes les tailles de calcul existantes ?
