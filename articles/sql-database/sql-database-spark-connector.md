...
Vous pouvez vous connecter à Azure SQL Database à l’aide de l’authentification Azure Active Directory (AAD). Utilisez l’authentification AAD pour centraliser la gestion des identités des utilisateurs de base de données et comme une alternative à l’authentification SQL Server.
