...
- Consultez la vue d’ensemble, [base de données de SQL Azure Machine Learning Services avec R (version préliminaire)](sql-database-machine-learning-services-overview.md).
