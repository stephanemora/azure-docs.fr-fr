...
| [Restauration d’une base de données](scripts/sql-database-restore-database-powershell.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Ce script PowerShell restaure une base de données SQL Azure à partir d’une sauvegarde géoredondante et restaure une base de données SQL Azure supprimée dans la dernière sauvegarde. |
...
| [Synchroniser des données entre SQL Database et une instance SQL Server locale](scripts/sql-database-sync-data-between-azure-onprem.md?toc=%2fpowershell%2fmodule%2ftoc.json) | Ce script PowerShell configure la synchronisation des données entre une base de données Azure SQL et une base de données SQL Server locale. |
...
| [créer et gérer une instance managée](scripts/sql-database-create-configure-managed-instance-powershell.md) | Ce script PowerShell vous montre comment créer et gérer une instance gérée à l’aide d’Azure PowerShell. |
...
| **Configurer le chiffrement TDE (Transparent Data Encryption)**||
