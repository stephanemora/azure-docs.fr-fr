...
### <a name="purchasing-models-service-tiers-compute-sizes-and-storage-amounts"></a>Achat de modèles, niveaux de service, tailles de calcul et quantités de stockage
