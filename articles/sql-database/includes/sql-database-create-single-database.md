...
1. Dans la page **Azure SQL**, sélectionnez **Ajouter**. 
   ...
   ![Ajouter à Azure SQL](../media/sql-database-single-database-get-started/sqldbportal.png)
...
1. Sélectionnez **Create** (Créer).
   ...
   ![Créer une base de données unique](../media/sql-database-single-database-get-started/create-single-database.png)
...
1. Sélectionnez **Suivant : Réseau** en bas de la page.
   ...
   ![Nouvelle base de données SQL - Onglet des informations de base](../media/sql-database-single-database-get-started/new-sql-database-basics.png)
...
1. Sélectionnez **Suivant : Paramètres supplémentaires** en bas de la page.
   ...
   ![Onglet Réseau](../media/sql-database-single-database-get-started/networking.png)
   
   Pour plus d’informations sur les paramètres de pare-feu, consultez [Autoriser les services et les ressources Azure à accéder à ce serveur](../sql-database-networkaccess-overview.md) et [Ajouter un point de terminaison privé](../../private-link/private-endpoint-overview.md).
...
1. Au bas de la page, sélectionnez **Examiner et créer**.
   ...
   ![Onglet Paramètres supplémentaires](../media/sql-database-single-database-get-started/additional-settings.png)
   
1. Après avoir passé en revue les paramètres, sélectionnez **Créer**.

# <a name="azure-cli"></a>[Azure CLI](#tab/azure-cli)

Vous pouvez créer un groupe de ressources, un serveur SQL et une base de données unique à l’aide de l’interface de ligne de commande Azure (Azure CLI). Si vous ne souhaitez pas utiliser Azure Cloud Shell, [installez Azure CLI](/cli/azure/install-azure-cli) sur votre ordinateur.
...
Le code Azure CLI suivant crée un groupe de ressources Azure, un serveur SQL, une base de données unique et une règle de pare-feu pour accéder au serveur. Veillez à prendre note du groupe de ressources et des noms de serveurs générés, afin de pouvoir gérer ces ressources ultérieurement.
...
| [az sql server firewall-rule create](/cli/azure/sql/server/firewall-rule##az-sql-server-firewall-rule-create) | Crée les règles de pare-feu d’un serveur. | 
| [az sql db create](/cli/azure/sql/db#az-sql-db-create?view=azure-cli-latest) | Crée une base de données. | 

Pour obtenir plus d’exemples Azure CLI Azure SQL Database, consultez [Exemples d’interface de ligne de commande Azure](../sql-database-cli-samples.md).

# <a name="powershell"></a>[PowerShell](#tab/azure-powershell)

Vous pouvez créer un groupe de ressources, un serveur SQL et une base de données unique à l’aide de Windows PowerShell. Si vous ne souhaitez pas utiliser Azure Cloud Shell, [installez le module Azure PowerShell](/powershell/azure/install-az-ps).
...
Le code PowerShell suivant crée un groupe de ressources Azure, un serveur SQL, une base de données unique et une règle de pare-feu pour accéder au serveur. Veillez à prendre note du groupe de ressources et des noms de serveurs générés, afin de pouvoir gérer ces ressources ultérieurement.
...
Pour obtenir plus d’exemples PowerShell Azure SQL Database, consultez [Exemples Azure PowerShell](../sql-database-powershell-samples.md).
