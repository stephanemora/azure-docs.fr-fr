...
- [Créer une instance gérée](../sql-database-managed-instance-get-started.md)
- [Créer une machine virtuelle SQL](../../virtual-machines/windows/sql/quickstart-sql-vm-create-portal.md)