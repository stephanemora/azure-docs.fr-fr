...
description: Liste les définitions de stratégie intégrées d’Azure Policy pour Azure SQL Database. Ces définitions de stratégie intégrées fournissent des approches courantes pour la gestion de vos ressources Azure.
ms.date: 05/13/2020
ms.topic: sample
author: stevestein
ms.author: sstein
...
ms.locfileid: "83657809"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-sql-database"></a>Définitions de stratégie intégrées d’Azure Policy pour Azure SQL Database

Cette page est un index des définitions de stratégie intégrées d’[Azure Policy](../governance/policy/overview.md) pour Azure SQL Database. Pour obtenir des éléments intégrés supplémentaires d’Azure Policy pour d’autres services, consultez [Définitions intégrées d’Azure Policy](../governance/policy/samples/built-in-policies.md).
