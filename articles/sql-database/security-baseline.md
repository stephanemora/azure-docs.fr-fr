...
Pour les machines virtuelles Azure qui se connecteront à votre instance de serveur Azure SQL Database, activez les journaux de flux du groupe de sécurité réseau (NSG) pour les NSG protégeant ces machines virtuelles, et envoyez les journaux dans un compte Stockage Azure à des fins d'audit du trafic. 
