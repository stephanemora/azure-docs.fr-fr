...
1. Pour estimer le nombre d’eDTU ou de vCore nécessaires pour le pool, procédez de la manière suivante :
   ...
   Pour le modèle d’achat basé sur des vCores (préversion) : MAX(<*nombre total de bases de données* X *utilisation vCore moyenne par base de données*>,<br>
...
3. Pour le modèle d’achat DTU, prenez la plus grande des estimations d’eDTU de l’étape 1 et de l’étape 2. Pour le modèle d’achat basé sur des vCores (préversion), prenez l’estimation vCore de l’étape 1.
