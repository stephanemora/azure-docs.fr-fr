...
- **SQL Server s’exécutant sur des machines virtuelles Azure**
...
- [Administration](#administration) : Les options PaaS réduisent le temps que vous devez investir pour administrer la base de données. Toutefois, il limite également la plage de tâches d’administration personnalisés et les scripts que vous pouvez effectuer ou exécuter. Par exemple, le CLR n’est pas pris en charge avec les bases de données uniques ou regroupées, mais est pris en charge pour une instance gérée. En outre, aucune option de déploiement dans PaaS prend en charge l’utilisation des indicateurs de trace.
...
**Lorsque vous utilisez la base de données SQL Azure :**
...
**Lorsque vous utilisez SQL Server sur des machines virtuelles Azure :**
...
- [Calculatrice de tarification Azure](https://azure.microsoft.com/pricing/calculator/)
