...
> [!NOTE]
> La période minimale de conservation des sauvegardes PITR qui peut être configurée pour les bases de données mises en pool uniques et les instances managées par le biais du portail Azure est de 7 jours. La période minimale de conservation des sauvegardes PITR de 1 jour peut être configurée pour une instance managée uniquement à l’aide de PowerShell avec le module As.SQL version 2.6.0 ou ultérieure.
