...
Pour toute question, contactez-nous sur la [page de questions Microsoft Q&R pour SQL Database](https://docs.microsoft.com/answers/topics/azure-sql-database.html). Ajoutez également des demandes de fonctionnalités dans le [forum de commentaires de Base de données SQL](https://feedback.azure.com/forums/217321-sql-database/).
