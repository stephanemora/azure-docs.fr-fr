...
Vous pouvez accéder à **Aide + support** dans le portail Azure. Cette fonctionnalité est disponible dans l’en-tête global ou dans le menu d’une ressource d’un service.
