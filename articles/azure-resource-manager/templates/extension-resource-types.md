...
- Pour récupérer l’ID d’une ressource d’extension dans un modèle Azure Resource Manager, utilisez [extensionResourceId](template-functions-resource.md#extensionresourceid).
