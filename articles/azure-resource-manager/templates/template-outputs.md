...
Dans Bicep, ajoutez une expression `for` qui définit les conditions de la sortie dynamique. L’exemple suivant itère au sein d’une plage d’entiers. Vous pouvez également effectuer une itération au sein d’un tableau.
