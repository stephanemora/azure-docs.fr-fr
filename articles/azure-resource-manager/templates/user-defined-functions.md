...
* Pour en savoir plus sur les propriétés disponibles pour les fonctions définies par l'utilisateur, consultez [Comprendre la structure et la syntaxe des modèles Azure Resource Manager](./syntax.md).
