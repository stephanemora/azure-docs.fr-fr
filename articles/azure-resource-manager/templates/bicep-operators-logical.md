...
ms.locfileid: "107211247"
---
# <a name="bicep-logical-operators"></a>Opérateurs logiques Bicep

Les opérateurs logiques évaluent des valeurs booléennes, retournent des valeurs non nulles ou évaluent une expression conditionnelle. Pour exécuter les exemples, utilisez Azure CLI ou Azure PowerShell pour [déployer un fichier Bicep](bicep-tutorial-create-first-bicep.md#deploy-bicep-file).
