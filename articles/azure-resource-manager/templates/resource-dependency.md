...
* Pour obtenir des recommandations lors de la définition des dépendances, consultez [Meilleures pratiques relatives aux modèles ARM](./best-practices.md).
...
* Pour apprendre à créer des modèles Azure Resource Manager, consultez [Comprendre la structure et la syntaxe des modèles ARM](./syntax.md).
