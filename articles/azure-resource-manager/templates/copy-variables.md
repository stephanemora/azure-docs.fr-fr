...
* Pour les autres utilisations de l’élément copy, voir :
  * [Itération de ressources dans des modèles Azure Resource Manager](copy-resources.md)
