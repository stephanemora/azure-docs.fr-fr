...
| Microsoft.Billing | [Cost Management et Facturation](/azure/billing/) |
...
| Microsoft.Devices | [Azure IoT Hub](/azure/iot-hub/)<br />[Service Azure IoT Hub Device Provisioning](/azure/iot-dps/) |
...
| Microsoft.Network | [Application Gateway](../../application-gateway/index.yml)<br />[Azure Bastion](/azure/bastion/)<br />[Azure DDoS Protection](../../virtual-network/ddos-protection-overview.md)<br />[Azure DNS](../../dns/index.yml)<br />[Azure ExpressRoute](../../expressroute/index.yml)<br />[Pare-feu Azure](../../firewall/index.yml)<br />[Azure Front Door Service](../../frontdoor/index.yml)<br />[Azure Private Link](../../private-link/index.yml)<br />[Équilibreur de charge](../../load-balancer/index.yml)<br />[Network Watcher](../../network-watcher/index.yml)<br />[Traffic Manager](../../traffic-manager/index.yml)<br />[Réseau virtuel](../../virtual-network/index.yml)<br />[Virtual WAN](../../virtual-wan/index.yml)<br />[Passerelle VPN](../../vpn-gateway/index.yml)<br /> |
...
| Microsoft.SerialConsole | [Console série Azure pour Windows](../../virtual-machines/troubleshooting/serial-console-windows.md) |
...
Pour plus d’informations sur les fournisseurs de ressources, consultez la page sur les [fournisseurs et types de ressources Azure](resource-providers-and-types.md).
