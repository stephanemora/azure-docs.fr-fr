...
| Nom de l'élément | Obligatoire | Description |
|:--- |:--- |:--- |
| namespace |OUI |Espace de noms pour les fonctions personnalisées. Utilisez pour éviter les conflits de noms avec les fonctions de modèle. |
