---
title: Vue d’ensemble d’Azure Deployment Manager | Microsoft Docs
description: Décrit le déploiement d’un service sur plusieurs régions avec Azure Deployment Manager
