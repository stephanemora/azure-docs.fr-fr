...
2. Effectuez les modifications suivantes :
    ...
    * Supprimez tous les paramètres sauf **location**.
...
Nous avons vu dans le [Tutoriel : Créer des modèles Azure Resource Manager avec des ressources dépendantes](./resource-manager-tutorial-create-templates-with-dependent-resources.md) que la ressource de machine virtuelle dépendait du compte de stockage :
