...
Pour appliquer toutes les étiquettes d'un groupe de ressources à ses ressources *en conservant les étiquettes existantes*, utilisez le script suivant :
