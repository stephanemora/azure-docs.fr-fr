...
# Démarrages rapides
## [Créer des modèles - portail](resource-manager-quickstart-create-templates-use-the-portal.md)
## [Créer des modèles - VS Code](resource-manager-quickstart-create-templates-use-visual-studio-code.md)
## [Créer des modèles - Visual Studio](vs-azure-tools-resource-groups-deployment-projects-create-deploy.md)
...
#### [Fonctions](resource-group-authoring-templates.md#functions)
...
### [Créer des abonnements EA](programmatically-create-subscription.md)
### [Accorder l’accès pour créer des abonnements EA](grant-access-to-create-subscription.md)
