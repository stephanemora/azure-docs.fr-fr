---
title: Utiliser Azure Key Vault dans un modèle Resource Manager
...
ms.locfileid: "72533595"
---
# <a name="tutorial-integrate-azure-key-vault-in-your-resource-manager-template-deployment"></a>Didacticiel : Intégrer Azure Key Vault à votre déploiement de modèle Resource Manager
...
![Diagramme affichant l’intégration d’un modèle Resource Manager avec un coffre de clés](./media/resource-manager-tutorial-use-key-vault/resource-manager-template-key-vault-diagram.png)
...
1. Sélectionnez **Ouvrir** pour ouvrir le fichier. Le scénario est identique à celui utilisé dans [Tutoriel : Créer des modèles Azure Resource Manager avec des ressources dépendantes](./resource-manager-tutorial-create-templates-with-dependent-resources.md).
...
1. Mettez à jour le paramètre `adminPassword` comme suit :
    ...
    ![Fichier de paramètres de déploiement de machine virtuelle pour l’intégration d’un coffre de clés à un modèle Resource Manager](./media/resource-manager-tutorial-use-key-vault/resource-manager-tutorial-create-vm-parameters-file.png)
...
Suivez les instructions dans [Déployer le modèle](./resource-manager-tutorial-create-templates-with-dependent-resources.md#deploy-the-template). Chargez *azuredeploy.json* et *azuredeploy.parameters.json* dans Cloud Shell, puis utilisez le script PowerShell suivant pour déployer le modèle :
