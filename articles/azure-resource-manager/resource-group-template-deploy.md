...
Pour passer les paramètres inline, indiquez les noms des paramètres au moyen de la commande `New-AzureRmResourceGroupDeployment`. Par exemple, pour passer une chaîne et un tableau à un modèle, utilisez :
