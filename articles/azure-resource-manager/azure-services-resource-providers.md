---
title: Fournisseurs de ressources Azure Resource Manager par les services Azure
description: Répertorie tous les espaces de noms de fournisseur ressources pour Azure Resource Manager et affiche le service Azure pour cet espace de noms.
author: tfitzmac
...
ms.locfileid: "64537462"
---
# <a name="resource-providers-for-azure-services"></a>Fournisseurs de ressources pour les services Azure

Cet article montre comment les espaces de noms de ressource fournisseur mappent aux services Azure.

## <a name="match-resource-provider-to-service"></a>Fournisseur de ressources de correspondance au service

| Espace de noms de ressources fournisseur | Service Azure |
| --------------------------- | ------------- |
...
| Microsoft.Blockchain | [Service Azure Blockchain](/azure/blockchain/workbench/) |
| Microsoft.Blueprint | [Plans d’Azure](/azure/governance/blueprints/) |
...
| Microsoft.ClassicCompute | Machine de virtuelle de modèle de déploiement classique |
| Microsoft.ClassicInfrastructureMigrate | Migration de modèle de déploiement classique |
| Microsoft.ClassicNetwork | Réseau virtuel de modèle de déploiement classique |
| Microsoft.ClassicStorage | Stockage de modèle de déploiement classique |
...
| Microsoft.Compute | [Machines virtuelles](/azure/virtual-machines/) |
| Microsoft.Consumption | [Gestion des coûts](/azure/cost-management/) |
| Microsoft.ContainerInstance | [Container Instances](/azure/container-instances/) |
| Microsoft.ContainerRegistry | [Registre de conteneurs](/azure/container-registry/) |
...
| Microsoft.CostManagement | [Gestion des coûts](/azure/cost-management/) |
| Microsoft.CustomerInsights | Insights client |
| Microsoft.CustomerLockbox | Référentiel sécurisé client pour Microsoft Azure |
...
| Microsoft.DataLakeAnalytics | [Data Lake Analytique](/azure/data-lake-analytics/) |
...
| Microsoft.DBforMariaDB | [Azure Database pour MariaDB](/azure/mariadb/) |
...
| Microsoft.DeploymentManager | [Gestionnaire de déploiement Azure](deployment-manager-overview.md) |
| Microsoft.Devices | [IoT Hub](/azure/iot-hub/) |
| Microsoft.DevSpaces | [Espaces de développement Azure](/azure/dev-spaces/) |
| Microsoft.DevTestLab | [Azure Lab Services](../lab-services/index.yml) |
| Microsoft.DocumentDB | [Azure Cosmos DB](../cosmos-db/index.yml) |
| Microsoft.DomainRegistration | [App Service](/azure/app-service/) |
| Microsoft.EnterpriseKnowledgeGraph | Graphique de base de connaissances d’entreprise |
...
| Microsoft.HealthcareApis | [API Azure pour FHIR](../healthcare-apis/index.yml) |
...
| Microsoft.IoTSpaces | [Représentations numériques Azure](../digital-twins/index.yml) |
| Microsoft.KeyVault | [Key Vault](../key-vault/index.yml) |
| Microsoft.Kusto | [Explorateur de données Azure](../data-explorer/index.yml) |
...
| Microsoft.MachineLearningCompute | [Service machine Learning](../machine-learning/service/index.yml) |
| Microsoft.MachineLearningModelManagement | [Service machine Learning](../machine-learning/service/index.yml) |
| Microsoft.MachineLearningServices | [Service machine Learning](../machine-learning/service/index.yml) |
...
| Microsoft.MixedReality | [Ancres Spatial Azure](/azure/spatial-anchors/) |
| Microsoft.NetApp | [Azure NetApp Files](../azure-netapp-files/index.yml) |
| Microsoft.Network | [Réseau virtuel](../virtual-network/index.yml)<br />[Équilibreur de charge](../load-balancer/index.yml)<br />[Application Gateway](/application-gateway/index.yml)<br />[Azure DNS](../dns/index.yml)<br />[ExpressRoute](../expressroute/index.yml)<br />[Passerelle VPN](../vpn-gateway/index.yml)<br />[Traffic Manager](../traffic-manager/index.yml)<br />[Network Watcher](../network-watcher/index.yml)<br />[Pare-feu Azure](../firewall/index.yml)<br />[Service de la porte d’entrée Azure](../frontdoor/index.yml) |
...
| Microsoft.Security | [Centre de sécurité](../security-center/index.yml) |
| Microsoft.ServiceBus | [Service Bus](/azure/service-bus/) |
| Microsoft.ServiceFabric | [Service Fabric](../service-fabric/index.yml) |
| Microsoft.ServiceFabricMesh | [Service Fabric Mesh](../service-fabric-mesh/index.yml) |
| Microsoft.SignalRService | [Service Azure SignalR](../azure-signalr/index.yml) |
| Microsoft.SiteRecovery | [Site Recovery](../site-recovery/index.yml) |
| Microsoft.Solutions | [Applications gérées Azure](../managed-applications/index.yml) |
| Microsoft.Sql | [Base de données SQL Azure](../sql-database/index.yml) |
...
Pour plus d’informations sur les fournisseurs de ressources, consultez [les types et les fournisseurs de ressources Azure](resource-manager-supported-services.md)
