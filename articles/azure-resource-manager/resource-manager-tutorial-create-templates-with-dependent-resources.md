...
> [!div class="checklist"]
> * Configurer un environnement sécurisé
...
* Pour empêcher les attaques par pulvérisation de mots de passe, générez un mot de passe pour le compte administrateur de la machine virtuelle. En voici un exemple :
