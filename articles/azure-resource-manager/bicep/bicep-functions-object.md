---
title: Fonctions Bicep - Objets
description: Décrit les fonctions à utiliser dans un fichier Bicep pour utiliser des objets.
author: mumian
ms.author: jgao
ms.topic: conceptual
ms.date: 09/30/2021
...
Si vous devez inclure une valeur de paramètre ou une variable dans l’objet JSON, utilisez la fonction [concat](./bicep-functions-string.md#concat) pour créer la chaîne que vous passez à la fonction.
