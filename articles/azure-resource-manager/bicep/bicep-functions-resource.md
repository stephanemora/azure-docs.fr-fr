...
Un [qualificateur d’espace de noms](bicep-functions.md#namespaces-for-functions) n’est pas nécessaire, car la fonction est utilisée avec un type de ressource.
