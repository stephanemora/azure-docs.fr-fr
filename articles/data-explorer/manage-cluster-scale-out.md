...
Vous pouvez également [gérer le scale-up de cluster](manage-cluster-scale-up.md) pour le bon dimensionnement d’un cluster.

Si vous avez besoin d’aide pour résoudre des problèmes de mise à l’échelle de clusters, [ouvrez une demande de support](https://portal.azure.com/#blade/Microsoft_Azure_Support/HelpAndSupportBlade/overview) dans le portail Azure.
