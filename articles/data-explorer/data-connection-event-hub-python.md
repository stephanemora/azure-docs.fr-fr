...
L’exemple suivant montre comment ajouter par programmation une connexion de données au hub d’événements. Consultez [Se connecter au hub d’événements](ingest-data-event-hub.md#connect-to-the-event-hub) pour ajouter une connexion de données au hub d’événements à l’aide du Portail Azure.
