...
* Vous pouvez [gérer le scale-out de cluster](manage-cluster-scale-out.md) afin d’adapter de manière dynamique le nombre d’instances en fonction des métriques que vous spécifiez.
