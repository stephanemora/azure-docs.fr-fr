---
title: Exemple Azure Policy - Références (SKU) d’équilibreur de charge autorisées
description: Cet exemple de stratégie exige que les équilibreurs de charge utilisent une référence (SKU) approuvée.
