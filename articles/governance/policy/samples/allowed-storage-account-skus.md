...
description: Cet exemple de définition de stratégie demande que les comptes de stockage utilisent une référence SKU approuvée définie dans un paramètre.
ms.date: 01/23/2019
ms.topic: sample
