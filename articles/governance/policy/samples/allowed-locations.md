...
description: Cet exemple de définition de stratégie exige que toutes les ressources soient déployées sur les emplacements approuvés définis dans un paramètre.
ms.date: 01/26/2019
ms.topic: sample
