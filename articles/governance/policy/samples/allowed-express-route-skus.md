...
description: Cet exemple de définition de stratégie exige qu’ExpressRoute utilise une référence SKU approuvée définie dans un paramètre.
ms.date: 01/29/2019
ms.topic: sample
