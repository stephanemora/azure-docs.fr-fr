...
description: Cet exemple de définition de stratégie demande que les interfaces réseau utilisent un sous-réseau approuvé défini dans un paramètre.
ms.date: 01/23/2019
ms.topic: sample
