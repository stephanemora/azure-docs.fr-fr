...
description: Cet exemple de définition de stratégie interdit le déploiement de types de ressources spécifiés définis dans un paramètre.
ms.date: 01/23/2019
ms.topic: sample
