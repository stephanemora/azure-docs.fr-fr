---
title: Exemple Azure Policy - Refuser les niveaux d’accès froids pour les comptes de stockage
description: Cet exemple de stratégie interdit l’utilisation des niveaux d’accès froids pour les comptes de stockage d’objets blob.
