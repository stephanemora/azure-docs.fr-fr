...
|Nom<br /><sub>(Portail Azure)</sub> |Description |Effet(s) |Version<br /><sub>(GitHub)</sub> |
|---|---|---|---|
|[Les HSM managés par Azure Key Vault doivent avoir la protection contre la suppression définitive activée](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fc39ba22d-4428-4149-b981-70acb31fc383) |La suppression malveillante d’un HSM managé par Azure Key Vault peut entraîner une perte de données définitive. Une personne malveillante interne à votre organisation peut potentiellement supprimer et vider un HSM managé par Azure Key Vault. La protection contre la suppression définitive vous protège des attaques internes en appliquant une période de conservation obligatoire pour les HSM managés par Azure Key Vault supprimés de manière réversible. Personne au sein de votre organisation ni chez Microsoft ne peut supprimer définitivement vos HSM managés par Azure Key Vault pendant la période de conservation de la suppression réversible. |Audit, Refuser, Désactivé |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Key%20Vault/ManagedHsm_Recoverable_Audit.json) |
