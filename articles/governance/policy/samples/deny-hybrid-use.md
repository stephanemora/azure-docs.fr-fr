...
description: Cet exemple de définition de stratégie interdit l’utilisation d’Azure Hybrid Use Benefit (AHUB) pour les machines virtuelles et les groupes de machines virtuelles identiques.
ms.date: 01/23/2019
ms.topic: sample
