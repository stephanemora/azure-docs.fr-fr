...
|[Les machines virtuelles doivent être connectées à un espace de travail spécifié](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ff47b5582-33ec-4c5c-87c0-b010a6b2e917) |Signale les machines virtuelles comme non conformes si elles ne journalisent pas sur l'espace de travail Log Analytics spécifié dans l'attribution de stratégie/d'initiative. |AuditIfNotExists, Désactivé |[1.1.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Monitoring/LogAnalytics_WorkspaceMismatch_VM_Audit.json) |
