---
title: Exemple Azure Policy - Références (SKU) de comptes de stockage autorisées
description: Cet exemple de stratégie exige que les comptes de stockage utilisent une référence (SKU) approuvée.
