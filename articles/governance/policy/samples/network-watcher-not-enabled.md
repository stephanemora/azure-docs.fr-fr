...
description: Cet exemple de définition de stratégie vérifie si Network Watcher n’est pas activé pour une région spécifiée définie dans un paramètre.
ms.date: 01/23/2019
ms.topic: sample
