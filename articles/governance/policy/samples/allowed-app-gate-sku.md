---
title: Exemple Azure Policy - Références (SKU) de passerelles d’application autorisées
description: Pour cet exemple de stratégie, les passerelles d’application doivent utiliser une référence approuvée.
