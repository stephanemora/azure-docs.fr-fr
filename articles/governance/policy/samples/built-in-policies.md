...
## <a name="app-platform"></a>Plateforme d’application
...
## <a name="custom-provider"></a>Fournisseur personnalisé
...
## <a name="healthcare-apis"></a>API Healthcare
...
## <a name="vm-image-builder"></a>Générateur d’images de machine virtuelle
