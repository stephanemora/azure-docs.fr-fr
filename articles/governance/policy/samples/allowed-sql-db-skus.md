---
title: Exemple Azure Policy - Références (SKU) de base de données SQL autorisées
description: Cet exemple de stratégie exige que les bases de données SQL utilisent une référence (SKU) approuvée.
