...
description: Cet exemple de définition de stratégie exige que les machines virtuelles et les groupes de machines virtuelles identiques utilisent des disques managés.
ms.date: 01/23/2019
ms.topic: sample
