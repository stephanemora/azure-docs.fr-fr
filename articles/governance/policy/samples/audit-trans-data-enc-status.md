---
title: Exemple Azure Policy - Auditer l’état du chiffrement transparent des données
description: Cet exemple de stratégie audite le chiffrement transparent des données des bases de données SQL s’il n’est pas activé.
