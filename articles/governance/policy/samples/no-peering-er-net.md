---
title: Exemple Azure Policy - Aucun appairage réseau à un réseau ER
description: Cet exemple de stratégie empêche l’association d’un appairage réseau à un réseau dans un groupe de ressources spécifique.
