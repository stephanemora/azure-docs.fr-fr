...
description: Cet exemple de définition de stratégie garantit que seuls les types de ressources approuvés définis dans un paramètre sont déployés.
ms.date: 01/23/2019
ms.topic: sample
