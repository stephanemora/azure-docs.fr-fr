---
title: Exemple Azure Policy - Exiger le chiffrement du compte de stockage
description: Cet exemple de stratégie exige que le compte de stockage utilise le chiffrement des objets blob.
