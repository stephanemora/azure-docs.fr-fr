...
Une analyse d’évaluation d’un abonnement ou d’un groupe de ressources peut être démarrée avec Azure CLI, Azure PowerShell ou un appel à l’API REST. Il s’agit d’un processus asynchrone.
