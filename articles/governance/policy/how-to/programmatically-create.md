...
Cet article vous explique comment créer et gérer des stratégies par programmation. Azure définitions de stratégie appliquent différentes règles et les effets sur vos ressources. Cette mise en conformité permet de garantir que les ressources restent conformes à vos normes d’entreprise et contrats de niveau de service.
...
1. Inscrire le fournisseur de ressources Azure Policy Insights à l’aide d’Azure PowerShell pour valider que votre abonnement fonctionne avec le fournisseur de ressources. Pour inscrire un fournisseur de ressources, vous devez être autorisé à exécuter l’opération d’inscription pour le fournisseur de ressources. Cette opération est incluse dans les rôles de contributeur et de propriétaire. Exécutez la commande suivante pour enregistrer le fournisseur de ressources :
...
1. Créez la définition de stratégie à l’aide de l’un des appels suivants :
   ...
   Pour plus d’informations sur la structure de la requête, consultez [les définitions de stratégie de Azure – Create ou Update](/rest/api/resources/policydefinitions/createorupdate) et [des définitions de stratégie – créer ou mise à jour au groupe d’administration](/rest/api/resources/policydefinitions/createorupdateatmanagementgroup)
...
- [Fournisseur de ressources Policy Insights Azure référence d’API REST](/rest/api/policy-insights)
