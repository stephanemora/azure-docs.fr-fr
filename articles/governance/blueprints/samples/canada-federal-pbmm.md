---
title: Exemple de blueprint Canada Federal PBMM
description: Vue d’ensemble de l’exemple de blueprint Canada Federal PBMM. Cet exemple de blueprint aide les clients à évaluer des contrôles spécifiques.
ms.date: 05/04/2021
ms.topic: sample
...
ms.locfileid: "108776038"
---
# <a name="canada-federal-pbmm-blueprint-sample"></a>Exemple de blueprint Canada Federal PBMM

L’exemple de blueprint Canada Federal PBMM fournit des garde-fous de gouvernance avec [Azure Policy](../../policy/overview.md), qui vous aident à évaluer des contrôles [Canada Federal PBMM](https://www.canada.ca/en/government/system/digital-government/digital-government-innovations/cloud-services/government-canada-security-control-profile-cloud-based-it-services.html) spécifiques. Avec ce blueprint, les clients peuvent déployer un ensemble de stratégies pour toute architecture déployée par Azure devant implémenter des contrôles pour Canada Federal PBMM.

## <a name="control-mapping"></a>Correspondance des contrôles

Le [mappage de contrôles Azure Policy](../../policy/samples/canada-federal-pbmm.md) fournit des détails sur les définitions de stratégie incluses dans ce blueprint et sur la façon dont ces définitions de stratégie sont mappées aux **contrôles** dans le framework Canada Federal PBMM. Quand des ressources sont attribuées à une architecture, elles sont évaluées par Azure Policy pour savoir si elles sont en conformité avec les stratégies affectées. Pour plus d’informations, consultez [Présentation d’Azure Policy](../../policy/overview.md).

## <a name="deploy"></a>Déployer

Pour déployer l’exemple de blueprint Canada Federal PBMM pour Azure Blueprints, vous devez effectuer les étapes suivantes :
...
1. Recherchez l’exemple de blueprint **Canada Federal PBMM** sous _Autres exemples_ et sélectionnez **Utiliser cet exemple**.

1. Entrez les _Fonctions de base_ de l’exemple de blueprint :

   - **Nom du blueprint** : Donnez un nom à votre copie de l’exemple de blueprint Canada Federal PBMM.
