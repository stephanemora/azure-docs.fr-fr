---
title: Déployer l’exemple de blueprint Azure Security Benchmark
description: Étapes de déploiement pour l’exemple de blueprint Azure Security Benchmark et informations détaillées sur les paramètres d’artefact de blueprint.
ms.date: 05/01/2020
ms.topic: sample
...
ms.locfileid: "82702670"
---
# <a name="deploy-the-azure-security-benchmark-blueprint-sample"></a>Déployer l’exemple de blueprint Azure Security Benchmark
...
|-|-|-|-|
|Auditer les recommandations d’Azure Security Benchmark et déployer des extensions de machine virtuelle de prise en charge spécifiques|Affectation de rôle|
Liste des utilisateurs exclus du groupe Administrateurs de machine virtuelle Windows|Liste séparée par des points-virgules des membres qui doivent être exclus du groupe Administrateurs local. Exemple : Administrator; myUser1; myUser2|
...
Maintenant que vous avez passé en revue les étapes de déploiement de l’exemple de blueprint Azure Security Benchmark, consultez les articles suivants pour découvrir plus d’informations sur le blueprint et le mappage des contrôles :

> [!div class="nextstepaction"]
> [Blueprint Azure Security Benchmark - Vue d’ensemble](./index.md)
> [Blueprint Azure Security Benchmark - Mappage des contrôles](./control-mapping.md)
