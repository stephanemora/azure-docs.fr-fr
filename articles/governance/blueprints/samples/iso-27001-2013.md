...
ms.locfileid: "101741275"
---
# <a name="iso-27001-blueprint-sample"></a>Exemple de blueprint ISO 27001

L’exemple de blueprint ISO 27001 fournit des garde-fous de gouvernance avec [Azure Policy](../../policy/overview.md), qui vous permettent d’évaluer des contrôles ISO 27001 spécifiques. Avec ce blueprint, les clients peuvent déployer un ensemble de stratégies pour toute architecture déployée par Azure devant implémenter des contrôles ISO 27001.
