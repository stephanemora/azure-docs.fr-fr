...
Pour déployer l’exemple de blueprint HIPAA HITRUST, vous devez effectuer les étapes suivantes :
...
Vous venez de passer en revue la procédure de déploiement de l’exemple HIPAA HITRUST. Consultez à présent les articles suivants pour obtenir une vue d’ensemble et découvrir le mappage des contrôles :

> [!div class="nextstepaction"]
> [Blueprints HIPAA HITRUST - Vue d’ensemble](./index.md)
> [Blueprints HIPAA HITRUST - Mappage des contrôles](./control-mapping.md)
