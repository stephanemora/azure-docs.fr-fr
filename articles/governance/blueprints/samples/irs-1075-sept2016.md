---
title: Exemple de blueprint IRS 1075 de septembre 2016
description: Vue d’ensemble de l’exemple de blueprint IRS 1075 de septembre 2016. Cet exemple de blueprint aide les clients à évaluer des contrôles spécifiques.
ms.date: 05/04/2021
ms.topic: sample
...
ms.locfileid: "108776036"
---
# <a name="irs-1075-september-2016-blueprint-sample"></a>Exemple de blueprint IRS 1075 de septembre 2016

L’exemple de blueprint IRS 1075 de septembre 2016 fournit des garde-fous de gouvernance avec [Azure Policy](../../policy/overview.md), qui vous permettent d’évaluer des contrôles [IRS 1075 de septembre 2016](https://www.irs.gov/pub/irs-pdf/p1075.pdf) spécifiques. Avec ce blueprint, les clients peuvent déployer un ensemble de stratégies pour toute architecture déployée par Azure devant implémenter des contrôles pour IRS 1075 de septembre 2016.

## <a name="control-mapping"></a>Correspondance des contrôles

Le [mappage de contrôles Azure Policy](../../policy/samples/irs-1075-sept2016.md) fournit des détails sur les définitions de stratégie incluses dans ce blueprint et sur la façon dont ces définitions de stratégie sont mappées aux **contrôles** dans le framework IRS 1075 de septembre 2016. Quand des ressources sont attribuées à une architecture, elles sont évaluées par Azure Policy pour savoir si elles sont en conformité avec les stratégies affectées. Pour plus d’informations, consultez [Présentation d’Azure Policy](../../policy/overview.md).

## <a name="deploy"></a>Déployer

Pour déployer l’exemple de blueprint Azure Blueprints IRS 1075 de septembre 2016, vous devez effectuer les étapes suivantes :
...
1. Recherchez l’exemple de blueprint **IRS 1075 de septembre 2016** sous _Autres exemples_, puis sélectionnez **Utiliser cet exemple**.

1. Entrez les _Fonctions de base_ de l’exemple de blueprint :

   - **Nom du blueprint** : entrez un nom pour votre copie de l’exemple de blueprint IRS 1075 de septembre 2016.
