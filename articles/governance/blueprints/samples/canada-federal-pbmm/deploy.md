...
ms.locfileid: "74544597"
---
# <a name="deploy-the-canada-federal-pbmm-blueprint-samples"></a>Déployer les exemples de blueprint Canada Federal PBMM

Pour déployer les exemples de blueprint Canada Federal PBMM, vous devez effectuer les étapes suivantes :
...
Vous venez de passer en revue la procédure de déploiement de l’exemple Canada Federal PBMM. Consultez à présent les articles suivants pour obtenir une vue d’ensemble et découvrir le mappage des contrôles :

> [!div class="nextstepaction"]
> [Blueprints Canada Federal PBMM - Vue d’ensemble](./index.md)
> [Blueprints Canada Federal PBMM - Correspondance des contrôles](./control-mapping.md)
