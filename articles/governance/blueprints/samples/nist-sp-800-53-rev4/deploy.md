---
title: Exemple de blueprint NIST SP 800-53 R4 - Étapes de déploiement
description: Étapes de déploiement pour l’exemple de blueprint NIST SP 800-53 R4 et informations détaillées sur les paramètres d’artefact de blueprint.
author: DCtheGeek
ms.author: dacoulte
ms.date: 06/24/2019
ms.topic: sample
...
ms.locfileid: "72297305"
---
# <a name="deploy-the-nist-sp-800-53-r4-blueprint-sample"></a>Déployer l’exemple de blueprint NIST SP 800-53 R4
...
Vous venez de passer en revue la procédure de déploiement de l’exemple de blueprint NIST SP 800-53 R4. Consultez à présent les articles suivants pour en savoir plus sur le blueprint et découvrir la mise en correspondance des contrôles :

> [!div class="nextstepaction"]
> [Blueprint NIST SP 800-53 R4 - Vue d’ensemble](./index.md)
> [Blueprint NIST SP 800-53 R4 - Mappage des contrôles](./control-mapping.md)
