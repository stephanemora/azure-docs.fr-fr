...
- \[Préversion\] : Auditer les comptes externes d’un abonnement qui disposent d’autorisations de lecture
...
- \[Préversion\] : Auditer les restrictions d’accès aux ressources CORS pour une application web
...
- \[Préversion\] : Auditer l’état du débogage à distance pour une application de fonction
- \[Préversion\] : Auditer l’état du débogage à distance pour une application web
- \[Préversion\] : Auditer l’état du débogage à distance pour une application API
- \[Préversion\] : Vérifier que les machines virtuelles Linux n’autorisent pas les connexions à distance à partir des comptes sans mot de passe
- \[Préversion\] : Déployer une extension de machine virtuelle pour vérifier que les machines virtuelles Linux n’autorisent pas les connexions à distance à partir des comptes sans mot de passe
...
- \[Préversion\] : Superviser les serveurs SQL non audités dans Azure Security Center
...
- \[Préversion\] : Vérifier que les machines virtuelles Linux n’ont pas de comptes sans mot de passe
- \[Préversion\] : Déployer une extension de machine virtuelle pour vérifier que les machines virtuelles Linux n’ont pas de comptes sans mot de passe
- \[Préversion\] : Vérifier que les machines virtuelles Linux ont les autorisations de fichier passwd définies sur 0644
- \[Préversion\] : Vérifier que les machines virtuelles Windows stockent les mots de passe à l’aide du chiffrement réversible
- \[Préversion\] : Déployer une extension de machine virtuelle pour vérifier que les machines virtuelles Linux ont les autorisations de fichier passwd définies sur 0644
...
- \[Préversion\] : Vérifier que les machines virtuelles Windows ne peuvent pas réutiliser les 24 mots de passe précédents
- \[Préversion\] : Vérifier que les machines virtuelles Windows ont une antériorité maximale du mot de passe de 70 jours
- \[Préversion\] : Vérifier que les machines virtuelles Windows ont une antériorité minimale du mot de passe de 1 jour
- \[Préversion\] : Vérifier que le paramètre de complexité de mot de passe est activé pour les machines virtuelles Windows
- \[Préversion\] : Vérifier que les machines virtuelles Windows limitent la longueur minimale du mot de passe à 14 caractères
- \[Préversion\] : Vérifier que les machines virtuelles Windows stockent les mots de passe à l’aide du chiffrement réversible
- \[Préversion\] : Déployer une extension de machine virtuelle pour vérifier que les machines virtuelles Windows ne peuvent pas réutiliser les 24 mots de passe précédents
- \[Préversion\] : Déployer une extension de machine virtuelle pour vérifier que les machines virtuelles Windows ont une antériorité maximale du mot de passe de 70 jours
- \[Préversion\] : Déployer une extension de machine virtuelle pour vérifier que les machines virtuelles Windows ont une antériorité minimale du mot de passe de 1 jour
- \[Préversion\] : Déployer une extension de machine virtuelle pour vérifier que le paramètre de complexité de mot de passe est activé pour les machines virtuelles Windows
- \[Préversion\] : Déployer une extension de machine virtuelle pour vérifier que les machines virtuelles Windows limitent la longueur minimale du mot de passe à 14 caractères
- \[Préversion\] : Déployer une extension de machine virtuelle pour vérifier que les machines virtuelles Windows stockent les mots de passe à l’aide du chiffrement réversible
...
- Auditer les serveurs SQL sans Advanced Data Security
- Déployer Advanced Data Security sur des serveurs SQL
- \[Préversion\] : Auditer les vulnérabilités de système d’exploitation de vos groupes de machines virtuelles identiques dans Azure Security Center
...
- \[Préversion\] : Vérifier que le niveau standard de la protection DDoS est activé pour un réseau virtuel
...
- \[Préversion\] : Superviser les machines virtuelles accessibles sur Internet pour fournir des recommandations visant à durcir le trafic du groupe de sécurité réseau
...
- \[Préversion\] : Auditer les mises à jour système manquantes dans les groupes de machines virtuelles identiques dans Azure Security Center
- \[Préversion\] : Auditer les vulnérabilités de système d’exploitation de vos groupes de machines virtuelles identiques dans Azure Security Center
...
- \[Préversion\] : Auditer la solution Endpoint Protection dans les groupes de machines virtuelles identiques dans Azure Security Center
...
Vous venez de passer en revue la mise en correspondance des contrôles du blueprint NIST SP 800-53 R4. Consultez à présent les articles suivants pour en savoir plus sur le blueprint et découvrir comment déployer cet exemple :

> [!div class="nextstepaction"]
> [Blueprint NIST SP 800-53 R4 - Vue d’ensemble](./index.md)
> [Blueprint NIST SP 800-53 R4 - Étapes de déploiement](./deploy.md)
