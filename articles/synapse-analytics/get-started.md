...
* [ÉTAPE 2 – Analyser en utilisant un pool SQL dédié](get-started-analyze-sql-pool.md)
* [ÉTAPE 3 – Analyser avec Apache Spark](get-started-analyze-spark.md)
* [ÉTAPE 4 – Analyser en utilisant un pool SQL serverless](get-started-analyze-sql-on-demand.md)
