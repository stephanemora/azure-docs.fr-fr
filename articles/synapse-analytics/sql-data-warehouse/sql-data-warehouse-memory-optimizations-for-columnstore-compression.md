...
Pour obtenir une présentation détaillée des besoins en mémoire de columnstore, visionnez la vidéo [Mise à l’échelle d’SQL Analytics : configuration et instructions](https://channel9.msdn.com/Events/Ignite/2016/BRK3291).
...
Pour découvrir d’autres façons d’améliorer les performances pour SQL Analytics, consultez [Vue d’ensemble des performances](cheat-sheet.md).
