...
Cet exemple utilise [CREATE TABLE AS SELECT](https://docs.microsoft.com/sql/t-sql/statements/create-table-as-select-azure-sql-data-warehouse?view=aps-pdw-2016-au7) pour recréer une table avec une colonne de distribution par hachage différente.
