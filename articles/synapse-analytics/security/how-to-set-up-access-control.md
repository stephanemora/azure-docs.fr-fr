...
Pour configurer le pare-feu de l’espace de travail, le réseau virtuel et la [Liaison privée](../../sql-database/sql-database-private-endpoint-overview.md).
