...
> [!NOTE]
> Vous devez [activer l’authentification Azure Active Directory](../sql/active-directory-authentication.md) pour vous authentifier à l’aide d’Active Directory.
