---
title: Prise en charge de version Apache Spark pour Azure Synapse Analytics
description: Versions de Spark, Scala, Python prises en charge
...
Le service Apache Spark dans Azure Synapse Analytics prend en charge différents runtimes et services dont les versions sont répertoriées dans ce document.

## <a name="spark-version"></a>Version de Spark

Spark 2.4 est actuellement la version prise en charge.

## <a name="operating-system-version"></a>Version du système d'exploitation

Apache Spark dans Azure Synapse s’exécute sur Ubuntu version 16.04.

## <a name="java-version"></a>Version de Java

Apache Spark dans Azure Synapse inclut la version Java 1.8.0_222

## <a name="scala-version"></a>version de Scala ;

Apache Spark dans Azure Synapse inclut Scala 2.11.12

## <a name="net-core-version"></a>Version .NET Core

Apache Spark dans Azure Synapse inclut .NET Core 3.0

## <a name="net-support-for-apache-spark"></a>Prise en charge de .NET pour Apache Spark

Azure Synapse inclut la prise en charge de .NET pour Apache Spark 0.11.0

## <a name="delta-lake"></a>Delta Lake

Synapse Analytics inclut la prise en charge de Delta Lake 0.6.0

## <a name="python-version"></a>Version Python

Apache Spark dans Azure Synapse inclut une installation de Python version 3.6.1
