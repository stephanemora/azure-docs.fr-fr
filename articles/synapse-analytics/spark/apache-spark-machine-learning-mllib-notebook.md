...
1. Créez un bloc-notes à l’aide du noyau PySpark. Pour obtenir des instructions, consultez [Créer un bloc-notes](./apache-spark-notebook-create-spark-use-sql.md#create-a-notebook).
