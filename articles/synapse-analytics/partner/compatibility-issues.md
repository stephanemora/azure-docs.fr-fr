...
* [Éléments de langage T-SQL pour le pool SQL dédié dans Azure Synapse Analytics.](../sql-data-warehouse/sql-data-warehouse-reference-tsql-language-elements.md)
* [Instructions T-SQL prises en charge pour un pool SQL dédié dans Azure Synapse Analytics.](../sql-data-warehouse/sql-data-warehouse-reference-tsql-statements.md)