---
title: Créer une bibliothèque de contenu pour déployer des machines virtuelles dans Azure VMware Solution (AVS)
...
> * Charger une image ISO dans la bibliothèque de contenu
> * Déployer une machine virtuelle à l’aide d’une image ISO dans la bibliothèque de contenu
...
1. Cliquez sur le bouton **Ajouter** pour créer une bibliothèque de contenu.

   ![Cliquez sur le bouton Ajouter pour créer une bibliothèque de contenu.](./media/content-library/create-new-content-library.png)
