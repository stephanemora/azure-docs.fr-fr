...
* [Étape 1. Créer des machines virtuelles ou des groupes de machines virtuelles source et de destination](#step-1-create-source-and-destination-vms-or-vm-groups) : le groupe source comporte une seule machine virtuelle, ou plusieurs machines virtuelles sur lesquelles le trafic est mis en miroir.
...
Sélectionnez l’onglet **Service DNS**, puis **Ajouter**. Entrez les détails, puis sélectionnez **OK**.
