...
Mode d’isolation pour le conteneur. Les valeurs valides sont default, process ou hyperv (uniquement prises en charge pour les conteneurs Windows). Sous Windows 10, seul le mode d’isolation Hyper-V est pris en charge, et le conteneur s’exécute en mode d’isolation Hyper-V, quel que soit son paramètre de mode d’isolation.
|Attribut|Valeur|
|---|---|
|Nom|Isolation|
|use|facultatif|
...
NetworkType. Seul le type « Open » est actuellement pris en charge.
|Attribut|Valeur|
|---|---|
|Nom|NetworkType|
|use|required|
...
#### <a name="port"></a>Port
Le port sera remplacé dans le manifeste de service
|Attribut|Valeur|
|---|---|
|Nom|Port|
|Type|xs:string|
...
Protocole pour le point de terminaison. EndpointCertificate et EndpointBindingPolicy doivent également être déclarés dans le manifeste d’application des points de terminaison HTTPS. Le protocole ne peut pas être modifié ultérieure lors d’une mise à niveau de l’application. 
|Attribut|Valeur|
|---|---|
|Nom|Protocole|
|Type|xs:string|
...
Droits à accorder, par défaut : Read.
|Attribut|Valeur|
|---|---|
|Nom|GrantRights|
|default|Lire|
...
Type de ressource, défini dans le manifeste de service : point de terminaison ou certificat.
|Attribut|Valeur|
|---|---|
|Nom|ResourceType|
|use|facultatif|
