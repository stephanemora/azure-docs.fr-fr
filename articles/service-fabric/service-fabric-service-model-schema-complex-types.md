---
title: Types complexes de schéma XML du modèle de service Azure Service Fabric | Microsoft Docs
...
|Contenu|0 élément(s), 4 attribut(s)|
|défini|au niveau global|
|Nom|ConfigPackageDescriptionType|
...
|Attribut|Valeur|
|---|---|
|Contenu|10 élément(s), 8 attribut(s)|
|défini|au niveau global|
...
|Attribut|Valeur|
|---|---|
|Nom|UseDefaultRepositoryCredentials|
|Type|xs:string|
|use|facultatif|
|default|false|
...
|Attribut|Valeur|
|---|---|
|Nom|UseTokenAuthenticationCredentials|
|Type|xs:string|
|use|facultatif|
|default|false|
...
|Contenu|0 élément(s), 1 attribut(s)|
|défini|au niveau global|
|Nom|ContainerNetworkPolicyEndpointBindingType|
...
|Contenu|1 élément(s), 1 attribut(s)|
|défini|au niveau global|
|Nom|ContainerNetworkPolicyType|
...
|Attribut|Valeur|
|---|---|
|Contenu|4 élément(s), 10 attribut(s)|
|défini|au niveau global|
...
Étiquettes pour les conteneurs avec la forme clé = valeur.
...
|Contenu|0 élément(s), 3 attribut(s)|
|défini|au niveau global|
|Nom|EnvironmentVariableOverrideType|
...
|Attribut|Valeur|
|---|---|
|Contenu|21 élément(s), 0 attribut|
|défini|au niveau global|
...
|Attribut|Valeur|
|---|---|
|Contenu|0 élément, 12 attribut(s)|
|défini|au niveau global|
...
|Contenu|0 élément(s), 2 attribut(s)|
|défini|au niveau global|
|Nom|ServiceFabricRuntimeAccessPolicyType|
...
|Attribut|Valeur|
|---|---|
|Nom|RemoveServiceFabricRuntimeAccess|
|Type|xs:boolean|
|default|false|
...
|Attribut|Valeur|
|---|---|
|Nom|UseServiceFabricReplicatedStore|
|Type|xs:boolean|
|default|false|
...
|Attribut|Valeur|
|---|---|
|Contenu|11 élément(s), 0 attribut|
|défini|au niveau global|
...
|Contenu|1 élément(s), 2 attribut(s)|
|défini|au niveau global|
|Nom|ServicePackageContainerPolicyType|
...
|Attribut|Valeur|
|---|---|
|Contenu|11 élément(s), 4 attribut(s)|
|défini|au niveau global|
