...
#### <a name="os"></a>Os
Version de build du système d’exploitation. Par ex. : 1809 pour RS1
|Attribut|Valeur|
|---|---|
|Type|xs:string|
|Nom|Os|
...
Mémoire totale (mémoire + échange) en Mo.
|Attribut|Valeur|
|---|---|
|Type|xs:string|
|Nom|MemorySwapInMB|
...
Limites logicielles de mémoire en Mo. Cette valeur doit être un entier positif.
|Attribut|Valeur|
|---|---|
|Type|xs:string|
...
Pourcentage utilisable d’UC disponibles (Windows uniquement). Cette valeur doit être un entier positif.
|Attribut|Valeur|
|---|---|
|Type|xs:string|
|Nom|CpuPercent|
...
Taux d’E/S maximum en termes d’E/S par seconde. Cette valeur doit être un entier positif.
|Attribut|Valeur|
|---|---|
|Type|xs:string|
|Nom|MaximumIOps|
...
Bande passante d’E/S maximum. Cette valeur doit être un entier positif.
|Attribut|Valeur|
|---|---|
|Type|xs:string|
...
Poids d’E/S de niveau bloc relatif. Doit être un entier positif compris entre 10 et 1000.
|Attribut|Valeur|
|---|---|
|Type|xs:string|
|Nom|BlockIOWeight|
