...
Décrit les stratégies de réseau, y compris les stratégies de réseau de conteneurs pour le package de service.
...
#### <a name="nodename"></a>NodeName
Nom du nœud où doit s’effectuer la mise à niveau de Fabric
|Attribut|Valeur|
|---|---|
|Nom|NodeName|
|Type|xs:string|
