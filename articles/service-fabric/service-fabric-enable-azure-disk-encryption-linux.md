---
title: Activer le chiffrement de disque pour les clusters Linux Service Fabric | Microsoft Docs
...
2. Vous pouvez procéder vous-même à l’inscription de votre abonnement en exécutant les étapes suivantes : 
```Powershell
...
6. Installez la dernière version du kit [SDK Azure d’Azure PowerShell](https://github.com/Azure/azure-powershell/releases). Les applets de commande ADE de groupe de machines virtuelles identiques permettant d’activer ([Set](https://docs.microsoft.com/en-us/powershell/module/azurerm.compute/set-azurermvmssdiskencryptionextension?view=azurermps-4.4.1)) le chiffrement, de récupérer ([Get](https://docs.microsoft.com/en-us/powershell/module/azurerm.compute/get-azurermvmssvmdiskencryption?view=azurermps-4.4.1)) l’état du chiffrement et de supprimer ([Disable](https://docs.microsoft.com/en-us/powershell/module/azurerm.compute/disable-azurermvmssdiskencryption?view=azurermps-4.4.1)) le chiffrement sur une instance de groupe identique sont les suivantes. 
...
* Les opérations de mise à niveau et de réimageage des machines virtuelles de groupes de machines virtuelles identiques ne sont pas prises en charge dans la préversion actuelle.
...
De plus, l’utilisateur peut se connecter à une machine virtuelle du cluster Linux et exécuter la commande LSBLK. La sortie doit indiquer ce disque de données ajouté dans la colonne du point de montage et Crypt dans la colonne Type pour le disque de données ajouté.
