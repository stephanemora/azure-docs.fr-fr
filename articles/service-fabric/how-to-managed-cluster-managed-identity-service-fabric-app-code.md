---
title: Utiliser une identité managée avec une application sur un cluster managé Service Fabric
description: Comment utiliser des identités managées dans du code d’application Azure Service Fabric pour accéder aux services Azure sur un cluster managé Service Fabric.
ms.topic: article
ms.date: 5/10/2021
...
ms.locfileid: "109689274"
---
# <a name="how-to-leverage-a-service-fabric-applications-managed-identity-to-access-azure-services-on-a-service-fabric-managed-cluster"></a>Comment tirer parti de l’identité managée d’une application Service Fabric pour accéder aux services Azure sur un cluster managé Service Fabric
...
- [Java version 1.2.0](/java/api/overview/azure/identity-readme).
...
* [Accorder à une application Azure Service Fabric l’accès à d’autres ressources Azure](./how-to-managed-cluster-grant-access-other-resources.md)
