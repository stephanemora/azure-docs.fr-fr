---
title: Groupes d’éléments du schéma XML du modèle de service Azure Service Fabric | Microsoft Docs
...
Définit un mécanisme permettant d’accroître le nombre d’instances d’une partition. Cela concerne uniquement les services sans état.
|Attribut|Valeur|
|---|---|
|maxOccurs|1|
...
Définit un mécanisme pour ajouter ou supprimer des partitions nommées.
|Attribut|Valeur|
|---|---|
|maxOccurs|1|
