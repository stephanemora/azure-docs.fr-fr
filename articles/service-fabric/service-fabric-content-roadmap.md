...
* Requêtes d’intégrité (par l’intermédiaire de [PowerShell](/powershell/module/servicefabric/?preserve-view=true&view=azureservicefabricps), de [l’interface CLI](service-fabric-sfctl.md), des [API FabricClient C#](/dotnet/api/system.fabric.fabricclient.healthclient) et des [API FabricClient Java](/java/api/system.fabric), ou des [API REST](/rest/api/servicefabric)).
