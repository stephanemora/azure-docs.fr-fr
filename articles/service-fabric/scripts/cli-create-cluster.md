...
Si nécessaire, installez l’Interface de ligne de commande Azure ([Azure CLI](/en-us/cli/azure/install-azure-cli)).
...
| Commande | Notes |
|---|---|
| [az sf cluster create](/cli/azure/sf/cluster) | Crée un cluster Service Fabric.  |
