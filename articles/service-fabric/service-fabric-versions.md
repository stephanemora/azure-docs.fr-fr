...
Les clusters Azure Service Fabric qui s’exécutent sur des versions inchangées ultérieures à la version 6.3 subiront une perte de fonctionnalités ou des interruptions de service s’ils n’ont pas été mis à niveau vers une version prise en charge avant le 19 janvier 2021.
 ...
 - **Pour les clusters exécutant une version de Service Fabric ultérieure à la version 6.3 et utilisant la [fonctionnalité de mise en réseau ouvert pour les conteneurs](./service-fabric-networking-modes.md#set-up-open-networking-mode)** , le cluster peut devenir indisponible et cesser de fonctionner, ce qui peut entraîner des interruptions de service pour vos charges de travail.
 
 -   **Pour les clusters exécutant une [version de Windows entre les versions 7.0.457 et 7.0.466 (incluses)](#supported-version-names) et le système d’exploitation Windows, la fonctionnalité de conteneurs Windows est activée. REMARQUE : Les versions 7.0.457, 7.0.464 et 7.0.465 de Linux ne sont PAS concernées**.
...
| 7.1.409.* | 7.0.466.* |Inférieure ou égale à la version 4.1 |31 juillet 2021 |
| 7.1.417.* | 7.0.466.* |Inférieure ou égale à la version 4.1 |31 juillet 2021 |
| 7.1.428.* | 7.0.466.* |Inférieure ou égale à la version 4.1 |31 juillet 2021 |
| 7.1.456.* | 7.0.466.* |Inférieure ou égale à la version 4.1 |31 juillet 2021 |
| 7.1.458.* | 7.0.466.* |Inférieure ou égale à la version 4.1 |31 juillet 2021 |
| 7.1.459.* | 7.0.466.* |Inférieure ou égale à la version 4.1 |31 juillet 2021 |
| 7.1.503.* | 7.0.466.* |Inférieure ou égale à la version 4.1 |31 juillet 2021 |
| 7.1.510.* | 7.0.466.* |Inférieure ou égale à la version 4.1 |31 juillet 2021 |
| 7.2.413.* | 7.0.470.* |Inférieure ou égale à la version 4.2 |30 novembre 2021 |
| 7.2.432.* | 7.0.470.* |Inférieure ou égale à la version 4.2 |30 novembre 2021 |
| 7.2.433.* | 7.0.470.* |Inférieure ou égale à la version 4.2 |30 novembre 2021 |
| 7.2.445.* | 7.0.470.* |Inférieure ou égale à la version 4.2 |30 novembre 2021 |
| 7.2.452.* | 7.0.470.* |Inférieure ou égale à la version 4.2 |30 novembre 2021 |
| 7.2.457.* | 7.0.470.* |Inférieure ou égale à la version 4.2 |30 novembre 2021 |
| 7.2.477.* | 7.0.478.* |Inférieure ou égale à la version 4.2 |30 novembre 2021 |
| 8.0.514.* | 7.1.510.* |Inférieure ou égale à la version 5.0 |Version actuelle ; par conséquent, pas de date de fin |
