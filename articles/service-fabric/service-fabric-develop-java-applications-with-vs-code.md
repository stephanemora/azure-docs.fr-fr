...
5. Quand vous avez terminé le débogage, vous pouvez utiliser la commande **Service Fabric : supprimer une application** pour supprimer l’application Voting de votre cluster local. 
