---
title: Descriptions du schéma XML du Modèle de service Azure Service Fabric
description: Description du schéma XML du Modèle de service Service Fabric, y compris l’emplacement et un résumé des composants.
ms.topic: reference
ms.date: 12/10/2018
...
ms.locfileid: "75639188"
---
<!-- The schema reference articles were generated by the Python script found in the end of this file -->

# <a name="service-model-xml-schema-documentation"></a>Documentation du schéma XML du modèle de service
Cet article décrit le fichier de schéma ServiceFabricServiceModel.xsd installé avec le SDK Service Fabric.  Par défaut, le fichier de schéma est installé dans *C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd*.

## <a name="namespace-bindings"></a>Liaisons d’espaces de noms

|Préfixe|URI d’espace de noms|
|---|---|
|xs|`https://www.w3.org/2001/XMLSchema`|

## <a name="component-summary"></a>Résumé du composant 
Les composants suivants sont définis dans ServiceFabricServiceModel.xsd :
- [257 éléments](service-fabric-service-model-schema-elements.md)
...
- [3 groupes d’éléments](service-fabric-service-model-schema-element-groups.md)
- [16 groupes d’attributs](service-fabric-service-model-schema-attribute-groups.md)
