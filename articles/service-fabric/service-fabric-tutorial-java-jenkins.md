...
1. Extrayez l’image du conteneur Jenkins de Service Fabric : `docker pull mcr.microsoft.com/azuredocs/jenkins:v10`. Cette image est fournie avec le plug-in Jenkins de Service Fabric préinstallé.
