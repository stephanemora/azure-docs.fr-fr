...
|[Configurer l’authentification au registre de conteneurs](service-fabric-get-started-containers.md#configure-container-registry-authentication)|[Manifeste de l’application de conteneur](service-fabric-manifest-example-container-app.md#application-manifest)|
