---
title: Vue d’ensemble de la documentation de référence d’Azure Communication Services
titleSuffix: An Azure Communication Services concept document
description: Découvrez la documentation de référence de Communication Services.
author: mikben
manager: jken
...
ms.locfileid: "103495723"
---
# <a name="reference-documentation-overview"></a>Vue d’ensemble de la documentation sur les références

[!INCLUDE [Public Preview Notice](../includes/public-preview-include.md)]


Le tableau suivant détaille les packages Communication Services disponibles, ainsi que la documentation de référence correspondante :
...
| Appel        | [npm](https://www.npmjs.com/package/@azure/communication-calling)         | -      | -      | -     | [GitHub](https://github.com/Azure/Communication/releases) ([docs](/objectivec/communication-services/calling/))     | [Maven](https://search.maven.org/artifact/com.azure.android/azure-communication-calling/)            | -                              |
