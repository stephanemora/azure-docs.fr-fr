...
Apprenez-en davantage sur la [gestion des événements dans Azure Communication Services](https://docs.microsoft.com/azure/event-grid/event-schema-communication-services).
