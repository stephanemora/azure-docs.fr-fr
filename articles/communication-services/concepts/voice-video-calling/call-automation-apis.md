...
ms.locfileid: "110468628"
---
# <a name="call-automation-apis-overview"></a>Vue d’ensemble des API d’automatisation des appels

[!INCLUDE [Private Preview Notice](../../includes/private-preview-include.md)]

Les API d’automatisation des appels permettent aux organisations de se connecter à grande l’échelle à leurs clients ou leurs employés par le biais d’une logique métier automatisée. Vous pouvez utiliser ces API pour créer des appels sortants automatisés de rappel de rendez-vous, ou pour fournir des notifications préventives concernant des événements tels que des coupures de courant ou des incendies de forêt. Les applications ajoutées à un appel peuvent superviser les mises à jour au fur et à mesure de l’arrivée ou du départ de participants, ce qui vous permet d’implémenter de riches fonctionnalités de création de rapports et de journalisation. 

## <a name="in-call-apis"></a>API In-Call

> [!NOTE] 
> Les applications In-Call sont facturées en tant que participants à l’appel, aux tarifs RTC et VoIP standard.
                                                        

### <a name="create-call"></a>Créer un appel
...
```
### <a name="play-audio-in-call"></a>Lire l’audio dans l’appel
#### <a name="request"></a>Requête
**HTTP**
<!-- {
  "blockType": "request",
...
```
### <a name="invite-participant"></a>Inviter un participant
#### <a name="request"></a>Requête
**HTTP**
<!-- {
  "blockType": "request",
...
```
### <a name="remove-participant"></a>Retirer un participant
#### <a name="request"></a>Requête
**HTTP**
<!-- {
  "blockType": "request",
...
Les notifications des événements sont envoyées en tant que charges utiles JSON à l’application appelante par le biais du `callbackUri` défini lors de la demande de création d’appel.

### <a name="callstate-event---establishing"></a>Événement CallState - Établissement
```
{
        "id": null,
        "topic": null,
...
```
### <a name="callstate-event---established"></a>Événement CallState - Établi
```
{
        "id": null,
        "topic": null,
...
### <a name="callstate-event---terminating"></a>Événement CallState - En cours d’arrêt
```
{
        "id": null,
        "topic": null,
...
### <a name="callstate-event---terminated"></a>Événement CallState - Terminé
```
{
        "id": null,
        "topic": null,
...
### <a name="dtmf-received-event"></a>Événement DTMF reçu
```
{
        "id": null,
        "topic": null,
...
### <a name="playaudioresult-event"></a>Événement PlayAudioResult
```
{
        "id": null,
        "topic": null,
...
### <a name="cancel-media-processing-event"></a>Événement d’annulation du traitement multimédia
```
{
        "id": null,
        "topic": null,
...
### <a name="invite-participant-result-event"></a>Événement de résultat de l’invitation d’un participant
```
{
...
### <a name="participants-updated-event"></a>Événement de mise à jour des participants
```
{
    "id": null,
    "topic": null,
...
> [!NOTE] 
> Le conversationID dans toutes les API hors appel peut provenir du client ou du groupID d’un appel de groupe.

### <a name="join-call"></a>Rejoindre un appel
#### <a name="request"></a>Requête
**HTTP**
<!-- {
  "blockType": "request",
...
### <a name="invite-participants"></a>Inviter des participants
#### <a name="request"></a>Requête
**HTTP**
<!-- {
  "blockType": "request",
...
Pour plus d’informations, consultez notre [exemple](https://github.com/Azure/communication-preview/tree/master/samples/Server-Calling/IncidentReporter).
