---
title: Guide pratique pour signer une requête HTTP avec C#
titleSuffix: An Azure Communication Services tutorial
description: Découvrez comment signer une requête HTTP avec Communication Services via C#
author: alexandra142
manager: soricos
