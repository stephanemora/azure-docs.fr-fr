---
title: Découvrir comment signer une requête HTTP avec C#
titleSuffix: An Azure Communication Services tutorial
description: Découvrez comment signer une requête HTTP avec Azure Communication Services via C#.
author: alexandra142
manager: soricos
