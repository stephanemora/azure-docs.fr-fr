...
Les clients de numéro de téléphone peuvent être authentifiés à l’aide de la chaîne de connexion obtenue à partir d’une ressource Azure Communication dans le [portail Azure] [azure_portal].
