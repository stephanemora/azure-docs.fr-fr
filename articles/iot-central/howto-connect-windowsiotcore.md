...
Pour configurer un appareil Windows IoT Core, suivez le guide pas à pas pour [Configurer un appareil Windows IoT Core] (https://github.com/Microsoft/microsoft-iot-central-firmware/tree/master/WindowsIoT#setup-a-physical-device).
...
Pour configurer un appareil Windows 10 IoT Core physique, vous devez d’abord disposer d’un appareil exécutant Windows 10 IoT Core. Découvrez [ici](https://developer.microsoft.com/en-us/windows/iot/getstarted/prototype/setupdevice) comment configurer un appareil Windows 10 IoT Core.
...
Une fois que vous avez fait cela, vous devez ouvrir le [Portail d’appareil Windows](https://docs.microsoft.com/en-us/windows/iot-core/manage-your-device/deviceportal) en tapant http://[adresse_IP_appareil]:8080 dans n’importe quel navigateur.
