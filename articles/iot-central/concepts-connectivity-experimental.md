...
1. Utilisez ces informations de connexion (**Identité d’appareil, Nom de l’appareil et Clé primaire de l’appareil**) dans le code de votre appareil pour l’approvisionner et le connecter, et constater l’afflux instantané des données. Si vous utilisez l’appareil MxChip, suivez [les instructions pas à pas ici](howto-connect-devkit-experimental.md#add-a-real-device). Commencez par la section **Préparer l’appareil DevKit**.   
    ...
    *   **Node.js :**  si vous voulez utiliser Node.js, [suivez les instructions pas à pas ici](tutorial-add-device-experimental.md#prepare-the-client-code), commencez par la section **Préparer le code client**.
...
Si vous utilisez l’appareil **MxChip** pour vous connecter, suivez les [instructions pas à pas ici](howto-connect-devkit-experimental.md#add-a-real-device). Commencez par la section **Préparer l’appareil DevKit**.   
...
- [Connecter un client Node.js générique à votre application Azure IoT Central](howto-connect-nodejs-experimental.md)
- [Connecter un appareil Raspberry Pi à votre application Azure IoT Central](howto-connect-raspberry-pi-python.md)
- [Connecter un appareil du kit DevDiv à votre application Azure IoT Central](howto-connect-devkit-experimental.md).
...
- [Préparer et connecter un appareil DevKit](howto-connect-devkit-experimental.md)
