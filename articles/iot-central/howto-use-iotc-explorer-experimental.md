...
1. Cliquez sur **Générer**.
    ![Capture d’écran de la page Jeton accès](media/howto-use-iotc-explorer-experimental/accesstokenspage.png)
...
1. Entrez un nom de jeton, cliquez sur **Suivant**, puis **copiez la valeur du jeton**.
    ...
    ![Copier la capture d’écran de la boîte de dialogue du jeton accès](media/howto-use-iotc-explorer-experimental/copyaccesstoken.png)
...
![sortie de la commande monitor-messages](media/howto-use-iotc-explorer-experimental/monitormessages.png)
...
![sortie de la commande get-twin](media/howto-use-iotc-explorer-experimental/getdevicetwin.png)
...
Maintenant que vous avez appris à utiliser IoT Central Explorer, l’étape suivante conseillée consiste à explorer la [Gestion des appareils IoT Central](howto-manage-devices-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
