...
1. Choisissez **Appareils** dans le menu de navigation gauche. Vous y voyez la liste complète de vos appareils et modèles d’appareils.
...
1. Le volet droit de la page **Appareils** présente la liste des appareils créés à partir de ce modèle d’appareils. Choisissez un des appareils pour afficher la page de détails correspondante :
    ...
    ![Page Détails de l’appareil](./media/howto-manage-devices-pnp/devicelist.png)
...
1. Choisissez **Appareils** dans le menu de navigation gauche.
...
1. Sélectionnez **Importer**.
    ...
    ![Action d’importation](./media/howto-manage-devices-pnp/bulkimport1a.png)
...
1. Une fois l’importation terminée, un message de réussite s’affiche dans le volet Opérations sur les appareils.
    ...
    ![Importation réussie](./media/howto-manage-devices-pnp/bulkimport3a.png)
...
1. Dans le volet gauche, choisissez **Tous les appareils** :
    ...
    ![Appareils non associés](./media/howto-manage-devices-pnp/unassociateddevices1a.png)
...
1. Sélectionnez **Migrer** :
    ...
    ![Associer des appareils](./media/howto-manage-devices-pnp/unassociateddevices2a.png)
...
1. Sélectionnez les appareils que vous souhaitez exporter, puis l’action **Exporter**.
    ...
    ![Exportation](./media/howto-manage-devices-pnp/export1a.png)
...
1. Cliquez sur le lien **Télécharger le fichier** pour télécharger le fichier vers un dossier local sur le disque.
    ...
    ![Exportation réussie](./media/howto-manage-devices-pnp/export2a.png)
...
Pour plus d’informations sur les chaînes de connexion et la connexion d’appareils réels à votre application IoT Central, consultez [Connectivité des appareils dans Azure IoT Central](concepts-connectivity-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
...
1. Choisissez **Appareils** dans le menu de navigation.
...
> [Comment utiliser des ensembles d’appareils](howto-use-device-groups-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
