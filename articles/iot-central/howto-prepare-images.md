...
Pour charger une image sur un modèle d’appareil, accédez à **Device Explorer** et choisissez le modèle d’appareil, puis un appareil. Vous devez être concepteur pour effectuer cette tâche :
...
Pour charger une image sur un tableau de bord d’appareil, accédez à **Device Explorer** et choisissez le modèle d’appareil, puis un appareil. Choisissez ensuite la page **Tableau de bord** et cliquez sur **Modifier un modèle**. Vous devez être concepteur pour effectuer cette tâche :
