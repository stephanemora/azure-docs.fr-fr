...
1. Choisissez **Ensembles d’appareils** dans le volet gauche.
...
L’analytique des ensembles d’appareils est identique à celle de l’onglet d’analytique principal dans le volet de gauche. Pour plus d’informations sur l’analytique, consultez [Comment créer une analytique](howto-use-device-sets.md).
