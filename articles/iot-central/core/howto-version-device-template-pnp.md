...
ms.locfileid: "72990339"
---
# <a name="create-a-new-device-template-version-preview-features"></a>Créer une nouvelle version de modèle d’appareil (fonctionnalités de préversion)
...
> [!NOTE]
> Pour en savoir plus sur la création d’un modèle d’appareil, consultez [Configurer et gérer un modèle d’appareil](howto-set-up-template-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
...
![Comment migrer un appareil](media/howto-version-device-template-pnp/pick-version.png)
...
> [Guide pratique pour créer des règles de télémétrie](tutorial-create-telemetry-rules-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
