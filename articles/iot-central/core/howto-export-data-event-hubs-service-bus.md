...
2. Dans le volet gauche, sélectionnez **Exportation continue de données**.

    > [!Note]
    > Si l’option Exportation continue de données n’apparaît pas dans le volet gauche, la raison en est que vous n’êtes pas l’administrateur de votre application. Contactez un administrateur pour configurer l’exportation de données.
