---
title: 'Didacticiel : Personnaliser les vues de l’opérateur dans Azure IoT Central'
description: 'Didacticiel : En tant que générateur, personnalisez les vues de l’opérateur dans votre application Azure IoT Central.'
author: sandeeppujar
ms.author: sandeepu
ms.date: 11/13/2019
ms.topic: tutorial
...
1. Pour modifier le modèle d’appareil **Climatiseur connecté**, choisissez **Modèles d’appareil** dans le volet de gauche :
