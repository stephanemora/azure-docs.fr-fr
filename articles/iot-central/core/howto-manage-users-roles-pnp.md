...
ms.locfileid: "73468194"
---
# <a name="manage-users-and-roles-in-your-iot-central-application-preview-features"></a>Gérer les utilisateurs et rôles dans votre application Azure IoT Central (fonctionnalités en préversion)
...
1. Pour ajouter un utilisateur à une application IoT Central, accédez à la page **Utilisateurs** dans la section **Administration**.
    ...
    >![Gestion des utilisateurs](media/howto-manage-users-roles-pnp/manage-users-pnp.png)
...
1. Choisissez un rôle pour l’utilisateur dans la liste déroulante **Rôle**. En savoir plus sur les rôles dans la section [Gérer les rôles](#manage-roles) de cet article.
    ...
    > [!div class="mx-imgBorder"]
    >![Ajouter un utilisateur et sélectionner un rôle](media/howto-manage-users-roles-pnp/add-user-pnp.png)
...
> [!div class="mx-imgBorder"]
> ![Gérer la sélection de rôles](media/howto-manage-users-roles-pnp/manage-roles-pnp.png)
...
> [!div class="mx-imgBorder"]
> ![Créer un rôle personnalisé](media/howto-manage-users-roles-pnp/create-custom-role-pnp.png)
...
| Nom | Les dépendances |
| ---- | -------- |
| Affichage | Aucun <br/> Autres dépendances : Afficher les modèles d’appareil et les groupes d’appareils |
| Mettre à jour | Affichage <br/> Autres dépendances : Afficher les modèles d’appareil et les groupes d’appareils  |
| Créer | Affichage <br/> Autres dépendances :  Afficher les modèles d’appareil et les groupes d’appareils  |
| Supprimer | Affichage <br/> Autres dépendances : Afficher les modèles d’appareil et les groupes d’appareils  |
...
| Nom | Les dépendances |
| ---- | -------- |
| Affichage | Aucun <br/> Autres dépendances : Afficher les modèles d’appareil et les instances d’appareils |
| Mettre à jour | Affichage <br/> Autres dépendances : Afficher les modèles d’appareil et les instances d’appareils   |
| Créer | Afficher, Mettre à jour <br/> Autres dépendances :  Afficher les modèles d’appareil et les instances d’appareils   |
| Supprimer | Affichage <br/> Autres dépendances :  Afficher les modèles d’appareil et les instances d’appareils   |
...
| Nom | Les dépendances |
| ---- | -------- |
| Lire l’instance | Aucun <br/> Autres dépendances : Afficher les modèles d’appareil, les groupes d’appareils et les instances d’appareils |
| Gérer l’instance | Aucun |
...
| Nom | Les dépendances |
| ---- | -------- |
| Affichage | Aucun <br/> Autres dépendances : Afficher les modèles d’appareils, les instances d’appareils et les groupes d’appareils |
| Mettre à jour | Affichage <br/> Autres dépendances : Afficher les modèles d’appareils, les instances d’appareils et les groupes d’appareils |
...
| Supprimer | Affichage <br/> Autres dépendances :  Afficher les modèles d’appareils, les instances d’appareils et les groupes d’appareils |
| Exécuter | Affichage <br/> Autres dépendances : Afficher les modèles d’appareils, les instances d’appareils et les groupes d’appareils ; Mettre à jour les instances d’appareils ; Exécuter des commandes sur des instances d’appareils |
...
| Nom | Les dépendances |
| ---- | -------- |
| Affichage | Aucun <br/> Autres dépendances : Afficher les modèles d’appareils |
| Mettre à jour | Affichage <br/> Autres dépendances : Afficher les modèles d’appareils |
| Créer | Afficher, Mettre à jour <br/> Autres dépendances :  Afficher les modèles d’appareils |
| Supprimer | Affichage <br/> Autres dépendances : Afficher les modèles d’appareils |
...
| ---- | -------- |
| Affichage | Aucun     |
| Exportation | Affichage <br/> Autres dépendances :  Afficher les modèles d’appareils, les instances d’appareils, les groupes d’appareils, les tableaux de bord, l’exportation de données, la personnalisation, les liens d’aide, les rôles personnalisés et les règles |
...
| Nom | Les dépendances |
| ---- | -------- |
| Affichage | Aucun <br/> Autres dépendances : Afficher les rôles personnalisés |
| Ajouter | Affichage <br/> Autres dépendances :  Afficher les rôles personnalisés |
| Supprimer | Affichage <br/> Autres dépendances :  Afficher les rôles personnalisés |
...
Maintenant que vous avez appris à gérer les utilisateurs et les rôles dans votre application Azure IoT Central, l’étape suivante suggérée est d’apprendre à [gérer votre facture](howto-view-bill-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
