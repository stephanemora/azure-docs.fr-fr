...
1. Accédez à l’onglet ***Modèles d’appareil*** dans le volet gauche, sélectionnez **+ Nouveau** :  ![Créer un modèle d'appareil](./media/howto-connect-ruuvi/devicetemplate-new.png). La page vous donne la possibilité de ***Créer un modèle personnalisé*** ou d'***Utiliser un modèle d'appareil préconfiguré***.
