...
Pour savoir plus en détails comment configurer le tableau de bord dans une application Azure IoT Central, voir [Ajouter des vignettes à un tableau de bord](./howto-add-tiles-to-your-dashboard.md).
