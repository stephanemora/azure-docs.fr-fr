...
Dans ce guide de démarrage rapide, vous ajoutez un modèle d’appareil pour une carte [*MXChip IoT DevKit* (DevKit)](https://aka.ms/iot-devkit-purchase) et créez un appareil simulé. Pour suivre ce guide de démarrage rapide, vous n’avez pas besoin d’appareil réel, vous travaillez avec un appareil simulé. Un appareil DevKit :
