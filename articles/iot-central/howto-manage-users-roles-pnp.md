...
1. Pour ajouter un utilisateur à une application IoT Central, accédez à la page **Utilisateurs** dans la section **Administration**.
    ...
    ![Liste des utilisateurs](media/howto-manage-users-roles-pnp/image1.png)
...
1. Choisissez un rôle pour l’utilisateur dans la liste déroulante **Rôle**. En savoir plus sur les rôles dans la section [Gérer les rôles](#manage-roles) de cet article.
    ...
    ![Sélection de rôle](media/howto-manage-users-roles-pnp/image3.png)
...
Maintenant que vous avez appris à gérer les utilisateurs et les rôles dans Azure IoT Central, l’étape suivante suggérée consiste à en savoir plus sur l’[affichage de votre facture](howto-view-bill-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) dans Azure IoT Central.
