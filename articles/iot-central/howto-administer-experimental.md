...
![Page Paramètres de l’application](media/howto-administer-experimental/image0-a.png)
...
Pour modifier l’image de l’application, consultez [Préparer et charger des images dans votre application Azure IoT Central](howto-prepare-images-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
...
![Page Paramètres de l’application](media/howto-administer-experimental/appCopy2.png)
...
![Page Paramètres de l’application](media/howto-administer-experimental/appCopy3.png)
...
1. Pour ajouter un utilisateur à une application IoT Central, accédez à la page **Utilisateurs** dans la section **Administration**.
    ...
    ![Liste des utilisateurs](media/howto-administer-experimental/image1.png)
...
1. Choisissez un rôle pour l’utilisateur dans la liste déroulante **Rôle**. En savoir plus sur les rôles dans la section [Gérer les rôles](#manage-roles) de cet article.
    ...
    ![Sélection de rôle](media/howto-administer-experimental/image3.png)
...
1. Accédez à la page **Facturation** de la section **Administration**. 
    ...
    ![État de la version d'évaluation](media/howto-administer-experimental/freetrialbilling.png)

1. Cliquez sur **Convertir en application avec paiement à l'utilisation**. 

    ![Convertir la version d'évaluation](media/howto-administer-experimental/convert.png)
...
> [Configurer le modèle d’appareil](howto-set-up-template-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
