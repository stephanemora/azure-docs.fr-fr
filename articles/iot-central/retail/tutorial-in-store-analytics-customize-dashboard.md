...
1. Sélectionnez **Paramètres du tableau de bord**, entrez un **nom** pour votre tableau de bord, puis sélectionnez **Enregistrer**. 

    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/dashboard-edit.png" alt-text="Modification du tableau de bord Azure IoT Central.":::

    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/new-dashboard.png" alt-text="Nouveau tableau de bord Azure IoT Central.":::
...
1. Sélectionnez **Configurer** sur la vignette d’image qui affiche l’image de marque Northwind. 
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/brand-image-edit.png" alt-text="Modification d’une image de marque Azure IoT Central.":::
...
1. Sélectionnez **Update** (Mettre à jour).
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/brand-image-save.png" alt-text="Enregistrement d’une image de marque Azure IoT Central.":::
...
1. Sélectionnez **Mettre à jour**.
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/store-map-save.png" alt-text="Enregistrement d’une carte de magasin Azure IoT Central.":::
...
1. Sélectionnez les **points de suspension** puis l’option **Supprimer** pour supprimer les vignettes suivantes : **Back to all zones**, **Visit store dashboard**, **Occupancy**, **Warm-up checkout zone**, **Cool-down checkout zone**, **Occupancy sensor settings**, **Thermostat sensor settings** et **Environment conditions**, ainsi que les trois vignettes associées à **Checkout 3**. Le tableau de bord du magasin Contoso n’utilise pas ces vignettes. 

    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/delete-tiles.png" alt-text="Suppression de vignettes Azure IoT Central.":::
...
1. Affichez les modifications apportées à votre disposition. 
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/firmware-battery-tiles.png" alt-text="Vignettes de batterie des microprogrammes Azure IoT Central.":::
...
1. Sélectionnez **Combiner**. 
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/add-zone1-ruuvi.png" alt-text="Ajout de la vignette RuuviTag 1 Azure IoT Central.":::
...
1. Sélectionnez **Enregistrer**. Le tableau de bord affiche les données de télémétrie des zones dans les deux nouvelles vignettes.
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/all-ruuvitag-tiles.png" alt-text="Toutes les vignettes RuuviTag Azure IoT Central.":::
...
1. Sélectionnez **Enregistrer**.  Le tableau de bord mis à jour affiche les nombres pour vos deux zones de caisse uniquement, lesquels sont basés sur la simulation du capteur de présence.
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/people-traffic-two-lanes.png" alt-text="Deux couloirs de fréquentation Azure IoT Central.":::
...
1. Sélectionnez **Enregistrer**.  
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/add-ruuvi-property-tiles.png" alt-text="Vignettes des propriétés RuuviTag Azure IoT Central.":::
...
1. Affichez votre tableau de bord Contoso terminé. 
    ...
    :::image type="content" source="media/tutorial-in-store-analytics-customize-dashboard/completed-dashboard.png" alt-text="Personnalisation complète du tableau de bord Azure IoT Central.":::
