...
1. Si vous disposez d’un abonnement Azure, connectez-vous avec les informations d’identification que vous utilisez pour y accéder. Sinon, connectez-vous à l’aide d’un compte Microsoft :
   ...
   ![Capture d’écran de la boîte de dialogue de connexion avec un compte Microsoft](./media/tutorial-in-store-analytics-create-app-pnp/sign-in.png)
...
1. Sélectionnez le modèle d’application **Centre de microtraitement**. Ce modèle comprend des modèles d’appareil pour tous les appareils utilisés dans le tutoriel. Le modèle fournit aussi un tableau de bord d’opérateur pour superviser l’état de votre centre de traitement ainsi que celui de vos robots porteurs. 
    ...
    ![Capture d’écran de la page Créer votre application IoT dans Azure IoT Central](./media/tutorial-micro-fulfillment-center-app-pnp/iotc-retail-homepage-mfc.png)
...
1. Sélectionnez **Create** (Créer).
    ...
    ![Capture d’écran de la page Nouvelle application dans Azure IoT Central](./media/tutorial-micro-fulfillment-center-app-pnp/iotc-retail-create-app-mfc.png)
...
À partir de ce tableau de bord, vous pouvez :
   ...
   * Déclencher des commandes pour réinitialiser le système de contrôle, mettre à jour le microprogramme du porteur et reconfigurer le réseau, par exemple.
     ...
     ![Capture d’écran du tableau de bord du centre de microtraitement de Northwind Traders](./media/tutorial-micro-fulfillment-center-app-pnp/mfc-dashboard1.png)
   ...
   * Superviser l’intégrité des charges utiles qui s’exécutent sur l’appareil de passerelle au sein du centre de traitement.    
     ...
     ![Capture d’écran du tableau de bord du centre de microtraitement de Northwind Traders](./media/tutorial-micro-fulfillment-center-app-pnp/mfc-dashboard2.png)
...
![Capture d’écran de l’onglet Règles](./media/tutorial-micro-fulfillment-center-app-pnp/rules.png)
...
![Capture d’écran de la page des paramètres de l’application du centre de microtraitement](./media/tutorial-micro-fulfillment-center-app-pnp/delete.png)

## <a name="next-steps"></a>Étapes suivantes
* Découvrez plus en détail l’[architecture des solutions de centre de microtraitement](./architecture-micro-fulfillment-center-pnp.md).
* Découvrez d’autres [modèles de vente au détail Azure IoT Central](./overview-iot-central-retail-pnp.md).
