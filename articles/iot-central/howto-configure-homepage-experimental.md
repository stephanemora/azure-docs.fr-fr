...
![Page d’accueil pour les applications basées sur le modèle « Exemple Contoso »](media/howto-configure-homepage-experimental/image1.png)
...
![Bibliothèque de tableaux de bord](media/howto-configure-homepage-experimental/image2.png)
...
![Formulaire « Configurer les détails de l’appareil » contenant les détails des paramètres et des propriétés](media/howto-configure-homepage-experimental/image3.png)
...
![Onglet « Tableau de bord » où figurent les paramètres et les propriétés de la vignette](media/howto-configure-homepage-experimental/image4.png)
...
> [Découvrir comment préparer et charger des images](howto-prepare-images-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
