...
2. Pour créer un modèle vide, cliquez sur **+**, puis entrez un nom, par exemple **Réfrigérateur**, pour votre nouveau modèle d’appareil. Sélectionnez ensuite **Créer** :

   ![Page de détails de l’appareil ayant « Réfrigérateur » comme nom de modèle](./media/howto-set-up-template-experimental/devicedetailspage.png)

4. Vous êtes maintenant dans la page **Détails de l’appareil** pour un nouveau modèle d’appareil. IoT Central crée automatiquement un appareil simulé quand vous créez un modèle d’appareil. Un appareil simulé vous permet de tester le comportement de votre application avant de connecter un appareil physique.
...
Pour ajouter une nouvelle mesure de télémétrie, cliquez sur **+ Nouvelle mesure**, choisissez **Télémétrie** comme type de mesure, puis entrez les détails dans le formulaire.
...
![Formulaire « Créer une télémétrie » contenant des détails sur la mesure de température](./media/howto-set-up-template-experimental/measurementsform.png)

Une fois que vous avez cliqué sur **Enregistrer**, la mesure **Température** figure dans la liste des mesures. Au bout de quelques instants, vous voyez la visualisation des données de température de l’appareil simulé.
...
Pour ajouter une nouvelle mesure d’événement, cliquez sur **+ Nouvelle mesure** et sélectionnez **Événement** comme type de mesure. Entrez les détails dans le formulaire **Créer un événement**.
...
![Formulaire « Créer un événement » contenant des détails sur un événement du moteur du ventilateur](./media/howto-set-up-template-experimental/eventmeasurementsform.png)

Une fois que vous avez cliqué sur **Enregistrer**, la mesure **Erreur du moteur du ventilateur** apparaît dans la liste des mesures. Au bout de quelques instants, vous voyez la visualisation des données d’événement de l’appareil simulé.

Pour afficher des détails supplémentaires sur un événement, cliquez sur l’icône de l’événement sur le graphique :

![Détails sur l’événement « Erreur du moteur du ventilateur »](./media/howto-set-up-template-experimental/eventmeasurementsdetail.png)
...
Pour ajouter une nouvelle mesure d’état, cliquez sur le bouton **+ Nouvelle mesure** et sélectionnez **État** comme type de mesure. Entrez les détails dans le formulaire **Créer un état**.
...
![Formulaire « Modifier l’état » contenant des détails sur le mode du ventilateur](./media/howto-set-up-template-experimental/statemeasurementsform.png)

Une fois que vous avez cliqué sur **Enregistrer**, la mesure d’état **Mode du ventilateur** apparaît dans la liste des mesures. Au bout de quelques instants, vous voyez la visualisation des données d’état de l’appareil simulé.

Si l’appareil envoie un trop grand nombre de points de données sur une courte période, la mesure d’état s’affiche avec un visuel différent. Cliquez sur le graphique pour voir tous les points de données de cette période par ordre chronologique. Vous pouvez également réduire l’intervalle de temps pour voir la mesure tracée sur le graphique.
...
Par exemple, vous pouvez ajouter un nouveau paramètre de vitesse du ventilateur en cliquant sur **Paramètres** et en entrant le nouveau paramètre **Nombre** :

| Nom d’affichage  | Nom du champ    |  Units  | Décimales |Initial|
| --------------| ------------- |---------| ---------|---- |
| Vitesse du ventilateur     | fanSpeed      | TR/MIN     | 2        | 0   |

![Formulaire « Configurer le nombre » contenant des détails sur les paramètres de vitesse](./media/howto-set-up-template-experimental/settingsform.png)
...
![Formulaire « Configurer le dernier entretien » sous l’onglet « Propriétés »](./media/howto-set-up-template-experimental/propertiesform.png)
...
- L’**emplacement en tant que propriété d’appareil**, qui est signalé par l’appareil à l’application.
...
3. Configurez les champs **Nom d’affichage**, **Nom du champ** et éventuellement **Valeur initiale** pour l’emplacement.
   ...
   ![Formulaire « Configurer l’emplacement » contenant les détails de l’emplacement](./media/howto-set-up-template-experimental/locationcloudproperty2.png)
...
4. Cliquez sur **Enregistrer**. Un opérateur peut mettre à jour la valeur de l’emplacement dans **Device Explorer**.
...
3. Configurez le nom d’affichage et le nom du champ, puis sélectionnez **Emplacement** comme type de données :
   ...
   ![Formulaire « Configurer les propriétés de l’appareil » contenant les détails de l’emplacement](./media/howto-set-up-template-experimental/locationdeviceproperty2.png)
...
Par exemple, vous pouvez ajouter une nouvelle commande **Echo** en sélectionnant l’onglet **Commandes**, en cliquant sur **+ Nouvelle commande**, puis en entrant les détails de la nouvelle commande :

| Nom d’affichage  | Nom du champ | Délai d’expiration par défaut | Type de données |
| --------------| -----------|---------------- | --------- |
| Commande echo  | echo       |  30             | texte      |

![Formulaire « Configurer la commande » contenant les détails de l’écho](./media/howto-set-up-template-experimental/commandsecho.png)
...
- La **règle de télémétrie**, qui se déclenche quand la télémétrie de l’appareil sélectionné dépasse un seuil spécifié. [Découvrez plus en détail les règles de télémétrie](howto-create-telemetry-rules-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json).
...
![Formulaire « Configurer les détails de l’appareil » contenant les détails des paramètres et des propriétés](./media/howto-set-up-template-experimental/dashboardsettingsandpropertiesform.png)
...
1. Donnez un titre à la carte. L’exemple suivant s’intitule **Emplacement d’installation**. Ensuite, choisissez la propriété d’emplacement que vous avez configurée sous l’onglet **Propriétés**. Dans l’exemple suivant, **Adresse d’installation** est sélectionnée.
   ...
   ![Formulaire « Configurer la carte » contenant les détails de la vignette et les propriétés](./media/howto-set-up-template-experimental/locationcloudproperty5map.png)
...
> [Créer une version d’un modèle d’appareil](howto-version-devicetemplate.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
