...
1. Dans votre application IoT Central, _ajoutez et vérifiez le certificat X.509 intermédiaire ou racine_ que vous utilisez pour générer des certificats d’appareils :
    ...
    - Accédez à **Administration > Connexion d’appareils > Certificats (X.509)** et ajoutez le certificat X.509 racine ou intermédiaire que vous utilisez pour générer les certificats de nœud terminal.
      ...
      ![Paramètres de connexion](media/concepts-connectivity-pnp/connection-settings.png)
    ...
    - la vérification de la propriété du certificat permet de s’assurer que l’utilisateur qui a chargé le certificat a la clé privée associée. Pour vérifier le certificat :
        ...
        - Chargez le certificat de vérification signé et sélectionnez **Vérifier**.
          ...
          ![Paramètres de connexion](media/concepts-connectivity-pnp/verify-cert.png)
...
![Paramètres de connexion](media/concepts-connectivity-pnp/device-connection-flow1.png)
...
1. Configurez vos paramètres de connexion :
    ...
    ![Paramètres de connexion SAP](media/concepts-connectivity-pnp/connection-settings-sas.png)
...
Pour en savoir plus sur la connexion d'un appareil IoT Plug-and-Play, voir [Connecter un appareil IoT Plug and Play](howto-connect-pnp-device-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json).
...
Pour en savoir plus sur l'utilisation des Kits de développement logiciel (SDK) d’appareil, voir [Connecter un appareil du kit DevDiv à votre application Azure IoT Central](howto-connect-devkit-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) pour obtenir un exemple de code.
...
- [Connecter un appareil IoT Plug-and-Play](howto-connect-pnp-device-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
- [Préparer et connecter un appareil DevKit](howto-connect-devkit-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
