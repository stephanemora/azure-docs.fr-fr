...
Pour obtenir une liste de toutes les tailles de machines virtuelles de calcul confidentielles disponibles dans les régions disponibles et les zones de disponibilité, exécutez la commande suivante dans [Azure CLI](/cli/azure/install-azure-cli-windows) :
