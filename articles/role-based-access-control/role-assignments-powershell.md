...
- Le compte que vous utilisez pour exécuter la commande PowerShell doit disposer des autorisations `Directory.Read.All` d’Azure Active Directory Graph et `Directory.Read.All` de Microsoft Graph.
