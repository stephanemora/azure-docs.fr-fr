...
Permet de tout gérer, à l’exception de l’octroi de l’accès aux ressources.
...
Lire les données de comptes Azure Cosmos DB. Consultez [Contributeur de compte DocumentDB](#documentdb-account-contributor) pour en savoir plus sur la gestion des comptes Azure Cosmos DB.
...
Peut vider les données d’analytique
...
Permet d’accéder aux nœuds du membre blockchain
...
Vous permet de créer, lire, mettre à jour, supprimer et gérer les clés de Cognitive Services.
...
Vous permet de lire et de répertorier les clés de Cognitive Services.
...
Permet de gérer des ancres spatiales dans votre compte, mais pas de les supprimer
...
Permet de gérer des ancres spatiales dans votre compte, y compris de les supprimer
...
Permet de localiser et de lire les propriétés d’ancres spatiales dans votre compte
...
Permet l’accès total aux données App Configuration.
...
Permet de lire les données App Configuration.
...
Permet un accès total aux ressources Azure Service Bus.
...
Permet d’obtenir un accès en réception aux ressources Azure Service Bus.
...
Permet d’obtenir un accès en envoi aux ressources Azure Service Bus.
...
Vous permet de gérer les opérations d’abonnement aux événements EventGrid.
...
Vous permet de lire les abonnements aux événements EventGrid.
...
Permet de gérer des applications logiques, mais pas d’en modifier l’accès.
...
Permet de lire, d’activer et de désactiver des applications logiques, mais pas de les modifier ou de les mettre à jour.
...
Peut lire toutes les données de surveillance et modifier les paramètres de surveillance. Consultez aussi [Bien démarrer avec les rôles, les autorisations et la sécurité dans Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/platform/roles-permissions-security#built-in-monitoring-roles).
...
Peut lire toutes les données de supervision (métriques, journaux d’activité, etc.) Consultez aussi [Bien démarrer avec les rôles, les autorisations et la sécurité dans Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/platform/roles-permissions-security#built-in-monitoring-roles).
