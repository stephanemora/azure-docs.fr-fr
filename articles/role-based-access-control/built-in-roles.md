...
| --- | --- |
| Microsoft.Authorization/*/read | Lire les rôles et les affectations de rôles |
| Microsoft.DataFactory/factory/* | Créer et gérer des fabriques de données ainsi que leurs ressources enfants |
...
* [Contrôle d’accès en fonction du rôle](role-assignments-portal.md): découvrez le contrôle d’accès en fonction du rôle dans le portail Azure.
...
* [Résolution des problèmes de contrôle d’accès en fonction du rôle](troubleshooting.md): obtenez des suggestions pour résoudre les problèmes courants.
