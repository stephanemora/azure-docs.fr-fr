...
Pour utiliser la page Contrôle d’accès (IAM) avec une efficacité optimale, il est judicieux de pouvoir répondre aux trois questions suivantes quand vous essayez d’attribuer un rôle :
...
1. Dans la liste déroulante **Rôle**, sélectionnez un rôle, tel que **Contributeur de machines virtuelles**.
   ...
   ![Volet Ajouter une attribution de rôle](./media/role-assignments-portal/add-role-assignment-with-scope.png)
