...
![Centre d’administration Azure AD - Propriétés - L’administrateur général peut gérer l’abonnement Azure - capture d’écran](./media/elevate-access-global-admin/aad-azure-portal-global-admin-can-manage-azure-subscriptions.png)
...
- En savoir plus sur la [gestion du contrôle d’accès en fonction du rôle à l’aide de REST](role-assignments-rest.md)

- [Gérer les attributions d’accès](role-assignments-users.md) dans le Portail Azure
