...
1. Utilisez la commande [Remove-AzureRmRoleAssignment](/powershell/module/azurerm.resources/remove-azurermroleassignment) pour supprimer l’attribution de rôle Administrateur de l’accès utilisateur.
