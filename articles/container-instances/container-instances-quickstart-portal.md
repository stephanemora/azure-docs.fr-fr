...
:::image type="content" source="media/container-instances-quickstart-portal/qs-portal-01.png" alt-text="L’application déployée à l’aide d’Azure Container Instances est affichée dans le navigateur":::
...
:::image type="content" source="media/container-instances-quickstart-portal/qs-portal-03.png" alt-text="L’application déployée à l’aide d’Azure Container Instances est affichée dans le navigateur":::
...
:::image type="content" source="media/container-instances-quickstart-portal/qs-portal-04.png" alt-text="L’application déployée à l’aide d’Azure Container Instances est affichée dans le navigateur":::
...
:::image type="content" source="media/container-instances-quickstart-portal/qs-portal-05.png" alt-text="L’application déployée à l’aide d’Azure Container Instances est affichée dans le navigateur":::
...
:::image type="content" source="media/container-instances-quickstart-portal/qs-portal-06.png" alt-text="L’application déployée à l’aide d’Azure Container Instances est affichée dans le navigateur":::
...
:::image type="content" source="media/container-instances-quickstart-portal/qs-portal-11.png" alt-text="L’application déployée à l’aide d’Azure Container Instances est affichée dans le navigateur":::
...
:::image type="content" source="media/container-instances-quickstart-portal/qs-portal-09.png" alt-text="L’application déployée à l’aide d’Azure Container Instances est affichée dans le navigateur":::

Cliquez sur **Oui** quand la boîte de dialogue de confirmation apparaît.

:::image type="content" source="media/container-instances-quickstart-portal/qs-portal-10.png" alt-text="L’application déployée à l’aide d’Azure Container Instances est affichée dans le navigateur":::
