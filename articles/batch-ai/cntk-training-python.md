---
title: Effectuer l’apprentissage d’un modèle CNTK avec Azure Batch AI - Python | Microsoft Docs
description: Effectuer l’apprentissage d’un réseau neuronal Microsoft Cognitive Toolkit (CNTK) avec Azure Batch AI à l’aide du SDK Python
services: batch-ai
...
Pour en savoir plus sur l’utilisation de Batch AI avec différents frameworks, consultez les [recettes de formation](https://github.com/Azure/BatchAI).