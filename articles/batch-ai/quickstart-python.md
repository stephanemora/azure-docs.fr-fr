...
2. Créer un répertoire dans le partage nommé `mnistcntksample`
...
service.create_directory(azure_file_share_name, mnist_dataset_directory,
                         fail_on_exist=False)
```
3. Téléchargez [l’exemple de package](https://batchaisamples.blob.core.windows.net/samples/BatchAIQuickStart.zip?st=2017-09-29T18%3A29%3A00Z&se=2099-12-31T08%3A00%3A00Z&sp=rl&sv=2016-05-31&sr=b&sig=hrAZfbZC%2BQ%2FKccFQZ7OC4b%2FXSzCF5Myi4Cj%2BW3sVZDo%3D) et décompressez-le dans le répertoire actif. Le code suivant télécharge les fichiers requis dans le partage de fichiers Azure :
...
Une fois que le cluster a été créé, configurez et envoyez le travail de formation :
