...
Pour plus d'informations sur l'utilisation des modèles ONNX dans Azure SQL Edge, consultez [Machine Learning et IA avec ONNX dans SQL Edge (préversion)](onnx-overview.md).
