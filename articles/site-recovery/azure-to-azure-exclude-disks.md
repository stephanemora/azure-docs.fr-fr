...
- Vous avez déjà créé un coffre Recovery Services et protégé vos machines virtuelles au moins une fois. Si pas puis le faire à l’aide de la documentation mentionnée [ici](azure-to-azure-powershell.md).
