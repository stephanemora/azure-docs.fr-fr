...
[Installation Push](vmware-azure-install-mobility-service.md) : configurez Site Recovery pour qu'il procède à une installation Push du service Mobilité. Pour ce faire, lorsque vous configurez la reprise d’activité, vous configurez également un compte que le serveur de processus Site Recovery pourra utiliser pour accéder à la machine virtuelle ou au serveur physique dans le cadre de l’installation du service.
