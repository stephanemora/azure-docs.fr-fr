...
--- | --- | --- | --- | --- | ---
[Correctif cumulatif 58](https://support.microsoft.com/topic/update-rollup-58-for-azure-site-recovery-kb5007075-37ba21c3-47d9-4ea9-9130-a7d64f517d5d) | 9.45.6096.1 | 5.1.6952.0 | 9.45.6096.1 | 5.1.6952.0 | 2.0.9237.0
...
## <a name="updates-september-2021"></a>Mises à jour (septembre 2021)

### <a name="update-rollup-58"></a>Correctif cumulatif 58

Le [correctif cumulatif 58](https://support.microsoft.com/topic/update-rollup-58-for-azure-site-recovery-kb5007075-37ba21c3-47d9-4ea9-9130-a7d64f517d5d) fournit les mises à jour suivantes :
...
## <a name="updates-august-2021"></a>Mises à jour (août 2021)

### <a name="update-rollup-57"></a>Mise à jour Rollup 57

La [mise à jour Rollup 57](https://support.microsoft.com/topic/update-rollup-57-for-azure-site-recovery-kb5006172-9fccc879-6e0c-4dc8-9fec-e0600cf94094) fournit les mises à jour suivantes :

> [!NOTE]
> La mise à jour Rollup fournit uniquement des mises à jour pour la version préliminaire publique des protections VMware vers Azure. Aucune autre correction ou amélioration n’a été traitée dans cette version.
> Pour configurer l’expérience en version préliminaire, vous devez effectuer une nouvelle installation et utiliser un nouveau coffre de Recovery Services. La mise à jour d’une architecture existante vers une nouvelle architecture n’est pas prise en charge.

Cette version préliminaire publique couvre une révision complète de l’architecture actuelle pour protéger les machines VMware.
- [En savoir plus](./vmware-azure-architecture-preview.md) sur la nouvelle architecture et les modifications introduites.
- Vérifiez les conditions préalables et configurez l’appliance de réplication ASR en suivant [ces étapes](./deploy-vmware-azure-replication-appliance-preview.md).
- [Activez la réplication](./vmware-azure-set-up-replication-tutorial-preview.md) pour vos machines VMware.
- Consultez la fonctionnalité de [mise à niveau automatique](./upgrade-mobility-service-preview.md) et de [commutation](./switch-replication-appliance-preview.md) pour l’appliance de réplication ASR.


### <a name="update-rollup-56"></a>Correctif cumulatif 56

Le [correctif cumulatif 56](https://support.microsoft.com/topic/update-rollup-56-for-azure-site-recovery-kb5005376-33f27950-1a07-43e5-bf40-4b380a270ef6) fournit les mises à jour suivantes :
...
Le [correctif cumulatif 54](https://support.microsoft.com/topic/update-rollup-54-for-azure-site-recovery-50873c7c-272c-4a7a-b9bb-8cd59c230533) fournit les mises à jour suivantes :
...
**SSD Standard** | Vous pouvez désormais configurer la récupération d’urgence pour les machines virtuelles Azure utilisant des [disques SSD standard](../virtual-machines/disks-types.md#standard-ssds).
