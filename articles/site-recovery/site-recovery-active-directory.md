...
* Les partages de NETLOGON et du dossier sysvol ne sont pas disponibles.

    ![Partage du dossier sysvol](./media/site-recovery-active-directory/sysvolshare.png)

    ![Dossier NtFrs sysvol](./media/site-recovery-active-directory/Event13565.png)
