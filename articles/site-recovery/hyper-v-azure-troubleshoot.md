...
8. Vérifiez que, si vous utilisez un serveur Linux, vous avez activé la cohérence des applications. [En savoir plus](/azure/site-recovery/site-recovery-faq.yml#replication)
