...
ms.locfileid: "37919724"
---
# <a name="use-role-based-access-control-to-manage-site-recovery-access"></a>Utiliser le contrôle d’accès en fonction du rôle pour gérer l’accès à Site Recovery
