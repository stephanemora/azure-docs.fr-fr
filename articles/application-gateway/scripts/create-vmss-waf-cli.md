...
| [az network public-ip show](https://docs.microsoft.com/cli/azure/network/public-ip#az-network_public_ip_show) | Obtient l’adresse IP publique d’une passerelle d’application. |
