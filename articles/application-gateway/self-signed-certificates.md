...
La configuration suivante est un exemple de [bloc Nginx Server](http://nginx.org/docs/http/configuring_https_servers.html) avec une configuration SSL :
