---
title: Limites de la taille des demandes adressées au pare-feu d’applications web et listes d’exclusions dans Azure Application Gateway - Portail Azure | Microsoft Docs
...
Vous pouvez ajouter des en-têtes de demande, des cookies de demande ou des arguments de chaîne de requête de demande aux listes d’exclusions du WAF. Vous pouvez spécifier une correspondance exacte d’une demande d’en-tête, d’un cookie ou d’un attribut de chaîne de requête ou spécifier des correspondances partielles. Voici les opérateurs de critères de correspondance pris en charge : 
