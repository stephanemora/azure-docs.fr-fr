...
![Exemple de pare-feu d’applications web](./media/create-waf-portal/scenario-waf.png)
...
3. Entrez ces valeurs pour la passerelle d’application :
    ...
    ![Créer une nouvelle passerelle d’application](./media/create-waf-portal/application-gateway-create.png)
...
5. Cliquez sur **Choisir un réseau virtuel**, cliquez sur **Créer nouveau**, puis entrez ces valeurs pour le réseau virtuel :
    ...
    ![Création d’un réseau virtuel](./media/create-waf-portal/application-gateway-vnet.png)
...
2. Cliquez sur **Sous-réseaux**, puis cliquez sur **Sous-réseau**.
    ...
    ![Créer un sous-réseau](./media/create-waf-portal/application-gateway-subnet.png)
...
1. Ouvrez l’interpréteur de commandes interactif et assurez-vous qu’il est défini sur **PowerShell**.
    ...
    ![Installer l’extension personnalisée](./media/create-waf-portal/application-gateway-extension.png)
...
3. Cliquez sur **Ajouter une cible** pour ajouter chaque machine virtuelle que vous avez créée au pool principal.
    ...
    ![Ajouter des serveurs principaux](./media/create-waf-portal/application-gateway-backend.png)
...
7. Cliquez sur **Enregistrer**.
    ...
    ![Configuration de la collecte des diagnostics](./media/create-waf-portal/application-gateway-diagnostics.png)
...
1. Recherchez l’adresse IP publique de la passerelle d’application sur l’écran de présentation. Cliquez sur **Toutes les ressources**, puis sur **myAGPublicIPAddress**.
    ...
    ![Enregistrer l’adresse IP publique de la passerelle d’application](./media/create-waf-portal/application-gateway-record-ag-address.png)

2. Copiez l’adresse IP publique, puis collez-la dans la barre d’adresses de votre navigateur.

    ![Tester la passerelle d’application](./media/create-waf-portal/application-gateway-iistest.png)
