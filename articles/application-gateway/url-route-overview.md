...
Les requêtes adressées à <http://contoso.com/video/*> sont acheminées vers VideoServerPool tandis que les requêtes adressées à <http://contoso.com/images/*> sont acheminées vers ImageServerPool. DefaultServerPool est sélectionné si aucun des modèles de chemin d’accès ne correspond.
