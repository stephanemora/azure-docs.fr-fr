...
description: Découvrez les spécifications physiques et environnementales applicables au matériel Azure FXT Edge Filer.
author: ekpgh
...
| Dimensions du serveur de fichiers            | Valeur                    |
|-----------------------------|--------------------------|
