...
La liste suivante indique les sources de données dans Azure que vous pouvez utiliser avec Azure Databricks. Pour obtenir la liste complète des sources de données que vous pouvez utiliser avec Azure Databricks, consultez [Data sources for Azure Databricks](/azure/databricks/data/data-sources/index.html) (Sources de données d’Azure Databricks).

- [Base de données Azure SQL](/azure/databricks/data/data-sources/sql-databases.html)
...
- [Stockage Blob Azure](/azure/databricks/data/data-sources/azure/azure-storage.html)
...
Pour en savoir plus sur les sources à partir desquelles vous pouvez importer des données dans Azure Databricks, consultez [Spark Data Sources](/azure/databricks/data/data-sources/index.html#) (Sources de données Spark)
