...
1. Cette fenêtre de terminal est à présent utilisée comme terminal de votre _appareil_. Accédez à votre dépôt cloné, puis au dossier **/azure-iot-samples-node/digital-twins/Quickstarts/Device**. Installez toutes les dépendances en exécutant la commande suivante :
