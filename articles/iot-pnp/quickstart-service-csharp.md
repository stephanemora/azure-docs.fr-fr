---
title: Démarrage rapide – Interagir avec un appareil IoT Plug-and-Play connecté à votre solution Azure IoT (C#) | Microsoft Docs
description: Démarrage rapide – Utilisez C# pour vous connecter à un appareil IoT Plug-and-Play connecté à votre solution Azure IoT et pour interagir avec lui.
author: ericmitt
ms.author: ericmitt
ms.date: 09/21/2020
ms.topic: quickstart
