---
title: Utiliser Azure IoT Device Workbench pour créer des appareils IoT Plug-and-Play (préversion) | Microsoft Docs
description: Utilisez l’extension Azure IoT Device Workbench dans Visual Studio Code pour accélérer la création de modèles d’appareils IoT Plug-and-Play et l’implémentation du code d’appareil.
author: liydu
ms.author: liydu
ms.date: 07/25/2019
ms.topic: conceptual
...
ms.locfileid: "69879209"
---
# <a name="use-azure-iot-device-workbench-extension-in-visual-studio-code"></a>Utiliser l’extension Azure IoT Device Workbench dans Visual Studio Code

L’extension Azure IoT Device Workbench pour Visual Studio Code fournit un environnement intégré pour créer des interfaces et des modèles de capacité d’appareil (DCM, device capability model), publier dans des référentiels de modèles et générer le code de squelette en C pour implémenter l’application d’appareil.
...
Pour en savoir plus sur l’utilisation de l’extension Device Workbench pour développer des appareils IoT, consultez [https://github.com/microsoft/vscode-iot-workbench](https://github.com/microsoft/vscode-iot-workbench).

## <a name="prerequisites"></a>Prérequis

Installez [Visual Studio Code](https://code.visualstudio.com/).

Pour installer l’extension dans VS Code, procédez comme suit :

1. Dans VS Code, sélectionnez l’onglet **Extensions**.
1. Recherchez et installez **Azure IoT Device Workbench** à partir de la Place de marché.
...
1. Ouvrez le dépôt **azure-iot-sdk-c** dans le volet **Team Explorer**, sélectionnez **Branches**, recherchez la branche **public-preview** et basculez sur cette branche.
    ...
    ![Préversion publique](media/howto-use-iot-device-workbench/vs-public-preview.png)
...
1. Dans la barre d’outils **Général**, recherchez la liste déroulante **Configurations**. Sélectionnez **Gérer les configurations** pour ajouter le paramètre CMake pour votre projet.
    ...
    ![Gérer la configuration](media/howto-use-iot-device-workbench/vs-manage-config.png)
...
L’extension Azure IoT Device Workbench est un projet open source sur GitHub. Si vous rencontrez des problèmes ou souhaitez formuler des requêtes liées aux fonctionnalités, vous pouvez [créer un problème dans GitHub](https://github.com/microsoft/vscode-iot-workbench/issues).

## <a name="next-steps"></a>Étapes suivantes

Dans cet article de procédure, vous avez appris à utiliser Azure IoT Device Workbench pour créer des fichiers d’interface et DCM. Vous avez également appris à générer du code de squelette C pour implémenter l’application d’appareil. À présent, nous vous invitons à découvrir comment [installer et à utiliser l’explorateur Azure IoT](./howto-install-iot-explorer.md).
