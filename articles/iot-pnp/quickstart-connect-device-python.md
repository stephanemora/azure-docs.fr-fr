---
title: Démarrage rapide – Connecter un exemple de code Python pour appareil IoT Plug-and-Play à Azure IoT Hub | Microsoft Docs
description: Démarrage rapide - Utilisez Python pour créer et exécuter un exemple de code pour appareil IoT Plug-and-Play, qui se connecte à un hub IoT. Utilisez l’outil Azure IoT Explorer pour afficher les informations envoyées par l’appareil au hub.
author: ericmitt
ms.author: ericmitt
ms.date: 7/14/2020
ms.topic: quickstart
