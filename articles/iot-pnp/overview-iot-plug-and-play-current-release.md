...
- Explorateur Azure IoT 0.14.x (Téléchargez et installez la version la plus récente de l’application)
...
- Extension VS Code 1.0.0.
    ...
    Pour plus d’informations, consultez [Cycle de vie et outils](concepts-modeling-guide.md#lifecycle-and-tools).
