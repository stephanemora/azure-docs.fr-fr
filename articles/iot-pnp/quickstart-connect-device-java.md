---
title: Démarrage rapide – Connecter un exemple de code Java pour appareil IoT Plug-and-Play à Azure IoT Hub | Microsoft Docs
description: Démarrage rapide – Créez et exécutez un exemple de code pour appareil IoT Plug-and-Play, qui se connecte à un hub IoT. Utilisez l’outil Azure IoT Explorer pour afficher les informations envoyées par l’appareil au hub.
author: ericmitt
ms.author: ericmitt
ms.date: 07/14/2020
ms.topic: quickstart
