---
title: Guide du développeur d’appareils (Java) – IoT Plug-and-Play | Microsoft Docs
description: Description d’IoT Plug-and-Play pour les développeurs utilisant des appareils Java
author: rido-min
ms.author: rmpablos
ms.date: 09/24/2020
ms.topic: conceptual
...
ms.locfileid: "91579134"
---
# <a name="iot-plug-and-play-device-developer-guide-java"></a>Guide du développeur d’appareils IoT Plug-and-Play (Java)
...
Les appareils qui utilisent [Device Provisioning Service (DPS)](../iot-dps/about-iot-dps.md) peuvent inclure le `modelId` à utiliser pendant le processus de provisionnement à l’aide de la charge utile JSON suivante.
...
Pour rapporter une propriété accessible en écriture à partir du composant par défaut :
...
Pour rapporter une propriété accessible en écriture à partir d’un composant imbriqué, le jumeau doit inclure un marqueur :
...
Un composant par défaut considère la propriété unique et crée le message `ack` rapporté avec la version reçue :
...
Un composant imbriqué reçoit le nom de la commande préfixé avec le nom du composant et le séparateur `*`.
