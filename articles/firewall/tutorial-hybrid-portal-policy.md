---
title: 'Tutoriel : Déployer et configurer le Pare-feu Azure et une stratégie de pare-feu dans un réseau hybride en utilisant le portail Azure'
description: Dans ce tutoriel, vous apprenez à déployer et configurer le Pare-feu Azure et une stratégie de pare-feu en utilisant le portail Azure.
services: firewall
author: vhorne
ms.service: firewall
ms.topic: tutorial
...
4. Sur la page **Créer un pare-feu**, utilisez le tableau suivant pour configurer le pare-feu :
   ...
   |Stratégie de pare-feu|Ajouter nouveau :<br>**hybrid-test-pol**<br>**USA Est** 
