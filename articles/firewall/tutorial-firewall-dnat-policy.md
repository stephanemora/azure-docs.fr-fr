---
title: 'Tutoriel : Filtrer le trafic Internet entrant avec une stratégie DNAT de Pare-feu Azure à l’aide du portail'
description: Ce tutoriel vous apprend à déployer et configurer une stratégie DNAT de Pare-feu Azure à l’aide du portail Azure.
services: firewall
author: vhorne
ms.service: firewall
ms.topic: tutorial
...
1. Sur la page **Créer un pare-feu**, utilisez le tableau suivant pour configurer le pare-feu :
   ...
   |Stratégie de pare-feu|**Ajouter nouveau** :<br>**fw-dnat-pol**<br>votre région sélectionnée 
...
1. Dans le champ **Nom**, tapez **RT-FW-route**.
1. Sélectionnez **Revoir + créer**.
1. Sélectionnez **Create** (Créer).
...
1. Pour **Nom de l’itinéraire**, tapez **fw-dg**.
...
1. Sous **Paramètres**, sélectionnez **Règles DNAT**.
...
1. Pou **Adresse traduite**, tapez l’adresse IP privée de **Srv-Workload**.
