---
title: Options d’aide et de support pour les groupes de machines virtuelles identiques Azure
description: Comment obtenir de l’aide et du support en cas de questions ou problèmes quand vous créez des solutions à l’aide de groupes de machines virtuelles identiques Azure.
author: mimckitt
ms.author: mimckitt
...
Voici quelques suggestions pour obtenir de l’aide lors du développement de vos solutions de groupes de machines virtuelles identiques Azure.
...
| Domaine | Tag |
|-------|----------------------|
| [Groupes de machines virtuelles identiques Azure](overview.md) | [azure-virtual-machine-scale-set](/answers/topics/azure-virtual-machines-scale-set.html) | 
| [Machines virtuelles Azure](../virtual-machines/linux/overview.md) | [azure-virtual-machines](/answers/topics/azure-virtual-machines.html) | 
...
| [Sauvegarde de machine virtuelle Azure](../virtual-machines/backup-recovery.md) | [azure-virtual-machine-backup](/answers/questions/36892/azure-virtual-machine-backups.html) | 
| [Extension de machine virtuelle Azure](../virtual-machines/extensions/overview.md) | [azure-virtual-machine-extension](/answers/topics/azure-virtual-machines-extension.html)| 
| [Images de machine virtuelle Azure](../virtual-machines/shared-image-galleries.md) | [azure-virtual-machine-images](/answers/topics/azure-virtual-machines-images.html) | 
| [Migration de machine virtuelle Azure](../virtual-machines/classic-vm-deprecation.md) | [azure-virtual-machine-migration](/answers/topics/azure-virtual-machines-migration.html) | 
...
| [Réseau de machine virtuelle Azure](../virtual-machines/network-overview.md) | [azure-virtual-machine-networking](/answers/topics/azure-virtual-machines-networking.html) | 
| [Stockage de machine virtuelle Azure](../virtual-machines/managed-disks-overview.md) | [azure-virtual-machine-storage](/answers/topics/azure-virtual-machines-storage.html) | 
...
Si vous avez besoin d’aide avec le langage et les outils utilisés pour développer et gérer des groupes de machines virtuelles identiques Azure, ouvrez un problème dans son référentiel sur GitHub.
...
Les nouveautés et informations sur les groupes de machines virtuelles identiques Azure sont partagées sur le [blog Azure](https://azure.microsoft.com/blog/topics/virtual-machines/).


## <a name="next-steps"></a>Étapes suivantes

En savoir plus sur les [groupes de machines virtuelles identiques Azure](overview.md)