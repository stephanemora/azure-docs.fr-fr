...
|         Azure Site Recovery  |            Oui, PowerShell uniquement  |            Oui  |            Oui  |
...
Pour obtenir un exemple complet, consultez le [modèle de démarrage rapide Azure](https://github.com/Azure/azure-quickstart-templates/tree/master/201-vm-vmss-flexible-orchestration-mode).
