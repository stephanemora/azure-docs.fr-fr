...
- Configurez votre environnement de développement en suivant le [Guide de prise en main](https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-arduino-iot-devkit-az3166-get-started).
