...
1. Ouvrez le fichier **src/main/java/com/microsoft/docs/iothub/samples/ReadDeviceToCloudMessages.java** dans l’éditeur de texte de votre choix.
    ...
    Remplacez la valeur de la variable `iotHubSasKey` par la clé principale iothubowner que vous avez notée précédemment. Puis enregistrez vos modifications dans le fichier **ReadDeviceToCloudMessages.java**.
