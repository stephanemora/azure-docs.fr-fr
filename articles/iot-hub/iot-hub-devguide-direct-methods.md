...
L’appel de méthodes directes avec un ID de module est pris en charge dans le Kit de développement logiciel (SDK) C# (disponible [ici](https://www.nuget.org/packages/Microsoft.Azure.Devices/)).
