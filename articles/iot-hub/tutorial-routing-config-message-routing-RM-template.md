...
![Barre de menus Cloud Shell avec l’icône Charger/télécharger des fichiers en surbrillance](media/tutorial-routing-config-message-routing-RM-template/CloudShell_upload_files.png)
