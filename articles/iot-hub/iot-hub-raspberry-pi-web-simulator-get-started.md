...
:::image type="content" source="media/iot-hub-raspberry-pi-web-simulator/3-banner.png" alt-text="Connecter le simulateur web Raspberry Pi à IoT Hub" border="false":::

[:::image type="content" source="media/iot-hub-raspberry-pi-web-simulator/6-button-default.png" alt-text="Démarrer le simulateur Raspberry Pi":::](https://azure-samples.github.io/raspberry-pi-web-simulator/#getstarted)
