...
2. Cliquez sur `F1`, puis saisissez **Arduino** et sélectionnez **Arduino : télécharger** pour générer et déployer l’exemple d’application sur la carte Feather HUZZAH ESP8266.
