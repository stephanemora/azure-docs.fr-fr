...
Vous pouvez également utiliser la commande d’extension CLI [az iot hub device-identity](/cli/azure/iot/hub/device-identity) pour configurer des certificats X.509 pour les appareils.
