...
* [Cmdlets Azure PowerShell](https://docs.microsoft.com/powershell/azure/azurerm/install-azurerm-ps).

* Un IoT Hub Azure. Si vous n’avez pas de IoT Hub, vous pouvez utiliser [la cmdlet New-AzureRmIoTHub](https://docs.microsoft.com/powershell/module/azurerm.iothub/new-azurermiothub) afin d’en créer un ou utiliser le portail pour [créer un IoT Hub](iot-hub-create-through-portal.md).

* Un compte de stockage Azure. Si vous n’avez pas de compte de stockage Azure, vous pouvez utiliser [les cmdlets PowerShell de stockage Azure](https://docs.microsoft.com/powershell/module/azurerm.storage/) afin d’en créer un ou utiliser le portail pour [créer un compte de stockage](../storage/common/storage-create-storage-account.md).
...
1. À l’invite PowerShell, exécutez l’applet de commande **Connect-AzureRmAccount** :
