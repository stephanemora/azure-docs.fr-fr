...
* --**hub-name** : nom du hub IoT dans lequel la configuration sera créée. Le hub doit être dans l’abonnement actuel. Basculer vers l’abonnement souhaitée avec la commande `az account set -s [subscription name]`
...
* --**hub-name** : nom du hub IoT dans lequel la configuration existe. Le hub doit être dans l’abonnement actuel. Basculer vers l’abonnement souhaitée avec la commande `az account set -s [subscription name]`
