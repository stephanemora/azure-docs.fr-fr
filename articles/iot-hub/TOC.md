...
# Démarrages rapides
## [Envoyer des données de télémétrie (Node.js)](quickstart-send-telemetry-node.md)
...
## [Contrôler un appareil (Python)](quickstart-control-device-python.md)
...
## Sécurité
### [Tout savoir sur la sécurité](/azure/iot-fundamentals/iot-security-ground-up?context=azure/iot-hub/rc/rc)
### [Meilleures pratiques en matière de sécurité](/azure/iot-fundamentals/iot-security-best-practices?context=azure/iot-hub/rc/rc)
### [Architecture de la sécurité](/azure/iot-fundamentals/iot-security-architecture?context=azure/iot-hub/rc/rc)
### [Sécuriser votre déploiement IoT](/azure/iot-fundamentals/iot-security-deployment?context=azure/iot-hub/rc/rc)
...
### [Sécuriser votre hub avec un certificat X.509](iot-hub-security-x509-get-started.md)
...
#### [Enregistrer les messages IoT Hub dans le stockage d’objets blob Azure](iot-hub-store-data-in-azure-table-storage.md)
...
## [REST (Appareil)](https://docs.microsoft.com/rest/api/iothub/device)
## [REST (Service)](https://docs.microsoft.com/rest/api/iothub/service)
## [REST (ressource IoT Hub)](https://docs.microsoft.com/rest/api/iothub/iothubresource)
## [REST (Certificats)](https://docs.microsoft.com/rest/api/iothub/certificates)

# Rubriques connexes
## solutions 
### [Accélérateurs de solution IoT](/azure/iot-accelerators) 
