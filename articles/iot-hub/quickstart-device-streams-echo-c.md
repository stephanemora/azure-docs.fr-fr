...
Comme mentionné précédemment, le SDK C IoT Hub prend uniquement en charge des flux d’appareil côté appareil. Pour l’application côté service, utilisez les programmes de service complémentaires disponibles dans les guides de [démarrage rapide C#](./quickstart-device-streams-echo-csharp.md) ou [démarrage rapide Node.js](./quickstart-device-streams-echo-nodejs.md).
