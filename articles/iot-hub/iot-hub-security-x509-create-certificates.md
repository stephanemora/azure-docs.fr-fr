...
* Certificats - Ordinateur local > Autorités de certification intermédiaires > Certificats

   ![Supprimer les certificats Azure IoT CA TestOnly](./media/iot-hub-security-x509-create-certificates/cleanup.png)
