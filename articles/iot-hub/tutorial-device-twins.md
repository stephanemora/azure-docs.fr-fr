...
Dans ce didacticiel, vous avez appris à synchroniser les informations d’état entre vos appareils et votre hub IoT en effectuant les tâches suivantes :
...
Passez au didacticiel suivant pour découvrir comment utiliser les jumeaux d’appareil pour implémenter un processus de mise à jour du microprogramme.
