...
Dans cette section, vous allez utiliser Azure Cloud Shell avec l’[extension IoT](/cli/azure/iot) pour surveiller les messages d’appareil envoyés par l’appareil Android.
