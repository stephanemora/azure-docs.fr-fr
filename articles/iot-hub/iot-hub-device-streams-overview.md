...
- Le choix du port 22 dépend du protocole et est spécifique à SSH dans le cas présent. Pour RDP, le port 3389 doit être utilisé. Cela peut être configuré dans les exemples de programmes fournis.
