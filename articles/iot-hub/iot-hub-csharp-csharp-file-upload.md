...
* [Documentation Stockage Blob Azure](/azure/storage/blobs/storage-blobs-introduction)

* [Informations de référence sur les API Stockage Blob Azure](/azure/storage/blobs/reference)
