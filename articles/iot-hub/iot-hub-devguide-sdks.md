---
title: Comprendre les kits Azure IoT SDK | Microsoft Docs
description: Guide du développeur - informations et liens vers divers kits Azure IoT device et service SDK que vous pouvez utiliser pour créer des applications d’appareil et des applications backend.
services: iot-hub
documentationcenter: ''
author: dominicbetts
manager: timlt
