...
7. Ajoutez les variables de niveau classe suivantes à la classe **App** . Remplacez `{yourdeviceconnectionstring}` par la chaîne de connexion de l’appareil que vous avez notée dans la section [Inscrire un nouveau périphérique dans le hub IoT](#register-a-new-device-in-the-iot-hub) :
