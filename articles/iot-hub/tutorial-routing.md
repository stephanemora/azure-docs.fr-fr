...
Pour supprimer le groupe de ressources, utilisez la commande [Remove-AzureRmResourceGroup](https://docs.microsoft.com/powershell/module/azurerm.resources/remove-azurermresourcegroup). $resourceGroup a été défini sur **ContosoIoTRG1** au début de ce didacticiel.
