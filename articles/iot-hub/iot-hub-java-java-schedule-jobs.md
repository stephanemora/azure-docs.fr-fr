...
* Méthodes directes : [Guide du développeur IoT Hub - méthodes directes](iot-hub-devguide-direct-methods.md) et [Tutoriel : Utiliser des méthodes directes](quickstart-control-device-java.md)
