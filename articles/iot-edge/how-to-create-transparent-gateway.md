...
Créez le nouveau certificat de l’appareil.  **NE NOMMEZ PAS** `myGatewayCAName` de la même façon que l’hôte de votre passerelle.  Cela provoquerait l’échec de la certification client sur ces certificats.
