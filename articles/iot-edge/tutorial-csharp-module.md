...
8. La méthode **Init** déclare un protocole de communication pour le module à utiliser. Remplacez les paramètres de MQTT avec les paramètres AMPQ. 
