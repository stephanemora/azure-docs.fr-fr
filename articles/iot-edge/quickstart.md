...
* Dans le cas d’un ordinateur Windows, assurez-vous qu’il possède la [configuration requise](https://docs.microsoft.com/virtualization/hyper-v-on-windows/reference/hyper-v-requirements) pour Hyper-V.
