...
3. Installez [Python sur Windows][lnk-python] et assurez-vous de pouvoir utiliser la commande pip. Ce démarrage rapide a été testé avec des versions de Python >= 2.7.9 et <=3.5.4.  
