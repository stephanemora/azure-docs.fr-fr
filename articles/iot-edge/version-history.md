...
* **IoT Edge 1.2 (préversion)** contient du contenu supplémentaire pour les fonctionnalités et les capacités qui se trouvent dans la préversion la plus récente : [1.2-rc1](https://github.com/Azure/azure-iotedge/releases/tag/1.2-rc1).
