...
Actuellement, Visual Studio Code peut développer des modules Node.js pour Linux AMD64 et Linux ARM32v7. Vous devez sélectionner l’architecture ciblée pour chaque solution car le conteneur est généré et exécuté différemment pour chaque type d’architecture. Linux AMD64 est la valeur par défaut. 
