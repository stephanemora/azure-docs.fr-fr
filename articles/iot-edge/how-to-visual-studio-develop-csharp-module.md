...
- Téléchargez et installez [l’extension Azure IoT Edge](https://marketplace.visualstudio.com/items?itemName=vsc-iot.vsiotedgetools) à partir de la Visual Studio Marketplace pour créer un projet IoT Edge dans Visual Studio 2017.
