...
Une fois IoT Edge installé avec succès, la sortie vous invitera à mettre à jour le fichier config. Suivez les étapes de la section [Configurer le démon de sécurité Azure IoT Edge](#configure-the-azure-iot-edge-security-daemon) pour terminer le provisionnement de votre périphérique. 
