...
Pour savoir comment créer une inscription individuelle, consultez le [Guide de démarrage rapide d’approvisionnement d’un appareil TPM simulé](../iot-dps/quick-create-simulated-device-tpm.md).
