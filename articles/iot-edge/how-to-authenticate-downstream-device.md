...
Si vous avez établi une relation parent/enfant pour l’appareil en aval (obligatoire pour l’authentification X.509 mais facultative pour l’authentification par clé symétrique), vous pouvez simplifier la chaîne de connexion en appelant la passerelle directement en tant qu’hôte de connexion. Par exemple : 
