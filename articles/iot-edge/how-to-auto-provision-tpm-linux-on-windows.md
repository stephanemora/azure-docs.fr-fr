...
Pour savoir comment créer une inscription individuelle pour un appareil TPM simulé, consultez le [guide de démarrage rapide d’approvisionnement d’un appareil TPM simulé](../iot-dps/quick-create-simulated-device-tpm.md).
