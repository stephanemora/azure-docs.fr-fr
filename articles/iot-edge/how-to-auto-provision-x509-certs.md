...
1. Fournissez un `registration_id` pour l’appareil si vous le souhaitez, ou laissez cette ligne commentée pour inscrire l’appareil avec le nom commun du certificat d’identité.
