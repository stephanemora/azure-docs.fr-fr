...
description: Découvrez comment activer une stratégie de rétention dans votre registre de conteneurs Azure Premium, pour la suppression automatique des manifestes non étiquetés à l’issue d’une période définie.
ms.topic: article
ms.date: 04/26/2021
...
La création d’une stratégie de rétention pour les manifestes non étiquetés constitue actuellement une fonctionnalité d’évaluation des registres de conteneurs **Premium**. Pour plus d’informations sur les niveaux de service de registre, consultez [Niveaux de service d’Azure Container Registry](container-registry-skus.md).
...
### <a name="manage-a-retention-policy"></a>Gestion d’une stratégie de rétention
...
Vous pouvez également définir une stratégie de rétention du registre via le [portail Azure](https://portal.azure.com). 
