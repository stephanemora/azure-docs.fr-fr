...
description: Restreindre l’accès à un registre de conteneurs Azure à l’aide d’un point de terminaison de service dans un réseau virtuel Azure
ms.topic: article
ms.date: 05/04/2020
