...
La fonctionnalité [WAF d’Azure Application Gateway](https://docs.microsoft.com/azure/application-gateway/waf-overview) permet de protéger de manière centralisée vos applications web contre les vulnérabilités courantes et le code malveillant exploitant. Le WAF suit les règles des [ensembles de règles de base OWASP](https://www.owasp.org/index.php/Category:OWASP_ModSecurity_Core_Rule_Set_Project) 3.0 ou 2.2.9.
...
Le niveau gratuit de Security Center offre une sécurité limitée pour vos ressources Azure uniquement. Le [niveau Standard de Security Center](https://docs.microsoft.com/azure/security-center/security-center-onboarding) étend ces fonctionnalités aux ressources locales et à d’autres clouds.
