...
|Traitement des données/alertes de sécurité| Alerte Azure Security Center, alerte Log Analytics|   Informations relatives à la sécurité et alertes.|   API REST, JSON|
