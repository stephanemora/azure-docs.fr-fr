...
ms.locfileid: "77616444"
---
# <a name="overview-of-azure-security-baselines"></a>Vue d’ensemble des bases de référence de la sécurité Azure

Les bases de référence de la sécurité Azure vous permettent de renforcer la sécurité de nos produits avec des outils, un suivi et des fonctionnalités de sécurité améliorés. Elles vous offrent une expérience utilisateur cohérente pour la sécurisation de votre environnement.

Les bases de référence de la sécurité des services Azure se concentrent sur les zones de contrôle axées sur le cloud. Ces contrôles sont cohérents avec les benchmarks de sécurité bien connus, par exemple ceux décrits par le CIS (Center for Internet Security). Nos bases de référence fournissent de l’aide sur les zones de contrôle listées dans le [benchmark de sécurité Azure](overview.md).
