...
| **Client<br />(Plan&nbsp;PCI&#8209;DSS)** | L’application de démonstration Contoso Webstore est un service PaaS, et la détection des modifications a été implémentée à l’aide de Log Analytics. Pour plus d’informations, consultez [Aide PCI - Solutions de gestion préinstallées](payment-processing-blueprint.md#management-solutions).<br /><br />|
...
| **Client<br />(Plan&nbsp;PCI&#8209;DSS)** | Contoso Webstore vous avertit des modifications qui ont été apportées par l’implémentation Log Analytics. Pour plus d’informations, consultez [Aide PCI - Solutions de gestion préinstallées](payment-processing-blueprint.md#management-solutions).<br /><br /><br /><br />|
