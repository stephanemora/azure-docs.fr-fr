...
| **Client<br />(Plan&nbsp;PCI&#8209;DSS)** | Contoso Webstore prend en charge l’audit de tous les éléments pour Azure. [Sauvegarde Azure](https://azure.microsoft.com/services/backup/) peut effectuer une sauvegarde sur une source externe.|
