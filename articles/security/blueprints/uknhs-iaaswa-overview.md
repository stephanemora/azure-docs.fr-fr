---
title: Azure Blueprint Sécurité et conformité - Application web IaaS pour le UK NHS
description: Azure Blueprint Sécurité et conformité - Application web IaaS pour le UK NHS
services: security
author: jomolesk
...
ms.locfileid: "37343198"
---
# <a name="azure-security-and-compliance-blueprint-iaas-web-application-for-uk-nhs"></a>Azure Blueprint Sécurité et conformité : application web IaaS pour le UK NHS
...
Pour renforcer la sécurité, toutes les ressources dans cette solution sont gérées sous forme de groupe de ressources dans Azure Resource Manager. Le contrôle d’accès en fonction du rôle Azure Active Directory est utilisé pour contrôler l’accès aux ressources déployées ainsi qu’à leurs clés dans Azure Key Vault. L’intégrité du système est surveillée par l’intermédiaire de Azure Security Center et de Azure Monitor. Les clients configurent ces deux services de surveillance pour la capture de journaux et la centralisation des informations concernant l’intégrité du système dans un tableau de bord facilement consultable. Azure Application Gateway est configuré comme un pare-feu en mode prévention et n’autorise pas le trafic qui n’est pas TLSv1.2.
