...
Dans cet article, nous abordons différentes bonnes pratiques relatives à la sécurité. Ces bonnes pratiques sont issues de notre expérience dans le domaine de la sécurité des bases de données Azure, mais également de celle des clients comme vous.
...
**Détails** : exécutez des [tests de charge](https://www.visualstudio.com/docs/test/performance-testing/getting-started/getting-started-with-performance-testing) à l’aide de VSTS pour effectuer les opérations suivantes :
...
La conception et la génération d’une résilience DDoS nécessitent la planification et la conception de divers modes d’échec.
