...
- Prêt à vous lancer dans les tests de pénétration de vos applications hébergées dans Microsoft Azure ? Si tel est le cas, rendez-vous sur les [Règles d’engagement de test de pénétration](https://www.microsoft.com/msrc/pentest-rules-of-engagement?rtc=2) et remplissez le formulaire de notification de test.
