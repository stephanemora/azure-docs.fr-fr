...
Cette base de référence de sécurité applique les conseils du [benchmark de sécurité Azure version 1.0](../benchmarks/overview-v1.md) à Azure DDoS Protection Standard. Le benchmark de sécurité Azure fournit des recommandations sur la façon dont vous pouvez sécuriser vos solutions cloud sur Azure. Le contenu est regroupé en fonction des **contrôles de sécurité** définis par le benchmark de sécurité Azure et les conseils associés applicables à Azure DDoS Protection Standard. Les **contrôles** non applicables à Azure DDoS Protection Standard, ou pour lesquels la responsabilité est celle de Microsoft, ont été exclus.

Pour voir la façon dont Azure DDoS Protection Standard est entièrement mappé au benchmark de sécurité Azure, consultez le [fichier de mappage complet de la base de référence de sécurité Azure DDoS Protection Standard](https://github.com/MicrosoftDocs/SecurityBenchmarks/tree/master/Azure%20Offer%20Security%20Baselines).
...
- [Informations sur l’accès à la télémétrie, aux journaux et à l’analytique des attaques pour le service Azure DDoS Protection Standard](/azure/ddos-protection/telemetry-monitoring-alerting#configure-alerts-for-ddos-protection-metrics)
...
En outre, Azure Active Directory (Azure AD) comporte des rôles intégrés qui doivent être explicitement attribués et qui peuvent être interrogés. Utilisez le module Azure AD PowerShell pour effectuer des requêtes ad hoc afin de découvrir les comptes membres de groupes d’administration.
...
- [Guide pratique pour activer Azure Active Directory Multi-Factor Authentication](../../active-directory/authentication/howto-mfa-getstarted.md)
...
**Conseils** : Utilisez une station de travail sécurisée et gérée par Azure avec Azure Active Directory Multi-Factor Authentication activé pour vous connecter à vos demandes Azure Customer Lockbox et les configurer.

- [Déployer une station de travail sécurisée gérée par Azure](/security/compass/overview)
...
**Conseils** : Utilisez des emplacements nommés Azure Active Directory (Azure AD) pour autoriser l’accès au portail Azure uniquement à partir de regroupements logiques spécifiques de plages d’adresses IP ou de pays/régions.
...
- [Gérer Azure RBAC dans Azure DDoS Protection](/azure/virtual-network/manage-ddos-protection)
