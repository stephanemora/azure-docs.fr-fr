...
| **Données et application** |  |
| [Microsoft Cloud App Security](/cloud-app-security/investigate) | Fournit des outils pour mieux comprendre ce qui se passe dans votre environnement cloud. |
