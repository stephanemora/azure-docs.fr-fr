...
- [Intégration des journaux Azure](azure-log-integration-overview.md)
...
* Si vous souhaitez fournir des informations de télémétrie, laissez la case cochée. Si vous préférez ne pas envoyer d’informations d’utilisation à Microsoft, décochez la case.
   ...
   Pour plus d’informations sur Azure Log Integration et sur son installation, consultez l’article [Intégration des journaux Azure avec la journalisation Diagnostics Azure et Windows Event Forwarding](azure-log-integration-get-started.md).
...
1. Importez les applets de commande AzLog en exécutant le script LoadAzLogModule.ps1. Entrez la commande `.\LoadAzLogModule.ps1`. (Notez la présence du caractère « .\" dans cette commande.) Le résultat suivant devrait s'afficher :</br>
   ...
   ![Liste des modules chargés](./media/azure-log-integration-keyvault-eventhub/loaded-modules.png)
...
1. Créez un groupe de ressources :
   ...
   ![Sortie après la création d’un groupe de ressources](./media/azure-log-integration-keyvault-eventhub/create-rg.png)
...
>
>![Erreur de profil Resource Manager](./media/azure-log-integration-keyvault-eventhub/rm-profile-error.png)
...
1. Définissez et lisez un secret pour générer des entrées de journal supplémentaires :
   ...
   ![Secret renvoyé](./media/azure-log-integration-keyvault-eventhub/keyvaultsecret.png)
...
- [Forum aux questions sur l’intégration des journaux Azure](azure-log-integration-faq.md)
- [Bien démarrer avec l’intégration des journaux Azure](azure-log-integration-get-started.md)
- [Intégrer des journaux d’activité à partir de ressources Azure dans vos systèmes SIEM](azure-log-integration-overview.md)
