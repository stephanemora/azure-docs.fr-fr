...
![Azure Disk Encryption demande l’exécution préalable du script dans PowerShell ISE](./media/quick-encrypt-vm-powershell/ade-prereq-script.PNG)
...
1. Une fois le chiffrement terminé, vous pouvez vérifier le chiffrement du disque avec l’applet de commande suivant : 
     ...
     ```
    ![Sortie Get-AzVmDiskEncryptionStatus](./media/quick-encrypt-vm-powershell/ade-get-encryption-status.PNG)
