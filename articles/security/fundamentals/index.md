---
title: Documentation sur les notions de base de la sécurité Azure
description: Découvrez la sécurité Azure.
services: security
author: arob98
manager: angrobe
layout: LandingPage
...
ms.locfileid: "70148895"
---
# <a name="azure-security-fundamentals-documentation"></a>Documentation sur les notions de base de la sécurité Azure

Découvrez la sécurité Azure.
        ...
        <a href="/azure/security/security-storage-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Vue d’ensemble de la sécurité du stockage</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-network-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Vue d’ensemble de la sécurité du réseau</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-azure-encryption-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Vue d’ensemble du chiffrement des données</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/develop">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Développer et déployer des applications sécurisées</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-disk-encryption">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Comment chiffrer des machines virtuelles Azure</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/develop/secure-dev-overview">Bonnes pratiques du développement sécurisé</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            ...
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/fundamentals/abstract-network-security">Sécurité du réseau Azure</a>
                            </li>
                            <li style="list-style: none;">
        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">Conformité</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">Services de ressources &amp;</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <a href="https://www.microsoft.com/en-us/trustcenter/">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Centre de gestion de la confidentialité MSFT</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="https://azuremarketplace.microsoft.com/en-us/marketplace/apps?search=security&page=1">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Partenaires de sécurité Azure</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/fundamentals/cyber-services">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Conseils sur la cybersécurité</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/fundamentals/pen-testing">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Test de pénétration</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-disk-encryption">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Chiffrement de disque</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/multi-factor-authentication/">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Authentification multifacteur (MFA)</p>
                        </div>
                    </div>
                </div>
            </div>
