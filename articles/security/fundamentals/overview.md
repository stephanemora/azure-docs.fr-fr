...
| :------------- | :------------- |:------------- |:------------- |:------------- |
|   [Objets annuaire](https://docs.microsoft.com/azure/active-directory/active-directory-editions),   [Gestion des utilisateurs/groupes (ajout/mise à jour/suppression)/Attribution basée sur l'utilisateur/Inscription de l'appareil](https://docs.microsoft.com/azure/active-directory/active-directory-editions),     [Authentification unique (SSO)](https://docs.microsoft.com/azure/active-directory/active-directory-editions),    [Modification de mot de passe en libre-service pour les utilisateurs du cloud](https://docs.microsoft.com/azure/active-directory/active-directory-editions),    [Connect (moteur de synchronisation qui étend les annuaires locaux à Azure Active Directory)](https://docs.microsoft.com/azure/active-directory/active-directory-editions),    [Rapports de sécurité/d’utilisation](https://docs.microsoft.com/azure/active-directory/active-directory-editions)       |     [Provisionnement/gestion des accès par groupe](https://docs.microsoft.com/azure/active-directory/active-directory-editions),    [Réinitialisation de mot de passe en libre-service pour les utilisateurs du cloud](https://docs.microsoft.com/azure/active-directory/active-directory-editions),     [Image de l'entreprise (personnalisation des pages de connexion/du volet d'accès)](https://docs.microsoft.com/azure/active-directory/active-directory-editions),   [Proxy d'application](https://docs.microsoft.com/azure/active-directory/active-directory-editions),   [SLA de 99,9 %](https://docs.microsoft.com/azure/active-directory/active-directory-editions) |  [Gestion des groupes et des applications en libre-service/Ajout d'applications en libre-service/Groupes dynamiques](https://docs.microsoft.com/azure/active-directory/active-directory-editions), [Réinitialisation/Modification/Déverrouillage de mot de passe en libre-service avec écriture différée locale](https://docs.microsoft.com/azure/active-directory/active-directory-editions),   [Authentification multifacteur cloud et locale (serveur MFA)](https://docs.microsoft.com/azure/active-directory/active-directory-editions),    [CAL MIM + serveur MIM](https://docs.microsoft.com/azure/active-directory/active-directory-editions),    [Cloud App Discovery](https://docs.microsoft.com/azure/active-directory/active-directory-editions),     [Connect Health](https://docs.microsoft.com/azure/active-directory/active-directory-editions),  [Substitution automatique de mot de passe pour les comptes de groupe](https://docs.microsoft.com/azure/active-directory/active-directory-editions)|  [Identity Protection](https://docs.microsoft.com/azure/active-directory/active-directory-identityprotection), [Privileged Identity Management](https://docs.microsoft.com/azure/active-directory/active-directory-privileged-identity-management-configure)|  [Jonction d’appareil à Azure AD/SSO Desktop/Microsoft Passport pour Azure AD/Récupération BitLocker de l’administrateur](https://docs.microsoft.com/azure/active-directory/active-directory-editions), [Inscription automatique MDM/Récupération BitLocker libre-service/Administrateurs locaux supplémentaires pour appareils Windows 10 par jonction Azure AD](https://docs.microsoft.com/azure/active-directory/active-directory-editions)|
