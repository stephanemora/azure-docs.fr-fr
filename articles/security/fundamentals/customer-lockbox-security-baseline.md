...
description: La base de sécurité de la fonctionnalité Customer Lockbox pour Microsoft Azure fournit des instructions et des ressources procédurales pour l’implémentation des recommandations de sécurité spécifiées dans le Benchmark de sécurité Azure.
author: msmbaldwin
ms.service: security
ms.topic: conceptual
ms.date: 03/31/2021
...
Cette base de sécurité applique les instructions du [Benchmark de sécurité Azure version 1.0](../benchmarks/overview-v1.md) à la fonctionnalité Customer Lockbox. Le benchmark de sécurité Azure fournit des recommandations sur la façon dont vous pouvez sécuriser vos solutions cloud sur Azure. Le contenu est regroupé en fonction des **contrôles de sécurité** définis par le Benchmark de sécurité Azure et les instructions associées applicables à la fonctionnalité Customer Lockbox. 

>[!NOTE]
>Les **contrôles** non applicables à la fonctionnalité Customer Lockbox, ou dont la responsabilité incombe à Microsoft, ont été exclus. Pour voir comment la fonctionnalité Customer Lockbox mappe complètement au Benchmark de sécurité Azure, consultez le [fichier de mappage complet de la base de sécurité de la fonctionnalité Customer Lockbox](https://github.com/MicrosoftDocs/SecurityBenchmarks/tree/master/Azure%20Offer%20Security%20Baselines).

## <a name="logging-and-monitoring"></a>Journalisation et supervision

*Pour plus d’informations, consultez [Benchmark de sécurité Azure : journalisation et supervision](../benchmarks/security-control-logging-monitoring.md).*
...
*Pour plus d’informations, consultez [Benchmark de sécurité Azure : contrôle des accès et des identités](../benchmarks/security-control-identity-access-control.md).*

### <a name="31-maintain-an-inventory-of-administrative-accounts"></a>3.1 : Tenir un inventaire des comptes d’administration

**Conseils** : conservez un inventaire des comptes d’utilisateur qui ont un accès administratif à vos demandes Customer Lockbox. Vous pouvez utiliser le volet de gestion des identités et des accès (IAM) dans le portail Azure de votre abonnement afin de configurer le contrôle d’accès en fonction du rôle d’Azure (Azure RBAC). Les rôles sont appliqués aux utilisateurs, aux groupes, aux principaux de service et aux identités managées dans Azure Active Directory (Azure AD).
...
**Aide** : activez l’authentification multifacteur Azure AD et suivez les recommandations de gestion des identités et des accès d’Azure Security Center.
...
**Aide** : utilisez une station de travail à accès privilégié sur laquelle l’authentification multifacteur Azure AD est activé pour vous connecter à vos demandes Customer Lockbox et les configurer. 
...
**Aide** : en cas d’écart de comportement des connexions au compte dans le plan de contrôle (par exemple, le portail Azure), utilisez les fonctionnalités de protection des identités et de détection des risques d’Azure Active Directory (Azure AD) pour configurer des réponses automatisées aux actions suspectes détectées en lien avec les identités utilisateur. Vous pouvez également ingérer des données dans Azure Sentinel pour approfondir votre examen.
...
*Pour plus d’informations, consultez [Benchmark de sécurité Azure : protection des données](../benchmarks/security-control-data-protection.md).*
...
*Pour plus d’informations, consultez [Benchmark de sécurité Azure : Gestion des stocks et des ressources](../benchmarks/security-control-inventory-asset-management.md).*
...
*Pour plus d’informations, consultez [Benchmark de sécurité Azure : Configuration sécurisée](../benchmarks/security-control-secure-configuration.md).*
...
*Pour plus d’informations, consultez [Benchmark de sécurité Azure : Défense contre les programmes malveillants](../benchmarks/security-control-malware-defense.md).*
...
*Pour plus d’informations, consultez [Benchmark de sécurité Azure : réponse aux incidents](../benchmarks/security-control-incident-response.md).*
...
*Pour plus d’informations, consultez [Benchmark de sécurité Azure : tests d’intrusion et exercices Red Team](../benchmarks/security-control-penetration-tests-red-team-exercises.md).*
