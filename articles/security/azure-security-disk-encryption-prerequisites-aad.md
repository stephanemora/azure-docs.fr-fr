...
3. Vérifiez les versions installées des modules.
      ...
      ```
4. Connectez-vous à Azure à l’aide de la cmdlet [Connect-AzAccount](/powershell/module/az.accounts/connect-azaccount).
...
1. Si nécessaire, [connectez-vous à votre abonnement Azure](azure-security-disk-encryption-appendix.md#bkmk_ConnectPSH).
2. Pour créer une application Azure AD, utilisez la cmdlet PowerShell [New-AzADApplication](/powershell/module/az.resources/new-azadapplication). Vous pouvez définir MyApplicationHomePage et MyApplicationUri sur les valeurs de votre choix.
