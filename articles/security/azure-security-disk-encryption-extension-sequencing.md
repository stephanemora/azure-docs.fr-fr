...
* Appliquer l’extension Azure Disk Encryption après un script d’interpréteur de commandes personnalisé qui formate le support (Linux) : [deploy-extseq-linux-ADE-after-customscript.json](https://github.com/Azure-Samples/compute-automation-configurations/blob/master/ade-vmss/deploy-extseq-linux-ADE-after-customscript.json)
