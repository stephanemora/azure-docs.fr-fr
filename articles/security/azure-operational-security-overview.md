...
Pour plus d’informations, consultez le [tableau des composants de Sauvegarde Azure](https://docs.microsoft.com/azure/backup/backup-introduction-to-azure-backup#which-backup-agent-should-i-use).
