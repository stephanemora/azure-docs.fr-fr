---
title: Configuration du partage des ressources cross-origin (CORS) dans l’API Azure pour FHIR
description: Cet article décrit comment configurer le partage des ressources cross-origin (CORS) dans l’API Azure pour FHIR
author: matjazl
ms.author: matjazl
ms.date: 3/11/2019
ms.topic: reference
...
ms.locfileid: "67033753"
---
# <a name="configure-cross-origin-resource-sharing-in-the-azure-api-for-fhir"></a>Configuration du partage des ressources cross-origin (CORS) dans l’API Azure pour FHIR
