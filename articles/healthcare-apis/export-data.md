...
Sélectionnez le panneau Réseau du compte de stockage Azure à partir du portail. 
...
Sélectionnez « Réseaux sélectionnés » et spécifiez l’adresse IP dans la zone **Plage d’adresses** en dessous de la section Pare-feu \| Ajouter des plages d’adresses IP pour autoriser l’accès à partir d’Internet ou de vos réseaux locaux. Dans le tableau ci-dessous, vous trouverez l’adresse IP correspondant à la région Azure dans laquelle le service API Azure pour FHIR est provisionné.
