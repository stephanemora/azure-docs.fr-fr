---
title: Inscrire une application cliente confidentielle dans Azure Active Directory - API Azure pour FHIR
...
Dans cet article, vous avez découvert comment inscrire une application cliente confidentielle dans Azure Active Directory. Ensuite, déployez une API FHIR dans Azure.
