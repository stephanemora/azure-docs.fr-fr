...
ms.locfileid: "122777596"
---
# <a name="access-the-fhir-service-using-postman"></a>Accéder au service FHIR à l’aide du poster

> [!IMPORTANT]
> Les API Azure Healthcare sont actuellement en version préliminaire. L’[Avenant aux conditions d’utilisation pour les préversions de Microsoft Azure](https://azure.microsoft.com/support/legal/preview-supplemental-terms/) contient des conditions légales supplémentaires qui s’appliquent aux fonctionnalités Azure en version bêta, en préversion ou pas encore en disponibilité générale.

Dans cet article, nous allons examiner les étapes d’accès au service FHIR des API de santé (par le biais du service FHIR) avec le [poste](https://www.getpostman.com/).

## <a name="prerequisites"></a>Prérequis

* Service FHIR déployé dans Azure. Pour plus d’informations sur le déploiement du service FHIR, consultez [déployer un service FHIR](fhir-portal-quickstart.md).
...
* Autorisations accordées à l’application cliente et à votre compte d’utilisateur, par exemple, « FHIR Data Contributor », pour accéder au service FHIR. Pour plus d’informations, consultez [déployer un service FHIR dans les API de santé Azure](fhir-portal-quickstart.md).
...
[![Créer un nouvel espace de travail dans le billet. ](media/postman/postman-create-new-workspace.png) ](media/postman/postman-create-new-workspace.png#lightbox)
...
[![Créez un nouveau regroupement. ](media/postman/postman-create-a-new-collection.png) ](media/postman/postman-create-a-new-collection.png#lightbox)
...
[![Importez des données. ](media/postman/postman-import-data.png) ](media/postman/postman-import-data.png#lightbox)
...
> [!NOTE]
> Vérifiez que vous avez configuré l’URL de redirection, [https://www.getpostman.com/oauth2/callback](https://www.getpostman.com/oauth2/callback) , dans l’inscription de l’application cliente.

[![Variable d’environnement. ](media/postman/postman-environments-variable.png) ](media/postman/postman-environments-variable.png#lightbox)
...
[![Créez une nouvelle demande. ](media/postman/postman-create-new-request.png) ](media/postman/postman-create-new-request.png#lightbox)
...
[![Paramètres de l’instruction de fonctionnalité. ](media/postman/postman-capability-statement.png) ](media/postman/postman-capability-statement.png#lightbox)

[![Enregistrez la demande. ](media/postman/postman-save-request.png) ](media/postman/postman-save-request.png#lightbox)
...
5. Appuyez sur **Envoyer**. vous devez voir une réponse avec le jeton d’accès Azure AD, qui est automatiquement enregistré dans la variable `accessToken` . Vous pouvez ensuite l’utiliser dans toutes les demandes de l’API du service FHIR.

  [![Bouton Envoyer. ](media/postman/postman-send-button.png) ](media/postman/postman-send-button.png#lightbox)
...
[![Revendications de jeton d’accès. ](media/postman/postman-access-token-claims.png) ](media/postman/postman-access-token-claims.png#lightbox)
...
[![Sélectionnez le jeton du porteur. ](media/postman/postman-select-bearer-token.png) ](media/postman/postman-select-bearer-token.png#lightbox)
...
[![Bouton Envoyer pour créer un nouveau patient. ](media/postman/postman-send-create-new-patient.png) ](media/postman/postman-send-create-new-patient.png#lightbox)
...
[![Publiez pour créer un nouveau patient 202 réponse acceptée. ](media/postman/postman-202-accepted-response.png) ](media/postman/postman-202-accepted-response.png#lightbox)
