---
title: Azure Policy les contrôles de conformité réglementaire pour le service FHIR des API de santé Azure
description: Répertorie Azure Policy contrôles de conformité réglementaire disponibles. Ces définitions de stratégie intégrées fournissent des approches courantes pour la gestion de la conformité de vos ressources Azure.
ms.date: 09/17/2021
ms.topic: sample
author: matjazl
ms.author: chrupa
