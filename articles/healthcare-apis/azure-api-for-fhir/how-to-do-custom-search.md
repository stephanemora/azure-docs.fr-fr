...
description: Cet article explique comment vous pouvez définir vos propres paramètres de recherche personnalisés dans l’API Azure pour FHIR à utiliser dans la base de données.
...
ms.locfileid: "129358495"
---
# <a name="defining-custom-search-parameters-for-azure-api-for-fhir"></a>Définition de paramètres de recherche personnalisés pour l’API Azure pour FHIR
