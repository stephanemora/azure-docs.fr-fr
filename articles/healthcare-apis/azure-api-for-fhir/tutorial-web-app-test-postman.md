...
ms.locfileid: "121784668"
---
# <a name="testing-the-fhir-api-on-azure-api-for-fhir"></a>Test de l’API FHIR sur Azure API pour FHIR
...
* [Azure AD et API Azure pour FHIR](azure-active-directory-identity-configuration.md) – Ce document décrit certains principes de base d’Azure Active Directory ainsi que son interaction avec l’API Azure pour FHIR.
* [Validation des jetons d’accès](azure-api-fhir-access-token-validation.md) – Ce guide pratique fournit des détails plus spécifiques sur la validation des jetons d’accès et sur la façon de résoudre les problèmes d’accès.
