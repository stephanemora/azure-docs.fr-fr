...
ms.locfileid: "121782591"
---
# <a name="deploy-javascript-app-to-read-data-from-azure-api-for-fhir"></a>Déployer une application JavaScript pour lire des données à partir de l’API Azure pour FHIR
