...
- Postman installé. 
  ...
  pour plus d’informations sur la publication, consultez [Prise en main avec le poster](https://www.getpostman.com).
...
![Définir OAuth 2.0](media/tutorial-postman/postman-select-oauth-two.png)
