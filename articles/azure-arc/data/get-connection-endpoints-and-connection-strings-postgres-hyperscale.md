...
> [!NOTE]
>
> - Le mot de passe de l'utilisateur _postgresql_ indiqué dans le point de terminaison nommé « _Instance PostgreSQL_ » est le mot de passe que vous avez choisi lors de la création du groupe de serveurs.
