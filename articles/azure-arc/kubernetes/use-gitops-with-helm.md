...
Exécutez la commande suivante et accédez à [localhost:3000](http://localhost:3000) sur votre navigateur pour vérifier que l’application fonctionne.
