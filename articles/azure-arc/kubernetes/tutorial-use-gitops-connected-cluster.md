...
* Déploiement : `cluster-config/azure-vote`
* ConfigMap : `team-a/endpoints`

Le `config-agent` interroge Azure sur l’existence de configurations nouvelles ou mises à jour. Cette tâche peut prendre jusqu’à 30 secondes.
...
| `--helm-operator-version` | Version de chart pour l’opérateur Helm (si activé). Utilisez la version 1.2.0 et ultérieure. Valeur par défaut : '1.2.0'. |
...
Passez à l’article suivant pour apprendre à utiliser Helm avec des configurations.
> [!div class="nextstepaction"]
> [Utiliser Helm avec des configurations](./use-gitops-with-helm.md)
