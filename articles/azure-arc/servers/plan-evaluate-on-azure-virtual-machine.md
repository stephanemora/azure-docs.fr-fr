...
* Découvrez [comment planifier et activer un grand nombre de machines sur des serveurs compatibles avec Azure Arc](plan-at-scale-deployment.md) afin de simplifier la configuration de fonctionnalités essentielles de sécurité, de gestion et de surveillance dans Azure.
