---
title: Créer un nouvel abonnement Azure associé à votre compte de facturation | Microsoft Docs
...
Cet article s’applique à un compte de facturation associé à un Contrat client Microsoft. [Vérifiez que vous avez accès à un Contrat client Microsoft](#check-access-to-a-microsoft-customer-agreement). Si vous souhaitez créer des abonnements pour d’autres comptes de facturation, consultez [Créer un abonnement supplémentaire dans le Portail Azure](billing-create-subscription.md).
...
5. Sélectionnez un profil de facturation. Les frais de votre abonnement sont repris sur la facture du profil de facturation et sont payés conformément à ses modes de paiement. Si vous avez accès à un seul profil de facturation, la sélection est grisée.

6. Sélectionnez une section de facture. Les frais de votre abonnement sont repris sur cette section de la facture du profil de facturation. Si vous avez accès à une seule section de facturation, la sélection est grisée.
...
6. Sélectionnez le rôle **Créateur de l’abonnement Azure**.
   ...
   ![Capture d’écran montrant l’attribution du rôle de créateur d’abonnement Azure à un utilisateur](./media/billing-mca-create-subscription/billing-mca-add-azure-subscription-creator.png)
