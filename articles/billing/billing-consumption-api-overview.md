...
Pour plus d’informations, consultez la spécification technique de [l’API Balances](https://docs.microsoft.com/rest/api/consumption/getbalancesbybillingaccount).
...
Utilisez cette API pour obtenir des recommandations pour l’achat d’instances de machines virtuelles réservées. Les recommandations sont conçues pour permettre aux clients d’analyser les économies et les montants d’achat attendus. 
