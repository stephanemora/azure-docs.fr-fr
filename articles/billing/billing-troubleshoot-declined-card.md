...
Cet article vous aidera à résoudre les problèmes de refus de carte de crédit lors de l'inscription Azure sur le portail Azure ou dans le Centre des comptes Azure. Avant de tenter de résoudre le problème, vérifiez les points suivants :

- Vérifiez que les informations que vous avez fournies pour votre profil de compte Azure (notamment l'adresse e-mail, l'adresse postale et le numéro de téléphone à contacter) sont correctes.
...
Les principaux problèmes susceptibles d'entraîner le refus d'une carte de crédit lors de l'inscription à Azure sont répertoriés ci-dessous.
...
[Vous ne parvenez pas à vous inscrire à Azure depuis le portail Azure ou le Centre des comptes Azure](billing-troubleshoot-azure-sign-up.md)
...
Pour plus d'informations sur le paiement par facture, consultez [Soumettre une demande de paiement par facture de l'abonnement Azure](billing-how-to-pay-by-invoice.md).

### <a name="your-credit-card-information-is-outdated"></a>Les informations de votre carte de crédit sont obsolètes 

Pour plus d'informations sur la gestion des informations de votre carte, notamment sur la modification ou la suppression d'une carte, consultez [Ajouter, mettre à jour ou supprimer une carte de crédit pour Azure](billing-how-to-change-credit-card.md).
...
- [Problèmes d’inscription](billing-troubleshoot-azure-sign-up.md)
- [Problèmes liés à la souscription d'un abonnement](billing-troubleshoot-sign-in-issue.md)
