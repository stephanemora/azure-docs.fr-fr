...
1. Accédez au [portail Azure](https://portal.azure.com) pour soumettre une demande de support. Recherchez et sélectionnez **Aide + support**.
    ...
    ![Recherche d’aide et de support, portail Microsoft Azure](./media/billing-how-to-pay-by-invoice/search-for-help-and-support.png)

2. Sélectionnez **Nouvelle demande de support**.

    ![Lien de la nouvelle demande de support, écran Aide + support, portail Microsoft Azure](./media/billing-how-to-pay-by-invoice/help-and-support.png)
...
1. Accédez au [portail Azure](https://portal.azure.com) pour vous connecter en tant qu’administrateur de compte. Recherchez et sélectionnez **Gestion des coûts + facturation**.
    ...
    ![Recherche de Gestion des coûts + facturation, portail Microsoft Azure](./media/billing-how-to-pay-by-invoice/search.png)
...
1. Dans la barre de commandes, sélectionnez le bouton **Payer par facture**.
    ...
    ![Bouton Payer par facture, Modes de paiement, portail Microsoft Azure](./media/billing-how-to-pay-by-invoice/pay-by-invoice.png)
...
1. Dans le menu, choisissez **Profils de facturation**.
    ...
    ![Option de menu Profils de facturation, Gestion des coûts + facturation, portail Microsoft Azure](./media/billing-how-to-pay-by-invoice/billing-profile.png)

1. Sélectionnez un profil de facturation.
1. Dans le menu **Profil de facturation**, sélectionnez **Modes de paiement**.

   ![Option de menu Modes de paiement, Profils de facturation, Gestion des coûts, portail Microsoft Azure](./media/billing-how-to-pay-by-invoice/billing-profile-payment-methods.png)

1. Sélectionnez la bannière indiquant que vous êtes éligible au paiement par chèque/virement bancaire.

    ![Bannière pour basculer vers chèque/virement bancaire, Modes de paiement, portail Microsoft Azure](./media/billing-how-to-pay-by-invoice/customer-led-switch-to-invoice.png)
