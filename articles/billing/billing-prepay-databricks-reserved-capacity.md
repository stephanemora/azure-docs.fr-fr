...
![Exemple d’achat Azure Databricks dans le portail Azure](./media/billing-prepay-databricks-reserved-capacity/data-bricks-pre-purchase.png)
...
Vous ne pouvez pas fractionner ou fusionner l’unité de validation Databricks avant l’achat. Pour plus d’informations sur la gestion des réservations, consultez [Gérer les réservations après l’achat](billing-manage-reserved-vm-instance.md).
...
- Pour plus d’informations sur les réservations Azure, consultez les articles suivants :
  ...
  - [Comprendre comment une remise DBCU Azure Databricks est appliquée avant l’achat](billing-reservation-discount-databricks.md)
