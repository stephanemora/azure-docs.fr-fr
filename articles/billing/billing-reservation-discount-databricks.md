...
- Pour en savoir plus sur le préachat d’Azure Databricks pour faire des économies, veuillez consulter [Optimiser les coûts de Azure Databricks avec un pré-achat](billing-prepay-databricks-reserved-capacity.md).
