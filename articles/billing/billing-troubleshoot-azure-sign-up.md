...
### <a name="error-we-cannot-proceed-with-sign-up-due-to-an-issue-with-your-account-please-contact-billing-support"></a>Error: *En raison d’un problème lié à votre compte, nous ne pouvons pas procéder à l’inscription. Veuillez contacter le support de facturation.*
...
![Vérification d'identité par carte](./media/billing-troubleshoot-azure-sign-up/identify-verification-by-card.png)
...
Vous pouvez voir une petite vérification retenue sur votre compte de carte de crédit après votre inscription. La retenue est supprimée dans un délai de trois à cinq jours. Si vous êtes soucieux quant à la gestion des coûts, lisez-en davantage sur la [prévention des coûts inattendus](billing-getting-started.md).
...
### <a name="error-your-current-account-type-is-not-supported"></a>Error: *Le type de votre compte actuel n’est pas pris en charge*
