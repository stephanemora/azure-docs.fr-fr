...
|**Catégorie**    |**Name**                                 |
|----------------|-----------------------------------------|
|Outils Azure     |[Azure PowerShell (6.1.0)](https://docs.microsoft.com/powershell/azure/overview)<br> [Azure CLI (2.0.33)](https://docs.microsoft.com/cli/azure)|
...
|.NET        |4.6        |
|Node.js     |8.9.4       |
|PowerShell  |5.1 et [6.0.2](https://github.com/PowerShell/powershell/releases)       |
|Python      |2.7        |
