...
**Conseils** : Azure Cloud Shell est une expérience de ligne de commande basée sur un navigateur qui utilise la même autorisation que celle utilisée pour accéder au Portail Azure. Dans ce cas, toute authentification multifacteur requise pour se connecter au Portail Azure est également nécessaire pour Cloud Shell.
