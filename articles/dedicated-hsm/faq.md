---
title: Questions fréquentes (FAQ) sur le service HSM dédié Azure | Microsoft Docs
...
### <a name="q-what-is-azure-dedicated-hsm-offering"></a>Q : En quoi consiste l’offre de service HSM dédié Azure ?
...
## <a name="what-hardware-is-used-for-dedicated-hsm"></a>Quel est le matériel utilisé pour le service HSM dédié ?
...
### <a name="q-what-is-an-hsm-used-for"></a>Q : À quoi sert un module HSM ?
...
### <a name="q-how-does-dedicated-hsm-work"></a>Q : Comment le service HSM dédié fonctionne-t-il ?
...
### <a name="q-how-does-my-application-connect-to-a-dedicated-hsm"></a>Q : Comment mon application se connecte-t-elle à un module HSM dédié ?
...
### <a name="q-can-an-application-connect-to-dedicated-hsm-from-a-different-vnet-in-or-across-regions"></a>Q : Une application peut-elle se connecter à un module HSM dédié à partir d’un autre réseau virtuel situé dans ou plusieurs régions ?
...
### <a name="q-can-i-synchronize-dedicated-hsm-with-on-premises-hsms"></a>Q : Puis-je synchroniser le service HSM dédié avec des modules HSM locaux ?
...
### <a name="q-can-i-encrypt-data-used-by-other-azure-services-using-keys-stored-in-dedicated-hsm"></a>Q : Puis-je chiffrer les données utilisées par d’autres services Azure à l’aide des clés stockées dans le service HSM dédié ?

Non. Les modules HSM dédiés Azure sont accessibles uniquement à l’intérieur de votre réseau virtuel.

### <a name="q-can-i-import-keys-from-an-existing-on-premises-hsm-to-dedicated-hsm"></a>Q : Puis-je importer les clés d’un module HSM local existant vers le service HSM dédié ?
...
### <a name="q-what-operating-systems-are-supported-by-dedicated-hsm-client-software"></a>Q : Quels systèmes d’exploitation les logiciels clients du service HSM dédié prennent-ils en charge ?

* Windows, Linux, Solaris, AIX, HP-UX, FreeBSD
* Virtuel : VMware, hyper-v, Xen, KVM

### <a name="q-how-do-i-configure-my-client-application-to-create-a-high-availability-configuration-with-multiple-partitions-from-multiple-hsms"></a>Q : Comment faire pour configurer mon application cliente de façon à créer une configuration à haute disponibilité avec plusieurs partitions issues de plusieurs modules HSM ?
...
### <a name="q-what-authentication-mechanisms-are-supported-by-dedicated-hsm"></a>Q : Quels sont les mécanismes d’authentification pris en charge par le service HSM dédié ?
...
### <a name="q-what-sdks-apis-client-software-is-available-to-use-with-dedicated-hsm"></a>Q : Quels SDK, API et logiciels clients est-il possible d’utiliser avec le service HSM dédié ?

PKCS #11, Java (JCA/JCE), Microsoft CAPI, CNG, OpenSSL

### <a name="q-can-i-importmigrate-keys-from-luna-56-hsms-to-azure-dedicated-hsms"></a>Q : Est-il possible d’importer/migrer des clés de modules HSM Luna 5/6 dans des modules HSM dédiés Azure ?
...
### <a name="q-can-dedicated-hsm-be-used-with-office-365-customer-key-azure-information-protection-azure-data-lake-store-disk-encryption-azure-storage-encryption-azure-sql-tde"></a>Q : Le service HSM dédié peut-il être utilisé avec la Clé client dans Office 365, Azure Information Protection, Azure Data Lake Store, Disk Encryption, le chiffrement Stockage Azure, le chiffrement TDE Azure SQL ?
...
### <a name="q-does-the-customer-get-full-exclusive-control-over-the-hsms-with-dedicated-hsms"></a>Q : Le client dispose-t-il d’un contrôle exclusif total sur les modules HSM avec les modules HSM dédiés ?
...
### <a name="q-what-level-of-access-does-microsoft-have-to-my-hsm"></a>Q : De quel niveau d’accès Microsoft bénéficie-t-il sur mon module HSM ?
...
### <a name="q-can-microsoft-or-anyone-at-microsoft-access-keys-in-my-dedicated-hsm"></a>Q : Est-il possible à Microsoft ou à toute personne travaillant chez Microsoft d’accéder aux clés de mon module HSM dédié ?

Non. Microsoft n’a pas accès aux clés stockées dans le module HSM dédié alloué par le client.

### <a name="q-can-i-upgrade-softwarefirmware-on-hsms-allocated-to-me"></a>Q : Puis-je mettre à niveau les logiciels/microprogrammes sur les modules HSM qui me sont alloués ?
...
### <a name="q-how-do-i-manage-dedicated-hsm"></a>Q : Comment faire pour gérer les modules HSM dédiés ?

Vous pouvez gérer les modules HSM dédiés en y accédant avec SSH.

### <a name="q-how-do-i-manage-partitions-on-the-dedicated-hsm"></a>Q : Comment faire pour gérer les partitions sur le module HSM dédié ?

Le logiciel client HSM Gemalto sert à gérer les modules HSM et les partitions.

### <a name="q-how-do-i-monitor-my-hsm"></a>Q : Comment faire pour superviser mon module HSM ?
...
### <a name="q-can-i-get-full-access-log-of-all-hsm-operations-from-dedicated-hsm"></a>Q : Puis-je obtenir un journal en accès complet de toutes les opérations du module HSM dédié ?

Oui. Vous pouvez envoyer des journaux de l’appliance HSM vers un serveur syslog.

## <a name="high-availability"></a>Haute disponibilité

### <a name="q-is-it-possible-to-configure-high-availability-in-the-same-region-or-across-multiple-regions"></a>Q : Est-il possible de configurer la haute disponibilité dans une même région ou dans plusieurs régions ?
...
### <a name="q-how-many-hsms-can-i-add-to-the-same-high-availability-configuration-from-one-single-application"></a>Q : Combien de modules HSM puis-je ajouter à une même configuration de haute disponibilité pour une application unique ?

16.

## <a name="support"></a>Support

### <a name="q-what-is-the-sla-for-dedicated-hsm-service"></a>Q : Quel contrat SLA le service HSM dédié offre-t-il ?
...
### <a name="q-how-do-i-ensure-that-keys-in-my-dedicated-hsms-are-not-lost-due-to-error-or-a-malicious-insider-attack"></a>Q : Comment faire pour éviter la perte des clés stockées dans les modules HSM dédiés à la suite d’une erreur ou d’une attaque interne malveillante ?
...
### <a name="q-how-do-i-get-support-for-dedicated-hsm"></a>Q : Comment faire pour bénéficier d’un support technique pour le service HSM dédié ?
...
### <a name="q-how-do-i-get-access-to-dedicated-hsm-client-software-documentation-firmware-images"></a>Q : Comment faire pour accéder au logiciel client, à la documentation et aux images de microprogramme du module HSM dédié ?
...
### <a name="q-is-it-safe-to-store-encryption-keys-for-my-most-important-data-in-dedicated-hsm"></a>Q : Est-il sûr de stocker les clés de chiffrement pour mes données les plus importantes dans le service HSM dédié ?
...
### <a name="q-what-cryptographic-keys-and-algorithms-are-supported-by-dedicated-hsm"></a>Q : Quels algorithmes et quelles clés de chiffrement le service HSM dédié prend-il en charge ?

Le service HSM dédié provisionne des appliances SafeNet Network HSM 7. Elles prennent en charge un large éventail d’algorithmes et de types de clé de chiffrement, dont l’ensemble de la suite B.
...
* Symétrique :
  ...
  * Encapsulage de clés : SP800-38F
  * Génération de nombres aléatoires : DRGB agréé par FIPS 140-2 (mode CTR SP 800-90), conforme à BSI DRG.4

### <a name="q-is-dedicated-hsm-fips-140-2-level-3-validated"></a>Q : Le service HSM dédié est-il certifié FIPS 140-2 de niveau 3 ?

Oui. Le service HSM dédié provisionne les appliances SafeNet Network HSM 7 qui utilisent des modules HSM certifiés FIPS 140-2 de niveau 3.

### <a name="q-what-do-i-need-to-do-to-make-sure-i-operate-dedicated-hsm-in-fips-140-2-level-3-validated-mode"></a>Q : Que faire pour que le service HSM dédié fonctionne en mode certifié FIPS 140-2 de niveau 3 ?
...
### <a name="q-how-many-cryptographic-operations-are-supported-per-second-with-dedicated-hsm"></a>Q : Combien d’opérations de chiffrement par seconde sont prises en charge avec le service HSM dédié ?
...
### <a name="q-how-many-partitions-can-be-created-in-dedicated-hsm"></a>Q : Combien de partitions est-il possible de créer dans le service HSM dédié ?

Selon le modèle de module HSM utilisé, les partitions disponibles sont au nombre de 10.

### <a name="q-how-many-keys-can-be-supported-in-dedicated-hsm"></a>Q : Combien de clés le service HSM dédié prend-il en charge ?
