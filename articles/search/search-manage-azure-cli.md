...
Pour [créer un service de recherche](search-create-service-portal.md), utilisez la commande [**az search service create**](/cli/azure/search/service#az_search_service_create).
