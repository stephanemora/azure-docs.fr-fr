...
+ *Un service par locataire :* chaque locataire possède son propre service Recherche cognitive Azure dédié, pour un niveau de séparation maximal entre les données et la charge de travail.

+ *Combinaison des deux :* les locataires les plus volumineux et actifs se voient attribuer des services dédiés, tandis que les locataires plus petits se voient attribuer des index individuels au sein de services partagés.

## <a name="model-1-one-index-per-tenant"></a>Modèle 1 : Un index par locataire
...
## <a name="model-3-hybrid"></a>Modèle 3 : Hybride
