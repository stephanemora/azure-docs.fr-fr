...
* Un [espace de travail AML](https://docs.microsoft.com/azure/machine-learning/concept-workspace)
* Une [cible de calcul AML Azure Kubernetes Service](https://docs.microsoft.com/azure/machine-learning/concept-compute-target) dans cet espace de travail avec un [modèle déployé](https://docs.microsoft.com/azure/machine-learning/how-to-deploy-azure-kubernetes-service)
  * La [cible de calcul doit permettre l’utilisation du protocole SSL](https://docs.microsoft.com/azure/machine-learning/how-to-secure-web-service#deploy-on-aks-and-field-programmable-gate-array-fpga). Recherche cognitive Azure autorise uniquement l’accès aux points de terminaison **https**.
...
|--------------------|-------------|
| `uri` | (Requis [en l’absence d’authentification ou pour une authentification par clé](#WhatSkillParametersToUse)) [URI de scoring du service AML](https://docs.microsoft.com/azure/machine-learning/how-to-consume-web-service) auquel la charge utile _JSON_ sera envoyée. Seul le schéma d’URI **https** est autorisé. |
| `key` | (Requis pour l’[authentification par clé](#WhatSkillParametersToUse)) [Clé du service AML](https://docs.microsoft.com/azure/machine-learning/how-to-consume-web-service#authentication-with-keys). |
...
* [Authentification basée sur une clé](https://docs.microsoft.com/azure/machine-learning/concept-enterprise-security#authentication-for-web-service-deployment). Une clé statique est fournie pour authentifier les demandes de scoring des compétences AML
  * Utiliser les paramètres _uri_ et _key_
* [Authentification basée sur un jeton](https://docs.microsoft.com/azure/machine-learning/concept-enterprise-security#authentication). Le service AML est [déployé à l’aide de l’authentification basée sur un jeton](https://docs.microsoft.com/azure/machine-learning/how-to-deploy-azure-kubernetes-service#authentication-with-tokens). L’[identité managée](https://docs.microsoft.com/azure/active-directory/managed-identities-azure-resources/overview) du service Recherche cognitive Azure reçoit le [rôle Lecteur](https://docs.microsoft.com/azure/machine-learning/how-to-assign-roles) dans l’espace de travail du service AML. La compétence AML utilise ensuite l’identité managée du service Recherche cognitive Azure pour s’authentifier auprès du service AML, sans qu’aucune clé statique soit nécessaire.
...
+ [Résolution des problèmes liés au service AML](https://docs.microsoft.com/azure/machine-learning/how-to-troubleshoot-deployment)
