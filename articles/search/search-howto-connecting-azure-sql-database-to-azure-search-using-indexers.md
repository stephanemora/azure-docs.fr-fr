...
Pour l’indexation incrémentielle, la Recherche Azure prend en charge deux stratégies de détection des modifications : le suivi des modifications intégré SQL et la limite supérieure.
