...
Les compétences cognitives de la Recherche cognitive Azure sont basées sur les modèles Machine Learning des API Cognitive Services : [Vision par ordinateur](https://docs.microsoft.com/azure/cognitive-services/computer-vision/) et [Analyse de texte](https://docs.microsoft.com/azure/cognitive-services/text-analytics/overview). 
...
| Traitement en langage naturel | Traitement de texte pour des insights et des informations sur les entrées de texte. La détection de langue, l’analyse des sentiments et l’extraction de phrases clés sont des compétences qui se trouvent dans le traitement en langage naturel.  | Consulter [Compétence d’extraction de phrases clés](cognitive-search-skill-keyphrases.md), [Compétence de détection de langue](cognitive-search-skill-language-detection.md), [Compétence d’analyse des sentiments](cognitive-search-skill-sentiment.md) |
