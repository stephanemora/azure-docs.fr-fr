...
La recherche cognitive est une fonctionnalité d'évaluation du service [Recherche Azure](search-what-is-azure-search.md) prise en charge dans [ces régions](#where-do-i-start). 
