...
* [Stockage de tables Azure](search-howto-indexing-azure-tables.md) 
    * Notez que Stockage Table Azure n’est pas pris en charge pour la [recherche cognitive](cognitive-search-concept-intro.md).
