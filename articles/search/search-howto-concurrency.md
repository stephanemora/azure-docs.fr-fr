...
Cet extrait de code illustre l’ajout d’une ressource synonymMap à un index existant. Ce code est tiré le [synonymes (version préliminaire) C# exemple pour Azure Search](search-synonyms-tutorial-sdk.md).
