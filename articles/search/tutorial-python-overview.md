---
title: 'Tutoriel Python : Vue d’ensemble de l’intégration de la recherche'
titleSuffix: Azure Cognitive Search
description: Vue d’ensemble technique et informations de configuration permettant d’ajouter une fonctionnalité de recherche à un site web en Python, et d’effectuer son déploiement sur Azure Static Web Apps.
manager: nitinme
author: diberry
ms.author: diberry
...
ms.locfileid: "110580584"
---
# <a name="1---overview-of-adding-search-to-a-website-with-python"></a>1 - Vue d’ensemble de l’ajout de la recherche à un site web en Python
...
Cet exemple de site web permet d’accéder à un catalogue de 10 000 livres. Un utilisateur peut effectuer une recherche dans le catalogue en entrant du texte dans la barre de recherche. Pendant que l’utilisateur entre du texte, le site web utilise la fonctionnalité de suggestion de l’index de recherche pour compléter ce texte. Une fois la requête terminée, la liste des livres s’affiche avec une partie des détails. Un utilisateur peut sélectionner un livre pour en voir tous les détails, lesquels sont stockés dans l’index de recherche du livre. 
...
L’[exemple](https://github.com/Azure-Samples/azure-search-python-samples/tree/master/search-website) inclut les éléments suivants :

|Application|Objectif|GitHub<br>Référentiel<br>Location|
|--|--|--|
|Client|Application React (couche de présentation) pour afficher les livres, avec la recherche. Elle appelle l’application Azure Function. |[/search-website/src](https://github.com/Azure-Samples/azure-search-python-samples/tree/master/search-website/src)|
|Serveur|Application de fonction Azure Functions (couche métier) : appelle l’API Recherche cognitive Azure à l’aide du kit SDK Python |[/search-website/api](https://github.com/Azure-Samples/azure-search-python-samples/tree/master/search-website/src)|
|Insertion en bloc|Fichier Python pour créer l’index et y ajouter des documents.|[/search-website/bulk-upload](https://github.com/Azure-Samples/azure-search-python-samples/tree/master/search-website/bulk-upload)|
...
- Facultatif :
    - Ce tutoriel n’exécute pas l’API Azure Function localement mais si vous envisagez de le faire, vous devez installer [azure-functions-core-tools](../azure-functions/functions-run-local.md?tabs=linux%2ccsharp%2cbash).
...
1. Dans GitHub, dupliquez (fork) l’[exemple de référentiel](https://github.com/Azure-Samples/azure-search-python-samples). 
...
* [Créer un index de recherche et le charger avec des documents](tutorial-python-create-load-index.md)
