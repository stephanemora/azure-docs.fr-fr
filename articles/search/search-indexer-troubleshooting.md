---
title: Résoudre les problèmes courants des indexeurs dans la Recherche Azure | Microsoft Docs
description: Résolvez les problèmes courants des indexeurs dans la Recherche Azure.
author: mgottein
manager: cgronlun
services: search
ms.service: search
