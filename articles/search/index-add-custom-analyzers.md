...
Un *analyseur personnalisé* est la combinaison d'un générateur de jetons définie par l'utilisateur, d'un ou plusieurs filtres de jetons et d'un ou plusieurs filtres de caractères spécifiés dans l'index de recherche, et qui font référence à des définitions de champ qui nécessitent une analyse personnalisée. Le générateur de jetons est chargé de segmenter le texte en jetons tandis que les filtres de jeton modifient les jetons émis par le générateur de jetons. Les filtres de caractères préparent le texte en entrée avant son traitement par le générateur de jetons. Pour des concepts et des exemples, consultez [Analyseurs dans Recherche cognitive Azure](search-analyzers.md).
...
La Recherche cognitive prend en charge les filtres de caractères dans la liste suivante. Vous trouverez plus d'informations sur chacune d'elles dans la référence de l'API Lucene.
...
La Recherche cognitive prend en charge les générateurs de jetons dans la liste suivante. Vous trouverez plus d'informations sur chacune d'elles dans la référence de l'API Lucene.
