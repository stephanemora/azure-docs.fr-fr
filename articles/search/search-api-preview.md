...
ms.locfileid: "85830126"
---
# <a name="preview-features-in-azure-cognitive-search"></a>Fonctionnalités d’évaluation dans Recherche cognitive Azure

Cet article est une liste complète de toutes les fonctionnalités d’évaluation, afin que vous puissiez déterminer si vous devez les utiliser dans le code de production. Les fonctionnalités d’évaluation sont fournies sans contrat de niveau de service et ne sont pas recommandées pour les charges de travail de production. Pour plus d’informations, consultez [Conditions d’Utilisation Supplémentaires relatives aux Évaluations Microsoft Azure](https://azure.microsoft.com/support/legal/preview-supplemental-terms/).
...
+ Pour les opérations de recherche, [ **`2020-06-30-Preview`** ](https://docs.microsoft.com/rest/api/searchservice/index-preview) correspond à la préversion actuelle.
...
> [Informations de référence sur l’API REST du service de recherche (préversion)](https://docs.microsoft.com/rest/api/searchservice/index-preview)