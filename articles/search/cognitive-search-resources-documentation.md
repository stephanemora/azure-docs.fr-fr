...
+ [API REST en préversion](search-api-2017-11-11-preview.md)
  + [Créer un ensemble de compétences (api-version=2017-11-11-Preview)](ref-create-skillset.md)
  + [Créer un indexeur (api-version=2017-11-11-Preview)](ref-create-indexer.md)
