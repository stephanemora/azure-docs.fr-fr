...
> [!NOTE]
> Cette fonctionnalité est disponible dans toutes les régions Azure où Azure Database pour PostgreSQL prend en charge les niveaux tarifaires « Usage général » et « Mémoire optimisée ».
