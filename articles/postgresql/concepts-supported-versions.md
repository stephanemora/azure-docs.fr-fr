...
Consultez la [documentation PostgreSQL](https://www.postgresql.org/docs/10/static/release-10-3.html) pour en savoir plus sur les améliorations et les correctifs dans PostgreSQL 10.3.

## <a name="postgresql-version-967"></a>PostgreSQL version 9.6.7
Consultez la [documentation PostgreSQL](https://www.postgresql.org/docs/9.6/static/release-9-6-7.html) pour en savoir plus sur les améliorations et les correctifs dans PostgreSQL 9.6.7.

## <a name="postgresql-version-9511"></a>PostgreSQL version 9.5.11
Consultez la [documentation PostgreSQL](https://www.postgresql.org/docs/9.5/static/release-9-5-11.html) pour en savoir plus sur les améliorations et les correctifs dans PostgreSQL 9.5.11.
