...
2. Sélectionnez **Usage général** ou **Mémoire optimisée**, selon le niveau souhaité.
   ...
   ![Capture d’écran du portail Azure pour choisir un niveau De base, Usage général ou À mémoire optimisée dans Azure Database pour PostgreSQL](./media/howto-create-manage-server-portal/change-pricing-tier.png)
...
2. Modifiez le paramètre **vCore** en déplaçant le curseur vers la valeur souhaitée.
   ...
   ![Capture d’écran du portail Azure pour choisir l’option vCore dans Azure Database pour PostgreSQL](./media/howto-create-manage-server-portal/scaling-compute.png)
...
2. Modifiez le paramètre **Stockage** en déplaçant le curseur vers la valeur souhaitée.
   ...
   ![Capture d’écran du portail Azure pour choisir le scale-in de stockage dans Azure Database pour PostgreSQL](./media/howto-create-manage-server-portal/scaling-storage.png)
...
1. Dans le Portail Azure, sélectionnez votre serveur. Dans la fenêtre **Vue d’ensemble**, sélectionnez **Réinitialiser le mot de passe**.
   ...
   ![Capture d’écran du portail Azure pour réinitialiser le mot de passe dans Azure Database pour PostgreSQL](./media/howto-create-manage-server-portal/overview-reset-password.png)
...
2. Entrez un nouveau mot de passe et confirmez-le. La zone de texte vous indique les exigences en matière de complexité du mot de passe.
   ...
   ![Capture d’écran du portail Azure pour réinitialiser votre mot de passe et l’enregistrer dans Azure Database pour PostgreSQL](./media/howto-create-manage-server-portal/reset-password.png)
...
1. Dans le Portail Azure, sélectionnez votre serveur. Dans la fenêtre **Vue d’ensemble**, sélectionnez **Supprimer**.
   ...
   ![Capture d’écran du portail Azure pour supprimer le serveur dans Azure Database pour PostgreSQL](./media/howto-create-manage-server-portal/overview-delete.png)

2. Entrez le nom du serveur dans la zone d’entrée pour confirmer qu’il s’agit du serveur à supprimer.

   ![Capture d’écran du portail Azure pour confirmer la suppression du serveur dans Azure Database pour PostgreSQL](./media/howto-create-manage-server-portal/confirm-delete.png)
