---
title: Journalisation d’audit avec pgAudit dans Azure Database pour PostgreSQL - Serveur unique
...
> [!NOTE]
> pgAudit peut uniquement être activé sur les serveurs à usage général et les serveurs à mémoire optimisée.
