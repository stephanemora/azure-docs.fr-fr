...
---
# <a name="azure-database-for-postgresql-use-php-to-connect-and-query-data"></a>Azure Database pour PostgreSQL : Utiliser PHP pour se connecter et interroger des données
