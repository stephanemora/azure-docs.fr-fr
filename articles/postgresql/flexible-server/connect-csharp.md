---
title: 'Démarrage rapide : Se connecter avec C# – Azure Database pour PostgreSQL – Serveur flexible'
description: Ce démarrage rapide fournit un exemple de code C# (.NET) que vous pouvez utiliser pour vous connecter et interroger des données à partir d’ Azure Database pour PostgreSQL - Serveur flexible.
author: mksuni
ms.author: sumuth
