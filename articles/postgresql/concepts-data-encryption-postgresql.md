...
* Assurez-vous que Key Vault et Azure Database pour PostgreSQL Serveur unique résident dans la même région pour garantir un accès plus rapide aux opérations wrap et unwrap des clés de chiffrement de données.
