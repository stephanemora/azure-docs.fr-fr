...
ms.locfileid: "42144232"
---
# <a name="access-control-in-azure-data-lake-storage-gen1"></a>Contrôle d’accès dans Azure Data Lake Storage Gen1

Azure Data Lake Storage Gen1 met en œuvre un modèle de contrôle d’accès dérivé de HDFS, lui-même issu du modèle de contrôle d’accès POSIX. Cet article présente les notions de base du modèle de contrôle d’accès pour Data Lake Storage Gen1. Pour en savoir plus sur le modèle de contrôle d’accès HDFS, consultez [HDFS Permissions Guide (Guide des autorisations HDFS)](https://hadoop.apache.org/docs/current/hadoop-project-dist/hadoop-hdfs/HdfsPermissionsGuide.html).
...
![ACL de Data Lake Storage Gen1](./media/data-lake-store-access-control/data-lake-store-acls-1.png)

Les ACL d’accès et les ACL par défaut ont la même structure.

![ACL de Data Lake Storage Gen1](./media/data-lake-store-access-control/data-lake-store-acls-2.png)
...
![ACL de Data Lake Storage Gen1](./media/data-lake-store-access-control/data-lake-store-acls-3.png)
...
![ACL de Data Lake Storage Gen1](./media/data-lake-store-access-control/data-lake-store-acls-4.png)
...
![ACL de Data Lake Storage Gen1](./media/data-lake-store-access-control/data-lake-store-acls-5.png)
...
![ACL de Data Lake Storage Gen1](./media/data-lake-store-access-control/data-lake-store-acls-6.png)
...
Dans le panneau **Explorateur de données** du compte Data Lake Storage Gen1, cliquez sur **Accès** pour afficher les ACL du fichier ou du dossier qui apparaît dans l’Explorateur de données. Cliquez sur **Accès** pour afficher les ACL du dossier **catalog** dans le compte **mydatastore**.

![ACL de Data Lake Storage Gen1](./media/data-lake-store-access-control/data-lake-store-show-acls-1.png)
...
![ACL de Data Lake Storage Gen1](./media/data-lake-store-access-control/data-lake-store-show-acls-simple-view.png)
...
![ACL de Data Lake Storage Gen1](./media/data-lake-store-access-control/data-lake-store-show-acls-advance-view.png)
...
Dans Azure, un compte Data Lake Storage Gen1 possède plusieurs rôles Azure, notamment :

* Propriétaires
* Contributeurs
* Lecteurs

Toutes les personnes ayant le rôle **Propriétaires** pour un compte Data Lake Storage Gen1 sont automatiquement considérées comme des super utilisateurs pour ce compte. Pour en savoir plus, consultez [Contrôle d’accès en fonction du rôle](../role-based-access-control/role-assignments-portal.md).
...
Lorsqu’un nouvel élément de système de fichiers est créé, Data Lake Storage Gen1 affecte une valeur au groupe propriétaire.
...
L’illustration suivante représente l’algorithme de vérification des accès pour les comptes Data Lake Storage Gen1.

![Algorithme des ACL de Data Lake Storage Gen1](./media/data-lake-store-access-control/data-lake-store-acls-algorithm.png)
...
![ACL de Data Lake Storage Gen1](./media/data-lake-store-access-control/data-lake-store-acls-mask-1.png)
...
![ACL de Data Lake Storage Gen1](./media/data-lake-store-access-control/data-lake-store-acls-mask-2.png)

À titre de référence, voici où se trouve le masque d’un fichier ou d’un dossier dans le portail Azure.

![ACL de Data Lake Storage Gen1](./media/data-lake-store-access-control/data-lake-store-show-acls-mask-view.png)
...
![ACL de Data Lake Storage Gen1](./media/data-lake-store-access-control/data-lake-store-acls-child-items-1.png)
...
![ACL de Data Lake Storage Gen1](./media/data-lake-store-access-control/data-lake-store-acls-child-items-2.png)

## <a name="advanced-topics-for-understanding-acls-in-data-lake-storage-gen1"></a>Rubriques avancées permettant de comprendre les ACL dans Data Lake Storage Gen1

Voici quelques rubriques avancées pour vous aider à comprendre comment les ACL sont déterminées pour les fichiers ou dossiers Date Lake Storage Gen1.
...
Dans un système HDFS, l’umask est généralement une option de configuration à l’échelle du site, contrôlée par les administrateurs. Data Lake Storage Gen1 utilise un **umask à l’échelle du compte** qui ne peut pas être modifié. Le tableau suivant présente l’umask de Data Lake Storage Gen1.
...
![ACL de Data Lake Storage Gen1](./media/data-lake-store-access-control/data-lake-store-acls-umask.png)

### <a name="the-sticky-bit"></a>Le sticky bit

Le sticky bit est une fonctionnalité avancée d’un système de fichiers POSIX. Dans le contexte de Data Lake Storage Gen1, il est peu probable que le sticky bit soit nécessaire.

Le tableau suivant montre comment le sticky bit fonctionne dans Data Lake Storage Gen1.
...
Voici quelques questions fréquentes concernant les ACL dans Data Lake Storage Gen1.
...
| masque | umask|
|------|------|
| La propriété **mask** est disponible sur tous les fichiers et dossiers. | Le **umask** est une propriété du compte Data Lake Storage Gen1. Il n’existe donc qu’un seul umask dans Data Lake Storage Gen1.    |
