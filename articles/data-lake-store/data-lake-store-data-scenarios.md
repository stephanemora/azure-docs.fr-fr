...
| --- | --- |
| Ordinateur local |<ul> <li>[Portail Azure](data-lake-store-get-started-portal.md)</li> <li>[Azure PowerShell](data-lake-store-get-started-powershell.md)</li> <li>[Azure CLI](data-lake-store-get-started-cli-2.0.md)</li> <li>[À l’aide de Data Lake Tools pour Visual Studio](../data-lake-analytics/data-lake-analytics-data-lake-tools-get-started.md) </li></ul> |
| Azure Storage Blob |<ul> <li>[Azure Data Factory](../data-factory/connector-azure-data-lake-store.md)</li> <li>[Outil AdlCopy](data-lake-store-copy-data-azure-storage-blob.md)</li><li>[DistCp en cours d’exécution sur un cluster de HDInsight](data-lake-store-copy-data-wasb-distcp.md)</li> </ul> |
...
| Exportez les données depuis Hadoop sous forme de fichiers. Copiez ensuite les fichiers dans Azure Data Lake Storage Gen1 à l’aide du mécanisme approprié. |Vous pouvez copier des fichiers dans Azure Data Lake Storage Gen1 en utilisant : <ul><li>[Azure PowerShell pour Windows du système d’exploitation](data-lake-store-get-started-powershell.md)</li><li>[Azure CLI](data-lake-store-get-started-cli-2.0.md)</li><li>Application personnalisée utilisant n’importe quel SDK Data Lake Storage Gen1</li></ul> |Pour commencer. Permet des téléchargements personnalisés |Processus en plusieurs étapes qui implique différentes technologies. La gestion et la surveillance deviendront de plus en plus exigeantes au fil du temps, étant donné le caractère personnalisé des outils |
| Utilisez Distcp pour copier les données de Hadoop dans Azure Storage. Copiez ensuite les fichiers de Stockage Azure vers Data Lake Storage Gen1 à l’aide du mécanisme approprié. |Vous pouvez copier les données de Stockage Azure vers Data Lake Storage Gen1 en utilisant : <ul><li>[Azure Data Factory](../data-factory/copy-activity-overview.md)</li><li>[Outil AdlCopy](data-lake-store-copy-data-azure-storage-blob.md)</li><li>[Apache DistCp en cours d’exécution sur des clusters HDInsight](data-lake-store-copy-data-wasb-distcp.md)</li></ul> |Vous pouvez utiliser des outils open source. |Processus en plusieurs étapes qui implique différentes technologies |
...
![Analyser des données dans Data Lake Storage Gen1](./media/data-lake-store-data-scenarios/analyze-data.png "Analyser des données dans Data Lake Storage Gen1")

Vous pouvez consulter les exemples suivants.

* [Créer un cluster HDInsight avec Data Lake Storage Gen1 en tant que stockage](data-lake-store-hdinsight-hadoop-use-portal.md)
...
* Déplacer des données vers d’autres référentiels pour créer une interface avec vos pipelines de traitement des données existantes. Par exemple, vous pourriez vouloir déplacer des données de Data Lake Storage Gen1 vers Azure SQL Database ou vers SQL Server local.
...
![Sortir des données à partir de Data Lake Storage Gen1](./media/data-lake-store-data-scenarios/egress-data.png "Sortir des données à partir de Data Lake Storage Gen1")
