...
:::image type="content" source="media/data-flow/create-derive-column.png" alt-text="Paramètres de la colonne dérivée":::
...
:::image type="content" source="media/data-flow/add-derived-column.png" alt-text="Nouvelle sélection de colonne dérivée":::
...
:::image type="content" source="media/data-flow/column-pattern-derive.png" alt-text="Modèles de colonne":::
...
:::image type="content" source="media/data-flow/derive-add-column.png" alt-text="Créer une colonne":::
...
:::image type="content" source="media/data-flow/create-local.png" alt-text="Créer une locale":::
...
:::image type="content" source="media/data-flow/create-local-2.png" alt-text="Créer une locale 2":::
...
:::image type="content" source="media/data-flow/using-locals.png" alt-text="Utilisation de locales":::
...
:::image type="content" source="media/data-flow/derive-script.png" alt-text="Exemple de dérivation":::
