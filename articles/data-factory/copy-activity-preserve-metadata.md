...
## <a name="preserve-metadata"></a> Conserver les métadonnées pour la migration entre lacs
...
>[!NOTE]
>Lorsque vous utilisez ADF pour conserver les ACL entre Data Lake Storage Gen1 et Gen2, les ACL existantes des dossiers/fichiers correspondants de Gen2 sont écrasées.
...
Si vous configurez la source en tant que Data Lake Storage Gen1 au format binaire ou avec l'option de copie binaire, et le récepteur en tant que Data Lake Storage Gen2 au format binaire ou avec l'option de copie binaire, vous trouverez l'option **Conserver** sur la page **Paramètres** de l'outil Copier des données ou sous **Copier l'activité** > **onglet Paramètres** pour la création de l'activité.
