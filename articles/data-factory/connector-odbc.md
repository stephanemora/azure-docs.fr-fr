---
title: Copier des données depuis/vers des banques de données ODBC
titleSuffix: Azure Data Factory & Azure Synapse
description: Découvrez comment utiliser l’activité de copie dans un pipeline Azure Data Factory ou Synapse Analytics pour copier des données vers et à partir de magasins de données ODBC.
author: jianleishen
...
ms.locfileid: "124787828"
---
# <a name="copy-data-from-and-to-odbc-data-stores-using-azure-data-factory-or-synapse-analytics"></a>Copier des données depuis/vers des banques de données ODBC à l’aide d’Azure Data Factory ou de Synapse Analytics
...
## <a name="create-a-linked-service-to-an-odbc-data-store-using-ui"></a>Créer un service lié à un magasin de données ODBC à l’aide de l’interface utilisateur
...
2. Recherchez ODBC et sélectionnez le connecteur ODBC.
    ...
    :::image type="content" source="media/connector-odbc/odbc-connector.png" alt-text="Capture d’écran du connecteur ODBC.":::    

1. Configurez les informations du service, testez la connexion et créez le nouveau service lié.

    :::image type="content" source="media/connector-odbc/configure-odbc-linked-service.png" alt-text="Capture d’écran de la configuration du service lié pour un magasin de données ODBC.":::
