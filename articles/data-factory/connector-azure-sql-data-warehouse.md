...
Si votre source de données est au format texte et il contient une valeur vide pour être chargé dans une colonne décimale de l’entrepôt de données SQL, vous pouvez atteindre l’erreur suivante :
