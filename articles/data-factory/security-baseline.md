...
* [Procédure de création d’un Azure-SSIS Integration Runtime](https://docs.microsoft.com/azure/data-factory/create-azure-ssis-integration-runtime)

* [Procédure de création et de configuration d’un IR auto-hébergé](https://docs.microsoft.com/azure/data-factory/create-self-hosted-integration-runtime)
...
* [Joindre un Azure-SSIS Integration Runtime à un réseau virtuel](https://docs.microsoft.com/azure/data-factory/join-azure-ssis-integration-runtime-virtual-network#virtual-network-configuration)
...
* [Joindre un Azure-SSIS Integration Runtime à un réseau virtuel](https://docs.microsoft.com/azure/data-factory/join-azure-ssis-integration-runtime-virtual-network)
...
* [Comprendre les balises de service spécifiques à Azure Data Factory](https://docs.microsoft.com/azure/data-factory/join-azure-ssis-integration-runtime-virtual-network)
...
* [Comprendre les journaux de diagnostic Azure Data Factory](https://docs.microsoft.com/azure/data-factory/monitor-using-azure-monitor)
...
* [Procédure de collecte de données à partir de machines virtuelles Azure avec Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/learn/quick-collect-azurevm)
...
* [Procédure d’activation des journaux de diagnostic dans Azure Data Factory](https://docs.microsoft.com/azure/data-factory/monitor-using-azure-monitor#set-up-diagnostic-logs)
...
* [Schéma Log Analytics](https://docs.microsoft.com/azure/data-factory/monitor-using-azure-monitor#schema-of-logs-and-events)

* [Procédure de collecte de données à partir d’une machine virtuelle Azure avec Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/learn/quick-collect-azurevm)
...
* [Alertes dans Azure Data Factory](https://docs.microsoft.com/azure/data-factory/monitor-visually#alerts)

* [Page de toutes les mesures prises en charge](https://docs.microsoft.com/azure/azure-monitor/platform/metrics-supported)
...
* [Informations sur l’API REST pour Azure Data Factory](https://docs.microsoft.com/rest/api/datafactory/)
...
* [Que sont les identités managées pour les ressources Azure ?](https://docs.microsoft.com/azure/active-directory/managed-identities-azure-resources/overview)

* [Copier et transformer des données dans Azure SQL Database à l’aide d’Azure Data Factory](https://docs.microsoft.com/azure/data-factory/connector-azure-sql-database#using-service-principal-authentication)

* [Procédure de configuration et de gestion de l’authentification Azure Active Directory avec Azure SQL Database](https://docs.microsoft.com/azure/sql-database/sql-database-aad-authentication-configure)
...
* [Configurer et gérer l’authentification Azure Active Directory avec SQL](https://docs.microsoft.com/azure/sql-database/sql-database-aad-authentication-configure?tabs=azure-powershell)

* [Activer l'authentification Azure Active Directory pour Azure-SSIS Integration Runtime](https://docs.microsoft.com/azure/data-factory/enable-aad-authentication-azure-ssis-ir)
...
* [Utilisation de la découverte et de la classification pour Azure SQL Server](https://docs.microsoft.com/azure/sql-database/sql-database-data-discovery-and-classification)
...
* [Présentation de Private Link](https://docs.microsoft.com/azure/private-link/private-endpoint-overview)
...
Toutes les connexions à Azure SQL Database et à Azure Synapse Analytics (anciennement SQL Data Warehouse) doivent être chiffrées (par SSL/TLS) lorsque les données sont en transit depuis et vers la base de données. Lorsque vous créez un pipeline à l’aide de JSON, ajoutez la propriété de chiffrement et définissez sa valeur sur True dans la chaîne de connexion. Pour le stockage Azure, vous pouvez utiliser HTTPS dans la chaîne de connexion.

* [Comprendre le chiffrement en transit avec Azure Data Factory](https://docs.microsoft.com/azure/data-factory/data-movement-security-considerations)
...
* [Comprendre le chiffrement au repos dans Azure Data Factory](https://docs.microsoft.com/azure/data-factory/data-movement-security-considerations)

* [Chiffrement côté serveur de disques managés Azure](https://docs.microsoft.com/azure/virtual-machines/windows/disk-encryption)

* [Azure Disk Encryption pour les machines virtuelles Windows](https://docs.microsoft.com/azure/virtual-machines/windows/disk-encryption-overview)

* [Utilisation des secrets Azure Key Vault dans les activités de pipeline](https://docs.microsoft.com/azure/data-factory/how-to-use-azure-key-vault-secrets-pipeline-activities)

* [Procédure de stockage des informations d’identification dans Azure Key Vault](https://docs.microsoft.com/azure/data-factory/store-credentials-in-key-vault)
...
* [Comprendre l’analyseur de vulnérabilité intégré pour machines virtuelles](https://docs.microsoft.com/azure/security-center/built-in-vulnerability-assessment)
...
* [Analyseur de vulnérabilité intégré pour machines virtuelles](https://docs.microsoft.com/azure/security-center/built-in-vulnerability-assessment)
...
* [Qu’est-ce qu’un pare-feu Azure ?](https://docs.microsoft.com/azure/firewall/overview)

* [Qu’est-ce que le pare-feu d’applications web Azure ?](https://docs.microsoft.com/azure/web-application-firewall/overview)

* [Groupes de sécurité réseau](https://docs.microsoft.com/azure/virtual-network/security-overview)

* [Qu’est-ce que le réseau virtuel Azure ?](https://docs.microsoft.com/azure/virtual-network/virtual-networks-overview)
...
* [Procédure de correction des recommandations d’Azure Security Center](https://docs.microsoft.com/azure/security-center/security-center-remediate-recommendations)
...
* [Procédure de chargement d’un disque dur virtuel de machine virtuelle personnalisé dans Azure](https://docs.microsoft.com/azure-stack/operator/azure-stack-add-vm-image?view=azs-1910)
...
* [Suppression réversible dans Azure Key Vault](https://docs.microsoft.com/azure/key-vault/key-vault-ovw-soft-delete)
...
* [Identité managée pour Azure Data Factory](https://docs.microsoft.com/azure/data-factory/data-factory-service-identity)
...
* [Sauvegarder une machine virtuelle Azure à partir des paramètres de la machine virtuelle](https://docs.microsoft.com/azure/backup/backup-azure-vms-first-look-arm)
...
* [Suppression réversible pour les machines virtuelles](https://docs.microsoft.com/azure/backup/backup-azure-security-feature-cloud#soft-delete)
