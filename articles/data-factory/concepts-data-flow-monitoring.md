...
![Supervision des flux de données](media/data-flow/mon001.png "Supervision des flux de données")
...
![Supervision des flux de données](media/data-flow/mon002.png "Supervision des flux de données")
...
![Supervision des flux de données](media/data-flow/mon003.png "Supervision des flux de données")
...
![Supervision des flux de données](media/data-flow/mon004.png "Supervision des flux de données")
