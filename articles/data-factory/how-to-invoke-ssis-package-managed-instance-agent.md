...
Avec cette fonctionnalité, vous pouvez exécuter des packages SSIS stockés dans SSISDB dans une instance managée SQL ou un système de fichiers comme Azure Files.
