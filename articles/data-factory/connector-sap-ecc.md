...
>[!TIP]
>Pour copier des données à partir de SAP ECC par le biais de SAP table/vue, vous pouvez utiliser [Table SAP](connector-sap-table.md) connecteur qui est plus performante et évolutive.
