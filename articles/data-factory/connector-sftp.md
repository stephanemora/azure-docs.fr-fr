...
## <a name="create-an-sftp-linked-service-using-ui"></a>Créer un service lié SFTP à l’aide de l’interface utilisateur
...
2. Recherchez SFTP et sélectionnez le connecteur SFTP.
    ...
    :::image type="content" source="media/connector-sftp/sftp-connector.png" alt-text="Capture d’écran du connecteur SFTP.":::    

1. Configurez les informations du service, testez la connexion et créez le nouveau service lié.

    :::image type="content" source="media/connector-sftp/configure-sftp-linked-service.png" alt-text="Capture d’écran de la configuration d’un service lié SFTP.":::
