...
Pour obtenir une procédure pas à pas de création d’une fabrique de données avec un pipeline, consultez [Démarrage rapide : Créez une fabrique de données](quickstart-create-data-factory-powershell.md). 
