...
:::image type="content" source="media/data-flow/create-params.png" alt-text="Créer des paramètres de flux de données":::
...
:::image type="content" source="media/data-flow/parameter-expression.png" alt-text="Capture d’écran montrant les paramètres disponibles sous l’onglet Paramètres.":::
...
:::image type="content" source="media/data-flow/new-parameter-expression.png" alt-text="Capture d’écran montrant les paramètres sous l’onglet Paramètres avec les nouveaux paramètres ajoutés.":::
...
:::image type="content" source="media/data-flow/parameter-assign.png" alt-text="Capture d’écran montrant l’onglet Paramètres avec l’expression de flux de données sélectionnée pour la valeur de myparam.":::
...
:::image type="content" source="media/data-flow/parameter-pipeline.png" alt-text="Capture d’écran montrant le volet du générateur d’expressions.":::
...
:::image type="content" source="media/data-flow/string-parameter.png" alt-text="Capture d’écran montrant le volet Paramètres du flux de données avec l’option Expression sélectionnée pour un paramètre.":::
...
:::image type="content" source="media/data-flow/parameter-timestamp.png" alt-text="Capture d’écran montrant l’onglet Paramètres dans lequel vous pouvez entrer une heure de déclenchement.":::
...
:::image type="content" source="media/data-flow/parameter-pipeline-2.png" alt-text="Capture d’écran montrant l’onglet Paramètres avec les paramètres nommés stringParam et intParam.":::

`@pipeline.parameters.pipelineParam` se voit affecter la valeur `abs(1)` au moment de l’exécution.

:::image type="content" source="media/data-flow/parameter-pipeline-4.png" alt-text="Capture d’écran montrant l’onglet Paramètres avec la valeur abs(1) sélectionnée.":::

Quand `$intParam` est référencé dans une expression telle qu’une colonne dérivée, il évalue que `abs(1)` retourne `1`. 

:::image type="content" source="media/data-flow/parameter-pipeline-3.png" alt-text="Capture d’écran montrant la valeur des colonnes.":::
...
:::image type="content" source="media/data-flow/parameterize-column-name.png" alt-text="Transmission d’un nom de colonne en tant que paramètre":::
