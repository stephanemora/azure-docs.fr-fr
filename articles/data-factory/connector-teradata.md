...
## <a name="create-a-linked-service-to-teradata-using-ui"></a>Créer un service lié à Teradata à l’aide de l’interface utilisateur
...
2. Recherchez Teradata et sélectionnez le connecteur Teradata.
    ...
    :::image type="content" source="media/connector-teradata/teradata-connector.png" alt-text="Sélectionnez le connecteur Teradata.":::    

1. Configurez les informations du service, testez la connexion et créez le nouveau service lié.

    :::image type="content" source="media/connector-teradata/configure-teradata-linked-service.png" alt-text="Configurez un service lié à Teradata.":::
