...
## Fonctions d’agrégation Les fonctions suivantes sont uniquement disponibles dans les transformations d’agrégation, de tableau croisé dynamique, de suppression de tableau croisé dynamique et de fenêtre.
___
### <code>avg</code>
...
## Fonctions de fenêtre Les fonctions suivantes sont disponibles uniquement dans des transformations de fenêtre.
___
### <code>cumeDist</code>
