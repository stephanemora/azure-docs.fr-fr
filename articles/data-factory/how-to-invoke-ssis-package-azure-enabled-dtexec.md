...
Vous pouvez appeler **AzureDTExec** depuis l’invite de ligne de commande et fournir les valeurs appropriées pour les options concernant votre scénario de cas d’usage, par exemple :
