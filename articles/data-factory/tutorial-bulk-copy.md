---
title: Copier les données en vrac
...
2. Créez les schémas de table correspondants dans SQL Data Warehouse. Plus tard, vous utiliserez Azure Data Factory pour migrer/copier les données.
