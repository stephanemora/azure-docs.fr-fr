...
> [!IMPORTANT]
> Pour le moment, le paramètre sliceIdentifierColumnName n’est pas pris en charge par Azure Synapse Analytics (anciennement SQL Data Warehouse). 
...
1. Utilisez-la dans l’activité de copie comme suit :
