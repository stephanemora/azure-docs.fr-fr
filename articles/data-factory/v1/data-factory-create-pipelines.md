...
| --- | --- | --- |
| name |Nom du pipeline. Spécifiez un nom qui représente l’action effectuée par le pipeline. <br/><ul><li>Nombre maximal de caractères : 260</li><li>Doit commencer par une lettre, un chiffre ou un trait de soulignement (\_)</li><li>Caractères suivants ne sont pas autorisés : «. », « + «, » ? », « / », « < », « > », «\*», « % », « & », « : «, »\\»</li></ul> |Oui |
