---
title: Générer votre première fabrique de données Data Factory (REST)
...
:::image type="content" source="./media/data-factory-build-your-first-pipeline-using-rest-api/three-ouptut-files.png" alt-text="données de sortie":::
