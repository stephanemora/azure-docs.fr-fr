...
| WindowEnd |Fin de l’intervalle de temps de l’intervalle d’exécution d’activité en cours |activity |identique à WindowStart. |
...
| Category | Fonction | Paramètres | Description |
| --- | --- | --- | --- |
