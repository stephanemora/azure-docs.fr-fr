...
Vous pouvez également configurer votre Azure-SSIS IR, qu’il soit nouveau ou existant, avec le runtime d’intégration auto-hébergé en tant que proxy à l’aide de PowerShell.
