---
title: Migration SSIS avec une instance managée Azure SQL Database en tant que destination des charges de travail de base de données | Microsoft Docs
