---
title: Copier des données à partir de Couchbase (préversion)
description: Découvrez comment utiliser l’activité de copie dans un pipeline Azure Data Factory ou Synapse Analytics pour copier des données de Couchbase vers des banques de données réceptrices prises en charge.
...
Cet article explique comment utiliser l’activité de copie dans le pipeline Azure Data Factory ou Synapse Analytics pour copier des données de Couchbase. Il s’appuie sur l’article [Vue d’ensemble de l’activité de copie](copy-activity-overview.md).
...
## <a name="create-a-linked-service-to-couchbase-using-ui"></a>Créer un service lié à Couchbase à l’aide de l’interface utilisateur

Utilisez les étapes suivantes pour créer un service lié à Couchbase dans l’interface utilisateur du portail Azure.
...
2. Recherchez Couchbase et sélectionnez le connecteur Couchbase.

   :::image type="content" source="media/connector-couchbase/couchbase-connector.png" alt-text="Capture d’écran du connecteur Couchbase.":::    


1. Configurez les informations du service, testez la connexion et créez le nouveau service lié.

   :::image type="content" source="media/connector-couchbase/configure-couchbase-linked-service.png" alt-text="Capture d’écran de la configuration du service lié pour Couchbase.":::
