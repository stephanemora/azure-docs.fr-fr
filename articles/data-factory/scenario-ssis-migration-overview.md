...
|-|-|-|
|SSISDB|[Migrez **SSISDB**](scenario-ssis-migration-ssisdb-mi.md).|[Migrer les travaux SSIS vers l'agent Azure SQL Managed Instance](scenario-ssis-migration-ssisdb-mi.md#ssis-jobs-to-sql-managed-instance-agent)|
