...
description: Combiner les données de deux sources de données à l’aide de la transformation de jointure dans un flux de données de mappage dans Azure Data Factory ou Synapse Analytics
author: kromerm
ms.author: makromer
...
:::image type="content" source="media/data-flow/join.png" alt-text="Transformation de jointure (Join)":::
...
:::image type="content" source="media/data-flow/non-equi-join.png" alt-text="Jointure différente":::
...
:::image type="content" source="media/data-flow/selfjoin.png" alt-text="Jointure réflexive":::
...
:::image type="content" source="media/data-flow/join-script1.png" alt-text="Capture d’écran montrant la transformation avec la sélection de l’onglet Paramètres de jointure, et un type de jointure Interne.":::
...
:::image type="content" source="media/data-flow/join-script2.png" alt-text="Capture d’écran montrant la transformation avec la sélection de l’onglet Paramètres de jointure, et un type de jointure personnalisé (croisé).":::
