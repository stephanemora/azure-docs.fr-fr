---
title: Format JSON dans Azure Data Factory | Microsoft Docs
...
| compressionCodec | Le codec de compression utilisé pour lire/écrire des fichiers texte. <br>Les valeurs autorisées sont **bzip2**, **gzip**, **deflate**, **ZipDeflate**, **snappy**, ou **lz4**. À utiliser lors de l’enregistrement du fichier. <br>Notez que l’activité de copie ne prend actuellement pas en charge « snappy » et « lz4 ». | Non       |
