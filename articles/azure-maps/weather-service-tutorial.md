...
description: Ce tutoriel vous montre comment joindre des données de capteur à des prévisions météorologiques à partir du Service Météo Microsoft Azure Maps, avec Azure Notebooks (Python).
author: walsehgal
ms.author: v-musehg
ms.date: 12/09/2019
ms.topic: tutorial
