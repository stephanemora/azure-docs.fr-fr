...
1. Si le ou les résultats souhaités ont un ou plusieurs ID géométriques, transmettez-les dans l’[API de polygone de recherche](/rest/api/maps/search/getsearchpolygon).
