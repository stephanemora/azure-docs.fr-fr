---
title: Demander des données sur les transports publics avec le service Mobility (préversion) Microsoft Azure Maps
...
> [!div class="nextstepaction"]
> [Documentation sur le service Mobility](/rest/api/maps/mobility)