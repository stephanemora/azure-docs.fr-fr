...
L’API Azure Maps est disponible partout, à l’exception des pays suivants :
...
Vérifiez que votre adresse IP actuelle ne correspond pas à l’un des pays non pris en charge cités plus haut.
