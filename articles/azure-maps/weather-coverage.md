---
title: Couverture météo dans Azure Maps | Microsoft Docs
description: Découvrez la couverture météo dans Azure Maps
author: walsehgal
ms.author: v-musehg
ms.date: 11/20/2019
ms.topic: conceptual
...
|--------|---------|
|*       |Couvre la météo le long de l’itinéraire, les conditions actuelles, les prévisions horaires, les prévisions au quart de journée et les API de prévisions quotidiennes |


## <a name="americas"></a>Amérique

| Pays/région              |  Vignette Satellite | Prévision à la minute, vignettes radar | Autre* | 
|-----------------------------|:----------------:|:-----------------:|:--------:|  
| Anguilla                                 | ✓ |   |  ✓| 
| Antarctique                               | ✓ |   |  ✓|
| Antigua-et-Barbuda                      | ✓ |   |  ✓| 
