...
ms.locfileid: "58260136"
---
# <a name="add-map-controls-to-azure-maps"></a>Ajouter des contrôles de carte à Azure Maps

Cet article décrit comment ajouter des contrôles de carte à une carte. Vous apprenez aussi à créer une carte avec tous les contrôles et un [sélecteur de styles](https://docs.microsoft.com/azure/azure-maps/choose-map-style).
...
Le troisième bloc de code crée un objet contrôle de zoom à l’aide de l’atlas [ZoomControl](/javascript/api/azure-maps-control/atlas.control.zoomcontrol) et l’ajoute à la carte à l’aide de la méthode [controls.add](https://docs.microsoft.com/javascript/api/azure-maps-control/atlas.map?view=azure-iot-typescript-latest) de la carte.

Le quatrième bloc de code crée un objet contrôle de tonalité à l’aide de l’atlas [PitchControl](/javascript/api/azure-maps-control/atlas.control.pitchcontrol) et l’ajoute à la carte à l’aide de la méthode [controls.add](https://docs.microsoft.com/javascript/api/azure-maps-control/atlas.map?view=azure-iot-typescript-latest) de la carte.

Le dernier bloc de code crée un objet sélecteur de style à l’aide de l’atlas [StyleControl](/javascript/api/azure-maps-control/atlas.control.stylecontrol) et l’ajoute à la carte à l’aide de la méthode [controls.add](https://docs.microsoft.com/javascript/api/azure-maps-control/atlas.map?view=azure-iot-typescript-latest) de la carte. Tous les objets de contrôle sont ajoutés dans le **détecteur d’événements** de la carte pour assurer leur chargement une fois la carte complètement chargée.
