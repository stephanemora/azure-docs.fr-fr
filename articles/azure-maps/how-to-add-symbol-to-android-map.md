...
Pour suivre les étapes décrites dans cet article, vous devez installer l’[Android SDK Azure Maps](./how-to-use-android-map-control-library.md) afin de charger une carte.
