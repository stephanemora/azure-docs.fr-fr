...
description: Dans cet article, vous allez apprendre à définir des données d’options de dessin à l’aide du Kit de développement logiciel (SDK) Web Microsoft Azure Maps
author: walsehgal
ms.author: v-musehg
ms.date: 01/29/2020
ms.topic: conceptual
