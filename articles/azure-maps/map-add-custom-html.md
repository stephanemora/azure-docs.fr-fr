...
description: Comment ajouter un marqueur HTML à un kit de développement logiciel (SDK) web Azure Maps.
author: jingjing-z
ms.author: jinzh
ms.date: 07/29/2019
ms.topic: conceptual
