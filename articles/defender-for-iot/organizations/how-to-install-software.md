...
La configuration du BIOS s’effectue par le biais d’une configuration prédéfinie. Le fichier est accessible à partir du [centre d’aide](https://cyberx-labs.zendesk.com/hc/).
