---
title: Générer le micro-agent Defender à partir du code source
...
ms.locfileid: "102124531"
---
# <a name="build-the-defender-micro-agent-from-source-code"></a>Générer le micro-agent Defender à partir du code source
