...
Pour plus d’informations sur l’interrogation des données à partir de Log Analytics, consultez [Bien démarrer avec les requêtes dans Azure Monitor](../../azure-monitor/logs/get-started-queries.md).
...
- En savoir plus sur Defender pour IoT, [Qu’est-ce qu’une solution basée sur agent pour les générateurs d’appareils](architecture-agent-based.md)
