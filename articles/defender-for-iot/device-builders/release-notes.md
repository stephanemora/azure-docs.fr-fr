...
description: Découvrez les dernières versions et fonctionnalités de Defender pour les fabricants d’appareils IoT.
ms.topic: overview
ms.date: 06/06/2021
...
### <a name="work-with-automatic-threat-intelligence-updates-public-preview"></a>Utiliser les mises à jour automatiques du renseignement sur les menaces (préversion publique)
