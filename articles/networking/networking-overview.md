...
| [Zones périphériques Azure](#edge-zones)| Déployez des machines virtuelles, des conteneurs et d’autres services dans des zones périphériques pour répondre aux exigences de faible latence et de débit élevé.| <p>[Edge Zones with Carrier](edge-zones-overview.md#carrier)<p> <p>[Private Edge Zones](edge-zones-overview.md#private-edge-zones)</p>|
| [Azure Orbital](#orbital)| Communiquez avec votre engin spatial ou vos constellations de satellites, transmettez des données en liaison descendante et ascendante, traitez vos données dans le Cloud, chaînez les services avec les services Azure dans des scénarios uniques et générez des produits pour vos clients.  | <p>[Communication globale](azure-orbital-overview.md#global-communication)</p>  <p>[Stations terriennes partenaires](azure-orbital-overview.md#digital-transformation)</p>|
||||
