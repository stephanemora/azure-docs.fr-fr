...
* [Cache Azure pour Redis](#azure-redis-cache-limits)
...
#### <a name="subscription-limits---azure-service-management-classic-resources"></a>Limites d’abonnement – Gestion des services Azure (ressources classiques)
