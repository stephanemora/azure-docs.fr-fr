...
* [Tutoriel : Écrire une requête valide pour intégrer des données de métriques](tutorials/write-a-valid-query.md)
* [Didacticiel : activer la notification d’anomalies dans Metrics Advisor](tutorials/enable-anomaly-notification.md)

### <a name="updated-articles"></a>Articles mis à jour

* [Flux d’intégration des métriques mises à jour](how-tos/onboard-your-data.md)
* [Conseils enrichis lors de l’ajout de flux de données à partir de différentes sources](data-feeds-from-different-sources.md)
* [Nouveau canal de notification mis à jour à l’aide de Microsoft Teams](how-tos/alerts.md#teams-hook)
* [Expérience de diagnostic d’incident mise à jour](how-tos/diagnose-an-incident.md)
...
* [Mise à jour concernant la façon dont Metrics Advisor crée une arborescence d’incident pour les métriques multidimensionnelles](./faq.yml)
