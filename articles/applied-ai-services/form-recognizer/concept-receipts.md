...
> [Essayer le modèle de reçu](https://aka.ms/fott-2.1-ga "Commencez avec un modèle prédéfini pour extraire les données des reçus.")
...
* **Receipt v2.1 intégré** prend en charge les reçus de ventes dans les paramètres régionaux anglais **en-au**, **en-ca**, **en-gb**, **en-in** et **en-us**
...
## <a name="analyze-receipt"></a>Analyser le reçu
...
## <a name="get-analyze-receipt-result"></a>Obtenir le résultat de l’analyse du reçu
