...
> [Essayer le modèle de carte de visite](https://aka.ms/fott-2.1-ga "Commencez avec un modèle prédéfini pour extraire des données de la carte de visite.")
...
![Image détaillée de Contoso provenant de l’outil d’étiquetage + sortie JSON](./media/business-card-example.jpg)
...
## <a name="analyze-business-card"></a>Analyser la carte de visite
...
## <a name="get-analyze-business-card-result"></a>Obtenir le résultat de l’analyse de la carte de visite
