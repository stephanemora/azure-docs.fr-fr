...
Utilisez Web3 pour vous connecter au nœud de transaction par défaut et créer un compte Ethereum. Vous pouvez appeler des méthodes sur l’objet Web3 pour interagir avec votre nœud de transaction.
