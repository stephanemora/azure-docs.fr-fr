---
title: Créer des applications en temps réel avec Azure Functions et Azure SignalR
description: Vue d’ensemble de l’utilisation du service Azure SignalR dans les applications serverless.
author: sffamily
ms.service: signalr
ms.topic: overview
ms.date: 09/18/2018
...
![Cosmos DB, Azure Functions, service SignalR](media/signalr-overview-azure-functions/signalr-cosmosdb-functions.png)
...
Dans cet article, vous avez obtenu une vue d’ensemble de l’utilisation d’Azure Functions avec le service SignalR pour permettre un large éventail de scénarios de messagerie serverless en temps réel. Suivez l’un de ces guides de démarrage rapide pour en savoir plus.
