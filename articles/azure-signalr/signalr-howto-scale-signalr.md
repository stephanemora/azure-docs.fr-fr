...
L’application des paramètres de mise à l’échelle prend quelques minutes. Ils ne nécessitent pas de changer votre code ou de redéployer votre application serveur.
...
3. Choisissez votre niveau tarifaire, puis cliquez sur **Sélectionner**. Vous devez définir le nombre d’unités pour le niveau **Standard**.
...
Pour voir un tableau des limites, quotas et contraintes du service dans chaque niveau, consultez [Limites de SignalR Service](../azure-subscription-service-limits.md#azure-signalr-service-limits).
