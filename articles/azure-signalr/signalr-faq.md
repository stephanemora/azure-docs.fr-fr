...
description: FAQ sur Azure SignalR Service.
author: sffamily
ms.service: signalr
ms.topic: overview
ms.date: 12/23/2018
...
Oui.
Pour notre annonce sur la disponibilité générale, consultez [Disponibilité générale d’Azure SignalR Service](https://azure.microsoft.com/en-us/blog/azure-signalr-service-now-generally-available/). 

[ASP.NET Core SignalR](https://docs.microsoft.com/en-us/aspnet/core/signalr/introduction) est entièrement pris en charge.
...
S’il persiste pendant plus d’une heure, [ouvrez un problème sur GitHub](https://github.com/Azure/azure-signalr/issues/new) ou [créez une demande de support dans Azure](https://docs.microsoft.com/en-us/azure/azure-supportability/how-to-create-azure-support-request).
...
Vous pouvez examiner le code source [ici](https://github.com/Azure/azure-signalr/blob/kevinzha/faq/src/Microsoft.Azure.SignalR/ServiceHubConnectionContext.cs).
...
Vous pouvez configurer les transports côté client conformément à cette [documentation](https://docs.microsoft.com/en-us/aspnet/core/signalr/configuration?view=aspnetcore-2.1#configure-allowed-transports).
