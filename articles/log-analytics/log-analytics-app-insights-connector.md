...
- Utilisez [Recherche dans les journaux](log-analytics-queries.md) pour afficher des informations détaillées sur vos applications Application Insights.
