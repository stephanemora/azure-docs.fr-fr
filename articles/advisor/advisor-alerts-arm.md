...
description: Découvrez comment configurer une alerte pour de nouvelles recommandations d’Azure Advisor en utilisant un modèle Resource Manager (modèle ARM).
ms.topic: quickstart
