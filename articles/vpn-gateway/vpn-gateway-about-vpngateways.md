...
### <a name="deployment-model"></a><a name="models"></a>Modèle de déploiement
...
## <a name="connection-topology-diagrams"></a><a name="diagrams"></a>Diagrammes de topologie de connexion
