...
## <a name="declare"></a>1. Se connecter et définir les variables
...
Déclarez les variables que vous souhaitez utiliser. Utilisez l’exemple ci-dessous en utilisant vos propres valeurs si nécessaire.
