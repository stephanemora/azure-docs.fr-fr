...
# Exemples
## [Créer une passerelle VPN](./scripts/vpn-gateway-sample-create-vpn-gateway-powershell.md)
## [Point à site : authentification RADIUS](./scripts/vpn-gateway-sample-point-to-site-radius-authentication-powershell.md)
## [Point à site : certificat d’authentification](./scripts/vpn-gateway-sample-point-to-site-certificate-authentication-powershell.md)
## [De site à site](./scripts/vpn-gateway-sample-site-to-site-powershell.md)
...
## [À propos du routage de point à site](vpn-gateway-about-point-to-site-routing.md)
...
### [Configurer une connexion de site à site](vpn-gateway-howto-site-to-site-classic-portal.md)
### [Configurer une connexion de point à site](vpn-gateway-howto-point-to-site-classic-azure-portal.md)
### [Configurer une connexion de réseau virtuel à réseau virtuel](vpn-gateway-howto-vnet-vnet-portal-classic.md)
### [Configurer un tunneling forcé](vpn-gateway-about-forced-tunneling.md)
### [Supprimer une passerelle VPN](vpn-gateway-delete-vnet-gateway-classic-powershell.md)
### [Configurer plusieurs connexions de site à site](vpn-gateway-multi-site.md)
### [Configurer une passerelle VPN](vpn-gateway-configure-vpn-gateway-mp.md)
