...
1. Utilisez la cmdlet `Get-AzureRmVpnClientConfiguration` pour générer la configuration du client VPN pour le protocole EapMSChapv2. Pour obtenir des instructions, consultez cette section de l’article.
