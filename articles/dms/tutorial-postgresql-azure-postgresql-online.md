---
title: Utiliser Azure Database Migration Service pour effectuer une migration en ligne de PostgreSQL vers Azure Database pour MySQL | Microsoft Docs
...
ms.locfileid: "47182465"
---
# <a name="migrate-postgresql-to-azure-database-for-postgresql-online-using-dms"></a>Migrer PostgreSQL vers Azure Database pour PostgreSQL en ligne à l’aide de DMS
...
> [!div class="checklist"]
> * Migrez l’exemple de schéma à l’aide de l’utilitaire pgdump.
...
6.  S’il existe un type de données ENUM dans des tables, il est recommandé de mettre temporairement un type de données « character varying » dans la table cible. À la fin de la réplication des données, rétablissez le type de données sur ENUM.
...
- Pour plus d’informations sur Azure Database pour MySQL, consultez l’article [Qu’est-ce qu’Azure Database pour PostgreSQL ?](https://docs.microsoft.com/azure/postgresql/overview).