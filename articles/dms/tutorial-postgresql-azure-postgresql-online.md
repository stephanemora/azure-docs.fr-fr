---
title: 'Tutoriel : Utiliser Azure Database Migration Service pour effectuer une migration en ligne de PostgreSQL vers Azure Database pour MySQL | Microsoft Docs'
