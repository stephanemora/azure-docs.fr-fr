...
* Créez une instance gérée SQL en suivant les indications de l’article [Créer une instance gérée SQL Azure dans le portail Azure](../azure-sql/managed-instance/instance-create-quickstart.md).
