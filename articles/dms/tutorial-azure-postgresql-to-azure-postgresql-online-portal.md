...
* Une instance [Azure Database pour PostgreSQL](https://docs.microsoft.com/azure/postgresql/) version 10 et ultérieure existante avec la base de données **DVD Rental**. 
