...
ms.locfileid: "58106030"
---
# <a name="tutorial-migrate-sql-server-to-a-single-database-or-pooled-database-in-azure-sql-database-offline-using-dms"></a>Tutoriel : Migrer SQL Server vers une base de données unique ou en pool dans Azure SQL Database hors connexion à l’aide de DMS
