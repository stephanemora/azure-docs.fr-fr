---
title: 'Tutoriel : Utiliser Azure Database Migration Service pour effectuer une migration hors connexion de SQL Server vers une base de données unique/en pool dans Azure SQL Database | Microsoft Docs'
