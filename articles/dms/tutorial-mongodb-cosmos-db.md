---
title: 'Didacticiel : Utiliser Azure Database Migration Service pour effectuer une migration hors connexion de MongoDB vers l’API MongoDB Azure Cosmos DB | Microsoft Docs'
