...
Recherchez `case DemoStep::ConfigSession:` et ajoutez la ligne suivante, en remplaçant le domaine de votre compte : `configuration.AccountDomain("MyAccountDomain");`.
