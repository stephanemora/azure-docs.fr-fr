---
title: Créer et localiser les points d’ancrage à l’aide d’Azure les ancres spatiale dans Unity | Microsoft Docs
...
---
# <a name="create-and-locate-anchors-using-azure-spatial-anchors-in-unity"></a>Créer et localiser les points d’ancrage à l’aide d’Azure les ancres spatiale dans Unity
...
Azure Spatial Anchors vous permet de partager des ancres dans le monde entre différents appareils. Il prend en charge plusieurs environnements de développement. Dans cet article, nous allons approfondir la marche à suivre dans Unity.
