...
## <a name="privacy-faq-for-developers"></a>Questions fréquentes sur la protection des données personnelles (pour les développeurs)
...
**Q : Quelles conditions générales s’appliquent quand j’utilise ASA dans mon application ou kit SDK ?**

**R :** Les [conditions générales](https://www.nuget.org/packages/Microsoft.Azure.SpatialAnchors.WinRT/2.9.0/License) suivantes s’appliquent, ainsi que toutes les conditions comprises dans cette licence.

### <a name="i-want-to-release-an-app-or-sdk-that-includes-asa"></a>Je souhaite publier une application ou un kit SDK qui comprend ASA.
**Q : Est-ce que je dois accepter des conditions supplémentaires ?**

**R :** Non. En utilisant ASA, vous acceptez les conditions d’utilisation associées et les conditions comprises ci-dessus. Aucune condition supplémentaire n’est nécessaire.

**Q : Est-ce que Microsoft demande la divulgation d’ASA dans mon application ou SDK à mes utilisateurs ?**
...
**Q : Mes utilisateurs doivent-ils accepter des conditions générales spécifiques ?**

**R :** Non. La relation contractuelle est entre Microsoft et le développeur de l’application ou du SDK.  Vous devez collaborer avec vos propres conseillers juridiques pour déterminer si le consentement à utiliser ASA ou si les pratiques de protection des données personnelles de Microsoft sont exigées par votre législation locale.

**Q : Je souhaite notifier mes utilisateurs que mon application/SDK utilise ASA, quelle est l’interface recommandée pour avertir mes utilisateurs ?**

**R :** « Cette application utilise Microsoft Azure Spatial Anchors.  Pour plus d’informations sur Azure Spatial Anchors, accédez à [Azure Spatial Anchors | Microsoft Azure](https://azure.microsoft.com/en-us/services/spatial-anchors/) ».
...
**R :** Azure Spatial Anchors est actuellement disponible dans les régions : USA Ouest 2, USA Est, USA Est 2, USA Centre Sud, Europe Ouest, Europe Nord, Royaume-Uni Sud, Australie Est, Asie Sud-Est et Corée Centre. Des régions supplémentaires seront également disponibles par la suite.
