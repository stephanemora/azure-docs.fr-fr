...
| {policy} | OUI | Flux utilisateur à exécuter. Spécifiez le nom d’un flux utilisateur que vous avez créé dans votre locataire Azure AD B2C. Par exemple : `b2c_1_sign_in`, `b2c_1_sign_up` ou `b2c_1_edit_profile`. |
