---
title: Configurer la connexion avec un compte Azure Active Directory dans Azure Active Directory B2C à l’aide de stratégies personnalisées
...
Cet article explique comment activer la connexion d’utilisateurs à partir d’une organisation Azure Active Directory (Azure AD) à l’aide de [stratégies personnalisées](active-directory-b2c-overview-custom.md) dans Azure Active Directory B2C (Azure AD B2C).
