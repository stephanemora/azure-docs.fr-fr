...
Avec un compte Mailjet créé et une Clé API Mailjet stockée dans une clé de stratégie Azure AD B2C, créez un [modèle transactionnel dynamique](https://Mailjet.com/docs/ui/sending-email/how-to-send-an-email-with-dynamic-transactional-templates/) Mailjet.
...
1. Enfin, ajoutez la transformation de revendications d’entrée suivante au profil technique LocalAccountSignUpWithLogonEmail.
