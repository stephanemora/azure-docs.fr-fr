...
| Élément | Occurrences | Description |
| ------- | ----------- | ----------- |
| Conditions préalables | 0:1 | Une liste de conditions préalables qui doivent être satisfaites pour que le profil technique de validation puisse s’exécuter. |
