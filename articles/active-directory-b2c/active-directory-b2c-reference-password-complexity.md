---
title: Complexité des mots de passe – Azure Active Directory B2C | Microsoft Docs
...
Si vous utilisez des stratégies personnalisées, vous pouvez ([configurer la complexité des mots de passe dans une stratégie personnalisée](active-directory-b2c-reference-password-complexity-custom.md)).
