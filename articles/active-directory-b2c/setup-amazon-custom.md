...
- Si vous n’avez pas de compte Amazon, créez-en un à l’adresse [http://www.amazon.com/](https://www.amazon.com/).
...
## <a name="create-a-policy-key"></a>Créer une clé stratégie

Vous devez stocker le secret client que vous avez enregistré dans votre locataire Azure AD B2C.
...
3. Ajouter un nouveau **ClaimsProvider** comme suit :  
...
2. Sous **ClaimsProviderSelects**, ajoutez l’élément suivant. Définissez la valeur de **TargetClaimsExchangeId** sur une valeur appropriée, par exemple `AmazonExchange` :
