---
title: Stratégies intégrées dans Azure Active Directory B2C | Microsoft Docs
description: Rubrique sur l’infrastructure de stratégie extensible d’Azure Active Directory B2C et la création de différents types de stratégies.
...
## <a name="preview-policies"></a>Afficher un aperçu des stratégies

À mesure que nous publions de nouvelles fonctionnalités, certaines d'entre elles risquent de ne pas être disponibles sur les stratégies existantes.  Nous prévoyons de remplacer les anciennes versions par la version la plus récente du même type, une fois ces stratégies mises à la disposition générale.  Vos stratégies existantes ne changeront pas, et pour tirer parti de ces nouvelles fonctionnalités, vous devez créer de nouvelles stratégies.
