---
title: Sécuriser une API web à l’aide de Node.js dans Azure Active Directory B2C | Microsoft Docs
description: Comment créer une API web Node.js qui accepte les jetons d’un locataire B2C.
