...
Suivez les étapes de l’article [Bien démarrer avec les stratégies personnalisées](custom-policy-get-started.md). Testez le parcours utilisateur d’inscription ou de connexion pour inscrire un nouveau compte local avant de continuer.
...
![Contrôle de liste déroulante à sélection unique présentant plusieurs options](./media/custom-policy-configure-user-input/dropdown-menu-example.png)
...
![Contrôle de case à cocher à sélection multiple présentant plusieurs options](./media/custom-policy-configure-user-input/multiselect-menu-example.png)
