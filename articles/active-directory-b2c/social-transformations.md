...
1. À l’aide de la **CreateAlternativeSecurityId** de revendications de transformation, créer un nouveau **alternativeSecurityId** avec un nom de type de revendication `AlternativeSecurityId2`
