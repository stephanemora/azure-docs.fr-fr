...
Vous pouvez automatiser d’autres tâches d’administration, par exemple, [gérer les comptes d’utilisateurs Azure AD B2C avec Microsoft Graph](microsoft-graph-operations.md).