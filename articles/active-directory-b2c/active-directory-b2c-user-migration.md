---
title: Approches de migration utilisateur dans Azure Active Directory B2C
...
Pour obtenir le lien vers votre stratégie de réinitialisation du mot de passe, procédez comme suit : Cette procédure suppose que vous avez déjà créé une [stratégie personnalisée](active-directory-b2c-get-started-custom.md) de réinitialisation du mot de passe.
