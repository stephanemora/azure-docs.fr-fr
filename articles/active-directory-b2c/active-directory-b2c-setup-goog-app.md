---
title: Configurer l’inscription et la connexion avec un compte Google – Azure Active Directory B2C
...
1. Entrez un **Nom du projet**, cliquez sur **Créer**, puis vérifiez que vous utilisez le nouveau projet.
...
1. Dans **Clé secrète client**, entrez la clé secrète que vous avez enregistrée.
