---
title: Traduire l’interface utilisateur de votre application avec une stratégie personnalisée
description: Apprenez à traduire une interface utilisateur à l’aide d’une stratégie personnalisée dans Azure Active Directory B2C.
