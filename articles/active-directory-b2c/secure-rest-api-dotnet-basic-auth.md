...
Dans un [article connexe sur Azure AD B2C](rest-api-claims-exchange-dotnet.md), vous créez un service RESTful (API web) qui s’intègre sans authentification aux parcours utilisateur Azure Active Directory B2C (Azure AD B2C).
...
Effectuez les étapes de l’article [Procédure pas à pas : intégration des échanges de revendications de l’API REST dans votre parcours utilisateur Azure Active Directory B2C comme validation d’une entrée de l’utilisateur](rest-api-claims-exchange-dotnet.md).
...
1. Cliquez avec le bouton droit sur le dossier *App_Start*, sélectionnez **Ajouter**, puis choisissez **Classe**.
   ...
   ![Ajouter une classe ClientAuthMiddleware.cs dans le dossier App_Start](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-OWIN-startup-auth1.png)

2. Dans la zone **Nom**, tapez **ClientAuthMiddleware.cs**.

   ![Création d’une classe C# dans la boîte de dialogue Ajouter un nouvel élément dans Visual Studio](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-OWIN-startup-auth2.png)
...
1. Cliquez avec le bouton droit sur le projet, sélectionnez **Ajouter** > **Nouvel élément**, puis recherchez **OWIN**.
   ...
   ![Création d’une classe de démarrage OWIN dans la boîte de dialogue Ajouter un nouvel élément dans Visual Studio](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-OWIN-startup.png)
...
![Ajouter la balise Authorize au contrôleur](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-authorize.png)
...
5. Immédiatement après l’élément `<Metadata>` fermant, ajoutez l’extrait de code XML suivant :
    ...
    ![Ajouter des éléments XML d’authentification de base au profil technique](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-add-1.png)
...
3. Testez le processus en tapant **Test** dans la zone **Prénom**.
    ...
    ![Test de la validation d’entrée du prénom sur votre API d’identité](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-test.png)
...
* [Utiliser les certificats client pour sécuriser votre API RESTful](secure-rest-api-dotnet-certificate-auth.md)
