---
title: Vérification et confirmation d’identité pour Azure AD B2C
titleSuffix: Azure AD B2C
description: Découvrez nos partenaires qui s’intègrent à Azure AD B2C pour fournir des solutions de vérification et de confirmation d’identité.
...
ms.locfileid: "105027460"
---
# <a name="identity-verification-and-proofing-partners"></a>Vérification des identités et partenaires de preuve
...
Microsoft travaille en partenariat avec les fournisseurs de logiciels indépendants (ISV) suivants.
