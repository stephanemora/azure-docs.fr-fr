...
2. Créez des stratégies d’administration déléguée et assignez des utilisateurs en tant qu’[administrateurs délégués](../active-directory/users-groups-roles/roles-concept-delegation.md) avec différents rôles.
