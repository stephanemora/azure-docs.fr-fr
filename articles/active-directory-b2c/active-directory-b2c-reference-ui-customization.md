...
* Assurez-vous de ne pas inclure les balises `<form>` dans votre HTML, étant donné le risque d’interférence avec les opérations POST générées par le HTML injecté à partir de Azure AD B2C.
