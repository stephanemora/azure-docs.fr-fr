...
En tant que développeur ou administrateur informatique, vous pouvez utiliser des connecteurs d’API pour intégrer vos flux d’utilisateur d’inscription avec des API web pour personnaliser l’inscription et intégrer des systèmes externes. Par exemple, avec les connecteurs d’API, vous pouvez :
