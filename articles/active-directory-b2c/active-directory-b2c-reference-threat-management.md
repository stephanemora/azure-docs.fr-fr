---
title: Gérer les menaces aux ressources et aux données dans Azure Active Directory B2C
...
![Section du rapport de connexion Azure AD montrant un compte verrouillé](media/active-directory-b2c-reference-threat-management/portal-01-locked-account.png)
