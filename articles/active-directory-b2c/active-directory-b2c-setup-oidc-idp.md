---
title: Ajout de fournisseurs d’identité OpenID Connect dans des stratégies intégrées - Azure AD B2C | Microsoft Docs
description: Guide de présentation sur l’ajout de fournisseurs OpenID Connect dans des stratégies intégrées dans Azure AD B2C
