...
> [!NOTE]
> Le secret client est facultatif. Toutefois, vous devez entrer un secret client si vous souhaitez utiliser le [flux de code d’autorisation](http://openid.net/specs/openid-connect-core-1_0.html#CodeFlowAuth), qui utilise le secret pour échanger le code pour le jeton.
