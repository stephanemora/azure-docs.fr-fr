...
1. Pour **Application**, sélectionnez l’application web *testapp1* que vous avez inscrite. L’**URL de réponse** doit être `https://jwt.ms`.
1. Cliquez sur **Exécuter le flux utilisateur**.
