...
Effectuez les étapes et les prérequis du [Tutoriel : Authentifiez les utilisateurs dans un client de bureau natif](active-directory-b2c-tutorials-desktop-app.md).
...
![Nom complet affiché dans le volet supérieur de l’application de bureau WPF](media/active-directory-b2c-tutorials-desktop-app-webapi/desktop-app-01-post-api-call.png)
