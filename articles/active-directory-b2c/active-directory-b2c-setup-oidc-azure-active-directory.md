---
title: 'Azure Active Directory B2C : Ajouter un fournisseur Azure AD à l’aide de stratégies prédéfinies | Microsoft Docs'
description: Découvrir comment ajouter un fournisseur d’identité Open ID Connect (Azure AD)
