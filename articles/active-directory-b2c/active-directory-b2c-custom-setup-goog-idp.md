...
2. Ajoutez le code suivant **ClaimsExchange** élément veillant à utiliser la même valeur pour l’ID que vous avez utilisé pour **TargetClaimsExchangeId**:
