---
title: Exemples d’applications intégrées avec Azure Active Directory B2C | Microsoft Docs
description: Exemples de code pour des intégrations mobiles, de bureau, web et monopages Azure AD B2C.
