---
title: Résoudre les problèmes liés aux stratégies personnalisées et aux flux d’utilisateurs dans Azure Active Directory B2C
...
ms.locfileid: "129661852"
---
# <a name="troubleshoot-azure-ad-b2c-custom-policies-and-user-flows"></a>Résoudre les problèmes Azure Active Directory B2C liés aux stratégies personnalisées et aux flux d’utilisateurs

[!INCLUDE [active-directory-b2c-choose-user-flow-or-custom-policy](../../includes/active-directory-b2c-choose-user-flow-or-custom-policy.md)]

Votre application doit gérer certaines erreurs provenant du service Azure B2C. Cet article met en évidence certaines des erreurs courantes et comment les gérer.

::: zone pivot="b2c-user-flow"

## <a name="password-reset-error"></a>Erreur de réinitialisation de mot de passe

Cette erreur se produit lorsque l'[expérience de réinitialisation du mot de passe en libre-service](add-password-reset-policy.md#self-service-password-reset-recommended) n’est pas activée dans un flux d’utilisateur. Par conséquent, le fait de sélectionner le lien **Vous avez oublié votre mot de passe ?** ne déclenche aucun flux d’utilisateur de réinitialisation de mot de passe. À la place, le code d’erreur `AADB2C90118` est retourné à votre application.

Il existe 2 solutions à ce problème :  
  - Répondre avec une nouvelle demande d’authentification à l’aide du flux d’utilisateur de réinitialisation de mot de passe Azure AD B2C.
  - Utiliser l’[expérience de réinitialisation de mot de passe en libre-service (SSPR)](add-password-reset-policy.md#self-service-password-reset-recommended) recommandée.  


## <a name="user-canceled-the-operation"></a>L’utilisateur a annulé l’opération
Le service Azure AD B2C peut également retourner une erreur à votre application lorsqu’un utilisateur annule une opération. Voici quelques exemples de scénarios dans lesquels un utilisateur effectue une opération d’annulation : 
-  Une stratégie d’utilisateur utilise l’[expérience de réinitialisation de mot de passe en libre-service (SSPR)](add-password-reset-policy.md#self-service-password-reset-recommended) recommandée avec un compte local de consommateur. L’utilisateur sélectionne le lien **Vous avez oublié votre mot de passe ?** , puis il clique sur le bouton **Annuler** pour terminer l’expérience du flux d’utilisateur. Dans ce cas, Azure AD service B2C retourne le code `AADB2C90091` d’erreur à votre application. 
- Un utilisateur choisit de s’authentifier auprès d’un fournisseur d’identité externe tel que [LinkedIn](identity-provider-linkedin.md). L’utilisateur sélectionne le bouton **Annuler** avant de s’authentifier auprès du fournisseur d’identité lui-même. Dans ce cas, Azure AD service B2C retourne le code `AADB2C90273` d’erreur à votre application. En savoir plus sur les [codes d’erreur Azure Active Directory service B2C retour](error-codes.md).

Pour gérer cette erreur, récupérez la **description de l’erreur** pour l’utilisateur et réagissez avec une nouvelle demande d’authentification avec le même Workflow utilisateur. 
