...
description: Découvrez les conditions préalables à l’utilisation de l’API de soumission de l’Espace partenaires pour les applications Azure dans la Place de marché Azure.
...
* [Créer un ressource technique Azure Container](azure-container-technical-assets.md)
* [Créer une offre Azure Container](azure-container-offer-setup.md)
