...
## <a name="publishing-offers"></a>Publication d'offres
...
| **Modèle de tarification** | **Description** | **S’applique à** |
| :---------------- | :---------------| :-----------------|
| **Gratuit** | Référence SKU gratuite Aucun frais n'est facturé aux clients de la Place de marché Azure pour l'utilisation de l'offre. En outre, aucun prix ne peut être appliqué à ces références. | <ul><li>Images de machine virtuelle</li><li>Extensions de machine virtuelle</li><li>Services</li><li>Modèles Resource Manager</li></ul> |
| **Version d'évaluation gratuite** <br> **(Essayez-la dès maintenant)** | Référence SKU fournie à titre gratuit pour une période limitée. Aucun frais n'est facturé aux clients de la Place de marché Azure pour l'utilisation de l'offre pendant la période d'évaluation. À l'expiration de la période d'essai, les clients sont facturés au coût standard d'utilisation de l'offre. La Place de marché n'est pas actuellement en mesure d'empêcher les clients de créer plusieurs abonnements aux offres d'évaluation gratuites. Il incombe aux éditeurs désireux de limiter le nombre d'abonnements aux offres d'évaluation gratuites d'inclure les restrictions appropriées dans leurs Conditions d'utilisation. | <ul><li>Images de machine virtuelle</li><li>Services</li></ul> |
**BYOL** | Référence SKU BYOL (avec apport de sa propre licence). S'ils ont obtenu le droit d'accéder à l'offre ou de l'utiliser en dehors de la Place de marché Azure, les clients ne font l'objet d'aucune facturation pour l'utilisation de l'offre dans la Place de marché Azure. | Images de machine virtuelle |
| **Abonnement mensuel** | Tout abonnement à une offre est soumis à une redevance mensuelle fixe. L'abonnement mensuel débute à la date d'achat du client, sauf dans les cas décrits ci-dessous. Le tarif mensuel n'est pas calculé au prorata en cas d'annulation en cours de mois ou en cas de services non utilisés. Les frais mensuels peuvent être calculés au prorata si les termes du contrat de licence du client prévoient une facturation mensuelle ou si le client change d’abonnement en milieu de mois. Le changement d’abonnement n’est possible que si l’éditeur configure l’offre en conséquence. | Services |
| **Facturation basée sur l'utilisation** | Les clients sont facturés selon l'utilisation réelle de l'offre. Pour les images Machines Virtuelles, les frais Place de marché Azure facturés aux clients sont basés sur l'utilisation réelle des machines virtuelles déployées à partir de ces images, selon un tarif horaire convenu par les éditeurs. Le tarif horaire peut être fixe ou variable en fonction de la taille des machines virtuelles. Les heures non terminées sont facturées à la minute. <br><br> Pour les services d'application, les éditeurs sont chargés de déterminer l'unité de mesure utilisée pour la facturation (par exemple, nombre de transactions, nombre de courriers électroniques envoyés, etc.). Les éditeurs peuvent définir plusieurs mesures pour un même plan de service d'application. Les éditeurs sont chargés d'effectuer le suivi personnel de l'utilisation pour chaque mesure définie par l'offre. Ils doivent également transmettre ces informations à Microsoft sur une base horaire à l'aide des mécanismes de rapports fournis par Microsoft. Celui-ci facture ensuite les clients en fonction des informations collectées par les éditeurs pour la période de facturation applicable. | <ul><li>Services</li><li>Images de machine virtuelle</li></ul> |
| | | |

Les éditeurs ont désormais la possibilité de réduire leurs frais d'utilisation des offres de machine virtuelle déjà publiées. Actuellement, la Place de marché ne prend en charge aucun autre type de modification de prix d'offres existantes. Les éditeurs qui souhaitent modifier les frais d’utilisation d’une offre doivent d'abord supprimer l’offre de la Place de marché.  Cette suppression doit se faire conformément aux dispositions du Contrat d’Éditeur de la Place de marché Microsoft et du présent document.  L'éditeur peut ensuite publier une nouvelle offre avec les nouveaux tarifs utilisateur.

Après avoir publié une offre de services sur la Place de marché, les éditeurs doivent conserver leurs propres journaux de données pendant au moins deux (2) années civiles. Les journaux de données contiennent la mise à disposition de leur offre aux clients. Si les données contenues dans les journaux de données de l’éditeur sont en conflit avec celles contenues dans les journaux de données de Microsoft, ces dernières font foi.

## <a name="offering-suspension-and-removal"></a>Suspension et retrait des offres
...
1. **Pays gérés par Microsoft.**
    ...
    1. Les pays suivants sont des Pays gérés par Microsoft pour les ventes réalisées dans tous les scénarios d’achat client : Arabie saoudite, Arménie, Bélarus, Canada, Corée du Sud, Émirats arabes unis, États-Unis, Inde, Irlande, Liechtenstein, Monaco, Nouvelle-Zélande, Norvège, Porto Rico, Russie, Serbie, Suisse, Taïwan, Turquie et Union européenne. 
