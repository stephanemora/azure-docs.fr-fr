...
> [!NOTE]
> Pour plus d’informations sur le délai de paiement de Microsoft pour une transaction enregistrée sur la Place de marché Microsoft, consultez [Détails de la politique de paiement](./payout-policy-details.md).
...
- [Vue d’ensemble de la synthèse des revenus](./payout-summary-overview.md)
