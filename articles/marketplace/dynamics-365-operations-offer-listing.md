---
title: Configurer les détails de la liste des offres Dynamics 365 for Operations sur Microsoft AppSource (Place de marché Azure)
description: Configurez les détails de la liste des offres Dynamics 365 for Operations sur Microsoft AppSource (Place de marché Azure).
...
ms.locfileid: "110615471"
---
# <a name="configure-d365-for-operations-offer-listing-details"></a>Configurer les détails de la liste des offres D365 for Operations
...
:::image type="content" source="media/dynamics-365/example-d365-operations.png" alt-text="Illustre la façon dont cette offre s’affiche dans Microsoft AppSource.":::

- La section encadrée en haut contient votre logo et le nom de votre offre, suivis du résumé des résultats de votre recherche, des évaluations et de la sélection de prix.
- L'onglet **Vue d'ensemble** contient un résumé des résultats de votre recherche, une description et des exemples de captures d'écran et (éventuellement) des vidéos miniatures liées.
- L'onglet **Détails et support** contient les informations que vous fournissez pour des sujets tels que la structure tarifaire, la version, le contrat de licence, la politique de confidentialité et le support.

Poursuivez la lecture ci-dessous pour savoir comment entrer ces détails sur la Place de marché.
...
- [Définir la disponibilité de l’offre](dynamics-365-operations-availability.md)
