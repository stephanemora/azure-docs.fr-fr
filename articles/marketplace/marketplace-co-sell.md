...
![Diagramme montrant la manière dont la co-vente se produit lorsque les prospects sont partagés, acceptés et gagnés auprès des clients gérés par Microsoft.](./media/marketplace-publishers-guide/marketplace-co-sell-v2.png)
</ul>
...
|<ol start=2><li>Soumettez les documents de co-vente requis.</li>|Offres IP *avec* [option de co-vente dans l'Espace partenaires](https://docs.microsoft.com/azure/marketplace/partner-center-portal/commercial-marketplace-co-sell)|[Chargez les documents requis dans l'Espace partenaires](#how-to-submit-co-sell-materials-in-partner-center) : <ul><li>Contact commercial pour chaque pays éligible.</li><li>Nomenclature : une page client, jeu de présentation client (facultatif), URL de la page d'arrivée de la solution, URL du canal de réseau social, ou autre (par exemple une étude de cas).|Prêt pour la co-vente|
...
1. Fournissez des détails sur votre offre et chargez les éléments associés dans la section **Documents**. Les vendeurs Microsoft utiliseront ces informations pour recommander et vendre votre offre.
...
1. Chargez les coordonnées du service commerciale dans la section **Contacts**. Les vendeurs Microsoft sont susceptibles de contacter ces personnes afin d’obtenir des informations supplémentaires sur votre offre.
