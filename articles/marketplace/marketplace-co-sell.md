...
- **Évaluation de solution** : collaborez avec des partenaires approuvés par l’équipe d’évaluation de solution afin de connaître les besoins technologiques des clients qui utilisent ou envisagent d’utiliser les technologies Microsoft.

## <a name="co-sell-statuses"></a>Statuts de co-vente

Quatre niveaux de statut de co-vente peuvent être appliqués à une offre :
...
Le statut _Co-vente avec incentives_ comprend _Co-vente Azure IP avec incentives_ et _Incentive Biz Apps ISV Connect Premium_. Ces statuts encouragent les partenaires à vendre votre offre. Pour les atteindre, vous devez également atteindre le statut Prêt pour la co-vente. Le statut Co-vente avec incentives accumule tous les avantages des solutions Prêtes pour la co-vente, peut accumuler des incentives supplémentaires pour les équipes de vente Microsoft, et être éligible à d’autres avantages de la Place de marché commerciale.
...
Le statut Incentive Biz Apps ISV Connect Premium peut être appliqué à ces types d’offres :
...
- Les offres qui atteignent le statut _Co-vente Azure IP avec incentives_ ou _Incentive Biz Apps ISV Connect Premium_ recevront un badge **Solutions préférées** dans la page d’annonce de l’offre dans les magasins en ligne. Ce badge démontre la qualité, les performances et la capacité d’une offre à répondre aux besoins des clients dans un segment vertical ou un domaine fonctionnel précis. Pour en savoir plus, consultez [Solutions préférées dans Microsoft AppSource et la Place de marché Azure](preferred-solutions.md).
