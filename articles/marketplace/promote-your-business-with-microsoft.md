...
*   Connexion avec les équipes ou les partenaires  
*   Solutions et formation pour vous aider à développer vos compétences  

Pour promouvoir votre offre ou application, utilisez le tableau suivant pour accéder à plus d’avantages et de ressources. 

| avantage | les ressources |  
|:--- |:--- |  
| Utiliser vos avantages fondamentaux | Dans le cadre de Microsoft Partner Network, vous recevez un ensemble d’avantages fondamentaux pouvant vous permettre de gagner du temps et de l’argent. Les avantages peuvent également vous aider à renforcer vos capacités, mieux servir les clients et créer des connexions pour atteindre pleinement votre potentiel commercial.<ul> <li>Pour plus d’informations sur les avantages fondamentaux, consultez la page Avantages fondamentaux et configuration requise à l’adresse [partner.microsoft.com/membership/core-benefits](https://partner.microsoft.com/membership/core-benefits).</li> </ul> |  
