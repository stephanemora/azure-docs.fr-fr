...
-   **URL de la version d’essai SaaS :** entrez l’URL de l’expérience d’essai de votre application.
...
Sélectionnez **Table Azure** si vous utilisez l’un de ces systèmes CRM : Salesforce, Marketo ou Microsoft Dynamics CRM. 
