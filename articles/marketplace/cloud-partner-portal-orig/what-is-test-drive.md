...
- **[Azure Resource Manager](./azure-resource-manager-test-drive.md)**  : une version d'évaluation Azure Resource Manager est un modèle de déploiement contenant toutes les ressources Azure qui constituent une solution générée par l'éditeur. Les produits adaptés à ce scénario sont ceux qui utilisent uniquement des ressources Azure.
