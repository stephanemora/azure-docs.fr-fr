---
title: Support pour le portail Cloud Partner | Microsoft Docs
...
Nous accuserons réception de votre ticket dans les 24 heures et nous affecterons à votre problème une priorité et une gravité. Notre équipe d'ingénieurs de support technique dédiée aidera à sa résolution en fonction des temps de réponse définis dans notre contrat de niveau de service. 

La capture d’écran suivante montre les informations d’incident que vous recevrez comme confirmation du support Microsoft.

![support4](./media/cloud-partner-portal-support-for-cloud-partner-portal/support4.png)


-   Si vous avez besoin de nous contacter à propos de votre problème, répondez au message pour que nous puissions prévoir un temps pour vous contacter.

-   Vous pouvez consulter la progression de votre problème à tout moment en sélectionnant le lien **Voir l’incident en ligne** qui se trouve dans la capture d’écran précédente.
