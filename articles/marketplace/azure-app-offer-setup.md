---
title: Créer une offre d’application Azure sur la Place de marché Azure
description: Créer une offre Azure Application pour référencer ou vendre votre application sur la Place de marché Azure ou via le programme Fournisseur de solutions cloud (CSP), en utilisant le portail de la Place de marché commerciale.
author: aarathin
ms.author: aarathin
...
- [Configurer les propriétés de l’application Azure](azure-app-properties.md)
