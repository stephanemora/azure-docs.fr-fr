...
Si vous effectuez des modifications, sélectionnez **Enregistrer le brouillon** avant de passer à l’onglet suivant du menu de navigation gauche.

## <a name="next-steps"></a>Étapes suivantes

Effectuez l’une des actions suivantes :

- Si vous avez choisi d’activer la gestion de licence d’application par le biais de Microsoft, accédez à [Créer des plans Dynamics 365 pour Customer Engagement et Power Apps](dynamics-365-customer-engage-plans.md).
- Sinon, accédez à [Définir la configuration technique de l’offre](dynamics-365-customer-engage-technical-configuration.md).
