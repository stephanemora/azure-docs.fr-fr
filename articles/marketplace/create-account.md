---
title: Créer un compte de marketplace commercial dans Espace partenaires – Place de marché Azure
...
Pour publier des offres sur [Microsoft AppSource](https://appsource.microsoft.com/) ou [Place de marché Azure](https://azuremarketplace.microsoft.com/), vous devrez créer un compte dans le cadre du programme de marketplace commercial dans Espace partenaires. Cet article explique comment créer un compte de marketplace commercial dans le cadre du programme dédié.
...
## <a name="create-an-account-in-partner-center"></a>Créer un compte dans Espace partenaires

Pour créer un compte dans le cadre du programme de marketplace commercial dans Espace partenaires, vérifiez que vous répondez aux conditions préalables suivantes. Nous vérifierons ces informations au cours du processus de création du compte.
...
- Si vous êtes nouveau dans Espace partenaires et que vous n’avez pas de compte Microsoft Partner Network (MPN), continuez vers [Créer un compte Espace partenaires et s’inscrire sur le marketplace commercial](#create-a-partner-center-account-and-enroll-in-the-commercial-marketplace).
- Si vous êtes déjà inscrit à Microsoft Partner Network ou à un programme de développement, créez un compte directement à partir d’Espace partenaires. Accédez à [Utiliser un compte Espace partenaires existant pour s’inscrire sur le marketplace commercial](#use-an-existing-partner-center-account-to-enroll-in-the-commercial-marketplace).

### <a name="create-a-partner-center-account-and-enroll-in-the-commercial-marketplace"></a>Créer un compte Espace partenaires et s’inscrire sur le marketplace commercial
...
Passez en revue les informations de la page d’inscription [Bienvenue dans l’Espace partenaires Microsoft](https://go.microsoft.com/fwlink/?linkid=2165529), puis inscrivez-vous pour obtenir un compte.
...
### <a name="use-an-existing-partner-center-account-to-enroll-in-the-commercial-marketplace"></a>Utiliser un compte Espace partenaires existant pour s’inscrire sur le marketplace commercial

Suivez les instructions de cette section pour créer un compte de marketplace commercial si vous êtes déjà inscrit à Espace partenaires de Microsoft. Il existe deux types d’inscriptions que vous pouvez utiliser pour configurer votre compte de la place de marché commerciale. Choisissez le scénario qui vous concerne :

*Que se passe-t-il si je suis déjà inscrit dans le Microsoft Partner Network ?*
- [Utilisez un compte Microsoft Partner Network existant](#use-an-existing-microsoft-partner-network-account) pour créer votre compte.
...
#### <a name="use-an-existing-microsoft-partner-network-account"></a>Utiliser un compte Microsoft Partner Network existant

Lorsque vous utilisez votre compte Microsoft Partner Network pour vous inscrire au programme de marketplace commercial dans Espace partenaires, nous lions le domaine du compte de messagerie professionnelle de votre entreprise à votre nouveau compte de marketplace commercial.

Vous pouvez ensuite attribuer les rôles d’utilisateur et les autorisations appropriés à vos utilisateurs, afin qu’ils puissent accéder au programme de marketplace commercial dans Espace partenaires.

**S’inscrire sur le marketplace commercial**

1. Connectez-vous à [Espace partenaires](https://go.microsoft.com/fwlink/?linkid=2165507) avec votre compte Microsoft Partner Network.
...
1. Sous **Marketplace commercial**, sélectionnez **Commencer**.
...
1. Pour vérifier que le compte de marketplace commercial est répertorié comme inscrit, en haut à droite de la page, sélectionnez **Paramètres** > **Paramètres du compte** > **Programmes**.
...
>
> Pour vous assurer que vous êtes autorisé à configurer le compte de votre société, nous avons besoin d’une vérification supplémentaire des comptes d’entreprise après l’inscription. Cette vérification peut prendre de quelques jours à quelques semaines, et comprend souvent un appel téléphonique à votre entreprise. Ces deux types de comptes vous permettent de soumettre des applications, des modules complémentaires et des services. Pour plus d’informations, voir  [Types de compte, emplacements et frais](/windows/uwp/publish/account-types-locations-and-fees).
...
1. Connectez-vous à [Espace partenaires](https://go.microsoft.com/fwlink/?linkid=2165507) avec votre compte existant.
1. En haut à droite, sélectionnez **Paramètres** > **Paramètres du compte** > **Programmes**.
...
1. Lisez les conditions générales du [contrat de l’éditeur Microsoft](/legal/marketplace/msft-publisher-agreement), puis sélectionnez **Accepter et continuer** pour terminer l’inscription.
    ...
    Une fois inscrit, vous allez être dirigé vers la page de vue d’ensemble de la place de marché commerciale.
...
Vous venez de créer un compte de la place de marché commerciale dans l’Espace partenaires. Pour obtenir de l’aide sur l’ajout d’éditeurs, continuez vers [Ajouter de nouveaux éditeurs au marketplace commercial](add-publishers.md).
...
Après avoir sélectionné le lien personnalisé et activé votre nouveau compte Espace partenaires, vous pouvez revenir à votre compte en vous rendant sur le [tableau de bord du marketplace commercial](https://go.microsoft.com/fwlink/?linkid=2165290) dans Espace partenaires.
...
- [Ajouter de nouveaux éditeurs au marketplace commercial](add-publishers.md)
