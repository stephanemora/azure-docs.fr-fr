---
title: Services Go-To-Market - Promouvoir votre entreprise avec Microsoft | Azure
description: 'Services Go-To-Market : cette section explique comment les éditeurs peuvent apprendre à promouvoir leur entreprise avec Microsoft.'
author: qianw211
...
ms.locfileid: "81685737"
---
# <a name="promote-your-business-with-microsoft"></a>Faites la promotion de votre entreprise avec Microsoft

Les partenaires de la Place de marché doivent faire partie de Microsoft Partner Network (MPN). En tant que membre MPN, vous pouvez accéder à des avantages supplémentaires orientées entreprise. Visitez [partner.microsoft.com](https://partner.microsoft.com) pour voir comment vous pouvez utiliser le réseau afin d’accéder aux éléments suivants :

* Les nouvelles opportunités commerciales.
* La connexion avec les équipes ou des partenaires.
* Les solutions et formations pour vous aider à développer vos compétences.

## <a name="benefits-and-resources"></a>Avantages et ressources

Afin de promouvoir votre offre ou application, et pour accéder à plus d’avantages et de ressources, utilisez le tableau suivant :
