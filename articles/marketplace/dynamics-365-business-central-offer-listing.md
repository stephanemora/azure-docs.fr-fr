---
title: Configurer les détails de la liste des offres Dynamics 365 for Business Central sur Microsoft AppSource (Place de marché Azure)
description: Configurez les détails de la liste des offres Dynamics 365 for Business Central sur Microsoft AppSource (Place de marché Azure).
...
ms.locfileid: "110616634"
---
# <a name="configure-dynamics-365-for-business-central-offer-listing-details"></a>Configurer les détails de la liste des offres Dynamics 365 for Business Central
...
:::image type="content" source="media/dynamics-365/example-365-business-central.png" alt-text="Illustre la façon dont cette offre s’affiche dans Microsoft AppSource.":::
...
Ajoutez au moins trois captures d'écran (mais pas plus de cinq) pour illustrer le fonctionnement de votre offre. Toutes les captures d’écran doivent être au format PNG en 1280 x 720 pixels. Ajoutez une légende pour chaque capture d’écran.
...
- [Définir la disponibilité de l’offre](dynamics-365-business-central-availability.md)
