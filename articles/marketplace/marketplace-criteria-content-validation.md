...
| 3 | Logo | Le logo s’affiche correctement | Le logo s’affiche correctement et inclut une [bannière](https://docs.microsoft.com/azure/marketplace/cloud-partner-portal-orig/cloud-partner-portal-solution-template-offer-publish) qui est en fait l’image grand format figurant sur le portail Azure |
...
| 7 | Artefacts marketing | Les logos s’affichent correctement | <br>• Logo comportant une « image de premier plan » qui correspond à l’image grand format figurant sur le Portail Azure <br>• Logos : format miniature (48 x 48) et grand format (216 x 216) requis <br>•   Exigences relatives aux images de bannière : https://docs.microsoft.com/azure/marketplace/cloud-partner-portal-orig/cloud-partner-portal-solution-template-offer-publish <br>• Capture d’écran (5 maxi.) :  le CPP nécessite une image .png avec une résolution de 1 280 x 720. |
...
| 3 | Artefacts de la Place de marché | Les logos s’affichent correctement |<br>• Logo comportant une « image de premier plan » qui correspond à l’image grand format figurant sur le Portail Azure <br>• Logos : format miniature (48 x 48) et grand format (216 x 216) requis <br>• Exigences relatives aux images de bannière : https://docs.microsoft.com/azure/marketplace/cloud-partner-portal-orig/cloud-partner-portal-solution-template-offer-publish<br>• Capture d’écran (5 maxi.) :  le CPP nécessite une image .png avec une résolution de 1 280 x 720.|
...
|  | Élément de liste | Configuration de base requise | Configuration optimale |
|:--- |:--- |:--- |:--- |
| 1 | Titre de l’offre  |  <br>•  Doit indiquer clairement le type et la durée du service au format suivant : NOM : TYPE DE DURÉE. (par exemple, « Engagement pour l’offre : preuve de concept d’une semaine »)  | <br>•  Ne répète pas le nom de l’éditeur <br>•  Reflète le style de titre déjà disponible dans la description : vous ne voulez pas de titres longs. | 
