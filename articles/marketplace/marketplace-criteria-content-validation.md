...
| Number | Élément de liste | Condition requise de base | Condition requise optimale |
|:--- |:--- |:--- |:--- |
| 1 | Destination du prospect | La destination de prospect est configurée.| Le catalogue OCP (One Commercial Partner) contient les informations CRM de destination de prospect, qui sont également listées sous l’onglet de la solution partenaire. | 
...
| Number | Élément de liste | Condition requise de base | Condition requise optimale | 
|:--- |:--- |:--- |:--- |
| 1 | État du référencement (appel à l’action) | Le lien doit donner accès à l’expérience d’*essai gratuit* menée par le client. | D’autres appels à l’action (par exemple, *Acheter maintenant*) sont également disponibles. | 
...
| 8 | Catégories et secteurs d’activité | <ul><li>Les catégories et sous-catégories doivent correspondre aux fonctionnalités de l’offre.</li><li>Ne sélectionnez pas de catégories ou sous-catégories qui ne correspondent pas aux fonctionnalités de votre offre. </li><li>Ciblez un secteur d’activité et des secteurs verticaux si l’offre est spécifique à un secteur d’activité. Si l’offre n’est pas spécifique à un secteur d’activité, ne sélectionnez pas de secteur d’activité.</li></ul> | <ul><li>Sélectionnez jusqu’à deux (2) catégories, y compris une catégorie principale et une catégorie secondaire (facultatif).</li> <li>Sélectionnez jusqu’à deux (2) sous-catégories pour chaque catégorie principale et/ou secondaire. Si aucune sous-catégorie n’est sélectionnée, votre offre sera tout de même détectable sur la catégorie sélectionnée uniquement.</li> <li>Sélectionnez jusqu’à deux secteurs d’activité et deux secteurs verticaux par secteur d’activité sélectionné.</li></ul> |
...
* Apprenez-en davantage sur les différents types d’offre dans la Place de marché Azure :
  * [Applications SaaS](https://docs.microsoft.com/azure/marketplace/marketplace-saas-applications-technical-publishing-guide)
  * [Containers](https://docs.microsoft.com/azure/marketplace/marketplace-containers)
  * [Services de conseil](https://docs.microsoft.com/azure/marketplace/consulting-services)

* [Déterminer votre option de publication](https://docs.microsoft.com/azure/marketplace/determine-your-listing-type)
