---
title: Questions courantes concernant la migration vers l’Espace partenaires - Place de marché commerciale de Microsoft
description: Réponses aux questions fréquemment posées sur la migration des offres du portail Cloud Partner vers l’Espace partenaires.
author: anbene
...
ms.locfileid: "83727477"
---
# <a name="common-questions-about-migrating-from-the-cloud-partner-portal-to-partner-center"></a>Questions courantes au sujet de la migration du Portail Cloud Partner vers l’Espace partenaires
...
| **Payouts (Paiements)** | Les achats et les déploiements qui ont lieu pendant ou après la migration continuent à être payés normalement. |
...
Toutes les offres ont été migrées vers l’Espace partenaires. La période de migration de chaque offre doit être inférieure à 24 heures. Une fois votre offre migrée, vous devez avoir reçu une notification par courrier électronique.
