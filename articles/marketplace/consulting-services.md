...
Les partenaires doivent également avoir une **compétence Silver ou Gold** dans le domaine de leur service. Le tableau suivant répertorie les compétences éligibles :
...
|Pays éligibles |  |  |
|---------|---------|---------|
|Australie    |Allemagne         |Nouvelle-Zélande         |
...
Le référencement de votre offre de services de conseil sur la Place de marché Azure implique les étapes suivantes :

1. **Demande** : pour envoyer votre demande, utilisez le [formulaire de candidature pour la Place de marché Azure](https://azuremarketplace.microsoft.com/en-us/sell/nominate) et dites-nous en plus sur votre organisation. Remarque : Les éditeurs ne doivent envoyer la demande de candidature qu’une seule fois pour référencer leurs offres sur la Place de marché Azure ou AppSource. Une fois la demande de candidature et d’intégration terminée, un portail Cloud Partner est généré où les éditeurs peuvent créer et envoyer les référencements de leurs offres.
