...
Vous devez fournir des documents annexes précisant les détails de votre offre. Les équipes de vente Microsoft utilisent ces informations pour déterminer si votre offre répond aux besoins des clients, afin de recommander et de vendre votre offre. Plus vous fournissez d’informations, plus les équipes de ventes Microsoft pourront comprendre et promouvoir votre produit.

Les types de fichiers pris en charge sont .pdf, .ppt, .pptx, .doc, .docx, .xls, .xlsx, .jpg, .png et .mp4. Des modèles de certains documents sont fournis dans le tableau 2 ci-dessous.

> [!NOTE]
> La **page de solution/offre** et le **jeu de diapositives de la solution/offre** sont nécessaires pour atteindre le statut « Co-sell ready ». Ces éléments sont également prérequis pour que certaines offres soient considérées comme des offres de co-vente Azure IP avec incentives. Le diagramme de l’architecture de référence est également requis pour que l’offre devienne une offre de co-vente Azure IP avec incentives. Les autres documents décrits dans ce tableau sont facultatifs mais recommandés.

***Tableau 2 : documents qui prennent en charge la co-vente***

| **Documents**    | **Description**  |
| :------------------- | :-------------------|
| *Page de la solution/offre (obligatoire)* | Attirez l’attention des clients potentiels sur votre offre à l’aide d’une page de solution/offre de qualité professionnelle, qui présente la proposition de valeur de votre solution.<br><br>Vous pouvez utiliser l’un des modèles pour fournir une description prête à l’emploi de votre offre :<br><ul><li> [Modèle d'une page Microsoft Azure](https://aka.ms/Customer-One-Pager_MicrosoftAzure)</li><li>[Modèle d'une page Microsoft Dynamics 365](https://aka.ms/Customer-One-Pager_MicrosoftDynamics365)</li> <li>[Modèle d’une page Microsoft 365](https://aka.ms/Customer-One-Pager_MicrosoftOffice365) </li><li>[Modèle d'une page Windows 10](https://aka.ms/Customer-One-Pager_Windows)</li></ul> <br> Les équipes commerciales de Microsoft peuvent partager ces informations avec les clients afin de déterminer si votre offre est adaptée à leurs besoins et de s'assurer qu'elle est prête à l'emploi. |
| *Jeu de diapositives de la solution/offre (obligatoire)* | Vous pouvez utiliser le [modèle de présentation client](https://aka.ms/GTMServices_CustomerPresentation) pour créer votre jeu de diapositives. Ce jeu doit référencer le [diagramme de l’architecture de référence](reference-architecture-diagram.md). L’objectif de ce jeu de diapositives est de mettre en valeur votre offre et sa proposition de valeur. Après avoir vérifié que votre offre est prête à l’emploi, les équipes commerciales de Microsoft peuvent partager cette présentation avec les clients afin de mettre en avant la valeur que Microsoft et votre entreprise apportent lors du déploiement d’une solution conjointe. La présentation doit décrire la fonction de votre offre, expliquer ce qu’elle apporte aux clients, indiquer pour quels secteurs d’activité elle est pertinente et mettre en avant ses atouts par rapport aux solutions concurrentes. |
| *Étude de cas client* (facultatif)| Utilisez le [modèle d’étude de cas](https://aka.ms/GTM_Case_Study_Template) pour créer votre étude de cas client. Ces informations montrent à un client potentiel que Microsoft et vous avez déjà déployé votre offre avec succès pour d’autres clients. |
| *Succès clients vérifiables* (facultatif) | Fournissez des exemples concrets de succès clients découlant du déploiement de votre offre. |
| *Jeu de diapositives destiné aux partenaires* (facultatif) | Jeu de diapositives contenant des informations qui aident les revendeurs partenaires à en savoir plus sur votre offre et à préparer leurs équipes commerciales à la vendre. Ce jeu comprend généralement un argumentaire éclair, des informations sur la clientèle visée, les questions à poser aux clients, des points de discussion et des liens vers des vidéos, de la documentation et des informations de support. |
| *Diagramme de l’architecture de référence* (requis pour que l’offre devienne une offre de co-vente Azure IP avec incentives) | Diagramme qui représente votre offre et sa relation avec les services cloud Microsoft. Il peut également illustrer la façon dont votre offre répond aux exigences techniques d’une offre de co-vente Azure IP avec incentives. [En savoir plus sur le diagramme de l’architecture de référence.](reference-architecture-diagram.md) |
| *Autres documents* (facultatif) | Vous pouvez charger cinq documents ou vidéos supplémentaires pour aider les équipes de vente Microsoft et les revendeurs partenaires à en savoir plus sur votre offre, votre organisation, et en quoi votre offre se différencie de la concurrence. |
|||

- Après avoir créé vos documents, faites-les glisser vers la zone appropriée sous **Documents**, ou sélectionnez l’option pour **parcourir vos fichiers** et charger un document à partir de votre ordinateur.

    [![Montre la section sur la documentation de la co-vente de l’onglet Co-vendre avec Microsoft.](./media/co-sell/co-sell-documents-section.png)](./media/co-sell/co-sell-documents-section.png#lightbox)
