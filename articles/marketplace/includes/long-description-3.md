...
|   Nouvelle ligne sans nouveau numéro (ou puce)  |  `<ol> & </ol>, <li> & </li>, <br>`  |  `<ol>`<br>`<li>`ajoutez du texte ici`</li>`<br>`<li>`ajoutez du texte ici`<br>`ajouter du texte ici`</li>`<br>`</ol>`  |  1. ajoutez du texte ici<br>2. ajoutez du texte ici<br>&nbsp;&nbsp;&nbsp;&nbsp;ajoutez du texte ici   |
