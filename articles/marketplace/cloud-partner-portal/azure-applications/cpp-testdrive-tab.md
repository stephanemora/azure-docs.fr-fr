---
title: Version d’évaluation pour une offre d’application Azure | Microsoft Docs
...
Le tableau suivant décrit les champs requis pour configurer la version d’évaluation de votre application gérée.
