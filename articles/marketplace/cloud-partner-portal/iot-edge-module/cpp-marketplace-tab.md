...
- Lorsque vous parcourez les offres :

    ![Affichage des offres de la Place de marché sur le site web de la Place de marché Microsoft Azure - navigation](./media/iot-edge-module-ampdotcom-card.png)
...
- Lorsque vous recherchez une offre :
...
>[!Important]
>Une fois le logo de bannière chargée, il ne peut pas être supprimé.
...
>[!Note]
>Les informations relatives aux prospects doivent être gérées en continu, et ces paramètres doivent être immédiatement mis à jour quand des modifications sont apportées à votre architecture de gestion des clients.
...
| **Utiliser Contrat Standard\***  | Indique s’il faut ou non utiliser le modèle de contrat Microsoft standard.  Pour plus d’informations, consultez [Contrat Standard](https://docs.microsoft.com/azure/marketplace/standard-contract).   |
| **Conditions d’utilisation\***            | *Conditions d’utilisation* au format HTML simple inclus ou lien vers la page de vos conditions d’utilisation publiées     |
|  |  |


## <a name="next-steps"></a>Étapes suivantes

Utilisez l’onglet [Support](./cpp-support-tab.md) pour spécifier les ressources de support utilisateur et techniques associées à votre offre.
