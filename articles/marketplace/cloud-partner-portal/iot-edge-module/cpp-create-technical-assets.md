...
- Utilisez l’[onglet Place de marché](./cpp-marketplace-tab.md) pour ajouter un lien vers [IoT Edge Certified](https://catalog.azureiotsolutions.com/alldevices?filters={%2218%22:[%221%22]}), un site web sur lequel les clients peuvent parcourir ou rechercher des appareils certifiés. Ce site web est également appelé le catalogue d’appareils [Azure IoT Edge Certified](https://catalog.azureiotsolutions.com/).
