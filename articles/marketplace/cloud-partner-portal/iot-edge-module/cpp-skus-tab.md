---
title: Références SKU de modules Azure IoT Edge | Microsoft Docs
...
Le tableau suivant décrit l’objectif, le contenu et le format des champs sous **Détails de la référence SKU**.
...
Le tableau suivant décrit l’objectif, le contenu et le format des champs pour :
...
<br/> Sélectionnez **Enregistrer** pour enregistrer vos paramètres de référence SKU. 
