---
title: Se connecter à votre machine virtuelle Microsoft Azure | Place de marché Azure
...
L’article suivant explique comment utiliser la prise en charge intégrée de Windows RDP pour vous connecter à votre machine virtuelle : [Comment se connecter et ouvrir une session sur une machine virtuelle Azure exécutant Windows](../../../virtual-machines/windows/connect-logon.md).  
...
8. Lorsque vous y êtes invité, entrez le nom de compte et le mot de passe de votre compte de machine virtuelle Linux. 
   ...
   Si vous rencontrez des problèmes de connexion, consultez la documentation de votre client SSH, par exemple [chapitre 10 : Messages d’erreur courants](https://www.ssh.com/ssh/putty/putty-manuals/0.68/Chapter10.html#errors).
