...
| **Publisher**     | Identificateur unique de votre organisation dans la Place de marché Microsoft Azure. Votre ID d’éditeur doit être associé à toutes vos offres. Une fois l’offre enregistrée, cette valeur n’est pas modifiable. |
