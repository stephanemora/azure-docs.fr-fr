...
Vous devez à présent [générer un identificateur Uniform Resource Identifier (URI) pour chaque VHD](./cpp-get-sas-uri.md) que vous soumettez à la place de marché. 
