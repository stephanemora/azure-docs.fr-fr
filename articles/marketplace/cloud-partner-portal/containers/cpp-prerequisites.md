...
Si vous ne l’avez pas déjà fait, vous devez [préparer vos ressources techniques de conteneur](./cpp-create-technical-assets.md) avant de [créer votre offre de conteneur](./cpp-create-offer.md).  