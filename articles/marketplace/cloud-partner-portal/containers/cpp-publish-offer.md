---
title: Publier une offre d’image de conteneurs Azure | Microsoft Docs
...
ms.locfileid: "50980149"
---
# <a name="publish-container-offer"></a>Publier l’offre de conteneur

 Une fois que vous avez créé une offre à l’aide de la page **Nouvelle offre**, vous pouvez publier cette offre. Sélectionnez **Publier** pour démarrer le processus de publication.

Le schéma ci-après illustre les principales étapes du processus de publication d’une offre.

![Étapes pour publier l’offre de conteneur](./media/offer-publishing-steps.png)
...
[Mettre à jour une offre de conteneur existante dans Place de marché Azure](./cpp-update-existing-offer.md)
