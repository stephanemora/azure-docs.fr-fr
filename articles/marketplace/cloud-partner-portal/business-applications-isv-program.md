...
Pour s’inscrire et profiter de tous les avantages [techniques, marketing et commerciaux](https://partner.microsoft.com/en-us/solutions/business-applications/isv-overview) du programme Business Applications ISV Connect, nous demandons aux partenaires ISV existants (avec *Dynamics CE* et *Ops*) d’effectuer les étapes suivantes : 

 - [Configurez votre compte](#set-up-your-microsoft-partner-center-account) dans le programme Place de marché commerciale de l’Espace partenaires
 - [Acceptez les termes et conditions de participation](#sign-the-business-applications-isv-program-addendum) au programme Business Applications ISV Connect
 - [Spécifiez vos informations de facturation](#set-up-your-billing-information), et
 - [Recertifiez votre application](#recertify-your-application) dans Microsoft AppSource

> [!IMPORTANT]
> Vous devrez suivre toutes les étapes ci-dessus avant d'apporter des modifications à une offre existante (vos offres ne pourront pas être modifiées dans le *portail Cloud Partner* avant cette date).

## <a name="set-up-your-microsoft-partner-center-account"></a>Configurer votre compte Espace partenaires Microsoft

[Espace partenaires](https://partner.microsoft.com) est l'endroit où vous gérez les paramètres de votre compte pour le nouveau programme Business Applications ISV Connect.

> [!NOTE]
> Cette étape nécessite un rôle *Propriétaire* dans le portail Cloud Partner pour votre compte donné.

Si vous avez déjà publié des offres Dynamics CE et/ou Dynamics Ops, il est fort probable que votre compte Cloud Partner Portal (CPP) a déjà été migré et activé sur l’Espace partenaires. Sinon, vous pouvez manuellement activer votre compte Espace partenaires à partir de votre profil d'éditeur CPP.
...
Pour plus d'informations, voir [*Migration de compte du Portail Cloud Partner vers l’Espace partenaires*](../partner-center-portal/account-migration-from-cpp-to-pc.md).

## <a name="sign-the-business-applications-isv-program-addendum"></a>Signer l'addenda du Programme Business Applications ISV
...
1. Rendez-vous sur https://partner.microsoft.com/dashboard/account/agreements (et connectez-vous à l’Espace partenaires, comme demandé).

2. Sous le titre **Place de marché Azure commerciale**, localisez **Microsoft Business Applications ISV Addendum** .
...
Après avoir effectué les étapes ci-dessus, vos offres Dynamics 365 CE et Dynamics 365 Ops existantes pourront être modifiées dans le portail Cloud Partner (vous devrez éventuellement actualiser la page). Vous pouvez également créer des offres via le portail Cloud Partner.
...
1. [Suivez les étapes](https://partner.microsoft.com/en-us/solutions/business-applications/isv-publish) pour recertifier votre application auprès d’AppSource.

2. [Créez et publiez une nouvelle offre](manage-offers/cpp-manage-offers.md) sur le portail Cloud Partner. Il s'agit d’une toute nouvelle offre qui ne remplace aucune offre existante.
