...
Utilisez l’onglet **Contacts** pour fournir les informations de support client et technique pour votre offre Dynamics 365 for Customer Engagement.

![Onglet Contacts de l’offre](./media/dynce-contacts-tab.png)
...
Une fois que vous avez vérifié avoir les [ressources techniques](./cpp-create-technical-assets.md) nécessaires à votre offre, vous êtes prêt à [publier l’offre Dynamics 365 for Customer Engagement](./cpp-publish-offer.md).
