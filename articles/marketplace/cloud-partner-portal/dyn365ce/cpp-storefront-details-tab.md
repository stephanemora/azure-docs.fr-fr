---
title: Dynamics 365 for Customer Engagement offre l’onglet Détails de vitrine | Place de marché Azure
...
Où le tableau suivant décrit les champs de cet onglet. Les champs obligatoires sont indiqués par un astérisque (*). 
...
|  Masquer la clé\*           | Clé secrète combinée à l’URL de l’offre pour vous permettre d’afficher un aperçu de l’offre avant sa mise en ligne.  Cette clé n’est *pas* un mot de passe.  Elle peut contenir uniquement des caractères alphanumériques.  |
|  |  |
...
|      Champ            |    Description                 |
|  ---------------      |  ---------------               |
| Logo (format png, 48 x 48) de l’offre\* | Chargez une image qui sera affichée dans la page de recherche de votre application. Elle doit être au format PNG et avoir une taille de 48 x 48 pixels. |
...
|      Champ            |    Description                 |
|  ---------------      |  ---------------               |
| URL de stratégie de confidentialité\*    | URL de la politique de confidentialité en ligne pour votre application.  |
