---
title: Offre de services de conseil Azure et Dynamics 365 - Conditions préalables | Microsoft Docs
description: Guide consacré aux conditions préalables à la publication d’une offre de services de conseil Azure ou Dynamics 365 sur le portail Cloud Partner.
...
ms.locfileid: "58011752"
---
# <a name="consulting-service-prerequisites"></a>Conditions préalables à la publication d’un service de conseil

Passez en revue la description d’et le type de la configuration requise pour cette offre dans [Consulting Services pour Azure Marketplace et AppSource](../../consulting-services.md).  Les types de services de conseil spécifiques suivants ont des exigences supplémentaires :
...
Une fois que vous avez rempli les conditions requises ci-dessus, vous êtes prêt à [créer une offre de services de conseil](./cpp-consulting-service-create-offer.md).
