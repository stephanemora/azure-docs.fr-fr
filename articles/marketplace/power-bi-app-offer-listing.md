---
title: Configurez les détails de liste d’offre de l’application Power BI sur Microsoft AppSource (place de marché Azure)
description: Configurez les détails de liste d’offre de l’application Power BI sur Microsoft AppSource (place de marché Azure).
...
ms.locfileid: "110631580"
---
# <a name="configure-power-bi-app-offer-listing-details"></a>Configurer Power BI détails de la liste des offres d’application

Cette page vous permet de définir les détails de l’offre, notamment le nom de l’offre, la description, les liens, les contacts, les logos et les captures d’écran qui apparaîtront sur Microsoft AppSource.
...
:::image type="content" source="media/power-bi/example-power-bi-app.png" alt-text="Illustre la façon dont cette offre s’affiche dans Microsoft AppSource.":::
...
1. Nom de l’offre
1. Résumé des résultats de recherche
1. Description
...
Fournissez ici jusqu’à trois documents marketing associés au format PDF, comme des livres blancs, des brochures, des listes de contrôle ou des présentations (optionnel).
...
Ajoutez jusqu’à quatre vidéos facultatives qui illustrent votre offre. Elles doivent être hébergées sur un service vidéo externe. Entrez le nom, l’adresse web et une image miniature PNG de 1280 x 720 pixels de chaque vidéo.
...
- [Configuration technique de l'offre](power-bi-app-technical-configuration.md)
