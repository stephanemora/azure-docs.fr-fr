...
**Les types de produits sont actuellement disponibles dans la place de marché Azure ?**
...
**Puis-je choisir les régions Microsoft Azure pour déployer mon bon de place de marché Azure ?**

Le client a la possibilité de déployer vers n’importe quelle région de centre de données Azure ils permettent. Nous vous recommandons de choisir les centres de données situés à proximité de vos services pour optimiser les performances et maîtriser votre budget.

**Si je supprime accidentellement un achat effectué dans la place de marché Azure, puis-je « annuler » l’action ?**
...
**Suis averti si je tente de supprimer un achat effectué dans la place de marché Azure qui est en cours d’utilisation par un de mes applications ?**
...
**Si mon fournisseur de place de marché Azure a des dépendances sur d’autres ressources comme un site Web Azure, dois-je les gérer ?**
...
Si le serveur de publication a configuré son offre toujours disponibles via le canal CSP, il sera disponible auprès de votre revendeur.

**Dans quels pays sont pris en charge pour l’achat d’applications et services approvisionnés/vendus via la place de marché Azure ?**
...
**J’ai déployé une Machine virtuelle de la place de marché Azure (VM) à un abonnement, et je souhaite maintenant migrer l’abonnement d’un compte Azure à un autre. Est-ce possible ?**
...
**Comment dois-je fournir ma clé de licence de logiciel pour les solutions de la place de marché BYOL et quel rôle joue la place de marché Azure ?**
...
**Quelle est la différence entre « Version d’évaluation gratuite » et « Essai logiciel gratuit » ?**
...
**Dois-je avoir un instrument de paiement (par exemple, carte de crédit) sur le fichier pour déployer le niveau gratuit ou apportez vos propres offres de licence (BYOL) ?**
...
**S’ils ont des questions sur la tarification des offres commercialisées via la place de marché Azure, qui contacter un client indirects contrat entreprise (EA) ?**
...
**Puis-je appliquer des crédits d’abonnement Azure ou prépayé dans mon compte à mes achats Azure Marketplace offre ?**
...
**Comment régler ces abonnements ? Mes achats Azure Marketplace apparaissent sur la facture Azure, ou existe-t-il une facture distincte ?**
...
**Comment annuler un module complémentaire de place de marché Azure pour la machine virtuelle Azure ?**
...
**La fréquence de facturation les achats effectués dans mon place de marché Azure ?**
...
**Quelle est la différence entre « price », « tarif logiciel » et « tarif total » dans la structure de coûts pour la Machine virtuelle offre dans la place de marché Azure ?**
...
**Puis-je appliquer des crédits d’abonnement Azure ou des fonds monétaires sur mon compte à mes achats de produits et services requis pour exécuter les offres place de marché Azure ?**
...
**Qui contacter pour la prise en charge/questions sur la facturation concernant une solution tierce acheté à partir de la place de marché ?**
...
**Existe-t-il un forum de support pour Azure Marketplace ?**
...
**Qui permet aux éditeurs nécessite une inscription de compte Centre de développement ?**
...
**Pourquoi est-un compte Centre de développement requis ?**
...
**Comment pour démarrer avec l’inscription au centre de développement ?**
...
**À quoi dois-je attendre après l’inscription ?**

Recherchez un e-mail provenant de verify@microsoft.com avec pour ligne d’objet « Action nécessaire : Vérifiez votre compte qui a reçu l’e-mail avec Microsoft ». Pour terminer l’inscription, cliquez sur le lien de vérification soumis à une contrainte de temps. Si aucun e-mail n’a été reçu dans les 24 heures, vérifiez le dossier du courrier indésirable.

**Quelles sont les étapes suivantes après vérification du centre de développement ?**
...
**Pourquoi mon application de centre de développement est rejetée ?**
...
**Comment contacter le support des problèmes concernant l’inscription au centre de développement ?**
...
**Pourquoi publier mon application sur place de marché Azure et comment il bénéficie-t-il moi ?**
...
**Quel est le facteur différenciant Azure Marketplace et AppSource ?**
...
**Que dois-je attendre après la soumission de mon inscription à publier dans la place de marché Azure ?**
...
**Quel est le critère pour publier une solution dans la place de marché Azure ?**
...
**Où trouver des instructions pour l’intégration de mon application avec Azure Active Directory (AAD) ?**
...
**Pourquoi est-compte Centre de développement requis ?**
...
**Quelles sont les prospects et pourquoi sont-elles importantes pour moi en tant qu’éditeur sur place de marché ?**
...
**Où puis-je obtenir de l’aide de la configuration de mon destination de prospect ?**
...
**Suis-je obligé de configurer une destination de prospect pour publier une offre sur la place de marché ?**
...
**Comment puis-je vérifier que la configuration de prospect est correcte ?**
...
**Comment supprimer une liste à partir de la place de marché Azure ?**
...
Web Apps (applications SaaS, module complémentaire) et services de conseil :
...
**Où les solutions de la Place de marché sont-elles promues au sein des propriétés web de Microsoft ?**
...
**Comment recevoir le paiement relatif à Mes ventes de la place de marché Azure ?**
...
**Pour les solutions des machines virtuelles achetées avec la facturation basée sur l’utilisation, lorsqu’un client à distance-sizes ou réduit la Machine virtuelle sous-jacente, la tarification de ma licence de logiciel suit ?**
...
**Est par nœud de facturation disponible pour Azure Marketplace ?**
...
**Existe-t-il des avertissements, si j’essaie de supprimer un achat effectué dans la place de marché Azure utilisé par l’une de mes applications ?**

Non, Azure ne vous avertit pas quand vous choisissez de supprimer un achat dont dépend votre application.

**Si mon fournisseur de place de marché Azure a des dépendances sur d’autres ressources comme un site Web Azure, puis dois-je les gérer ?**
...
**J’ai déployé une Machine virtuelle de la place de marché Azure (VM) à un abonnement, et je souhaite maintenant migrer cet abonnement à partir d’un seul compte Azure à un autre. Est-ce possible ?**
...
* **Tarif mensuel** : Des frais fixes vous sont facturés chaque mois pour l’abonnement à l’offre, à compter de la date de début de l’abonnement à ce plan. Le tarif mensuel peut être calculé au prorata en cas d’annulation en cours de mois ou de services non utilisés.
...
**Comment régler ces abonnements ? Mes achats Azure Marketplace apparaissent sur la facture Azure, ou il existe une facture distincte ?**
...
**Commet annuler un complément de la Place de marché Azure ajouté à une machine virtuelle Azure ?**
...
**Puis-je appliquer des crédits d’abonnement Azure ou prépayé de mon compte vers les produits et services, qui sont requis pour exécuter les offres place de marché Azure ?**
...
Pour tout support technique concernant un produit, contactez son éditeur sur la Place de marché Microsoft Azure. Les coordonnées des éditeurs et/ou un lien vers le site web de support se trouvent sur la page des détails de la solution.
