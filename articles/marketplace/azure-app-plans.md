---
title: Créer des plans pour une offre Azure Application
description: Créez des plans pour une offre Azure Application dans l’Espace partenaires (Place de marché Azure).
author: aarathin
ms.author: aarathin
...
ms.locfileid: "111542500"
---
# <a name="create-plans-for-an-azure-application-offer"></a>Créer des plans pour une offre Azure Application
...
#### <a name="to-re-use-a-technical-configuration"></a>Pour réutiliser la configuration technique
...
- [Configurer un plan de modèle de solution](azure-app-solution.md)
- [Configurer un plan d’application managée](azure-app-managed.md)
