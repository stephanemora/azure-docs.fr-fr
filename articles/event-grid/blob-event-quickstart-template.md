...
* **Microsoft.Storage/storageAccounts** : crée un compte de stockage Azure.
* **"Microsoft. Storage/storageAccounts/Providers/eventSubscriptions** : crée un abonnement Azure Event Grid pour le compte de stockage. 
...
1. Sélectionnez le lien suivant pour vous connecter à Azure et ouvrir un modèle. Le modèle crée un coffre de clés et un secret.
    ...
    [Déployer dans Azure](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F101-event-grid-subscription-and-storage%2Fazuredeploy.json)
