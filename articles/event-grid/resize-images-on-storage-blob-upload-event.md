...
Maintenant, vous devez configurer l’application de fonction pour vous connecter au compte de stockage d’objets blob que vous avez créé dans le [tutoriel précédent][previous-tutorial].
