...
Pour obtenir une description détaillée des champs disponibles, de leur type et de leur définition, consultez [CloudEvents v1.0](https://github.com/cloudevents/spec/blob/v1.0/spec.md#required-attributes).
...
| Rubriques/domaines utilisateur | Schéma personnalisé     | Schéma personnalisé, schéma Event Grid ou schéma CloudEvent
