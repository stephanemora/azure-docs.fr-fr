---
title: Azure Communication Services - Événements de conversation
description: Cet article explique comment utiliser Azure Communication Services comme source d’événement Event Grid pour les événements de conversation.
ms.topic: conceptual
ms.date: 10/15/2021
ms.author: vikramdh
...
ms.locfileid: "130134313"
---
# <a name="azure-communication-services---chat-events"></a>Azure Communication Services - Événements de conversation

Cet article décrit les propriétés et le schéma des événements de conversation Communication Services.  Pour une présentation des schémas d’événements, consultez [Schéma d’événements Azure Event Grid](event-schema.md).

## <a name="event-types"></a>Types d’événements

Azure Communication Services émet les types d’événements de conversation suivants :
