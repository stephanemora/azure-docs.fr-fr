---
title: Exemple de script Azure PowerShell - S’abonner à un compte de stockage blob | Microsoft Docs
description: Exemple de script Azure PowerShell - S’abonner à un compte de stockage blob
services: event-grid
