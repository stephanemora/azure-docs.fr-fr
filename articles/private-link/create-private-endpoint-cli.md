...
Dans cette section, vous allez créer et configurer la zone DNS privée au moyen de [az network private-dns zone create](/cli/azure/network/private-dns/zone#az_network_private_dns_zone_create).  

Vous utiliserez [az network private-dns link vnet create](/cli/azure/network/private-dns/link/vnet#az_network_private_dns_link_vnet_create) pour créer le lien de réseau virtuel vers la zone DNS.
