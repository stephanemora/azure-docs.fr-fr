...
Pour obtenir des détails sur votre service de Private Link [New-AzPrivateLinkService](/powershell/module/az.network/get-azprivatelinkservice), procédez comme suit :
