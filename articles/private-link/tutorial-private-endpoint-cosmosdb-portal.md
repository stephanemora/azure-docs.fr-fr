...
description: Commencez avec un point de terminaison privé Azure pour vous connecter en privé à un compte Azure Cosmos.
author: asudbring
ms.author: allensu
...
2. Sous l’onglet **Informations de base** de la page **Créer un compte Cosmos DB**, entrez ou sélectionnez les informations suivantes :
    ...
    | Géoredondance | Conservez la valeur **Désactiver** par défaut. |
...
12. Dans l’Explorateur Stockage, cliquez avec le bouton droit de la souris sur **Comptes Cosmos DB**, puis sélectionnez **Se connecter à Cosmos DB**.
