...
> [!NOTE]
> Les balises de service Azure indiquent les préfixes d’adresse du cloud spécifique utilisé. Les balises de service régionales ne sont pas prises en charge sur les clouds nationaux, qui ne prennent en charge que le format global (par exemple : Storage, Sql).
