...
\* = Le niveau se rapporte à la fonctionnalité [Équilibreur de charge interrégion](https://docs.microsoft.com/azure/load-balancer/cross-region-overview), actuellement en préversion.
