...
4. Entrez ou sélectionnez des valeurs pour les paramètres suivants et, sous **Créer une adresse IP publique**, sélectionnez **Créer** :
   ...
   |Subscription|OUI|Doit exister dans le même [abonnement](../azure-glossary-cloud-terminology.md?toc=%2fazure%2fvirtual-network%2ftoc.json#subscription) que la ressource à laquelle vous voulez associer l’adresse IP publique.|
   ...
   |Location|OUI|Doit exister au même [emplacement](https://azure.microsoft.com/regions) (également appelé région) que la ressource à laquelle vous voulez associer l’adresse IP publique.|
