...
4. Entrez ou sélectionnez des valeurs pour les paramètres suivants et, sous **Créer une adresse IP publique**, sélectionnez **Créer** :
   ...
   |Subscription|Oui|Doit exister dans le même [abonnement](../azure-glossary-cloud-terminology.md?toc=%2fazure%2fvirtual-network%2ftoc.json#subscription) que la ressource à laquelle vous allez associer l’adresse IP publique.|
