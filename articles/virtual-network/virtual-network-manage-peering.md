...
5. Modifiez le paramètre approprié. En savoir plus sur les options de chaque paramètre dans [étape 5](#add-peering) de créer une homologation.
...
- **PowerShell** : [Get-AzVirtualNetworkPeering](/powershell/module/az.network/get-azvirtualnetworkpeering) pour afficher les paramètres de l’homologation et [Set-AzVirtualNetworkPeering](/powershell/module/az.network/set-azvirtualnetworkpeering) pour modifier les paramètres.
...
Si vous souhaitez que les réseaux virtuels communiquent occasionnellement, au lieu de supprimer une homologation, vous pouvez définir le paramètre **Autoriser l’accès au réseau virtuel** sur **Désactivé**. Pour en savoir plus, consultez l’étape 6 de la création d’une section de l’homologation de cet article. Il se peut que vous trouviez plus facile de désactiver et activer l’accès réseau que de supprimer et recréer des homologations.
