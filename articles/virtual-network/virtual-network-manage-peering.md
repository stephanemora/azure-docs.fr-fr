...
* <a name="cross-region"></a>Vous pouvez homologuer des réseaux virtuels dans la même région ou dans différentes régions. Les contraintes suivantes ne s’appliquent pas lorsque les deux réseaux virtuels sont dans la *même* région, mais elles s’appliquent lorsque les réseaux virtuels sont dans des régions *différentes* : 
    - Les réseaux virtuels ne peuvent exister que dans les régions suivantes : Corée du Sud, Royaume-Uni Sud, Royaume-Uni Ouest, Est du Canada, Inde Sud, Inde Centre, Inde Ouest, États-Unis Centre-Ouest, Centre du Canada, Ouest des États-Unis 2.
