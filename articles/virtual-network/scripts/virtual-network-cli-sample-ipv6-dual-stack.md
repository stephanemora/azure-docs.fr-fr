...
ms.locfileid: "107776467"
---
# <a name="configure-ipv6-endpoints-in-virtual-network-script-sample"></a>Exemple de script de configuration de points de terminaison IPv6 dans un réseau virtuel
