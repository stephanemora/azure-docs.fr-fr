...
* Déployez des machines virtuelles proches les unes des autres pour une faible latence avec un [groupe de placement de proximité](../virtual-machines/co-location.md)
