...
* **Homologation de réseau virtuel (VNet)**  : lorsque vous créez un peering de réseau virtuel entre deux réseaux virtuels, un itinéraire est ajouté pour chaque plage d’adresses dans l’espace d’adressage de chaque réseau virtuel pour laquelle un peering est créé. En savoir plus sur le [peering de réseaux virtuels](virtual-network-peering-overview.md).<br>
