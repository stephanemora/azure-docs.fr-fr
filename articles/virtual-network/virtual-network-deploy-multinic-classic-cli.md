---
title: Créer une machine virtuelle (classique) avec plusieurs cartes réseau - Azure Classic CLI | Microsoft Docs
description: Découvrez comment créer une machine virtuelle (classique) avec plusieurs cartes réseau à l’aide de l’interface de ligne de commande (CLI) Azure Classic.
