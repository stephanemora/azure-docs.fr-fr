...
**Conseils** : Activez l’authentification multifacteur (MFA) Azure Active Directory (Azure AD) et suivez les recommandations relatives à la gestion des identités et des accès dans Security Center.
...
### <a name="46-use-role-based-access-control-to-manage-access-to-resources"></a>4.6 : Utiliser le contrôle d’accès en fonction du rôle pour gérer l’accès aux ressources 
