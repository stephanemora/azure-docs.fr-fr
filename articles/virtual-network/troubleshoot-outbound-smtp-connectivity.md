...
Si vous utilisez des ressources Azure par le biais d’un fournisseur de solutions cloud, vous pouvez effectuer une demande de suppression de la restriction dans la section **Impossible d’envoyer un e-mail (SMTP/Port 25)** du panneau **Diagnostiquer et résoudre** pour une ressource de réseau virtuel dans le portail Azure. Si votre demande est acceptée, votre abonnement sera activé ou vous recevrez des instructions pour les étapes suivantes.
