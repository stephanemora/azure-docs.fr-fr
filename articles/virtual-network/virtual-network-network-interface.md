...
ms.locfileid: "72168579"
---
# <a name="create-change-or-delete-a-network-interface"></a>Create, change, or delete a network interface
...
## <a name="create-a-network-interface"></a>Create a network interface
...
## <a name="view-network-interface-settings"></a>View network interface settings
...
## <a name="enable-or-disable-ip-forwarding"></a>Enable or disable IP forwarding
...
## <a name="change-subnet-assignment"></a>Change subnet assignment
...
## <a name="add-to-or-remove-from-application-security-groups"></a>Add to or remove from application security groups
...
## <a name="associate-or-dissociate-a-network-security-group"></a>Associate or dissociate a network security group
...
## <a name="delete-a-network-interface"></a>Delete a network interface
...
## <a name="resolve-connectivity-issues"></a>Resolve connectivity issues
...
### <a name="view-effective-security-rules"></a>View effective security rules
...
### <a name="view-effective-routes"></a>View effective routes
