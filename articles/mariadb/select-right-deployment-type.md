---
title: Sélection du type de déploiement adapté à Azure Database for MariaDB
...
|            | Azure Database for MariaDB | MariaDB sur des machines virtuelles Azure    |
|:-------------------|:-----------------------------|:--------------------|
