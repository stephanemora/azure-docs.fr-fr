...
3. Activez la journalisation binaire.
    ...
    Pour vérifier que la journalisation binaire est activée sur le serveur principal, entrez la commande suivante :
...
5. Créez un nouveau rôle de réplication et définir des autorisations.
...
7. Obtenez le nom actuel du fichier du journal binaire et le décalage.
...
8. Obtenez la position de l'identificateur GTID (facultatif, requis pour la réplication avec GTID).
