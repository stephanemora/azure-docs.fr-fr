...
description: Découvrez le service Azure Database for MariaDB, un service de bases de données relationnelles dans le cloud Microsoft qui repose sur l’édition communautaire de MariaDB.
author: savjani
ms.author: pariks
ms.service: mariadb
ms.topic: overview
...
- Pour donner votre avis ou demander de nouvelles fonctionnalités, créez une entrée via le [Forum de commentaires Azure](https://feedback.azure.com/d365community/forum/8f6502f1-ed24-ec11-b6e6-000d3a4f0da0).
