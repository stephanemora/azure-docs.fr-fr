...
Une fois que le Gestionnaire de QnA Maker sélectionne le compte, l’administrateur Active Directory recevra une notification qu’il doit autoriser l’accès de l’application (pas le Gestionnaire de QnA Maker) à la ressource Sharepoint QnA Maker. Le Gestionnaire d’Active Directory devez procéder ainsi pour chaque ressource de Sharepoint, mais pas tous les documents dans cette ressource. 
