...
Consultez la documentation sur les [Limites d’une API prédéfinie](../limits.md#prebuilt-question-answering-limits) 

## <a name="prebuilt-api-reference"></a>Référence de l’API prédéfinie
Pour comprendre les paramètres d’entrée et de sortie requis pour appeler l’API, consultez la documentation de [Référence de l’API prédéfinie](/rest/api/cognitiveservices-qnamaker/qnamaker5.0preview2/prebuilt/generateanswer).