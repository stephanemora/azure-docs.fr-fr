...
|`QNAMAKER_HOST`|`endpoint`|`https://your-resource-name.api.cognitive.microsoft.com` : Remplacer le sous-domaine `your-resource-name` par la valeur du nom de votre ressource|
||||
