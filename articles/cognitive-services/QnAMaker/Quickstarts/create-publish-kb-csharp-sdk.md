...
Remplacez la variable **Endpoint**, `<your-custom-domain>`, par le nom de votre domaine personnalisé. Cet emplacement est mentionné dans la page **Vue d’ensemble** de votre ressource QnA Maker dans le portail Azure.
