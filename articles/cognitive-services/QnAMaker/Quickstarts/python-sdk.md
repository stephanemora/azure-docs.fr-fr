...
|`QNAMAKER_HOST`|`host`|`https://your-resource-name.api.cognitive.microsoft.com` : Remplacer `your-resource-name` par votre propre nom de ressource|
||||
