...
1. Vous devez disposer de la bibliothèque [apache httpclient](https://hc.apache.org/downloads.cgi). Par exemple, téléchargez le client HTTP binaire 4.x.x.tar.gz pour rechercher tous les fichiers jar dont vous avez besoin pour l’importation dans votre projet.
