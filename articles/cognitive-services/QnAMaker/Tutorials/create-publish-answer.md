...
Si vous voulez limiter la réponse aux seules questions, ajoutez la propriété `[rankerType](Learn more about [rankerType](../concepts/best-practices.md#choosing-ranker-type).
)` au corps, par exemple : 
