...
* Pour les **fichiers**, utilisez l'objet [FileDTO](/javascript/api/@azure/cognitiveservices-qnamaker/filedto). FileDTO contient le nom de fichier et l’URL publique d’accès au fichier.
