...
* **Chaîne de connexion**  : Consultez [Afficher et copier une chaîne de connexion](../../storage/common/storage-account-keys-manage.md?tabs=azure-portal&toc=%252fazure%252fstorage%252ftables%252ftoc.json#view-account-access-keys) pour plus d’informations sur la façon de récupérer la chaîne de connexion à partir du Stockage Table Azure.
