...
| [API Speech Service](../../speech-service/speech-container-howto.md?tab=ntts) | Synthèse vocale neuronale | `containerpreview.azurecr.io/microsoft/cognitive-services-custom-text-to-speech` |
