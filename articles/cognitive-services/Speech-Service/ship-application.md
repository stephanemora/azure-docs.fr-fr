---
title: Azure Cognitive Services, documentation sur les API Kit de développement logiciel (SDK) Speech de Cognitive Services - Didacticiels, Informations de référence de l’API | Microsoft Docs
