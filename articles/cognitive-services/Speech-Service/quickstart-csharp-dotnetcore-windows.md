---
title: 'Démarrage rapide : reconnaissance vocale dans C# sous .NET Core sur Windows à l’aide du kit de développement logiciel (SDK) Cognitive Services Speech | Microsoft Docs'
