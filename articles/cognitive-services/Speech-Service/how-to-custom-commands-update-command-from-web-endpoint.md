...
Pour cet exemple, vous avez besoin d’une [fonction Azure](https://docs.microsoft.com/azure/azure-functions/) déclenchée par HTTP, qui prend en charge l’entrée suivante (ou un sous-ensemble de cette entrée) :
