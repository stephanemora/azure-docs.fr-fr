...
> [!NOTE]
> Vous pouvez créer des voix personnalisées sur la page du projet Custom Voice. Sélectionnez le lien **Speech Studio**, puis **Custom Voice** pour commencer.
