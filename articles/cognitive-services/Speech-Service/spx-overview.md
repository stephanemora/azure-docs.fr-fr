...
* Traduction vocale : traduisez de l’audio dans une langue source en texte dans une langue cible.

* Exécuter sur des ressources de calcul Azure : envoyer des commandes SPX à exécuter sur une ressource de calcul Azure distante à l’aide de `spx webjob`.

## <a name="get-started"></a>Bien démarrer

Pour commencer à utiliser l’interface de ligne commande Speech, consultez [l’article de base](spx-basics.md). Cet article explique comment exécuter certaines commandes de base avec SPX et affiche également des commandes légèrement plus avancées pour l’exécution d’opérations par lot pour la reconnaissance vocale et la synthèse vocale. Après avoir lu l’article de base, vous devez disposer d’une connaissance suffisante de la syntaxe SPX pour commencer à écrire des commandes personnalisées ou automatiser des opérations Speech simples.
