---
title: 'Démarrage rapide : Assistant vocal personnalisé, Java (Android) - Service de reconnaissance vocale'
titleSuffix: Azure Cognitive Services
description: Découvrir comment créer une application d’assistant vocal dans Java sur Android à l’aide du Kit de développement logiciel (SDK) Speech
...
ms.locfileid: "74111795"
---
# <a name="quickstart-create-a-voice-assistant-in-java-on-android-by-using-the-speech-sdk"></a>Démarrage rapide : Créer un assistant vocal dans Java sur Android à l’aide du Kit de développement logiciel (SDK) Speech

Un guide de démarrage rapide est également disponible pour la [reconnaissance vocale](~/articles/cognitive-services/Speech-Service/quickstarts/speech-to-text-from-microphone.md?pivots=programming-language-java&tabs=android) et la [synthèse vocale](~/articles/cognitive-services/Speech-Service/quickstarts/text-to-speech.md?pivots=programming-language-java&tabs=android).

Dans cet article, vous allez créer un assistant vocal avec Java pour Android à l’aide du [Kit de développement logiciel (SDK) Speech](speech-sdk.md). Cette application se connecte à un bot que vous avez déjà créé et configuré avec le [canal Direct Line Speech](https://docs.microsoft.com/azure/bot-service/bot-service-channel-connect-directlinespeech). Elle envoie ensuite une demande de voix au bot et présente une activité de réponse vocale.
...
1. Dans le même fichier, remplacez les chaînes de configuration par vos ressources :
    ...
    * Remplacez `YourServiceRegion` par la [région](regions.md) associée à votre abonnement. Seul un sous-ensemble de régions Speech Services sont actuellement prises en charge avec Direct Line Speech. Pour plus d’informations, consultez la page sur les [régions](regions.md#voice-assistants).
