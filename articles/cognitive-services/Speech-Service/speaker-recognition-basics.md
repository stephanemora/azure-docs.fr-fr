---
title: Principes de base de la reconnaissance de l’orateur - Service Speech
titleSuffix: Azure Cognitive Services
description: Découvrez comment utiliser le SDK Speech pour répondre à la question « qui parle ». Dans cet article, découvrez les modèles de conception courants pour travailler avec la vérification et l’identification de l’orateur.
...
ms.locfileid: "84632296"
---
# <a name="learn-the-basics-of-speaker-recognition"></a>Découvrir les principes de base de la reconnaissance de l’orateur

Dans cet article, découvrez les modèles de conception de base pour la reconnaissance de l’orateur à l’aide du SDK Speech, notamment :
