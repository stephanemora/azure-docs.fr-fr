---
title: Guide pratique pour sélectionner un périphérique d’entrée audio avec le SDK Speech - Services Speech
...
En C#, vous pouvez utiliser la bibliothèque [NAudio](https://github.com/naudio/NAudio) pour accéder à l’API CoreAudio et énumérer les périphériques comme suit :
...
Voici un exemple d’ID de périphérique : `{0.0.1.00000000}.{5f23ab69-6181-4f4a-81a4-45414013aac8}`.
...
Voici un exemple d’ID de périphérique : `\\\\?\\SWD#MMDEVAPI#{0.0.1.00000000}.{5f23ab69-6181-4f4a-81a4-45414013aac8}#{2eef81be-33fa-4800-9670-1cd474972c3f}`.
...
Par exemple, l’UID pour le microphone intégré est `BuiltInMicrophoneDevice`.
