...
Consultez la liste complète des [langues prises en charge](supported-languages.md) dans les modèles de langage de **reconnaissance vocale** personnalisés.
