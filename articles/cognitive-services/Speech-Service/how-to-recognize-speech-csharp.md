...
description: >
  Présente différentes façons d’effectuer une reconnaissance vocale (à partir d’un fichier, à partir d’un micro, avec un modèle personnalisé, en continu ou en une seule fois) à l’aide du kit de développement logiciel (SDK) Speech pour C#.
...
Recherchez le code dans cet article dans le dossier `samples/csharp/sharedcontent/console`.
