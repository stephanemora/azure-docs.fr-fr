...
> [Visitez l’exemple d’application de l’Assistant vocal UWP pour obtenir des exemples et des procédures de code](windows-voice-assistants-faq.yml#the-uwp-voice-assistant-sample)
