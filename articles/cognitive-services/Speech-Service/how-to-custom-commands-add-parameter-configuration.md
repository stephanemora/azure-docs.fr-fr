...
1. Dans la fenêtre **Nouvelle validation**, configurez la validation comme suit, puis sélectionnez **Créer**.
    ...
    | Réponse d'échec |  Éditeur simple > Première variation > `Sorry, I can only set temperature between 60 and 80 degrees` | Inviter à demander une nouvelle valeur en cas d'échec de la validation |
