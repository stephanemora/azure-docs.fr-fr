...
- [L’interface de ligne de commande Azure Speech](https://github.com/msimecek/Azure-Speech-CLI), pour interagir avec le service Speech à partir de la ligne de commande ou d’un workflow automatisé.
