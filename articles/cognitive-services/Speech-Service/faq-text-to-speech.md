...
Si vous ne trouvez pas de réponses à vos questions dans ce forum aux questions, consultez [d’autres options d’assistance](support.md).
...
**R** : Les modèles ne peuvent pas être téléchargés et exécutés localement.
