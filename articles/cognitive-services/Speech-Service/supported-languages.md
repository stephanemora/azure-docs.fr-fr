...
L’API de reconnaissance vocale Microsoft prend en charge les langues suivantes. 
  ...
  Code | Langage | Adaptation acoustique | Adaptation de langage | Adaptation de prononciation
 ------|----------|---------------------|---------------------|-------------------------
 ...
 fr-FR | Français (France) | Non  | Oui | Non 
 zh-CN | Chinois (mandarin, simplifié) | Non  | Oui | Non 
...
en-AU | Anglais (Australie) | Féminin | « Voix de synthèse vocale pour le service Speech Microsoft Server (en-AU, Catherine) »
