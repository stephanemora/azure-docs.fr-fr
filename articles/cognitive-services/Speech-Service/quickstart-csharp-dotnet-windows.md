---
title: 'Démarrage rapide : reconnaissance vocale dans C# sous .NET Framework sur Windows à l’aide du kit de développement logiciel (SDK) Cognitive Services Speech | Microsoft Docs'
...
1. Générez l’application. Dans la barre de menus, sélectionnez **Générer** > **Générer la solution**. Le code doit maintenant se compiler sans erreur.
