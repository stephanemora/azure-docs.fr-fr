...
## <a name="microsoft-software-license-termsbrmicrosoft-cognitive-services-speech-devices-sdkbrpurpose--for-use-only-with-azure-cognitive-speech-services"></a>TERMES DU CONTRAT DE LICENCE LOGICIEL MICROSOFT<br>SDK D’APPAREILS MICROSOFT COGNITIVE SERVICES SPEECH<br>Objectif : pour une utilisation uniquement avec Azure Cognitive Speech Services
...
**SI VOUS RESPECTEZ CES TERMES DU CONTRAT DE LICENCE, VOUS DISPOSEZ DES DROITS STIPULÉS CI-DESSOUS.  EN UTILISANT LE LOGICIEL, VOUS ACCEPTEZ CES TERMES.**
...
1. CODE DISTRIBUABLE. Le logiciel peut contenir du code que vous êtes autorisé à distribuer (par exemple, en le mettant à la disposition de tiers) dans des applications que vous développez, comme décrit dans cette section.
    ...
    i. Fichiers REDIST.TXT. Vous pouvez copier et distribuer le code objet du code répertorié dans la liste REDIST dans le logiciel, le cas échéant, ou répertoriés au https://aka.ms/sdsdk-redist;
...
1. PORTÉE DE LA LICENCE. Le logiciel est concédé sous licence, pas vendu. Microsoft se réserve tous les autres droits. Sauf si la loi applicable vous confère davantage de droits nonobstant cette limitation, vous n’êtes pas autorisé à :
...
Notez ce qui suit : Ce logiciel étant distribué au Canada, certaines des clauses du présent contrat sont fournies ci-dessous en Français.
