...
description: Dans ce guide de démarrage rapide, vous utilisez le SDK Speech pour traduire de façon interactive des paroles dans une langue en texte dans une autre langue.
