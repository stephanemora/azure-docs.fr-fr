...
description: Dans ce guide démarrage rapide, vous utilisez le SDK Speech pour effectuer une reconnaissance vocale interactive à partir de données audio capturées depuis un micro.
