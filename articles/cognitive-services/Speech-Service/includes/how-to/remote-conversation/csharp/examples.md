...
ms.locfileid: "88934636"
---
## <a name="upload-the-audio"></a>Charger l’audio

Avant de pouvoir effectuer une transcription asynchrone, vous devez envoyer l’audio au service Transcription de conversation en utilisant le SDK client Microsoft Cognitive Speech (version 1.13.0 ou ultérieure).

Cet exemple de code montre comment créer un transcripteur de conversation pour le mode asynchrone uniquement. Pour diffuser l’audio en continu sur le transcripteur, vous ajoutez le code de diffusion audio en continu dérivé de [Transcrire des conversations en temps réel avec le Kit de développement logiciel (SDK) Speech](../../../../how-to-use-conversation-transcription.md). 
...
Installez **Microsoft.CognitiveServices.Speech.Remoteconversation version 1.13.0 ou une version ultérieure** via NuGet.

### <a name="sample-transcription-code"></a>Exemple de code de transcription

Une fois que vous disposez du `conversationId`, créez un client de transcription de conversation à distance **RemoteConversationTranscriptionClient** sur l’application cliente pour interroger l’état de la transcription asynchrone. Créez un objet de **RemoteConversationTranscriptionOperation** pour obtenir un objet d’[opération](https://github.com/Azure/azure-sdk-for-net/tree/master/sdk/core/Azure.Core#consuming-long-running-operations-using-operationt) durable. Vous pouvez vérifier l’état de l’opération ou attendre qu’elle se termine. 
