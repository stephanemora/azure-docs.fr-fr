...
ms.locfileid: "79371940"
---
## <a name="additional-language-and-platform-support"></a>Prise en charge de langues et de plateformes supplémentaires

Si vous avez cliqué sur cet onglet, c’est que vous n’avez probablement pas vu d’article sur les notions fondamentales dans votre langage de programmation favori. Ne vous inquiétez pas, nous proposons d’autres exemples de code sur GitHub. Utilisez le tableau pour rechercher l’exemple convenant à votre langage de programmation, ainsi qu’à votre combinaison plateforme/système d’exploitation.
...
| C++         | [Démarrage rapide][cpp-quickstarts], [Échantillons][cpp-samples]                                                                                  |
