...
Spécifiez la langue ou la voix de [`SpeechConfig`](/java/api/com.microsoft.cognitiveservices.speech.speechconfig) en fonction de votre texte d’entrée, puis utilisez la voix souhaitée.
