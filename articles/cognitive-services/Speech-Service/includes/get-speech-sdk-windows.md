...
Le Kit de développement logiciel (SDK) Speech sur Windows nécessite que <a href="https://support.microsoft.com/help/2977003/the-latest-supported-visual-c-downloads" target="_blank">Microsoft Visual C++ Redistributable pour Visual Studio 2019</a> soit installé sur le système.

- <a href="https://aka.ms/vs/16/release/vc_redist.x86.exe" target="_blank">Installer pour x86 </a>
- <a href="https://aka.ms/vs/16/release/vc_redist.x64.exe" target="_blank">Installer pour x64 </a>
- <a href="https://aka.ms/vs/16/release/vc_redist.arm64.exe" target="_blank">Installer pour ARMx64</a>
