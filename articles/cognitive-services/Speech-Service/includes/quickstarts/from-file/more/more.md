...
|--|--|--|
| C# | [À partir d’un micro][1-mic], [À partir d’un objet blob][1-blob] | [.NET Framework][dotnet], [.NET Core][netcore], [UWP][uwp], [Unity][unity], [Xamarin][xamarin] |
| C++ | [À partir d’un micro][2-mic], [À partir d’un objet blob][2-blob] | [Windows][cpp-windows], [Linux][cpp-linux], [macOS][cpp-mac] |
| Java | [À partir d’un micro][3-mic], [À partir d’un objet blob][3-blob] | [Android][java-android], [JRE][java-jre] |
...
| Python | [À partir d’un micro][4-mic], [À partir d’un objet blob][4-blob] | [Windows, Linux, macOS][python] |
