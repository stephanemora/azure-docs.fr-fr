...
|--|--|--|
| C# | [Vers un haut-parleur][1-speaker] | [.NET Framework][dotnet], [.NET Core][netcore], [UWP][uwp], [Unity][unity], [Xamarin][xamarin] |
| C++ | [Vers un haut-parleur][2-speaker] | [Windows][cpp-windows], [Linux][cpp-linux], [macOS][cpp-mac] |
| Java | [Vers un haut-parleur][3-speaker] | [Android][java-android], [JRE][java-jre] |
...
| Python | [Vers un haut-parleur][4-speaker] | [Windows, Linux, macOS][python] |
