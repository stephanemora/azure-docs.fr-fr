---
title: 'Démarrage rapide : Synthétiser la voix en un fichier audio, C++ (Windows) - Service de reconnaissance vocale'
...
1. Votre texte est converti en synthèse vocale et enregistré dans les données audio spécifiées.
