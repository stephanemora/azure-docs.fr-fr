...
ms.locfileid: "75660482"
---
## <a name="prerequisites"></a>Conditions préalables requises

Avant de commencer :

* S’il s’agit de votre premier projet Python, utilisez ce guide pour <a href="../quickstarts/create-project.md" target="_blank">créer un exemple de projet vide</a>.
* <a href="../quickstarts/setup-platform.md" target="_blank">Installez le kit SDK Speech pour votre environnement de développement</a>.
