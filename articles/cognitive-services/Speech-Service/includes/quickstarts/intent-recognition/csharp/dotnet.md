...
ms.locfileid: "75660481"
---
## <a name="prerequisites"></a>Conditions préalables requises

Avant de commencer :

* S’il s’agit de votre premier projet C#, utilisez ce guide pour <a href="../quickstarts/create-project.md?tabs=dotnet" target="_blank">créer un exemple de projet vide</a>.
* <a href="../quickstarts/setup-platform.md?tabs=dotnet" target="_blank">Installez le kit SDK Speech pour votre environnement de développement</a>.
