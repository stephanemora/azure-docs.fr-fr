---
title: 'Démarrage rapide : Reconnaître la parole stockée dans Stockage Blob – Service de reconnaissance vocale'
...
ms.locfileid: "73506234"
---
## <a name="additional-language-and-platform-support"></a>Prise en charge de langues et de plateformes supplémentaire

Si vous avez cliqué sur cet onglet, c’est que vous n’avez probablement pas vu de guide de démarrage rapide dans votre langage de programmation préféré. Ne vous inquiétez pas, nous proposons d’autres documents et exemples de code sur GitHub pour bien démarrer. Utilisez le tableau pour trouver l’exemple adapté à votre langage de programmation, ainsi qu’à votre combinaison plateforme/système d’exploitation.

| Langage | Guides de démarrage rapide supplémentaires | Exemples de code |
|----------|------------------------|--------------|
| C++ | |[Guides de démarrage rapide](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart/cpp), [Exemples](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/samples/cpp-linux)|
