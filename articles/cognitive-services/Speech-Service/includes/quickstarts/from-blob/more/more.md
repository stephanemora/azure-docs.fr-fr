...
| Langage | Démarrages rapides supplémentaires | Exemples de code |
|--|--|--|
| C# | [À partir d’un micro][1-mic], [À partir d’un fichier][1-file] | [.NET Framework][dotnet], [.NET Core][netcore], [UWP][uwp], [Unity][unity], [Xamarin][xamarin] |
| C++ | [À partir d’un micro][2-mic], [À partir d’un fichier][2-file] | [Windows][cpp-windows], [Linux][cpp-linux], [macOS][cpp-mac] |
| Java | [À partir d’un micro][3-mic], [À partir d’un fichier][3-file] | [Android][java-android], [JRE][java-jre] |
| JavaScript | [Browser à partir d’un micro][js-browser], [Node.js à partir d’un fichier][js-node] | [Windows, Linux, macOS][js-code] |
| Objective-C | [iOS à partir d’un micro][obj-iOS-qck], [macOS à partir d’un micro][obj-macOS-qck] | [iOS][obj-iOS], [macOS][obj-macOS] |
| Python | [À partir d’un micro][4-mic], [À partir d’un fichier][4-file] | [Windows, Linux, macOS][python] |
| Swift | [iOS à partir d’un micro][swift-iOS-qck], [macOS à partir d’un micro][swift-macOS-qck] | [iOS][swift-iOS], [macOS][swift-macOS] |
