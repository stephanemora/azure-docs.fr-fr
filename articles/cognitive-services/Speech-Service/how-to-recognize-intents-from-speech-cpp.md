...
description: Apprenez à reconnaître des intentions vocales à partir d’un fichier ou à partir d’un micro à l’aide du kit de développement logiciel (SDK) Speech pour C++.
