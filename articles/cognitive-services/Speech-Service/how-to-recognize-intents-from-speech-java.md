...
description: >
  Présente différentes façons d’effectuer une reconnaissance des intentions vocales (à partir d’un fichier, à partir d’un micro) à l’aide du kit de développement logiciel (SDK) Speech pour Java.
