---
title: 'Démarrage rapide : Synthèse vocale, Java (Android) - Service Speech'
...
ms.locfileid: "71803760"
---
# <a name="quickstart-synthesize-speech-in-java-on-android-by-using-the-speech-sdk"></a>Démarrage rapide : Synthèse vocale en Java sur Android à l’aide du SDK Speech

Des guides de démarrage rapide sont également disponibles pour la [reconnaissance vocale](quickstart-java-android.md) et l’[assistant virtuel « voice-first »](quickstart-virtual-assistant-java-android.md).

Dans cet article, vous allez apprendre à créer une application Java pour Android à l’aide du SDK Cognitive Services Speech pour synthétiser de la voix à partir de texte.
L’application est basée sur le package Maven, version 1.7.0 du SDK Speech, et sur Android Studio 3.3.
...
![Capture d’écran de l’application Android](media/sdk/qs-java-android-13-2-gui-on-device-tts.png)
