...
|-------------|-------|---|
|{API_KEY} | Clé d’API de la ressource Speech. |xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx|
|{ENDPOINT_URI} | Valeur du point de terminaison, région comprise.|`https://westus.api.cognitive.microsoft.com/sts/v1.0`|
