---
title: 'Démarrage rapide : API REST Azure Form Recognizer'
...
> [!NOTE]
>
> * Ce guide de démarrage rapide cible la version **2.1** de l’API Azure Form Recognizer et utilise cURL pour exécuter des appels d’API REST.
