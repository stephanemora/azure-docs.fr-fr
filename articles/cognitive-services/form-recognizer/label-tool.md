...
Pour essayer en ligne l’outil d’étiquetage des exemples Form Recognizer, accédez au [site web FOTT](https://fott-2-1.azurewebsites.net/).
...
Cette fonctionnalité est disponible uniquement dans la version 2.1
