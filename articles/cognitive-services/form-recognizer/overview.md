...
Utilisez l’exemple d’outil Form Recognizer pour tester Layout et les modèles prédéfinis, et pour effectuer l’entraînement d’un modèle personnalisé pour vos documents :  
