---
title: Méthode CalcHistogram dans l’API Service d’exploration des connaissances | Microsoft Docs
description: Découvrez comment utiliser la méthode CalcHistogram dans l’API Service d’exploration des connaissances (KES) dans Cognitive Services.
