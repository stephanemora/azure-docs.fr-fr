---
title: Format de schéma dans l’API Service d’exploration des connaissances | Microsoft Docs
description: Découvrez le format de schéma dans l’API Service d’exploration des connaissances (KES) de Cognitive Services.
