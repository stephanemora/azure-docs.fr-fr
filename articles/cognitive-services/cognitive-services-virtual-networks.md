...
La prise en charge des réseaux virtuels pour Cognitive Services est limitée aux régions Azure *Canaries - USA Centre - EUAP*, *Europe Ouest* et *USA Ouest 2*. De plus, toutes les offres Cognitive Services ne prennent pas en charge les réseaux virtuels. Les offres Cognitive Services suivantes permettent l’utilisation de réseaux virtuels. Si l’offre de services n’est pas listée ici, elle ne prend pas en charge les réseaux virtuels.
