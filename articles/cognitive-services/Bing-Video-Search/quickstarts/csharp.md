---
title: 'Démarrage rapide : Rechercher des vidéos à l’aide de l’API REST Recherche de vidéos Bing et C#'
...
2. Ajoutez des variables pour votre clé d’abonnement, votre point de terminaison et votre terme de recherche.
...
3. Définissez un struct `SearchResult` pour contenir les résultats de recherche d’images et les informations d’en-tête JSON.
