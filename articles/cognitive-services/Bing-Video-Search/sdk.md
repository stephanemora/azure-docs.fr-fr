...
1.  Lancer une requête pour obtenir une vidéo.
2.  Lancer une requête limitée aux vidéos gratuites, courtes et présentant des proportions déterminées, en affichant les fonctionnalités de filtrage des vidéos.
3.  Rechercher des vidéos tendance actuellement sur divers réseaux.
4.  Lancer une requête en utilisant des informations détaillées sur la vidéo, telles que sa source, sont titre, etc.
...
* Bien commencer avec les [exemples .NET](https://github.com/Azure-Samples/cognitive-services-dotnet-sdk-samples/tree/master/BingSearchv7)
    * [Package NuGet](https://www.nuget.org/packages/Microsoft.Azure.CognitiveServices.Search.VideoSearch/1.2.0)
    * Voir aussi les [bibliothèques .NET](https://github.com/Azure/azure-sdk-for-net/tree/psSdkJson6/src/SDKs/CognitiveServices/dataPlane/Search/BingVideoSearch) pour les définitions et les dépendances.
