...
description: Dans ce guide de démarrage rapide, vous allez voir comment utiliser l’API Détecteur d’anomalies pour détecter les anomalies dans vos séries de données en lot ou en streaming.
