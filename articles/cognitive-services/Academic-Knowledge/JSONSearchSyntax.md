---
title: Syntaxe d’une recherche JSON dans l’API Connaissances universitaires | Microsoft Docs
description: Découvrez la syntaxe de recherche JSON que vous pouvez utiliser dans l’API Connaissances universitaires de Microsoft Cognitive Services.
