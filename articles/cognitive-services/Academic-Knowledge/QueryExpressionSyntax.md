---
title: Syntaxe d’une expression de requête dans l’API Connaissances universitaires | Microsoft Docs
description: Découvrez comment utiliser la syntaxe d’expression de requête dans l’API Connaissances universitaires de Microsoft Cognitive Services.
