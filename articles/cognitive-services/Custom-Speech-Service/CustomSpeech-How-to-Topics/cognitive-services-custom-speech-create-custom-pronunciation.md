---
title: Utiliser la prononciation personnalisée - Custom Speech Service
titlesuffix: Azure Cognitive Services
description: Découvrez comment créer un modèle de langage avec Custom Speech Service.
