---
title: Métriques d’évaluation de NER personnalisée
titleSuffix: Azure Cognitive Services
description: En savoir plus sur les métriques d’évaluation de la reconnaissance d’entité nommée (NER) personnalisée
...
ms.locfileid: "131096726"
---
# <a name="evaluation-metrics-for-custom-ner-models"></a>Métriques d’évaluation pour les modèles de NER personnalisée

L’évaluation d’un modèle d’extraction d’entité personnalisée utilise les métriques suivantes :
...
[Voir l’évaluation d’un modèle dans Language Studio](../how-to/view-model-evaluation.md)
