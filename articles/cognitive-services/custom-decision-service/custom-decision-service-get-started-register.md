...
1. Accédez à la [page d’accueil](https://portal.ds.microsoft.com/) de la fonctionnalité Service Décision personnalisée. Dans le ruban, cliquez sur **My Portal** (Mon portail), comme illustré sur l’image :
