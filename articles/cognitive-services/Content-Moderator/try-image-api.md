---
title: Modérer des images avec Azure Content Moderator | Microsoft Docs
description: Testez la modération d’images dans la console d’API Content Moderator.
