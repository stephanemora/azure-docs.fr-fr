...
ms.locfileid: "65020182"
---
# <a name="what-are-azure-cognitive-services"></a>Présentation d’Azure Cognitive Services

La solution Azure Cognitive Services est une famille d’API, de kits de développement logiciel (SDK) et de services destinés à aider les développeurs à générer des applications intelligentes sans disposer de connaissances ou compétences directes en matière d’intelligence artificielle ou de science des données. Azure Cognitive Services permettent aux développeurs d’ajouter facilement des fonctionnalités cognitives dans leurs applications. L’objectif de l’équipe Azure Cognitive Services est d’aider les développeurs à créer des applications capables de voir, d’entendre, de parler, de comprendre et même de commencer à raisonner. Le catalogue de services au sein d’Azure Cognitive Services peut être classé en cinq principaux piliers - Vision, Speech, langue, recherche Web et la décision.
...
|[Service Vision personnalisée](https://docs.microsoft.com/azure/cognitive-services/Custom-Vision-Service/home "Service Vision personnalisée")|Le Service Vision personnalisée vous permet de créer des classifieurs d’images personnalisés.|
|[API Visage](https://docs.microsoft.com/azure/cognitive-services/face/ "API Visage")|L’API Visage donne accès à des algorithmes d’analyse du visage permettant la détection et la reconnaissance d’attributs faciaux.|
|[Écran de module de reconnaissance](https://docs.microsoft.com/azure/cognitive-services/form-recognizer/ "forment le module de reconnaissance") (version préliminaire)|Module de reconnaissance de forme identifie et extrait les données de table et de paires clé-valeur à partir de documents de l’écran ; renvoie ensuite les données structurées, y compris les relations dans le fichier d’origine.|
|[Module de reconnaissance de l’encre](https://docs.microsoft.com/azure/cognitive-services/ink-recognizer/ "module de reconnaissance de l’encre") (version préliminaire)|Module de reconnaissance de l’encre vous permet de reconnaître et analyser les données de trait d’encre numérique, de formes et de contenu manuscrit, et une structure de document avec toutes les entités reconnues de sortie.|
...
|Nom du service|Description du service|
|:-----------|:------------------|
|[Services de reconnaissance vocale](https://docs.microsoft.com/azure/cognitive-services/speech-service/ "Services Speech")|Speech Service ajoute des fonctionnalités vocales aux applications.|
|[API Reconnaissance de l’orateur](https://docs.microsoft.com/azure/cognitive-services/speaker-recognition/home "API Reconnaissance de l’orateur") (préversion)|L’API Reconnaissance de l’orateur fournit des algorithmes pour l’identification et la vérification de l’orateur.|
|[Reconnaissance vocale Bing](https://docs.microsoft.com/azure/cognitive-services/speech/home "reconnaissance vocale Bing") (mise hors service)|L’API Reconnaissance vocale Bing vous offre un moyen facile de créer des fonctionnalités vocales dans vos applications.|
|[Translator Speech](https://docs.microsoft.com/azure/cognitive-services/translator-speech/ "Translator Speech") (mise hors service)|La Traduction de conversation Translator Speech est un service de traduction automatique.|

## <a name="language-apis"></a>Les API Langage

|Nom du service|Description du service|
|:-----------|:------------------|
|[Language Understanding Intelligent Service](https://docs.microsoft.com/azure/cognitive-services/luis/ "Language Understanding")|Le service Language Understanding (LUIS) permet à votre application de comprendre le sens des propos d’une personne.|
...
|Nom du service|Description du service|
|:-----------|:------------------|
|[Recherche d’actualités Bing](https://docs.microsoft.com/azure/cognitive-services/bing-news-search/ "Recherche d’actualités Bing")|La Recherche d’actualités Bing retourne une liste d’articles d’actualités jugés pertinents en réponse à la requête de l’utilisateur.|
...
|[Recherche d’entités Bing](https://docs.microsoft.com/azure/cognitive-services/bing-entities-search/ "Recherche d’entités Bing")|La Recherche d’entités Bing retourne des informations sur des entités que Bing juge pertinentes en lien avec la requête d’un utilisateur.|
...
|[Recherche d’entreprise Local Bing](https://docs.microsoft.com/azure/cognitive-services/bing-local-business-search/ "recherche d’entreprise Local Bing")| API de recherche Bing Local Business permet à vos applications trouver des informations de contact et l’emplacement sur les entreprises locales basées sur des requêtes de recherche.|
...
|Nom du service|Description du service|
|:-----------|:------------------|
|[Détecteur d’anomalies](https://docs.microsoft.com/azure/cognitive-services/anomaly-detector/ "détecteur d’anomalies") (version préliminaire)|Détecteur d’anomalies vous permet de surveiller et de détecter les anomalies dans vos données de série chronologique.|
...
|[Personalizer](https://docs.microsoft.com/azure/cognitive-services/personalizer/ "Personalizer") (version préliminaire)|Personalizer vous permet de choisir la meilleure expérience pour montrer à vos utilisateurs, de formation à partir de leur comportement en temps réel.|
...
Toutes les API ont un plan d’évaluation gratuit qui a l’utilisation et débit limites.  Vous pouvez augmenter ces limites en utilisant une offre payante et en sélectionnant l’option de niveau de tarification approprié lors du déploiement du service dans le portail Azure. [En savoir plus sur les offres et tarification](https://azure.microsoft.com/pricing/details/cognitive-services/ "offres et tarification"). Vous devez créer un compte d’abonné Azure avec une carte de crédit et un numéro de téléphone. Si vous avez des exigences particulières ou souhaitez simplement communiquer avec le service commercial, cliquez sur le bouton « Nous contacter » en haut de la page de tarification.
...
COGNITIVE Services a reçu les certifications telles que la Certification de CSA STAR, FedRAMP Moderate et HIPAA BAA.

Vous pouvez [télécharger](https://gallery.technet.microsoft.com/Overview-of-Azure-c1be3942) certifications pour vos propres audits et des révisions de sécurité.

Pour comprendre la gestion des données et confidentialité, accédez à la [centre de confidentialité](https://servicetrust.microsoft.com/).

## <a name="support"></a>Support

* Pour une demande d’assistance ou des questions techniques, publiez votre demande dans [Stack Overflow](https://stackoverflow.com/questions/tagged/microsoft-cognitive).
* Pour une demande de commentaires ou de fonctionnalité, accédez à [UserVoice](https://cognitive.uservoice.com/).
