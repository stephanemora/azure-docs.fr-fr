...
1. Créez un fichier appelé _analyze-image.html_, ouvrez-le dans un éditeur de texte, puis copiez-y le code suivant.
...
1. Sélectionnez le bouton **Analyser l’image**.
