...
description: Dans ce démarrage rapide, vous allez extraire le texte imprimé d’une image à l’aide de l’API Vision par ordinateur avec Java dans Cognitive Services.
...
ms.locfileid: "43770221"
---
# <a name="quickstart-extract-printed-text-ocr---rest-java"></a>Démarrage rapide : Extraire le texte imprimé (OCR) - REST, Java
...
Une réponse correcte est retournée au format JSON. Les résultats de la reconnaissance optique de caractères incluent le texte détecté et les rectangles englobants correspondant aux régions, lignes et mots.
