...
> [!NOTE]
> Si vous extrayez du texte en langue anglaise, envisagez d’utiliser la nouvelle [opération de lecture](../concept-recognizing-text.md). Un [Démarrage rapide de Java](./java-hand-text.md) est disponible. 
