...
description: Dans ce démarrage rapide, vous allez générer une miniature à partir d’une image à l’aide de l’API Vision par ordinateur avec C# dans Cognitive Services.
...
ms.locfileid: "43770214"
---
# <a name="quickstart-generate-a-thumbnail---rest-c35"></a>Démarrage rapide : Générer une miniature - REST, C&#35;
...
1. Remplacez la valeur `uriBase` par l’emplacement où vous avez obtenu vos clés d’abonnement, le cas échéant.
1. Exécutez le programme.
1. À l’invite, entrez le chemin d’accès à une image locale.

La miniature est enregistrée dans le même dossier que l’image locale, avec le nom d’origine contenant le suffixe « _thumb ».
