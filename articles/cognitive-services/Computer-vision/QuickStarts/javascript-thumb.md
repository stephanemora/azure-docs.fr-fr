...
description: Dans ce démarrage rapide, vous générez une miniature à partir d’une image à l’aide de l’API Vision par ordinateur avec Javascript dans Cognitive Services.
...
ms.locfileid: "43770237"
---
# <a name="quickstart-generate-a-thumbnail---rest-javascript"></a>Démarrage rapide : Générer une miniature - REST, Javascript
...
1. Copiez le script suivant et enregistrez-le dans un fichier tel que `thumbnail.html`.
...
1. Cliquez sur le bouton `Generate thumbnail`.
