...
Ce guide de mise à niveau identifie les changements apportés entre la version 5 et la version 7 de l’API Suggestion automatique Bing. Utilisez ce guide pour aider à mettre à jour votre application pour utiliser la version 7.
