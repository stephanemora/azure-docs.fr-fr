...
Le client Recherche personnalisée Bing est un objet [BingCustomSearchAPI](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.bingcustomsearchapi) qui est créé à partir de la méthode [authenticate()](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.bingcustomsearchmanager.authenticate) de l’objet [BingCustomSearchManager](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.bingcustomsearchmanager). Vous pouvez envoyer une demande de recherche en utilisant la méthode [BingCustomInstances.search()](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.bingcustominstances.search#com_microsoft_azure_cognitiveservices_search_customsearch_BingCustomInstances_search__) du client.

La réponse de l’API est un objet [SearchResponse](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.models.searchresponse) contenant des informations sur la requête de recherche et les résultats de la recherche.
...
Votre méthode main doit inclure un objet [BingCustomSearchManager](/java/api/com.microsoft.azure.cognitiveservices.search.customsearch.bingcustomsearchapi) qui prend votre clé et appelle sa méthode `authenticate()`.
