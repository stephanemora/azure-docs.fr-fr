...
description: Utilisez le SDK Recherche personnalisée Bing pour Python afin d’obtenir des résultats de recherche personnalisée.
...
1. Créez une variable pour votre clé d’abonnement.
