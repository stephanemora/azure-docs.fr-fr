---
title: 'Recherche personnalisée Bing : Utiliser des marqueurs d’ornement pour mettre en surbrillance un texte | Microsoft Docs'
description: Montre comment activer des ornements de texte dans les réponses de recherche.
