---
title: 'Démarrage rapide : SDK Recherche d’entités Bing, C#'
...
ms.locfileid: "55152935"
---
# <a name="quickstart-bing-entity-search-sdk-with-c"></a>Démarrage rapide : SDK Recherche d’entités Bing avec C#
...
Le [code source des exemples du Kit de développement logiciel (SDK) C# pour Recherche d’entités Bing](https://github.com/Azure-Samples/cognitive-services-dotnet-sdk-samples/tree/master/BingSearchv7/BingEntitySearch) est disponible sur GitHub.
...
Pour configurer une application console à l’aide du Kit de développement logiciel (SDK) pour Recherche d’entités Bing, accédez à l’option `Manage NuGet Packages` à partir de l’Explorateur de solutions dans Visual Studio.  Ajoutez le package `Microsoft.Azure.CognitiveServices.Search.EntitySearch`.

L’installation du [package NuGet Recherche d’entités](https://www.nuget.org/packages/Microsoft.Azure.CognitiveServices.Search.EntitySearch/1.2.0) installe également les dépendances, y compris les assemblys suivants :
* Microsoft.Rest.ClientRuntime
* Microsoft.Rest.ClientRuntime.Azure
* Newtonsoft.Json

## <a name="entity-search-client"></a>Client Recherche d’entités
Pour créer une instance du client `EntitySearchAPI`, ajoutez à l’aide de directives :
```
...
L’application console suivante recherche une seule entité avec la requête « Satya Nadella », et affiche une brève description.
```
using System;
using System.Linq;
using System.Text;
...
## <a name="ambiguous-results"></a>Résultats ambigus
Le code suivant gère la levée d’ambiguïté des résultats d’une requête ambiguë « William Gates ».
```
...
## <a name="entitydata-places"></a>Emplacements d’EntityData
Le code suivant recherche un seul magasin « Microsoft Store », et affiche son numéro de téléphone.
```
...
```
## <a name="entityscenario-list"></a>Liste EntityScenario
Le code suivant consulte une liste de « Seattle restaurants » (restaurants de Seattle) et les noms et numéros de téléphone des restaurants.
```
...
```
## <a name="error-results"></a>Résultats de l’erreur
Le code suivant déclenche une demande incorrecte et montre comment lire la réponse d’erreur.
```
