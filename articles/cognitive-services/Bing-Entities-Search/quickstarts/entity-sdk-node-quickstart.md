---
title: 'Démarrage rapide : Envoyer une requête de recherche avec le SDK Recherche d’entités Bing pour Node.js'
...
2. Envoyez une requête de recherche d’entités avec `entitiesOperations.search()`. Après avoir reçu une réponse, imprimez le `queryContext`, le nombre de résultats retournés et la description du premier résultat.
