---
title: 'Démarrage rapide : Utiliser cURL et REST pour déterminer l’intention - LUIS'
titleSuffix: Azure Cognitive Services
description: Dans ce guide de démarrage rapide avec une API REST, utilisez cURL et REST pour déterminer l’intention d’un utilisateur à partir d’un texte de conversation.
...
ms.locfileid: "91316254"
---
# <a name="quickstart-use-curl-and-rest-to-get-intent"></a>Démarrage rapide : Utiliser cURL et REST pour déterminer l’intention

Ce guide de démarrage rapide vous montre comment utiliser une application LUIS pour déterminer l’intention d’un utilisateur à partir du texte conversationnel. Vous utilisez cURL pour envoyer l’intention de l’utilisateur sous forme de texte au point de terminaison de prédiction HTTP de l’application de pizza. Au niveau du point de terminaison, LUIS applique le modèle de l’application de pizza pour analyser le sens du texte en langage naturel, déterminer l’intention globale et extraire les données pertinentes pour le domaine de l’application.

[Documentation de référence](https://westeurope.dev.cognitive.microsoft.com/docs/services/luis-programmatic-apis-v3-0-preview/operations/5890b47c39e2bb052c5b9c08)
...
* Le programme en ligne de commande cURL. Le programme cURL est préinstallé sur macOS, sur la plupart des distributions Linux ainsi que sur Windows 10 build 1803 et ultérieur. Si vous devez installer le programme cURL, téléchargez-le à partir de la [page de téléchargement de cURL](https://curl.haxx.se/download.html).
...
> [Ajouter des énoncés et effectuer l’apprentissage de](luis-get-started-rest-get-model.md)
