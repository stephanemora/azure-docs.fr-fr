---
title: Documentation de référence pour les entités prédéfinies désapprouvées de LUIS - Azure | Microsoft Docs
titleSuffix: Azure
...
ms.locfileid: "39237058"
---
# <a name="deprecated-entities"></a>Entités désapprouvées
...
## <a name="geography-culture"></a>Culture de Geography
L’entité prédéfinie **Geography** est disponible uniquement dans les paramètres régionaux `en-us`.

#### <a name="3-geography-subtypes"></a>3 Sous-types de Geography
...
## <a name="encyclopedia-culture"></a>Culture de Encyclopedia
...
Entité prédéfinie   |   Entité prédéfinie (sous-types)   |   Exemple d’énoncé
------|------|------|
