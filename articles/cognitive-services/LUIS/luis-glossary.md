...
Un jeton est la plus petite unité pouvant être étiquetée dans une entité. La segmentation du texte en unités lexicales (tokenization) dépend de la [culture](luis-supported-languages.md#tokenization) de l’application.
