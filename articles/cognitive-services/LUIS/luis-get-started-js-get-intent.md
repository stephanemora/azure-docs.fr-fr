...
ms.locfileid: "36265402"
---
# <a name="tutorial-call-a-luis-endpoint-using-javascript"></a>Didacticiel : Appeler un point de terminaison LUIS à l’aide de JavaScript
...
4. Retournez sur le site web [LUIS](luis-reference-regions.md) et connectez-vous avec votre compte Azure. 
    ...
    [![](media/luis-get-started-node-get-intent/app-list.png "Capture d’écran de la liste Créer une application")](media/luis-get-started-node-get-intent/app-list.png)
...
1. Le point de terminaison de l’exemple d’application est au format suivant : `https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/df67dcdb-c37d-46af-88e1-8b97951ca1c2?subscription-key=<YOUR_API_KEY>&verbose=false&q=turn%20on%20the%20bedroom%20light`. Copiez l’URL et remplacez votre clé d’abonnement pour la valeur du champ `subscription-key`.
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-javascript"></a>Utiliser un résultat LUIS à l’aide de l’API de point de terminaison avec JavaScript 
...
2. Remplacez `"YOUR SUBSCRIPTION KEY"` par votre clé d’abonnement dans cette ligne de code : `xhrObj.setRequestHeader("Ocp-Apim-Subscription-Key","YOUR SUBSCRIPTION KEY");`

3. Ouvrez le fichier que vous avez enregistré à l’aide d’un navigateur web.  Une fenêtre d’alerte doit apparaître indiquant que `Detected the following intent: TurnOn`.

![Fenêtre contextuelle indiquant TurnOn](./media/luis-get-started-node-get-intent/popup-turn-on.png)
