---
title: Didacticiel permettant de découvrir comment appeler une application Language Understanding Intelligent Service (LUIS) à l’aide de Node.js | Microsoft Docs
...
ms.locfileid: "36263650"
---
# <a name="tutorial-call-a-luis-endpoint-using-nodejs"></a>Didacticiel : Appeler un point de terminaison LUIS à l’aide de Node.js
...
Vous avez besoin d’une clé API Cognitive Services pour passer des appels à l’exemple d’application LUIS utilisée dans cette procédure pas à pas. 
...
3. Suivez les étapes indiquées dans l’article relatif à la [création de clés d’abonnement à l’aide d’Azure](./luis-how-to-azure-subscription.md) pour obtenir une clé.
...
## <a name="understand-what-luis-returns"></a>Comprendre les éléments retournés par une application LUIS

Pour comprendre ce que retourne une application LUIS, vous pouvez coller l’URL d’un exemple d’application LUIS dans une fenêtre de navigateur. L’exemple d’application est une application IoT qui détecte si l’utilisateur souhaite allumer ou éteindre la lumière.
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-nodejs"></a>Consommer un résultat LUIS à l’aide de l’API Endpoint avec Node.js
...
2. Définissez la variable d’environnement `LUIS_APP_ID` comme décrit dans les commentaires de code. 

3. Définissez la variable d’environnement `LUIS_SUBSCRIPTION_KEY` sur votre clé d’abonnement Cognitive Services.

4. Exécutez le code. Il affiche des valeurs identiques à celles que vous avez vues plus tôt dans la fenêtre du navigateur.
<!-- 
