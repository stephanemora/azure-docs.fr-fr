...
Cognitive Services fournit deux services de traitement en langage naturel, [Language Understanding](what-is-luis.md) et [QnA Maker](../qnamaker/overview/overview.md), chacun avec un objectif différent. Découvrez quand utiliser chaque service et comment ils se complètent. 
...
* Bonnes pratiques [LUIS](luis-concept-best-practices.md)
