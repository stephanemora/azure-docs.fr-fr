...
Lorsque le processus d’abonnement LUIS est terminé, [ajoutez la clé](luis-how-to-manage-keys.md#assign-endpoint-key) à l’application à la page **Publier**. 
