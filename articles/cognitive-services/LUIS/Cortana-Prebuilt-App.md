...
Pour appeler le point de terminaison, vous pouvez ajouter votre argument de clé de point de terminaison et votre chaîne de requête au point de terminaison. 
