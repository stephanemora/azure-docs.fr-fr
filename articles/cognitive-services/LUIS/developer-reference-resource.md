...
|--|--|--|--|
|C#|[Création](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.authoring)</br>[Prédiction](/dotnet/api/microsoft.azure.cognitiveservices.language.luis.runtime)|[NuGet - création](https://www.nuget.org/packages/Microsoft.Azure.CognitiveServices.Language.LUIS.Authoring/)<br>[NuGet - prédiction](https://www.nuget.org/packages/Microsoft.Azure.CognitiveServices.Language.LUIS.Runtime/)|[Création](./client-libraries-rest-api.md?pivots=rest-api)<br>[Prédiction de requête](./client-libraries-rest-api.md?pivots=rest-api)|
...
|Java|[Création et prédiction](/java/api/overview/azure/cognitiveservices/client/languageunderstanding)|[Maven - création](https://search.maven.org/artifact/com.microsoft.azure.cognitiveservices/azure-cognitiveservices-luis-authoring)<br>[Maven - prédiction](https://search.maven.org/artifact/com.microsoft.azure.cognitiveservices/azure-cognitiveservices-luis-runtime)|
|JavaScript|[Création](/javascript/api/@azure/cognitiveservices-luis-authoring/)<br>[Prédiction](/javascript/api/@azure/cognitiveservices-luis-runtime/)|[NPM - création](https://www.npmjs.com/package/@azure/cognitiveservices-luis-authoring)<br>[NPM - prédiction](https://www.npmjs.com/package/@azure/cognitiveservices-luis-runtime)|[Création](./client-libraries-rest-api.md?pivots=rest-api)<br>[Prédiction](./client-libraries-rest-api.md?pivots=rest-api)|
|Python|[Création et prédiction](./client-libraries-rest-api.md?pivots=rest-api)|[Pip](https://pypi.org/project/azure-cognitiveservices-language-luis/)|[Création](./client-libraries-rest-api.md?pivots=rest-api)<br>[Prédiction](./client-libraries-rest-api.md?pivots=rest-api)|
