---
title: Ajouter des exemples d’énoncés dans des applications LUIS | Microsoft Docs
titleSuffix: Azure
...
Après avoir ajouté, modifié ou supprimé des énoncés, [formez](luis-how-to-train.md) et [publiez](PublishApp.md) votre application pour que vos modifications affectent les requêtes de point de terminaison. 
