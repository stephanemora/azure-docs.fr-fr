---
title: Appeler une application Language Understanding Intelligent Service (LUIS) à l’aide de PHP | Microsoft Docs
...
ms.locfileid: "36265124"
---
# <a name="tutorial-call-a-luis-endpoint-using-php"></a>Didacticiel : Appeler un point de terminaison LUIS à l’aide de PHP
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-php"></a>Utiliser un résultat LUIS à l’aide de l’API de point de terminaison avec PHP 
...
3. Exécutez l’application PHP. Des valeurs identiques à celles que vous avez vues plus tôt dans la fenêtre du navigateur s’affichent.
