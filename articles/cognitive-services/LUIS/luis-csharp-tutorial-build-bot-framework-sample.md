...
Un [Bot Framework 4.x tutoriel LUIS](luis-csharp-tutorial-bf-v4.md) est également disponible.
...
> 
> [!WARNING]
> Si vous supprimez votre clé d’ID ou LUIS application, le robot cessent de fonctionner.
