...
| "composites" : [],        | Déprécié, utilisez [entités de machine-learning](luis-concept-entity-types.md). Référence d’[entité composite](./reference-entity-machine-learned-entity.md). |
