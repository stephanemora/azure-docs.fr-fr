---
title: Didacticiel permettant de découvrir comment appeler une application Language Understanding Intelligent Service (LUIS) à l’aide de Python | Microsoft Docs
...
ms.locfileid: "36264582"
---
# <a name="tutorial-call-a-luis-endpoint-using-python"></a>Didacticiel : Appeler un point de terminaison LUIS à l’aide de Python
...
1. Copiez l’un des extraits de code suivants :
...
2. Remplacez la valeur du champ `Ocp-Apim-Subscription-Key` par votre clé d’abonnement LUIS.

3. Exécutez le script. Des valeurs identiques à celles que vous avez vues plus tôt dans la fenêtre du navigateur s’affichent.
<!-- 
