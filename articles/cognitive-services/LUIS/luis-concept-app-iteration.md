...
Ce type de schéma d’intention peut avoir des entités si cela permet à LUIS de déterminer l’intention de l’utilisateur. Par exemple, une entité d’expédition (comme descripteur d’intention) permet à LUIS de déterminer une intention d’expédition. 
