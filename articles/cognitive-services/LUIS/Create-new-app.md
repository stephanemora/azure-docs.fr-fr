...
## <a name="export-endpoint-logs"></a>Exporter les journaux d’activité du point de terminaison
Les journaux d’activité contiennent la requête, l’heure UTC et la réponse JSON LUIS.

1. Sur la page **Mes applications**, sélectionnez les points de suspension (***…***) à la fin de la ligne de l’application. 
2. Sélectionnez **Export endpoint logs** (Exporter les journaux d’activité du point de terminaison) dans le menu.
