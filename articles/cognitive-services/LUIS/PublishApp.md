...
Les intentions et leurs scores sont également inclus dans les journaux de point de terminaison. Vous pouvez [exporter](create-new-app.md#export-app) ces journaux et analyser les scores. 
...
|--|--|--|--|
|verbose|booléen|true|Inclure [tous les scores d’intention](#include-all-predicted-intent-scores) pour un énoncé|
...
|spellCheck|booléen|true|[Corriger l’orthographe](#enable-bing-spell-checker) de l’énoncé ; utilisée conjointement avec le paramètre de chaîne de requête bing-spell-check-subscription-key|
...
|staging|booléen|false|sélectionner un point de terminaison de production ou de préproduction|
|log|booléen|true|ajouter une requête et des résultats au journal|
...
* Voir [Gérer les clés](./Manage-Keys.md) pour ajouter des clés à votre application LUIS et découvrir comment les clés sont mappées aux régions.
