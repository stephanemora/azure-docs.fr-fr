...
ms.locfileid: "84142161"
---
# <a name="text-analytics-api-v3-language-support"></a>Prise en charge linguistique de l’API Analyse de texte v3 

> [!IMPORTANT]
> La version 3.x de l’API Analyse de texte n’est pas disponible actuellement dans les régions suivantes : Inde Centre, Fairfax, Émirats arabes unis Nord, Afrique du Sud Nord, Chine Nord 2, Chine Est.
