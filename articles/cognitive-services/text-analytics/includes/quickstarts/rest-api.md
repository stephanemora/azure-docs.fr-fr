...
ms.locfileid: "102444573"
---
# <a name="version-31-preview"></a>[Version préliminaire de la version 3.1](#tab/version-3-1)

[Documentation de référence sur la version 3.1](https://westus2.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v3-1-preview-3/)

# <a name="version-30"></a>[Version 3.0](#tab/version-3)

[Documentation de référence sur la version 3](https://westus.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v3-0) 
...
> [!NOTE]
> L’exemple ci-dessous comprend une requête pour la fonctionnalité Exploration des opinions de l’Analyse des sentiments avec le paramètre `opinionMining=true`, qui fournit des informations précises sur les opinions relatives à différents aspects du texte (tels que les attributs des produits ou des services).
...
### <a name="detecting-personally-identifying-information"></a>Détection des informations d’identification personnelle
