...
ms.locfileid: "104599067"
---
# <a name="version-31-preview"></a>[Version préliminaire de la version 3.1](#tab/version-3-1)

[Documentation de référence sur la version 3.1](https://westus2.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v3-1-preview-4/)
...
> [!NOTE]
> L’exemple ci-dessous comprend une requête pour la fonctionnalité Exploration des opinions de l’Analyse des sentiments avec le paramètre `opinionMining=true`, qui fournit des informations précises sur les évaluations (adjectifs) relatives aux cibles (noms) dans le texte.
