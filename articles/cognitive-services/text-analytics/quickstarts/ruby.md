---
title: Démarrage rapide avec Ruby de l’API Analyse de texte dans Azure Cognitive Services | Microsoft Docs
...
---
# <a name="quickstart-for-text-analytics-api-with-ruby"></a>Démarrage rapide de l’API Analyse de texte avec Ruby 
<a name="HOLTop"></a>
...
2. Ajoutez le code fourni ci-dessous.
...
Une réponse correcte est renvoyée sous forme de code JSON, comme dans l’exemple suivant : 
...
**Réponse d’extraction d’expressions clés**
