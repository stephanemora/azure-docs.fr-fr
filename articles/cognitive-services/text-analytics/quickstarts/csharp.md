...
1. Sélectionnez le package NuGet et installez-le. Tant que l’exemple de code n’a pas été mis à jour vers v3.0.0, vous devrez peut-être passer à la version v2.8.0 (à compter du 18-3-2019).
