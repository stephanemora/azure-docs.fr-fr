...
2. Créez un objet `TextAnalyticsClient` avec le paramètre `ApiKeyServiceClientCredentials`, puis générez une liste d’objets `MultiLanguageInput`contenant les documents que vous souhaitez analyser.
...
2. Créez un objet `TextAnalyticsClient` avec le paramètre `ApiKeyServiceClientCredentials`, puis générez une liste d’objets `LanguageInput`contenant vos documents.
...
2. Créez un objet `TextAnalyticsClient` avec le paramètre `ApiKeyServiceClientCredentials`, puis générez une liste d’objets `MultiLanguageBatchInput`contenant vos documents.
