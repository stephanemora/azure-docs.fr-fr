---
title: 'L’API de traduction de texte Translator Text : identification de la langue du texte avec C# | Microsoft Docs'
titleSuffix: Microsoft Cognitive Services
description: Dans ce démarrage rapide, vous identifiez la langue du texte source à l’aide de l’API de traduction de texte Translator Text avec C# dans Cognitive Services.
