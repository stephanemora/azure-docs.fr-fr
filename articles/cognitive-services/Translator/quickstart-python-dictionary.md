---
title: 'Démarrage rapide : Rechercher des traductions alternatives,Python - API de traduction de texte Translator Text'
titleSuffix: Azure Cognitive Services
description: Dans ce guide de démarrage rapide, vous allez rechercher des traductions alternatives et des exemples de termes en contexte à l’aide de l’API de traduction de texte Translator Text avec Python.
...
ms.locfileid: "49646408"
---
# <a name="quickstart-find-alternate-translations-with-the-translator-text-rest-api-python"></a>Démarrage rapide : Rechercher des traductions alternatives à l’aide de l’API REST de traduction de texte Translator Text (Python)
