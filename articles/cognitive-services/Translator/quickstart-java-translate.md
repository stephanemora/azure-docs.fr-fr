...
ms.locfileid: "50414614"
---
# <a name="quickstart-translate-text-with-the-translator-text-rest-api-java"></a>Démarrage rapide : Traduire du texte à l’aide de l’API REST de traduction de texte Translator Text (Java)
