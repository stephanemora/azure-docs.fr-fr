...
ms.locfileid: "49644900"
---
# <a name="quickstart-get-sentence-lengths-with-the-translator-text-rest-api-nodejs"></a>Démarrage rapide : obtenir la longueur des phrases avec l’API REST de traduction de texte Translator Text (Node.js)
