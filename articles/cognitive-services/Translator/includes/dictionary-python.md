...
Le point de terminaison global de Translator est défini sur `endpoint`. `path` définit le chemin des `dictionary/lookup` et reconnait que nous souhaitons atteindre la version 3 de l’API.
