...
## <a name="get-endpoint-information-from-an-environment-variable"></a>Obtenir des informations de point de terminaison à partir d’une variable d’environnement
...
## <a name="set-the-route"></a>Définir la route
