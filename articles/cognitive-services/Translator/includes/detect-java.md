...
Ajoutez ces lignes à la classe `Detect`. Vous voyez que la clé d’abonnement et le point de terminaison sont lus à partir des variables d’environnement :
