...
Le point de terminaison global de Translator est défini sur `endpoint`. `path` définit le chemin des `transliterate` et reconnait que nous souhaitons atteindre la version 3 de l’API.
...
>[!NOTE]
> Pour plus d’informations sur les points de terminaison, les itinéraires et les paramètres de requête, consultez [Translator 3.0 : Translittérer](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-transliterate).
