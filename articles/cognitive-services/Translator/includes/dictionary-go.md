...
Créez un projet Go avec votre IDE ou votre éditeur favori, ou créez un dossier sur votre poste de travail. Copiez ensuite cet extrait de code dans votre projet/dossier, dans un fichier nommé `dictionaryLookup.go`.
...
Créons une fonction pour obtenir des traductions alternatives. Cette fonction n’utilisera qu’un seul argument, votre clé d’abonnement Translator.
