---
title: Traduction de documentation - get operations
titleSuffix: Azure Cognitive Services
description: La méthode get operations retourne une liste des demandes de lots soumises et l’état de chaque demande.
...
La méthode Get Operations retourne une liste des demandes de lots soumises et l’état de chaque demande. Cette liste contient uniquement les demandes de lots soumises par l’utilisateur (en fonction de l’abonnement). L’état de chaque demande est trié par ID.
...
## <a name="get-operations-response"></a>Réponse de get operations

### <a name="successful-get-operations-response"></a>Réponse positive de get operations
