---
title: Traduction de documentation - get operation status
titleSuffix: Azure Cognitive Services
description: La méthode get operation status retourne l’état d’une demande de traduction de document.
...
ms.locfileid: "105613756"
---
# <a name="document-translation-get-operation-status"></a>Traduction de documentation : get operation status

La méthode Get Operation Documents Status retourne l’état d’une demande de traduction de document. L’état comprend l’état global de la demande et l’état des documents en cours de traduction dans le cadre de cette demande.
...
## <a name="get-operation-status-response"></a>Réponse de get operation status

### <a name="successful-get-operation-status-response"></a>Réponse positive de get operation status
