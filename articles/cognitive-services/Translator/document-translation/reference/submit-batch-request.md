---
title: Traduction de document - Envoyer une demande de lot
titleSuffix: Azure Cognitive Services
description: Envoyez une demande de traduction de document au service Traduction de document.
...
ms.locfileid: "105613758"
---
# <a name="document-translation-submit-batch-request"></a>Traduction de document : Envoyer une demande de lot

Utilisez cette API pour envoyer une demande de traduction en bloc (lot) au service Traduction de document. Chaque demande peut contenir plusieurs documents, et doit contenir un conteneur source et un conteneur de destination pour chaque document.
