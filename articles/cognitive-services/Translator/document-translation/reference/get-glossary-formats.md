---
title: Traduction de documentation - Méthode get glossary formats
titleSuffix: Azure Cognitive Services
description: La méthode get glossary formats retourne la liste des formats de glossaires pris en charge.
...
ms.locfileid: "105613764"
---
# <a name="document-translation-get-glossary-formats"></a>Traduction de documentation : get glossary formats

La méthode Get Glossary Formats retourne une liste des formats de glossaires pris en charge par le service Traduction de documentation. La liste comprend l’extension de fichier commune utilisée.
...
## <a name="get-glossary-formats-response"></a>Réponse de get glossary formats

Type de base pour le retour de liste dans l’API Get Glossary Formats.

### <a name="successful-get-glossary-formats-response"></a>Réponse positive de get glossary formats
