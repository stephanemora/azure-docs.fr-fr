---
title: 'Démarrage rapide : Détecter la langue du texte, Node.js – API de traduction de texte Translator Text'
titleSuffix: Azure Cognitive Services
description: Dans ce démarrage rapide, vous allez apprendre à identifier la langue du texte fourni à l’aide de Node.js et de l’API REST de traduction de texte Translator Text.
...
ms.locfileid: "65604244"
---
# <a name="quickstart-use-the-translator-text-api-to-detect-text-language-with-nodejs"></a>Démarrage rapide : Utiliser l’API de traduction de texte Translator Text et Node.js pour détecter la langue du texte

Dans ce démarrage rapide, vous allez apprendre à détecter la langue du texte fourni à l’aide de Node.js et de l’API REST de traduction de texte Translator Text.
...
Recherchez l’abréviation du pays/de la région dans cette [liste des langues](https://docs.microsoft.com/azure/cognitive-services/translator/language-support).
