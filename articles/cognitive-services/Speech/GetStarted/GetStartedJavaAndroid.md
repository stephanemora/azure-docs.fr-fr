...
* **Événements d’intention** : Appelés sur les clients « WithIntent » (uniquement en mode `ShortPhrase`) une fois le résultat final de la reconnaissance est converti en intention JSON structurée.
