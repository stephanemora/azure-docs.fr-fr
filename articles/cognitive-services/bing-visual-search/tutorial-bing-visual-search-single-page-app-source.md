---
title: 'Tutoriel : Générer une application web à page unique (code source) - Recherche visuelle Bing'
titleSuffix: Azure Cognitive Services
description: Code source du tutoriel expliquant comment utiliser l’API Recherche visuelle Bing dans une application web à page unique.
