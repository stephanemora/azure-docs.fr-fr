---
title: Balise insights par défaut | Microsoft Docs
titleSuffix: Bing Web Search APIs - Cognitive Services
description: Cet article donne des informations sur les insights retournés par défaut par la recherche visuelle sur une image.
...
Pour configurer rapidement votre première demande, consultez les guides de démarrage rapide : [C#](quickstarts/csharp.md) | [Java](quickstarts/java.md) | [node.js](quickstarts/nodejs.md) | [Python](quickstarts/python.md).
