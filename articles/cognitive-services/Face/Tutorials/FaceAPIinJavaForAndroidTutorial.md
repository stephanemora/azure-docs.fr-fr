...
description: Dans ce didacticiel, vous créez une simple application Android qui utilise l’API Visage de Cognitive Services pour détecter et encadrer des visages humains dans une image.
