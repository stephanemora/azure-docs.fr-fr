---
title: Détecter des visages dans des images avec l’API Visage | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Utilisez l’API Visage de Cognitive Services pour détecter des visages dans des images.
...
---
# <a name="how-to-detect-faces-in-image"></a>Comment détecter des visages dans une image

Ce guide va vous montrer comment détecter des visages sur une image, grâce à l’extraction d’attributs tels que le sexe, l’âge ou la posture. Les exemples sont écrits dans C# à l’aide de la bibliothèque cliente de l’API Visage. 
...
## <a name="step2"></a> Étape 2 : charger une image dans le service et exécuter la détection des visages
...
## <a name="step3"></a> Étape 3 : comprendre et utiliser les points de repère du visage
...
## <a name="step4"></a> Étape 4 : utiliser d’autres attributs du visage
...
[Comment identifier les visages dans l’image](HowtoIdentifyFacesinImage.md)
