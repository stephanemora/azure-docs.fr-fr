...
- [Guide de référence du SDK C# de Vérification orthographique Bing](/dotnet/api/overview/azure/cognitiveservices/client/bingspellcheck?view=azure-dotnet)