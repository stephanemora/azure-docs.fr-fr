...
ms.locfileid: "35368497"
---
# <a name="build-a-web-page-spell-check-client"></a>Générer une page web pour le client de vérification orthographique
...
Créez un formulaire HTML avec un champ de texte. Gérez l’événement **onsubmit** et appelez la fonction bingSpellCheck, en passant le contenu du champ de texte et la clé API Vérification orthographique Bing.
