---
title: Chargement d’images Bing pour obtenir des informations (code source) | Microsoft Docs
description: Code source destiné à une application console qui utilise l’API Recherche d’images Bing pour charger une image et obtenir des informations à son sujet.
...
Vous trouverez ci-dessous l’intégralité du code source utilisé dans le cadre du didacticiel [Chargement d’images Bing pour obtenir des informations](tutorial-image-post.md) qui utilise le point de terminaison Recherche d’images avec une requête `POST`. Pour exécuter l’application, copiez le code source dans une application console C#. La compilation et l’exécution se font dans le débogueur Visual Studio.
