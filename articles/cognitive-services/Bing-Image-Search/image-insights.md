---
title: Obtenir des informations sur les images | Microsoft Docs
titleSuffix: Bing Web Search APIs - Cognitive Services
description: Décrit comment utiliser l’API Recherche d’images Bing pour obtenir plus d’informations sur une image.
...
ms.locfileid: "35369981"
---
# <a name="get-insights-about-an-image"></a>Obtenir des informations sur une image
...
Pour obtenir des informations sur une image, capturez le jeton [imageInsightsToken](https://docs.microsoft.com/rest/api/cognitiveservices/bing-images-api-v7-reference#image-imageinsightstoken) de l’image dans la réponse. 
...
Pour demander toutes les informations sur une image, définissez le paramètre de requête [modules](https://docs.microsoft.com/rest/api/cognitiveservices/bing-images-api-v7-reference#modulesrequested) sur `All`. Pour obtenir les recherches associées, la requête doit inclure la chaîne de requête de l’utilisateur. Cet exemple montre comment utiliser [insightsToken](https://docs.microsoft.com/rest/api/cognitiveservices/bing-images-api-v7-reference#insightstoken) pour spécifier l’image.  
...
L’objet de niveau supérieur est un objet [ImageInsightsResponse](https://docs.microsoft.com/rest/api/cognitiveservices/bing-images-api-v7-reference#imageinsightsresponse) au lieu d’objet un [Images](https://docs.microsoft.com/rest/api/cognitiveservices/bing-images-api-v7-reference#images).  
...
L’exemple suivant montre comment spécifier l’image à l’aide du paramètre [imgUrl](https://docs.microsoft.com/rest/api/cognitiveservices/bing-images-api-v7-reference#imgurl). N’oubliez pas de coder au format URL les paramètres de requête.  
...
-   Droite correspond à [car](https://docs.microsoft.com/rest/api/cognitiveservices/bing-images-api-v7-reference#car)  
-   Bas correspond à [cab](https://docs.microsoft.com/rest/api/cognitiveservices/bing-images-api-v7-reference#cab)  

## <a name="finding-visually-similar-images"></a>Recherche d’images visuellement similaires  

Pour rechercher des images qui sont visuellement similaires à l’image d’origine, définissez le paramètre de requête [modules](https://docs.microsoft.com/rest/api/cognitiveservices/bing-images-api-v7-reference#modulesrequested) sur SimilarImages.  
  
La requête suivante montre comment obtenir des images visuellement similaires. La requête utilise le paramètre de requête [insightsToken](https://docs.microsoft.com/rest/api/cognitiveservices/bing-images-api-v7-reference#insightstoken) pour identifier l’image d’origine. Pour améliorer la pertinence, vous devez inclure la chaîne de requête de l’utilisateur.  
...
Pour rechercher des images contenant des produits qui sont visuellement similaires aux produits trouvés dans l’image d’origine, définissez le paramètre de requête [modules](https://docs.microsoft.com/rest/api/cognitiveservices/bing-images-api-v7-reference#modulesrequested) sur SimilarProducts.  
  
La requête suivante montre comment obtenir des images de produits visuellement similaires. La requête utilise le paramètre de requête [insightsToken](https://docs.microsoft.com/rest/api/cognitiveservices/bing-images-api-v7-reference#insightstoken) pour identifier l’image d’origine qui a été retournée dans une requête précédente. Pour améliorer la pertinence, vous devez inclure la chaîne de requête de l’utilisateur.  
