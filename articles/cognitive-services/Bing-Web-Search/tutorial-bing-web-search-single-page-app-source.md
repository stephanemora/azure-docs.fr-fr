---
title: Application web à page unique Recherche Web Bing (code source) | Microsoft Docs
description: Code source pour un tutoriel expliquant comment utiliser l’API Recherche Web Bing dans une application web à page unique.
