---
title: Utilisation du classement pour afficher les réponses web | Microsoft Docs
description: Montre comment utiliser le classement pour afficher les réponses renvoyées par l’API Recherche Web Bing.
