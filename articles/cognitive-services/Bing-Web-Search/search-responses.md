---
title: Réponses de recherche - API Recherche Web Bing
titleSuffix: Azure Cognitive Services
description: Apprenez-en plus sur les types de réponses et sur les réponses issues par l’API Recherche Web Bing.
