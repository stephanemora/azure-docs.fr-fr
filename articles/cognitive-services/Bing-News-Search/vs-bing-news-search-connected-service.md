---
title: Tutoriel C# Recherche d’actualités Bing | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Connectez-vous à Cognitive Services Recherche d’actualités Bing sur une application web ASP.NET Core.
