...
Votre système d’approbation peut utiliser les [types de réponse d’API](self-service-sign-up-add-api-connector.md#expected-response-types-from-the-web-api) à partir des deux points de terminaison d’API pour contrôler le flux d’inscription.
