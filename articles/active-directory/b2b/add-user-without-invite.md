...
> [!NOTE]
> Désormais, les utilisateurs invités n’ont plus besoin de l’e-mail d’invitation, sauf dans certains cas spéciaux. Pour plus d’informations, consultez [Utilisation d'invitations B2B Collaboration](redemption-experience.md).  
...
2. L’administrateur de l’organisation hôte [définit les stratégies](delegate-invitations.md) qui permettent à Sam d’identifier et d’ajouter d’autres utilisateurs de l’organisation partenaire (Litware).
