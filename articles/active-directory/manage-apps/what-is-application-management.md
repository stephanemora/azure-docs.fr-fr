...
Pour commencer à intégrer des applications avec Azure AD, consultez le [Guide de prise en main de l’intégration d’Azure Active Directory avec les applications](plan-an-application-integration.md).

## <a name="see-also"></a>Voir aussi
* [Index d’articles pour la gestion des applications dans Azure Active Directory](../active-directory-apps-index.md)
* [Plan de déploiement étape par étape pour l’authentification unique dans une application SaaS](http://aka.ms/ssodeploymentplan)
