...
- URL interne :
    ...
    ![URL interne](./media/application-proxy-wildcard/42.png)


- URL externe :

    ![URL externe](./media/application-proxy-wildcard/43.png)

 
- SPN d’application interne : 

    ![Configuration SPN](./media/application-proxy-wildcard/44.png)
