...
2.  Le format de journal correspond au format standard attendu. Ce point est vérifié au moment du chargement. Pour optimiser le format de journal, consultez [Créer des rapports d’instantané Cloud App Discovery](cloud-app-discovery-create-snapshot-reports.md).
...
* [Créer des rapports d’instantanés](cloud-app-discovery-create-snapshot-reports.md)
