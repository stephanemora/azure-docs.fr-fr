...
Pour accorder le consentement administrateur aux autorisations sur Microsoft Graph et Azure AD Graph, vous avez besoin de privilèges d’administrateur général. 
