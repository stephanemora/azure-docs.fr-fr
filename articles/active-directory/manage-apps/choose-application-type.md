...
Le tableau ci-après décrit les différents modes d’authentification unique et d’approvisionnement pris en charge par chacun des types d’applications précédents. Vous pouvez utiliser ce tableau pour mieux comprendre quelle application vous devez ajouter pour répondre à un objectif précis.
  ...
  ![Tableau : Différents modes d’authentification unique et d’approvisionnement pris en charge par chaque type d’application](./media/choose-application-type/table1.png)
...
1. Tapez « **Azure Active Directory** » dans la zone de recherche de filtre et sélectionnez l’élément **Azure Active Directory**.
1. Cliquez sur **Applications d’entreprise** dans le menu de navigation de gauche d’Azure Active Directory.
1. Cliquez sur **Toutes les applications** pour afficher la liste complète de vos applications.
...
1. Sélectionnez l’application pour laquelle vous souhaitez configurer l’approvisionnement.
1. Une fois l’application chargée, cliquez sur **Approvisionnement** dans le menu de navigation de gauche de l’application.
