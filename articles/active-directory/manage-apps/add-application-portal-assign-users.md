---
title: 'Démarrage rapide : Affecter des utilisateurs à une application'
...
ms.locfileid: "114667166"
---
# <a name="quickstart-assign-users-to-an-application"></a>Démarrage rapide : Affecter des utilisateurs à une application
...
3. Cliquez sur le bouton **Ajouter un utilisateur/groupe**.
...
6. Lorsque vous avez terminé, choisissez **Sélectionner**.
   :::image type="content" source="./media/assign-user-or-group-access-portal/assign-users.png" alt-text="Affecter un utilisateur ou un groupe à l’application":::
