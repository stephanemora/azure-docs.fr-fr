---
title: Installer l’extension de navigateur du volet d’accès aux applications - Azure AD
...
Pour obtenir des instructions pas à pas sur la configuration et le déploiement d’une stratégie de groupe, consultez [Déployer l’extension du volet d’accès pour Internet Explorer à l’aide de la stratégie de groupe](deploy-access-panel-browser-extension.md).
