...
[Créer un point de terminaison SCIM et configurer le provisionnement lors de la création de votre propre application](use-scim-to-provision-users-and-groups.md)
