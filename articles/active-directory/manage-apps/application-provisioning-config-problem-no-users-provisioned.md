...
[Azure AD Connect Sync : présentation de l’approvisionnement déclaratif](../connect/active-directory-aadconnectsync-understanding-declarative-provisioning.md)
