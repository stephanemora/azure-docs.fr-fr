...
| Cette application d’entreprise n’est pas accessible pour l’instant. Réessayez ultérieurement... Le connecteur a dépassé le délai d’expiration. | Votre utilisateur peut recevoir cette erreur lorsque vous tentez d’accéder à l’application que vous avez publiée s’ils ne sont pas correctement définis pour cette application sur le côté local sur. Assurez-vous que les utilisateurs ont les autorisations appropriées, comme défini pour cette application principale sur l’ordinateur local sur. |
