---
title: Problèmes de connexion à une application Microsoft
...
La liste ci-après répertorie les problèmes couramment rencontrés lorsque les utilisateurs ne peuvent pas se connecter à une application Microsoft.
...
7. Une fois le **portail d’administration Multi-Factor Authentication** chargé, vérifiez que vous vous trouvez sur l’onglet **Utilisateurs**.
...
5. Sélectionnez **Tous les groupes**.

6. **Recherchez** le groupe qui vous intéresse et **cliquez sur la ligne** pour le sélectionner.

7. Sélectionnez **Membres** pour consulter la liste des utilisateurs affectés à ce groupe.
...
7. Sélectionnez **Règles d’appartenance dynamique**.
...
7. Sélectionnez **Licences** pour voir quelles licences sont actuellement affectées au groupe.
...
8. Sélectionnez le bouton **Retraiter** pour vérifier que les licences attribuées aux membres de ce groupe sont à jour. Cette opération peut être très longue, selon la taille et la complexité du groupe.
...
11. Sélectionnez le bouton **Attribuer** pour attribuer ces licences à ce groupe. Cette opération peut être très longue, selon la taille et la complexité du groupe.
...
4. Sélectionnez **Applications d’entreprise** dans le menu de navigation.

5. Sélectionnez l’élément de navigation **Accès conditionnel**.

6. Sélectionnez la stratégie que vous souhaitez examiner.
...
5. Sélectionnez **Toutes les applications**.
...
7. Sélectionnez l’élément de navigation **Accès conditionnel**.

8. Sélectionnez la stratégie que vous souhaitez examiner.
...
L’accès à l’application peut être bloqué, car l’opération de consentement avec les autorisations adéquates n’a pas eu lieu. La liste ci-après répertorie quelques méthodes pouvant vous aider à résoudre les problèmes de consentement d’application :
