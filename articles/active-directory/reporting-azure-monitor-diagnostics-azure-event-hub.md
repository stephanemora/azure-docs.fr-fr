...
---
# <a name="tutorial-stream-azure-ad-logs-to-an-azure-event-hub-preview"></a>Didacticiel : diffuser en continu des journaux d’activité Azure Active Directory sur un hub d’événements Azure (aperçu)

Dans ce didacticiel, découvrez comment configurer les paramètres de diagnostic Azure Monitor pour diffuser en continu des journaux d’activité Azure Active Directory sur un hub d’événements Azure. Ce mécanisme permet d’intégrer vos journaux d’activité Security Information and Event Management (SIEM) tiers, tels que Splunk et QRadar.
...
## <a name="archive-logs-to-an-event-hub"></a>Archiver des journaux d’activité dans un hub d’événements
