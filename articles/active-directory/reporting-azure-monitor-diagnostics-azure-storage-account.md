---
title: 'Didacticiel : Archiver des journaux d’activité Azure Active Directory dans un compte de stockage Azure (préversion) | Microsoft Docs'
...
4. Dans le volet **Paramètres de diagnostic**, effectuez l’une des opérations suivantes :
    * Pour modifier des paramètres existants, sélectionnez **Modifier le paramètre**.
    * Pour ajouter de nouveaux paramètres, sélectionnez **Ajouter un paramètre de diagnostic**.  
    ...
    ![Paramètres d’exportation](./media/reporting-azure-monitor-diagnostics-azure-storage-account/ExportSettings.png)
...
11. Sélectionnez **Enregistrer** pour enregistrer le paramètre.
    ...
    ![Paramètres de diagnostic](./media/reporting-azure-monitor-diagnostics-azure-storage-account/DiagnosticSettings.png)

12. Après environ 15 minutes, vérifiez que les journaux d’activité sont transmis à votre compte de stockage. Accédez au [portail Azure](https://portal.azure.com), sélectionnez **Comptes de stockage**, sélectionnez le compte de stockage que vous avez utilisé précédemment, puis sélectionnez **Blobs**. 

13. Dans **Journaux d’audit**, sélectionnez **insights-log-audit**. Dans **Journaux d’activité de connexion**, sélectionnez **insights-logs-signin**.
    ![Compte de stockage](./media/reporting-azure-monitor-diagnostics-azure-storage-account/StorageAccount.png)
