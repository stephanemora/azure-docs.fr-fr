...
Pour protéger votre environnement, il se peut que vous souhaitiez empêcher les utilisateurs suspects de se connecter à l’activité. [Azure Active Directory (Azure AD) Identity Protection](active-directory-identityprotection.md) analyse chaque connexion et calcule la probabilité qu’une tentative de connexion n’émane pas du propriétaire légitime d’un compte d’utilisateur. La probabilité (faible, moyenne ou élevée) est indiquée sous forme de valeurs calculées appelées [niveaux de risque de connexion](active-directory-conditional-access-conditions.md#sign-in-risk). En définissant la condition du risque de connexion, vous pouvez configurer une stratégie d’accès conditionnel afin de répondre aux niveaux de risque de connexion spécifiques. 
...
![Créer une stratégie](./media/active-directory-conditional-access-app-sign-in-risk/1000.png)
...
- **Identity Protection** : Identity Protection doit être activé pour suivre le scénario de ce démarrage rapide. Pour en savoir plus sur l’activation d’Identity Protection dans Azure AD, consultez la page [Activer Azure Active Directory Identity Protection](active-directory-identityprotection-enable.md).

- **Navigateur Tor** : le [navigateur Tor](https://www.torproject.org/projects/torbrowser.html.en) est conçu pour vous aider à préserver votre confidentialité en ligne. Identity Protection détecte les connexions à partir du navigateur Tor en tant que **connexions depuis des adresses IP anonymes**, offrant un niveau de risque moyen. Pour plus d’informations, consultez [Événements à risque dans Azure Active Directory](active-directory-reporting-risk-events.md).  
...
3. Dans la page **Azure Active Directory**, dans la section **Gérer**, cliquez sur **Accès conditionnel**.
    ...
    ![Accès conditionnel](./media/active-directory-conditional-access-app-sign-in-risk/03.png)
 
4. Dans la page **Accès conditionnel**, dans la barre d’outils en haut, cliquez sur **Ajouter**.

    ![NOM](./media/active-directory-conditional-access-app-sign-in-risk/108.png)

5. Sur la page **Nouveau**, dans la zone de texte **Nom**, saisissez **Block access for medium risk level**.

    ![NOM](./media/active-directory-conditional-access-app-sign-in-risk/104.png)

6. Dans la section **Affectation**, cliquez sur **Utilisateurs et groupes**.

    ![Utilisateurs et groupes](./media/active-directory-conditional-access-app-sign-in-risk/06.png)

7. Sur la page **Utilisateurs et groupes** :

    ![Accès conditionnel](./media/active-directory-conditional-access-app-sign-in-risk/107.png)
...
8. Cliquez sur **Applications cloud**.
    ...
    ![Applications cloud](./media/active-directory-conditional-access-app-sign-in-risk/08.png)

9. Sur la page **Applications cloud** :

    ![Accès conditionnel](./media/active-directory-conditional-access-app-sign-in-risk/109.png)
...
10. Dans la section **Contrôles d’accès**, cliquez sur **Accorder**.
    ...
    ![Contrôles d’accès](./media/active-directory-conditional-access-app-sign-in-risk/10.png)

11. Sur la page des **octrois** :

    ![Accès conditionnel](./media/active-directory-conditional-access-app-sign-in-risk/105.png)
...
12. Dans la section **Activer la stratégie**, cliquez sur **Activée**.
    ...
    ![Activer la stratégie](./media/active-directory-conditional-access-app-sign-in-risk/18.png)
...
![Utilisateur](./media/active-directory-conditional-access-app-sign-in-risk/117.png)
...
2. Cliquez sur **Utilisateur**, sélectionnez **Alain Charon** sur la page **Utilisateurs**, puis cliquez sur **Sélectionner**.
    ...
    ![Utilisateur](./media/active-directory-conditional-access-app-sign-in-risk/116.png)

3. Dans **Risque de connexion**, choisissez **Moyen**.

    ![Utilisateur](./media/active-directory-conditional-access-app-sign-in-risk/119.png)
...
- Pour supprimer votre stratégie, sélectionnez-la, puis cliquez sur **Supprimer** dans la barre d’outils Accès rapide.
    ...
    ![Authentification multifacteur](./media/active-directory-conditional-access-app-sign-in-risk/33.png)
...
> [Exiger une authentification multifacteur pour des applications spécifiques](./active-directory-conditional-access-app-based-mfa.md)
