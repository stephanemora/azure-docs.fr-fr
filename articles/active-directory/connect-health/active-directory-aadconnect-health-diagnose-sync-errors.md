...
Pour plus d’informations sur Azure AD, consultez [Synchronisation des identités et résilience d’attribut en double](https://aka.ms/dupattributeresdocs).
...
![Scénario courant de diagnostic d’erreur de synchronisation](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixCommonCase.png)
...
![Scénario Diagnostiquer une erreur de synchronisation - objet orphelin](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
...
![Scénario Diagnostiquer une erreur de synchronisation - objet orphelin *l’utilisateur existe-t-il*](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
...
![Scénario Diagnostiquer une erreur de synchronisation - objet orphelin *même utilisateur*](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
...
![Diagnostiquer une erreur de synchronisation après la correction](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixAfterFix.png)
