...
- Vous ne pouvez effectuer cette action que si Active Directory gère les informations d’identification de l’utilisateur. (Qu’est-ce que cela signifie ?)
