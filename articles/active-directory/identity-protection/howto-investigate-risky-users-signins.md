...
- ignorer le risque de l’utilisateur si vous pensez que les événements à risque actifs d’un utilisateur sont des faux positifs. Pour plus d’informations, consultez l’article [Fournir un feedback sur les événements à risque dans Azure AD Identity Protection](howto-provide-risk-event-feedback.md).
...
Pour plus d’informations, consultez l’article [Fournir un feedback sur les événements à risque dans Azure AD Identity Protection](howto-provide-risk-event-feedback.md).
