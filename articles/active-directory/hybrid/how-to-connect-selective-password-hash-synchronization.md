...
Si vous souhaitez exclure un sous-ensemble d'utilisateurs de la synchronisation du hachage de leurs mots de passe sur Azure AD, vous pouvez configurer la synchronisation sélective du hachage de mot de passe en suivant les étapes guidées fournies dans cet article.
