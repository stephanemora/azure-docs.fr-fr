...
* [Comptes dans Active Directory](reference-connect-accounts-permissions.md) si vous utilisez le chemin d’installation des paramètres personnalisés.
