...
| --- | --- | --- | --- |
| N/A |Utilisateur exécutant l’Assistant d’installation |Administrateur du serveur local |<li>Crée le compte de service ADSync à utiliser pour exécuter le service de synchronisation. |
