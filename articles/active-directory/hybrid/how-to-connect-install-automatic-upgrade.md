...
Notez que, pour des raisons de sécurité, l’agent qui effectue la mise à niveau automatique valide la nouvelle version d’Azure AD Connect en fonction de la signature numérique de la version téléchargée.
