...
![Création d’un réseau virtuel](./media/how-to-connect-fed-azure-adfs/deploynetwork1.png)
...
![Création d’un groupe de sécurité réseau](./media/how-to-connect-fed-azure-adfs/creatensg1.png)
...
![Initialisation d’un groupe de sécurité réseau](./media/how-to-connect-fed-azure-adfs/nsgint1.png)
...
![Configuration d’un groupe de sécurité réseau](./media/how-to-connect-fed-azure-adfs/nsgconfigure1.png)
...
![Rechercher un équilibreur de charge](./media/how-to-connect-fed-azure-adfs/browseloadbalancer.png)
...
![Configuration du pool principal de l’équilibreur de charge interne](./media/how-to-connect-fed-azure-adfs/ilbdeployment3.png)
...
![Configuration des règles d’équilibrage de l’équilibreur de charge interne](./media/how-to-connect-fed-azure-adfs/ilbdeployment5.png)
...
![Configuration de l’équilibreur de charge accessible sur Internet](./media/how-to-connect-fed-azure-adfs/elbdeployment3.png) 

![Configuration de l’équilibreur de charge accessible sur Internet (DNS)](./media/how-to-connect-fed-azure-adfs/elbdeployment4.png)
...
![Configuration d’un pool principal pour l’équilibreur de charge accessible sur Internet](./media/how-to-connect-fed-azure-adfs/elbdeployment5.png)
...
![Configuration des règles d’équilibrage de l’équilibreur de charge accessible sur Internet](./media/how-to-connect-fed-azure-adfs/elbdeployment7.png)
...
* [Configuration et gestion de vos services AD FS avec Azure AD Connect](how-to-connect-fed-whatis.md)
