...
![Composants requis](./media/how-to-connect-install-custom/requiredcomponents.png)
...
Pour en savoir plus, voir [Mode intermédiaire](how-to-connect-sync-operations.md#staging-mode).
