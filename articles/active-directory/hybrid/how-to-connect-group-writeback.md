...
9. Ouvrez Windows PowerShell sur le serveur Azure Active Directory Connect, puis exécutez les commandes suivantes.
...
Pour plus d’informations sur la configuration des groupes Office 365, consultez [Configurer des groupes Microsoft 365 dans un déploiement Exchange hybride local](https://docs.microsoft.com/exchange/hybrid-deployment/set-up-office-365-groups#enable-group-writeback-in-azure-ad-connect).
