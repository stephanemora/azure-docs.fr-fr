...
Pour plus d’informations, consultez l’article sur la [synchronisation de hachage de mot de passe](how-to-connect-password-hash-synchronization.md).
