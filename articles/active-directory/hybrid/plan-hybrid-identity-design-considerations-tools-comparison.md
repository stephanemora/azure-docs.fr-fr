...
- [L’approvisionnement cloud Azure AD Connect](../cloud-sync/what-is-cloud-sync.md) est un nouvel agent Microsoft pour la synchronisation entre AD DS et Azure AD, utile pour des scénarios tels que les fusions et acquisitions, où les forêts AD de la société acquise sont isolées de celles de l’entreprise parente.

Pour en savoir plus sur les différences entre la synchronisation Azure AD Connect et le provisionnement cloud Azure AD Connect, consultez l’article [Présentation du provisionnement cloud Azure AD Connect](../cloud-sync/what-is-cloud-sync.md)
