---
title: 'Didacticiel : Intégrer une forêt AD unique avec la synchronisation de hachage de mot de passe (PHS, password hash sync) | Microsoft Docs'
