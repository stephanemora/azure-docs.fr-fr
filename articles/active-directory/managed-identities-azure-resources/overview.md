...
## <a name="which-operations-can-i-perform-using-managed-identities"></a>Quelles opérations puis-je effectuer à l’aide des identités managées ?
