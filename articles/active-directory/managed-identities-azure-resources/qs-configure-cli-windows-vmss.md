...
Si vous devez [Activer](/cli/azure/vmss/identity/#az-vmss-identity-assign) l’identité managée affectée par le système sur un groupe de machines virtuelles identiques Azure existant :
