---
title: Changer le type d’appartenance au groupe statique en dynamique dans Azure Active Directory | Microsoft Docs
description: Comment créer des règles d’appartenance pour remplir automatiquement des groupes et une référence de règle.
