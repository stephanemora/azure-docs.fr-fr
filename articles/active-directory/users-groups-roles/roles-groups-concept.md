...
- Attribuer des groupes cloud à des rôles Azure AD (intégrés ou personnalisés) sur une unité administrative
...
- [Créer un groupe assignable à un rôle](roles-groups-create-eligible.md)
- [Attribuer un rôle à un groupe assignable à un rôle](roles-groups-assign-role.md)
