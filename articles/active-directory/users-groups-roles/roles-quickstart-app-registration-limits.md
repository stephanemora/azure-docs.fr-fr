...
- Pour plus d’informations sur les attributions de rôles Azure AD, consultez [Attribuer des rôles d’administrateur](directory-assign-admin-roles.md).
