---
title: Déléguer les autorisations de création et de gestion de l’administrateur d’application – Azure Active Directory | Microsoft Docs
...
Pour plus d’informations et pour afficher la description de ces rôles, consultez  [Rôles disponibles](directory-assign-admin-roles.md#available-roles).
...
- [Créez une *définition de rôle*](roles-create-custom.md) personnalisée et [ajoutez-lui des autorisations à partir d’une liste prédéfinie](roles-custom-available-permissions.md). Il s’agit des mêmes autorisations que celles utilisées dans les rôles intégrés.
- [Créez une *attribution de rôle*](roles-assign-powershell.md) pour attribuer le rôle personnalisé.
...
Pour plus d’informations sur les principes de base des rôles personnalisés, consultez [Vue d’ensemble des rôles personnalisés](roles-custom-overview.md), ainsi que la façon de [créer un rôle personnalisé](roles-create-custom.md) et d’[attribuer un rôle](roles-assign-powershell.md).

## <a name="next-steps"></a>Étapes suivantes

- [Autorisations et sous-types d’inscription d’application](roles-custom-available-permissions.md)
