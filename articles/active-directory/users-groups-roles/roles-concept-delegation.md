...
Déterminez les tâches Active Directory qui sont exécutées par les administrateurs et comment elles sont mappées aux rôles. Vous pouvez [voir des descriptions détaillées des rôles](directory-manage-roles-portal.md) dans le portail Azure.
