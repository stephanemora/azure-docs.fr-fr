...
- [Ajouter un utilisateur cloud](../fundamentals/add-users-azure-active-directory.md) et [Attribuer au nouvel utilisateur le rôle d’administrateur général](../fundamentals/active-directory-users-assign-role-azure-portal.md).
