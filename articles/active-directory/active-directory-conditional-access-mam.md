...
- Comment [configurer votre stratégie d’accès conditionnel](conditional-access/app-based-mfa.md)

- La [migration des stratégies d’accès conditionnel](conditional-access/best-practices.md#policy-migration).
...
Pour savoir comment configurer une stratégie d’accès conditionnel, consultez [Exiger une authentification multifacteur (MFA) pour des applications spécifiques disposant d’un accès conditionnel Azure Active Directory](conditional-access/app-based-mfa.md).
