...
3. Dans la fenêtre de terminal, envoyez une requête au point de terminaison des identités managées locales pour ressources Azure en vue d’obtenir un jeton d’accès pour Azure Resource Manager.  
