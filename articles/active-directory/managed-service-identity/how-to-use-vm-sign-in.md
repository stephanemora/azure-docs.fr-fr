...
- Accédez à la page **Extensions**, puis assurez-vous que l’extension d’identités managées pour ressources Azure a été déployée avec succès.
