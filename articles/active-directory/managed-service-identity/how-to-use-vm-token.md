...
Exemple de requête utilisant le point de terminaison d’extension de machine virtuelle d’identités managées pour ressources Azure *(prochainement déprécié)*  :
