---
title: Utiliser une identité managée attribuée par le système de la machine virtuelle Linux pour accéder à Azure Data Lake Store
...
Ce didacticiel vous indique comment utiliser une identité managée attribuée par le système de la machine virtuelle Linux afin d’accéder à Cosmos DB. Vous allez apprendre à effectuer les actions suivantes : 
...
- [Activer l’identité attribuée par le système sur votre machine virtuelle](/azure/active-directory/managed-service-identity/qs-configure-portal-windows-vm#enable-system-assigned-identity-on-an-existing-vm)
