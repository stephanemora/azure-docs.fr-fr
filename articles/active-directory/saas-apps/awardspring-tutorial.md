...
1. Dans la zone de recherche, tapez **AwardSpring**, sélectionnez **AwardSpring** dans le panneau de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
...
1. **[Créer un utilisateur de test AwardSpring](#create-an-awardspring-test-user)** pour avoir un équivalent de Britta Simon dans AwardSpring, associé à sa représentation dans Azure AD.
...
1. Dans la section **Domaine et URL AwardSpring**, suivez les étapes ci-dessous pour configurer l’application en mode initié par **IDP** :
