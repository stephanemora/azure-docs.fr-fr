...
> * [Authentification unique](./teamviewer-tutorial.md) auprès de TeamViewer (recommandée)
...
3. Déterminez les données à [mapper entre Azure AD et TeamViewer](../app-provisioning/customize-application-attributes.md). 
