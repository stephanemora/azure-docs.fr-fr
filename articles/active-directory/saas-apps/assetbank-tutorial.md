...
1. Dans la zone de recherche, tapez **Asset Bank**.

    ![Création d’un utilisateur de test Azure AD](./media/assetbank-tutorial/tutorial_assetbank_search.png)

1. Dans le panneau de résultats, sélectionnez **Asset Bank**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/assetbank-tutorial/tutorial_assetbank_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Asset Bank](#creating-an-asset-bank-test-user)** pour avoir un équivalent de Britta Simon dans Asset Bank lié à sa représentation Azure AD de l’utilisateur.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/assetbank-tutorial/tutorial_assetbank_samlbase.png)

1. Dans la section **Domaine et URL Asset Bank**, effectuez les étapes suivantes :

    ![Configurer l'authentification unique](./media/assetbank-tutorial/tutorial_assetbank_url.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/assetbank-tutorial/tutorial_general_400.png)

1. Pour configurer l’authentification unique côté **Asset Bank**, vous devez envoyer le fichier **XML des métadonnées** téléchargé à [l’équipe du support Asset Bank](mailto:support@assetbank.co.uk). 
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/assetbank-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/assetbank-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/assetbank-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/assetbank-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **Asset Bank**.
    ...
    ![Configurer l'authentification unique](./media/assetbank-tutorial/tutorial_assetbank_app.png) 
