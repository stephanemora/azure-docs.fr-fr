...
4. Dans la zone de recherche, tapez **AppDynamics**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/appdynamics-tutorial/tutorial_appdynamics_search.png)

5. Dans le panneau de résultats, sélectionnez **AppDynamics**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/appdynamics-tutorial/tutorial_appdynamics_addfromgallery.png)
...
10. Dans la section **Authentication Provider** , procédez comme suit :
    ...
    e. Cliquez sur **Enregistrer**.
     ...
     ![Enregistrer](./media/appdynamics-tutorial/ic777673.png "enregistrer")
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/appdynamics-tutorial/create_aaduser_01.png) 

2. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/appdynamics-tutorial/create_aaduser_02.png) 

3. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/appdynamics-tutorial/create_aaduser_03.png) 

4. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/appdynamics-tutorial/create_aaduser_04.png) 
...
2. Accédez à **Utilisateurs**, puis cliquez sur **+** pour ouvrir la boîte de dialogue **Créer un utilisateur**.
    ...
    ![Utilisateurs](./media/appdynamics-tutorial/ic790229.png "Utilisateurs")

3. Dans la section **Créer un utilisateur** , procédez comme suit :
   
    ![Créer un utilisateur](./media/appdynamics-tutorial/ic790230.png "Créer un utilisateur")
