...
ms.locfileid: "56204387"
---
# <a name="tutorial-azure-active-directory-integration-with-fluxx-labs"></a>Tutoriel : Intégration d’Azure Active Directory à Fluxx Labs
...
1. Dans la zone de recherche, tapez **Fluxx Labs**, sélectionnez **Fluxx Labs** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Fluxx Labs dans la liste des résultats](./media/fluxxlabs-tutorial/tutorial_fluxxlabs_addfromgallery.png)
...
1. **[Créer un utilisateur de test Fluxx Labs](#create-a-fluxx-labs-test-user)** pour avoir un équivalent de Britta Simon dans Fluxx Labs, lié à la représentation Azure AD de l’utilisateur.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Boîte de dialogue Authentification unique](./media/fluxxlabs-tutorial/tutorial_fluxxlabs_samlbase.png)

1. Dans la section **Domaine et URL Fluxx Labs**, procédez comme suit :

    ![Informations d’authentification unique dans Domaine et URL Fluxx Labs](./media/fluxxlabs-tutorial/tutorial_fluxxlabs_url.png)
...
1. Dans la section **Certificat de signature SAML**, cliquez sur **Téléchargez le certificat (Base64)** puis enregistrez le fichier du certificat sur votre ordinateur.
    ...
    ![Lien Téléchargement de certificat](./media/fluxxlabs-tutorial/tutorial_fluxxlabs_certificate.png) 

1. Cliquez sur le bouton **Enregistrer** .

    ![Bouton Enregistrer de la page Configurer l’authentification unique](./media/fluxxlabs-tutorial/tutorial_general_400.png)

1. Dans la section **Configuration de Fluxx Labs**, cliquez sur **Configurer Fluxx Labs** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez l **’URL du service d’authentification unique SAML** à partir de la **section Référence rapide.**

    ![Configuration de Fluxx Labs](./media/fluxxlabs-tutorial/tutorial_fluxxlabs_configure.png)

1. Dans une autre fenêtre de navigateur web, connectez-vous à votre site d’entreprise Fluxx Labs en tant qu’administrateur.

1. Sélectionnez **Admin** sous la section **Paramètres**.

    ![Configuration de Fluxx Labs](./media/fluxxlabs-tutorial/config1.png)

1. Dans le volet Administration, sélectionnez **Plug-ins** > **Intégrations**, puis **SAML SSO-(Disabled)** (Authentification unique SAML-(Désactivée))

    ![Configuration de Fluxx Labs](./media/fluxxlabs-tutorial/config2.png)

1. Dans la section d’attributs, procédez comme suit :
    ...
    f. Dans la zone de texte **URL SSO du fournisseur d’identité**, collez la valeur **URL du service d’authentification unique SAML** copiée dans le portail Azure.
...
1. Dans le volet gauche du Portail Azure, cliquez sur le bouton **Azure Active Directory**.
    ...
    ![Bouton Azure Active Directory](./media/fluxxlabs-tutorial/create_aaduser_01.png)

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.

    ![Liens « Utilisateurs et groupes » et « Tous les utilisateurs »](./media/fluxxlabs-tutorial/create_aaduser_02.png)

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue **Tous les utilisateurs**.

    ![Bouton Ajouter](./media/fluxxlabs-tutorial/create_aaduser_03.png)

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :

    ![Boîte de dialogue Utilisateur](./media/fluxxlabs-tutorial/create_aaduser_04.png)
...
1. Cliquez sur **l’icône** affichée ci-dessous.

    ![Configuration de Fluxx Labs](./media/fluxxlabs-tutorial/config6.png)

1. Dans le tableau de bord, cliquez sur l’icône affichée ci-dessous pour ouvrir la carte **New PEOPLE** (Nouvelles personnes).

    ![Configuration de Fluxx Labs](./media/fluxxlabs-tutorial/config4.png)

1. Dans la section **NEW PEOPLE** (NOUVELLES PERSONNES), procédez comme suit :
...
1. Dans la liste des applications, sélectionnez **Fluxx Labs**.
    ...
    ![Lien Fluxx Labs dans la liste des applications](./media/fluxxlabs-tutorial/tutorial_fluxxlabs_app.png)  
