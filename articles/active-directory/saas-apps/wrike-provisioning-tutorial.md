...
11. Pour configurer des filtres dՎtendue, suivez les instructions fournies dans le [tutoriel sur les filtres dՎtendue](../manage-apps/define-conditional-rules-for-provisioning-user-accounts.md).
