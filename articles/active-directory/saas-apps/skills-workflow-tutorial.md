...
Quand vous cliquez sur la vignette Skills Workflow dans le volet d’accès, vous devez vous connecter automatiquement à l’application Skills Workflow pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
