...
> * [Authentification unique](./mixpanel-tutorial.md) auprès de Mixpanel (recommandé)
...
3. Déterminez les données à [mapper entre Azure AD et Mixpanel](../app-provisioning/customize-application-attributes.md). 
