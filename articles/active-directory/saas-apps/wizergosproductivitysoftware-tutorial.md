---
title: 'Tutoriel : Intégration d’Azure Active Directory à Wizergos Productivity Software | Microsoft Docs'
...
ms.locfileid: "56208093"
---
# <a name="tutorial-azure-active-directory-integration-with-wizergos-productivity-software"></a>Tutoriel : Intégration d’Azure Active Directory à Wizergos Productivity Software
...
1. Dans la zone de recherche, tapez **Wizergos Productivity Software**, sélectionnez **Wizergos Productivity Software** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Wizergos Productivity Software dans la liste des résultats](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_addfromgallery.png)
...
1. **[Créez un utilisateur de test Wizergos Productivity Software](#create-a-wizergos-productivity-software-test-user)** pour avoir un équivalent de Britta Simon dans Wizergos Productivity Software qui soit lié à la représentation Azure AD associée.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Boîte de dialogue Authentification unique](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_samlbase.png)

1. Dans la section **Domaine et URL Wizergos Productivity Software**, effectuez les étapes suivantes :

    ![Informations d’authentification unique dans Domaine et URL Wizergos Productivity Software](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_url.png)

    Dans la zone de texte **Identificateur**, tapez l’URL : `https://www.wizergos.net`
...
1. Dans la section **Certificat de signature SAML**, cliquez sur **Certificat**, puis enregistrez le fichier du certificat sur votre ordinateur.
    ...
    ![Lien Téléchargement de certificat](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_certificate.png) 

1. Cliquez sur le bouton **Enregistrer** .

    ![Bouton Enregistrer de la page Configurer l’authentification unique](./media/wizergosproductivitysoftware-tutorial/tutorial_general_400.png)

1. Dans **Configuration de Wizergos Productivity Software**, cliquez sur **Configurer Wizergos Productivity Software** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez **l’URL de déconnexion, l’ID d’entité SAML et l’URL du service d’authentification unique SAML** à partir de la **section Référence rapide.**

    ![Configuration Wizergos Productivity Software](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_configure.png) 
...
1. Dans le menu de type hamburger, sélectionnez **Admin**(Administrateur).

    ![Configurer l’authentification unique côté application](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_000.png)

1. Dans le menu de gauche de la page Admin (Administrateur), sélectionnez **AUTHENTICATION** (AUTHENTIFICATION), puis cliquez sur **Azure AD**.

    ![Configurer l’authentification unique côté application](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_002.png)

1. Dans la section **AUTHENTICATION** (AUTHENTIFICATION), procédez comme suit :

    ![Configurer l’authentification unique côté application](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_003.png)
...
1. Dans le volet gauche du Portail Azure, cliquez sur le bouton **Azure Active Directory**.
    ...
    ![Bouton Azure Active Directory](./media/wizergosproductivitysoftware-tutorial/create_aaduser_01.png)

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.

    ![Liens « Utilisateurs et groupes » et « Tous les utilisateurs »](./media/wizergosproductivitysoftware-tutorial/create_aaduser_02.png)

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue **Tous les utilisateurs**.

    ![Bouton Ajouter](./media/wizergosproductivitysoftware-tutorial/create_aaduser_03.png)

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :

    ![Boîte de dialogue Utilisateur](./media/wizergosproductivitysoftware-tutorial/create_aaduser_04.png)
...
1. Dans la liste des applications, sélectionnez **Wizergos Productivity Software**.

    ![Lien Wizergos Productivity Software dans la liste des applications](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_app.png)  
