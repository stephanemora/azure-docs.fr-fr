...
1. Dans la zone de recherche, tapez **SAP NetWeaver**.

    ![Création d’un utilisateur de test Azure AD](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_search.png)

1. Dans le panneau de résultats, sélectionnez **SAP NetWeaver**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_addfromgallery.png)
...
1. **[Création d’un utilisateur de test SAP NetWeaver](#creating-an-sap-netweaver-test-user)** pour avoir un équivalent de Britta Simon dans SAP NetWeaver lié à la représentation Azure AD de l’utilisateur.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_samlbase.png)

1. Dans la section **SAP NetWeaver Domain and URLs** (Domaine et URL SAP NetWeaver), procédez comme suit :

    ![Configurer l'authentification unique](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_url.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/sap-netweaver-tutorial/tutorial_general_400.png)
    
1. Dans la section **SAP NetWeaver Configuration** (Configuration de SAP NetWeaver), cliquez sur **Configure SAP NetWeaver** (Configurer SAP NetWeaver) pour ouvrir la fenêtre **Configurer l’authentification**. Copiez **l’ID d’entité SAML** à partir de la **section Référence rapide**.

    ![Configurer l'authentification unique](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_configure.png) 

1. Pour configurer l’authentification unique côté **SAP NetWeaver**, vous devez envoyer le fichier **XML de métadonnées** téléchargé et **l’ID d’entité SAML** à [l’équipe de support SAP NetWeaver](https://www.sap.com/support.html). 
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/sap-netweaver-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/sap-netweaver-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/sap-netweaver-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/sap-netweaver-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **SAP NetWeaver**.
    ...
    ![Configurer l'authentification unique](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_app.png) 
