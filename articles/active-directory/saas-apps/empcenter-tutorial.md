...
1. Dans la zone de recherche, tapez **EmpCenter**.

    ![Création d’un utilisateur de test Azure AD](./media/empcenter-tutorial/tutorial_EmpCenter_search.png)

1. Dans le volet de résultats, sélectionnez **EmpCenter**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
...
1. **[Création d’un utilisateur de test EmpCenter](#creating-an-empcenter-test-user)** pour avoir un équivalent de Britta Simon dans EmpCenter lié à la représentation Azure AD de l’utilisateur.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/empcenter-tutorial/tutorial_EmpCenter_samlbase.png)

1. Dans la section **Domaine et URL EmpCenter**, effectuez les étapes suivantes :

    ![Configurer l'authentification unique](./media/empcenter-tutorial/tutorial_EmpCenter_url.png)
...
1. Dans la liste des applications, sélectionnez **EmpCenter**.

    ![Configurer l'authentification unique](./media/empcenter-tutorial/tutorial_EmpCenter_app.png) 
