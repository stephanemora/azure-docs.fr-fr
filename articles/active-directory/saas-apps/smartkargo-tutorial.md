---
title: 'Tutoriel : Intégration de l’authentification unique Azure Active Directory à SmartKargo | Microsoft Docs'
...
## <a name="adding-smartkargo-from-the-gallery"></a>Ajout de SmartKargo à partir de la galerie
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-smartkargo"></a>Configurer et tester l’authentification unique Azure AD pour SmartKargo
...
Pour configurer et tester l’authentification unique Azure AD avec SmartKargo, suivez les indications des sections ci-après :
...
1. Dans le [portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **SmartKargo**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
1. Dans la section **Configuration SAML de base**, entrez les valeurs pour les champs suivants :
    ...
    c. Dans la zone de texte **URL de réponse**, tapez une URL au format suivant : `https://<CUSTOMER_NAME>.smartkargo.com/SamlResponse.aspx`
...
Dans cette section, vous allez créer un utilisateur appelé B.Simon dans SmartKargo. Pour ajouter des utilisateurs à la plateforme SmartKargo, collaborez avec l’ [équipe de support technique de SmartKargo](https://www.smartkargo.com/company/contact-2/). Les utilisateurs doivent être créés et activés avant que vous utilisiez l’authentification unique.

## <a name="test-sso"></a>Tester l’authentification unique (SSO) 

Dans cette section, vous allez tester la configuration de l’authentification unique Azure AD à l’aide du volet d’accès.

Quand vous cliquez sur la vignette SmartKargo dans le volet d’accès, vous devez être connecté automatiquement à l’application SmartKargo pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Essayer SmartKargo avec Azure AD](https://aad.portal.azure.com/)

- [Qu’est-ce que le contrôle de session dans Microsoft Cloud App Security ?](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

- [Guide pratique pour protéger SmartKargo avec une visibilité et des contrôles avancés](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)