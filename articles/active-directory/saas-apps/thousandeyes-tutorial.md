...
**Pour ajouter ThousandEyes à partir de la galerie, effectuez les étapes suivantes :**
...
- [Configurer l’approvisionnement des utilisateurs](https://docs.microsoft.com/azure/active-directory/saas-apps/thousandeyes-provisioning-tutorial)
