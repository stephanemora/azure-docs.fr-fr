---
title: 'Tutoriel : Intégration d’Azure Active Directory à HeyBuddy | Microsoft Docs'
...
ms.locfileid: "55197889"
---
# <a name="tutorial-azure-active-directory-integration-with-heybuddy"></a>Tutoriel : Intégration d’Azure Active Directory à HeyBuddy
...
- Vous pouvez autoriser les utilisateurs à se connecter automatiquement à HeyBuddy (via l’authentification unique) avec leur compte Azure AD.
...
1. Ajout de HeyBuddy à partir de la galerie
...
4. Dans la zone de recherche, tapez **HeyBuddy**, sélectionnez **HeyBuddy** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
    ...
    ![HeyBuddy dans la liste des résultats](./media/heybuddy-tutorial/tutorial_heybuddy_addfromgallery.png)
...
Pour que l’authentification unique fonctionne, Azure AD doit savoir qui est l’utilisateur HeyBuddy équivalent dans Azure AD. En d’autres termes, une relation entre un utilisateur Azure AD et un utilisateur HeyBuddy associé doit être établie.
...
3. **[Création d’un utilisateur de test HeyBuddy](#creating-a-heybuddy-test-user)** pour avoir un équivalent de Britta Simon dans HeyBuddy lié à la représentation Azure AD de l’utilisateur.
4. **[Affectation de l’utilisateur de test Azure AD](#assigning-the-azure-ad-test-user)** : permet à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Test de l’authentification unique](#testing-single-sign-on)** pour vérifier si la configuration fonctionne.

### <a name="configuring-azure-ad-single-sign-on"></a>Configuration de l’authentification unique Azure AD

Dans cette section, vous allez activer l’authentification unique Azure AD dans le portail Azure et configurer l’authentification unique dans votre application HeyBuddy.

**Pour configurer l’authentification unique Azure AD avec HeyBuddy, procédez comme suit :**

1. Dans le Portail Azure, sur la page d’intégration de l’application **HeyBuddy**, cliquez sur **Authentification unique**.
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL HeyBuddy](./media/heybuddy-tutorial/tutorial_heybuddy_url.png)

    a. Dans la zone de texte **URL de connexion**, tapez une URL au format suivant : `https://api.heybuddy.com/auth/<ENTITY ID>`

    b. Dans la zone de texte **Identificateur (ID d’entité)**, entrez une URL au format suivant : `YourCompanyInstanceofHeyBuddy`
...
7. Sur la page **Certificat de signature SAML**, dans la section **Certificat de signature SAML**, cliquez sur l’**icône** de copie pour copier l’ **URL des métadonnées de fédération de l’application** , puis collez-la dans le bloc-notes.

    ![Lien Téléchargement de certificat](./media/heybuddy-tutorial/tutorial_heybuddy_certificate.png) 

8. Pour configurer l’authentification unique côté **HeyBuddy**, vous devez envoyer l’**URL des métadonnées de fédération de l’application** copiée à l’[équipe du support technique HeyBuddy](mailto:support@heybuddy.com). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
### <a name="creating-a-heybuddy-test-user"></a>Création d’un utilisateur de test HeyBuddy

L’objectif de cette section est de créer un utilisateur appelé Britta Simon dans HeyBuddy. HeyBuddy prend en charge l’approvisionnement juste-à-temps, option activée par défaut. Vous n’avez aucune opération à effectuer dans cette section. Un utilisateur est créé lors d’une tentative d’accès à HeyBuddy s’il n’existe pas déjà.
>[!Note]
...
2. Dans la liste des applications, sélectionnez **HeyBuddy**.
    ...
    ![Configurer l'authentification unique](./media/heybuddy-tutorial/tutorial_heybuddy_app.png)
...
Lorsque vous cliquez sur la vignette HeyBuddy dans le volet d’accès, vous devez être connecté automatiquement à votre application HeyBuddy.
