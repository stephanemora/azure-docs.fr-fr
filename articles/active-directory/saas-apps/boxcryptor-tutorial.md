...
Dans ce tutoriel, vous allez apprendre à intégrer Boxcryptor à Azure Active Directory (Azure AD). Quand vous intégrez Boxcryptor à Azure AD, vous pouvez :

* Contrôler qui a accès à Boxcryptor dans Azure AD.
* Permettre à vos utilisateurs de se connecter automatiquement à Boxcryptor avec leur compte Azure AD.
...
## <a name="add-boxcryptor-from-the-gallery"></a>Ajouter Boxcryptor depuis la galerie
...
1. Dans la section **Ajouter à partir de la galerie**, tapez **Boxcryptor** dans la zone de recherche.
1. Sélectionnez **Boxcryptor** dans le volet des résultats, puis ajoutez l’application. Patientez quelques secondes pendant que l’application est ajoutée à votre locataire.

## <a name="configure-and-test-azure-ad-sso-for-boxcryptor"></a>Configurer et tester l’authentification unique Azure AD pour Boxcryptor

Configurez et testez l’authentification unique Azure AD avec Boxcryptor pour un utilisateur de test nommé **B.Simon**. Pour que l’authentification unique fonctionne, vous devez établir un lien entre un utilisateur Azure AD et l’utilisateur associé dans Boxcryptor.

Pour configurer et tester l’authentification unique Azure AD avec Boxcryptor, effectuez les étapes suivantes :

1. **[Configurer l’authentification unique Azure AD](#configure-azure-ad-sso)** pour permettre à vos utilisateurs d’utiliser cette fonctionnalité.
    1. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec B. Simon.
    1. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à B. Simon d’utiliser l’authentification unique Azure AD.
1. **[Configurer l’authentification unique Boxcryptor](#configure-boxcryptor-sso)** pour configurer les paramètres de l’authentification unique côté application.
    1. **[Créer un utilisateur de test Boxcryptor](#create-boxcryptor-test-user)** pour avoir un équivalent de B.Simon dans Boxcryptor qui soit lié à la représentation Azure AD associée.
...
1. Dans la page d’intégration de l’application **Boxcryptor** du portail Azure, recherchez la section **Gérer**, puis sélectionnez **Authentification unique**.
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    a. Dans la zone de texte **URL de connexion**, tapez l’URL : `https://www.boxcryptor.com/app`
...
Dans cette section, vous allez autoriser B.Simon à utiliser l’authentification unique Azure en lui accordant l’accès à Boxcryptor.
...
## <a name="configure-boxcryptor-sso"></a>Configurer l’authentification unique Boxcryptor
...
* Cliquez sur **Tester cette application** dans le portail Azure. Cette opération redirige vers l’URL de connexion Boxcryptor, où vous pouvez lancer le processus de connexion. 
