...
1. Dans la zone de recherche, tapez **Cisco Spark**.

    ![Création d’un utilisateur de test Azure AD](./media/cisco-spark-tutorial/tutorial_ciscospark_search.png)

1. Dans le panneau de résultats, sélectionnez **Cisco Spark**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/cisco-spark-tutorial/tutorial_ciscospark_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Cisco Spark](#creating-a-cisco-spark-test-user)** pour avoir un équivalent de Britta Simon dans Cisco Spark, lié à la représentation Azure AD associée.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/cisco-spark-tutorial/tutorial_ciscospark_samlbase.png)

1. Dans la section **Domaine et URL Cisco Spark**, procédez comme suit :

    ![Configurer l'authentification unique](./media/cisco-spark-tutorial/tutorial_ciscospark_url.png)
...
1. Dans la section **Certificat de signature SAML**, cliquez sur **Métadonnées XML** puis enregistrez le fichier de métadonnées sur votre ordinateur.
    ...
    ![Configurer l'authentification unique](./media/cisco-spark-tutorial/tutorial_ciscospark_certificate.png) 

1. L’application Cisco Spark s’attend à ce que les assertions SAML contiennent des attributs spécifiques. Configurez les attributs suivants pour cette application. Vous pouvez gérer les valeurs de ces attributs à partir de la section **Attributs utilisateur** sur la page d’intégration des applications. La capture d’écran suivante montre un exemple :
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/cisco-spark-tutorial/tutorial_general_400.png)
...
1. Sélectionnez **Settings** (Paramètres), puis, dans la section **Authentication** (Authentification), cliquez sur **Modify** (Modifier).
   
    ![Configurer l'authentification unique](./media/cisco-spark-tutorial/tutorial_cisco_spark_10.png)
    
1. Sélectionnez **intégrer un fournisseur d’identité tiers. (Avancé)** et accédez à l’écran suivant.
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/cisco-spark-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/cisco-spark-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/cisco-spark-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/cisco-spark-tutorial/create_aaduser_04.png) 
...
1. Cliquez sur **Utilisateurs**, puis sur **Gérer les utilisateurs**.
   
    ![Configurer l'authentification unique](./media/cisco-spark-tutorial/tutorial_cisco_spark_12.png) 

1. Dans la fenêtre **Manage User** (Gérer l’utilisateur), sélectionnez **Manually add or modify users** (Ajouter ou modifier manuellement des utilisateurs), puis cliquez sur **Next** (Suivant).

1. Sélectionnez **Names and Email address** (Noms et adresse de messagerie). Ensuite, complétez la zone de texte comme suit :
...
1. Cliquez sur le signe plus pour ajouter Britta Simon. Cliquez ensuite sur **Suivant**.

1. Dans la fenêtre **Add Services for Users** (Ajouter des services pour les utilisateurs), cliquez sur **Save** (Enregistrer), puis sur **Finish** (Terminer).
...
1. Dans la liste des applications, sélectionnez **Cisco Spark**.

    ![Configurer l'authentification unique](./media/cisco-spark-tutorial/tutorial_ciscospark_app.png) 
