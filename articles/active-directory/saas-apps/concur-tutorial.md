...
1. Dans la zone de recherche, tapez **Concur**.

    ![Création d’un utilisateur de test Azure AD](./media/concur-tutorial/tutorial_concur_search.png)

1. Dans le volet de résultats, sélectionnez **Concur**, puis cliquez sur **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/concur-tutorial/tutorial_concur_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Concur](#creating-a-concur-test-user)** pour avoir un équivalent de Britta Simon dans Concur lié à la représentation Azure AD associée.
...
1. Dans la section **Domaine et URL Concur**, effectuez les étapes suivantes :
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l’authentification unique](./media/concur-tutorial/tutorial_general_400.png)
<CS>

1. Pour configurer l’authentification unique du côté **Concur**, vous devez envoyer le **XML de métadonnées** téléchargé aux techniciens du support technique Concur. Ils configurent ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/concur-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/concur-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/concur-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/concur-tutorial/create_aaduser_04.png) 
...
* [Configurer l’approvisionnement de l’utilisateur](concur-provisioning-tutorial.md)
