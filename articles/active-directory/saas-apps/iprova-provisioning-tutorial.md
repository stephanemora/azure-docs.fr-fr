---
title: 'Didacticiel : Configurer iProva pour l’approvisionnement automatique des utilisateurs avec Azure Active Directory | Microsoft Docs'
...
ms.locfileid: "74896811"
---
# <a name="tutorial-configure-iprova-for-automatic-user-provisioning"></a>Didacticiel : Configurer iProva pour l’approvisionnement automatique d’utilisateurs

L’objectif de ce didacticiel est de présenter les étapes à effectuer dans iProva et Azure Active Directory (Azure AD) pour configurer Azure AD pour l’approvisionnement et l’annulation de l’approvisionnement automatiques d’utilisateurs et/ou de groupes sur iProva.
...
## <a name="assigning-users-to-iprova"></a>Attribution d’utilisateurs à iProva

Azure Active Directory utilise un concept appelé *affectations* pour déterminer les utilisateurs devant recevoir l’accès aux applications sélectionnées. Dans le cadre d’une attribution automatique d’utilisateurs, seuls les utilisateurs ou les groupes auxquels une application a été attribuée dans Azure AD sont synchronisés.

Avant de configurer et d’activer l’approvisionnement automatique d’utilisateurs, vous devez décider quels utilisateurs et/ou groupes dans Azure AD ont besoin d’accéder à iProva. Une fois que vous avez choisi, vous pouvez attribuer ces utilisateurs et/ou groupes à iProva en suivant les instructions fournies ici :
* [Affecter un utilisateur ou un groupe à une application d’entreprise](../manage-apps/assign-user-or-group-access-portal.md)

## <a name="important-tips-for-assigning-users-to-iprova"></a>Conseils importants pour l’attribution d’utilisateurs à iProva

* Il est recommandé de n’attribuer qu’un seul utilisateur Azure AD à iProva pour tester la configuration de l’approvisionnement automatique d’utilisateurs. Les autres utilisateurs et/ou groupes peuvent être affectés ultérieurement.

* Quand vous attribuez un utilisateur à iProva, vous devez sélectionner un rôle valide propre à l’application (si possible) dans la boîte de dialogue d’attribution. Les utilisateurs dont le rôle est **Accès par défaut** sont exclus de l’approvisionnement.

## <a name="set-up-iprova-for-provisioning"></a>Configurer iProva pour l’approvisionnement
...
Avant de configurer iProva pour l’approvisionnement automatique d’utilisateurs avec Azure AD, vous devez ajouter iProva depuis la galerie d’applications Azure AD à votre liste d’applications SaaS managées.

**Pour ajouter iProva à partir de la galerie d’applications Azure AD, effectuez les étapes suivantes :**
...
4. Dans la zone de recherche, entrez **iProva**, sélectionnez **iProva** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![iProva dans la liste des résultats](common/search-new-app.png)

## <a name="configuring-automatic-user-provisioning-to-iprova"></a>Configuration de l’approvisionnement automatique d’utilisateurs sur iProva 
...
> [!TIP]
> Vous pouvez aussi choisir d’activer l’authentification unique basée sur SAML pour iProva en suivant les instructions fournies dans le [didacticiel sur l’authentification unique iProva](https://docs.microsoft.com/azure/active-directory/saas-apps/iProva-tutorial). La configuration de l’authentification unique est indépendante de celle de l’approvisionnement automatique d’utilisateurs, même si ces deux fonctionnalités se complètent.
...
8. Dans la section **Mappages**, sélectionnez **Synchroniser les utilisateurs Azure Active Directory sur iProva**.
    ...
    ![iProva – Mappages d’utilisateurs](media/iprova-provisioning-tutorial/usermappings.png)
...
9. Passez en revue les attributs utilisateur qui sont synchronisés entre Azure AD et iProva dans la section **Mappage d’attributs**. Les attributs sélectionnés en tant que propriétés de **correspondance** sont utilisés pour faire correspondre les comptes d’utilisateurs dans iProva pour les opérations de mise à jour. Cliquez sur le bouton **Enregistrer** pour valider les modifications.
    ...
    ![iProva – Attributs utilisateur](media/iprova-provisioning-tutorial/userattributes.png)

10. Dans la section **Mappages**, sélectionnez **Synchroniser les groupes Azure Active Directory sur iProva**.

    ![iProva – Mappages de groupes](media/iprova-provisioning-tutorial/groupmappings.png)
...
11. Passez en revue les attributs utilisateur qui sont synchronisés entre Azure AD et iProva dans la section **Mappage d’attributs**. Les attributs sélectionnés comme propriétés de **correspondance** sont utilisés afin de faire correspondre les groupes dans iProva pour les opérations de mise à jour. Cliquez sur le bouton **Enregistrer** pour valider les modifications.
    ...
    ![iProva – Attributs du groupe](media/iprova-provisioning-tutorial/groupattributes.png)
...
Cette opération démarre la synchronisation initiale de tous les utilisateurs et/ou groupes définis dans **Étendue** dans la section **Paramètres**. La synchronisation initiale prend plus de temps que les synchronisations suivantes, qui se produisent toutes les 40 minutes environ tant que le service de provisionnement Azure AD est en cours d’exécution. Vous pouvez utiliser la section **Détails de synchronisation** pour surveiller la progression et les liens vers les rapports d’activité d’approvisionnement, qui décrivent toutes les actions effectuées par le service d’approvisionnement Azure AD sur iProva.
