...
3. Déterminez les données à [mapper entre Azure AD et Bentley - Automatic User Provisioning](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
...
Ajoutez Bentley - Automatic User Provisioning à partir de la galerie d’applications Azure AD pour commencer à gérer le provisionnement vers Bentley - Automatic User Provisioning. En savoir plus sur l’ajout d’une application à partir de la galerie [ici](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app). 
