...
1. Dans la zone de recherche, tapez **Condeco**.

    ![Création d’un utilisateur de test Azure AD](./media/condeco-tutorial/tutorial_condeco_search.png)

1. Dans le volet des résultats, sélectionnez **Condeco**, puis cliquez sur **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/condeco-tutorial/tutorial_condeco_addfromgallery.png)
...
1. **[Création d’un utilisateur test Condeco](#creating-a-condeco-test-user)** pour avoir un équivalent de Britta Simon dans Condeco lié à la représentation Azure AD associée.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/condeco-tutorial/tutorial_condeco_samlbase.png)

1. Dans la section **Domaine et URL Condeco**, effectuez les étapes suivantes :

    ![Configurer l'authentification unique](./media/condeco-tutorial/tutorial_condeco_url.png)

    Dans la zone de texte **URL de connexion**, tapez une URL au format suivant : `https://<companyname>.condecosoftware.com`

    > [!NOTE] 
    > Cette valeur n’est pas la valeur réelle. Mettez à jour cette valeur avec l’URL d’authentification réelle. Contactez [l’équipe de support Condeco](mailTo:supportna@condecosoftware.com) pour obtenir cette valeur. 
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/condeco-tutorial/tutorial_general_400.png)

1. Pour configurer l’authentification unique côté **Condeco**, vous devez envoyer le fichier **XML des métadonnées** téléchargé à l’[équipe de support technique de Condeco](mailTo:supportna@condecosoftware.com). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/condeco-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/condeco-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/condeco-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/condeco-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **Condeco**.
    ...
    ![Configurer l'authentification unique](./media/condeco-tutorial/tutorial_condeco_app.png) 
