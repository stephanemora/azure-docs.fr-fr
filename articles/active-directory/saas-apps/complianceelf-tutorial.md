...
4. Dans la zone de recherche, tapez **Compliance ELF**, sélectionnez **Compliance ELF** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
    ...
    ![Compliance ELF dans la liste des résultats](./media/complianceelf-tutorial/tutorial_complianceelf_addfromgallery.png)
...
6. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Bouton Enregistrer de la page Configurer l’authentification unique](./media/complianceelf-tutorial/tutorial_general_400.png)
...
1. Dans le volet gauche du Portail Azure, cliquez sur le bouton **Azure Active Directory**.
    ...
    ![Bouton Azure Active Directory](./media/complianceelf-tutorial/create_aaduser_01.png)

2. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.

    ![Liens « Utilisateurs et groupes » et « Tous les utilisateurs »](./media/complianceelf-tutorial/create_aaduser_02.png)

3. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue **Tous les utilisateurs**.

    ![Bouton Ajouter](./media/complianceelf-tutorial/create_aaduser_03.png)

4. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :

    ![Boîte de dialogue Utilisateur](./media/complianceelf-tutorial/create_aaduser_04.png)
...
2. Dans la liste des applications, sélectionnez **Compliance ELF**.
    ...
    ![Lien Compliance ELF dans la liste des applications](./media/complianceelf-tutorial/tutorial_complianceelf_app.png)  
