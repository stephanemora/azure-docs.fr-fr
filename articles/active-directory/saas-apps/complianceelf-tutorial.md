---
title: 'Tutoriel : Intégration d’Azure Active Directory à Compliance ELF | Microsoft Docs'
...
Dans cette section, vous allez créer un utilisateur appelé Britta Simon dans Compliance ELF. Travaillez avec l’ [équipe de support de Compliance ELF](mailto:support@complianceelf.com) pour ajouter des utilisateurs à la plateforme Compliance ELF. Les utilisateurs doivent être créés et activés avant que vous utilisiez l’authentification unique.

### <a name="test-single-sign-on"></a>Tester l’authentification unique 

Dans cette section, vous allez tester la configuration de l’authentification unique Azure AD à l’aide du volet d’accès.

Quand vous cliquez sur la vignette Compliance ELF dans le volet d’accès, vous devez être connecté automatiquement à l’application Compliance ELF pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
