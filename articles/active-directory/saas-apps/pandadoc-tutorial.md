...
## <a name="configure-and-test-azure-ad-single-sign-on-for-pandadoc"></a>Configurer et tester l’authentification unique Azure AD pour PandaDoc
...
Quand vous cliquez sur la vignette PandaDoc dans le volet d’accès, vous devez être connecté automatiquement à l’application PandaDoc pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
...
- [Essayer PandaDoc avec Azure AD](https://aad.portal.azure.com/)