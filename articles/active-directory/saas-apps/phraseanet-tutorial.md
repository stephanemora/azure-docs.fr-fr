...
4. Dans la zone de recherche, tapez **Phraseanet** , sélectionnez **Phraseanet** dans le panneau de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
     ...
     ![Phraseanet dans la liste des résultats](common/search-new-app.png)
...
Pour que l’authentification unique fonctionne, une relation entre un utilisateur Azure AD et l’utilisateur Phraseanet associé doit être établie.
...
2. **[Configurer l’authentification unique Phraseanet](#configure-phraseanet-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test Phraseanet](#create-phraseanet-test-user)** pour avoir un équivalent de Britta Simon dans Phraseanet lié à la représentation Azure AD associée.
...
4. Dans la section **Configuration SAML de base** , effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL Phraseanet](common/sp-signonurl.png)

    Dans la zone de texte **URL de connexion** , tapez une URL au format suivant : `https://<SUBDOMAIN>.alchemyasp.com`
...
### <a name="configure-phraseanet-single-sign-on"></a>Configurer l’authentification unique Phraseanet
...
2. Dans la liste des applications, sélectionnez **Phraseanet** .
    ...
    ![Lien Phraseanet dans la liste des applications](common/all-applications.png)
...
### <a name="create-phraseanet-test-user"></a>Créer un utilisateur de test Phraseanet
...
Quand vous cliquez sur la vignette Phraseanet dans le volet d’accès, vous devez être connecté automatiquement à l’application Phraseanet pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
