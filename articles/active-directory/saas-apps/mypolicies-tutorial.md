...
1. Dans la zone de recherche, tapez **myPolicies**.

    ![Création d’un utilisateur de test Azure AD](./media/mypolicies-tutorial/tutorial_mypolicies_search.png)

1. Dans le panneau de résultats, sélectionnez **myPolicies**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/mypolicies-tutorial/tutorial_mypolicies_addfromgallery.png)
...
1. **[Création d’un utilisateur de test myPolicies](#creating-a-mypolicies-test-user)** pour avoir un équivalent de Britta Simon dans myPolicies lié à la représentation de l’utilisateur Azure AD.
...
1. Dans la section **Domaine et URL myPolicies**, procédez comme suit :
...
1. Pour ouvrir la fenêtre **Configurer l’authentification**, dans la section **Configuration de myPolicies**, cliquez sur **Configurer myPolicies**. Copiez l **’URL du service d’authentification unique SAML** à partir de la **section Référence rapide.**
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/mypolicies-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/mypolicies-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/mypolicies-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/mypolicies-tutorial/create_aaduser_04.png) 
