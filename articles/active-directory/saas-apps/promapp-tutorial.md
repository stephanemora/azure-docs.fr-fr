...
1. Dans la zone de recherche, entrez **Promapp**.

    ![Création d’un utilisateur de test Azure AD](./media/promapp-tutorial/tutorial_promapp_search.png)

1. Dans le volet de résultats, sélectionnez **Promapp**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/promapp-tutorial/tutorial_promapp_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Promapp](#creating-a-promapp-test-user)** pour avoir un équivalent de Britta Simon dans Promapp lié à la représentation Azure AD associée.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/promapp-tutorial/tutorial_promapp_samlbase.png)

1. Dans la section **Domaines et URL Promapp**, suivez les étapes ci-dessous si vous souhaitez configurer l’application en mode initié par **IDP** :
...
1. Si vous souhaitez configurer l’application en **mode démarré par le fournisseur de service**, cochez **Afficher les paramètres d’URL avancés**, puis effectuez les étapes suivantes :
    ...
    ![Configurer l'authentification unique](./media/promapp-tutorial/tutorial_promapp_url1.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/promapp-tutorial/tutorial_general_400.png)

1. Dans la section **Configuration de Promapp**, cliquez sur **Configurer Promapp** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez l **’URL du service d’authentification unique SAML** à partir de la **section Référence rapide.**

    ![Configurer l'authentification unique](./media/promapp-tutorial/tutorial_promapp_configure.png) 
...
1. Dans la boîte de dialogue **Security** , procédez comme suit :
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/promapp-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/promapp-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/promapp-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/promapp-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **Promapp**.

    ![Configurer l'authentification unique](./media/promapp-tutorial/tutorial_promapp_app.png) 
...
Pour tester votre application en mode initié par **SP** : vous devez lancer l’authentification à partir de votre site Promapp. Pour ce faire, cliquez sur le bouton « Login with Single Sign-on » (Connexion avec authentification unique) de votre page de connexion après avoir activé le mode **Facultatif**.
