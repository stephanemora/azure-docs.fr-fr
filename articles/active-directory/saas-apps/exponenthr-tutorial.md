---
title: 'Didacticiel : Intégration de l’authentification unique Azure Active Directory à ExponentHR | Microsoft Docs'
...
ms.locfileid: "72271899"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-exponenthr"></a>Didacticiel : Intégration de l’authentification unique Azure Active Directory à ExponentHR
...
Quand vous cliquez sur la vignette ExponentHR dans le volet d’accès, vous devez vous connecter automatiquement à l’application ExponentHR pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
