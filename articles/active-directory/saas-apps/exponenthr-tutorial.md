...
* Vous pouvez utiliser Mes applications de Microsoft. Quand vous cliquez sur la mosaïque ExponentHR dans Mes applications, une redirection est effectuée vers l’URL de connexion à ExponentHR. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).
