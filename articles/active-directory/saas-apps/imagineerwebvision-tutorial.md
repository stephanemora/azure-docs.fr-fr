---
title: "Didacticiel : Intégration d'Azure Active Directory à Imagineer WebVision | Microsoft Docs"
...
* Imagineer WebVision prend en charge l’authentification unique lancée par le **fournisseur de services**
...
4. Dans la zone de recherche, tapez **Imagineer WebVision**, sélectionnez **Imagineer WebVision** dans le panneau de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
    ...
    ![Imagineer WebVision dans la liste des résultats](common/search-new-app.png)
...
Pour que l’authentification unique fonctionne, une relation entre l’utilisateur Azure AD et l’utilisateur Imagineer WebVision associé doit être établie.
...
2. **[Configurer l’authentification unique Imagineer WebVision](#configure-imagineer-webvision-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test Imagineer WebVision](#create-imagineer-webvision-test-user)** pour avoir un équivalent de Britta Simon dans Imagineer WebVision qui soit lié à la représentation Azure AD associée.
...
1. Dans le [portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **Imagineer WebVision**, sélectionnez **Authentification unique**.
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL Imagineer WebVision](common/sp-identifier.png)

    a. Dans la zone de texte **URL de connexion**, saisissez une URL au format suivant : `https://<YOUR SERVER URL>/<yourapplicationloginpage>`

    b. Dans la zone de texte **Identificateur (ID d’entité)** , saisissez une URL au format suivant : `https://<YOUR SERVER URL>/<yourapplicationloginpage>`

    > [!NOTE]
    > Il ne s’agit pas de valeurs réelles. Mettez à jour ces valeurs avec l’URL de connexion et l’identificateur réels. Pour obtenir ces valeurs, contactez [l’équipe du support technique d’Imagineer WebVision](mailto:support@itgny.com). Vous pouvez également consulter les modèles figurant à la section **Configuration SAML de base** dans le portail Azure.
...
### <a name="configure-imagineer-webvision-single-sign-on"></a>Configurer l’authentification unique Imagineer WebVision

Pour configurer l’authentification unique côté **Imagineer WebVision**, vous devez envoyer **l’URL des métadonnées de fédération de l’application** à [l’équipe du support technique Imagineer WebVision](mailto:support@itgny.com). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
1. Dans le Portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis sélectionnez **Imagineer WebVision**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **Imagineer WebVision**.

    ![Lien Imagineer WebVision dans la liste des applications](common/all-applications.png)
...
### <a name="create-imagineer-webvision-test-user"></a>Créer un utilisateur de test Imagineer WebVision
...
Lorsque vous cliquez sur la vignette Imagineer WebVision dans le panneau d’accès, vous êtes connecté automatiquement à votre application Imagineer WebVision pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
