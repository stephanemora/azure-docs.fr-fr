...
Lorsque vous cliquez sur la vignette Imagineer WebVision dans le panneau d’accès, vous êtes connecté automatiquement à votre application Imagineer WebVision pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
