---
title: 'Tutoriel : Intégration de l’authentification unique (SSO) Azure Active Directory à MyVR | Microsoft Docs'
...
ms.locfileid: "92522544"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-myvr"></a>Tutoriel : Intégration de l’authentification unique (SSO) Azure Active Directory à MyVR
...
* MyVR prend en charge l’authentification unique initiée par le **fournisseur de services et le fournisseur d’identité**.
* MyVR prend en charge le provisionnement d’utilisateurs **juste-à-temps**.
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-myvr"></a>Configurer et tester l’authentification unique Azure AD pour MyVR

Configurez et testez l’authentification unique Azure AD auprès de MyVR avec un utilisateur de test appelé **B.Simon**. Pour que l’authentification unique fonctionne, vous devez établir un lien entre un utilisateur Azure AD et l’utilisateur MyVR associé.
...
1. Si vous souhaitez configurer l’application en **mode démarré par le fournisseur de services**, cliquez sur **Définir des URL supplémentaires**, puis effectuez les étapes suivantes :
    ...
    Dans la zone de texte **URL de connexion**, tapez une URL : `https://ess.virtualroster.net/ess/login.aspx`

1. L’application MyVR s’attend à recevoir les assertions SAML dans un format spécifique, ce qui vous oblige à ajouter des mappages d’attributs personnalisés à la configuration des attributs du jeton SAML. La capture d’écran suivante montre la liste des attributs par défaut.
...
Quand vous cliquez sur la vignette MyVR dans le volet d’accès, vous devez être connecté automatiquement à l’application MyVR pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
...
- [Essayer MyVR avec Azure AD](https://aad.portal.azure.com/)