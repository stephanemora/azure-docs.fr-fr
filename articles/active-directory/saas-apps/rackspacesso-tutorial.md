...
Pour que l’authentification unique fonctionne, une relation entre un utilisateur Azure AD et l’utilisateur Rackspace SSO associé doit être établie.
...
5. **[Créer un utilisateur de test Rackspace SSO](#create-rackspace-sso-test-user)** pour avoir un équivalent de Britta Simon dans Rackspace SSO lié à la représentation Azure AD associée.
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    Dans la zone de texte **URL de connexion**, tapez une URL : `https://login.rackspace.com/federate/`

5. Sur la page **Configurer l’authentification unique avec SAML**, dans la section **Certificat de signature SAML**, cliquez sur **Télécharger** pour télécharger le fichier **XML de métadonnées de fédération** en fonction des options définies selon vos besoins, puis enregistrez-le sur votre ordinateur.

    ![Lien Téléchargement de certificat](common/metadataxml.png)

6. Dans la section **Configurer Rackspace SSO**, copiez la ou les URL appropriées en fonction de vos besoins.
...
Pour configurer l’authentification unique côté **Rackspace SSO**, vous devez envoyer le **XML des métadonnées de fédération** téléchargé et les URL correspondantes copiées à partir du portail Azure à l’[équipe du support technique Rackspace SSO](https://support.rackspace.com/). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
### <a name="create-rackspace-sso-test-user"></a>Créer un utilisateur de test Rackspace SSO

Dans cette section, vous créez un utilisateur nommé Britta Simon dans Rackspace SSO. Collaborez avec l’ [équipe de support Rackspace SSO](https://support.rackspace.com/) pour ajouter les utilisateurs à la plateforme Rackspace SSO. Les utilisateurs doivent être créés et activés avant que vous utilisiez l’authentification unique.
