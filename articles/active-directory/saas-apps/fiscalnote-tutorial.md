---
title: 'Didacticiel : Intégration d’Azure Active Directory à FiscalNote | Microsoft Docs'
...
* Vous pouvez permettre aux utilisateurs de se connecter automatiquement à FiscalNote (par le biais de l’authentification unique) avec leur compte Azure AD.
...
4. Dans la zone de recherche, tapez **FiscalNote**, sélectionnez **FiscalNote** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

     ![FiscalNote dans la liste des résultats](common/search-new-app.png)
...
Pour que l’authentification unique fonctionne, une relation entre l’utilisateur Azure AD et l’utilisateur FiscalNote associé doit être établie.
...
2. **[Configurer l’authentification unique FiscalNote](#configure-fiscalnote-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test FiscalNote](#create-fiscalnote-test-user)** pour avoir un équivalent de Britta Simon dans FiscalNote, lié à la représentation Azure AD de l’utilisateur.
...
1. Dans le [portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **FiscalNote**, sélectionnez **Authentification unique**.
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL FiscalNote](common/sp-identifier.png)
...
5. L’application FiscalNote s’attend à recevoir les assertions SAML dans un format spécifique, ce qui vous oblige à ajouter des mappages d’attributs personnalisés à votre configuration Attributs du jeton SAML. La capture d’écran suivante montre la liste des attributs par défaut. Cliquez sur l’icône Modifier pour ajouter les attributs.

    ![image](common/edit-attribute.png)

6. L’application FiscalNote s’attend à ce que quelques attributs de plus soient transmis dans la réponse SAML, en plus de ceux ci-dessus. Dans la section **Revendications des utilisateurs** de la boîte de dialogue **Attributs utilisateur**, effectuez les étapes suivantes pour ajouter le jeton SAML comme indiqué dans le tableau ci-dessous :
...
7. Dans la page **Configurer l’authentification unique avec SAML**, à la section **Certificat de signature SAML**, cliquez sur **Télécharger** pour télécharger le **Certificat (Raw)** en fonction des options définies, puis enregistrez-le sur votre ordinateur.

    ![Lien Téléchargement de certificat](common/certificateraw.png)

8. Dans la section **Configurer FiscalNote**, copiez la ou les URL appropriées en fonction de vos besoins.
...
### <a name="configure-fiscalnote-single-sign-on"></a>Configurer l’authentification unique de FiscalNote
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis **FiscalNote**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **FiscalNote**.

    ![Lien FiscalNote dans la liste des applications](common/all-applications.png)
...
Lorsque vous cliquez sur la vignette FiscalNote dans le volet d’accès, vous devez être connecté automatiquement à l’application FiscalNote pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
