...
* Après avoir configuré Harmony, vous pouvez appliquer le contrôle de session, qui protège contre l’exfiltration et l’infiltration des données sensibles de votre organisation en temps réel. Le contrôle de session est étendu à partir de l’accès conditionnel. [Découvrez comment appliquer un contrôle de session avec Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).

## <a name="adding-harmony-from-the-gallery"></a>Ajout de Harmony à partir de la galerie
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-harmony"></a>Configurer et tester l’authentification unique Azure AD pour Harmony
...
Pour configurer et tester l’authentification unique Azure AD avec Harmony, suivez les indications des sections ci-après :
...
1. Sur le [portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **Harmony** , recherchez la section **Gérer** , puis sélectionnez **Authentification unique**.
...
Quand vous cliquez sur la vignette Harmony dans le volet d’accès, vous devez vous être connecté automatiquement à l’application Harmony pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
...
- [Essayer Harmony avec Azure AD](https://aad.portal.azure.com/)

- [Qu’est-ce que le contrôle de session dans Microsoft Cloud App Security ?](/cloud-app-security/proxy-intro-aad)

- [Guide pratique pour protéger Harmony avec une visibilité et des contrôles avancés](/cloud-app-security/proxy-intro-aad)