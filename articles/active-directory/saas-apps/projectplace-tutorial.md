...
ms.locfileid: "55175132"
---
# <a name="tutorial-azure-active-directory-integration-with-projectplace"></a>Tutoriel : Intégration d’Azure Active Directory à Projectplace
...
1. Dans la zone de recherche, saisissez **Projectplace**.

    ![Création d’un utilisateur de test Azure AD](./media/projectplace-tutorial/tutorial_projectplace_search.png)

1. Dans le panneau des résultats, sélectionnez **Projectplace**, puis cliquez sur **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/projectplace-tutorial/tutorial_projectplace_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Projectplace](#creating-a-projectplace-test-user)** pour obtenir un équivalent de Britta Simon dans Projectplace lié à la représentation Azure AD de l’utilisateur.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/projectplace-tutorial/tutorial_projectplace_samlbase.png)

1. Dans la section **Domaine et URL Projectplace**, procédez comme suit :

    ![Configurer l'authentification unique](./media/projectplace-tutorial/tutorial_projectplace_url.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/projectplace-tutorial/tutorial_general_400.png)
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/projectplace-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/projectplace-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/projectplace-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/projectplace-tutorial/create_aaduser_04.png) 
...
1. Accédez à **People**, puis cliquez sur **Members**.
...
1. Dans la section **Add Member** , procédez comme suit :
...
1. Dans la liste des applications, sélectionnez **Projectplace**.
    ...
    ![Configurer l'authentification unique](./media/projectplace-tutorial/tutorial_projectplace_app.png) 
