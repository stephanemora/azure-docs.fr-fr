...
1. Dans la zone de recherche, saisissez **Innotas**.

    ![Création d’un utilisateur de test Azure AD](./media/innotas-tutorial/tutorial_innotas_search.png)

1. Dans le volet de résultats, sélectionnez **Innotas**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/innotas-tutorial/tutorial_innotas_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Innotas](#creating-an-innotas-test-user)** : pour avoir un équivalent de Britta Simon dans Innotas lié à la représentation de l’utilisateur Azure AD.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/innotas-tutorial/tutorial_innotas_samlbase.png)

1. Dans la section **Domaine et URL Innotas**, procédez comme suit :

    ![Configurer l'authentification unique](./media/innotas-tutorial/tutorial_innotas_url.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/innotas-tutorial/tutorial_general_400.png)

1. Pour configurer l’authentification unique du côté **Innotas**, vous devez envoyer le **XML de métadonnées** téléchargé à [l’équipe de support technique d’Innotas](https://www.innotas.com/contact). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/innotas-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/innotas-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/innotas-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/innotas-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **Innotas**.
    ...
    ![Configurer l'authentification unique](./media/innotas-tutorial/tutorial_innotas_app.png) 
