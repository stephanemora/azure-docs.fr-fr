...
**Pour ajouter Thoughtworks Mingle à partir de la galerie, effectuez les étapes suivantes :**
...
3. Dans la section **SSO Config**, procédez comme suit :
    ...
    a. Pour télécharger le fichier de métadonnées, cliquez sur **Choose file**. 
...
5. Dans la boîte de dialogue **New User** , procédez comme suit :
    ...
    b. Comme **User type**, sélectionnez **Full user**.
