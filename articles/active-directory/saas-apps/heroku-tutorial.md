...
1. Dans la zone de recherche, tapez **Heroku**.

    ![Création d’un utilisateur de test Azure AD](./media/heroku-tutorial/tutorial_heroku_search.png)

1. Dans le volet de résultats, sélectionnez **Heroku**, puis cliquez sur **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/heroku-tutorial/tutorial_heroku_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Heroku](#creating-a-heroku-test-user)** pour avoir un équivalent de Britta Simon dans Heroku lié à la représentation Azure AD associée.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/heroku-tutorial/tutorial_heroku_samlbase.png)

1. Dans la section **Domaine et URL Heroku**, effectuez les étapes suivantes :

    ![Configurer l'authentification unique](./media/heroku-tutorial/tutorial_heroku_url.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/heroku-tutorial/tutorial_general_400.png)

1. Pour activer SSO dans Heroku, procédez comme suit :
    ...
    ![Configurer l'authentification unique](./media/heroku-tutorial/tutorial_heroku_52.png) 
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/heroku-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/heroku-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/heroku-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/heroku-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **Heroku**.
    ...
    ![Configurer l'authentification unique](./media/heroku-tutorial/tutorial_heroku_app.png) 
