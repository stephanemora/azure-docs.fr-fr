...
* Vous pouvez autoriser les utilisateurs à se connecter automatiquement à Opal (par le biais de l’authentification unique) avec leur compte Azure AD.
...
* Abonnement Opal pour lequel l’authentification unique est activée
...
**Pour ajouter Opal à partir de la galerie, effectuez les étapes suivantes :**
...
4. Dans la zone de recherche, tapez **Opal**, sélectionnez **Opal** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
     ...
     ![Opal dans la liste des résultats](common/search-new-app.png)
...
Pour que l’authentification unique fonctionne, une relation entre un utilisateur Azure AD et l’utilisateur Opal associé doit être établie.
...
2. **[Configurer l’authentification unique Opal](#configure-opal-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test Opal](#create-opal-test-user)** pour avoir un équivalent de Britta Simon dans Opal lié à la représentation Azure AD associée.
...
Pour configurer l’authentification unique Azure AD avec Opal, effectuez les étapes suivantes :

1. Dans le [portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **Opal**, sélectionnez **Authentification unique**.
...
4. Sur la page **Configurer l’authentification unique avec SAML**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Opal Domain and URLs (Domaines et URL Opal)](common/idp-intiated.png)
...
6. En plus de ce qui précède, l’application Opal s’attend à ce que quelques attributs supplémentaires soient repassés dans la réponse SAML. Dans la section **Revendications des utilisateurs** de la boîte de dialogue **Attributs utilisateur**, effectuez les étapes suivantes pour ajouter le jeton SAML comme indiqué dans le tableau ci-dessous :
...
8. Dans la section **Configurer Opal**, copiez l’URL ou les URL appropriées en fonction de vos besoins.
...
### <a name="configure-opal-single-sign-on"></a>Configurer l’authentification unique Opal
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis **Opal**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **Opal**.

    ![Lien Opal dans la liste des applications](common/all-applications.png)
