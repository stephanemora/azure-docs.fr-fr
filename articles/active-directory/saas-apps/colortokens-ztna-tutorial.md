...
## <a name="configure-and-test-azure-ad-single-sign-on-for-colortokens-ztna"></a>Configurer et tester l’authentification unique Azure AD pour ColorTokens ZTNA
...
Pour configurer et tester l’authentification unique Azure AD avec ColorTokens ZTNA, suivez les indications des sections ci-après :
...
1. Dans le [portail Azure](https://portal.azure.com/), accédez à la page d’intégration de l’application **ColorTokens ZTNA**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
1. Dans la section **Configuration SAML de base**, entrez les valeurs pour les champs suivants :
    ...
    a. Dans la zone de texte **URL de connexion**, saisissez une URL au format suivant : `https://<COLORMASTER_HOST>/colormaster/api/v1/<TENANT_NAME>/saml/login?resourceId=<RESOURCEID>&iwa=<TRUE/FALSE>`

    b. Dans la zone de texte **Identificateur (ID d’entité)** , saisissez une URL au format suivant : `https://<COLORMASTER_HOST>.com/<TENANT_NAME>`

    c. Dans la zone de texte **URL de réponse**, tapez une URL au format suivant : `https://<COLORMASTER_HOST>.com/<TENANT_NAME>`
...
Quand vous cliquez sur la vignette ColorTokens ZTNA dans le volet d’accès, vous devez être connecté automatiquement à l’application ColorTokens ZTNA pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Essayer ColorTokens ZTNA avec Azure AD](https://aad.portal.azure.com/)

- [Qu’est-ce que le contrôle de session dans Microsoft Cloud App Security ?](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)

- [Guide pratique pour protéger ColorTokens ZTNA avec une visibilité et des contrôles avancés](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)