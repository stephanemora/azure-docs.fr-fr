...
Pour plus d’informations sur la lecture des journaux d’activité de provisionnement Azure AD, consultez [Créer des rapports sur le provisionnement automatique de comptes d’utilisateur](../app-provisioning/check-status-user-account-provisioning.md).
