...
* Vous pouvez autoriser les utilisateurs à se connecter automatiquement à itslearning (via l’authentification unique) avec leur compte Azure AD.
...
4. Dans la zone de recherche, tapez **itslearning** , sélectionnez **itslearning**  dans le panneau de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

     ![itslearning dans la liste des résultats](common/search-new-app.png)
...
Pour que l’authentification unique fonctionne, une relation entre un utilisateur Azure AD et l’utilisateur itslearning associé doit être établie.
...
2. **[Configurer l’authentification unique itslearning](#configure-itslearning-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Création d’un utilisateur de test itslearning](#create-itslearning-test-user)** pour avoir un équivalent de Britta Simon dans itslearning lié à la représentation Azure AD de l’utilisateur.
...
1. Dans le [portail Azure](https://portal.azure.com/), sur la page d’intégration de l’application **itslearning**, sélectionnez **Authentification unique**.
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique Domaine et URL itslearning](common/sp-identifier.png)
...
### <a name="configure-itslearning-single-sign-on"></a>Configuration de l’authentification unique itslearning
...
1. Dans le Portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis sélectionnez **itslearning**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **itslearning**.

    ![Lien itslearning dans la liste des applications](common/all-applications.png)
