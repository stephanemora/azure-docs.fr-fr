...
* Vous pouvez permettre aux utilisateurs de se connecter automatiquement à Kiteworks (par le biais de l’authentification unique) avec leur compte Azure AD.
...
4. Dans la zone de recherche, tapez **Kiteworks**, sélectionnez **Kiteworks** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

     ![Kiteworks dans la liste des résultats](common/search-new-app.png)
...
Pour que l’authentification unique fonctionne, une relation entre l’utilisateur Azure AD et l’utilisateur Kiteworks associé doit être établie.
...
2. **[Configurer l’authentification unique Kiteworks](#configure-kiteworks-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
...
1. Dans le [portail Azure](https://portal.azure.com/), sur la page d’intégration de l’application **Kiteworks**, sélectionnez **Authentification unique**.
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL Kiteworks](common/sp-identifier.png)

    a. Dans la zone de texte **URL de connexion**, saisissez une URL au format suivant : `https://<subdomain>.kiteworks.com`

    b. Dans la zone de texte **Identificateur (ID d’entité)** , saisissez une URL au format suivant : `https://<subdomain>.kiteworks.com/sp/module.php/saml/sp/saml2-acs.php/sp-sso`
...
6. Dans la section **Configurer Kiteworks**, copiez l’URL appropriée (ou les URL) en fonction de vos besoins.
...
### <a name="configure-kiteworks-single-sign-on"></a>Configurer l’authentification unique Kiteworks
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis **Kiteworks**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **Kiteworks**.

    ![Lien Kiteworks dans la liste des applications](common/all-applications.png)
...
Le fait de cliquer sur la vignette Kiteworks dans le panneau d’accès doit vous connecter automatiquement à l’application Kiteworks pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
