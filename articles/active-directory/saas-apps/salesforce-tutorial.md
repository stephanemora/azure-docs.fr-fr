...
4. **[Créer un utilisateur de test Salesforce](#create-salesforce-test-user)** pour disposer, dans Salesforce, d’un équivalent de Britta Simon lié à la représentation Azure AD de l’utilisateur.
