...
* Vous pouvez utiliser Mes applications de Microsoft. Le fait de cliquer sur la vignette Zoom dans Mes applications vous redirige vers l’URL de connexion Zoom. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).
