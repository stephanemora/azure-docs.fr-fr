...
* Vous pouvez permettre aux utilisateurs de se connecter automatiquement à Anaplan (par le biais de l’authentification unique) avec leur compte Azure AD.
...
* Anaplan prend en charge l’authentification unique lancée par le **fournisseur de services**
...
Dans cette section, vous allez configurer et tester l’authentification unique Azure AD auprès d’Anaplan sur un utilisateur de test nommé **Britta Simon**.
Pour que l’authentification unique fonctionne, une relation entre un utilisateur Azure AD et l’utilisateur Anaplan associé doit être établie.
...
2. **[Configurer l’authentification unique Anaplan](#configure-anaplan-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test Anaplan](#create-anaplan-test-user)** pour avoir un équivalent de Britta Simon dans Anaplan, associé à sa représentation dans Azure AD.
...
Pour configurer l’authentification unique Azure AD auprès d’Anaplan, effectuez les étapes suivantes :

1. Dans le [portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **Anaplan**, sélectionnez **Authentification unique**.
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL Anaplan](common/sp-identifier.png)
...
### <a name="configure-anaplan-single-sign-on"></a>Configurer l’authentification unique Anaplan
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis **Anaplan**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **Anaplan**.

    ![Lien Anaplan dans la liste des applications](common/all-applications.png)
...
Quand vous cliquez sur la vignette Anaplan dans le volet d’accès, vous devez vous connecter automatiquement à l’application Anaplan pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
