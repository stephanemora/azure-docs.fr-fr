...
- Vous pouvez autoriser vos utilisateurs à se connecter automatiquement à BorrowBox (via l’authentification unique) avec leur compte Azure AD.
...
- Un abonnement dans lequel l’authentification unique BorrowBox est activée
...
1. Ajout de BorrowBox à partir de la galerie
...
Dans cette section, vous allez configurer et tester l’authentification unique Azure AD avec BorrowBox avec un utilisateur de test appelé « Britta Simon ».

Pour que l’authentification unique fonctionne, Azure AD doit savoir quel utilisateur dans BorrowBox correspond un utilisateur dans Azure AD. En d’autres termes, une relation entre un utilisateur Azure AD et l’utilisateur BorrowBox associé doit être établie.
...
3. **[Créer un utilisateur de test BorrowBox](#create-a-borrowbox-test-user)** pour avoir un utilisateur correspondant à Britta Simon dans BorrowBox et lié à la représentation de cet utilisateur dans Azure AD.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Tester l’authentification unique](#test-single-sign-on)** : pour vérifier si la configuration fonctionne.

### <a name="configure-azure-ad-single-sign-on"></a>Configurer l’authentification unique Azure AD

Dans cette section, vous allez activer l’authentification unique Azure AD dans le portail Azure et configurer l’authentification unique dans votre application BorrowBox.

**Pour configurer l’authentification unique Azure AD avec BorrowBox, procédez comme suit :**
...
4. Dans la section **Configuration SAML de base**, l’utilisateur n’a rien à faire, car l’application est déjà intégrée à Azure.
    ...
    b. Dans la zone de texte **URL de connexion**, tapez une URL au format suivant : `https://fe.bolindadigital.com/wldcs_bol_fo/b2i/mainPage.html?b2bSite=<ID>`.
...
### <a name="create-a-borrowbox-test-user"></a>Créer un utilisateur de test BorrowBox
...
Lorsque vous cliquez sur la vignette de BorrowBox dans le volet d’accès, vous devez vous connecter automatiquement à votre application BorrowBox.
