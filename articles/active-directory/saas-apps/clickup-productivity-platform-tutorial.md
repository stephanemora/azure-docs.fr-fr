...
* Vous pouvez utiliser Mes applications de Microsoft. Lorsque vous cliquez sur la vignette de ClickUp Productivity Platform dans Mes applications, vous êtes redirigez vers l'URL de connexion à ClickUp Productivity Platform. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).
