...
## <a name="adding-single-sign-on-for-skytap-from-the-gallery"></a>Ajout de Single Sign-on for Skytap à partir de la galerie
...
Configurez et testez l’authentification unique Azure AD avec Single Sign-on for Skytap à l’aide d’un utilisateur de test appelé **B.Simon**. Pour que l’authentification unique fonctionne, vous devez établir un lien entre un utilisateur Azure AD et l’utilisateur Single Sign-on for Skytap associé.

Pour configurer et tester l’authentification unique Azure AD avec Single Sign-on for Skytap, suivez les indications des modules ci-après :
...
1. **[Configurer l’authentification unique Single Sign-on for Skytap](#configure-single-sign-on-for-skytap-sso)** pour configurer les paramètres de l’authentification unique côté application.
    1. **[Créer un utilisateur de test Single Sign-on for Skytap](#create-single-sign-on-for-skytap-test-user)** pour avoir un équivalent de B.Simon dans Single Sign-on for Skytap qui soit lié à la représentation Azure AD de l’utilisateur.
...
1. Dans le [portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **Single Sign-on for Skytap**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
Pour configurer l’authentification unique côté **Single Sign-on for Skytap**, vous devez envoyer le **XML des métadonnées de fédération** téléchargé et les URL appropriées copiées à partir du portail Azure à l’[équipe du support Single Sign-on for Skytap](mailto:support@skytap.com). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.


### <a name="create-single-sign-on-for-skytap-test-user"></a>Créer un utilisateur de test Single Sign-on for Skytap

Dans cette section, vous allez créer un utilisateur appelé Britta Simon dans Single Sign-on for Skytap. Collaborez avec l’ [équipe du support technique de Single Sign-on for Skytap](mailto:support@skytap.com) pour ajouter les utilisateurs à la plateforme Single Sign-on for Skytap. Les utilisateurs doivent être créés et activés avant que vous utilisiez l’authentification unique.

## <a name="test-sso"></a>Tester l’authentification unique (SSO) 

Dans cette section, vous allez tester la configuration de l’authentification unique Azure AD à l’aide du volet d’accès.

Quand vous cliquez sur la vignette Single Sign-on for Skytap dans le volet d’accès, vous devez être connecté automatiquement à l’application Single Sign-on for Skytap pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
