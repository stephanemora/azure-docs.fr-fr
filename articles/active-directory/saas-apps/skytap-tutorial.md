...
4. Dans la zone de recherche, tapez **Skytap**, sélectionnez **Skytap** dans le panneau de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
...
3. **[Créer un utilisateur de test Skytap](#create-a-skytap-test-user)** pour avoir un équivalent de Britta Simon dans Skytap qui soit associé à la représentation de l’utilisateur Azure AD.
...
3. Dans la section **Domaines et URL Skytap**, suivez les étapes ci-dessous si vous souhaitez configurer l’application en mode initié par **IDP** :
...
7. Pour configurer l’authentification unique côté **Skytap**, vous devez envoyer le **fichier XML de métadonnées** téléchargé à [l’équipe du support technique de Skytap](mailto:support@skytap.com). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
