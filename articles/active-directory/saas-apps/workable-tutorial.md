...
4. À la section **Configuration SAML de base**, si vous souhaitez configurer l’application en mode initié par **IDP**, suivez les étapes ci-dessous :
    ...
    ![Capture d’écran montrant Configuration SAML de base où vous pouvez entrer une URL de réponse](common/both-replyurl.png)
...
3. Dans les propriétés de l’utilisateur, effectuez les étapes suivantes.
    ...
    b. Dans le champ **User name**, entrez `brittasimon@yourcompanydomain.extension` (par exemple, `brittasimon@contoso.com`).
...
Le fait de cliquer sur la vignette Workable dans le panneau d’accès doit vous connecter automatiquement à l’application Workable pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
