...
ms.locfileid: "55170248"
---
# <a name="tutorial-azure-active-directory-integration-with-neota-logic-studio"></a>Tutoriel : Intégration d’Azure Active Directory à Neota Logic Studio
...
1. Dans la zone de recherche, tapez **Neota Logic Studio**.

    ![Création d’un utilisateur de test Azure AD](./media/neotalogicstudio-tutorial/tutorial_neotalogicstudio_search.png)

1. Dans le volet de résultats, sélectionnez **Neota Logic Studio**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/neotalogicstudio-tutorial/tutorial_neotalogicstudio_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Neota Logic Studio](#creating-a-neota-logic-studio-test-user)** pour avoir un équivalent de Britta Simon dans Neota Logic Studio lié à la représentation Azure AD de l’utilisateur.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/neotalogicstudio-tutorial/tutorial_neotalogicstudio_samlbase.png)

1. Dans la section **Domaine et URL Neota Logic Studio**, effectuez les étapes suivantes :

    ![Configurer l'authentification unique](./media/neotalogicstudio-tutorial/tutorial_neotalogicstudio_url.png)
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/neotalogicstudio-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/neotalogicstudio-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/neotalogicstudio-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/neotalogicstudio-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **Neota Logic Studio**.

    ![Configurer l'authentification unique](./media/neotalogicstudio-tutorial/tutorial_neotalogicstudio_app.png) 
...
Cliquez sur la mosaïque Neota Logic Studio dans le volet d’accès. Vous êtres alors redirigé vers la page de connexion à Organization. Une fois la connexion établie, vous êtes connecté à votre application Neota Logic Studio. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/active-directory-saas-access-panel-introduction.md).
