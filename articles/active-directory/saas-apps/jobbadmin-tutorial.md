...
1. Dans la zone de recherche, tapez **Jobbadmin**.

    ![Création d’un utilisateur de test Azure AD](./media/jobbadmin-tutorial/tutorial_jobbadmin_search.png)

1. Dans le panneau de résultats, sélectionnez **Jobbadmin**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/jobbadmin-tutorial/tutorial_jobbadmin_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Jobbadmin](#creating-a-jobbadmin-test-user)** pour avoir un équivalent de Britta Simon dans Jobbadmin lié à la représentation Azure AD de l’utilisateur.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/jobbadmin-tutorial/tutorial_jobbadmin_samlbase.png)

1. Dans la section **Jobbadmin Domain and URLs** (Domaine et URL Jobadmin), procédez comme suit :

    ![Configurer l'authentification unique](./media/jobbadmin-tutorial/tutorial_jobbadmin_url.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/jobbadmin-tutorial/tutorial_general_400.png)

1. Pour configurer l’authentification unique du côté **Jobbadmin**, vous devez envoyer le **XML de métadonnées** téléchargé à [l’équipe de support technique Jobbadmin](https://www.jobbnorge.no/om-oss/kontakt-oss). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/jobbadmin-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/jobbadmin-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/jobbadmin-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/jobbadmin-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **Jobbadmin**.

    ![Configurer l'authentification unique](./media/jobbadmin-tutorial/tutorial_jobbadmin_app.png) 
