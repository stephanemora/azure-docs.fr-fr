...
1. Dans la zone de recherche, tapez **ICIMS**, sélectionnez **ICIMS** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![ICIMS dans la liste des résultats](./media/icims-tutorial/tutorial_icims_addfromgallery.png)
...
1. **[Créer un utilisateur de test ICIMS](#create-an-icims-test-user)** pour avoir dans ICIMS un équivalent de Britta Simon lié à la représentation Azure AD associée.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Boîte de dialogue Authentification unique](./media/icims-tutorial/tutorial_icims_samlbase.png)

1. Dans la section **ICIMS Domain and URLs** (Domaine et URL ICIMS), procédez comme suit :

    ![Informations d’authentification unique dans ICIMS Domain and URLs (Domaine et URL ICIMS)](./media/icims-tutorial/tutorial_icims_url.png)
...
1. Dans la section **Certificat de signature SAML**, cliquez sur **Métadonnées XML** puis enregistrez le fichier de métadonnées sur votre ordinateur.
    ...
    ![Lien Téléchargement de certificat](./media/icims-tutorial/tutorial_icims_certificate.png) 

1. Cliquez sur le bouton **Enregistrer** .

    ![Bouton Enregistrer de la page Configurer l’authentification unique](./media/icims-tutorial/tutorial_general_400.png)

1. Dans la section **ICIMS Configuration** (Configuration d’ICIMS), cliquez sur **Configure ICIMS** (Configurer ICIMS) pour ouvrir la fenêtre **Configurer l’authentification**. Copiez **l’URL de déconnexion, l’ID d’entité SAML et l’URL du service d’authentification unique SAML** à partir de la **section Référence rapide.**

    ![Configuration d’ICIMS](./media/icims-tutorial/tutorial_icims_configure.png) 
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Bouton Azure Active Directory](./media/icims-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Liens « Utilisateurs et groupes » et « Tous les utilisateurs »](./media/icims-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Bouton Ajouter](./media/icims-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Boîte de dialogue Utilisateur](./media/icims-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **ICIMS**.
    ...
    ![Lien ICIMS dans la liste des applications](./media/icims-tutorial/tutorial_icims_app.png) 
