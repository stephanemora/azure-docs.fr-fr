...
## <a name="configure-and-test-azure-ad-single-sign-on-for-icims"></a>Configurer et tester l’authentification unique Azure AD pour ICIMS
...
Pour configurer et tester l’authentification unique Azure AD avec ICIMS, suivez les indications des sections ci-après :
...
1. Dans le [portail Azure](https://portal.azure.com/), accédez à la page d’intégration de l’application **ICIMS** , recherchez la section **Gérer** et sélectionnez **Authentification unique** .
...
1. Dans la section **Configuration SAML de base** , effectuez les étapes suivantes :
    ...
    b. Dans la zone de texte **Identificateur** , tapez une URL : `icims.com`

    c. Dans la zone de texte **URL de réponse** , tapez l’URL : `https://.icims.com/`
...
Quand vous cliquez sur la vignette ICIMS dans le volet d’accès, vous devez être connecté automatiquement à l’application ICIMS pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
...
- [Essayer ICIMS avec Azure AD](https://aad.portal.azure.com/)
