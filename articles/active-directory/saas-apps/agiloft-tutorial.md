...
Dans ce tutoriel, vous allez apprendre à intégrer Agiloft dans Azure Active Directory (Azure AD). Quand vous intégrez Agiloft à Azure AD, vous pouvez :

* Contrôler dans Azure AD qui a accès à Agiloft.
* Permettre à vos utilisateurs de se connecter automatiquement à Agiloft avec leur compte Azure AD.
...
## <a name="add-agiloft-from-the-gallery"></a>Ajout d’Agiloft à partir de la galerie
...
1. Dans la section **Ajouter à partir de la galerie**, tapez **Agiloft** dans la zone de recherche.
1. Sélectionnez **Agiloft** dans le volet de résultats, puis ajoutez l’application. Patientez quelques secondes pendant que l’application est ajoutée à votre locataire.

## <a name="configure-and-test-azure-ad-sso-for-agiloft"></a>Configurer et tester Azure AD SSO pour Agiloft

Configurez et testez l’authentification SSO Azure AD avec Agiloft pour un utilisateur de test nommé **B.Simon**. Pour que l'authentification unique fonctionne, vous devez établir un lien entre un utilisateur Azure AD et l'utilisateur associé dans Agiloft.

Pour configurer et tester Azure AD SSO avec Agiloft, effectuez les étapes suivantes :

1. **[Configurer l’authentification unique Azure AD](#configure-azure-ad-sso)** pour permettre à vos utilisateurs d’utiliser cette fonctionnalité.
    1. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec B. Simon.
    1. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à B. Simon d’utiliser l’authentification unique Azure AD.
1. **[Configurer l’authentification unique Agiloft](#configure-agiloft-sso)** pour configurer les paramètres de l’authentification unique côté application.
    1. **[Créer un utilisateur de test Agiloft](#create-agiloft-test-user)** pour avoir un équivalent de B.Simon dans Agiloft, associé à sa représentation dans Azure AD.
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **Agiloft**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
Dans cette section, vous allez autoriser B.Simon à utiliser l’authentification unique Azure en accordant l’accès à Agiloft.

1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, puis **Toutes les applications**.
1. Dans la liste des applications, sélectionnez **Agiloft**.
...
## <a name="configure-agiloft-sso"></a>Configurer l’authentification unique Agiloft
...
4. Une boîte de dialogue d’assistant s’affiche. Dans la boîte de dialogue, cliquez sur **Identity Provider Details** (Détails du fournisseur d’identité) et renseignez les champs suivants :  
    ...
    ![Configuration d’Agiloft](./media/agiloft-tutorial/details.png)
...
* Cliquez sur **Tester cette application** dans le portail Azure. Vous êtes alors redirigé vers l’URL de connexion à Agiloft à partir de laquelle vous pouvez lancer le flux de connexion.  

* Accédez directement à l’URL de connexion à Agiloft pour lancer le flux de connexion.

#### <a name="idp-initiated"></a>Lancée par le fournisseur d’identité :

* Cliquez sur **Tester cette application** dans le portail Azure : vous devez être connecté automatiquement à l’instance de Agiloft pour laquelle vous avez configuré l’authentification unique. 

Vous pouvez aussi utiliser Mes applications de Microsoft pour tester l’application dans n’importe quel mode. Si, quand vous cliquez sur la vignette Agiloft dans Mes applications, le mode Fournisseur de services est configuré, vous êtes redirigé vers la page de connexion de l’application pour lancer le flux de connexion ; s’il s’agit du mode Fournisseur d’identité, vous êtes automatiquement connecté à l’instance d’Agiloft pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Étapes suivantes

Après avoir configuré Agiloft, vous pouvez appliquer le contrôle de session, qui protège en temps réel contre l’exfiltration et l’infiltration des données sensibles de votre organisation. Le contrôle de session est étendu à partir de l’accès conditionnel. [Découvrez comment appliquer un contrôle de session avec Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-aad).
