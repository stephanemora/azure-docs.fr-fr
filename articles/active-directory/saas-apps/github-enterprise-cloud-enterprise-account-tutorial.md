...
Lorsque vous cliquez sur la vignette GitHub Enterprise Cloud – Enterprise Account dans le volet d’accès, vous devez être connecté automatiquement au GitHub Enterprise Cloud – Enterprise Account pour lequel vous configurez l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
