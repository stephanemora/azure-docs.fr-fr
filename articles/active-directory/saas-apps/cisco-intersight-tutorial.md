...
* Vous pouvez utiliser Mes applications de Microsoft. Un clic sur la vignette Cisco Intersight dans Mes applications vous redirige vers l’URL de connexion à Cisco Intersight. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
