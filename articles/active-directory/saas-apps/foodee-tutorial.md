...
* Foodee prend en charge l’attribution d’utilisateurs **juste-à-temps**.
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-foodee"></a>Configurer et tester l’authentification unique Azure AD pour Foodee
...
Quand vous cliquez sur la vignette Foodee dans le volet d’accès, vous devez être connecté automatiquement à l’application Foodee pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
...
- [Essayer Foodee avec Azure AD](https://aad.portal.azure.com/)