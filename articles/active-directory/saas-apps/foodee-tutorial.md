---
title: 'Tutoriel : Intégration de l’authentification unique (SSO) Azure Active Directory à Foodee | Microsoft Docs'
...
ms.locfileid: "128604882"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-foodee"></a>Tutoriel : Intégration de l’authentification unique (SSO) Azure Active Directory à Foodee
...
* Foodee prend en charge l’authentification unique lancée par **le fournisseur de services et le fournisseur d’identité**.
* Foodee prend en charge le provisionnement d’utilisateurs **juste-à-temps**.
* Foodee prend en charge le [provisionnement d’utilisateurs automatisé](foodee-provisioning-tutorial.md).
...
## <a name="configure-and-test-azure-ad-sso-for-foodee"></a>Configurer et tester l’authentification unique Azure AD pour Foodee
...
Pour configurer et tester l’authentification unique Azure AD avec Foodee, effectuez les étapes suivantes :

1. **[Configurer l’authentification unique Azure AD](#configure-azure-ad-sso)** pour permettre à vos utilisateurs d’utiliser cette fonctionnalité.
    1. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec B. Simon.
    1. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à B. Simon d’utiliser l’authentification unique Azure AD.
1. **[Configurer l’authentification unique Foodee](#configure-foodee-sso)** pour configurer les paramètres de l’authentification unique côté application.
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **Foodee**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
### <a name="configure-foodee-sso"></a>Configurer l’authentification unique Foodee

1. Pour automatiser la configuration dans Foodee, vous devez installer l’**extension de navigateur My Apps Secure Sign-in** en cliquant sur **Installer l’extension**.

    ![Extension My apps](common/install-myappssecure-extension.png)

2. Après l’ajout de l’extension au navigateur, cliquez sur **Configurer Foodee** pour être dirigé vers l’application Foodee. À partir de là, indiquez les informations d’identification de l’administrateur pour vous connecter à Foodee. Cette extension de navigateur configure automatiquement l’application et automatise les étapes 3 et 4.

    ![Configuration](common/setup-sso.png)

3. Si vous souhaitez configurer manuellement Foodee, ouvrez une nouvelle fenêtre de navigateur web, connectez-vous à votre site d’entreprise Foodee en tant qu’administrateur et effectuez les étapes suivantes :

4. Cliquez sur **profile logo** (Logo de profil) dans l’angle supérieur droit de la page, puis accédez à **Single Sign On** (Authentification unique) et effectuez les étapes suivantes :

   ![Configuration de Foodee](./media/foodee-tutorial/profile-logo.png)
...
Foodee prend également en charge le provisionnement automatique d’utilisateurs ; vous trouverez plus d’informations [ici](./foodee-provisioning-tutorial.md) sur la façon de configurer ce dernier.
...
* Cliquez sur Tester cette application dans le portail Azure. Vous êtes alors redirigé vers l’URL de connexion à Foodee, d’où vous pouvez lancer le flux de connexion.

* Accédez directement à l’URL de connexion à Foodee pour lancer le flux de connexion.

Lancée par le fournisseur d’identité :

* Cliquez sur Tester cette application dans le portail Azure : vous devez être connecté automatiquement à l’instance de Foodee pour laquelle vous avez configuré l’authentification unique.

Vous pouvez aussi utiliser Mes applications de Microsoft pour tester l’application dans n’importe quel mode. Quand vous cliquez sur la vignette Foodee dans Mes applications, si le mode Fournisseur de services est configuré, vous êtes redirigé vers la page de connexion de l’application pour lancer le flux de connexion ; si le mode Fournisseur d’identité est configuré, vous êtes automatiquement connecté à l’application Foodee pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).


## <a name="next-steps"></a>Étapes suivantes

Après avoir configuré Foodee, vous pouvez appliquer le contrôle de session, qui protège votre organisation en temps réel contre l’exfiltration et l’infiltration de ses données sensibles. Le contrôle de session est étendu à partir de l’accès conditionnel. [Découvrez comment appliquer un contrôle de session avec Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).