---
title: 'Didacticiel : Intégration de l’authentification unique Azure Active Directory à Juno Journey | Microsoft Docs'
...
ms.locfileid: "72271829"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-juno-journey"></a>Didacticiel : Intégration de l’authentification unique (SSO) Azure Active Directory à Juno Journey
...
* Juno Journey prend en charge l’authentification unique lancée par **le fournisseur de services et le fournisseur d’identité**.
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-juno-journey"></a>Configurer et tester l’authentification unique Azure AD pour Juno Journey
...
Pour configurer et tester l’authentification unique Azure AD avec Juno Journey, effectuez les modules suivants :
...
1. Dans le [portail Azure](https://portal.azure.com/), accédez à la page d’intégration de l’application **Juno Journey**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
- [Essayer Juno Journey avec Azure AD](https://aad.portal.azure.com/)
