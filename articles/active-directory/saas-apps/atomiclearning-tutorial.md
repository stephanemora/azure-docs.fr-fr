...
1. Dans la zone de recherche, entrez **Atomic Learning**.

    ![Création d’un utilisateur de test Azure AD](./media/atomiclearning-tutorial/tutorial_atomiclearning_search.png)

1. Dans le volet de résultats, sélectionnez **Atomic Learning**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/atomiclearning-tutorial/tutorial_atomiclearning_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Atomic Learning](#creating-an-atomic-learning-test-user)** pour avoir dans Atomic Learning un équivalent de Britta Simon lié à la représentation Azure AD de l’utilisateur.
...
1. Dans la section **Domaine et URL Atomic Learning**, procédez comme suit :
    ...
    > [!NOTE] 
    > Cette valeur n’est pas la valeur réelle. Mettez à jour cette valeur avec l’URL d’authentification réelle. Contactez l’[équipe du support technique d’Atomic Learning](mailto:cs@atomiclearning.com) pour obtenir cette valeur. 
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/atomiclearning-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/atomiclearning-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/atomiclearning-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/atomiclearning-tutorial/create_aaduser_04.png) 
