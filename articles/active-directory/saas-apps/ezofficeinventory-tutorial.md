...
* EZOfficeInventory prend en charge le provisionnement d’utilisateurs **juste-à-temps**.

> [!NOTE]
> L’identificateur de cette application étant une valeur de chaîne fixe, une seule instance peut être configurée dans un locataire.

## <a name="add-ezofficeinventory-from-the-gallery"></a>Ajouter EZOfficeInventory à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-ezofficeinventory"></a>Configurer et tester l’authentification unique Azure AD pour EZOfficeInventory
...
Pour configurer et tester l’authentification unique Azure AD avec EZOfficeInventory, procédez comme suit :
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **EZOfficeInventory**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
1. En haut à droite de la page, cliquez sur **Profile** (Profil), puis accédez à **Settings** > **Add Ons** (Paramètres > Compléments).
    ...
    ![Capture d’écran montrant la page « Settings » avec l’action « Add Ons » sélectionnée.](./media/ezofficeinventory-tutorial/settings.png)

1. Faites défiler jusqu’à la section **SAML Integration** (Intégration SAML) et effectuez les étapes suivantes :

    ![Configuration de EZOfficeInventory](./media/ezofficeinventory-tutorial/integration.png)
...
* Cliquez sur **Tester cette application** dans le portail Azure. Vous êtes alors redirigé vers l’URL de connexion à EZOfficeInventory à partir de laquelle vous pouvez lancer le flux de connexion. 

* Accédez directement à l’URL de connexion à EZOfficeInventory pour lancer le processus de connexion.

* Vous pouvez utiliser Mes applications de Microsoft. Quand vous cliquez sur la vignette EZOfficeInventory dans Mes applications, vous êtes redirigé vers l’URL de connexion à EZOfficeInventory. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).
