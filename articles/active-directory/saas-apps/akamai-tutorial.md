---
title: 'Didacticiel : Intégration de l’authentification unique Azure Active Directory à Akamai | Microsoft Docs'
...
ms.locfileid: "74979135"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-akamai"></a>Didacticiel : Intégration de l’authentification unique Azure Active Directory à Akamai
...
1. Dans la section **Configuration SAML de base**, si vous souhaitez configurer l’application en mode Initié par le **fournisseur d’identité**, entrez les valeurs pour les champs suivants :
    ...
    a. Dans la zone de texte **Identificateur**, tapez une URL au format suivant : `https://<Yourapp>.login.go.akamai-access.com/sp/response`

    b. Dans la zone de texte **URL de réponse**, tapez une URL au format suivant : `https:// <Yourapp>.login.go.akamai-access.com/sp/response`
...
1. Dans la console **Akamai EAA**, sélectionnez **Identity** > **Identity Providers** (Identité > Fournisseurs d’identité).
...
1. Cliquez sur Save and Go to Authentication (Enregistrer et accéder à l’authentication).
...
Cliquez sur **Deploy Application**.

![Configuration d’Akamai](./media/header-akamai-tutorial/configure32.png)

### <a name="kerberos-applications"></a>Applications Kerberos
...
![Configuration d’Akamai](./media/header-akamai-tutorial/configure35.png)

![Configuration d’Akamai](./media/header-akamai-tutorial/configure36.png)
