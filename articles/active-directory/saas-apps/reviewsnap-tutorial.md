...
3. **[Créer un utilisateur de test Reviewsnap](#create-a-reviewsnap-test-user)** pour avoir un équivalent de Britta Simon dans Reviewsnap, lié à la représentation Azure AD associée.
...
3. Dans la section **Domaine et URL Reviewsnap**, suivez les étapes ci-dessous pour configurer l’application en mode initié par le **fournisseur d’identité** :
...
7. Dans la section **Configuration de Reviewsnap**, cliquez sur **Configurer Reviewsnap** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez **l’URL de déconnexion, l’ID d’entité SAML et l’URL du service d’authentification unique SAML** à partir de la **section Référence rapide.**
