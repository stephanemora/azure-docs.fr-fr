...
- Vous pouvez autoriser vos utilisateurs à se connecter automatiquement à ZephyrSSO (via l’authentification unique) avec leur compte Azure AD.
...
- Un abonnement avec l’authentification unique activée à ZephyrSSO
...
1. Ajout de ZephyrSSO depuis la galerie
...
4. Dans la zone de recherche, tapez **ZephyrSSO**, sélectionnez **ZephyrSSO** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
    ...
    ![ZephyrSSO dans la liste des résultats](./media/zephyrsso-tutorial/tutorial_zephyrsso_addfromgallery.png)
...
Pour que l’authentification unique fonctionne, Azure AD doit savoir qui est l’utilisateur ZephyrSSO équivalent à un utilisateur dans Azure AD. En d’autres termes, une relation entre un utilisateur Azure AD et un utilisateur ZephyrSSO associé doit être établie.
...
3. **[Créer un utilisateur de test ZephyrSSO](#create-a-zephyrsso-test-user)** pour avoir dans ZephyrSSO un équivalent de Britta Simon lié à la représentation Azure AD de cet utilisateur.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Tester l’authentification unique](#test-single-sign-on)** : pour vérifier si la configuration fonctionne.

### <a name="configure-azure-ad-single-sign-on"></a>Configurer l’authentification unique Azure AD

Dans cette section, vous allez activer l’authentification unique Azure AD dans le portail Azure et configurer l’authentification unique dans votre application ZephyrSSO.

**Pour configurer l'authentification unique Azure AD avec ZephyrSSO, effectuez les étapes suivantes :**

1. Dans le portail Azure, sur la page d’intégration de l’application **ZephyrSSO**, cliquez sur **Authentification unique**.

    ![Lien Configurer l’authentification unique][4]

2. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.

    ![Boîte de dialogue Authentification unique](./media/zephyrsso-tutorial/tutorial_zephyrsso_samlbase.png)

3. Dans la section **Domaine et URL ZephyrSSO**, effectuez les étapes suivantes :

    ![Informations d’authentification unique dans Domaine et URL ZephyrSSO](./media/zephyrsso-tutorial/tutorial_zephyrsso_url.png)
    ...
    > [!NOTE]
    > Il ne s’agit pas de valeurs réelles. Mettez à jour ces valeurs avec l’identificateur et l’URL de réponse réels. Pour obtenir ces valeurs, contactez [l’équipe de support technique ZephyrSSO](https://support.getzephyr.com).

4. Dans la section **Certificat de signature SAML**, cliquez sur **Métadonnées XML** puis enregistrez le fichier de métadonnées sur votre ordinateur.

    ![Lien Téléchargement de certificat](./media/zephyrsso-tutorial/tutorial_zephyrsso_certificate.png)

5. Cliquez sur le bouton **Enregistrer** .

    ![Bouton Enregistrer de la page Configurer l’authentification unique](./media/zephyrsso-tutorial/tutorial_general_400.png)

6. Pour configurer l’authentification unique côté **ZephyrSSO**, vous devez envoyer le fichier **XML de métadonnées** téléchargé à l’[équipe de support technique ZephyrSSO](https://support.getzephyr.com). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
1. Dans le volet gauche du Portail Azure, cliquez sur le bouton **Azure Active Directory**.
    ...
    ![Bouton Azure Active Directory](./media/zephyrsso-tutorial/create_aaduser_01.png)

2. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.

    ![Liens « Utilisateurs et groupes » et « Tous les utilisateurs »](./media/zephyrsso-tutorial/create_aaduser_02.png)

3. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue **Tous les utilisateurs**.

    ![Bouton Ajouter](./media/zephyrsso-tutorial/create_aaduser_03.png)

4. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :

    ![Boîte de dialogue Utilisateur](./media/zephyrsso-tutorial/create_aaduser_04.png)
...
**Pour affecter Britta Simon à ZephyrSSO, effectuez les étapes suivantes :**
...
2. Dans la liste des applications, sélectionnez **ZephyrSSO**.
    ...
    ![Lien ZephyrSSO dans la liste des applications](./media/zephyrsso-tutorial/tutorial_zephyrsso_app.png)  
...
Quand vous cliquez sur la vignette ZephyrSSO dans le volet d’accès, vous devez être connecté automatiquement à votre application ZephyrSSO.
