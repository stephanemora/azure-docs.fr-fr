...
**Pour ajouter Onit à partir de la galerie, effectuez les étapes suivantes :**
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    a. Dans la zone de texte **URL de connexion**, entrez une URL au format suivant : `https://<sub-domain>.onit.com`
