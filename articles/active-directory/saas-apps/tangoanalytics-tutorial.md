---
title: "Tutoriel : Intégration d'Azure Active Directory à Tango Analytics | Microsoft Docs"
...
ms.locfileid: "56166644"
---
# <a name="tutorial-azure-active-directory-integration-with-tango-analytics"></a>Tutoriel : Intégration d'Azure Active Directory à Tango Analytics
...
1. Dans la zone de recherche, tapez **Tango Analytics**.

    ![Création d’un utilisateur de test Azure AD](./media/tangoanalytics-tutorial/tutorial_tangoanalytics_search.png)

1. Dans le panneau de résultats, sélectionnez **Tango Analytics**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/tangoanalytics-tutorial/tutorial_tangoanalytics_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Tango Analytics](#creating-a-tango-analytics-test-user)** pour avoir un équivalent de Britta Simon dans Tango Analytics lié à la représentation de l’utilisateur Azure AD.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/tangoanalytics-tutorial/tutorial_tangoanalytics_samlbase.png)

1. Dans la section **Domaine et URL Tango Analytics**, procédez comme suit :

    ![Configurer l'authentification unique](./media/tangoanalytics-tutorial/tutorial_tangoanalytics_url.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/tangoanalytics-tutorial/tutorial_general_400.png)
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/tangoanalytics-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/tangoanalytics-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/tangoanalytics-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/tangoanalytics-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **Tango Analytics**.
    ...
    ![Configurer l'authentification unique](./media/tangoanalytics-tutorial/tutorial_tangoanalytics_app.png) 
