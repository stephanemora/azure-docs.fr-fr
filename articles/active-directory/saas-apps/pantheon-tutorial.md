...
* Vous pouvez utiliser Mes applications de Microsoft. Lorsque vous cliquez sur la mosaïque Pantheon dans Mes applications, vous devez être connecté automatiquement à l’application Pantheon pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).
