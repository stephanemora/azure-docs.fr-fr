...
* Dans Azure AD, vous pouvez contrôler qui a accès à GoodPractice Toolkit.
* Vous pouvez permettre aux utilisateurs de se connecter automatiquement à GoodPractice Toolkit (par le biais de l’authentification unique) avec leur compte Azure AD.
...
Pour configurer l’intégration de GoodPractice Toolkit à Azure AD, vous avez besoin des éléments suivants :

* Un abonnement Azure AD Si vous n’avez pas d’environnement Azure AD, vous pouvez obtenir un essai d’un mois [ici](https://azure.microsoft.com/pricing/free-trial/).
* Abonnement GoodPractice Toolkit pour lequel l’authentification unique est activée

## <a name="scenario-description"></a>Description du scénario

Dans ce didacticiel, vous configurez et testez l’authentification unique Azure AD dans un environnement de test.

* GoodPractice Toolkit prend en charge l’authentification unique initiée par **SP**
* GoodPractice Temps prend en charge l’approvisionnement **juste-à-temps** des utilisateurs

## <a name="adding-goodpractice-toolkit-from-the-gallery"></a>Ajout de GoodPractice Toolkit depuis la galerie
...
Pour configurer et tester l’authentification unique Azure AD avec GoodPractice Toolkit, vous devez suivre les indications des sections suivantes :
...
Pour configurer l’authentification unique Azure AD avec GoodPractice Toolkit, procédez comme suit :

1. Sur la page d’intégration de l’application [GoodPractice](https://portal.azure.com/) du **Portail Azure**, sélectionnez **Authentification unique**.
...
5. Dans la page **Configurer l’authentification unique avec SAML**, dans la section **Certificat de signature SAML**, cliquez sur **Télécharger** pour télécharger le fichier **XML de métadonnées de fédération** en fonction des options définies en fonction de vos besoins, puis enregistrez-le sur votre ordinateur.

    ![Lien Téléchargement de certificat](common/metadataxml.png)

6. Dans la section **Configurer GoodPractice Toolkit**, copiez la ou les URL appropriées correspondant à vos besoins.
...
### <a name="configure-goodpractice-toolkit-single-sign-on"></a>Configurer l’authentification unique GoodPractice Toolkit

Pour configurer l’authentification unique côté **GoodPractice Toolkit**, vous devez envoyer le fichier **XML de métadonnées de fédération** téléchargé et les URL copiées appropriées à partir du Portail Azure à [l’équipe de support technique GoodPractice Toolkit](mailto:support@goodpractice.com). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
Dans cette section, vous allez autoriser Britta Simon à utiliser l’authentification unique Azure en lui accordant l’accès à GoodPractice Toolkit.

1. Dans le Portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis sélectionnez **GoodPractice Toolkit**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **GoodPractice Toolkit**.

    ![Lien GoodPractice Toolkit dans la liste des applications](common/all-applications.png)
