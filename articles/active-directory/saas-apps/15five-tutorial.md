...
* Vous pouvez utiliser Mes applications de Microsoft. Le fait de cliquer sur la vignette 15Five dans Mes applications vous redirige vers l’URL de connexion 15Five. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).
