---
title: 'Tutoriel : Configurer Klaxoon pour l’attribution automatique d’utilisateurs avec Azure Active Directory | Microsoft Docs'
description: Découvrez comment approvisionner des comptes d’utilisateur et supprimer leurs privilèges d’accès à partir d’Azure AD dans Klaxoon.
...
ms.locfileid: "129716486"
---
# <a name="tutorial-configure-klaxoon-for-automatic-user-provisioning"></a>Tutoriel : Configurer Klaxoon pour l’attribution automatique d’utilisateurs

Ce tutoriel décrit les étapes à suivre dans Klaxoon et Azure Active Directory (Azure AD) pour configurer l’attribution automatique des utilisateurs. Une fois configuré, Azure AD attribue des utilisateurs et des groupes et supprime leurs privilèges d’accès automatiquement dans [Klaxoon](https://www.Klaxoon.com/) à l’aide du service Approvisionnement d’Azure AD. Pour découvrir les informations importantes sur ce que fait ce service, comment il fonctionne et consulter le forum aux questions, reportez-vous à l’article [Automatiser l’attribution et l’annulation de l’attribution des utilisateurs dans les applications SaaS avec Azure Active Directory](../app-provisioning/user-provisioning.md). 
...
> * [Authentification unique](klaxoon-saml-tutorial.md) auprès de Klaxoon (recommandée).
...
1. Déterminez les données à [mapper entre Azure AD et Klaxoon](../app-provisioning/customize-application-attributes.md). 

## <a name="step-2-configure-klaxoon-to-support-provisioning-with-azure-ad"></a>Étape 2. Configurer Klaxoon pour prendre en charge l’approvisionnement avec Azure AD

* Contactez [Klaxoon](https://klaxoon.com/) pour recevoir une **URL de locataire** unique et un **jeton secret**.

## <a name="step-3-add-klaxoon-from-the-azure-ad-application-gallery"></a>Étape 3. Ajouter Klaxoon à partir de la galerie d’applications Azure AD

Ajoutez Klaxoon à partir de la galerie d’applications Azure AD pour commencer à gérer l’approvisionnement sur Klaxoon. Si vous avez déjà configuré Klaxoon pour l’authentification unique, vous pouvez utiliser la même application. Toutefois, il est recommandé de créer une application distincte lors du test initial de l’intégration. En savoir plus sur l’ajout d’une application à partir de la galerie [ici](../manage-apps/add-application-portal.md). 
...
Cette section vous guide tout au long des étapes de configuration du service d’approvisionnement d’Azure AD pour créer, mettre à jour et désactiver des utilisateurs et/ou des groupes dans Klaxoon en fonction des assignations d’utilisateurs et/ou de groupes dans Azure AD.

### <a name="to-configure-automatic-user-provisioning-for-klaxoon-in-azure-ad"></a>Pour configurer l’attribution automatique d’utilisateurs pour Klaxoon dans Azure AD :

1. Connectez-vous au [portail Azure](https://portal.azure.com). Sélectionnez **Applications d’entreprise**, puis **Toutes les applications**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

1. Dans la liste des applications, sélectionnez **Klaxoon**.

    ![Lien Klaxoon dans la liste des applications](common/all-applications.png)
...
1. Dans la section **Mappages**, sélectionnez **Synchroniser les utilisateurs Azure Active Directory avec Klaxoon**.
...
1. Dans la section **Mappages**, sélectionnez **Synchroniser les groupes Azure Active Directory avec Klaxoon**.
...
1. Pour activer le service d’approvisionnement d’Azure AD pour Klaxoon, attribuez la valeur **Activé** au paramètre **État de l’approvisionnement** dans la section **Paramètres**.

    ![État d’approvisionnement activé](common/provisioning-toggle-on.png)

1. Définissez les utilisateurs et/ou les groupes que vous souhaitez attribuer sur Klaxoon en choisissant les valeurs souhaitées dans **Étendue** de la section **Paramètres**.
