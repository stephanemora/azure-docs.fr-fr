...
## <a name="add-beekeeper-azure-ad-sso-from-the-gallery"></a>Ajouter Beekeeper Azure AD SSO à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-beekeeper-azure-ad-sso"></a>Configurer et tester l’authentification unique Azure AD pour Beekeeper Azure AD SSO
...
Pour configurer et tester l’authentification unique Azure AD avec Beekeeper Azure AD SSO,effectuez les étapes suivantes :
...
1. **[Configurer l’authentification unique Beekeeper Azure AD SSO](#configure-beekeeper-azure-ad-sso)** pour configurer les paramètres de l’authentification unique côté application.
    1. **[Créer un utilisateur de test Beekeeper Azure AD SSO](#create-beekeeper-azure-ad-sso-test-user)** pour avoir dans Beekeeper Azure AD SSO un équivalent de B.Simon lié à la représentation Azure AD associé.
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **Beekeeper Azure AD SSO**, recherchez la section **Gérer**, puis sélectionnez **Authentification unique**.
...
* Cliquez sur **Tester cette application** dans le portail Azure. Vous êtes alors redirigé vers l’URL de connexion à Beekeeper Azure AD SSO, d’où vous pouvez lancer le flux de connexion.  

* Accédez directement à l’URL de connexion à Beekeeper Azure AD SSO pour lancer le flux de connexion.

#### <a name="idp-initiated"></a>Lancée par le fournisseur d’identité :

* Cliquez sur **Tester cette application** dans le portail Azure. Vous devez alors être automatiquement connecté à l’instance de Beekeeper Azure AD SSO pour laquelle vous avez configuré l’authentification unique. 

Vous pouvez aussi utiliser Mes applications de Microsoft pour tester l’application dans n’importe quel mode. Si, quand vous cliquez sur la vignette Beekeeper Azure AD SSO dans Mes applications, le mode Fournisseur de services est configuré, vous êtes redirigé vers la page de connexion de l’application pour lancer le flux de connexion ; s’il s’agit du mode Fournisseur d’identité, vous êtes automatiquement connecté à l’instance de Beekeeper Azure AD SSO pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).
