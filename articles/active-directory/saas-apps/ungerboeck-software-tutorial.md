...
Dans ce tutoriel, vous allez configurer et tester l’authentification unique Azure AD dans un environnement de test. Ungerboeck Software prend en charge l’authentification unique lancée par le **fournisseur de services**.

## <a name="adding-ungerboeck-software-from-the-gallery"></a>Ajout de Ungerboeck Software à partir de la galerie
...
Pour configurer et tester l’authentification unique Azure AD avec Ungerboeck Software, conformez-vous aux indications des sections suivantes :

1. **[Configurer l’authentification unique Azure AD](#configure-azure-ad-sso)** pour permettre à vos utilisateurs d’utiliser cette fonctionnalité.
2. **[Configurez l’authentification unique Ungerboeck Software](#configure-ungerboeck-software-sso)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec B. Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à B. Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test Ungerboeck Software](#create-ungerboeck-software-test-user)** pour avoir un équivalent de Britta Simon dans Ungerboeck Software lié à la représentation Azure AD de l’utilisateur.
...
1. Dans le [portail Azure](https://portal.azure.com/), accédez à la page d’intégration de l’application **Ungerboeck Software** , recherchez la section **Gérer** et sélectionnez **Authentification unique**.
