...
Quand vous cliquez sur la vignette Eventfinity dans le volet d’accès, vous êtes automatiquement connecté à l’application Eventfinity pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
