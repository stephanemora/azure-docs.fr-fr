...
**Pour ajouter Predictix Assortment Planning à partir de la galerie, effectuez les étapes suivantes :**
...
4. Dans la zone de recherche, tapez **Predictix Assortment Planning**, sélectionnez **Predictix Assortment Planning** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
     ...
     ![Predictix Assortment Planning dans la liste des résultats](common/search-new-app.png)
...
Pour que l’authentification unique fonctionne, il faut établir une relation entre l’utilisateur Azure AD et l’utilisateur Predictix Assortment Planning associé.
...
2. **[Configurer l’authentification unique Predictix Assortment Planning](#configure-predictix-assortment-planning-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test Predictix Assortment Planning](#create-predictix-assortment-planning-test-user)** pour avoir un équivalent de Britta Simon dans Predictix Assortment Planning associé à sa représentation dans Azure AD.
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL Predictix Assortment Planning](common/sp-identifier.png)
...
6. Dans la section **Configurer Predictix Assortment Planning**, copiez la ou les URL appropriées en fonction de vos besoins.
...
Pour configurer l’authentification unique côté **Predictix Assortment Planning**, vous devez envoyer le **Certificat (Base64)** téléchargé et les URL appropriées copiées à partir du portail Azure à l’[équipe du support Predictix Assortment Planning](https://www.infor.com/support). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
2. Dans la liste des applications, sélectionnez **Predictix Assortment Planning**.
    ...
    ![Lien Predictix Assortment Planning dans la liste des applications](common/all-applications.png)
...
### <a name="create-predictix-assortment-planning-test-user"></a>Créer un utilisateur de test Predictix Assortment Planning

Dans cette section, vous allez créer un utilisateur appelé Britta Simon dans Predictix Assortment Planning. Pour ajouter des utilisateurs à la plateforme Predictix Assortment Planning, contactez l’ [équipe du support Predictix Assortment Planning](https://www.infor.com/support). Les utilisateurs doivent être créés et activés avant que vous utilisiez l’authentification unique.
...
Quand vous cliquez sur la vignette Predictix Assortment Planning dans le volet d’accès, vous devez être connecté automatiquement à l’application Predictix Assortment Planning pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
