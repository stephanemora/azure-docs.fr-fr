...
* Vous pouvez permettre à vos utilisateurs d’être automatiquement connectés à Lessonly.com (par le biais de l’authentification unique) avec leur compte Azure AD.
...
* Abonnement Lessonly.com pour lequel l’authentification unique est activée

## <a name="scenario-description"></a>Description du scénario

Dans ce didacticiel, vous configurez et testez l’authentification unique Azure AD dans un environnement de test.

* Lessonly.com prend en charge l’authentification unique (SSO) initiée par le **fournisseur de services**
* Lessonly.com prend en charge l’attribution d’utilisateurs **Juste-à-temps**
...
4. Dans la zone de recherche, tapez **Lessonly.com**, sélectionnez **Lessonly.com** dans le panneau de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

     ![Lessonly.com dans la liste des résultats](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurer et tester l’authentification unique Azure AD

Dans cette section, vous allez configurer et tester l’authentification unique Azure AD auprès de Lessonly.com, à l’aide d’un utilisateur de test nommé **Britta Simon**.
Pour que l’authentification unique fonctionne, une relation entre l’utilisateur Azure AD et l’utilisateur Lessonly.com associé doit être établie.
...
2. **[Configurer l’authentification unique de Lessonly.com](#configure-lessonlycom-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer l’utilisateur de test Lessonly.com](#create-lessonlycom-test-user)** pour avoir dans Lessonly.com un équivalent de Britta Simon lié à la représentation Azure AD associée.
...
Pour configurer l’authentification unique Azure AD auprès de Lessonly.com, effectuez les étapes suivantes :

1. Dans la page d’intégration de l’application [Lessonly.com](https://portal.azure.com/) sur le **portail Azure**, sélectionnez **Authentification unique**.
...
8. Dans la section **Configurer Lessonly.com**, copiez l’URL ou les URL appropriées, en fonction de vos besoins.
...
### <a name="configure-lessonlycom-single-sign-on"></a>Configurer l’authentification unique de Lessonly.com

Pour configurer l’authentification unique côté **Lessonly.com**, vous devez envoyer le **certificat (Base64)** téléchargé et les URL appropriées, copiées à partir du portail Azure, à l’[équipe du support technique de Lessonly.com](mailto:support@lessonly.com). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis **Lessonly.com**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **Lessonly.com**.

    ![Lien Lessonly.com dans la liste des applications](common/all-applications.png)
...
### <a name="create-lessonlycom-test-user"></a>Créer l’utilisateur de test Lessonly.com
...
Le fait de cliquer sur la vignette Lessonly.com dans le volet d’accès doit vous connecter automatiquement à l’application Lessonly.com pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
