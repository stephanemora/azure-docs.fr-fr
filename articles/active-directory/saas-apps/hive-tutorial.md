...
1. Cliquez sur **Profil utilisateur**, puis sélectionnez **Utilisateurs**.
    ...
    ![Configuration de Hive](./media/hive-tutorial/configure1.png)

1. Cliquez sur **Authentification**, puis effectuez les étapes suivantes :

    ![Configuration de Hive](./media/hive-tutorial/configure2.png)
...
Le fait de cliquer sur la vignette Hive dans le volet d’accès doit vous connecter automatiquement à l’application Hive pour laquelle vous avez configuré l’authentification unique (SSO). Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
