---
title: 'Didacticiel : Intégration d’Azure Active Directory à Land Gorilla | Microsoft Docs'
...
ms.locfileid: "68880006"
---
# <a name="tutorial-integrate-land-gorilla-with-azure-active-directory"></a>Didacticiel : Intégrer Land Gorilla à Azure Active Directory
...
1. Dans la page **Configurer l’authentification unique avec SAML**, entrez les valeurs des champs suivants :
...
Le fait de cliquer sur la vignette Land Gorilla dans le panneau d’accès doit vous connecter automatiquement à l’application Land Gorilla pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
