...
1. Dans la zone de recherche, tapez **BGS Online**.

    ![Création d’un utilisateur de test Azure AD](./media/bgsonline-tutorial/tutorial_bgsonline_search.png)

1. Dans le volet de résultats, sélectionnez **BGS Online**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/bgsonline-tutorial/tutorial_bgsonline_addfromgallery.png)
...
1. **[Création d’un utilisateur de test BGS Online](#creating-a-bgs-online-test-user)** pour avoir dans BGS Online un équivalent de Britta Simon lié à la représentation Azure AD de l’utilisateur.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/bgsonline-tutorial/tutorial_bgsonline_samlbase.png)

1. Dans la section **Domaine et URL BGS Online**, procédez comme suit :

    ![Configurer l'authentification unique](./media/bgsonline-tutorial/tutorial_bgsonline_url.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/bgsonline-tutorial/tutorial_general_400.png)

1. Dans la section **Configuration BGS Online**, cliquez sur **Configurer BGS Online** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez l **’URL du service d’authentification unique SAML** à partir de la **section Référence rapide.**

    ![Configurer l'authentification unique](./media/bgsonline-tutorial/tutorial_bgsonline_configure.png) 

1. Pour configurer l’authentification unique du côté de **BGS Online**, vous devez envoyer le fichier **XML de métadonnées** et **l’URL du service d’authentification unique SAML** téléchargés à [l’équipe du support technique de BGS Online](mailto:bgsdashboardteam@millwardbrown.com). 
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/bgsonline-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/bgsonline-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/bgsonline-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/bgsonline-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **BGS Online**.

    ![Configurer l'authentification unique](./media/bgsonline-tutorial/tutorial_bgsonline_app.png) 
