...
* 21/1/2021 – Ajout des attributs d’extension personnalisés **configurationFilter**, **identityProvider**, **nameIdentifier**, **customFieldText1**, **customFieldText2**, **customFieldText3**, **customFieldText3** et **customFieldText5**.
