---
title: "Tutoriel : Intégration d'Azure Active Directory à BC in the Cloud | Microsoft Docs"
...
1. Pour ajouter l’application, cliquez sur le bouton **Ajouter** en haut de la boîte de dialogue.

    ![APPLICATIONS][3]

1. Dans la zone de recherche, tapez **BC in the Cloud**.

    ![Création d’un utilisateur de test Azure AD](./media/bcinthecloud-tutorial/tutorial_bcinthecloud_search.png)

1. Dans le volet de résultats, sélectionnez **BC in the Cloud**, puis cliquez sur **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/bcinthecloud-tutorial/tutorial_bcinthecloud_addfromgallery.png)
...
1. **[Création d’un utilisateur de test BC in the Cloud](#creating-a-bc-in-the-cloud-test-user)** pour avoir un équivalent de Britta Simon dans BC in the Cloud lié à la représentation Azure AD associée.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/bcinthecloud-tutorial/tutorial_bcinthecloud_samlbase.png)

1. Dans la section **Domaine et URL BC in the Cloud**, effectuez les étapes suivantes :

    ![Configurer l'authentification unique](./media/bcinthecloud-tutorial/tutorial_bcinthecloud_url.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/bcinthecloud-tutorial/tutorial_general_400.png)

1. Pour configurer l’authentification unique côté **BC in the Cloud**, vous devez envoyer le fichier **XML de métadonnées** téléchargé à [l’équipe du support BC in the Cloud](https://www.bcinthecloud.com/supportcenter/).
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/bcinthecloud-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/bcinthecloud-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/bcinthecloud-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/bcinthecloud-tutorial/create_aaduser_04.png) 
...
Dans cette section, vous allez créer un utilisateur appelé Britta Simon dans BC in the Cloud. Pour ajouter des utilisateurs dans l'application BC in the Cloud, contactez l' [équipe du support technique de BC in the Cloud](https://www.bcinthecloud.com/supportcenter/) . Les utilisateurs doivent être créés et activés avant que vous utilisiez l’authentification unique. 
...
1. Dans la liste des applications, sélectionnez **BC in the Cloud**.
    ...
    ![Configurer l'authentification unique](./media/bcinthecloud-tutorial/tutorial_bcinthecloud_app.png) 
...
Dans cette section, vous allez tester la configuration de l’authentification unique Azure AD à l’aide du volet d’accès.
 ...
 Lorsque vous cliquez sur la vignette BC in the Cloud dans le volet d’accès, vous devez être connecté automatiquement à votre application BC in the Cloud. Pour plus d'informations sur le volet d'accès, consultez  [Présentation du volet d'accès](../user-help/active-directory-saas-access-panel-introduction.md).
