---
title: 'Tutoriel : Intégration de l’authentification unique (SSO) Azure Active Directory avec Otsuka Shokai | Microsoft Docs'
...
ms.locfileid: "92513734"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-otsuka-shokai"></a>Tutoriel : Intégration de l’authentification unique (SSO) Azure Active Directory avec Otsuka Shokai
...
* Otsuka Shokai prend en charge l’authentification unique lancée par le **fournisseur d’identité** .
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-otsuka-shokai"></a>Configurer et tester l’authentification unique Azure AD pour Otsuka Shokai

Configurez et testez l’authentification unique Azure AD avec Otsuka Shokai à l’aide d’un utilisateur de test appelé **B.Simon** . Pour que l’authentification unique fonctionne, vous devez établir un lien entre un utilisateur Azure AD et l’utilisateur Otsuka Shokai associé.
...
1. **[Configurer l’authentification unique Otsuka Shokai](#configure-otsuka-shokai-sso)** – pour configurer les paramètres d’authentification unique côté application.
    1. **[Créer un utilisateur de test Otsuka Shokai](#create-otsuka-shokai-test-user)** – pour avoir un équivalent de B.Simon dans Otsuka Shokai qui soit lié à la représentation Azure AD de l’utilisateur.
...
1. Votre application Otsuka Shokai s’attend à recevoir les assertions SAML dans un format spécifique. Vous devez donc ajouter des mappages d’attributs personnalisés à votre configuration d’attributs de jetons SAML. La capture d’écran suivante montre la liste des attributs par défaut, où **nameidentifier** est mappé avec **user.userprincipalname** . L’application Otsuka Shokai s’attend à ce que **nameidentifier** soit mappé sur **user.objectid** . Vous devez donc modifier le mappage d’attribut en cliquant sur l’icône **Modifier** .
...
## <a name="configure-otsuka-shokai-sso"></a>Configurer l’authentification unique Otsuka Shokai
...
Quand vous cliquez sur la vignette Otsuka Shokai dans le volet d’accès, vous devez être connecté automatiquement à l’application Otsuka Shokai pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
...
- [Essayer Otsuka Shokai avec Azure AD](https://aad.portal.azure.com/)