---
title: 'Didacticiel : Intégration de l’authentification unique Azure Active Directory à Blue Access for Members (BAM) | Microsoft Docs'
...
ms.locfileid: "74085152"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-blue-access-for-members-bam"></a>Didacticiel : Intégration de l’authentification unique Azure Active Directory à Blue Access for Members (BAM)
...
### <a name="create-blue-access-for-members-bam-test-user"></a>Créer un utilisateur de test Blue Access for Members (BAM)
