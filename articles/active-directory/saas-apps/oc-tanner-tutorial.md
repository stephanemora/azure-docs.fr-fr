...
* Vous pouvez permettre aux utilisateurs de se connecter automatiquement à O.C. Tanner - AppreciateHub (par le biais de l’authentification unique) avec leur compte Azure AD.
...
* O.C. Un abonnement Tanner - AppreciateHub pour lequel l’authentification unique est activée

## <a name="scenario-description"></a>Description du scénario

Dans ce didacticiel, vous configurez et testez l’authentification unique Azure AD dans un environnement de test.

* O.C. Tanner - AppreciateHub prend en charge l’authentification unique lancée par le **fournisseur d’identité**
...
**Pour ajouter O.C. Tanner - AppreciateHub à partir de la galerie, effectuez les étapes suivantes :**
...
4. Dans la zone de recherche, tapez **O.C. Tanner - AppreciateHub**, sélectionnez **O.C. Tanner - AppreciateHub** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

     ![O.C. Tanner - AppreciateHub dans la liste des résultats](common/search-new-app.png)
...
Pour que l’authentification unique fonctionne, une relation entre un utilisateur Azure AD et l’utilisateur O.C. Tanner - AppreciateHub associé doit être établie.
...
2. **[Configurer l’authentification unique O.C. Tanner - AppreciateHub](#configure-oc-tanner---appreciatehub-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer l’utilisateur de test O.C. Tanner - AppreciateHub](#create-oc-tanner---appreciatehub-test-user)** pour avoir un équivalent de Britta Simon dans O.C. Tanner - AppreciateHub lié à la représentation Azure AD associée.
...
1. Dans le [portail Azure](https://portal.azure.com/), sur la page d’intégration de l’application **O.C. Tanner - AppreciateHub**, sélectionnez **Authentification unique**.
...
4. Dans la section **Configuration SAML de base**, si vous disposez d’un **fichier de métadonnées du fournisseur de services**, suivez les étapes ci-dessous :
    ...
    >[!NOTE]
    >Vous pouvez télécharger le **fichier de métadonnées du fournisseur de services** en cliquant [ici](https://fed.appreciatehub.com/fed/sp/metadata)
    ...
    c. Une fois le fichier de métadonnées chargé, les valeurs **Identificateur** et **URL de réponse** sont automatiquement renseignées dans la section Configuration SAML de base.
     ...
     ![Informations d’authentification unique dans Domaine et URL O.C. Tanner - AppreciateHub](common/idp-intiated.png)

    > [!Note]
    > Si les valeurs **Identificateur** et **URL de réponse** ne sont pas automatiquement renseignées, renseignez-les manuellement en fonction de vos besoins. Pour obtenir cette valeur, contactez [l’équipe du support technique O.C. Tanner - AppreciateHub](mailto:sso@octanner.com). Vous pouvez également consulter les modèles figurant à la section **Configuration SAML de base** dans le portail Azure.
...
6. Dans la section **Configurer O.C. Tanner - AppreciateHub**, copiez l’URL ou les URL appropriées en fonction de vos besoins.
...
### <a name="configure-oc-tanner---appreciatehub-single-sign-on"></a>Configurer l’authentification unique O.C. Tanner - AppreciateHub
...
3. Dans les propriétés de l’utilisateur, effectuez les étapes suivantes.
    ...
    b. Dans le champ **Nom d’utilisateur**, entrez un utilisateur tel que BrittaSimon@contoso.com.
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis sélectionnez **O.C. Tanner - AppreciateHub**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **O.C. Tanner - AppreciateHub**.

    ![Lien O.C. Tanner - AppreciateHub dans la liste des applications](common/all-applications.png)
