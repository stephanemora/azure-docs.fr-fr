---
title: "Didacticiel : Intégration d'Azure Active Directory à JDA Cloud | Microsoft Docs"
...
ms.locfileid: "64917543"
---
# <a name="tutorial-azure-active-directory-integration-with-jda-cloud"></a>Didacticiel : Intégration d'Azure Active Directory à JDA Cloud
...
Le fait de cliquer sur la vignette JDA Cloud dans le volet d’accès doit vous connecter automatiquement à l’application JDA Cloud pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
