---
title: 'Tutoriel : Intégration d’Azure Active Directory à Showpad | Microsoft Docs'
...
ms.locfileid: "54809936"
---
# <a name="tutorial-azure-active-directory-integration-with-showpad"></a>Tutoriel : Intégration d’Azure Active Directory à Showpad
...
1. Dans la zone de recherche, entrez **Showpad**.

    ![Création d’un utilisateur de test Azure AD](./media/showpad-tutorial/tutorial_showpad_search.png)

1. Dans le volet de résultats, sélectionnez **Showpad**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/showpad-tutorial/tutorial_showpad_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Showpad](#creating-a-showpad-test-user)** - pour avoir un équivalent de Britta Simon dans Showpad lié à sa représentation dans Azure AD.
...
1. Dans la section **Domaine et URL Showpad**, procédez comme suit :
...
1. Connectez-vous à votre client Showpad en tant qu’administrateur.

1. Dans le menu situé en haut, cliquez sur **Paramètres**.
   
    ![Configurer l’authentification unique côté application](./media/showpad-tutorial/tutorial_showpad_001.png) 

1. Accédez à **Authentification unique** et cliquez sur **Activer**.
   
    ![Configurer l’authentification unique côté application](./media/showpad-tutorial/tutorial_showpad_002.png)

1. Dans la boîte de dialogue **Add a SAML 2.0 Service** (Ajouter un service SAML 2.0), procédez comme suit :
   
    ![Configurer l’authentification unique côté application](./media/showpad-tutorial/tutorial_showpad_003.png) 
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/showpad-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/showpad-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/showpad-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/showpad-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **Showpad**.
