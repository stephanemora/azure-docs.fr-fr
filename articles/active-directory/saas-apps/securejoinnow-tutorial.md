...
ms.locfileid: "68880116"
---
# <a name="tutorial-integrate-securew2-joinnow-connector-with-azure-active-directory"></a>Didacticiel : Intégrer Azure Active Directory à SecureW2 JoinNow Connector
...
Le fait de cliquer sur la mosaïque SecureW2 JoinNow Connector dans le volet d’accès doit vous connecter automatiquement à l’application SecureW2 JoinNow Connector pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
