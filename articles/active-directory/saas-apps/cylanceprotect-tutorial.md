...
* Vous pouvez permettre aux utilisateurs de se connecter automatiquement à CylancePROTECT (par le biais de l’authentification unique) avec leur compte Azure AD.
...
* Abonnement CylancePROTECT pour lequel l’authentification unique est activée
...
4. Dans la zone de recherche, saisissez **CylancePROTECT**, sélectionnez **CylancePROTECT** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
     ...
     ![CylancePROTECT dans la liste des résultats](common/search-new-app.png)
...
Pour que l’authentification unique fonctionne, une relation entre un utilisateur Azure AD et l’utilisateur CylancePROTECT associé doit être établie.
...
2. **[Configurer l’authentification unique CylancePROTECT](#configure-cylanceprotect-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test CylancePROTECT](#create-cylanceprotect-test-user)** pour avoir un équivalent de Britta Simon dans CylancePROTECT lié à la représentation Azure AD de l’utilisateur.
...
Pour configurer l’authentification unique Azure AD avec CylancePROTECT, effectuez les étapes suivantes :

1. Dans le [portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **CylancePROTECT**, sélectionnez **Authentification unique**.
...
4. Sur la page **Configurer l’authentification unique avec SAML**, cliquez sur le bouton **Modifier** pour ouvrir la boîte de dialogue **Configuration SAML de base**.
    ...
    ![Informations d’authentification unique dans Domaine et URL CylancePROTECT](common/idp-intiated.png)
...
6. Dans la section **Configurer CylancePROTECT**, copiez la ou les URL appropriées en fonction de vos besoins.
...
### <a name="configure-cylanceprotect-single-sign-on"></a>Configurer l’authentification unique CylancePROTECT

Pour configurer l’authentification unique côté **CylancePROTECT**, vous devez envoyer le **Certificat (Base64)** téléchargé et les URL copiées correspondantes, depuis le portail Azure à l’administrateur de la console. Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis sélectionnez **CylancePROTECT**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **CylancePROTECT**.

    ![Le lien CylancePROTECT dans la liste des applications](common/all-applications.png)
...
Dans cette section, créez un utilisateur appelé Britta Simon dans CylancePROTECT. Collaborez avec l’administrateur de la console pour ajouter les utilisateurs dans la plateforme CylancePROTECT. Le titulaire du compte Azure Active Directory reçoit un message électronique contenant un lien à suivre pour confirmer son compte et l’activer.
