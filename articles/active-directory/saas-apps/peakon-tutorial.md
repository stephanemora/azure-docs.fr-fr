---
title: 'Didacticiel : Intégration d’Azure Active Directory à Peakon | Microsoft Docs'
...
3. Dans la boîte de dialogue **New employee** (Nouvel employé), effectuez les étapes suivantes :
    ...
    b. Dans le **E-mail** zone de texte, tapez l’adresse de messagerie comme **Brittasimon\@contoso.com**.
