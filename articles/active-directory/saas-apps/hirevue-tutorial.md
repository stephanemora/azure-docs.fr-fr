...
* Vous pouvez autoriser les utilisateurs à se connecter automatiquement à HireVue (par le biais de l’authentification unique) avec leur compte Azure AD.
...
4. Dans la zone de recherche, tapez **HireVue**, sélectionnez **HireVue** dans le panneau de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

     ![HireVue dans la liste des résultats](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurer et tester l’authentification unique Azure AD

Dans cette section, vous allez configurer et tester l’authentification unique Azure AD avec HireVue pour un utilisateur de test appelé **Britta Simon**.
Pour que l’authentification unique fonctionne, une relation entre l’utilisateur Azure AD et l’utilisateur HireVue associé doit être établie.
...
2. **[Configurer l’authentification unique HireVue](#configure-hirevue-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test HireVue](#create-hirevue-test-user)** pour avoir un équivalent de Britta Simon dans HireVue lié à la représentation Azure AD de l’utilisateur.
...
Pour configurer l’authentification unique Azure AD avec HireVue, effectuez les étapes suivantes :

1. Dans le [portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **HireVue**, sélectionnez **Authentification unique**.
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL HireVue](common/sp-identifier.png)
...
### <a name="configure-hirevue-single-sign-on"></a>Configurer l’authentification unique HireVue
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis **HireVue**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **HireVue**.

    ![Lien HireVue dans la liste des applications](common/all-applications.png)
...
Dans cette section, vous allez créer un utilisateur appelé Britta Simon dans HireVue. Contactez l’ [équipe du support technique HireVue](mailto:samlsupport@hirevue.com) pour ajouter des utilisateurs dans la plateforme HireVue. Les utilisateurs doivent être créés et activés avant que vous utilisiez l’authentification unique.

### <a name="test-single-sign-on"></a>Tester l’authentification unique

Dans cette section, vous allez tester la configuration de l’authentification unique Azure AD à l’aide du volet d’accès.

Quand vous cliquez sur la vignette HireVue dans le volet d’accès, vous devez être connecté automatiquement à l’application HireVue pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
