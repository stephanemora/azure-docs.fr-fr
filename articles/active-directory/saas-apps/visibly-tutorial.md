...
1. Accédez à l’option **Settings** (Paramètres) dans le menu de navigation.
    ...
    ![Configuration](./media/visibly-tutorial/settings.png)

1. Cliquez sur **Integrations** dans Settings.

    ![Configuration](./media/visibly-tutorial/integrations.png)

1. Dans **Integrations**, sélectionnez **SSO**.

    ![Configuration](./media/visibly-tutorial/sso.png)

1. Effectuez les étapes ci-après dans la page suivante.

    ![Configuration](./media/visibly-tutorial/configuration.png)
...
Quand vous cliquez sur la vignette Visibly dans le volet d’accès, vous devez être connecté automatiquement à l’application Visibly pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
