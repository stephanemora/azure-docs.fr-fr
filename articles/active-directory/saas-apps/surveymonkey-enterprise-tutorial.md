...
* Vous pouvez utiliser Mes applications de Microsoft. Quand vous cliquez sur la vignette SurveyMonkey Enterprise dans Mes applications, vous devez être connecté automatiquement à l’instance de SurveyMonkey Enterprise pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).
