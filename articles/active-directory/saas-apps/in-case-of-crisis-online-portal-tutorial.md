...
Le fait de cliquer sur la vignette In Case of Crisis - Online Portal dans le volet d’accès doit vous connecter automatiquement à l’application In Case of Crisis - Online Portal pour laquelle vous avez configuré l’authentification unique (SSO). Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
