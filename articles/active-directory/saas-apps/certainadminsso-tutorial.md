...
1. Dans la zone de recherche, tapez **Certain Admin SSO**, sélectionnez **Certain Admin SSO** dans le panneau de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
...
1. **[Créer un utilisateur de test Certain Admin SSO](#create-a-certain-admin-sso-test-user)** pour avoir un équivalent de Britta Simon dans Certain Admin SSO lié à la représentation Azure AD associée.
...
1. Dans la section **Domaine et URL Certain Admin SSO**, suivez les étapes ci-dessous :
...
1. Dans la section **Configuration de Certain Admin SSO**, cliquez sur **Configurer Certain Admin SSO** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez **l’URL de déconnexion, l’ID d’entité SAML et l’URL du service d’authentification unique SAML** à partir de la **section Référence rapide.**
