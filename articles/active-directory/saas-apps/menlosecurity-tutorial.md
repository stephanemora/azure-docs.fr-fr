...
1. Dans la zone de recherche, tapez **Menlo Security**.

    ![Création d’un utilisateur de test Azure AD](./media/menlosecurity-tutorial/tutorial_menlosecurity_search.png)

1. Dans le volet des résultats, sélectionnez **Menlo Security**, puis cliquez sur **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/menlosecurity-tutorial/tutorial_menlosecurity_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Menlo Security](#creating-a-menlo-security-test-user)** pour avoir un équivalent de Britta Simon dans Menlo Security lié à la représentation Azure AD de l’utilisateur.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/menlosecurity-tutorial/tutorial_menlosecurity_samlbase.png)

1. Dans la section **Domaine et URL Menlo Security**, effectuez les étapes suivantes :

    ![Configurer l'authentification unique](./media/menlosecurity-tutorial/tutorial_menlosecurity_url.png)
...
1. Dans la section **Certificat de signature SAML**, cliquez sur **Certificat (en base64)**, puis enregistrez le fichier de certificat sur votre ordinateur.

    ![Configurer l'authentification unique](./media/menlosecurity-tutorial/tutorial_menlosecurity_certificate.png) 

1. Cliquez sur le bouton **Enregistrer** .

    ![Configurer l'authentification unique](./media/menlosecurity-tutorial/tutorial_general_400.png)

1. Dans la section **Configuration de Menlo Security**, cliquez sur **Configurer Menlo Security** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez l’**ID d’entité SAML** et l’**URL du service d’authentification unique SAML** à partir de la **section Référence rapide**.

    ![Configurer l'authentification unique](./media/menlosecurity-tutorial/tutorial_menlosecurity_configure.png) 
...
1. Sous **Settings**, accédez à **Authentication** et effectuez les opérations suivantes :
    ...
    d. **Point de terminaison SAML 2.0** : collez l'**URL du service d'authentification unique SAML** que vous avez copiée à partir du portail Azure.

    e. **Identificateur du service (émetteur)**  : collez l'**ID d'entité SAML** que vous avez copié à partir du portail Azure.
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/menlosecurity-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/menlosecurity-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/menlosecurity-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/menlosecurity-tutorial/create_aaduser_04.png) 
...
Dans cette section, vous allez créer un utilisateur appelé Britta Simon dans Menlo Security. Rapprochez-vous de l' [équipe du support technique de Menlo Security](https://www.menlosecurity.com/menlo-contact) pour ajouter des utilisateurs sur la plateforme Menlo Security. Les utilisateurs doivent être créés et activés avant que vous utilisiez l’authentification unique. 
...
1. Dans la liste d’applications, sélectionnez **Menlo Security**.
    ...
    ![Configurer l'authentification unique](./media/menlosecurity-tutorial/tutorial_menlosecurity_app.png) 
