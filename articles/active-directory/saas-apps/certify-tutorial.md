---
title: 'Tutoriel : Intégration d’Azure Active Directory à Certify | Microsoft Docs'
...
* Dans Azure AD, vous pouvez contrôler l’accès des utilisateurs à Certify.
* Vous pouvez permettre aux utilisateurs de se connecter automatiquement à Certify (via l’authentification unique) avec leurs comptes Azure AD.
...
* Abonnement Certify pour lequel l’authentification unique est activée
...
4. Dans la zone de recherche, tapez **Certify**, sélectionnez **Certify** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

     ![Certify dans la liste des résultats](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurer et tester l’authentification unique Azure AD

Dans cette section, vous allez configurer et tester l’authentification unique Azure AD avec Certify pour un utilisateur de test appelé **Britta Simon**.
Pour que l’authentification unique fonctionne, une relation entre un utilisateur Azure AD et l’utilisateur Certify associé doit être établie.
...
2. **[Configurer l’authentification unique Certify](#configure-certify-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test Certify](#create-certify-test-user)** pour avoir un équivalent de Britta Simon dans Certify lié à la représentation Azure AD associée.
...
Pour configurer l’authentification unique Azure AD avec Certify, effectuez les étapes suivantes :

1. Dans le [Portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **Certify**, sélectionnez **Authentification unique**.
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL Certify](common/idp-identifier.png)
...
### <a name="configure-certify-single-sign-on"></a>Configurer l’authentification unique Certify
...
1. Dans le Portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis **Certify**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **Certify**.

    ![Lien Certify dans la liste des applications](common/all-applications.png)
