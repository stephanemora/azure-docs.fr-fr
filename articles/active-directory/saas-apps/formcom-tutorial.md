...
* Vous pouvez utiliser Mes applications de Microsoft. Un clic sur la vignette Form.com dans Mes applications vous redirige vers l’URL de connexion à Form.com. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
