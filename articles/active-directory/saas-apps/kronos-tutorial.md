...
1. Dans la zone de recherche, entrez **Kronos**.

    ![Création d’un utilisateur de test Azure AD](./media/kronos-tutorial/tutorial_kronos_search.png)

1. Dans le volet de résultats, sélectionnez **Kronos**, puis cliquez sur **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/kronos-tutorial/tutorial_kronos_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Kronos](#creating-a-kronos-test-user)** pour avoir un équivalent de Britta Simon dans Kronos lié à la représentation Azure AD associée.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/kronos-tutorial/tutorial_kronos_samlbase.png)

1. Dans la section **Domaine et URL Kronos**, procédez comme suit :

    ![Configurer l'authentification unique](./media/kronos-tutorial/tutorial_kronos_url.png)
...
1. Votre application Kronos attend les assertions SAML dans un format spécifique. Collaborez avec [l’équipe de support de Kronos](https://www.kronos.in/contact/en-in/form) pour identifier tout d’abord l’identificateur utilisateur correct qui est mappé à l’application. Suivez également les instructions sur l’attribut à utiliser pour ce mappage.
    ...
    ![Configurer l'authentification unique](./media/kronos-tutorial/tutorial_kronos_attribute.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/kronos-tutorial/tutorial_general_400.png)

1. Pour configurer l’authentification unique côté **Kronos**, vous devez envoyer le **XML de métadonnées** téléchargé à [l’équipe de support technique de Kronos](https://www.kronos.in/contact/en-in/form). 
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/kronos-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/kronos-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/kronos-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/kronos-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **Kronos**.
    ...
    ![Configurer l'authentification unique](./media/kronos-tutorial/tutorial_kronos_app.png) 
