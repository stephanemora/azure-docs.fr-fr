...
## <a name="configure-and-test-azure-ad-single-sign-on-for-klue"></a>Configurer et tester l’authentification unique Azure AD pour Klue
...
Pour configurer et tester l’authentification unique Azure AD avec Klue, suivez les indications des modules ci-après :
...
1. Dans le [Portail Azure](https://portal.azure.com/), accédez à la page d’intégration de l’application **Klue** , recherchez la section **Gérer** et sélectionnez **Authentification unique** .
...
Le fait de cliquer sur la vignette Klue dans le volet d’accès doit vous connecter automatiquement à l’application Klue pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
