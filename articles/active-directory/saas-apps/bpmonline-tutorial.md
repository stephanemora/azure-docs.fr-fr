...
* Vous pouvez permettre à vos utilisateurs d’être connectés automatiquement à Bpm’online (par le biais de l’authentification unique) avec leur compte Azure AD.
...
* Bpm’online prend en charge l’authentification unique lancée par **le fournisseur de services et le fournisseur d’identité**
...
4. Dans la zone de recherche, tapez **Bpm’online**, sélectionnez **Bpm’online** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
    ...
    ![Bpm’online dans la liste des résultats](common/search-new-app.png)
...
Pour que l’authentification unique fonctionne, vous devez associer l’utilisateur Azure AD à l’utilisateur Bpm’online.
...
2. **[Configurer l’authentification unique Bpm’online](#configure-bpmonline-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test Bpm’online](#create-bpmonline-test-user)** pour avoir dans Bpm’online un équivalent de Britta Simon lié à la représentation Azure AD de l’utilisateur.
...
Pour configurer l’authentification unique Azure AD auprès de Bpm’online, effectuez les étapes suivantes :

1. Dans le [portail Azure](https://portal.azure.com/), sur la page d’intégration de l’application **Bpm’online**, sélectionnez **Authentification unique**.
...
4. Dans la section **Configuration SAML de base**, si vous souhaitez configurer l’application en mode lancé par le **fournisseur d’identité**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL Bpm’online](common/idp-intiated.png)
...
5. Si vous souhaitez configurer l’application en **mode démarré par le fournisseur de services**, cliquez sur **Définir des URL supplémentaires**, puis effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL Bpm’online](common/metadata-upload-additional-signon.png)

    Dans la zone de texte **URL de connexion**, tapez une URL au format suivant : `https://<client site name>.bpmonline.com/`

    > [!NOTE]
    > Il ne s’agit pas de valeurs réelles. Mettez à jour ces valeurs avec l’identificateur, l’URL de réponse et l’URL de connexion réels. Pour obtenir ces valeurs, contactez [l’équipe de support technique Bpm’online](mailto:support@bpmonline.com). Vous pouvez également consulter les modèles figurant à la section **Configuration SAML de base** dans le portail Azure.
...
### <a name="configure-bpmonline-single-sign-on"></a>Configurer l’authentification unique Bpm’online
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis **Bpm’online**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **Bpm’online**.

    ![Lien Bpm’online dans la liste des applications](common/all-applications.png)
...
### <a name="create-bpmonline-test-user"></a>Créer un utilisateur de test Bpm’online
...
Quand vous cliquez sur la vignette Bpm’online dans le volet d’accès, vous devez vous connecter automatiquement à l’application Bpm’online pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
