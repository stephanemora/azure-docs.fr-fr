...
Dans cette section, vous allez créer un utilisateur appelé B.Simon dans Momenta. Collaborez avec l’ [équipe de support technique de Momenta](mailto:microsoftsupport@bts.com) pour ajouter les utilisateurs à la plateforme Momenta. Les utilisateurs doivent être créés et activés avant que vous utilisiez l’authentification unique.

## <a name="test-sso"></a>Tester l’authentification unique (SSO) 

Dans cette section, vous allez tester la configuration de l’authentification unique Azure AD à l’aide du volet d’accès.

Quand vous cliquez sur la vignette Momenta dans le volet d’accès, vous devez être connecté automatiquement à l’application Momenta pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
...
- [Guide pratique pour protéger Momenta avec une visibilité et des contrôles avancés](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
