...
1. Dans la zone de recherche, tapez **Flock**, sélectionnez **Flock** dans le panneau de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
...
1. **[Créer un utilisateur de test Flock](#create-a-flock-test-user)** pour avoir un équivalent de Britta Simon dans Flock, lié à la représentation Azure AD associée.
...
1. Dans la section **Domaine et URL Flock**, suivez les étapes ci-dessous :
...
1. Dans la section **Configuration de Flock**, cliquez sur **Configurer Flock** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez l’**ID d’entité SAML et l’URL du service d’authentification unique SAML** à partir de la **section Référence rapide.**
...
1. Sélectionnez l’onglet **Authentification** dans le volet de navigation de gauche, puis **Authentification SAML**.
...
1. Cliquez sur **Gérer l’équipe** dans le volet de navigation de gauche.

    ![Ajouter un employé](./media/flock-tutorial/user1.png)

1. Cliquez sur l’onglet **Ajouter un membre**, puis sélectionnez **Membres de l’équipe**.

    ![Ajouter un employé](./media/flock-tutorial/user2.png)

1. Entrez l’adresse e-mail de l’utilisateur, par exemple, **Brittasimon@contoso.com**, puis sélectionnez **Ajouter des utilisateurs**.
