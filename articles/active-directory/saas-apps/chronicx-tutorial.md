...
3. **[Créer un utilisateur de test ChronicX®](#create-a-chronicx®-test-user)** pour avoir un équivalent de Britta Simon dans ChronicX®, lié à la représentation Azure AD de l’utilisateur.
...
3. Dans la section **Domaine et URL ChronicX®**, procédez comme suit :
...
6. Pour configurer l’authentification unique côté **ChronicX®**, vous devez envoyer le fichier **XML des métadonnées** téléchargé à [l’équipe du support ChronicX®](https://www.casebank.com/contact-us/). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
