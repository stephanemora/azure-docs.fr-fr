...
3. **[Créer un utilisateur de test Autotask Endpoint Backup](#create-a-autotask-endpoint-backup-test-user)** pour avoir un équivalent de Britta Simon dans Autotask Workplace qui soit associé à la représentation de l’utilisateur Azure AD.
...
3. Dans la section **Domaine et URL Autotask Endpoint Backup**, réalisez les étapes suivantes :
