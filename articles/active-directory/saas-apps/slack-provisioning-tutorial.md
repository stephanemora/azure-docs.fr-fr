...
> * [Authentification unique](https://docs.microsoft.com/azure/active-directory/saas-apps/slack-tutorial) auprès de Slack (recommandé)
...
3. Déterminez les données à [mapper entre Azure AD et Slack](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
