---
title: 'Tutoriel : Intégration entre l’authentification unique Azure Active Directory et Zero Networks | Microsoft Docs'
...
ms.locfileid: "123077565"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-zero-networks"></a>Tutoriel : Intégration entre l’authentification unique Azure Active Directory et Zero Networks
...
## <a name="configure-and-test-azure-ad-sso-for-zero-networks"></a>Configuration et test de l’authentification unique Azure AD pour Zero Networks

Configurez et testez l’authentification unique Azure AD avec Zero Networks à l’aide d’un utilisateur de test nommé **B.Simon**. Pour que l’authentification unique fonctionne, vous devez établir un lien entre un utilisateur Azure AD et l’utilisateur associé dans Zero Networks.

Pour configurer et tester l’authentification unique Azure AD avec Zero Networks, procédez comme suit :

1. **[Configurer l’authentification unique Azure AD](#configure-azure-ad-sso)** pour permettre à vos utilisateurs d’utiliser cette fonctionnalité.
    1. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec B. Simon.
    1. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à B. Simon d’utiliser l’authentification unique Azure AD.
1. **[Configurer l’authentification unique Zero Networks](#configure-zero-networks-sso)** pour configurer les paramètres de l’authentification unique côté application.
    1. **[Créer un utilisateur de test Zero Networks](#create-zero-networks-test-user)** pour avoir dans Zero Networks un équivalent de B.Simon lié à la représentation Azure AD de l’utilisateur.
...
1. Sur le Portail Azure, accédez à la page d’intégration de l’application **Zero Networks**, recherchez la section **Gérer**, puis sélectionnez **Authentification unique**.
...
Dans cette section, vous allez autoriser B.Simon à utiliser l’authentification unique Azure en lui accordant l’accès à Zero Networks.

1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, puis **Toutes les applications**.
1. Dans la liste des applications, sélectionnez **Zero Networks**.
...
1. Connectez-vous à votre site d’entreprise Zero Networks en tant qu’administrateur.
...
### <a name="create-zero-networks-test-user"></a>Création d’un utilisateur de test Zero Networks

Dans cette section, vous allez créer un utilisateur appelé Britta Simon dans Zero Networks. Pour ajouter les utilisateurs dans la plateforme Zero Networks, travaillez avec [l’équipe de support Zero Networks](mailto:support@zeronetworks.com). Les utilisateurs doivent être créés et activés avant que vous utilisiez l’authentification unique.
