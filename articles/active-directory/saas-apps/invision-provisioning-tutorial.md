...
> * [Authentification unique](https://docs.microsoft.com/azure/active-directory/saas-apps/invision-tutorial) auprès d’InVision (obligatoire)
...
3. Déterminez les données à [mapper entre Azure AD et InVision](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
