...
Le fait de cliquer sur la vignette AuditBoard dans le panneau d’accès doit vous connecter automatiquement à l’application AuditBoard pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
