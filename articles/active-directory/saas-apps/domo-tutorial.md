...
1. Dans la zone de recherche, tapez **Domo**.

    ![Création d’un utilisateur de test Azure AD](./media/domo-tutorial/tutorial_domo_search.png)

1. Dans le volet de résultats, sélectionnez **Domo**, puis cliquez sur **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/domo-tutorial/tutorial_domo_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Domo](#creating-a-domo-test-user)** pour avoir un équivalent de Britta Simon dans Domo lié à la représentation Azure AD associée.
...
1. Dans la section **Domaine et URL Domo**, procédez comme suit :
...
1. Dans la section **Configuration de Domo**, cliquez sur **Configurer Domo** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez **l’URL de déconnexion, l’ID d’entité SAML et l’URL du service d’authentification unique SAML** à partir de la **section Référence rapide.**   

   ![Configurer l'authentification unique](./media/domo-tutorial/tutorial_domo_configure.png) 

1. Pour configurer l’authentification unique côté **Domo**, accédez à l’article de la Base de connaissances de Domo [ici](http://knowledge.domo.com?cid=azuread), puis suivez les instructions.
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/domo-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/domo-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/domo-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/domo-tutorial/create_aaduser_04.png) 
