...
1. Dans la zone de recherche, tapez **CompetencyIQ**.

    ![Création d’un utilisateur de test Azure AD](./media/competencyiq-tutorial/tutorial_competencyiq_search.png)

1. Dans le volet des résultats, sélectionnez **CompetencyIQ**, puis cliquez sur **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/competencyiq-tutorial/tutorial_competencyiq_addfromgallery.png)
...
1. **[Création d’un utilisateur de test CompetencyIQ](#creating-a-competencyiq-test-user)** pour avoir un équivalent de Britta Simon dans CompetencyIQ lié à la représentation Azure AD associée.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/competencyiq-tutorial/tutorial_competencyiq_samlbase.png)

1. Dans la section **Domaine et URL CompetencyIQ**, effectuez les étapes suivantes :

    ![Configurer l'authentification unique](./media/competencyiq-tutorial/tutorial_competencyiq_url1.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/competencyiq-tutorial/tutorial_general_400.png)

1. Dans la section **Configuration de CompetencyIQ**, cliquez sur **Configurer CompetencyIQ** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez l’**ID d’entité SAML** et l’**URL du service d’authentification unique SAML** à partir de la **section Référence rapide**.

    ![Configurer l'authentification unique](./media/competencyiq-tutorial/tutorial_competencyiq_configure.png) 
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/competencyiq-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/competencyiq-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/competencyiq-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/competencyiq-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **CompetencyIQ**.

    ![Configurer l'authentification unique](./media/competencyiq-tutorial/tutorial_competencyiq_app.png) 
