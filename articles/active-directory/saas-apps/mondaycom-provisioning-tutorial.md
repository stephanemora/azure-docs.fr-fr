...
3. Déterminez les données à [mapper entre Azure AD et monday.com](../app-provisioning/customize-application-attributes.md). 
...
* monday.com prend uniquement en charge les attributs userType « admin », « invité », « membre » et « viewer ». L’attribut userType « Utilisateur » n’est pas pris en charge et sera supprimé à l’avenir.

## <a name="change-log"></a>Journal des modifications
* 21/01/2021 – Ajout de la prise en charge de l’attribut de base « userType » pour les utilisateurs.
