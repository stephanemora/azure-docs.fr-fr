...
1. Dans le [Portail Azure](https://portal.azure.com/), accédez à la page d’intégration de l’application **RedBrick Health**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
Quand vous cliquez sur la vignette RedBrick Health dans le volet d’accès, vous devez être connecté automatiquement à l’application RedBrick Health pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://support.microsoft.com/account-billing/sign-in-and-start-apps-from-the-my-apps-portal-2f3b1bae-0e5a-4a86-a33e-876fbd2a4510).
