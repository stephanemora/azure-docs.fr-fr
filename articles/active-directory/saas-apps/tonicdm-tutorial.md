...
3. **[Créer un utilisateur de test TonicDM](#create-a-tonicdm-test-user)** pour avoir un équivalent de Britta Simon dans TonicDM, lié à la représentation Azure AD associée.
...
3. Dans la section **Domaine et URL TonicDM**, suivez les étapes ci-dessous :
...
6. Dans la section **Configuration de TonicDM**, cliquez sur **Configurer TonicDM** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez **l’URL de déconnexion, l’ID d’entité SAML et l’URL du service d’authentification unique SAML** à partir de la **section Référence rapide.**
