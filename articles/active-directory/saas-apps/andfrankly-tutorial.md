...
* Vous pouvez permettre aux utilisateurs de se connecter automatiquement à &frankly (par le biais de l’authentification unique) avec leur compte Azure AD.
...
Pour que l’authentification unique fonctionne, une relation entre l’utilisateur Azure AD et l’utilisateur &frankly associé doit être établie.
...
2. **[Configurer l’authentification unique &frankly](#configure-frankly-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test &frankly](#create-frankly-test-user)** pour avoir un équivalent de Britta Simon dans &frankly lié à la représentation Azure AD de l’utilisateur.
...
Pour configurer l’authentification unique Azure AD avec &frankly, effectuez les étapes suivantes :

1. Dans le [portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **&frankly**, sélectionnez **Authentification unique**.
...
4. À la section **Configuration SAML de base**, si vous souhaitez configurer l’application en mode initié par **IDP**, suivez les étapes ci-dessous :
    ...
    ![Informations d’authentification unique dans Domaine et URL &frankly](common/idp-intiated.png)
...
5. Si vous souhaitez configurer l’application en **mode démarré par le fournisseur de services**, cliquez sur **Définir des URL supplémentaires**, puis effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL &frankly](common/metadata-upload-additional-signon.png)
...
7. Dans la section **Configurer &frankly**, copiez la ou les URL appropriées en fonction de vos besoins.
...
### <a name="configure-frankly-single-sign-on"></a>Configurer l’authentification unique &frankly

Pour configurer l’authentification unique côté **&frankly**, vous devez envoyer le **XML des métadonnées de fédération** téléchargé et les URL appropriées copiées à partir du portail Azure à l’[équipe du support technique &frankly](mailto:help@andfrankly.com). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis **&frankly**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **&frankly**.

    ![Lien &frankly dans la liste des applications](common/all-applications.png)
...
Quand vous cliquez sur la vignette &frankly dans le volet d’accès, vous devez être connecté automatiquement à l’application &frankly pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
