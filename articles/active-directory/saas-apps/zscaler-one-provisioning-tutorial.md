...
14. Pour configurer des filtres dՎtendue, suivez les instructions fournies dans le [didacticiel sur les filtres dՎtendue](./../active-directory-saas-scoping-filters.md).
