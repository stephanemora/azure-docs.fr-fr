...
4. Dans la zone de recherche, tapez **Zscaler One**, sélectionnez **Zscaler One** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
    ...
    ![Zscaler One dans la liste des résultats](./media/zscaler-one-tutorial/tutorial_zscalerone_addfromgallery.png)
...
3. **[Création d’un utilisateur de test Zscaler One](#creating-a-zscaler-one-test-user)** pour avoir un équivalent de Britta Simon dans Zscaler One qui est lié à la représentation de l’utilisateur Azure AD.
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL Zscaler One](./media/zscaler-one-tutorial/tutorial_zscalerone_url.png)
...
7. Dans la page **Certificat de signature SAML**, dans la section **Certificat de signature SAML**, cliquez sur **Télécharger** pour télécharger le **Certificat (Base64)**, puis enregistrez le fichier de certificat sur votre ordinateur.
    ...
    ![Lien Téléchargement de certificat](./media/zscaler-one-tutorial/tutorial_zscalerone_certificate.png) 

8. Dans la section **Configurer Zscaler One**, copiez l’URL appropriée en fonction de vos besoins.
    ...
    ![Configuration de Zscaler One](common/configuresection.png)

9. Dans une autre fenêtre de navigateur web, connectez-vous à votre site d’entreprise Zscaler One en tant qu’administrateur.
...
L’objectif de cette section est de créer un utilisateur appelé Britta Simon dans Zscaler One. Zscaler One prend en charge le provisionnement juste-à-temps, option activée par défaut. Vous n’avez aucune opération à effectuer dans cette section. Un utilisateur est créé lors d’une tentative d’accès à Zscaler One s’il n’existe pas encore.
>[!Note]
>Si vous avez besoin de créer un utilisateur manuellement, contactez l’ [équipe de support technique Zscaler One](https://www.zscaler.com/company/contact).
