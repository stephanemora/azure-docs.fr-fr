...
**Pour ajouter Image Relay à partir de la galerie, effectuez les étapes suivantes :**
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    a. Dans la zone de texte **URL de connexion**, entrez une URL au format suivant : `https://<companyname>.imagerelay.com/`
...
**Pour créer un utilisateur appelé Britta Simon dans Image Relay, effectuez les étapes suivantes :**
...
Le fait de cliquer sur la vignette Image Relay dans le volet d’accès doit vous connecter automatiquement à l’application Image Relay pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
