...
## <a name="configure-and-test-azure-ad-sso-for-deskradar"></a>Configurer et tester l’authentification unique Azure AD pour Deskradar
...
Pour configurer et tester l’authentification unique Azure AD avec Deskradar, effectuez les étapes suivantes :
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **Deskradar**, recherchez la section **Gérer**, puis sélectionnez **Authentification unique**.
...
* Cliquez sur **Tester cette application** dans le portail Azure. Cette opération effectue une redirection vers l’URL de connexion à Deskradar, d’où vous pouvez lancer le flux de connexion.  

* Accédez directement à l’URL de connexion à Deskradar, puis lancez le flux de connexion.

#### <a name="idp-initiated"></a>Lancée par le fournisseur d’identité :

* Cliquez sur **Tester cette application** sur le portail Azure. Vous êtes alors connecté automatiquement à l’instance Deskradar pour laquelle vous avez configuré l’authentification unique. 

Vous pouvez aussi utiliser Mes applications de Microsoft pour tester l’application dans n’importe quel mode. Si, quand vous cliquez sur la vignette Deskradar dans Mes applications, le mode Fournisseur de services est configuré, vous êtes redirigé vers la page de connexion de l’application pour lancer le flux de connexion. S’il s’agit du mode Fournisseur d’identité, vous êtes automatiquement connecté à l’instance Deskradar pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Étapes suivantes

Une fois que vous avez configuré Deskradar, vous pouvez appliquer le contrôle de session, qui protège contre l’exfiltration et l’infiltration des données sensibles de votre organisation en temps réel. Le contrôle de session est étendu à partir de l’accès conditionnel. [Découvrez comment appliquer un contrôle de session avec Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-any-app).