---
title: 'Tutoriel : Intégration de l’authentification unique (SSO) Azure Active Directory à Innoverse | Microsoft Docs'
...
ms.locfileid: "92460085"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-innoverse"></a>Tutoriel : Intégration de l’authentification unique (SSO) Azure Active Directory à Innoverse
...
Le fait de cliquer sur la vignette Innoverse dans le panneau d’accès doit vous connecter automatiquement à l’application Innoverse pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
