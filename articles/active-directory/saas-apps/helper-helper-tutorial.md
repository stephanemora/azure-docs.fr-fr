---
title: 'Didacticiel : Intégrer Helper Helper à Azure Active Directory | Microsoft Docs'
...
ms.locfileid: "66569353"
---
# <a name="tutorial-integrate-helper-helper-with-azure-active-directory"></a>Didacticiel : Intégrer Helper Helper à Azure Active Directory
...
Quand vous sélectionnez la vignette Helper Helper dans le volet d’accès, vous devez être connecté automatiquement à l’application Helper Helper pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
