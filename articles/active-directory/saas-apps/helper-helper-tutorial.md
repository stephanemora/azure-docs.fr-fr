---
title: 'Tutoriel : Intégration de l’authentification unique Azure AD à Helper Helper'
...
ms.locfileid: "130004252"
---
# <a name="tutorial-azure-ad-sso-integration-with-helper-helper"></a>Tutoriel : Intégration de l’authentification unique Azure AD à Helper Helper
...
* Helper Helper prend en charge l’authentification unique lancée par **le fournisseur d’identité et le fournisseur de service** ainsi que le provisionnement d’utilisateurs **juste-à-temps**.

## <a name="add-helper-helper-from-the-gallery"></a>Ajouter Helper Helper à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-helper-helper"></a>Configurer et tester l’authentification unique Azure AD pour Helper Helper

Configurez et testez l’authentification unique Azure AD avec Helper Helper à l’aide d’un utilisateur test appelé **B. Simon**. Pour que l’authentification unique fonctionne, vous devez établir un lien entre un utilisateur Azure AD et l’utilisateur Helper Helper associé.

Pour configurer et tester l’authentification unique Azure AD avec Helper Helper, effectuez les étapes suivantes :

1. **[Configurer l’authentification unique Azure AD](#configure-azure-ad-sso)** pour permettre à vos utilisateurs d’utiliser cette fonctionnalité.
   1. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec B. Simon.
   1. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à B. Simon d’utiliser l’authentification unique Azure AD.
1. **[Configurer l’authentification unique de Helper Helper](#configure-helper-helper-sso)** pour configurer les paramètres de l’authentification unique côté application.
   1. **[Créer un utilisateur test Helper Helper](#create-helper-helper-test-user)** pour avoir dans Helper Helper un équivalent de B. Simon lié à la représentation Azure AD de l’utilisateur.
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **Helper Helper**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
## <a name="configure-helper-helper-sso"></a>Configurer l’authentification unique de Helper Helper
...
* Cliquez sur **Tester cette application** dans le portail Azure. Vous êtes alors redirigé vers l’URL d’authentification de Helper Helper, à partir de laquelle vous pouvez lancer le processus de connexion.  

* Accédez directement à l’URL d’authentification de Helper Helper pour lancer le processus de connexion.

#### <a name="idp-initiated"></a>Lancée par le fournisseur d’identité :

* Cliquez sur **Tester cette application** dans le portail Azure, ce qui devrait vous connecter automatiquement à l’application Helper Helper pour laquelle vous avez configuré l’authentification unique. 

Vous pouvez aussi utiliser Mes applications de Microsoft pour tester l’application dans n’importe quel mode. Quand vous cliquez sur la vignette Helper Helper dans Mes applications, si le mode Fournisseur de services est configuré, vous êtes redirigé vers la page d’authentification de l’application pour lancer le processus de connexion. Si le mode Fournisseur d’identité est configuré, vous devriez être automatiquement connecté à l’application Helper Helper pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).

## <a name="next-steps"></a>Étapes suivantes

Une fois que vous avez configuré Helper Helper, vous pouvez appliquer le contrôle de session, qui protège contre l’exfiltration et l’infiltration des données sensibles de votre organisation en temps réel. Le contrôle de session est étendu à partir de l’accès conditionnel. [Découvrez comment appliquer un contrôle de session avec Microsoft Cloud App Security](/cloud-app-security/proxy-deployment-aad).