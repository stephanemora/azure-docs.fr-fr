---
title: "Tutoriel : Intégration d'Azure Active Directory au Portail du financement | Microsoft Docs"
...
1. Dans la zone de recherche, tapez **Portail du financement**.

    ![Création d’un utilisateur de test Azure AD](./media/thefundingportal-tutorial/tutorial_thefundingportal_search.png)

1. Dans le volet de résultats, sélectionnez **The Funding Portal**, puis cliquez sur **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/thefundingportal-tutorial/tutorial_thefundingportal_addfromgallery.png)
...
1. **[Création d’un utilisateur de test The Funding Portal](#creating-the-funding-portal-test-user)** pour avoir un équivalent de Britta Simon dans The Funding Portal lié à la représentation Azure AD associée.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/thefundingportal-tutorial/tutorial_thefundingportal_samlbase.png)

1. Dans la section **Domaine et URL The Funding Portal**, procédez comme suit :

    ![Configurer l'authentification unique](./media/thefundingportal-tutorial/tutorial_thefundingportal_url.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/thefundingportal-tutorial/tutorial_general_400.png)

1. Pour configurer l’authentification unique côté **The Funding Portal**, vous devez envoyer le **XML de métadonnées** à l’[équipe de support technique The Funding Portal](mailto:info@regenteducation.com). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/thefundingportal-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/thefundingportal-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/thefundingportal-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/thefundingportal-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **Portail du financement**.

    ![Configurer l'authentification unique](./media/thefundingportal-tutorial/tutorial_thefundingportal_app.png) 
