---
title: 'Didacticiel : Intégration de l’authentification unique (SSO) Azure Active Directory à Darwinbox | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-darwinbox"></a>Didacticiel : Intégration de l’authentification unique (SSO) Azure Active Directory à Darwinbox
