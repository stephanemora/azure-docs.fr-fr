...
* Dans Azure AD, vous pouvez contrôler qui a accès à ThirdLight.
...
* Abonnement ThirdLight pour lequel l’authentification unique est activée
...
**Pour ajouter Thirdlight à partir de la galerie, effectuez les étapes suivantes :**
...
4. Dans la zone de recherche, tapez **ThirdLight**, sélectionnez **ThirdLight** dans le panneau de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

     ![ThirdLight dans la liste des résultats](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurer et tester l’authentification unique Azure AD

Dans cette section, vous allez configurer et tester l’authentification unique Azure AD avec ThirdLight à l’aide d’un utilisateur de test appelé **Britta Simon**.
Pour que l’authentification unique fonctionne, une relation entre l’utilisateur Azure AD et l’utilisateur ThirdLight associé doit être établie.
...
2. **[Configurer l’authentification unique ThirdLight](#configure-thirdlight-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test ThirdLight](#create-thirdlight-test-user)** pour avoir un équivalent de Britta Simon dans ThirdLight lié à la représentation Azure AD associée.
...
Pour configurer l’authentification unique Azure AD avec ThirdLight, effectuez les étapes suivantes :
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL ThirdLight](common/sp-identifier.png)

    a. Dans la zone de texte **URL de connexion**, entrez une URL au format suivant : `https://<subdomain>.thirdlight.com/`

    b. Dans la zone de texte **Identificateur (ID d’entité)**, saisissez une URL au format suivant : `https://<subdomain>.thirdlight.com/saml/sp`

    > [!NOTE]
    > Il ne s’agit pas de valeurs réelles. Mettez à jour ces valeurs avec l’URL de connexion et l’identificateur réels. Pour obtenir ces valeurs, contactez l’[équipe de support technique Thirdlight](https://www.thirdlight.com/support). Vous pouvez également consulter les modèles figurant à la section **Configuration SAML de base** dans le portail Azure.
...
1. Dans une autre fenêtre de navigateur web, connectez-vous au site de votre entreprise ThirdLight en tant qu’administrateur.
...
1. Dans la section de configuration de SAML2, procédez comme suit :
    ...
    c. Ouvrez le fichier de métadonnées téléchargé à partir du portail Azure, copiez son contenu, puis collez-le dans la zone de texte **Idp Metadata XML**.
...
2. Dans la liste des applications, sélectionnez **Thirdlight**.
    ...
    ![Lien ThirdLight dans la liste des applications](common/all-applications.png)
...
### <a name="create-thirdlight-test-user"></a>Créer un utilisateur de test ThirdLight

Pour permettre aux utilisateurs Azure AD de se connecter à ThirdLight, vous devez les provisionner dans ThirdLight.  
...
Le fait de cliquer sur la vignette ThirdLight dans le panneau d’accès doit vous connecter automatiquement à l’application ThirdLight pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
