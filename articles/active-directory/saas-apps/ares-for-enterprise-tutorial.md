...
* Vous pouvez utiliser Mes applications de Microsoft. Quand vous cliquez sur la vignette ARES for Enterprise dans Mes applications, une redirection est effectuée vers l’URL de connexion à ARES for Enterprise. Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).
