...
1. Dans la zone de recherche, tapez **Eli Onboarding**, sélectionnez **Eli Onboarding** dans le panneau de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
...
1. **[Créer un utilisateur de test Eli Onboarding](#create-an-eli-onboarding-test-user)** pour avoir un équivalent de Britta Simon dans Eli Onboarding lié à la représentation Azure AD associée.
...
1. Dans la section **Domaine et URL Eli Onboarding**, suivez les étapes ci-dessous :
