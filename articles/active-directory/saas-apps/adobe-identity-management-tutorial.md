...
* Adobe Identity Management prend en charge [l’attribution d’utilisateurs et la suppression des privilèges d’accès **automatisées**](adobe-identity-management-provisioning-tutorial.md) (recommandé).
