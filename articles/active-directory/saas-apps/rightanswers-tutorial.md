---
title: "Tutoriel : Intégration d'Azure Active Directory à RightAnswers | Microsoft Docs"
...
ms.locfileid: "54827552"
---
# <a name="tutorial-azure-active-directory-integration-with-rightanswers"></a>Tutoriel : Intégration d'Azure Active Directory à RightAnswers
...
1. Dans la zone de recherche, tapez **RightAnswers**.

    ![Création d’un utilisateur de test Azure AD](./media/rightanswers-tutorial/tutorial_rightanswers_search.png)

1. Dans le panneau de résultats, sélectionnez **RightAnswers**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/rightanswers-tutorial/tutorial_rightanswers_addfromgallery.png)
...
1. **[Création d’un utilisateur de test RightAnswers](#creating-a-rightanswers-test-user)** pour avoir un équivalent de Britta Simon dans RightAnswers lié à la représentation Azure AD de l’utilisateur.
...
1. Dans la section **RightAnswers Domain and URLs** (Domaine et URL RightAnswers), procédez comme suit :
...
1. Pour configurer l’authentification unique côté **RightAnswers**, vous devez envoyer le fichier **XML de métadonnées** téléchargé à [l’équipe de support technique RightAnswers](https://www.rightanswers.com/contact-us/).
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/rightanswers-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/rightanswers-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/rightanswers-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/rightanswers-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **RightAnswers**.
