...
1. Dans la zone de recherche, saisissez **CS Stars**.

    ![Création d’un utilisateur de test Azure AD](./media/cs-stars-tutorial/tutorial_csstars_search.png)

1. Dans le volet de résultats, sélectionnez **CS Stars**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/cs-stars-tutorial/tutorial_csstars_addfromgallery.png)
...
1. **[Création d’un utilisateur de test CS Stars](#creating-a-cs-stars-test-user)** pour avoir un équivalent de Britta Simon dans CS Stars lié à la représentation Azure AD de l’utilisateur.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/cs-stars-tutorial/tutorial_csstars_samlbase.png)

1. Dans la section **Domaine et URL CS Stars**, procédez comme suit :

    ![Configurer l'authentification unique](./media/cs-stars-tutorial/tutorial_csstars_url.png)
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/cs-stars-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/cs-stars-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/cs-stars-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/cs-stars-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **CS Stars**.

    ![Configurer l'authentification unique](./media/cs-stars-tutorial/tutorial_csstars_app.png) 
