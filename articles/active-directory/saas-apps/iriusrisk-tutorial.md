...
1. **[Créer un utilisateur de test IriusRisk](#create-an-iriusrisk-test-user)**  - pour avoir un équivalent de Britta Simon dans IriusRisk, lié à la représentation Azure AD de l’utilisateur.
