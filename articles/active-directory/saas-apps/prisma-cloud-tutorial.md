...
* Prisma Cloud SSO prend en charge le provisionnement d’utilisateurs **juste-à-temps**.

## <a name="add-prisma-cloud-sso-from-the-gallery"></a>Ajouter Prisma Cloud SSO à partir de la galerie
...
## <a name="configure-and-test-azure-ad-sso-for-prisma-cloud-sso"></a>Configurer et tester l’authentification unique Azure AD pour Prisma Cloud SSO
...
Pour configurer et tester l’authentification unique Azure AD auprès de Prisma Cloud SSO, effectuez les étapes suivantes :
...
1. Dans le portail Azure, accédez à la page d’intégration de l’application **Prisma Cloud SSO**, recherchez la section **Gérer**, puis sélectionnez **Authentification unique**.
...
* Un clic sur Tester cette application dans le portail Azure doit vous connecter automatiquement à l’instance de Prisma Cloud SSO pour laquelle vous avez configuré l’authentification unique.

* Vous pouvez utiliser Mes applications de Microsoft. Le fait de cliquer sur la vignette Prisma Cloud SSO dans Mes applications doit vous connecter automatiquement à l’application Prisma Cloud SSO pour laquelle vous avez configuré l’authentification unique (SSO). Pour plus d’informations sur Mes applications, consultez [Présentation de Mes applications](../user-help/my-apps-portal-end-user-access.md).
