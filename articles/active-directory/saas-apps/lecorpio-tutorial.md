...
1. Dans la zone de recherche, tapez **Lecorpio**.

    ![Création d’un utilisateur de test Azure AD](./media/lecorpio-tutorial/tutorial_lecorpio_search.png)

1. Dans le volet de résultats, sélectionnez **Lecorpio**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/lecorpio-tutorial/tutorial_lecorpio_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Lecorpio](#creating-a-lecorpio-test-user)** pour avoir un équivalent de Britta Simon dans Lecorpio lié à la représentation Azure AD de l’utilisateur.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/lecorpio-tutorial/tutorial_lecorpio_samlbase.png)

1. Dans la section **Domaine et URL Lecorpio**, effectuez les étapes suivantes :

    ![Configurer l'authentification unique](./media/lecorpio-tutorial/tutorial_lecorpio_url.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/lecorpio-tutorial/tutorial_general_400.png)

1. Pour configurer l’authentification unique côté **Lecorpio**, vous devez envoyer le fichier **XML des métadonnées** téléchargé à l’[équipe de support technique Lecorpio](mailto:info@lecorpio.com).
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/lecorpio-tutorial/create_aaduser_01.png) 

1. Accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs** pour afficher la liste des utilisateurs.
    
    ![Création d’un utilisateur de test Azure AD](./media/lecorpio-tutorial/create_aaduser_02.png) 

1. En haut de la boîte de dialogue, cliquez sur **Ajouter** pour ouvrir la boîte de dialogue **Utilisateur**.
 
    ![Création d’un utilisateur de test Azure AD](./media/lecorpio-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/lecorpio-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **Lecorpio**.

    ![Configurer l'authentification unique](./media/lecorpio-tutorial/tutorial_lecorpio_app.png) 
