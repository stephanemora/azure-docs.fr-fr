...
2. Clé secrète client pour la génération de jetons d’accès. Ce secret doit vous avoir été transmis de manière sécurisée. Contactez support@mid.de pour plus d’informations.
