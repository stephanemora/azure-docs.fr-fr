---
title: "Didacticiel : Intégration d'Azure Active Directory à TurboRater | Microsoft Docs"
...
**Pour ajouter TurboRater à partir de la galerie, effectuez les étapes suivantes :**
...
Dans cette section, vous allez configurer et tester l’authentification unique Azure AD auprès de TurboRater, en ayant recours à un utilisateur de test appelé **Britta Simon**.
Pour que l’authentification unique fonctionne, une relation entre l’utilisateur Azure AD et l’utilisateur TurboRater associé doit être établie.
...
2. **[Configurer l’authentification unique TurboRater](#configure-turborater-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test TurboRater](#create-turborater-test-user)** pour avoir un équivalent de Britta Simon dans TurboRater, lié à la représentation Azure AD associée.
...
4. Sur la page **Configurer l’authentification unique avec SAML**, effectuez les étapes suivantes :
    ...
    a. Dans la zone de texte **Identificateur**, tapez une URL : `https://www.itcdataservices.com`
...
6. Dans la section **Configurer TurboRater**, copiez la ou les URL appropriées en fonction de vos besoins.
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis **TurboRater**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **TurboRater**.

    ![Lien vers TurboRater dans la liste des applications](common/all-applications.png)
...
### <a name="create-turborater-test-user"></a>Créer un utilisateur de test TurboRater

Dans cette section, vous allez créer un utilisateur appelé Britta Simon dans TurboRater. Contactez l’ [équipe du support technique TurboRater](https://www.getitc.com/support) pour ajouter des utilisateurs dans la plateforme TurboRater. Les utilisateurs doivent être créés et activés avant que vous utilisiez l’authentification unique.

### <a name="test-single-sign-on"></a>Tester l’authentification unique 

Dans cette section, vous allez tester la configuration de l’authentification unique Azure AD à l’aide du volet d’accès.

Le fait de cliquer sur la vignette TurboRater dans le volet d’accès doit vous connecter automatiquement à l’application TurboRater pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
