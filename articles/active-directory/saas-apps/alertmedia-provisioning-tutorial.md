...
> * [Authentification unique](https://docs.microsoft.com/azure/active-directory/saas-apps/alertmedia-tutorial) auprès d’AlertMedia (recommandée)
...
3. Déterminez les données à [mapper entre Azure AD et AlertMedia](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
