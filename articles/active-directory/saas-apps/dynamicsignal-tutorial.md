...
1. Dans la zone de recherche, tapez **Dynamic Signal**, sélectionnez **Dynamic Signal** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
...
1. **[Créer utilisateur de test Dynamic Signal](#create-a-dynamic-signal-test-user)** pour avoir un équivalent de Britta Simon dans Dynamic Signal lié à la représentation Azure AD associée.
...
1. Dans la section **Domaine et URL Dynamic Signal**, procédez comme suit :
...
1. Dans la section **Configuration de Dynamic Signal**, cliquez sur **Configurer Dynamic Signal** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez **l’URL de déconnexion, l’ID d’entité SAML et l’URL du service d’authentification unique SAML** à partir de la **section Référence rapide.**
