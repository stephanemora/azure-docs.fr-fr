---
title: 'Didacticiel : Intégration d’Azure Active Directory à Spacio | Microsoft Docs'
...
* Vous pouvez permettre aux utilisateurs de se connecter automatiquement à Spacio (par le biais de l’authentification unique) avec leur compte Azure AD.
...
* Spacio prend en charge l’authentification unique (SSO) initiée par le **fournisseur de services**
...
**Pour ajouter Spacio à partir de la galerie, effectuez les étapes suivantes :**
...
4. Dans la zone de recherche, tapez **Spacio**, sélectionnez **Spacio** dans le panneau de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
     ...
     ![Spacio dans la liste des résultats](common/search-new-app.png)
...
Pour que l’authentification unique fonctionne, une relation entre l’utilisateur Azure AD et l’utilisateur Spacio associé doit être établie.
...
2. **[Configurer l’authentification unique Spacio](#configure-spacio-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test Spacio](#create-spacio-test-user)** pour avoir un équivalent de Britta Simon dans Spacio lié à la représentation Azure AD associée.
...
1. Dans le [portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **Spacio**, sélectionnez **Authentification unique**.
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique pour Domaine et URL Spacio](common/sp-identifier.png)

    a. Dans la zone de texte **URL de connexion**, entrez une URL au format suivant : `https://sso.spac.io/<brokerageID>`
...
### <a name="configure-spacio-single-sign-on"></a>Configurer l’authentification unique Spacio

Pour configurer l’authentification unique côté **Spacio**, vous devez envoyer **l’URL des métadonnées de fédération de l’application** à [l’équipe du support technique Spacio](mailto:support@spac.io). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis sélectionnez **Spacio**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **Spacio**.

    ![Lien Spacio dans la liste des applications](common/all-applications.png)
...
### <a name="create-spacio-test-user"></a>Créer un utilisateur de test Spacio
...
Lorsque vous cliquez sur la mosaïque Spacio dans le volet d’accès, vous devez être connecté automatiquement à l’application Spacio pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
