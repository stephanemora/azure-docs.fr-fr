...
1. Dans la zone de recherche, tapez **Spacio**, sélectionnez **Spacio** dans le panneau de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Spacio dans la liste des résultats](./media/spacio-tutorial/tutorial_spacio_addfromgallery.png)
...
1. **[Créer un utilisateur de test Spacio](#create-a-spacio-test-user)** pour avoir un équivalent de Britta Simon dans Spacio lié à la représentation Azure AD associée.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Boîte de dialogue Authentification unique](./media/spacio-tutorial/tutorial_spacio_samlbase.png)

1. Dans la section **Domaine et URL Spacio**, procédez comme suit :

    ![Informations d’authentification unique pour Domaine et URL Spacio](./media/spacio-tutorial/tutorial_spacio_url.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Bouton Enregistrer de la page Configurer l’authentification unique](./media/spacio-tutorial/tutorial_general_400.png)
...
1. Dans la section **Certificat de signature SAML**, cliquez sur le bouton Copier pour copier **l’URL des métadonnées de fédération de l’application**, puis collez-la dans le Bloc-notes. 
    ...
    ![Lien Téléchargement de certificat](./media/spacio-tutorial/tutorial_spacio_certificate.png)
...
1. Dans le volet gauche du Portail Azure, cliquez sur le bouton **Azure Active Directory**.
    ...
    ![Bouton Azure Active Directory](./media/spacio-tutorial/create_aaduser_01.png)

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.

    ![Liens « Utilisateurs et groupes » et « Tous les utilisateurs »](./media/spacio-tutorial/create_aaduser_02.png)

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue **Tous les utilisateurs**.

    ![Bouton Ajouter](./media/spacio-tutorial/create_aaduser_03.png)

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :

    ![Boîte de dialogue Utilisateur](./media/spacio-tutorial/create_aaduser_04.png)
...
1. Dans la liste des applications, sélectionnez **Spacio**.

    ![Lien Spacio dans la liste des applications](./media/spacio-tutorial/tutorial_spacio_app.png)  
