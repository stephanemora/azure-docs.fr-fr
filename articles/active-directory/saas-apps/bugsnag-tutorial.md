...
ms.locfileid: "67106039"
---
# <a name="tutorial-azure-active-directory-integration-with-bugsnag"></a>Didacticiel : Intégration d’Azure Active Directory à Bugsnag
...
Le fait de cliquer sur la vignette Bugsnag dans le volet d’accès doit automatiquement vous connecter à l’application Bugsnag pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
