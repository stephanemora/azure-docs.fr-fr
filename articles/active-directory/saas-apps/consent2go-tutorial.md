...
ms.locfileid: "56869222"
---
# <a name="tutorial-azure-active-directory-integration-with-consent2go"></a>Tutoriel : Intégration d’Azure Active Directory à Consent2Go
...
* Vous pouvez permettre aux utilisateurs de se connecter automatiquement à Consent2Go (par le biais de l’authentification unique) avec leur compte Azure AD.
...
4. Dans la zone de recherche, tapez **Consent2Go**, sélectionnez **Consent2Go** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
     ...
     ![Consent2Go dans la liste des résultats](common/search-new-app.png)
...
Pour que l’authentification unique fonctionne, une relation entre l’utilisateur Azure AD et l’utilisateur Consent2Go associé doit être établie.
...
2. **[Configurer l’authentification unique Consent2Go](#configure-consent2go-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test Consent2Go](#create-consent2go-test-user)** pour avoir dans Consent2Go un équivalent de Britta Simon lié à la représentation Azure AD associée.
...
Pour configurer l’authentification unique Azure AD avec Consent2Go, effectuez les étapes suivantes :
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL Consent2Go](common/sp-signonurl.png)

    Dans la zone de texte **URL de connexion**, tapez une URL : `https://www.mcbschools.com/Login`
...
### <a name="configure-consent2go-single-sign-on"></a>Configurer l’authentification unique Consent2Go
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis **Consent2Go**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **Consent2Go**.

    ![Lien Consent2Go dans la liste des applications](common/all-applications.png)
...
Dans cette section, vous allez créer un utilisateur appelé Britta Simon dans Consent2Go. Collaborez avec l’ [équipe du support technique Consent2Go](mailto:support@consent2go.com) pour ajouter les utilisateurs à la plateforme Consent2Go. Les utilisateurs doivent être créés et activés avant que vous utilisiez l’authentification unique.

### <a name="test-single-sign-on"></a>Tester l’authentification unique 

Dans cette section, vous allez tester la configuration de l’authentification unique Azure AD à l’aide du volet d’accès.

Quand vous cliquez sur la vignette Consent2Go dans le volet d’accès, vous devez être connecté automatiquement à l’application Consent2Go pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
