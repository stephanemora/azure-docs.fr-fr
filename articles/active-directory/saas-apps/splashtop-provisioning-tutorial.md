...
> * [Authentification unique](https://docs.microsoft.com/azure/active-directory/saas-apps/splashtop-tutorial) auprès de Splashtop (recommandé)
...
3. Déterminez les données à [mapper entre Azure AD et Splashtop](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes). 
