...
> - [Authentification unique](./travelperk-tutorial.md) auprès de TravelPerk (recommandé)
...
3. Déterminez les données à [mapper entre Azure AD et TravelPerk](../app-provisioning/customize-application-attributes.md).
