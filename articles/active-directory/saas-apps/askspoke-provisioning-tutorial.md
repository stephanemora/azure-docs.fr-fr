...
> -  [Authentification unique](./askspoke-tutorial.md) sur askSpoke (recommandé)
...
3. Déterminez les données à [mapper entre Azure AD et askSpoke](../app-provisioning/customize-application-attributes.md).
