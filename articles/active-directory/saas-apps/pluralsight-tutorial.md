...
## <a name="configure-and-test-azure-ad-single-sign-on-for-pluralsight"></a>Configurer et tester l’authentification unique Azure AD pour Pluralsight
...
Pour configurer et tester l’authentification unique Azure AD avec Pluralsight, suivez les indications des sections ci-après :
...
1. Dans le [portail Azure](https://portal.azure.com/), accédez à la page d’intégration de l’application **Pluralsight** , recherchez la section **Gérer** et sélectionnez **Authentification unique** .
...
1. Dans la section **Configuration SAML de base** , entrez les valeurs pour les champs suivants :
    ...
    b. Dans la zone de texte **Identificateur** , tapez une URL en utilisant le format suivant : `www.pluralsight.com`
...
- [Essayer Pluralsight avec Azure AD](https://aad.portal.azure.com/)