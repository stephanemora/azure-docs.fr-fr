---
title: 'Tutoriel : Intégration d’Azure Active Directory à TimeLive | Microsoft Docs'
...
ms.locfileid: "55194523"
---
# <a name="tutorial-azure-active-directory-integration-with-timelive"></a>Tutoriel : Intégration d’Azure Active Directory à TimeLive
...
1. Dans la zone de recherche, tapez **TimeLive**, sélectionnez **TimeLive** dans le panneau des résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![TimeLive dans la liste des résultats](./media/timelive-tutorial/tutorial_timelive_addfromgallery.png)
...
1. **[Créer un utilisateur de test TimeLive](#create-a-timelive-test-user)** pour avoir dans TimeLive un équivalent de Britta Simon lié à la représentation Azure AD associée.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Boîte de dialogue Authentification unique](./media/timelive-tutorial/tutorial_timelive_samlbase.png)

1. Dans la section **Domaine et URL TimeLive**, procédez comme suit :

    ![Informations d’authentification unique dans Domaine et URL TimeLive](./media/timelive-tutorial/tutorial_timelive_url.png)
...
1. Dans la section **Certificat de signature SAML**, cliquez sur **Téléchargez le certificat (Base64)** puis enregistrez le fichier du certificat sur votre ordinateur.
    ...
    ![Lien Téléchargement de certificat](./media/timelive-tutorial/tutorial_timelive_certificate.png) 

1. Cliquez sur le bouton **Enregistrer** .

    ![Bouton Enregistrer de la page Configurer l’authentification unique](./media/timelive-tutorial/tutorial_general_400.png)
    
1. Dans la section **Configuration de TimeLive**, cliquez sur **Configurer TimeLive** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez **l’URL de déconnexion et l’URL du service d’authentification unique SAML** à partir de la **section Référence rapide**.

    ![Configuration de TimeLive](./media/timelive-tutorial/tutorial_timelive_configure.png)

1. Dans une autre fenêtre de navigateur web, connectez-vous à votre site d’entreprise TimeLive en tant qu’administrateur.

1. Sous **Options d’administration**, sélectionnez **Préférences**.

    ![Configuration de TimeLive](./media/timelive-tutorial/configure1.png)

1. Dans la section **Préférence d’application**, procédez comme suit :
...
1. Dans le volet gauche du Portail Azure, cliquez sur le bouton **Azure Active Directory**.
    ...
    ![Bouton Azure Active Directory](./media/timelive-tutorial/create_aaduser_01.png)

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.

    ![Liens « Utilisateurs et groupes » et « Tous les utilisateurs »](./media/timelive-tutorial/create_aaduser_02.png)

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue **Tous les utilisateurs**.

    ![Bouton Ajouter](./media/timelive-tutorial/create_aaduser_03.png)

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :

    ![Boîte de dialogue Utilisateur](./media/timelive-tutorial/create_aaduser_04.png)
...
1. Dans la liste des applications, sélectionnez **TimeLive**.

    ![Lien TimeLive dans la liste des applications](./media/timelive-tutorial/tutorial_timelive_app.png)  
