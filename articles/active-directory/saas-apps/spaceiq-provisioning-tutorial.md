---
title: 'Didacticiel : Configurer SpaceIQ pour l’approvisionnement automatique d’utilisateurs avec Azure Active Directory | Microsoft Docs'
...
ms.locfileid: "74134357"
---
# <a name="tutorial-configure-spaceiq-for-automatic-user-provisioning"></a>Didacticiel : Configurer SpaceIQ pour l’attribution automatique d’utilisateurs
...
5. Sous la section **Informations d’identification de l’administrateur**, saisissez `https://api.spaceiq.com/scim` dans **URL du locataire**. Saisissez la valeur de **Jeton d’authentification SCIM** récupérée précédemment dans **Jeton secret**. Cliquez sur **Tester la connexion** pour vérifier qu'Azure AD peut se connecter à SpaceIQ. Si la connexion échoue, vérifiez que votre compte SpaceIQ dispose d’autorisations d’administrateur et réessayez.
