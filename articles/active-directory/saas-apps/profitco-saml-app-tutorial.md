...
* Permettre aux utilisateurs de se connecter automatiquement à Profit.co SAML App avec leur compte Azure AD.
...
## <a name="add-profitco-saml-app-from-the-gallery"></a>Ajouter Profit.co SAML App à partir de la galerie
...
Configurez et testez l’authentification unique (SSO) Azure AD avec Profit.co SAML App à l’aide d’un utilisateur de test appelé **B.Simon**. Pour que l’authentification unique fonctionne, établissez un lien entre un utilisateur Azure AD et l’utilisateur Profit.co SAML App associé.

Voici la procédure générale pour configurer et tester l’authentification unique Azure AD avec Profit.co SAML App :
...
1. **[Configurer l’authentification unique Profit.co SAML App](#configure-profitco-saml-app-sso)** pour configurer les paramètres de l’authentification unique côté application
    1. **[Créer un utilisateur de test Profit.co SAML App](#create-a-profitco-saml-app-test-user)** pour avoir un équivalent de B.Simon dans Profit.co SAML App Cet équivalent est lié à la représentation Azure AD de l’utilisateur.
...
1. Sur le [portail Azure](https://portal.azure.com/), accédez à la page d’intégration de l’application **Profit.co SAML App** et recherchez la section **Gérer**. Sélectionnez **Authentification unique**.
...
Pour configurer l’authentification unique côté Profit.co SAML App, vous devez envoyer l’URL des métadonnées de fédération de l’application à l’[équipe du support technique Profit.co SAML App](mailto:support@profit.co). Celle-ci configure ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.

### <a name="create-a-profitco-saml-app-test-user"></a>Créer un utilisateur de test Profit.co SAML App

Dans cette section, vous allez créer un utilisateur appelé B.Simon dans Profit.co SAML App. Rapprochez-vous de l’ [équipe du support technique Profit.co SAML App](mailto:support@profit.co) pour ajouter les utilisateurs dans la plateforme Profit.co SAML App. Vous ne pouvez pas utiliser l’authentification unique avant d’avoir créé et activé les utilisateurs.
...
Quand vous sélectionnez la vignette Profit.co SAML App dans le volet d’accès, vous devez être connecté automatiquement à l’application Profit.co SAML App pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations, consultez [Présentation du volet d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
