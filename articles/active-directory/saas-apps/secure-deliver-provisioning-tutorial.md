...
> * Utiliser l’[authentification unique](./securedeliver-tutorial.md) pour SECURE DELIVER (recommandé)
...
3. Déterminez les données à [mapper entre Azure AD et SECURE DELIVER](../app-provisioning/customize-application-attributes.md). 
