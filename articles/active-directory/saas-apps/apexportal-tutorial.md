...
* Vous pouvez permettre aux utilisateurs de se connecter automatiquement à Apex Portal (par le biais de l’authentification unique) avec leur compte Azure AD.
...
Dans cette section, vous allez configurer et tester l’authentification unique Azure AD auprès d’Apex Portal sur un utilisateur de test nommé **Britta Simon**.
Pour que l’authentification unique fonctionne, une relation entre un utilisateur Azure AD et l’utilisateur Apex Portal associé doit être établie.
...
2. **[Configurer l’authentification unique Apex Portal](#configure-apex-portal-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test Apex Portal](#create-apex-portal-test-user)** pour avoir un équivalent de Britta Simon dans Apex Portal, associé à sa représentation dans Azure AD.
...
Pour configurer l’authentification unique Azure AD auprès d’Apex Portal, effectuez les étapes suivantes :

1. Dans le [portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **Apex Portal**, sélectionnez **Authentification unique**.
...
8. Dans la section **Configurer Apex Portal**, copiez la ou les URL appropriées en fonction de vos besoins.
...
### <a name="configure-apex-portal-single-sign-on"></a>Configurer l’authentification unique Apex portail
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis **Apex Portal**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **Apex Portal**.

    ![Lien Apex Portal dans la liste des applications](common/all-applications.png)
