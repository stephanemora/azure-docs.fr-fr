---
title: 'Didacticiel : Intégration de l’authentification unique (SSO) Azure Active Directory à Blink | Microsoft Docs'
...
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-blink"></a>Didacticiel : Intégration de l’authentification unique (SSO) Azure Active Directory à Blink
...
Le fait de cliquer sur la vignette Blink dans le volet d’accès doit vous connecter automatiquement à l’application Blink pour laquelle vous avez configuré l’authentification unique (SSO). Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
