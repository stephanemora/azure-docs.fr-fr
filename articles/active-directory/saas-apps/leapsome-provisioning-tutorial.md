---
title: 'Didacticiel : Configurer Leapsome pour l’approvisionnement automatique d’utilisateurs avec Azure Active Directory | Microsoft Docs'
...
ms.locfileid: "67672693"
---
# <a name="tutorial-configure-leapsome-for-automatic-user-provisioning"></a>Didacticiel : Configurer Leapsome pour l’approvisionnement automatique d’utilisateurs
...
5. Sous la section **Informations d’identification de l’administrateur**, saisissez `https://www.leapsome.com/api/scim` dans **URL du locataire**. Saisissez la valeur de **Jeton d’authentification SCIM** récupérée précédemment dans **Jeton secret**. Cliquez sur **Tester la connexion** pour vérifier qu’Azure AD peut se connecter à Leapsome. Si la connexion échoue, vérifiez que votre compte Leapsome dispose d’autorisations d’administrateur et réessayez.
