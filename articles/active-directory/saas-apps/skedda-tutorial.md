...
Pour configurer et tester l’authentification unique Azure AD avec Skedda, effectuez les modules suivants :
...
1. Sur le [portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **Skedda** , recherchez la section **Gérer** , puis sélectionnez **Authentification unique**.
...
Le fait de cliquer sur la vignette Skedda dans le volet d’accès doit vous connecter automatiquement à l’application Skedda pour laquelle vous avez configuré l’authentification unique (SSO). Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
...
- [Essayer Skedda avec Azure AD](https://aad.portal.azure.com/)

- [Qu’est-ce que le contrôle de session dans Microsoft Cloud App Security ?](/cloud-app-security/proxy-intro-aad)

- [Guide pratique pour protéger Skedda avec une visibilité et des contrôles avancés](/cloud-app-security/proxy-intro-aad)