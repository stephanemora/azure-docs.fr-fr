...
Quand vous cliquez sur la vignette Ivanti Service Manager (ISM) dans le volet d’accès, vous devez être connecté automatiquement au service Ivanti Service Manager (ISM) pour lequel vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
