...
3. **[Créer un utilisateur de test OrgChart Now](#create-an-orgchart-now-test-user)** pour avoir un équivalent de Britta Simon dans OrgChart Now, lié à la représentation Azure AD associée.
...
3. Dans la section **Domaines et URL OrgChart Now**, si vous souhaitez configurer l’application en mode initié par **IDP**, suivez les étapes ci-dessous :
