...
1. Dans la zone de recherche, tapez **Cherwell**.

    ![Création d’un utilisateur de test Azure AD](./media/cherwell-tutorial/tutorial_cherwell_search.png)

1. Dans le volet de résultats, sélectionnez **Cherwell**, puis cliquez sur **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/cherwell-tutorial/tutorial_cherwell_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Cherwell](#creating-a-cherwell-test-user)** pour avoir un équivalent de Britta Simon dans Cherwell lié à la représentation Azure AD de l’utilisateur.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/cherwell-tutorial/tutorial_cherwell_samlbase.png)

1. Dans la section **Domaine et URL Cherwell**, effectuez les étapes suivantes :

    ![Configurer l'authentification unique](./media/cherwell-tutorial/tutorial_cherwell_url.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/cherwell-tutorial/tutorial_general_400.png)

1. Dans la section **Configuration de Cherwell**, cliquez sur **Configurer Cherwell** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez l’**ID d’entité SAML et l’URL du service d’authentification unique SAML** à partir de la **section Référence rapide**

    ![Configurer l'authentification unique](./media/cherwell-tutorial/tutorial_cherwell_configure.png) 

1. Pour configurer l’authentification unique côté **Cherwell**, vous devez envoyer le **Certificat (en base64)** téléchargé, **l’URL du service d’authentification unique SAML** et **l’ID d’entité SAML** à [l’équipe du support Cherwell](https://csm.cherwell.com/contact). 
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/cherwell-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/cherwell-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/cherwell-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/cherwell-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **Cherwell**.
    ...
    ![Configurer l'authentification unique](./media/cherwell-tutorial/tutorial_cherwell_app.png) 
