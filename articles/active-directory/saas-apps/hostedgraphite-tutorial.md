---
title: 'Tutoriel : Intégration d’Azure Active Directory à Hosted Graphite | Microsoft Docs'
...
ms.locfileid: "55152074"
---
# <a name="tutorial-azure-active-directory-integration-with-hosted-graphite"></a>Tutoriel : Intégration d’Azure Active Directory à Hosted Graphite
...
1. Dans la zone de recherche, tapez **Hosted Graphite**.

    ![Création d’un utilisateur de test Azure AD](./media/hostedgraphite-tutorial/tutorial_hostedgraphite_search.png)

1. Dans le volet des résultats, sélectionnez **Hosted Graphite**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/hostedgraphite-tutorial/tutorial_hostedgraphite_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Hosted Graphite](#creating-a-hosted-graphite-test-user)** pour avoir un équivalent de Britta Simon dans Hosted Graphite lié à la représentation Azure AD associée.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/hostedgraphite-tutorial/tutorial_hostedgraphite_samlbase.png)

1. Dans la section **Domaine et URL Hosted Graphite**, si vous voulez configurer l’application en **Mode initié par IDP**, procédez comme suit :

    ![Configurer l'authentification unique](./media/hostedgraphite-tutorial/tutorial_hostedgraphite_url.png)
...
1. Dans la section **Domaine et URL Hosted Graphite**, si vous voulez configurer l’application en **Mode initié par SP**, procédez comme suit :
   
    ![Configurer l'authentification unique](./media/hostedgraphite-tutorial/tutorial_hostedgraphite_10.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/hostedgraphite-tutorial/tutorial_general_400.png)

1. Dans la section **Configuration d’Hosted Graphite**, cliquez sur **Configurer Hosted Graphite** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez **l’ID d’entité SAML et l’URL du service d’authentification unique SAML** à partir de la **section Référence rapide**.

    ![Configurer l'authentification unique](./media/hostedgraphite-tutorial/tutorial_hostedgraphite_configure.png) 

1. Connectez-vous à votre client Hosted Graphite en tant qu’administrateur.

1. Accédez à la **page de configuration de SAML** dans la barre latérale (**Accéder -> Configuration SAML**).
   
    ![Configurer l’authentification unique côté application](./media/hostedgraphite-tutorial/tutorial_hostedgraphite_000.png)

1. Confirmez que ces URL correspondent à votre configuration de la section **Domaine et URL Hosted Graphite** du portail Azure.
   
    ![Configurer l’authentification unique côté application](./media/hostedgraphite-tutorial/tutorial_hostedgraphite_001.png)

1. Dans les zones de texte **ID d’entité ou d’émetteur** et **URL de connexion à authentification unique**, collez les valeurs **ID d’entité SAML** et **URL du service d’authentification unique SAML** que vous avez copiées à partir du portail Azure. 
   
    ![Configurer l’authentification unique côté application](./media/hostedgraphite-tutorial/tutorial_hostedgraphite_002.png)
   

1. Sélectionnez « **Lecture seule** » comme **Rôle d’utilisateur par défaut**.
    
    ![Configurer l’authentification unique côté application](./media/hostedgraphite-tutorial/tutorial_hostedgraphite_004.png)

1. Ouvrez dans le Bloc-notes votre certificat codé en base 64 téléchargé à partir du portail Azure, copiez son contenu dans le Presse-papiers, puis collez-le dans la zone de texte **Certificat X.509**.
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/hostedgraphite-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/hostedgraphite-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/hostedgraphite-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/hostedgraphite-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **Hosted Graphite**.
    ...
    ![Configurer l'authentification unique](./media/hostedgraphite-tutorial/tutorial_hostedgraphite_app.png) 
