...
4. Dans la zone de recherche, entrez **SAP Business Object Cloud**.
    ...
    ![La zone de recherche](./media/sapboc-tutorial/tutorial_sapboc_search.png)

5. Dans le panneau de résultats, sélectionnez **SAP Business Object Cloud**, puis cliquez sur **Ajouter**.

    ![SAP Business Object Cloud dans la liste des résultats](./media/sapboc-tutorial/tutorial_sapboc_addfromgallery.png)
...
2. Dans la page **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML**.
    ...
    ![Sélectionner l’authentification basée sur SAML](./media/sapboc-tutorial/tutorial_sapboc_samlbase.png)
...
4. Sous **le certificat de signature SAML**, sélectionnez **XML des métadonnées**. Ensuite, enregistrez le fichier de métadonnées sur votre ordinateur.
    ...
    ![Sélectionnez XML des métadonnées](./media/sapboc-tutorial/tutorial_sapboc_certificate.png) 

5. Sélectionnez **Enregistrer**.

    ![Sélectionner Enregistrer](./media/sapboc-tutorial/tutorial_general_400.png)
...
1. Dans le menu de gauche du Portail Azure, sélectionnez **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/sapboc-tutorial/create_aaduser_01.png) 

2. Pour afficher la liste des utilisateurs, sélectionnez **Utilisateurs et groupes**, puis **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/sapboc-tutorial/create_aaduser_02.png) 

3. Pour ouvrir la boîte de dialogue **Utilisateur**, sélectionnez **Ajouter**.
 
    ![Création d’un utilisateur de test Azure AD](./media/sapboc-tutorial/create_aaduser_03.png) 
...
4. Dans la boîte de dialogue **Utilisateur**, suivez les étapes ci-dessous :
    ...
    4. Sélectionnez **Créer**.
        ...
        ![Boîte de dialogue Utilisateur](./media/sapboc-tutorial/create_aaduser_04.png) 
...
2. Dans la liste des applications, sélectionnez **SAP Business Object Cloud**.
    ...
    ![Configurer l'authentification unique](./media/sapboc-tutorial/tutorial_sapboc_app.png) 
