...
## <a name="adding-code42-from-the-gallery"></a>Ajout de Code42 depuis la galerie
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-code42"></a>Configurer et tester l’authentification unique Azure AD pour Code42
...
Pour configurer et tester l’authentification unique Azure AD avec Code42, suivez les indications des modules ci-après :
...
1. **[Configurer l’authentification unique Code42](#configure-code42-sso)** pour configurer les paramètres de l’authentification unique côté application.
    * **[Créer un utilisateur de test Code42](#create-code42-test-user)** pour avoir un équivalent de B.Simon dans Code42, associé à sa représentation dans Azure AD.
...
1. Dans le [portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **Code42**, recherchez la section **Gérer** et sélectionnez **Authentification unique**.
...
1. Dans la section **Configuration SAML de base**, entrez les valeurs pour les champs suivants :
    ...
    Dans la zone de texte **URL de connexion**, tapez une URL : `https://www.crashplan.com/console`
...
Le fait de cliquer sur la vignette Code42 dans le volet d’accès doit vous connecter automatiquement à l’application Code42 pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
...
- [Essayer Code42 avec Azure AD](https://aad.portal.azure.com/)
