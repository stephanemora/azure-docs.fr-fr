...
* Dans Azure AD, vous pouvez contrôler qui a accès à CBRE ServiceInsight.
* Vous pouvez permettre aux utilisateurs de se connecter automatiquement à CBRE ServiceInsight (par le biais de l’authentification unique) avec leur compte Azure AD.
...
Pour configurer l’intégration d’Azure AD à CBRE ServiceInsight, vous avez besoin des éléments suivants :

* Un abonnement Azure AD Si vous n’avez pas d’environnement Azure AD, vous pouvez obtenir un essai d’un mois [ici](https://azure.microsoft.com/pricing/free-trial/).
* Abonnement CBRE ServiceInsight pour lequel l’authentification unique est activée
...
**Pour ajouter CBRE ServiceInsight à partir de la galerie, effectuez les étapes suivantes :**
...
4. Dans la zone de recherche, tapez **CBRE ServiceInsight**, sélectionnez **CBRE ServiceInsight** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

     ![CBRE ServiceInsight dans la liste des résultats](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurer et tester l’authentification unique Azure AD

Dans cette section, vous allez configurer et tester l’authentification unique Azure AD avec CBRE ServiceInsight avec un utilisateur de test appelé **Britta Simon**.
Pour que l’authentification unique fonctionne, une relation entre un utilisateur Azure AD et l’utilisateur associé dans CBRE ServiceInsight doit être établie.

Pour configurer et tester l’authentification unique Azure AD avec CBRE ServiceInsight, vous devez suivre les indications des sections suivantes :

1. **[Configurer l’authentification unique Azure AD](#configure-azure-ad-single-sign-on)** pour permettre à vos utilisateurs d’utiliser cette fonctionnalité.
2. **[Configurer l’authentification unique CBRE ServiceInsight](#configure-cbre-serviceinsight-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test CBRE ServiceInsight](#create-cbre-serviceinsight-test-user)** pour obtenir un équivalent de Britta Simon dans CBRE ServiceInsight lié à la représentation Azure AD associée.
...
Pour configurer l’authentification unique Azure AD avec CBRE ServiceInsight, effectuez les étapes suivantes :

1. Dans le [Portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **CBRE ServiceInsight**, sélectionnez **Authentification unique**.
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL CBRE ServiceInsight](common/sp-signonurl.png)

    Dans la zone de texte **URL de connexion**, tapez une URL au format suivant : `https://adfs4.mainstreamsasp.com/adfs/ls/`
...
### <a name="configure-cbre-serviceinsight-single-sign-on"></a>Configurer l’authentification unique CBRE ServiceInsight
...
Dans cette section, vous allez autoriser Britta Simon à utiliser l’authentification unique Azure en lui accordant l’accès à CBRE ServiceInsight.

1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis sélectionnez **CBRE ServiceInsight**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **CBRE ServiceInsight**.

    ![Lien CBRE ServiceInsight dans la liste des applications](common/all-applications.png)
