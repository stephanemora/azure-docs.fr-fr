...
## <a name="adding-signagelive-from-the-gallery"></a>Ajout de Signagelive à partir de la galerie
...
**Pour ajouter Signagelive à partir de la galerie, effectuez les opérations suivantes :**
...
4. Dans la zone de recherche, tapez **Signagelive**, sélectionnez **Signagelive** dans le panneau de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
...
Pour que l’authentification unique fonctionne, une relation entre l’utilisateur Azure AD et l’utilisateur Signagelive associé doit être établie.

Pour configurer et tester l’authentification unique Azure AD auprès de Signagelive, vous devez suivre les indications des modules suivants :
...
5. **[Créer un utilisateur de test Signagelive](#create-signagelive-test-user)** pour avoir un équivalent de Britta Simon dans Signagelive lié à la représentation Azure AD associée.
...
Pour configurer l’authentification unique Azure AD auprès de Signagelive, effectuez les étapes suivantes :
...
6. Dans la section **Configurer Signagelive**, copiez la ou les URL appropriées en fonction de vos besoins.
...
Pour configurer l’authentification unique côté **Signagelive**, vous devez envoyer le **certificat (brut)** téléchargé et les URL copiées correspondantes depuis le portail Azure à l’[équipe du support technique Signagelive](mailto:support@signagelive.com). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
Dans cette section, vous allez créer un utilisateur appelé Britta Simon dans Signagelive. Contactez l’ [équipe du support technique Signagelive](mailto:support@signagelive.com) pour ajouter des utilisateurs dans la plateforme Signagelive. Les utilisateurs doivent être créés et activés avant que vous utilisiez l’authentification unique.

### <a name="test-single-sign-on"></a>Tester l’authentification unique 

Dans cette section, vous allez tester la configuration de l’authentification unique Azure AD à l’aide du volet d’accès.

Le fait de cliquer sur la vignette Signagelive dans le volet d’accès doit vous connecter automatiquement à l’application Signagelive pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
