...
* Vous pouvez permettre aux utilisateurs de se connecter automatiquement à Appinux (par le biais de l’authentification unique) avec leur compte Azure AD.
...
4. Dans la zone de recherche, tapez **Appinux**, sélectionnez **Appinux** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
     ...
     ![Appinux dans la liste des résultats](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurer et tester l’authentification unique Azure AD

Dans cette section, vous allez configurer et tester l’authentification unique Azure AD avec Appinux, à l’aide d’un utilisateur de test appelé **Britta Simon**.
Pour que l’authentification unique fonctionne, l’utilisateur Azure AD et l’utilisateur Appinux doivent être associés.
...
2. **[Configurer l’authentification unique Appinux](#configure-appinux-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test Appinux](#create-appinux-test-user)** pour avoir dans Appinux un équivalent de Britta Simon lié à sa représentation dans Azure AD.
...
Pour configurer l’authentification unique Azure AD avec Appinux, effectuez les étapes suivantes :

1. Sur le [portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **Appinux**, sélectionnez **Authentification unique**.
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL Appinux](common/sp-identifier.png)
...
8. Dans la section **Configurer Appinux**, copiez la ou les URL appropriées, selon vos besoins.
...
### <a name="configure-appinux-single-sign-on"></a>Configurer l’authentification unique Appinux
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis **Appinux**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **Appinux**.

    ![Lien Appinux dans la liste des applications](common/all-applications.png)
...
Le fait de cliquer sur la vignette Appinux dans le panneau d’accès doit vous connecter automatiquement à l’application Appinux pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
