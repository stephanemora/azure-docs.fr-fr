...
## <a name="configure-and-test-azure-ad-single-sign-on-for-appinux"></a>Configurer et tester l’authentification unique Azure AD pour Appinux
...
Pour configurer et tester l’authentification unique Azure AD avec Appinux, suivez les indications des modules ci-après :
...
1. Dans le [Portail Azure](https://portal.azure.com/), accédez à la page d’intégration de l’application **Appinux** , recherchez la section **Gérer** et sélectionnez **Authentification unique** .
...
Le fait de cliquer sur la vignette Appinux dans le panneau d’accès doit vous connecter automatiquement à l’application Appinux pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
...
- [Essayer Appinux avec Azure AD](https://aad.portal.azure.com/)