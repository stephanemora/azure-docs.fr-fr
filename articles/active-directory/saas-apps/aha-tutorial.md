...
4. Dans la zone de recherche, tapez **Aha!**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/aha-tutorial/tutorial_aha_search.png)

5. Dans le volet de résultats, sélectionnez **Aha!**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/aha-tutorial/tutorial_aha_addfromgallery.png)
...
2. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/aha-tutorial/tutorial_aha_samlbase.png)

3. Dans la section **Domaine et URL Aha!** , procédez comme suit :

    ![Configurer l'authentification unique](./media/aha-tutorial/tutorial_aha_url.png)
...
5. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/aha-tutorial/tutorial_general_400.png)
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/aha-tutorial/create_aaduser_01.png) 

2. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/aha-tutorial/create_aaduser_02.png) 

3. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/aha-tutorial/create_aaduser_03.png) 

4. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/aha-tutorial/create_aaduser_04.png) 
...
2. Dans la liste des applications, sélectionnez **Aha!**.
    ...
    ![Configurer l'authentification unique](./media/aha-tutorial/tutorial_aha_app.png) 
