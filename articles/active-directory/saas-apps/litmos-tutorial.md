...
5. Dans le cadre de la configuration, vous devez personnaliser les **Attributs du jeton SAML** pour votre application Litmos.
    ...
    ![Ajouter un attribut](./media/litmos-tutorial/tutorial_attribute_04.png)

    ![Boîte de dialogue Ajouter un attribut](./media/litmos-tutorial/tutorial_attribute_05.png)
