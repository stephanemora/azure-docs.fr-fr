...
* Birst Agile Business Analytics prend en charge l’authentification unique lancée par le **fournisseur de services**
...
4. Dans la zone de recherche, tapez **Birst Agile Business Analytics**, sélectionnez **Birst Agile Business Analytics** dans le volet de résultats, puis cliquez sur **Ajouter** pour ajouter l’application.

    ![Birst Agile Business Analytics dans la liste des résultats](common/search-new-app.png)
...
Pour que l’authentification unique fonctionne, vous devez associer l’utilisateur Azure AD à l’utilisateur Birst Agile Business Analytics.
...
2. **[Configurer l’authentification unique Birst Agile Business Analytics](#configure-birst-agile-business-analytics-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test Birst Agile Business Analytics](#create-birst-agile-business-analytics-test-user)** pour avoir un équivalent de Britta Simon dans Birst Agile Business Analytics qui soit lié à sa représentation Azure AD associée.
...
Pour configurer l’authentification unique Azure AD avec Birst Agile Business Analytics, effectuez les étapes suivantes :

1. Sur le [portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **Birst Agile Business Analytics**, sélectionnez **Authentification unique**.
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL Birst Agile Business Analytics](common/sp-intiated.png)
...
6. Dans la section **Configurer Birst Agile Business Analytics**, copiez la ou les URL appropriées, selon vos besoins.
...
### <a name="configure-birst-agile-business-analytics-single-sign-on"></a>Configurer l’authentification unique Birst Agile Business Analytics

Pour configurer l’authentification unique côté **Birst Agile Business Analytics**, vous devez envoyer le **Certificat (Base64)** téléchargé et les URL copiées correspondantes à partir du portail Azure à l’[équipe du support Birst Agile Business Analytics](mailto:info@birst.com). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis **Birst Agile Business Analytics**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **Birst Agile Business Analytics**.

    ![Lien Birst Agile Business Analytics dans la liste des applications](common/all-applications.png)
...
### <a name="create-birst-agile-business-analytics-test-user"></a>Créer un utilisateur de test Birst Agile Business Analytics

Dans cette section, vous allez créer un utilisateur nommé Britta Simon dans Birst Agile Business Analytics. Collaborez avec l’[équipe du support technique Birst Agile Business Analytics](mailto:info@birst.com) pour ajouter des utilisateurs dans la plateforme Birst Agile Business Analytics. Les utilisateurs doivent être créés et activés avant que vous utilisiez l’authentification unique.

### <a name="test-single-sign-on"></a>Tester l’authentification unique 

Dans cette section, vous allez tester la configuration de l’authentification unique Azure AD à l’aide du volet d’accès.

Lorsque vous cliquez sur la vignette Birst Agile Business Analytics dans le volet d’accès, vous devez être connecté automatiquement à l’application Birst Agile Business Analytics pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
