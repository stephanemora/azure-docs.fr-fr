...
1. Dans la zone de recherche, tapez **Birst Agile Business Analytics**.

    ![Création d’un utilisateur de test Azure AD](./media/birst-tutorial/tutorial_birst_search.png)

1. Dans le volet de résultats, sélectionnez **Birst Agile Business Analytics**, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.

    ![Création d’un utilisateur de test Azure AD](./media/birst-tutorial/tutorial_birst_addfromgallery.png)
...
1. **[Création d’un utilisateur de test Birst Agile Business Analytics](#creating-a-birst-agile-business-analytics-test-user)** pour avoir un équivalent de Britta Simon dans Birst Agile Business Analytics, lié à sa représentation Azure AD associée.
...
1. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Configurer l'authentification unique](./media/birst-tutorial/tutorial_birst_samlbase.png)

1. Dans la section **Domaine et URL Birst Agile Business Analytics**, effectuez les étapes suivantes :

    ![Configurer l'authentification unique](./media/birst-tutorial/tutorial_birst_url.png)
...
1. Cliquez sur le bouton **Enregistrer** .
    ...
    ![Configurer l'authentification unique](./media/birst-tutorial/tutorial_general_400.png)

1. Dans la section **Configuration de Birst Agile Business Analytics**, cliquez sur **Configurer Birst Agile Business Analytics** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez **l’URL de déconnexion, l’ID d’entité SAML et l’URL du service d’authentification unique SAML** à partir de la **section Référence rapide.**

    ![Configurer l'authentification unique](./media/birst-tutorial/tutorial_birst_configure.png) 

1. Pour configurer l’authentification unique côté **Birst Agile Business Analytics**, vous devez envoyer le **Certificat (Base64)** téléchargé, l’**URL de déconnexion, l’ID d’entité SAML et l’URL du service d’authentification unique SAML** à l’[équipe de support Birst Agile Business Analytics](mailto:info@birst.com). 
...
1. Dans le panneau de navigation gauche du **portail Azure**, cliquez sur l’icône **Azure Active Directory**.
    ...
    ![Création d’un utilisateur de test Azure AD](./media/birst-tutorial/create_aaduser_01.png) 

1. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.
    
    ![Création d’un utilisateur de test Azure AD](./media/birst-tutorial/create_aaduser_02.png) 

1. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue.
 
    ![Création d’un utilisateur de test Azure AD](./media/birst-tutorial/create_aaduser_03.png) 

1. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :
 
    ![Création d’un utilisateur de test Azure AD](./media/birst-tutorial/create_aaduser_04.png) 
...
1. Dans la liste des applications, sélectionnez **Birst Agile Business Analytics**.

    ![Configurer l'authentification unique](./media/birst-tutorial/tutorial_birst_app.png) 
