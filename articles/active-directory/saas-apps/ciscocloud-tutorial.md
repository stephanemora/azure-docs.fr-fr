...
4. À la section **Configuration SAML de base** , si vous souhaitez configurer l’application en mode initié par **IDP** , suivez les étapes ci-dessous :
    ...
    ![Capture d’écran montrant Basic SAML Configuration, où apparaissent les valeurs Identifier et Reply URL.](common/idp-intiated.png)
...
Le fait de cliquer sur la vignette Cisco Cloud dans le panneau d’accès doit vous connecter automatiquement à l’application Cisco Cloud pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
