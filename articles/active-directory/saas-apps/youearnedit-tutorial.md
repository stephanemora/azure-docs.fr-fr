...
1. Dans la zone de recherche, tapez **YouEarnedIt**, sélectionnez **YouEarnedIt** dans le panneau de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
...
1. **[Créer un utilisateur de test YouEarnedIt](#create-a-youearnedit-test-user)** pour avoir un équivalent de Britta Simon dans YouEarnedIt lié à la représentation Azure AD de l’utilisateur.
...
1. Dans la section **Domaine et URL YouEarnedIt**, procédez comme suit :
...
1. Dans la section **Configuration de YouEarnedIt**, cliquez sur **Configurer YouEarnedIt** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez l **’URL du service d’authentification unique SAML** à partir de la **section Référence rapide.**
