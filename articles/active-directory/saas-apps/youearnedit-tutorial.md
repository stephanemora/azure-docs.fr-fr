...
* Vous pouvez permettre à vos utilisateurs de se connecter automatiquement à YouEarnedIt (par le biais de l’authentification unique) avec leur compte Azure AD.
...
* Abonnement YouEarnedIt pour lequel l’authentification unique est activée
...
4. Dans la zone de recherche, tapez **YouEarnedIt** , sélectionnez **YouEarnedIt** dans le panneau de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
     ...
     ![YouEarnedIt dans la liste des résultats](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurer et tester l’authentification unique Azure AD

Dans cette section, vous configurez et testez l’authentification unique Azure AD avec YouEarnedIt au moyen d’un utilisateur de test appelé **Britta Simon** .
Pour que l’authentification unique fonctionne, une relation entre un utilisateur Azure AD et l’utilisateur YouEarnedIt associé doit être établie.
...
Pour configurer l’authentification unique Azure AD avec YouEarnedIt, effectuez les étapes suivantes :

1. Dans le [portail Azure](https://portal.azure.com/), sur la page d’intégration de l’application **YouEarnedIt** , sélectionnez **Authentification unique** .
...
### <a name="configure-youearnedit-single-sign-on"></a>Configurer l’authentification unique YouEarnedIt
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise** , **Toutes les applications** , puis **YouEarnedIt** .

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, tapez et sélectionnez **YouEarnedIt** .

    ![Lien YouEarnedIt dans la liste des applications](common/all-applications.png)
...
Le fait de cliquer sur la vignette YouEarnedIt dans le panneau d’accès doit vous connecter automatiquement à l’application YouEarnedIt pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](../user-help/my-apps-portal-end-user-access.md).
