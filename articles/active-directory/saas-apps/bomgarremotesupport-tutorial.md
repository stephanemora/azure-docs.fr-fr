...
* Vous pouvez autoriser vos utilisateurs à se connecter automatiquement à Bomgar Remote Support (par le biais de l’authentification unique) avec leur compte Azure AD.
...
* Bomgar Remote Support prend en charge l’authentification unique lancée par le **fournisseur de services**
* Bomgar Remote Support prend en charge le provisionnement d’utilisateurs **Juste-à-temps**
...
4. Dans la zone de recherche, tapez **Bomgar Remote Support**, sélectionnez **Bomgar Remote Support** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
     ...
     ![Bomgar Remote Support dans la liste des résultats](common/search-new-app.png)
...
Pour que l’authentification unique fonctionne, une relation entre un utilisateur Azure AD et l’utilisateur Bomgar Remote Support associé doit être établie.
...
2. **[Configurer l’authentification unique Bomgar Remote Support Passport](#configure-bomgar-remote-support-single-sign-on)** pour configurer les paramètres de l’authentification unique côté application.
3. **[Créer un utilisateur de test Azure AD](#create-an-azure-ad-test-user)** pour tester l’authentification unique Azure AD avec Britta Simon.
4. **[Affecter l’utilisateur de test Azure AD](#assign-the-azure-ad-test-user)** pour permettre à Britta Simon d’utiliser l’authentification unique Azure AD.
5. **[Créer un utilisateur de test Bomgar Remote Support](#create-bomgar-remote-support-test-user)** pour avoir un équivalent de Britta Simon dans Bomgar Remote Support lié à la représentation Azure AD de l’utilisateur.
...
1. Dans le [portail Azure](https://portal.azure.com/), dans la page d’intégration de l’application **Bomgar Remote Support**, sélectionnez **Authentification unique**.
...
4. Dans la section **Configuration SAML de base**, effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans les URL et le domaine Bomgar Remote Support](common/sp-identifier.png)
...
6. Dans la section **Configurer Bomgar Remote Support**, copiez l’URL ou les URL appropriées en fonction de vos besoins.
...
### <a name="configure-bomgar-remote-support-single-sign-on"></a>Configurer l’authentification unique Bomgar Remote Support

Pour configurer l’authentification unique côté **Bomgar Remote Support**, vous devez envoyer le **XML des métadonnées de fédération** téléchargé et les URL correspondantes copiées à partir du portail Azure à l’[équipe du support technique Bomgar Remote Support](https://www.bomgar.com/docs/index.htm#support). Celles-ci configurent ensuite ce paramètre pour que la connexion SSO SAML soit définie correctement des deux côtés.
...
1. Dans le portail Azure, sélectionnez **Applications d’entreprise**, **Toutes les applications**, puis **Bomgar Remote Support**.

    ![Panneau Applications d’entreprise](common/enterprise-applications.png)

2. Dans la liste des applications, sélectionnez **Bomgar Remote Support**.

    ![Lien Bomgar Remote Support dans la liste des applications](common/all-applications.png)
...
### <a name="create-bomgar-remote-support-test-user"></a>Créer un utilisateur de test Bomgar Remote Support

Dans cette section, un utilisateur appelé Britta Simon est créé dans Bomgar Remote Support. Bomgar Remote Support prend en charge le provisionnement d’utilisateurs juste-à-temps, qui est activé par défaut. Vous n’avez aucune opération à effectuer dans cette section. S’il n’existe pas encore d’utilisateur dans Bomgar Remote Support, il en est créé un après l’authentification.
...
Quand vous cliquez sur la vignette Bomgar Remote Support dans le volet d’accès, vous devez être automatiquement connecté à l’application Bomgar Remote Support pour laquelle vous avez configuré l’authentification unique. Pour plus d’informations sur le panneau d’accès, consultez [Présentation du panneau d’accès](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction).
