---
title: Autoriser ou bloquer des invitations aux utilisateurs B2B à partir d’organisations spécifiques - Azure Active Directory | Microsoft Docs
...
- Pour plus d’informations sur l’accès conditionnel et la collaboration B2B, consultez [Accès conditionnel pour les utilisateurs de collaboration B2B](active-directory-b2b-mfa-instructions.md).
