...
![Provisionnement d’objets](media/concept-attributes/attribute-1.png)
...
> [!WARNING]
> La configuration de la synchronisation cloud crée un principal de service. Le principal du service est visible dans le portail Azure. Vous ne devez pas modifier les mappages d’attributs via l’interface du principal du service dans le portail Azure.  Cela n'est pas pris en charge.
...
1. Cette requête retourne le schéma.
   ...
   ![Schéma retourné](media/concept-attributes/schema-1.png)
