...
- Pour obtenir la liste complète de toutes les activités d’audit, consultez [Azure AD audit activity reference](active-directory-reporting-activity-audit-reference.md) (Référence sur l’activité d’audit Azure AD)
