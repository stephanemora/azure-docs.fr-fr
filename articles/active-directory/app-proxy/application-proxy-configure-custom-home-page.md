---
title: Page d’accueil personnalisée pour les applications publiées – Proxy d’application Azure Active Directory
description: Découvrez les bases des connecteurs Proxy d’application Azure Active Directory.
...
- [Activer l’accès distant pour SharePoint avec le proxy d’application Azure AD](../manage-apps/application-proxy-integrate-with-sharepoint-server.md)
