---
title: Publier des applications sur des réseaux distincts via des groupes de connecteurs - Azure Active Directory
description: Explique comment créer et gérer des groupes de connecteurs dans le Proxy d'application Azure Active Directory.
...
Les clients utilisent le Proxy d'application Azure AD pour obtenir d'autres scénarios et applications. C’est pourquoi nous avons rendu le proxy d’application encore plus flexible en activant davantage de topologies. Vous pouvez créer des groupes de connecteurs de proxy d’application pour attribuer des connecteurs spécifiques permettant de servir des applications spécifiques. Cette fonctionnalité vous offre davantage de contrôle et de méthodes pour optimiser votre déploiement de proxy d’application.
...
[Présentation des connecteurs du Proxy d'application Azure AD](application-proxy-connectors.md)
[Activer l'authentification unique](../manage-apps/what-is-single-sign-on.md)
