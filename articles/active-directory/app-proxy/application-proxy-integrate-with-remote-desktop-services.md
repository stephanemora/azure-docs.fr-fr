...
- Si vous utilisez Windows Server 2019, vous devrez peut-être désactiver le protocole HTTP2. Pour plus d’informations, consultez [Didacticiel : Ajouter une application locale pour un accès à distance via le service Proxy d’application d’Azure Active Directory](../app-proxy/application-proxy-add-on-premises-application.md).
...
1. [Publiez une nouvelle application de proxy d’application](../app-proxy/application-proxy-add-on-premises-application.md) avec les valeurs suivantes :
