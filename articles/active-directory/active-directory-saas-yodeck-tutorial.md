...
4. Dans la zone de recherche, tapez **Yodeck**, sélectionnez **Yodeck** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
    ...
    ![Yodeck dans la liste des résultats](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_addfromgallery.png)
...
3. **[Créer un utilisateur de test Yodeck](#create-a-yodeck-test-user)** pour avoir un équivalent de Britta Simon dans Yodeck lié à la représentation Azure AD de l’utilisateur.
...
2. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Boîte de dialogue Authentification unique](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_samlbase.png)

3. Dans la section **Domaines et URL Yodeck**, suivez les étapes ci-dessous si vous souhaitez configurer l’application en mode initié par **IDP** :

    ![Informations d’authentification unique dans Domaine et URL Yodeck](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_url.png)
...
4. Si vous souhaitez configurer l’application en **mode démarré par le fournisseur de service**, cochez **Afficher les paramètres d’URL avancés**, puis effectuez les étapes suivantes :
    ...
    ![Informations d’authentification unique dans Domaine et URL Yodeck](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_url1.png)
...
5. Dans la section **Certificat de signature SAML**, cliquez sur le bouton Copier pour copier **l’URL des métadonnées de fédération de l’application**, puis collez-la dans le Bloc-notes.
    ...
    ![Lien Téléchargement de certificat](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_certificate.png)

6. Cliquez sur le bouton **Enregistrer** .

    ![Bouton Enregistrer de la page Configurer l’authentification unique](./media/active-directory-saas-yodeck-tutorial/tutorial_general_400.png)
    
7. Dans une autre fenêtre de navigateur web, connectez-vous au site de votre entreprise Yodeck en tant qu’administrateur.

8. Cliquez sur **User Settings** dans l’angle supérieur droit de la page et sélectionnez **Account Settings**.

    ![Configuration de Yodeck](./media/active-directory-saas-yodeck-tutorial/configure1.png)

9. Sélectionnez **SAML** et effectuez les opérations suivantes :

    ![Configuration de Yodeck](./media/active-directory-saas-yodeck-tutorial/configure2.png)
...
1. Dans le volet gauche du Portail Azure, cliquez sur le bouton **Azure Active Directory**.
    ...
    ![Bouton Azure Active Directory](./media/active-directory-saas-yodeck-tutorial/create_aaduser_01.png)

2. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.

    ![Liens « Utilisateurs et groupes » et « Tous les utilisateurs »](./media/active-directory-saas-yodeck-tutorial/create_aaduser_02.png)

3. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue **Tous les utilisateurs**.

    ![Bouton Ajouter](./media/active-directory-saas-yodeck-tutorial/create_aaduser_03.png)

4. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :

    ![Boîte de dialogue Utilisateur](./media/active-directory-saas-yodeck-tutorial/create_aaduser_04.png)
...
2. Cliquez sur **User Settings** dans l’angle supérieur droit de la page et sélectionnez **Users**.
    ...
    ![Ajouter un employé](./media/active-directory-saas-yodeck-tutorial/user1.png)

3. Cliquez sur **+User** pour ouvrir l’onglet **User Details**.

    ![Ajouter un employé](./media/active-directory-saas-yodeck-tutorial/user2.png)

4. Dans la page de boîte de dialogue **User Details** , procédez comme suit :

    ![Ajouter un employé](./media/active-directory-saas-yodeck-tutorial/user3.png)
...
2. Dans la liste des applications, sélectionnez **Yodeck**.
    ...
    ![Lien Yodeck dans la liste des applications](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_app.png)  
