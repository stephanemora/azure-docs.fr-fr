...
- [Sécuriser vos API utilisées en tant que connecteur d’API dans les flux d’utilisateur d’inscription en libre-service d’Azure Active Directory External Identities](self-service-sign-up-secure-api-connector.md)
...
- [Groupes dynamiques et Azure Active Directory B2B Collaboration](use-dynamic-groups.md)
...
- [Tutoriel : Appliquer l’authentification multifacteur pour les utilisateurs invités B2B](b2b-tutorial-require-mfa.md)
- [Ajouter un flux utilisateur d’inscription en libre-service à une application](self-service-sign-up-user-flow.md)
- [Démarrage rapide : Ajouter des utilisateurs invités à votre annuaire dans le portail Azure](b2b-quickstart-add-guest-users-portal.md)
- [Fédération avec des fournisseurs d’identité SAML/WS-Fed pour les utilisateurs invités (préversion)](direct-federation.md)
- [Ajouter Google comme fournisseur d’identité pour les utilisateurs invités B2B](google-federation.md)
- [Quitter une organisation en tant qu’utilisateur invité](leave-the-organization.md)
- [Utilisation d’invitations Azure Active Directory B2B Collaboration](redemption-experience.md)
