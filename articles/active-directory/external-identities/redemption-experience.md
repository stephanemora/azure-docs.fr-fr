...
3. L’invité utilise ses propres informations d’identification pour se connecter à votre répertoire. Si l’invité n’a pas de compte qui peut être fédéré à votre répertoire et que la fonctionnalité [Code secret e-mail à usage unique (OTP)](https://docs.microsoft.com/azure/active-directory/b2b/one-time-passcode) n’est pas activée, l’invité est invité à créer un [MSA](https://support.microsoft.com/help/4026324/microsoft-account-how-to-create) personnel ou un [compte libre-service Azure AD](https://docs.microsoft.com/azure/active-directory/users-groups-roles/directory-self-service-signup). Pour plus d’informations, reportez-vous au [flux d’acceptation d’invitation](#invitation-redemption-flow).
...
1. Azure AD effectue une découverte basée sur l’utilisateur pour déterminer si l’utilisateur existe dans un [locataire Azure AD](https://docs.microsoft.com/azure/active-directory/b2b/what-is-b2b#easily-add-guest-users-in-the-azure-ad-portal).

2. Si un administrateur a activé la [fédération directe](https://docs.microsoft.com/azure/active-directory/b2b/direct-federation), Azure AD vérifie si le suffixe de domaine de l’utilisateur correspond au domaine d’un fournisseur d’identité SAML/WS-Fed configuré et redirige l’utilisateur vers le fournisseur d’identité préconfiguré.

3. Si un administrateur a activé la [fédération Google](https://docs.microsoft.com/azure/active-directory/b2b/google-federation), Azure AD vérifie si le suffixe de domaine de l’utilisateur est gmail.com ou googlemail.com et redirige l’utilisateur vers Google.
