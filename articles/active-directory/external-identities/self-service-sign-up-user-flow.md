...
description: Fédérez avec Facebook pour permettre à des utilisateurs externes (invités) de se connecter à vos applications Azure AD avec leurs propres comptes Facebook.
