...
Lorsqu’une connexion échoue, vous voyez un code d’erreur correspondant à l’échec. [Recherchez la description d’un code d’erreur](https://login.microsoftonline.com/error).
