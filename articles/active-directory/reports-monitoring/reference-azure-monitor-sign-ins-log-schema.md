...
| authProcessingDetails | Bibliothèque d’authentification de l’application Azure AD | Contient des informations sur les familles, les bibliothèques et les plateformes au format suivant : « Famille : ADAL Bibliothèque : ADAL.JS 1.0.0 Plateforme : JS » |
