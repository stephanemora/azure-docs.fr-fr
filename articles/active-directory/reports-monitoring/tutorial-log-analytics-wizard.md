...
- [Tutoriel : Collecter et analyser des journaux de ressources à partir d’une ressource Azure](https://docs.microsoft.com/azure/azure-monitor/learn/tutorial-resource-logs)

- [Intégrer des journaux d’activité Azure AD aux journaux d’activité Azure Monitor](https://docs.microsoft.com/azure/active-directory/reports-monitoring/howto-integrate-activity-logs-with-log-analytics)
...
- [Aide-mémoire sur KQL](https://docs.microsoft.com/azure/data-explorer/kql-quick-reference)
