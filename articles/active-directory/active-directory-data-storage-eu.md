...
Une grande partie des données d’identité européennes concernant Azure AD, pour les organisations disposant d’adresses en Europe, restent dans des centres de données européens. Les données de Azure AD qui ne sont pas stockées dans des centres de données européens incluent :
...
- **Services et applications intégrés avec Azure AD**
    ...
    Pour plus d’informations sur la résidence des données des services de Microsoft, consultez la section [Où se trouvent vos données ?](https://www.microsoft.com/en-us/trustcenter/privacy/where-your-data-is-located) du Microsoft Trust Center.

## <a name="next-steps"></a>Étapes suivantes
Pour plus d’informations sur les fonctionnalités décrites ci-dessus, consultez les articles suivants.
- [Prise en main d’Azure Active Directory](get-started-azure-ad.md)
- [Présentation d’authentification multifacteur](https://docs.microsoft.com/en-us/azure/active-directory/authentication/multi-factor-authentication)
- [Réinitialisation de mot de passe en libre-service Azure AD](https://docs.microsoft.com/en-us/azure/active-directory/authentication/active-directory-passwords-overview)
- [Qu’est-ce qu’Azure Active Directory B2C ?](https://docs.microsoft.com/en-us/azure/active-directory-b2c/active-directory-b2c-overview)
- [Qu'est-ce que la collaboration B2B d'Azure AD ?](https://docs.microsoft.com/en-us/azure/active-directory/active-directory-b2b-what-is-azure-ad-b2b)
- [Services de domaine Azure Active Directory (AD)](https://docs.microsoft.com/en-us/azure/active-directory-domain-services/active-directory-ds-overview)
