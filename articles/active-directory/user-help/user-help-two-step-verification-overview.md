...
Pour obtenir des informations et des instructions détaillées sur la configuration, l’utilisation et la maintenance de la vérification à deux facteurs, consultez les articles suivants :

|Article |Description |
|------|------------|
| [Configurer la vérification à deux facteurs pour mon compte professionnel ou scolaire](multi-factor-authentication-end-user-first-time.md) | Décrit comment configurer la vérification à deux facteurs pour la première fois. |
| [Modifier les paramètres de la méthode de vérification de sécurité](multi-factor-authentication-end-user-manage-settings.md) | Illustre comment modifier vos paramètres, comme le numéro de téléphone ou la méthode d’inscription favorite. |
| [Comment se connecter à l’aide de votre méthode de vérification de sécurité](user-help-sign-in.md) | Décrit comment se connecter à l’aide de votre méthode de vérification spécifiée. |
| [Obtenir de l’aide pour la vérification à deux facteurs](multi-factor-authentication-end-user-troubleshoot.md) | Décrit comment résoudre les problèmes courants liés à la vérification à deux facteurs. |
