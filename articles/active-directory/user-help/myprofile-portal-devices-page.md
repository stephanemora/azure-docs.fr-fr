---
title: Gérer vos appareils connectés à partir du portail Mon profil (préversion) - Azure Active Directory | Microsoft Docs
description: Une vue d’ensemble globale sur la page Appareils du portail Mon profil.
...
1. Sélectionnez **Désactiver** à partir de l’appareil que vous souhaitez supprimer.

    ![Page Appareil avec lien Désactiver mis en surbrillance](media/myprofile-portal/myprofile-portal-devices-disable.png)

2. Sélectionnez **Oui** pour confirmer que vous voulez désactiver l’appareil.
