...
2. En bas de la page **Security basics** (Fonctions de base de la sécurité), cliquez sur le lien **more security options** (Autres options de sécurité).
    ...
    ![Page Security basics (Fonctions de base de la sécurité) dont le lien « more security options » (Autres options de sécurité) est mis en surbrillance](./media/microsoft-authenticator-app-add-personal-account/more-security-options-link.png)
...
2. Sélectionnez l’option **Ajouter un compte** à partir de l’icône **Customize and control** (Personnaliser et contrôler) située dans le coin supérieur droit.
    ...
    ![Page de comptes dont l’icône Customize and control (Personnaliser et contrôler) est mise en surbrillance](./media/microsoft-authenticator-app-add-personal-account/customize-and-control-icon.png)
