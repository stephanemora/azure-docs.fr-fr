...
- Mettre à jour une partie de vos informations de profil et de compte
- Voir les informations sur vos **groupes**
- Effectuer des **révisions d’accès** pour vos applications et groupes 
...
2. À partir de la page **Applications**, sélectionnez votre photo de profil en haut à droite où figurent votre nom et votre organisation, puis sélectionnez **Profil**.
    ...
    La page **Profil** s’affiche en présentant les informations de votre profil.

    ![Page de profil présentant toutes les informations disponibles](media/my-apps-portal/my-apps-portal-profile-page.png)

3. À partir de la page **Profil**, vous pouvez :

    - **Passer en revue les détails liés à votre organisation.** Voir vos photo, nom, titre, adresses e-mail associées et informations de bureau. Ces informations sont gérées par votre organisation et vous ne pouvez pas les modifier. Si vous voyez une erreur, contactez votre support technique.

    - **Passer en revue vos appareils et activités**. Vérifiez que chaque appareil vous est familier et correctement connecté à votre organisation. Si vous ne reconnaissez pas un appareil, sélectionnez **Désactiver l’appareil** pour supprimer l’association à votre compte. Une fois qu’un appareil est désactivé, il est retiré de cette page.
...
- Activer la réinitialisation de mot de passe (si votre administrateur a activé cette fonctionnalité).

- Fournir d’autres informations de vérification de la sécurité.

- Passer en revue les conditions d’utilisation de votre organisation.
...
2. Dans la page **Changer le mot de passe**, vérifiez que votre ID d’utilisateur est correct, puis tapez votre ancien mot de passe et le nouveau dans les zones prévues à cet effet.
    ...
    ![Page Changer le mot de passe](media/my-apps-portal/my-apps-portal-change-password-page.png)
...
2. Dans la page **Vérification de sécurité supplémentaire**, vous pouvez ajouter, modifier ou supprimer les informations suivantes :

    - **Option de vérification par défaut.** Sélectionnez la méthode secondaire par défaut à utiliser pour la vérification à deux facteurs. Cette méthode est utilisée automatiquement chaque fois que la vérification à deux facteurs vous est demandée après que vous avez entré votre nom d’utilisateur et votre mot de passe.

    - **Ajouter, mettre à jour ou supprimer des méthodes de vérification.** Vous pouvez ajouter de nouvelles informations, mettre à jour des informations existantes ou supprimer des informations anciennes qui n’ont plus cours.

    - **Configurer l’application Microsoft Authenticator.** Vous pouvez choisir de configurer l’application Microsoft Authenticator pour en faire votre méthode de vérification. Pour plus d’informations sur l’application Microsoft Authenticator, consultez [Qu’est-ce que l’application Microsoft Authenticator ?](user-help-auth-app-overview.md)
...
2. Passez en revue les conditions d’utilisation de votre organisation et sélectionnez **Accepter** pour confirmer que vous avez lu et compris les conditions d’utilisation de votre organisation.

    ![Page Conditions d’utilisation du portail Mes applications](media/my-apps-portal/my-apps-portal-tou-page.png)
