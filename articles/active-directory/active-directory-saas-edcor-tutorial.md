...
4. Dans la zone de recherche, tapez **Edcor**, sélectionnez **Edcor** dans le volet de résultats, puis cliquez sur le bouton **Ajouter** pour ajouter l’application.
    ...
    ![Edcor dans la liste des résultats](./media/active-directory-saas-edcor-tutorial/tutorial_edcor_addfromgallery.png)
...
2. Dans la boîte de dialogue **Authentification unique**, pour le **Mode**, sélectionnez **Authentification basée sur SAML** pour activer l’authentification unique.
    ...
    ![Boîte de dialogue Authentification unique](./media/active-directory-saas-edcor-tutorial/tutorial_edcor_samlbase.png)

3. Dans la section **Domaine et URL Edcor**, procédez comme suit :

    ![Informations d’authentification unique dans Domaine et URL Edcor](./media/active-directory-saas-edcor-tutorial/tutorial_edcor_url1.png)
...
4. Dans la section **Certificat de signature SAML**, cliquez sur **Métadonnées XML** puis enregistrez le fichier de métadonnées sur votre ordinateur.
    ...
    ![Lien Téléchargement de certificat](./media/active-directory-saas-edcor-tutorial/tutorial_edcor_certificate.png) 

5. Cliquez sur le bouton **Enregistrer** .

    ![Bouton Enregistrer de la page Configurer l’authentification unique](./media/active-directory-saas-edcor-tutorial/tutorial_general_400.png)
...
6. Dans la section **Configuration d’Edcor**, cliquez sur **Configurer Edcor** pour ouvrir la fenêtre **Configurer l’authentification**. Copiez **l’URL de déconnexion et l’ID d’entité SAML** à partir de la **section Référence rapide**.
    ...
    ![Configuration d’Edcor](./media/active-directory-saas-edcor-tutorial/tutorial_edcor_configure.png) 
...
1. Dans le volet gauche du Portail Azure, cliquez sur le bouton **Azure Active Directory**.
    ...
    ![Bouton Azure Active Directory](./media/active-directory-saas-edcor-tutorial/create_aaduser_01.png)

2. Pour afficher la liste des utilisateurs, accédez à **Utilisateurs et groupes**, puis cliquez sur **Tous les utilisateurs**.

    ![Liens « Utilisateurs et groupes » et « Tous les utilisateurs »](./media/active-directory-saas-edcor-tutorial/create_aaduser_02.png)

3. Pour ouvrir la boîte de dialogue **Utilisateur**, cliquez sur **Ajouter** en haut de la boîte de dialogue **Tous les utilisateurs**.

    ![Bouton Ajouter](./media/active-directory-saas-edcor-tutorial/create_aaduser_03.png)

4. Dans la boîte de dialogue **Utilisateur**, procédez comme suit :

    ![Boîte de dialogue Utilisateur](./media/active-directory-saas-edcor-tutorial/create_aaduser_04.png)
...
Dans cette section, vous allez créer un utilisateur appelé Britta Simon dans Edcor. Collaborez avec l’[équipe du support technique Edcor](http://www.edcor.com/contact-us-2/) pour ajouter des utilisateurs dans la plate-forme Edcor. Les utilisateurs doivent être créés et activés avant que vous utilisiez l’authentification unique.  
...
2. Dans la liste des applications, sélectionnez **Edcor**.
    ...
    ![Lien Edcor dans la liste des applications](./media/active-directory-saas-edcor-tutorial/tutorial_edcor_app.png)  
