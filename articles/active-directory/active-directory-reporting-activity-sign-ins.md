...
> Pour en savoir plus, consultez le [Forum aux questions sur les informations de l’accès conditionnel dans toutes les connexions](active-directory-reporting-faq.md#conditional-access).

![Activité de connexion](./media/active-directory-reporting-activity-sign-ins/ConditionalAccess.png "Activité de connexion")
...
En plus de l’implémentation technique, le nombre d’enregistrements que vous pouvez télécharger est limité par les [stratégies de rétention de rapport Azure Active Directory](active-directory-reporting-retention.md).  
