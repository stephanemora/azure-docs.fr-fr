...
Consultez les exemples de code pour les scénarios du type navigateur web vers application web. Et consultez régulièrement cette page à laquelle nous ajoutons fréquemment de nouveaux exemples. [Application web](active-directory-code-samples.md#web-applications)
...
1. Le navigateur appelle les composants principaux de l’API web de l’application, avec le jeton d’accès dans l’en-tête d’autorisation.

#### <a name="code-samples"></a>Exemples de code

Consultez les exemples de code pour les scénarios du type application à page unique (SPA). Veillez à consultez régulièrement cette page à laquelle nous ajoutons fréquemment de nouveaux exemples. [Application à page unique (SPA)](active-directory-code-samples.md#single-page-applications).
...
Consultez les exemples de code pour les scénarios du type application native vers API web. Et consultez régulièrement cette page à laquelle nous ajoutons fréquemment de nouveaux exemples. [Application native vers API web](active-directory-code-samples.md#desktop-and-mobile-public-client-applications-calling-microsoft-graph-or-a-web-api).
...
Consultez les exemples de code pour les scénarios du type application démon ou serveur vers API web. Et consultez régulièrement cette page à laquelle nous ajoutons fréquemment de nouveaux exemples. [Application serveur ou démon vers API web](active-directory-code-samples.md#daemon-applications-accessing-web-apis-with-the-applications-identity)
