...
![Lignes rouges Se connecter avec Microsoft](./media/active-directory-branding-guidelines/Sign-in-with-Microsoft-redlines.png)
...
| Asset                                | Format PNG | Format SVG |
| ------------------------------------ | ---------- | ---------- |
| Se connecter avec Microsoft (thème sombre)  | ![Bouton Se connecter, thème sombre PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.png) | ![Bouton Se connecter avec Microsoft, thème sombre SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.svg) |
| Se connecter avec Microsoft (thème clair) | ![Bouton Se connecter, thème clair PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.png) | ![Bouton Se connecter avec Microsoft, thème clair SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.svg) |
| Se connecter (thème sombre)                 | ![Bouton Se connecter, version courte, thème sombre PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.png) | ![Bouton Se connecter, version courte, thème sombre SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.svg) |
| Se connecter (thème clair)                | ![Bouton Se connecter, version courte, thème clair PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.png) | ![Bouton Se connecter, version courte, thème clair SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.svg) |
