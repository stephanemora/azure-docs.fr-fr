...
2. Ouvrez le panneau Inscriptions d’applications, puis cliquez sur **+Nouvelle inscription**.
...
7. Cliquez sur **Essayer la nouvelle expérience** en haut de l’écran pour ouvrir la nouvelle expérience d’inscription d’application, puis cliquez sur **+Nouvelle inscription** >  **+ Ajouter une plateforme** > **iOS/macOS**.
...
8. Cliquez sur `Configure` et enregistrez la **Configuration MSAL** qui apparaît dans la page **Configuration MSAL** pour pouvoir l’entrer plus tard quand vous configurez votre application.  Cliquez sur **Done**.
