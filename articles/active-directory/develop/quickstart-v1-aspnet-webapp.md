...
![Comment fonctionne ce guide](./media/quickstart-v1-aspnet-webapp/aspnet-intro.png)
...
Pour plus d’informations sur ce paramètre et le concept d’application mutualisée, consultez [cet article](howto-convert-app-to-be-multi-tenant.md "Vue d’ensemble de l’architecture mutualisée").
