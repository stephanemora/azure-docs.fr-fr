...
Sous **Gérer**, sélectionnez **Authentification** > **Octroi implicite et flux hybrides**. Sélectionnez **Jetons d’ID**, puis **Enregistrer**.
...
| `{DOMAIN}`    | Domaine principal          | `tenantname.onmicrosoft.com`           |
