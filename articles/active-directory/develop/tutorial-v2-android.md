---
title: Bien démarrer avec Azure Active Directory v2.0 Android | Microsoft Docs
description: Cet article explique comment une application Android peut obtenir un jeton d’accès et appeler une ou plusieurs API Microsoft Graph qui nécessitent des jetons d’accès à partir d’un point de terminaison Azure Active Directory v2.0.
