...
- [Flux d’utilisateurs](../../active-directory-b2c/tutorial-create-user-flows.md?pivots=b2c-user-flow)
- [Stratégies personnalisées](../../active-directory-b2c/tutorial-create-user-flows.md?pivots=b2c-custom-policy)
