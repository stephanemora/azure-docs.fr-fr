...
| `x5t` | Chaîne | Fonctions identiques (en utilisation et en valeur) à `kid`. `x5t` une revendication héritée est émise uniquement dans les jetons d’accès v1.0 pour des raisons de compatibilité. |
