...
Visual Studio n’a sans doute pas mis correctement à jour le fichier Android.csproj*. Parfois le chemin d’accès au fichier **<HintPath>** contient netstandard13 au lieu de **monoandroid90**, ce qui est incorrect.
