...
MSAL expose des métriques importantes dans l’objet [AuthenticationResult. AuthenticationResultMetadata](/dotnet/api/microsoft.identity.client.authenticationresultmetadata.md) : 
