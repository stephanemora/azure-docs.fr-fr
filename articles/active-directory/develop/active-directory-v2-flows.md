...
Pour en savoir plus, découvrez comment [inscrire une application](quickstart-v2-register-an-app.md).
...
![Flux d’authentification d’API web](/media/v2-protocols-oidc/convergence_scenarios_webapi.png)
