...
| ![MSAL4J](media/sample-v2-code/logo_java.png) <br/>[Préversion MSAL4J](https://github.com/AzureAD/microsoft-authentication-library-for-java)|Java|
