...
![Créer une stratégie](./media/active-directory-conditional-access-tou/5555.png)
...
5. Dans la page **Azure Active Directory**, dans la section **Gérer**, cliquez sur **Accès conditionnel**.
    ...
    ![Accès conditionnel](./media/active-directory-conditional-access-tou/03.png) 

6. Dans la section **Gérer**, cliquez sur **Conditions d’utilisation**.

    ![Conditions d’utilisation](./media/active-directory-conditional-access-tou/04.png) 

7. Dans le menu supérieur, cliquez sur **Nouvelles conditions**.

    ![Conditions d’utilisation](./media/active-directory-conditional-access-tou/05.png) 

8. Sur la page **Nouvelles conditions d’utilisation** :

    ![Conditions d’utilisation](./media/active-directory-conditional-access-tou/112.png) 
...
![Créer une stratégie](./media/active-directory-conditional-access-tou/1234.png)
...
1. Sur la page **Nouveau**, dans la zone de texte **Nom**, saisissez **Require TOU for Isabella**.
    ...
    ![NOM](./media/active-directory-conditional-access-tou/71.png)

2. Dans la section **Affectation**, cliquez sur **Utilisateurs et groupes**.

    ![Utilisateurs et groupes](./media/active-directory-conditional-access-tou/06.png)

3. Sur la page **Utilisateurs et groupes** :

    ![Utilisateurs et groupes](./media/active-directory-conditional-access-tou/24.png)
...
4. Cliquez sur **Applications cloud**.
    ...
    ![Applications cloud](./media/active-directory-conditional-access-tou/08.png)

5. Sur la page **Applications cloud** :

    ![Sélection des applications cloud](./media/active-directory-conditional-access-tou/26.png)
...
6. Dans la section **Contrôles d’accès**, cliquez sur **Accorder**.
    ...
    ![Contrôles d’accès](./media/active-directory-conditional-access-tou/10.png)

7. Sur la page des **octrois** :

    ![Grant (Autoriser)](./media/active-directory-conditional-access-tou/111.png)
...
8. Dans la section **Activer la stratégie**, cliquez sur **Activée**.
    ...
    ![Activer la stratégie](./media/active-directory-conditional-access-tou/18.png)
...
![Outil de stratégie What If](./media/active-directory-conditional-access-tou/79.png)
...
2. Cliquez sur **Utilisateurs**, sélectionnez **Isabella Simonsen**, puis cliquez sur **Sélectionner**.
    ...
    ![Utilisateur](./media/active-directory-conditional-access-tou/15.png)

2. Pour sélectionner une application cloud :

    ![Applications cloud](./media/active-directory-conditional-access-tou/16.png)
...
![Conditions d’utilisation](./media/active-directory-conditional-access-tou/57.png)
...
- Pour supprimer votre stratégie, sélectionnez-la, puis cliquez sur **Supprimer** dans la barre d’outils Accès rapide.
    ...
    ![Authentification multifacteur](./media/active-directory-conditional-access-tou/33.png)
...
- Pour supprimer vos conditions d’utilisation, sélectionnez-les, puis cliquez sur **Supprimer les conditions** dans la barre d’outils supérieure. 
    ...
    ![Authentification multifacteur](./media/active-directory-conditional-access-tou/29.png)
