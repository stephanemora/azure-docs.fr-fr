...
Pour les périphériques Windows 10 exécutant la version 1703 ou une version antérieure, si votre organisation requiert un accès à Internet via un proxy sortant, vous devez implémenter la détection automatique de proxy web (WPAD) pour permettre aux ordinateurs Windows 10 de s’inscrire à Azure AD. 
