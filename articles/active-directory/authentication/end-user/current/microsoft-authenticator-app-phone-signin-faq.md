...
1. Activez la connexion par téléphone pour votre compte.
  ...
  - Si vous ne disposez pas encore de l’application Microsoft Authenticator, installez-la et ajoutez votre compte Microsoft personnel en suivant la procédure présentée dans l’article [Microsoft Authenticator](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md). Les comptes qui viennent d’être ajoutés sont automatiquement activés. Vous n’avez donc rien d’autre à faire.
...
Si vous avez des questions concernant l’application en général, consultez le [Forum aux questions sur l’application Microsoft Authenticator](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-faq.md).
