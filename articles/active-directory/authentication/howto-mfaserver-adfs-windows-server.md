...
description: Cet article explique la prise en main d’Azure Multi-Factor Authentication et d’AD FS dans Windows Server 2016.
...
Cet article traite de l’utilisation du serveur Azure Multi-Factor Authentication avec AD FS à partir de Windows Server 2016. Pour plus d’informations, consultez l’article qui explique comment [sécuriser les ressources de cloud et locales à l’aide du serveur Azure Multi-Factor Authentication avec AD FS 2.0](howto-mfaserver-adfs-2.md).
