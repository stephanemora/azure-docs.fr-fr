...
![Vérification](./media/concept-mfa-howitworks/howitworks.png)
...
- Obtenez des réponses aux [questions fréquemment posées](../../multi-factor-authentication/multi-factor-authentication-faq.md).