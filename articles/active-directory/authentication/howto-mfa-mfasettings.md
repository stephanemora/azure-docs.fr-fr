---
title: Configuration d’Azure Multi-Factor Authentication
...
Vous pouvez accéder à des paramètres liés à Multi-Factor Authentication à partir du portail Azure en accédant à **Azure Active Directory** > **MFA**.
