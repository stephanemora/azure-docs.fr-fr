...
ms.locfileid: "77505610"
---
# <a name="complete-a-passwordless-authentication-deployment-in-azure-active-directory"></a>Effectuer un déploiement d’authentification sans mot de passe dans Azure Active Directory

La majorité des cyberattaques commencent par un nom d’utilisateur et un mot de passe volés à un membre d’une organisation. Les organisations essaient de contrer la menace en demandant aux utilisateurs d’adopter l’une des approches suivantes :
...
- Meilleure expérience utilisateur. Tandis qu’ils sont mobiles, offrez aux utilisateurs un moyen pratique d’accéder aux données en tous lieux, et fournissez un accès facile aux applications et services comme Outlook, OneDrive ou Office.
...
L’activation de la connexion Windows 10 au moyen de clés de sécurité FIDO2 nécessite l’activation de la fonctionnalité de fournisseur d’informations d’identification dans Windows 10 en procédant de l’une des façons suivantes :
