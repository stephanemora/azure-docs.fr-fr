...
* **Q : Puis-je empêcher des utilisateurs de réinitialiser leur mot de passe ?**
  ...
  > **R :** Oui, si vous utilisez un groupe pour activer la réinitialisation du mot de passe en libre-service, vous pouvez supprimer un utilisateur du groupe qui permet aux utilisateurs de réinitialiser leur mot de passe. Si l’utilisateur est administrateur général, il conserve la possibilité de réinitialiser son mot de passe, et cette fonctionnalité ne peut pas être désactivée.
  >
  >
