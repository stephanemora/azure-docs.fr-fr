...
Si vos utilisateurs ont [des difficultés avec la vérification en deux étapes](end-user/current/multi-factor-authentication-end-user-troubleshoot.md), aidez-les à diagnostiquer eux-mêmes les problèmes. 
