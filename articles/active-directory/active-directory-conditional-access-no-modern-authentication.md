...
Pour plus d’informations, consultez [Qu’est-ce que l’accès conditionnel dans Azure Active Directory](active-directory-conditional-access-azure-portal.md).
