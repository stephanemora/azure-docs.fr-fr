...
![Classement](media/active-directory-aadconnect-sql-delegation/sql4.png)
...
![autorisations](media/active-directory-aadconnect-sql-delegation/sql3a.png)
