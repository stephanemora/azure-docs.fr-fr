...
Pour obtenir des conseils sur le renouvellement du certificat, consultez la page [Renouveler les certificats](active-directory-aadconnect-o365-certs.md).
...
![Version d’Azure AD Connect dans le Panneau de configuration](media/active-directory-aadconnect-faq/faq1.png)

**Q : Comment effectuer la mise à niveau vers la dernière version d’Azure AD Connect ?**  
Pour savoir comment effectuer la mise à niveau d’Azure AD Connect vers la dernière version, consultez l’article [Azure AD Connect : effectuer une mise à niveau vers la dernière version](active-directory-aadconnect-upgrade-previous-version.md). 
