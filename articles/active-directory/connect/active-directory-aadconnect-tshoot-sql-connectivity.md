...
![Erreur SQL](media/active-directory-aadconnect-tshoot-sql-connectivity/sql1.png)
...
Ou installez [Modules PowerShell PackageManagement Preview - Mars 2016 pour PowerShell 3.0/4.0](https://www.microsoft.com/en-us/download/details.aspx?id=51451) 
...
-  [Connectivité Azure AD avec Azure AD Connect](active-directory-aadconnect-troubleshoot-connectivity.md)