...
* **[Lecteurs d’annuaire](#directory-readers)** : il s’agit d’un rôle hérité qui doit être affecté aux applications ne prenant pas en charge le [framework de consentement](active-directory-integrating-applications.md). Vous ne devez pas l’affecter à tous les utilisateurs.
...
* **[Enregistreurs d’annuaire](#directory-writers)** : il s’agit d’un rôle hérité qui doit être affecté aux applications ne prenant pas en charge le [framework de consentement](active-directory-integrating-applications.md). Vous ne devez pas l’affecter à tous les utilisateurs.
...
Les membres de ce rôle sont ajoutés au groupe Administrateurs local sur des appareils joints à Azure AD.
...
### <a name="directory-reader"></a>Lecteur d’annuaire
...
| microsoft.aad.directory/OAuth2PermissionGrant/Read | Lisez des propriétés standard sur des octrois d’autorisation OAuth2 (OAuth2PermissionGrants) dans Azure Active Directory. |
...
| microsoft.aad.reports/AllEntities/Read | Lisez des rapports Azure AD. |
| microsoft.aad.servicehealth/AllEntities/AllActions | Lisez et configurez Office 365 Service Health. |
| microsoft.office365.usagereports/AllEntities/Read | Lisez des rapports d’utilisation d’Office 365. |
