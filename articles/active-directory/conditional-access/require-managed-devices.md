...
- Pour la prise en charge de Firefox, à partir de **Firefox 91**  sous **Windows 10 version 1809 ou supérieure**, configurez [Windows SSO](https://support.mozilla.org/kb/windows-sso).
