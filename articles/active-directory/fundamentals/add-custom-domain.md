...
- **Si vous tentez de vérifier un domaine enfant, commencez par vérifier le domaine parent.** Vérifiez que le domaine parent est créé et vérifié en premier avant d’essayer de vérifier le domaine enfant.
