...
1. Connectez-vous au [Portail Azure](https://portal.azure.com/) en utilisant un compte de propriétaire d’abonnement pour l’annuaire, puis sélectionnez **Azure Active Directory**.
