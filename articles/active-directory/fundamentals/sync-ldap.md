...
* **Azure AD** : Azure AD synchronise les informations d’identité (utilisateurs, groupes) à partir des répertoires LDAP locaux de l’organisation via Azure AD Connect. 
