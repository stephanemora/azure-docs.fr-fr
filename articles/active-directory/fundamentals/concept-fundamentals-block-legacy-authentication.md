...
Avant de commencer l’activation de l’authentification moderne en local, vérifiez que vous avez respecté les conditions préalables. Vous êtes maintenant prêt à activer l’authentification moderne en local.
