...
- La valeur de **DeviceTrustType** doit être **Domain Joined**. C’est l’équivalent à l’état **Joint à une version hybride d’Azure AD** dans la page Appareils du portail Azure AD.
