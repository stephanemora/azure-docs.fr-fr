...
- Identifier les appareils, à savoir :
   ...
   - imprimantes utilisant l’[Impression universelle](https://docs.microsoft.com/universal-print/fundamentals/universal-print-getting-started).
