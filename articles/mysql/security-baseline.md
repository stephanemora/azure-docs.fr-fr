...
description: Base de référence de sécurité Azure pour Azure Database pour MySQL
author: msmbaldwin
ms.service: security
ms.topic: conceptual
ms.date: 03/23/2020
...
Comment configurer Private Link pour Azure Database pour MySQL : https://docs.microsoft.com/azure/mysql/howto-configure-privatelink-portal

Comment créer et gérer des points de terminaison de service de réseau virtuel et des règles de réseau virtuel dans Azure Database pour MySQL : https://docs.microsoft.com/azure/sql-database/sql-database-vnet-service-endpoint-rule-overview

Comment configurer des règles de pare-feu d’Azure Database pour MySQL : https://docs.microsoft.com/azure/mysql/howto-manage-firewall-using-portal
...
Comment configurer Advanced Threat Protection pour Azure Database pour MySQL : https://docs.microsoft.com/azure/mysql/howto-database-threat-protection-portal
...
Comprendre l’utilisation des étiquettes de service pour Azure Database pour MySQL : https://docs.microsoft.com/azure/mysql/concepts-data-access-and-security-vnet#terminology-and-description
...
Comprendre les journaux de serveur pour Azure Database pour MySQL : https://docs.microsoft.com/azure/mysql/concepts-monitoring#server-logs
...
Comment configurer et consulter les journaux d’audit pour Azure Database pour MySQL : https://docs.microsoft.com/azure/mysql/howto-configure-audit-logs-portal
...
Comment activer Advanced Threat Protection pour Azure Database pour MySQL (préversion) : https://docs.microsoft.com/azure/mysql/howto-database-threat-protection-portal
...
Comprendre les opérations de fournisseurs de ressources d’Azure Database pour MySQL : https://docs.microsoft.com/azure/role-based-access-control/resource-provider-operations#microsoftdbformysql

Comprendre la gestion des accès pour Azure Database pour MySQL : https://docs.microsoft.com/azure/mysql/concepts-security#access-management
...
Comment créer des comptes supplémentaires pour Azure Database pour MySQL : https://docs.microsoft.com/azure/mysql/howto-create-users

Comment mettre à jour le mot de passe d’administrateur : https://docs.microsoft.com/azure/mysql/howto-create-manage-server-portal#update-admin-password
...
Comprendre comment créer des utilisateurs administrateurs dans Azure Database pour MySQL : https://docs.microsoft.com/azure/mysql/howto-create-users
...
Utiliser Azure Active Directory pour l’authentification avec Azure Database pour MySQL : https://docs.microsoft.com/azure/mysql/howto-configure-sign-in-azure-ad-authentication

Comprendre l’API REST d’Azure Database pour MySQL : https://docs.microsoft.com/rest/api/mysql/
...
Utilisez les détections de risque Azure AD pour voir les alertes et des rapports sur les comportements à risque des utilisateurs.
...
Comment configurer Private Link pour Azure Database pour MySQL : https://docs.microsoft.com/azure/mysql/concepts-data-access-security-private-link

Comment créer et gérer des points de terminaison de service de réseau virtuel et des règles de réseau virtuel dans Azure Database pour MySQL : https://docs.microsoft.com/azure/sql-database/sql-database-vnet-service-endpoint-rule-overview

Comment configurer des règles de pare-feu d’Azure Database pour MySQL : https://docs.microsoft.com/azure/mysql/concepts-firewall-rules
...
Comment atténuer l’exfiltration de données pour Azure Database pour MySQL : https://docs.microsoft.com/azure/mysql/concepts-data-access-security-private-link#data-exfiltration-prevention
...
Comprendre le chiffrement au repos pour Azure Database pour MySQL : https://docs.microsoft.com/azure/mysql/concepts-security

Comment configurer les clés gérées par le client pour Azure Database pour MySQL : https://docs.microsoft.com/azure/mysql/concepts-data-encryption-mysql
...
**Aide** : Actuellement non disponible ; Azure Security Center ne prend pas encore en charge l’évaluation des vulnérabilités pour Azure Database pour MySQL.
...
**Aide** : Si vous utilisez des définitions de stratégie Azure personnalisées pour vos instances Azure Database pour MySQL et des ressources associées, utilisez Azure Repos pour stocker et gérer votre code de façon sécurisée.
...
Comprendre la configuration initiale d’Azure Database pour MySQL : https://docs.microsoft.com/azure/mysql/tutorial-design-database-using-portal
...
Comprendre les sauvegardes pour Azure Database pour MySQL : https://docs.microsoft.com/azure/mysql/howto-restore-server-portal 
