...
1. Dans **Azure Database pour MySQL**, fournissez les informations suivantes :
    ...
    | Location | Sélectionnez une région Azure dans laquelle vous souhaitez que votre serveur MySQL réside. |
...
2. Entrez `nslookup  myServer.mysql.privatelink.database.azure.com`. 
