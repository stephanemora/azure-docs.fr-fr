...
2. Sur la page du serveur flexible, sous l’en-tête **Paramètres** , cliquez sur **Mise en réseau** pour ouvrir la page Mise en réseau pour le serveur flexible.
...
6. Cliquez sur **Enregistrer** sur la barre d’outils pour enregistrer cette règle de pare-feu. Attendez la confirmation que la mise à jour des règles de pare-feu a réussi.
...
Vous pouvez activer des ressources ou des applications déployées dans Azure pour vous connecter à votre serveur flexible. Cela comprend les applications web hébergées dans Azure App Service, exécutées sur une machine virtuelle Azure, une passerelle de gestion des données Azure Data Factory et bien plus encore.
