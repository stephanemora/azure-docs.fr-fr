...
ms.locfileid: "58351505"
---
# <a name="azure-database-for-mysql-use-nodejs-to-connect-and-query-data"></a>Azure Database pour MySQL : Utiliser Node.js pour se connecter et interroger des données
