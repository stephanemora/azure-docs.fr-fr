...
description: Ce guide de démarrage rapide vous montre comment utiliser le portail Azure pour créer un exemple de serveur Azure Database pour MySQL en seulement cinq minutes environ.
author: ajlam
ms.author: andrela
ms.service: mysql
ms.custom: mvc
