...
| [az mysql server create](/cli/azure/mysql/server) | Crée un serveur MySQL qui héberge les bases de données. |
| [az mysql server restore](/cli/azure/mysql/server) | Restaure un serveur à partir de la sauvegarde. |
