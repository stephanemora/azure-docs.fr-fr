...
| Versions prises en charge de TLS | TLS 1.2, TLS 1.0/1.1 - [Configurable](/rest/api/cdn/cdn/customdomains/enablecustomhttps#usermanagedhttpsparameters) | TLS 1.2 | TLS 1.2 | TLS 1.2 |
||||
...
| [Types MIME de compression](./cdn-improve-performance.md)  |Configurable |Configurable |Configurable  |Configurable  |
| Encodages de compression  |gzip, brotli |gzip |gzip, deflate, bzip2, brotli  |gzip, deflate, bzip2, brotli  |
