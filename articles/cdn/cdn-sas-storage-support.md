...
### <a name="option-1-using-sas-with-pass-through-to-blob-storage-from-azure-cdn"></a>Option 1 : À l’aide de SAP avec transfert direct vers le stockage blob à partir d’Azure CDN
...
### <a name="option-2-hidden-cdn-sas-token-using-a-rewrite-rule"></a>Option 2 : Jeton de CDN SAS masqué à l’aide d’une règle de réécriture
...
### <a name="option-3-using-cdn-security-token-authentication-with-a-rewrite-rule"></a>Option 3 : À l’aide d’authentification de jeton de sécurité CDN avec une règle de réécriture
