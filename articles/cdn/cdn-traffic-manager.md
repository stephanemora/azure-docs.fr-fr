...
description: Découvrez comment configurer le basculement entre plusieurs points de terminaison Azure Content Delivery Network à l’aide d’Azure Traffic Manager.
services: cdn
documentationcenter: ''
author: asudbring
manager: danielgi
