...
7. Sélectionnez le type d’identité à utiliser pour gérer la clé gérée par le client pour cette ressource. Vous pouvez utiliser l’identité **attribuée par le système** générée lors de la création de la commande ou choisir une identité attribuée par l’utilisateur.
    ...
    Vous ne pouvez pas créer d’identité d’utilisateur ici. Pour savoir comment procéder, consultez [Créer, répertorier, supprimer ou affecter un rôle à une identité managée attribuée par l’utilisateur à l’aide du portail Azure](/azure-docs/blob/master/articles/active-directory/managed-identities-azure-resources/how-to-manage-ua-identity-portal).
