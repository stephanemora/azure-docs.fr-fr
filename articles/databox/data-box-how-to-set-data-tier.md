---
title: Utiliser Azure Data Box pour envoyer des données à un niveau de stockage d’objets blob de bloc approprié chaud, froid ou archive | Microsoft Docs
description: Décrit comment utiliser Azure Data Box pour envoyer des données à un niveau de stockage d’objets blob de bloc approprié comme chaud, froid ou archive.
services: databox
author: alkohli
ms.service: databox
ms.subservice: pod
