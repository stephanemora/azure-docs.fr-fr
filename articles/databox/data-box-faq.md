...
Par exemple, dans le scénario d’importation, si vous souhaitez transférer des données locales se trouvant au Canada vers un compte de stockage Azure USA Ouest, vous pouvez procéder comme suit :
...
### <a name="q-i-have-lost-my-data-box-is-there-a-lost-device-charge"></a>Q. J’ai perdu ma Data Box. La perte d’un appareil occasionne-t-elle des frais supplémentaires ?
R. Oui. La perte ou l’endommagement d’un appareil occasionne des frais supplémentaires. Ceux-ci sont décrits dans la [page des tarifs](https://azure.microsoft.com/pricing/details/storage/databox/) ainsi que dans les [conditions d’utilisation du produit](https://www.microsoft.com/licensing/product-licensing/products).
...
### <a name="q-i-have-finished-prepare-to-ship-for-my-import-order-and-shut-down-the-device-can-i-still-add-more-data-to-data-box"></a>Q. J’ai terminé la préparation de la livraison pour ma commande d’importation et j’ai arrêté l’appareil. Puis-je quand même ajouter des données à Data Box ?
...
R.  Quand vous copiez les données sur la Data Box, selon qu’il s’agit d’objets blob de blocs, d’objets blob de pages ou de fichiers Azure, elles sont chargées sur l’un des chemins suivants dans votre compte Stockage Azure.
...
R.  Non. Si vous avez choisi la livraison gérée par Microsoft, vous ne pouvez pas modifier les données. Actuellement, le centre de données Azure n’accepte pas la remise des Data Box des clients ou de transporteurs autres que UPS.

Si vous avez choisi la gestion auto-gérée des expéditions, vous pouvez récupérer ou déposer votre Data Box à partir du centre de gestion Azure.
