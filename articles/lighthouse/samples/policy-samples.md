...
ms.locfileid: "83647680"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-lighthouse"></a>Définitions de stratégie intégrées d’Azure Policy pour Azure Lighthouse

Cette page est un index des définitions de stratégie intégrées d’[Azure Policy](../../governance/policy/overview.md) pour Azure Lighthouse. Pour obtenir des éléments intégrés supplémentaires d’Azure Policy pour d’autres services, consultez [Définitions intégrées d’Azure Policy](../../governance/policy/samples/built-in-policies.md).
