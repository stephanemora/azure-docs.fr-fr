---
title: FAQ - Solution Azure VMware de CloudSimple
...
L’accès au portail CloudSimple s’effectue à partir du portail Azure.  Pour plus d’informations, consultez [Accès à la solution VMware par CloudSimple, à partir du portail Microsoft Azure](access-cloudsimple-portal.md).
