---
title: Solution Azure VMware de CloudSimple – Modèle d’autorisation de cloud privé
...
> [!NOTE]
> L’utilisateur par défaut de votre Cloud privé CloudSimple est `cloudowner@cloudsimple.local` lorsqu’un cloud privé est créé sans être relié à votre vCenter local.
...
| **Opérations de chiffrement** | Ajouter un disque <br> Cloner <br> Decrypt (Déchiffrer) <br> Accès direct <br> Encrypt (Chiffrer) <br> Chiffrer nouveau <br> Gérer KMS <br> Gérer les stratégies de chiffrement <br> Gérer les clés <br> Migrer <br> Chiffrer à nouveau <br> Inscrire la machine virtuelle <br> Inscrire l’hôte |
...
| **Agent Manager ESX** | Configuration <br> Modifier <br> Affichage |
| **Extension** | Inscrire l’extension <br> Annuler l’inscription de l’extension <br> Mettre à jour l'extension |
| **Fournisseur de statistiques externes**| Register <br> Unregister <br> Mettre à jour |
...
| **Fournisseur de mises à jour d’intégrité** | Register <br> Unregister <br> Mettre à jour |
...
| **Réseau** | Attribuer un réseau <br> Configuration <br> Déplacer le réseau <br> Supprimer |
...
| **Transférer le service**| gérer <br> Surveiller |
| **vApp** | Ajouter une machine virtuelle <br> Attribuer une liste de ressources partagées <br> Attribuer vApp <br> Cloner <br> Créer <br> Supprimer <br> Exportation <br> Importer <br> Déplacer <br> Mise hors tension <br> Mise sous tension <br> Renommer <br> Interrompre <br> Unregister <br> Afficher l’environnement OVF <br> Configuration de l’application vApp <br> Configuration de l'instance vApp <br> Configuration de vApp managedBy <br> Configuration de ressource vApp |
...
| **Machine virtuelle > Gestion des instantanés** | Création d’un instantané <br> Supprimer l’instantané <br> Renommer l'instantané <br> Restaurer l’instantané |
