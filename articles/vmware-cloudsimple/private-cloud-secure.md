---
title: Solution Azure VMware par CloudSimple – Sécurisation d’un cloud privé
description: Indique comment sécuriser la solution Azure VMware par cloud privé CloudSimple
author: sharaths-cs
ms.author: b-shsury
ms.date: 08/19/2019
ms.topic: article
...
1. [Élevez les privilèges](escalate-private-cloud-privileges.md) pour **CloudOwner@cloudsimple.local** un utilisateur sur le cloud privé.
2. Connectez-vous à vCenter à l’aide de **CloudOwner@cloudsimple.local**
