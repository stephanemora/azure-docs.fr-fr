---
title: Solution Azure VMware de CloudSimple - Optimiser votre cloud privé CloudSimple pour Oracle RAC
...
|-------------------------------------------|-----------------------------------------------|-------------|
| OS                                        | Disque de système d’exploitation                         | Non          |
...
![Configuration du groupe de disques de données Oracle RAC](media/oracle-vm-os-disks.png)
...
1. [Connectez-vous au client vSphere](https://docs.azure.cloudsimple.com/vsphere-access) de votre cloud privé.
...
1. Dans vCenter, cliquez avec le bouton droit sur l’une des machines virtuelles Oracle, puis sélectionnez **Edit settings** (Modifier les paramètres).
2. Dans la section New Device (Nouvel appareil), sélectionnez **SCSI controller** (Contrôleur SCSI), puis cliquez sur **Add** (Ajouter).
...
2. [Connectez-vous au client vSphere](https://docs.azure.cloudsimple.com/vsphere-access) de votre cloud privé.
