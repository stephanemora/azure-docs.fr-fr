---
title: Développer Azure VMware par CloudSimple – Composants VMware de cloud privé
...
Les nœuds doivent être configurés avant de pouvoir développer votre cloud privé.  Pour plus d’informations sur l’approvisionnement des nœuds, consultez l’article [Approvisionner des nœuds pour la Solution VMware de CloudSimple - Azure](create-nodes.md).  Pour créer un nouveau cluster, vous devez disposer d’au moins trois nœuds disponibles avec la même référence SKU.
...
1. [Accéder au portail CloudSimple](access-cloudsimple-portal.md).
