...
1. [Dans le portail CloudSimple, copiez les informations d’homologation ExpressRoute](virtual-network-connection.md).
...
4. [Utilisez les informations d’homologation que vous avez copiées pour lier votre réseau virtuel au circuit ExpressRoute](virtual-network-connection.md).
