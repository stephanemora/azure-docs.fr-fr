...
Les solutions de contournement VMware documentées sont implémentées à la place de l’installation d’un patch correspondant jusqu’à ce que les prochaines mises à jour planifiées soient déployées. 
