...
description: Solution VMware Azure par CloudSimple - Décrit comment créer et gérer des réseaux locaux virtuels/sous-réseaux pour vos clouds privés, puis appliquer des règles de pare-feu.
author: sharaths-cs
ms.author: b-shsury
ms.date: 08/15/2019
ms.topic: article
...
3. Cliquez sur **Create VLAN/Subnet** (Créer un réseau local virtuel/sous-réseau).
    ...
    ![Page VLAN/subnet](media/vlan-subnet-page.png)
...
> [!NOTE]
> Un sous-réseau peut être associé à une seule table de pare-feu. Une table de pare-feu peut être associée à plusieurs sous-réseaux.
