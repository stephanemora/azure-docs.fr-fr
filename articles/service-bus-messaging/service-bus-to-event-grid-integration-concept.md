...
#### <a name="deadletter-messages-available-event"></a>Événement Messages lettres mortes disponibles
...
Le schéma de l’événement est le suivant :
