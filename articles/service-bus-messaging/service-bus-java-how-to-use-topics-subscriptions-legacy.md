...
> [!WARNING]
>  Ce guide de démarrage rapide utilise le package azure-servicebus actuellement en disponibilité générale. Pour obtenir un guide de démarrage rapide qui utilise le nouveau package azure-messaging-servicebus en **préversion**, consultez [Envoyer et recevoir des messages à l’aide d’azure-messaging-servicebus](service-bus-java-how-to-use-topics-subscriptions.md).
