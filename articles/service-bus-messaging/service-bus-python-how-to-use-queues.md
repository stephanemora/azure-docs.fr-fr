...
Dans ce didacticiel, vous allez apprendre à créer des applications Python pour envoyer des messages à et de recevoir des messages à partir d’une file d’attente Service Bus. 
