...
> [!NOTE]
> Dans la préversion publique d’Azure Data Lake Storage Gen2, la disponibilité de certaines des fonctionnalités répertoriées ci-dessous peut varier. Vous serez informé à mesure de la publication des nouvelles régions et fonctionnalités par le biais de notre groupe Yammer dédié.  
...
> [!NOTE]
> Avec la publication de la préversion, si vous activez l’espace de noms hiérarchique, il n’y a pas d’interopérabilité des données ou des opérations entre les API REST Data Lake Storage Gen2 et d’objets blob. Cette fonctionnalité sera ajoutée pendant la préversion.

## <a name="next-steps"></a>Étapes suivantes

- [Créer un compte de stockage](./quickstart-create-account.md)