...
![Graphique de l’entité Employé où une application cliente peut utiliser une requête de pointage pour récupérer une entité d’employé individuelle en utilisant le nom de service et l’ID d’employé (valeurs PartitionKey et RowKey).](media/storage-table-design-guide/storage-table-design-IMAGE06.png)
...
![Graphique montrant une entité Employee avec différentes valeurs RowKey](media/storage-table-design-guide/storage-table-design-IMAGE07.png)
...
* Vous n'avez pas toujours besoin de dupliquer toutes les propriétés de votre entité. Par exemple, si les requêtes de recherche des entités à l’aide de l’adresse de messagerie dans la **RowKey** n’ont jamais besoin de l’âge de l’employé, ces entités peuvent présenter la structure suivante :
   ...
   ![Graphique de l’entité Employee](media/storage-table-design-guide/storage-table-design-IMAGE08.png)
...
![Graphique de la structure de l’entité Employee, qui lorsqu’elle est utilisée, permet à une application cliente d’employer une requête de pointage pour récupérer une entité d’employé individuelle en utilisant le nom de service et l’ID d’employé (valeurs PartitionKey et RowKey).](media/storage-table-design-guide/storage-table-design-IMAGE09.png)
...
![Graphique montrant l’entité d’employé avec index primaire et entité d’employé avec index secondaire](media/storage-table-design-guide/storage-table-design-IMAGE10.png)
...
* Vous n'avez pas toujours besoin de dupliquer toutes les propriétés de votre entité. Par exemple, si les requêtes de recherche des entités à l’aide de l’adresse de messagerie dans la **RowKey** n’ont jamais besoin de l’âge de l’employé, ces entités peuvent présenter la structure suivante :
   ...
   ![Graphique montrant l’entité Employee avec index secondaire](media/storage-table-design-guide/storage-table-design-IMAGE11.png)
...
![Diagramme de solution pour la cohérence finale](media/storage-table-design-guide/storage-table-design-IMAGE12.png)
...
![Graphique de la structure de l’entité Employé où une application cliente peut récupérer efficacement une entité d’employé individuelle en utilisant le nom de service et l’ID d’employé (PartitionKey et RowKey).](media/storage-table-design-guide/storage-table-design-IMAGE13.png)
...
![Graphique montrant l’entité d’employé avec une chaîne contenant la liste des ID d’employés ayant le même nom de famille](media/storage-table-design-guide/storage-table-design-IMAGE14.png)
...
![Graphique d’entité Department et d’entité Employee](media/storage-table-design-guide/storage-table-design-IMAGE16.png)
...
![Graphique d’entité Department dénormalisée et combinée](media/storage-table-design-guide/storage-table-design-IMAGE17.png)
...
![Graphique de la structure d’entité Employé que vous devez utiliser pour stocker les entités d’employés dans le stockage Table.](media/storage-table-design-guide/storage-table-design-IMAGE18.png)
...
![Graphique d’entité d’évaluation d’employé](media/storage-table-design-guide/storage-table-design-IMAGE19.png)
...
![Graphique d’entité Employee avec clé composée](media/storage-table-design-guide/storage-table-design-IMAGE20.png)
...
![Graphique d’entité de tentative de connexion](media/storage-table-design-guide/storage-table-design-IMAGE21.png)
...
![Graphique d’entité de statistiques de message](media/storage-table-design-guide/storage-table-design-IMAGE22.png)
...
![Graphique d’entité de statistiques de message avec propriétés distinctes](media/storage-table-design-guide/storage-table-design-IMAGE23.png)
...
![Graphique d’entité de statistiques de message avec RowKey 01 et entité de statistiques de message avec RowKey 02](media/storage-table-design-guide/storage-table-design-IMAGE24.png)
...
![Graphique montrant l’entité Employee avec chaîne Photo qui pointe vers le stockage Blob](media/storage-table-design-guide/storage-table-design-IMAGE25.png)
...
Si vous utilisez la bibliothèque cliente de table, vous avez trois options pour travailler avec plusieurs types d’entité.  
