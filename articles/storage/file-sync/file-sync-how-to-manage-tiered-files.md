...
Cet article fournit des conseils pour les utilisateurs qui ont des questions en lien avec la gestion des fichiers hiérarchisés. Pour des questions conceptuelles sur la hiérarchisation Cloud, consultez [FAQ Azure Files](../files/storage-files-faq.md?toc=%2fazure%2fstorage%2ffilesync%2ftoc.json).
