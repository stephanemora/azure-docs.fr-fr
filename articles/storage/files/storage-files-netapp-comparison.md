...
| Chiffrement | Tous les protocoles<br><ul><li>Chiffrement au repos (AES 256) avec clés managées par le client ou par Microsoft</li></ul><br>SMB<br><ul><li>Chiffrement Kerberos utilisant AES 256 ou RC4-HMAC</li><li>Chiffrement en transit</li></ul><br>REST<br><ul><li>Chiffrement en transit</li></ul><br> Pour en savoir plus, consultez [sécurité](./storage-files-compare-protocols.md#security). | Tous les protocoles<br><ul><li>Chiffrement au repos (AES 256) avec clés managées par Microsoft </li></ul><br>NFS 4.1<ul><li>Chiffrement en transit à l’aide de Kerberos avec AES 256</li></ul><br> Pour plus d’informations, consultez [FAQ de sécurité](../../azure-netapp-files/azure-netapp-files-faqs.md#security-faqs). |
...
| Taille maximale du partage/volume | 100 Tio | Tous les niveaux<br><ul><li>100 tio (limite de la capacité du pool 500 Tio)</li></ul><br>Jusqu’à 12,5 PiB par compte Azure NetApp. |
