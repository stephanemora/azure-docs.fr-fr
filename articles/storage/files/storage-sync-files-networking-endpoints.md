...
description: Présentation des options de réseau pour Azure File Sync.
author: roygara
ms.service: storage
ms.topic: overview
ms.date: 5/11/2020
...
- Vous avez déjà créé un partage de fichiers Azure dans un compte de stockage auquel vous souhaitez vous connecter à partir d’un emplacement local. Pour savoir comment créer un partage de fichiers Azure, consultez [Créer un partage de fichiers Azure](storage-how-to-create-file-share.md).
...
# <a name="portal"></a>[Portail](#tab/azure-portal)
Cela n’est pas possible via le portail Azure. Pour obtenir des instructions sur la façon de désactiver le point de terminaison public du service de synchronisation du stockage, sélectionnez l’onglet Azure PowerShell ou Azure CLI. 
