...
- Vous tentez de vous connecter à un partage de fichiers Azure à partir d’une machine virtuelle Azure qui n’est pas située dans la même région que le compte de stockage.
