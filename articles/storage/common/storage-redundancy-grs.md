...
* Si Microsoft initie un basculement vers la région secondaire, vous obtenez un accès en lecture et en écriture à ces données une fois le basculement effectué. Pour plus d’informations, consultez [Conseils sur la récupération d’urgence](storage-disaster-recovery-guidance.md).
