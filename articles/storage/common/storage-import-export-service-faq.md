...
- Si vous utilisez [WAImportExport V1](https://download.microsoft.com/download/0/C/D/0CD6ABA7-024F-4202-91A0-CE2656DCE413/WaImportExportV1.zip), voici un exemple de commande
    ...
    ```
- Si vous utilisez [WAImportExport V2](https://www.microsoft.com/download/details.aspx?id=55280), spécifiez « AlreadyEncrypted », puis indiquez la clé dans le fichier driveset.csv.
    ```
