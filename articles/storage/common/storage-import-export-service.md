...
2.  Pour activer le chiffrement sur l’ordinateur Windows, activez le chiffrement BitLocker sur le volume NTFS. Suivez les instructions sur https://technet.microsoft.com/library/cc731549(v=ws.10).aspx.
