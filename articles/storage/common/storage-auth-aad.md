...
Pour savoir comment attribuer un rôle intégré Azure à un principal de sécurité, consultez [Attribuer un rôle Azure pour l’accès aux données d’objet blob](../blobs/assign-azure-role-data-access.md).
