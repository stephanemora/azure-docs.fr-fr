...
|---------|---------|---------|---------|---------|
|Objets blob Azure     |[Pris en charge](https://docs.microsoft.com/rest/api/storageservices/authenticate-with-shared-key/)         |[Pris en charge](storage-dotnet-shared-access-signature-part-1.md)         |[Pris en charge](storage-auth-aad.md)         |[Pris en charge](../blobs/storage-manage-access-to-resources.md)         |
...
|Azure Files (REST)     |[Pris en charge](https://docs.microsoft.com/rest/api/storageservices/authenticate-with-shared-key/)         |[Pris en charge](storage-dotnet-shared-access-signature-part-1.md)         |Non pris en charge         |Non pris en charge         |
|Files d'attente Azure     |[Pris en charge](https://docs.microsoft.com/rest/api/storageservices/authenticate-with-shared-key/)         |[Pris en charge](storage-dotnet-shared-access-signature-part-1.md)         |[Pris en charge](storage-auth-aad.md)         |Non pris en charge         |
|Tables Azure     |[Pris en charge](https://docs.microsoft.com/rest/api/storageservices/authenticate-with-shared-key/)         |[Pris en charge](storage-dotnet-shared-access-signature-part-1.md)         |Non pris en charge         |Non pris en charge         |
