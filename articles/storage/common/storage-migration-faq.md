...
## <a name="copy-upload-or-download"></a>Copier, charger ou télécharger
...
## <a name="migration-or-backup"></a>Migration ou sauvegarde
...
2.  Utilisez [AzCopy](https://azure.microsoft.com/blog/azcopy-5-1-release/) pour copier le contenu du conteneur d'objets blob d'origine vers un autre conteneur d'objets blob.
...
**Où puis-je obtenir plus d'informations sur le chiffrement du stockage Azure ?**  
...
- [Fournir une clé de chiffrement lors d’une requête au stockage d’objets blob (préversion)](encryption-customer-provided-keys.md)
