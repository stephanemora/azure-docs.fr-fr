---
title: Contrôles de conformité réglementaire Azure Policy pour Azure Data Lake Storage Gen2
description: Liste les contrôles de conformité réglementaire Azure Policy pour Azure Data Lake Storage Gen2. Ces définitions de stratégie intégrées fournissent des approches courantes pour la gestion de la conformité de vos ressources Azure.
ms.date: 10/07/2020
ms.topic: sample
author: normesta
ms.author: normesta
