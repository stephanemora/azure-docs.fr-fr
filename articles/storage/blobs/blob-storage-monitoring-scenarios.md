...
1. Exportez les journaux vers un compte de stockage. Consultez [Création d’un paramètre de diagnostic](monitor-blob-storage.md#creating-a-diagnostic-setting).
