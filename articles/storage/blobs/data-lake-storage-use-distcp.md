...
- Un cluster Azure HDInsight ayant accès à un compte de stockage avec la fonctionnalité d’espace de noms hiérarchique activée. Pour plus d’informations, consultez [Utiliser Azure Data Lake Storage Gen2 avec des clusters Azure HDInsight](../../hdinsight/hdinsight-hadoop-use-data-lake-storage-gen2.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json). Veillez à activer le Bureau à distance pour le cluster.
...
1. Créez une session SSH sur votre cluster HDI. Pour plus d’informations, consultez [Connexion à un cluster HDInsight sous Linux](../../hdinsight/hdinsight-hadoop-linux-use-ssh-unix.md).
