...
Vous pouvez définir des autorisations à la racine de votre système de fichiers. Pour ce faire, vous devez être connecté à l’Explorateur de stockage Azure avec votre compte spécifique disposant des droits adaptés (par opposition à une chaîne de connexion). Cliquez avec le bouton droit sur votre système de fichiers, puis sélectionnez **Gérer les autorisations**, ce qui affiche la boîte de dialogue **Gérer les autorisations**.
