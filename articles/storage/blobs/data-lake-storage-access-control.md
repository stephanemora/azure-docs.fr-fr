...
description: Comprendre le fonctionnement du contrôle d’accès dans Azure Data Lake Storage Gen2. Le contrôle d’accès en fonction du rôle Azure (Azure RBAC) et les listes ACL de type POSIX sont pris en charge.
author: normesta
