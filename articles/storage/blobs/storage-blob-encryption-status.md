...
Pour plus d’informations sur l’utilisation d’AzCopy afin de copier des données d’objets blob, consultez [Transférer des données avec AzCopy et le Stockage Blob](../common/storage-use-azcopy-blobs.md).
