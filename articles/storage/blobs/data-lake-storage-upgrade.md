...
| Opérations de données - Journaux d’activité  | Oui | Requêtes uniques de journaux d’activité pour une durée spécifique avec intégration Azure Monitoring des tickets de support | Requêtes uniques de journaux d’activité pour une durée spécifique avec des tickets de support – *Disponible maintenant*<br><br> Intégration Azure Monitoring – *Pas encore disponible* |
...
| Journaux de diagnostic                                                                                        | [Lien](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#request-logs) | Requêtes uniques de journaux d’activité pour une durée spécifique avec Intégration Azure Monitoring – *Pas encore disponible* des tickets de support - *Déjà disponible* |
