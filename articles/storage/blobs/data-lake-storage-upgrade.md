...
| Opérations de données - Journaux  | OUI | Requêtes uniques de journaux pour une durée spécifique avec intégration Azure Monitoring des tickets de support | Requêtes uniques de journaux pour une durée spécifique avec des tickets de support – *Disponible maintenant*<br><br> Intégration Azure Monitoring – *Pas encore disponible* |
...
| PowerShell - gestion et système de fichiers | [Lien](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | Gestion – Pas pris en charge Système de fichiers - *Pas encore disponible*        | Gestion – *Disponible maintenant -* [Lien](https://docs.microsoft.com/powershell/module/az.storage) <br><br>Système de fichiers – *Pas encore disponible* |
...
Le schéma d’URI permettant d’accéder aux fichiers Data Lake Storage Gen2 est expliqué [ici](https://docs.microsoft.com/azure/storage/data-lake-storage/use-hdi-cluster) en détail, mais de manière générale, il suit le format *abfss://\<NOM_SYSTÈME_FICHIERS\>\@\<NOM_COMPTE\>.dfs.core.windows.net/\<CHEMIN_ACCÈS\>.*
