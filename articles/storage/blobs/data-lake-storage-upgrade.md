...
| Opérations de données - Journaux  | Oui | Requêtes uniques de journaux pour une durée spécifique avec intégration Azure Monitoring des tickets de support | Requêtes uniques de journaux pour une durée spécifique avec intégration Azure Monitoring – *Pas encore disponible* des tickets de support – *Déjà disponibles* |
...
| Contrat SLA de disponibilité                            | [Voir contrat SLA](https://azure.microsoft.com/support/legal/sla/data-lake-store/v1_0/)                                                                   | [Voir contrat SLA](https://azure.microsoft.com/support/legal/sla/storage/v1_3/)                                                                                                                                                                                                                                                                                                                                                | *Pas encore disponible*                                                                                                                           |
...
| PowerShell - gestion et système de fichiers | [Lien](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | Gestion – Pas pris en charge Système de fichiers - *Pas encore disponible*        | Gestion – *Déjà disponible -* [Lien](https://docs.microsoft.com/powershell/module/az.storage) Système de fichiers - *Pas encore disponible* |
