...
La fonctionnalité de stockage de la **Figure1** est fournie par Data Lake Storage Gen1 (**Figure 2**). Notez comment les différents composants du flux de données interagissent avec Data Lake Storage Gen1 via l’API REST ou le SDK Java. Notez également la façon dont les composants de fonctionnalités transversales interagissent avec Data Lake Storage Gen1. Le composant d’approvisionnement utilise des modèles de ressources Azure, tandis que le composant d’analyse qui utilise des journaux Azure Monitor utilise des données opérationnelles qui provient de génération 1 de Data Lake Storage.
...
| Kits de développement logiciel pour développeur | .NET, Java, Python, Node.js  | .NET, Java, Python, Node.js, C++, Ruby, PHP, Go, Android, iOS| *Pas encore disponible* |
...
| Node.js - gestion                   | [Lien](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                                | Non pris en charge                                                      | *Déjà disponible -* [Lien](https://azure.github.io/azure-storage-node/)                                                                                            |
...
| Python - système de fichiers                    | [Lien](https://azure-datalake-store.readthedocs.io/en/latest/)                                                                                                                                                                                                                                                                 | *Pas encore disponible*                                                | *Pas encore disponible*                                                                                                                                             |
