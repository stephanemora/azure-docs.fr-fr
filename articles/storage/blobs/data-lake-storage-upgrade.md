...
Ce tableau décrit les ensembles d’API disponibles pour vos applications personnalisées. Pour rendre les choses un peu plus clairs, nous avons réparti ces ensembles d’API en 2 types : gestion des API et le fichier API du système.

API de gestion vous aident à gérer les comptes, tout en les API vous aident à opérer sur les fichiers et dossiers de système de fichiers.
...
| Kit de développement .NET – système de fichiers                  | [Lien](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/client?view=azure-dotnet)                                                                                                                                                                                                                     | *Pas encore disponible*                                                | *Pas encore disponible*                                                                                                                                             |
...
| Java SDK – système de fichiers                  | [Lien](https://docs.microsoft.com/java/api/overview/azure/datalake)                                                                                                                                                                                                                                         | *Pas encore disponible*                                                | *Pas encore disponible*                                                                                                                                             |
...
| PowerShell - gestion et système de fichiers | [Lien](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | Gestion – pas pris en charge que le système de fichiers - *pas encore disponible*        | Gestion – *Disponible maintenant -* [Lien](https://docs.microsoft.com/powershell/module/az.storage) <br><br>Système de fichiers - *pas encore disponible* |
...
| Consommation          | [Power BI Desktop](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-power-bi)                                                                           | *Pas encore disponible*                                                                                                                                                          | *Pas encore disponible*                                                                                                                             |
...
* Dans Data Lake Storage Gen1, le niveau le plus élevé auquel vous pouvez définir les ACL se trouve à la racine du compte. Dans Data Lake Storage Gen2, toutefois, le niveau le plus élevé, vous pouvez définir des ACL est dans le dossier racine dans un système de fichiers, pas l’ensemble de compte. Par conséquent, si vous souhaitez définir des ACL par défaut au niveau du compte, vous devez dupliquer les ACL de tous les systèmes de fichiers dans votre compte Data Lake Storage Gen2.
...
La tâche principale ici consiste à traduire les URI qui ont un préfixe de `adl://` en URI ayant un `abfss://` préfixe.
...
Une fois la transition terminée, les étapes finales impliquent une vérification approfondie de la mise à niveau. Voulez-vous inclure ce service se limite ne pas à vérification des données a été copiée fiable, ACL vérification ont été définies correctement, les pipelines de bout en bout pour vérification ne fonctionnent correctement, etc. Une fois les vérifications terminées, vous pouvez arrêter vos anciens pipelines, supprimer vos comptes source Data Lake Storage Gen1 et adopter pleinement vos solutions basées sur Data Lake Storage Gen2.
