...
Tout d’abord, créez les références aux objets ContainerURL et BlobURL utilisés pour accéder au stockage Blob et le gérer. Ces objets offrent des API de bas niveau telles que Create, Upload et Download pour publier des API REST.
