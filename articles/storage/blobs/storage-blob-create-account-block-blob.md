...
Pour plus d’informations sur les comptes de stockage d’objets blob de bloc, consultez [vue d’ensemble du compte de stockage Azure](https://docs.microsoft.com/azure/storage/common/storage-account-overview).
