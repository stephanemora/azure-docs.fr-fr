...
|Azure Event Hub|Mise à la disposition générale|[Capturer des événements avec Azure Event Hubs dans Stockage Blob Azure ou Azure Data Lake Storage](https://docs.microsoft.com/azure/event-hubs/event-hubs-capture-overview)|
|Azure Event Grid|Mise à la disposition générale|[Tutoriel : Implémenter le modèle de capture de lac de données pour mettre à jour une table Delta Databricks](data-lake-storage-events.md)|
...
|Azure Synapse Analytics (anciennement SQL Data Warehouse)|Mise à la disposition générale|[Utiliser avec Azure Synapse Analytics (anciennement SQL Data Warehouse)](https://docs.microsoft.com/azure/sql-database/sql-database-vnet-service-endpoint-rule-overview?toc=%2fazure%2fstorage%2fblobs%2ftoc.json#azure-sql-data-warehouse-polybase)|
...
|Explorateur de données Azure|PRÉVERSION|[Interroger des données dans Azure Data Lake à l’aide d’Azure Data Explorer](https://docs.microsoft.com/azure/data-explorer/data-lake-query-data)|
