...
| Stratégie d’immuabilité sur une version de blob (préversion) | Oui<sup>2</sup> | Oui<sup>3</sup> | Oui | Oui<sup>4</sup> |
| Stratégie d’immuabilité sur un conteneur | Oui<sup>5</sup> | Oui | Oui | Oui |
| Suppression réversible de conteneur | Non | Oui | Non | Non |
| Contrôle de version de blob<sup>6</sup> | Non | Non | Oui | Oui |
| Suppression réversible de blob | Non | Non | Oui | Oui |
| Limite de restauration dans le temps<sup>6</sup> | Non | Non | Oui | Oui |
| Instantané d’objet blob | Non | Non | Non | Oui |
| Solution personnalisée pour copier des données vers un deuxième compte<sup>7</sup> | Non | Oui | Oui | Oui |

<sup>1</sup> Un verrou Azure Resource Manager ne protège pas un conteneur contre la suppression.<br />
<sup>2</sup> La suppression du compte de stockage échoue s’il existe au moins un conteneur dont le stockage immuable au niveau de la version est activé.<br />
<sup>3</sup> La suppression du conteneur échoue si au moins un blob existe dans le conteneur, que la stratégie soit verrouillée ou déverrouillée.<br />
<sup>4</sup> Le remplacement du contenu de la version actuelle du blob crée une nouvelle version. Une stratégie d’immuabilité protège les métadonnées d’une version contre le remplacement.<br />
<sup>5</sup> Quand une stratégie de conservation légale ou de rétention à durée déterminée est en vigueur au niveau du conteneur, le compte de stockage est également protégé contre la suppression.<br />
<sup>6</sup> Non pris en charge actuellement pour les charges de travail Data Lake Storage.<br />
<sup>7</sup> AzCopy et Azure Data Factory sont des options prises en charge pour les charges de travail Stockage Blob et Data Lake Storage. La réplication d’objets est prise en charge uniquement pour les charges de travail de Stockage Blob.<br />
...
| Blob (tout type) | Récupérer un blob supprimé de manière réversible<br />[En savoir plus…](soft-delete-blob-enable.md) | La suppression réversible de blob est activée et l’intervalle de rétention de suppression réversible n’a pas expiré. |
