...
![Azure Databricks avec Data Lake Storage Gen2 et SQL Data Warehouse](./media/data-lake-storage-handle-data-using-databricks/databricks-extract-transform-load-sql-datawarehouse.png "Azure Databricks avec Data Lake Storage Gen2 et SQL Data Warehouse")
...
* [Créer un compte Azure Data Lake Storage Gen2](data-lake-storage-quickstart-create-account.md)
...
3. Dans la boîte de dialogue **Créer un bloc-notes**, entrez un nom pour le bloc-notes. Sélectionnez **Scala** comme langage, puis sélectionnez le cluster Spark que vous avez créé précédemment.
    ...
    ![Créer un notebook dans Databricks](./media/data-lake-storage-handle-data-using-databricks/databricks-notebook-details.png "Créer un notebook dans Databricks")

    Sélectionnez **Créer**.

4. Entrez le code suivant dans la première cellule et exécutez le code. N’oubliez pas de remplacer les espaces réservés affichés entre crochets dans l’exemple par vos propres valeurs :
...
5. Appuyez sur **Maj+Entrée** pour exécuter la cellule de code.
...
> [!NOTE]
> Si vous n’avez pas déjà un compte activé pour Azure Data Lake Storage Gen2, suivez le [guide de démarrage rapide pour en créer un](./data-lake-storage-quickstart-create-account.md).
