...
> [Kit de développement logiciel (SDK) Stockage Microsoft Azure v10 pour Java](https://github.com/azure/azure-storage-java) 
> [Référence API Java](https://docs.microsoft.com/java/azure/)
