...
Si vous rencontrez des problèmes lors de la création de clusters HDInsight, reportez-vous aux [exigences de contrôle d’accès](../../hdinsight/hdinsight-administer-use-portal-linux.md#create-clusters).
