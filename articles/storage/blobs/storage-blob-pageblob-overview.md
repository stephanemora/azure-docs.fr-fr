---
title: Fonctionnalités uniques des objets blob de pages Azure | Microsoft Docs
...
> [!WARNING]
> Les objets blob de pages du stockage Premium sont conçus pour être utilisés en tant que disques durs virtuels uniquement. Microsoft ne recommande pas de stocker d’autres types de données dans les objets blob de pages du stockage Premium, dans la mesure où le coût associé peut s’avérer considérablement supérieur. Utilisez des objets blob de blocs pour stocker des données non contenues dans un disque dur virtuel.
