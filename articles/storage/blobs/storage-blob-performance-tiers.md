---
title: Niveaux de performance du service de stockage d'objets blob de blocs
...
Le niveau de performance Standard prend en charge différents [niveaux d'accès](access-tiers-overview.md) pour stocker les données de la manière la plus économique. Il est optimisé pour une capacité et un débit élevés sur les jeux de données volumineux.
