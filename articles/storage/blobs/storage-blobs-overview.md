---
title: À propos du Stockage (d’objets) Blob – Stockage Azure
description: Le stockage Blob Azure stocke de grandes quantités de données d’objet non structurées, telles que des données texte ou binaires. Stockage Blob prend également en charge Azure Data Lake Storage Gen2 pour l’analytique Big Data.
services: storage
author: tamram
ms.service: storage
ms.topic: overview
