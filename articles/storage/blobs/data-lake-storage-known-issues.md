...
| **Recherche Azure** |Pris en charge uniquement si vous vous inscrivez à la préversion [d’accès multiprotocole sur Data Lake Storage](data-lake-storage-multi-protocol-access.md).|
