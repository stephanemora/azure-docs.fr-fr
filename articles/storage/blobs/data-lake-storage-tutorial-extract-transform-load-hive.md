...
![Opération ETL à l’aide d’Apache Hive sur Azure HDInsight](./media/data-lake-storage-tutorial-extract-transform-load-hive/hdinsight-etl-architecture.png "Opération ETL à l’aide d’Apache Hive sur Azure HDInsight")

Si vous ne disposez pas d’abonnement Azure, créez un [compte gratuit](https://azure.microsoft.com/free/) avant de commencer.

## <a name="prerequisites"></a>Prérequis

* **Cluster Hadoop Linux sur HDInsight**. Consultez [Configurer des clusters dans HDInsight avec Hadoop, Spark, Kafka et bien plus encore](./data-lake-storage-quickstart-create-connect-hdi-cluster.md) pour savoir comment créer un cluster HDInsight basé sur Linux.
