...
description: Dans ce guide de démarrage rapide, vous utilisez le portail Azure pour créer une file d’attente, puis pour ajouter un message.
services: storage
author: tamram
ms.custom: mvc
ms.service: storage
