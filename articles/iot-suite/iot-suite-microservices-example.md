...
La prochaine opération à tenter est la [personnalisation du microservice de simulateur d’appareil dans la solution de surveillance à distance](iot-suite-remote-monitoring-test.md)
