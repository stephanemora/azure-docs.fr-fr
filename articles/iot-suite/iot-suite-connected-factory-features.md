...
![Tableau de bord de la solution Usine connectée](media/iot-suite-connected-factory-features/dashboard.png)
...
[Configurez des règles de seuil des alertes](iot-suite-connected-factory-configure.md).
