...
1. Dans le portail Azure, cliquez sur le bouton **Cloud Shell**.
    ...
    ![Icône de lancement de portail](media/iot-suite-integrate-data-lake/portal-launch-icon.png)
...
1. Cliquez sur **Créer une ressource**, sélectionnez Internet des objets à partir de la Place de marché, puis cliquez sur **Tâche Stream Analytics**.
    ...
    ![Nouvelle tâche Stream Analytics](media/iot-suite-integrate-data-lake/new-stream-analytics-job.png)
...
1. Cliquez sur **Créer**.
    ...
    ![Créer une tâche Stream Analytics](media/iot-suite-integrate-data-lake/create-stream-analytics-job.png)
...
1. Dans la page Vue d’ensemble, cliquez sur **Entrées**.
    ...
    ![Page Vue d’ensemble](media/iot-suite-integrate-data-lake/stream-analytics-overview.png)

1. Cliquez sur **Ajouter une entrée de flux** et sélectionnez **Hub IoT** dans la liste déroulante.

    ![Ajouter une entrée](media/iot-suite-integrate-data-lake/stream-analytics-add-input.png)
...
1. Dans la liste déroulante Groupe de consommateurs, sélectionnez le groupe de consommateurs que vous avez créé précédemment. Nous utilisons ici **streamanalyticsjob**.
    ...
    ![Sélectionner l’entrée](media/iot-suite-integrate-data-lake/stream-analytics-new-input.png)

1. Cliquez sur **Enregistrer**.

1. Dans la page Vue d’ensemble, cliquez sur **Sorties**.

    ![Ajouter Data Lake Store](media/iot-suite-integrate-data-lake/stream-analytics-overview-2.png)

1. Cliquez sur **Ajouter** et sélectionnez **Data Lake Store** dans la liste déroulante.

    ![Ajouter une sortie](media/iot-suite-integrate-data-lake/stream-analytics-output.png)
...
1. Dans le champ Format de date, entrez **/streaming/{date}/{time}**. Laissez le format de date YYYY/MM/DD et le format d’heure HH par défaut.
    ...
    ![Indiquer une structure de dossiers](media/iot-suite-integrate-data-lake/stream-analytics-new-output.png)
...
1. Cliquez sur **Autoriser**.
    ...
    ![Autoriser Stream Analytics sur Data Lake Store](media/iot-suite-integrate-data-lake/stream-analytics-out-authorize.png)
...
1. Dans l’éditeur de requête, remplacez les espaces réservés [YourOutputAlias] et [YourInputAlias] par les valeurs précédemment définies.
    ...
    ![Requête Stream Analytics](media/iot-suite-integrate-data-lake/stream-analytics-query.png)
...
1. Cliquez sur **Démarrer**.
    ...
    ![Travail en cours d’exécution](media/iot-suite-integrate-data-lake/stream-analytics-running.png)
...
1. Dans l’Explorateur de données, descendez dans la hiérarchie jusqu’au dossier **/streaming**. Vous verrez des dossiers créés avec le format YYYY/MM/DD/HH.
    ...
    ![Explorer les données de streaming](media/iot-suite-integrate-data-lake/data-lake-store-data-explorer.png)

    Vous verrez des fichiers json avec un fichier par heure.

    ![Explorer les données de streaming](media/iot-suite-integrate-data-lake/data-lake-store-file-preview.png)

## <a name="next-steps"></a>Étapes suivantes

Azure Data Lake Analytics peut être utilisé pour effectuer une analyse de big data sur vos jeux de données Data Lake Store. Explorez la [Documentation Data Lake Analytics](https://docs.microsoft.com/en-us/azure/data-lake-analytics) pour en savoir plus.
