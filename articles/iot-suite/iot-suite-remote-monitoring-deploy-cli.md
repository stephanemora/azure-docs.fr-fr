...
| Quantité | Ressource                       | type         | Utilisation |
|-------|--------------------------------|--------------|----------|
...
| Quantité | Ressource                                     | Référence (SKU) / Taille      | Utilisation |
|-------|----------------------------------------------|-----------------|----------|
