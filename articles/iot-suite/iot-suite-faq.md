...
### <a name="what-sdks-can-i-use-to-develop-device-clients-for-the-preconfigured-solutions"></a>Quels kits de développement logiciel puis-je utiliser pour développer des clients de périphériques pour les solutions préconfigurées ?
