...
Les appareils Azure Stack Edge Pro R disposent de huit disques de données et de deux disques SATA 2 M.2 faisant office de disques de système d’exploitation. Pour plus d’informations, consultez [Disques SATA M.2](https://en.wikipedia.org/wiki/M.2).
...
|     Boîtier                                 |     Poids          |
|-----------------------------------------------|---------------------|
|    Poids total d’un appareil à nœud unique + boîtier avec bouchons     |    Environ 114 livres          |
