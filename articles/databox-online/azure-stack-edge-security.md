---
title: Sécurité Azure Stack Edge | Microsoft Docs
description: Décrit les fonctionnalités de sécurité et de confidentialité qui protègent votre appareil, votre service et vos données Azure Stack Edge en local et dans le cloud.
...
- **Appareil Azure Stack Edge**. appareil de transfert qui vous est livré pour que vous puissiez importer vos données locales dans Azure.
- **Clients/hôtes connectés à l’appareil** : Clients dans votre infrastructure qui se connectent à l’appareil Azure Stack Edge et contiennent des données à protéger.
...
Cette section décrit les fonctionnalités de sécurité d’Azure Stack Edge qui protègent les données en transit et stockées.
...
Pour afficher la liste des utilisateurs qui ont accès à un partage ou qui peuvent supprimer un partage, suivez les étapes décrites dans [Gérer les partages sur Azure Stack Edge](azure-stack-edge-manage-shares.md).
...
[Déployer votre appareil Azure Stack Edge](azure-stack-edge-deploy-prep.md)
