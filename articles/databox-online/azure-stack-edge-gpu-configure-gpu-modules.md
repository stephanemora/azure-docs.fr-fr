...
2. Dans **Vue d’ensemble**, sélectionnez **IoT Edge**.
    ...
    ![Configurer le module pour utiliser le GPU 1](media/azure-stack-edge-gpu-configure-gpu-modules/configure-compute-1.png)

3. Dans **Activer le service IoT Edge**, sélectionnez **Ajouter**.

   ![Configurer le module pour utiliser le GPU 2](media/azure-stack-edge-gpu-configure-gpu-modules/configure-compute-2.png)
...
4. Dans **Créer un service IoT Edge**, entrez les paramètres de votre ressource IoT Hub :
   ...
   ![Bien démarrer avec le calcul 2](./media/azure-stack-edge-gpu-configure-gpu-modules/configure-compute-3.png)
   ...
   ![Bien démarrer avec le calcul 3](./media/azure-stack-edge-gpu-configure-gpu-modules/configure-compute-4.png)

5. Pour vérifier que le rôle de calcul Edge a été configuré, sélectionnez **Propriétés**.

   ![Bien démarrer avec le calcul 4](./media/azure-stack-edge-gpu-configure-gpu-modules/configure-compute-5.png)

6. Dans **Propriétés**, sélectionnez le lien pour **Appareil IoT Edge**.

   ![Configurer le module pour utiliser le GPU 6](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-2.png)
...
7. Sélectionnez cet appareil IoT Edge.
   ...
   ![Configurer le module pour utiliser le GPU 7](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-3.png)

8. Sélectionnez **Définir des modules**.

   ![Configurer le module pour utiliser le GPU 8](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-4.png)

9. Sélectionnez **+ Ajouter**, puis **+ Module IoT Edge**. 

    ![Configurer le module pour utiliser le GPU 9](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-5.png)
...
10. Sous l’onglet **Ajouter un module IoT Edge** :
    ...
    ![Configurer le module pour utiliser le GPU 10](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-6.png)
...
11. Sous l’onglet **Variables d’environnement**, indiquez le nom de la variable et la valeur correspondante. 
    ...
    2. Définissez cette condition sur la valeur 0 ou 1. Une valeur de 0 ou 1 garantit qu’au moins un GPU est utilisé par l’appareil pour ce module. Quand vous définissez la valeur sur 0, 1, cela signifie que ces deux GPU sur votre appareil sont utilisés par ce module.
       ...
       ![Configurer le module pour utiliser le GPU 11](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-7.png)
...
12. Entrez un nom pour votre module. À ce stade, vous pouvez choisir de fournir une option de création de conteneur et de modifier les paramètres de jumeau de module ou, si vous avez terminé, sélectionnez **Ajouter**. 
    ...
    ![Configurer le module pour utiliser le GPU 12](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-8.png)

13. Vérifiez que le module est en cours d’exécution et sélectionnez **Vérifier + créer**.

    ![Configurer le module pour utiliser le GPU 13](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-9.png)
...
14. Sous l’onglet **Vérifier + créer**, les options de déploiement que vous avez sélectionnées s’affichent. Vérifiez les options et sélectionnez **Créer**.
    ...
    ![Configurer le module pour utiliser le GPU 14](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-10.png)

15. Prenez note de l’**état du runtime** du module.
    
    ![Configurer le module pour utiliser le GPU 15](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-11.png)
    ...
    ![Configurer le module pour utiliser le GPU 16](media/azure-stack-edge-gpu-configure-gpu-modules/configure-gpu-12.png)
