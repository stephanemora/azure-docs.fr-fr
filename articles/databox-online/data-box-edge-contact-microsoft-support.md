---
title: Enregistrer un ticket de support pour Azure Data Box Edge, Azure Data Box Gateway | Microsoft Docs
description: Découvrez comment enregistrer une demande de support pour les problèmes liés à vos commandes Data Box Edge ou Data Box Gateway.
services: databox
author: alkohli
ms.service: databox
ms.subservice: ''
...
Cet article s’applique aux services Azure Data Box Edge et Azure Data Box Gateway, qui sont managés par le service Azure Data Box Edge/Azure Data Box Gateway. Si vous rencontrez des problèmes avec votre service, vous pouvez créer une demande de service pour obtenir un support technique. Cet article vous guide tout au long des procédures suivantes :
...
1. Accédez à votre commande Data Box Edge ou Data Box Gateway. Accédez à la section **Support + dépannage**, puis cliquez sur **Nouvelle demande de support**.
...
2. Dans **Nouvelle demande de support**, dans l'onglet **De base**, procédez comme suit :
    ...
    3. Sous **Service**, sélectionnez **Mes services**. Dans la liste déroulante, sélectionnez **Data Box Edge et Data Box Gateway**.
    ...
    8. Sélectionnez **Suivant : Solutions >>** .
        ...
        ![Concepts de base](./media/data-box-edge-contact-microsoft-support/data-box-edge-support-request-1.png)
...
Ces informations ne s'appliquent qu'à l’appareil Data Box Edge. Le processus de signalement des problèmes matériels est le suivant :

1. Ouvrez un ticket de support depuis le portail Azure pour signaler un problème matériel. Sous **Type de problème**, sélectionnez **Data Box Edge Hardware (Matériel Data Box Edge)** . Choisissez le **sous-type de problème** **Hardware failure (Défaillance matérielle)** . 

    ![Problème matériel](./media/data-box-edge-contact-microsoft-support/data-box-edge-hardware-issue-1.png)
...
1. Pour accéder à la page d’aide et de support, cliquez sur **Parcourir > Aide + support**.
    ...
    ![Gérer les demandes de support](./media/data-box-edge-contact-microsoft-support/data-box-edge-manage-support-request-1.png)   
...
Découvrez comment [résoudre les problèmes liés au service Data Box Edge](data-box-edge-troubleshoot.md).
