---
title: Retourner votre appareil Azure Stack Edge | Microsoft Docs
description: Décrit comment retourner l’appareil Azure Stack Edge.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
- Lorsque vous avez retourné l’appareil à Microsoft, il est soumis à une inspection physique dans le centre de données Azure, et l’équipe d’opérations Azure Stack Edge vous appelle pour confirmer que l’appareil a été retourné.
