...
Une seule instance de la ressource Data Box Gateway peut gérer plusieurs appareils virtuels Data Box Gateway. Pour créer une ressource Data Box Gateway, procédez comme suit. 
