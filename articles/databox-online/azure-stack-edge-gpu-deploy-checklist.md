---
title: Liste de contrôle préalable au déploiement d’un processeur GPU Azure Stack Edge | Microsoft Docs
description: Cet article décrit les informations qui peuvent être collectées avant de déployer un processeur GPU Azure Stack Edge.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "89268140"
---
# <a name="deployment-checklist-for-your-azure-stack-edge-gpu-device"></a>Liste de contrôle du déploiement d’un processeur GPU Azure Stack Edge  

Cet article décrit les informations qui peuvent être collectées avant le déploiement proprement dit d’un appareil Azure Stack Edge. 

Suivez la liste de contrôle ci-dessous pour vérifier que vous disposez de ces informations après avoir passé commande d’un appareil Azure Stack Edge et avant de le recevoir. 

## <a name="deployment-checklist"></a>Liste de vérification de déploiement 

| Étape                             | Paramètre                                                                                                                                                                                                                           | Détails                                                                                                           |
|-----------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| Gestion des appareils               | <li>Abonnement Microsoft Azure</li><li>API Graph Azure Active Directory</li><li>Compte Stockage Microsoft Azure</li>|<li>Activé pour Azure Stack Edge/Data Box Gateway, autorisations de contributeur</li><li>Accès administrateur ou utilisateur</li><li>Informations d’identification d’accès requises</li> |
...
| Activation                        | Exiger une clé d’activation de la ressource Azure Stack Edge/Data Box Gateway.                                                                                                                                                       | Une fois générée, la clé expire au bout de trois jours.                                                                        |


## <a name="next-steps"></a>Étapes suivantes

Préparez le déploiement de votre [appareil Azure Stack Edge](azure-stack-edge-gpu-deploy-prep.md).
