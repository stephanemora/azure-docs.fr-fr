...
1. Sur le portail Azure, accédez à votre ressource Azure Stack Edge, puis à **Utilisateurs**. Sélectionnez **+ Ajouter un utilisateur** dans la barre de commandes.
    ...
    ![Sélectionner Ajouter un utilisateur](media/azure-stack-edge-gpu-manage-users/add-user-1.png)
...
2. Indiquez le nom d’utilisateur et le mot de passe de l’utilisateur que vous souhaitez ajouter. Confirmez le mot de passe, puis sélectionnez **Ajouter**.
    ...
    ![Spécifier un nom d’utilisateur et un mot de passe](media/azure-stack-edge-gpu-manage-users/add-user-2.png)
...
![Modification d’une planification](media/azure-stack-edge-gpu-manage-users/modify-user-1.png)
...
1. Sur le portail Azure, accédez à votre ressource Azure Stack Edge, puis à **Utilisateurs**.
    ...
    ![Sélectionner un utilisateur à supprimer](media/azure-stack-edge-gpu-manage-users/delete-user-1.png)
...
2. Sélectionnez un utilisateur dans la liste des utilisateurs, puis choisissez **Supprimer**. Quand vous y êtes invité, confirmez la suppression.
    ...
    ![Sélectionner un utilisateur à supprimer 2](media/azure-stack-edge-gpu-manage-users/delete-user-2.png)

La liste des utilisateurs est actualisée afin de tenir compte de la suppression de l’utilisateur.

![Liste des utilisateurs mise à jour](media/azure-stack-edge-gpu-manage-users/delete-user-4.png)

## <a name="next-steps"></a>Étapes suivantes

- Découvrez comment [gérer la bande passante](azure-stack-edge-gpu-manage-bandwidth-schedules.md).
