---
title: Tutoriel relatif au déballage, au montage en rack et au raccordement de l'appareil physique Azure Stack Edge Pro FPGA | Microsoft Docs
description: Le deuxième tutoriel consacré à l'installation d'Azure Stack Edge Pro FPGA fournit des explications sur le déballage, le montage en rack et le raccordement de l'appareil physique.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "110461288"
---
# <a name="tutorial-install-azure-stack-edge-pro-fpga"></a>Tutoriel : Installer Azure Stack Edge Pro FPGA

Ce tutoriel explique comment installer un appareil physique Azure Stack Edge Pro FPGA. La procédure d’installation comprend le déballage, le montage en rack et le câblage de l’appareil. 
...
* Vous avez terminé toutes les étapes décrites dans [Préparer le déploiement d'Azure Stack Edge Pro FPGA](azure-stack-edge-deploy-prep.md).
...
### <a name="for-the-azure-stack-edge-pro-fpga-physical-device"></a>Pour l'appareil physique Azure Stack Edge Pro FPGA
...
- Passez en revue les conditions réseau requises pour déployer Azure Stack Edge Mini R, puis configurez le réseau du centre de données conformément à ces conditions. Pour plus d'informations, consultez [Conditions réseau requises pour Azure Stack Edge Pro FPGA](azure-stack-edge-system-requirements.md#networking-port-requirements).
...
3. Déballez le carton. Une fois le carton déballé, vous devez disposer des éléments suivants :
    - Un appareil Azure Stack Edge Pro FPGA dans son boîtier
    - 2 câbles d’alimentation
    - 1 assemblage du kit de rails
    - 1 livret relatif à la sécurité, l’environnement et les réglementations

Si vous n'avez pas reçu tous les éléments énumérés ici, contactez le support Azure Stack Edge Pro FPGA. L’étape suivante consiste à monter votre appareil en rack.
...
> [!IMPORTANT]
> Les appareils Azure Stack Edge Pro FPGA doivent être montés en rack pour fonctionner correctement.
...
Acheminez les câbles, puis branchez votre appareil. Les procédures suivantes expliquent comment raccorder votre appareil Azure Stack Edge Pro FPGA à la source d'alimentation et au réseau.

Avant de commencer à câbler votre appareil, vous avez besoin des éléments suivants :

- Votre appareil physique Azure Stack Edge Pro FPGA, déballé et monté en rack.
- 2 câbles d’alimentation.
...
> - L'appareil Azure Stack Edge Pro FPGA doit être connecté au réseau du centre de données pour pouvoir ingérer les informations provenant des serveurs des sources de données.

Sur votre appareil Azure Stack Edge Pro FPGA :
...
> [Connecter et configurer Azure Stack Edge Pro FPGA](./azure-stack-edge-deploy-connect-setup-activate.md)
