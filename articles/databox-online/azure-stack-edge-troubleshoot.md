---
title: Résoudre les problèmes liés au FPGA Azure Stack Edge Pro par le biais du portail Azure
description: Découvrez comment résoudre les problèmes liés à votre FPGA Azure Stack Edge Pro. Vous pouvez exécuter les diagnostics, collecter des informations pour le support et utiliser les journaux pour résoudre les problèmes.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "111986175"
---
# <a name="troubleshoot-your-azure-stack-edge-pro-fpga-issues"></a>Résoudre vos problèmes liés au FPGA Azure Stack Edge Pro

Cet article explique comment résoudre les problèmes liés à votre FPGA Azure Stack Edge Pro. 
...
> * Résoudre les erreurs d’IoT Edge
...
* Apprenez-en davantage sur les [problèmes connus de cette version](../databox-gateway/data-box-gateway-release-notes.md).