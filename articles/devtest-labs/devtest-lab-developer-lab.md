...
5. **Contrôle des coûts**
   ...
   | [Supprimer toutes les machines virtuelles de laboratoire à l’aide d’un script PowerShell](./devtest-lab-faq.yml) |Supprimez tous les laboratoires en une seule opération une fois le développement terminé.|
...
6. **Partager le laboratoire avec chaque développeur**
   ...
   | [Obtenir un lien vers le laboratoire](./devtest-lab-faq.yml) |Découvrez comment les développeurs peuvent accéder directement à un laboratoire via un lien hypertexte.|
