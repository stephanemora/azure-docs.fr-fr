...
| Script | Description |
|---|---|
|[Ajouter un utilisateur externe à un laboratoire](scripts/add-external-user-to-lab.md)| Ce script PowerShell ajoute un utilisateur externe à un lab dans Azure DevTest Labs. |
|[Ajouter des images marketplace à un laboratoire](scripts/add-marketplace-images-to-lab.md)| Ce script PowerShell ajoute des images de place de marché à un lab dans Azure DevTest Labs. |
