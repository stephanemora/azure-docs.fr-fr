...
titleSuffix: Azure
description: Découvrez comment Microsoft Genomics peut optimiser le séquençage du génome, offrant maintenant une implémentation cloud de BWA-GATK pour une analyse secondaire.
...
Microsoft Genomics propose un contrat de niveau de service (SLA) avec une disponibilité de 99,99 % pour la réception des requêtes de flux de travail. En savoir plus sur le [SLA](https://azure.microsoft.com/support/legal/sla/genomics/v1_0/) de Microsoft Genomics.
