...
* [Exemple partiellement automatisé (msrsync)](#use-the-msrsync-utility-to-populate-cloud-volumes) 
...
## <a name="use-the-msrsync-utility-to-populate-cloud-volumes"></a>Utiliser l’utilitaire msrsync pour remplir des volumes cloud
...
Notez que ``msrsync`` peut uniquement écrire vers et depuis des volumes locaux. La source et la destination doivent être accessibles en tant que montages locaux dans le réseau virtuel du cluster.

Pour utiliser msrsync pour remplir un volume cloud Azure avec un cluster Avere, suivez ces instructions :
