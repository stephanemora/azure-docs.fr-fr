...
Les commandes nsupdate suivantes sont un exemple de configuration correcte d’un DNS :
...
Pour plus d’informations sur l’utilisation de cette page, consultez [DNS Settings](<http://library.averesystems.com/ops_guide/4_7/gui_admin_network.html#gui-dns>) dans le guide de configuration du cluster Avere.
