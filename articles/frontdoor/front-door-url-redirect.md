---
title: Azure Front Door Service - Redirection d’URL | Microsoft Docs
description: Cet article vous aide à comprendre comment Azure Front Door Service prend en charge la redirection d’URL pour les itinéraires, si configurés.
services: front-door
documentationcenter: ''
author: sharad4u
...
- **HTTPS uniquement** : Définissez le protocole sur HTTPS uniquement si vous cherchez à rediriger le trafic HTTP vers HTTPS. Azure Front Door Service recommande de toujours définir la redirection vers HTTPS uniquement.
