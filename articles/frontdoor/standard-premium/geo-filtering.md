---
title: Filtrage géographique sur un domaine pour Azure Front Door Standard/Premium | Microsoft Docs
description: Dans cet article, vous en apprendrez plus sur la stratégie de filtrage géographique pour Azure Front Door Standard/Premium
services: frontdoor
documentationcenter: ''
author: duongau
editor: ''
...
ms.locfileid: "123441134"
---
# <a name="geo-filtering-on-a-domain-for-azure-front-door-standardpremium-preview"></a>Filtrage géographique sur un domaine pour Azure Front Door Standard/Premium (préversion)
...
Vous pouvez configurer une stratégie de filtrage géographique pour votre Front Door à l’aide du [portail Azure](../../web-application-firewall/afds/waf-front-door-create-portal.md) ou d’un [modèle de démarrage rapide](https://github.com/Azure/azure-quickstart-templates/tree/master/quickstarts/microsoft.network/front-door-standard-premium-geo-filtering).
...
- Apprenez à [configurer une stratégie WAF de géofiltrage](../../web-application-firewall/afds/waf-front-door-create-portal.md).
