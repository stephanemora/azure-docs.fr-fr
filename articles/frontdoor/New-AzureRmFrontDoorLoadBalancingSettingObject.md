...
ms.locfileid: "47046468"
---
# New-AzureRmFrontDoorLoadBalancingSettingObject
Créer un objet PSLoadBalancingSetting pour la création d’une porte d’entrée
...
Latence supplémentaire, en millisecondes, pour que les sondes soient incluses dans l’intervalle de latence le plus faible. La valeur par défaut est 0
...
Nombre d’échantillons qui doivent réussir dans la période d’échantillonnage. La valeur par défaut est 2
