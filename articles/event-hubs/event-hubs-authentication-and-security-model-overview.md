---
title: Modèle de sécurité et d’authentification - Azure Event Hubs | Microsoft Docs
description: Cet article décrit le modèle de sécurité et d’authentification Azure Event Hubs.
services: event-hubs
