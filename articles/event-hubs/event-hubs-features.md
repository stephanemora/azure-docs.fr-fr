...
Les partitions vous permet une mise à l’échelle votre traitement en aval. En raison du modèle de consommateur partitionné qui offre des concentrateurs d’événements avec des partitions, vous pouvez faire évoluer lors du traitement de vos événements simultanément. Un concentrateur d’événements peut avoir jusqu'à 32 partitions.
