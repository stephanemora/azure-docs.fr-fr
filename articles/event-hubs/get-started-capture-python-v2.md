...
> [!IMPORTANT]
> Ce guide de démarrage rapide utilise la version 5 du Kit de développement logiciel (SDK) Azure Event Hubs Python. Pour un guide de démarrage rapide qui utilise la version 1 du SDK Python, consultez [cet article](event-hubs-capture-python.md). 
