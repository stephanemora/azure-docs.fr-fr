...
ms.locfileid: "83649921"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-event-hubs"></a>Définitions de stratégie intégrées d’Azure Policy pour Azure Event Hubs

Cette page est un index des définitions de stratégie intégrées d’[Azure Policy](../governance/policy/overview.md) pour Azure Event Hubs. Pour obtenir des éléments intégrés supplémentaires d’Azure Policy pour d’autres services, consultez [Définitions intégrées d’Azure Policy](../governance/policy/samples/built-in-policies.md).
