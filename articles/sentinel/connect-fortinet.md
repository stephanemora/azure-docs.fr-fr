---
title: Collecter des données Fortinet Sentinel version préliminaire d’Azure | Microsoft Docs
description: Découvrez comment collecter des données de Fortinet dans Azure Sentinel.
services: sentinel
