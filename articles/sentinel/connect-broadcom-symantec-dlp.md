...
1. Suivez les instructions de l’onglet **Instructions**, sous **Configuration** :
    ...
    1. Sous **3. Valider la connexion**  : Vérifiez l’ingestion des données en copiant la commande sur la page du connecteur et en l’exécutant sur votre redirecteur de journal. Consultez [Valider la connectivité CEF](troubleshooting-cef-syslog.md#validate-cef-connectivity) dans la documentation Azure Sentinel pour obtenir des instructions et des explications plus détaillées.
