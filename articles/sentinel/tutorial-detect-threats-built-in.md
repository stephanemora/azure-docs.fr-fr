...
## <a name="use-built-in-analytics-rules"></a>Utiliser des règles d’analyse intégrées

Cette procédure décrit comment utiliser les modèles de règles d’analyse intégrés.

**Pour utiliser des règles d’analyse intégrées** :

1. Dans Azure Sentinel > page **Analyse** > **Modèles de règles**, sélectionnez le nom du modèle, puis sélectionnez le bouton **Créer une règle** dans le volet d’informations pour créer une nouvelle règle active basée sur ce modèle. 
