...
1. Activez **Journaux de diagnostic** sur tous les pare-feu dont vous souhaitez connecter les journaux :
    ...
    1. Activez les cases à cocher des types de règles dont vous souhaitez ingérer les journaux. Nous vous recommandons d’utiliser **AzureFirewallApplicationRule**, **AzureFirewallNetworkRule** et **AzureFirewallDNSProxy**.
