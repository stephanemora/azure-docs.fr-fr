...
description: Apprenez à visualiser vos données avec des workbooks dans Azure Sentinel.
services: sentinel
...
Cet article explique comment visualiser vos données dans Azure Sentinel.
...
Dans cet article, vous avez appris à visualiser vos données dans Azure Sentinel à l’aide de Workbooks Azure.
...
Pour découvrir les workbooks intégrés populaires, consultez [Workbooks Azure Sentinel courants](top-workbooks.md). 
