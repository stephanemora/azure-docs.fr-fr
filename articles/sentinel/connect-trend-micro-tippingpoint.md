...
Pour interroger les données de Trend Micro TippingPoint dans Log Analytics, copiez le code suivant dans la fenêtre de requête, en appliquant d’autres filtres au choix :
