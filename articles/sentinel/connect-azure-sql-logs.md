---
title: Connecter tous les journaux de diagnostics et d’audit de la Base de données Azure SQL à Azure Sentinel
description: Découvrez comment utiliser Azure Policy pour appliquer la connexion des journaux de diagnostic et d’audit de sécurité de la Base de données Azure SQL à Azure Sentinel.
author: yelevin
manager: rkarlin
...
ms.locfileid: "122531765"
---
# <a name="connect-azure-sql-database-diagnostics-and-auditing-logs"></a>Connecter les journaux de diagnostics et d’audit de la Base de données Azure SQL
...
Le connecteur de la Base de données Azure SQL vous permet de diffuser les journaux d’audit et de diagnostics de vos bases de données dans Azure Sentinel, de façon à pouvoir surveiller en continu l’activité dans toutes vos instances.
