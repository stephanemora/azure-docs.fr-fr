---
title: Connectez les données de Palo Alto Networks vers Azure Sentinel Preview | Microsoft Docs
description: Découvrez comment connecter les données de Palo Alto Networks à Azure Sentinel.
services: sentinel
