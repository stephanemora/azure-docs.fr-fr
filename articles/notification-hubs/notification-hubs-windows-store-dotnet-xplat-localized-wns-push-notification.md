...
ms.locfileid: "54451321"
---
# <a name="tutorial-push-localized-notifications-to-windows-apps-by-using-azure-notification-hubs"></a>Tutoriel : Envoyer des notifications localisées vers des applications Windows avec Azure Notification Hubs
...
2. Mettez à jour le fichier `MainPage.xaml` de la solution pour y ajouter une zone de liste modifiable de paramètres régionaux :
    ...
    ```
3. Dans la classe `Notifications`, ajoutez un paramètre régional aux méthodes `StoreCategoriesAndSubscribe` et `SubscribeToCateories`.
