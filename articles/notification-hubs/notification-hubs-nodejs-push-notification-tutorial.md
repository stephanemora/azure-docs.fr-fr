...
Pour la liste des options **TargetName**, **NotificationClass** et d’en-tête valides, consultez [Notifications Push](https://msdn.microsoft.com/library/hh221551.aspx).
