...
Sur le serveur principal, effectuez simplement un appel unique, CreateOrUpdateInstallation. Ce dernier étant totalement idempotent, n’hésitez pas à réessayer si nécessaire.
