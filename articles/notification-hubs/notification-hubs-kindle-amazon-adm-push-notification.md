...
* Obtenez le kit Android SDK (en supposant que vous utilisez Eclipse) depuis le [portail des développeurs Android](https://go.microsoft.com/fwlink/?LinkId=389797).
...
2. Ajoutez les autorisations comme le premier élément sous l'élément du manifeste. Remplacez **[VOTRE NOM DE PACKAGE]** par le package utilisé pour créer votre application.
    ...
    ```
3. Insérez l'élément suivant comme le premier enfant de l'élément de l'application. N’oubliez pas de remplacer **[YOUR SERVICE NAME]** par le nom de votre gestionnaire de messages ADM que vous créez dans la section suivante (y compris le package), puis remplacez **[YOUR PACKAGE NAME]** par le nom de package avec lequel vous avez créé votre application.
