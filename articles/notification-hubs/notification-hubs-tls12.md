...
Pour plus d'informations, consultez la vue d'ensemble de la [prise en charge des protocoles TLS sous Windows](https://docs.microsoft.com/archive/blogs/kaushal/support-for-ssltls-protocols-on-windows).
