---
title: 'Tutoriel : Configurer les ressources IoT nécessaires pour IoT Plug-and-Play | Microsoft Docs'
description: 'Tutoriel : Créer un hub IoT et une instance de service de provisionnement des appareils à utiliser avec les tutoriels et les démarrages rapides IoT Plug-and-Play.'
author: dominicbetts
ms.author: dobett
ms.date: 08/11/2020
ms.topic: quickstart
...
ms.locfileid: "114406509"
---
# <a name="tutorial-set-up-your-environment-for-the-iot-plug-and-play-quickstarts-and-tutorials"></a>Tutoriel : Configurer votre environnement pour les tutoriels et les démarrages rapides IoT Plug-and-Play
...
Pour plus d’informations, consultez [Installer et utiliser l’explorateur Azure IoT](../iot-fundamentals/howto-use-iot-explorer.md).
...
> [Connecter un exemple d’application pour appareil IoT Plug-and-Play à IoT Hub](tutorial-connect-device.md)
