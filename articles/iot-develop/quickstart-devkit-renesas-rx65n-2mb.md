---
title: 'Démarrage rapide : Connecter un RX65N-2MB Renesas à Azure IoT Central'
description: Utilisez le logiciel intégré Azure RTOS pour connecter un appareil RX65N-2MB Renesas à Azure IoT et envoyer de la télémétrie.
author: timlt
ms.author: timlt
...
[![Parcourir le code](media/common/browse-code.svg)](https://github.com/azure-rtos/getting-started/tree/master/Renesas/RSK_RX65N_2MB)

Dans le cadre de ce démarrage rapide, vous utilisez Azure RTOS pour connecter le starter kit+ Renesas pour RX65N-2MB (ci-après, le RX65N Renesas) à Azure IoT.
...
* Matériel
    ...
    * Le [starter kit+ Renesas pour RX65N-2MB](https://www.renesas.com/products/microcontrollers-microprocessors/rx-32-bit-performance-efficiency-mcus/rx65n-2mb-starter-kit-plus-renesas-starter-kit-rx65n-2mb) (RX65N Renesas)
    * L’[émulateur E2 Lite de Renesas](https://www.renesas.com/software-tool/e2-emulator-lite-rte0t0002lkce00000r)
    * 2 câbles USB 2.0 A mâle à mini-USB mâle
    * Le bloc d’alimentation de 5 V fourni
    * Câble Ethernet
...
> [!NOTE]
> Pour plus d’informations sur la configuration et la prise en main du RX65N Renesas, consultez [Démarrage rapide du starter kit+ de Renesas pour RX65N-2MB](https://www.renesas.com/document/man/e2studio-renesas-starter-kit-rx65n-2mb-quick-start-guide).

1. Suivez les étapes suivantes en vous référant à l’image ci-dessous.
    
    :::image type="content" source="media/quickstart-devkit-renesas-rx65n-2mb/renesas-rx65n.jpg" alt-text="Localisez Reset, Power, Ethernet, USB et E1/E2Lite sur la carte RX65N Renesas":::

1. À l’aide du bloc d’alimentation de 5 V, connectez l’**entrée d’alimentation** du RX65N Renesas à une prise électrique.

1. À l’aide du câble Ethernet, connectez l’**Ethernet** du RX65N Renesas à votre routeur.

1. À l’aide du premier câble mini-USB, connectez le port **USB série** du RX65N Renesas à votre ordinateur.

1. À l’aide du second câble mini-USB, connectez le **port série USB E2 Lite** de l’émulateur E2 Lite de Renesas à votre ordinateur.

1. À l’aide du câble plat fourni, connectez l’**E1/E2Lite** du RX65N Renesas à l’émulateur E2 Lite de Renesas.
...
2. Dans le menu *Fichier*, sélectionnez *Nouveau projet...* , puis entrez les paramètres suivants :
    ...
    * **Outil** : E2 Emulator Lite
    ...
    :::image type="content" source="media/quickstart-devkit-renesas-rx65n-2mb/rfp-new.png" alt-text="Capture d’écran de l’application Renesas Flash Programmer, Nouveau projet":::
...
4. Sélectionnez *Réinitialiser le code confidentiel en tant que Hi-Z*, puis appuyez sur le bouton *OK*.
    ...
    :::image type="content" source="media/quickstart-devkit-renesas-rx65n-2mb/rfp-reset.png" alt-text="Capture d’écran de l’application Renesas Flash Programmer, Réinitialiser les paramètres":::

5. Appuyez sur le bouton *Se connecter*, puis, quand vous y êtes invité, cochez la case *Authentification automatique* et appuyez sur *OK*.

    :::image type="content" source="media/quickstart-devkit-renesas-rx65n-2mb/rfp-auth.png" alt-text="Capture d’écran de l’application Renesas Flash Programmer, Authentification":::
...
1. Vérifiez que le **modèle d’appareil** est mis à jour en **Guide de prise en main**.
    ...
    :::image type="content" source="media/quickstart-devkit-renesas-rx65n-2mb/iot-central-device-view-status.png" alt-text="Capture d’écran de l’état de l’appareil dans IoT Central":::
...
1. Affichez la télémétrie lorsque l’appareil envoie des messages au cloud sous l’onglet **Vue d’ensemble**.
    ...
    :::image type="content" source="media/quickstart-devkit-renesas-rx65n-2mb/iot-central-device-telemetry.png" alt-text="Capture d’écran de la télémétrie de l’appareil dans IoT Central":::
...
1. Dans la liste déroulante **État**, sélectionnez **Vrai**, puis **Exécuter**.  Le voyant doit s’allumer.
    ...
    :::image type="content" source="media/quickstart-devkit-renesas-rx65n-2mb/iot-central-invoke-method.png" alt-text="Capture d’écran de l’appel d’une méthode directe sur un appareil dans IoT Central":::
...
:::image type="content" source="media/quickstart-devkit-renesas-rx65n-2mb/iot-central-device-about.png" alt-text="Capture d’écran des informations sur l’appareil dans IoT Central":::
