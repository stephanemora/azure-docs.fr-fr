...
Pour savoir comment étendre le pont IoT Plug-and-Play afin de prendre en charge des protocoles d’appareils supplémentaires, consultez [Étendre le pont IoT Plug-and-Play](https://github.com/Azure/iot-plug-and-play-bridge/blob/master/pnpbridge/docs/author_adapter.md). Pour savoir comment créer et déployer le pont IoT Plug-and-Play, consultez [Créer et déployer le pont IoT Plug-and-Play](https://github.com/Azure/iot-plug-and-play-bridge/blob/master/pnpbridge/docs/build_deploy.md).
...
- [Exemple de connexion d’un pont IoT Plug-and-Play s’exécutant sur Linux ou Windows à IoT Hub](https://github.com/Azure/iot-plug-and-play-bridge/blob/master/pnpbridge/docs/quick_start.md)
- [Créer et déployer un pont IoT Plug-and-Play](https://github.com/Azure/iot-plug-and-play-bridge/blob/master/pnpbridge/docs/build_deploy.md)
- [Étendre un pont IoT Plug-and-Play](https://github.com/Azure/iot-plug-and-play-bridge/blob/master/pnpbridge/docs/author_adapter.md)
