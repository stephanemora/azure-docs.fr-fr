...
Ici, « contoso.com » est le nom de domaine DNS de votre domaine managé. « contoso-centos » est le nom d’hôte de la machine virtuelle CentOS que vous joignez au domaine managé.
...
2. Initialisez Kerberos. Sur votre terminal SSH, saisissez la commande suivante :
    ...
    > [!TIP]
    > * Spécifiez un utilisateur appartenant au groupe « AAD DC Administrators ». Si nécessaire, [ajoutez un compte utilisateur à un groupe dans Azure AD](../active-directory/fundamentals/active-directory-groups-members-azure-portal.md)
