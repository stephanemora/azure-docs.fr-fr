...
1. Dans le volet gauche, choisissez votre domaine managé Azure AD DS, comme *contoso.com*. Une liste d’unités d’organisation et de ressources existantes s’affiche.
