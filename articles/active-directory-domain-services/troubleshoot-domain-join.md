...
* Si vous recevez une erreur lors de l’authentification, la connexion au domaine managé Azure AD DS est établie.
...
Si la machine virtuelle ne peut pas trouver le domaine managé Azure AD DS, il s’agit généralement d’un problème de configuration ou de connexion réseau. Passez en revue les étapes suivantes de résolution des problèmes pour localiser et résoudre le problème :
...
1. Vérifiez l’état d’intégrité de votre domaine managé Azure AD DS dans le portail Azure. Si vous avez une alerte pour *AADDS001*, une règle de groupe de sécurité réseau bloque l’accès.
...
1. Essayez d’utiliser les informations d’identification d’un compte d’utilisateur faisant partie du domaine managé AD DS pour joindre des machines virtuelles au domaine managé.
