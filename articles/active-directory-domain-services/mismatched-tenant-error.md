...
* [Déplacez l’abonnement Azure](../billing/billing-subscription-transfer.md) contenant le réseau virtuel vers le même annuaire Azure AD que le domaine managé Azure AD DS.
