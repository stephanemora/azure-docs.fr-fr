...
Pour les problèmes IoT Plug-and-Play liés au référentiel de modèles, reportez-vous à [notre guide de documentation sur le référentiel de modèles d’appareil](https://docs.microsoft.com/azure/iot-pnp/concepts-model-repository).
