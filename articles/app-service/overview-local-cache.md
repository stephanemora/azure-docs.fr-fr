---
title: Présentation du cache local - Azure App Service | Microsoft Docs
...
* Le [streaming des journaux](troubleshoot-diagnostic-logs.md#streamlogs) est affecté par la copie de « meilleur effort ». Vous pouvez observer jusqu'à une minute de délai dans les journaux diffusés en continu.
