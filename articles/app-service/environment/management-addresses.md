...
Il existe un appel d’API qui permet d’obtenir la liste des adresses de gestion correspondant à votre ASE.  L’appel est :

    get /subscriptions/<subscription ID>/resourceGroups/<resource group>/providers/Microsoft.Web/hostingEnvironments/<ASE Name>/inboundnetworkdependenciesendpoints?api-version=2016-09-01

Cet appel retourne un document JSON qui comprend toutes les adresses de trafic entrant de l’ASE : adresses de gestion, adresse IP virtuelle utilisée par l’ASE et sous-réseau ASE lui-même.  

Pour appeler l’API avec [armclient](http://github.com/projectkudu/ARMClient), utilisez les commandes suivantes en indiquant votre ID d’abonnement, votre groupe de ressources et le nom de l’ASE.  
