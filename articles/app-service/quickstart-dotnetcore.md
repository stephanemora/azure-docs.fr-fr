...
:::image type="content" source="./media/quickstart-dotnetcore/portal-app-service-list.png" alt-text="Capture d’écran de la page App Services avec un exemple d’application web sélectionnée.":::
