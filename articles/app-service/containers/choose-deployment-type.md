---
title: 'Déploiement d’Azure App Service sur Linux : image personnalisée, groupe de plusieurs conteneurs ou image de plateforme intégrée ?  | Microsoft Docs'
...
- **Architecture multiniveau** : déployez plusieurs conteneurs, comme une couche d’application web et une couche API, pour séparer les fonctionnalités à l’aide d’un groupe de plusieurs conteneurs. 
