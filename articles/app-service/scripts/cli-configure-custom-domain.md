...
| [`az webapp config hostname add`](/cli/azure/webapp/config/hostname#az_webapp_config_hostnam_eadd) | Mappe un domaine personnalisé à une application App Service. |
