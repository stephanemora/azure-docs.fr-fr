---
title: Exemple de script Azure CLI - Mapper un domaine personnalisé à une application | Microsoft Docs
description: Exemple de script Azure CLI - Mapper un domaine personnalisé à une application
