...
Cet exemple de script crée un groupe de ressources, un plan App Service et une application web. Le plan App Service est ensuite mis à l’échelle pour passer d’une instance unique à plusieurs instances.
