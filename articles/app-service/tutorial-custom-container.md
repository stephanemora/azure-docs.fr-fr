...
1. Récupérez votre ID d’abonnement avec la commande [`az account show`](/cli/azure/account#az_account_show). Vous en aurez besoin à la prochaine étape :
