---
title: Déployer le code avec un fichier ZIP ou WAR - Azure App Service | Microsoft Docs
...
* [Kudu : Déploiement à partir d’un fichier zip](https://github.com/projectkudu/kudu/wiki/Deploying-from-a-zip-file)
