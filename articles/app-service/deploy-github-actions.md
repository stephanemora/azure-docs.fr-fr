---
title: Déployer votre code à partir d’un pipeline CI/CD avec des actions GitHub - Azure App Service | Microsoft Docs
description: Découvrez comment utiliser GitHub Actions pour déployer votre code sur App Service
