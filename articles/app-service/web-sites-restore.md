...
- [Azure Database pour MySQL](https://azure.microsoft.com/en-us/services/mysql)
- [Base de données Azure pour PostgreSQL](https://azure.microsoft.com/en-us/services/postgres)
