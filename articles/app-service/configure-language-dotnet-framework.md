...
Vous pouvez ajouter des messages de diagnostic dans votre code d’application à l’aide de [System.Diagnostics.Trace](https://docs.microsoft.com/dotnet/api/system.diagnostics.trace). Par exemple : 
