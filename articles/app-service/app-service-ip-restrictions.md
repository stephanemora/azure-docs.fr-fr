...
La fonctionnalité Restrictions d’adresse IP est implémentée dans les rôles frontend App Service, qui sont en amont des hôtes de travail où votre code s’exécute. C’est pourquoi les restrictions d’adresse IP sont comparables à des listes de contrôle d’accès (ACL) réseau.  
