...
![Configurer le nom de l’application](./media/app-service-web-get-started-dotnet-framework/web-app-name.png)
...
Sur la page de publication, sélectionnez **Publier**.
![Page Résumé de la publication Visual Studio](./media/app-service-web-get-started-dotnet-framework/publish-summary-page.png)
...
![Navigation au sein du portail pour accéder à l’application Azure](./media/app-service-web-get-started-dotnet-framework/access-portal.png)
