---
title: Comparer App Service, Virtual Machines, Service Fabric et Microsoft Azure Cloud Services - Azure | Microsoft Docs
...
Azure offre plusieurs méthodes d’hébergement des sites web : [Azure App Service][Azure App Service], [Virtual Machines][Virtual Machines], [Service Fabric][Service Fabric] et [Microsoft Azure Cloud Services][Cloud Services]. Cet article vous aidera à comprendre ces différentes possibilités et à faire le bon choix en fonction de votre application web.
...
Si vous exécutez une application multiniveau, par exemple un serveur web qui se connecte à une base de données, Azure App Service est une bonne option, qui permet une intégration à Azure SQL Database. Et vous pouvez utiliser la fonctionnalité WebJobs pour exécuter des processus principaux.
