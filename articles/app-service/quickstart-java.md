...
Ouvrez `pom.xml` pour voir la configuration mise à jour.
...
> [!div class="nextstepaction"]
> [J’ai rencontré un problème](https://www.research.net/r/javae2e?quickstart-java&step=deploy)
