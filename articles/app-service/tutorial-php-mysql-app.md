...
:::image type="content" source="./media/tutorial-php-mysql-app/php-mysql-in-azure.png" alt-text="Capture d’écran d’un exemple d’application PHP intitulé Task List (Liste des tâches).":::
