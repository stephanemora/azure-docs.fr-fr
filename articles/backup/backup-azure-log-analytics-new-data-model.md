...
| OperationName                     | Texte          | Ce champ représente le nom de l’opération en cours - BackupItem, BackupItemAssociation ou ProtectedContainer. |
...
| OperationName                  | Texte          | Nom de l’opération en cours. Par exemple, Alerte            |
...
| ------------------------------ | ------------- | ------------------------------------------------------------ |
| ResourceId                     | Texte          | Identificateur unique de la ressource sur laquelle les données sont collectées. Par exemple, un ID de ressource de coffre Recovery Services |
| OperationName                  | Texte          | Nom de l’opération, par exemple ProtectedInstance         |
...
| ------------------------------- | -------------- | ------------------------------------------------------------ |
| ResourceId                      | Texte           | Identificateur unique de la ressource sur laquelle les données sont collectées. Par exemple, un ID de ressource de coffre Recovery Services |
| OperationName                   | Texte           | Nom de l’opération, par exemple, Policy ou PolicyAssociation |
...
| ------------------------------ | ------------- | ------------------------------------------------------------ |
| ResourceId                     | Texte          | Identificateur de ressource des données collectées. Par exemple, ID de ressource du coffre Recovery Services |
| OperationName                  | Texte          | Ce champ représente le nom de l’opération en cours - Storage ou StorageAssociation |
...
- [Découvrez comment envoyer des données de diagnostic à Log Analytics](https://aka.ms/AA6il6r)