---
title: Sauvegarder plusieurs machines virtuelles Azure avec PowerShell
...
3. Exécutez une sauvegarde ad hoc avec [Backup-AzRecoveryServicesBackupItem](/powershell/module/az.recoveryservices/backup-Azrecoveryservicesbackupitem). 
