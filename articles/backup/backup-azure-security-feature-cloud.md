...
La suppression réversible est actuellement prise en charge dans la région USA Centre-Ouest et Asie Est.
...
Pour plus d’informations, consultez [Fonctionnalité de chiffrement du service Stockage Azure pour les données au repos](https://docs.microsoft.com/en-in/azure/storage/common/storage-service-encryption).
...
Pour plus d’informations, consultez [Utiliser le contrôle d’accès en fonction du rôle pour gérer les points de récupération de Sauvegarde Azure](https://docs.microsoft.com/en-us/azure/backup/backup-rbac-rs-vault).
...
#### <a name="how-can-i-delete-the-data-earlier-than-the-14-days-soft-delete-period-after-deletion"></a>Comment puis-je supprimer les données antérieures à la période de suppression réversible de 14 jours après la suppression ?

Il n’existe aucun moyen de vider les données avant les 14 jours qui suivent la suppression. Si vous êtes confronté à un problème bloquant ou de conformité, contactez le support technique de Microsoft.
