...
* [Ajout d’une adresse IP interne statique à une machine virtuelle existante](/previous-versions/azure/virtual-network/virtual-networks-reserved-private-ip.md#how-to-add-a-static-internal-ip-to-an-existing-vm)
