---
title: Mise à niveau vers le modèle de déploiement Azure Resource Manager pour la pile de sauvegarde de machine virtuelle Azure | Microsoft Docs
