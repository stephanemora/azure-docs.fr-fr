...
Pour plus d’informations sur les différents états de la tâche d’importation Azure, consultez [Voir l’état des tâches Azure Import/Export](../import-export/storage-import-export-view-drive-status.md).
