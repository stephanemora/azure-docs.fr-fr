...
La tâche de sauvegarde de machine virtuelle est identifiée par le champ « jobId » et peut être suivie comme indiqué [ici](/rest/api/backup/job-details) en utilisant une simple requête *GET*.
