...
Pour intégrer la fonctionnalité à la préversion, veuillez lire la [section Avant de commencer](https://docs.microsoft.com/azure/backup/backup-create-rs-vault#set-cross-region-restore).
