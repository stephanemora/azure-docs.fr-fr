...
> [!NOTE]
> Pour obtenir une liste des étiquettes de service de stockage et des régions, consultez [Balises de service pour le stockage](../virtual-network/security-overview.md#service-tags).
