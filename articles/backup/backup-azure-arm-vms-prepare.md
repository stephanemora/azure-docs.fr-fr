...
2. Dans **Restauration instantanée**, spécifiez la durée pendant laquelle vous souhaitez conserver les instantanés localement en vue d’une restauration instantanée.
...
3. Dans **Durée de rétention**, spécifiez la durée pendant laquelle vous souhaitez conserver vos points de sauvegarde quotidiens ou hebdomadaires.
4. Dans **Rétention du point de sauvegarde mensuel**, spécifiez si vous souhaitez conserver une sauvegarde mensuelle de vos sauvegardes quotidiennes ou hebdomadaires.
