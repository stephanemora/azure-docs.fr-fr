...
| Serveurs (64 bits)          | Windows Server 2019, 2016, 2012 R2, 2012                    | Machine virtuelle Azure (quand la charge de travail s’exécute en tant que machine virtuelle Azure)  <br><br>    Serveur physique  <br><br>    Machine virtuelle Hyper-V <br><br>     Machine virtuelle VMware  <br><br>    Azure Stack | V3 UR1                            | Volume, partage, dossier, fichier, volumes dédupliqués (NTFS et ReFS)  <br><br>   État système et sauvegarde complète (non pris en charge quand la charge de travail s’exécute en tant que machine virtuelle Azure) |
| Serveurs (64 bits)          | Windows Server 2008 R2 SP1, Windows Server 2008 SP2 (vous devez installer [Windows Management Frame 4.0](https://www.microsoft.com/download/details.aspx?id=40855)) | Serveur physique  <br><br>    Machine virtuelle Hyper-V  <br><br>      Machine virtuelle VMware  <br><br>   Azure Stack | V3 UR1                            | Volume, partage, dossier, fichier, état système/sauvegarde complète        |
