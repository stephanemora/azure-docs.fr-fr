---
title: Sauvegarder des serveurs VMware avec le serveur de sauvegarde Azure
...
|Privilèges de vCenter 6.0 et 6.5| Privilèges de vCenter 5.5|
|----------------------------------|---------------------------|
