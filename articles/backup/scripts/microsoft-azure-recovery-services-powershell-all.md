---
title: 'Exemple de script : Configuration de Sauvegarde Azure pour un serveur Windows local'
description: Apprenez à utiliser un script afin de configurer Sauvegarde Azure pour un serveur Windows local.
ms.topic: sample
ms.date: 06/23/2021
...
ms.locfileid: "112560801"
---
# <a name="powershell-script-to-configure-backup-for-on-premises-windows-server"></a>Script PowerShell visant à configurer Sauvegarde Azure pour un serveur Windows local

Ce script vous aide à configurer Sauvegarde Azure pour votre serveur Windows local, de la création d’un coffre à la configuration de la stratégie et de l’agent MARS.
