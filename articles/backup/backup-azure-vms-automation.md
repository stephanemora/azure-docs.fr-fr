...
4. Attachez le disque du système d’exploitation et les disques de données. Reportez-vous à la section correspondant à la configuration de vos machines virtuelles pour afficher les applets de commande respectives associées :
 ...
 Lors de la définition du disque du système d’exploitation, vérifiez que le type de système d’exploitation approprié est mentionné.   
    ```
...
Le chiffrement des disques de données doit être activé manuellement à l’aide de la commande suivante.
