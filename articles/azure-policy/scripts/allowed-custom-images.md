...
description: Cette stratégie exige que seules des images personnalisées approuvées soient déployées dans votre environnement.
...
Dans cet exemple de paramètre, seule la valeur _ContosoStdImage_ du groupe de ressources _YourResourceGroup_ ou la version d’image de mai 2018 de Windows Server 2016 Datacenter située dans le « Centre des États-Unis » est autorisée.
...
- Consulter d’autres [exemples Azure Policy](../json-samples.md)
- Consulter [Structure de définition Azure Policy](../policy-definition.md)
- Consulter des exemples Azure Policy pour des machines virtuelles dans [Appliquer des stratégies aux machines virtuelles Windows](../../virtual-machines/windows/policy.md)