---
title: Exemple JSON Azure Policy - Auditer le chiffrement transparent des données de SQL Database | Microsoft Docs
description: Cet exemple de stratégie JSON vérifie si la base de données SQL n’a pas de chiffrement transparent des données activé.
