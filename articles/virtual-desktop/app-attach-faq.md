...
## <a name="how-many-misx-applications-can-i-add-to-each-session-host"></a>Combien d’applications MISX puis-je ajouter à chaque hôte de session ?
...
## <a name="how-many-vhd-or-vhdx-files-can-i-mount-on-a-host-pool"></a>Combien de fichiers .VHD ou .VHDX puis-je monter sur un pool d’hôtes ?

L’attachement d’application MSIX n’a pas de limite quant au nombre de fichiers que vous pouvez monter. Toutefois, le pool d’hôtes lui-même peut être limité par les facteurs suivants :
