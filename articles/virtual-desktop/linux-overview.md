...
Vous pouvez demander l’accès au Kit de développement logiciel (SDK) Linux sur notre [forum Tech Community](https://go.microsoft.com/fwlink/?linkid=2116541).
