...
## <a name="can-i-upgrade-a-windows-10-vm-to-windows-10-enterprise-multi-session"></a>Puis-je mettre à niveau une machine virtuelle Windows 10 vers Windows 10 Entreprise multisession ?

Non. Il n’est actuellement pas possible de mettre à niveau une machine virtuelle existante qui exécute Windows 10 Professionnel ou Entreprise vers Windows 10 Entreprise multisession. De même, si vous déployez une machine virtuelle Windows 10 Entreprise multisession et que vous mettez à jour la clé de produit vers une autre édition, vous ne pourrez pas rebasculer la machine virtuelle vers Windows 10 Entreprise multisession et devrez redéployer la machine virtuelle.
