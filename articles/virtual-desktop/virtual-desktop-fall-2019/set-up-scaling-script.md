...
Les rapports de problèmes pour l’outil de mise à l’échelle sont actuellement traités sur GitHub plutôt que par le Support Microsoft. Si vous rencontrez des problèmes avec l’outil de mise à l’échelle, vous pouvez les signaler en ouvrant un problème GitHub intitulé « 4a-WVD-Scaling-logicapps » sur la [page GitHub RDS](https://github.com/Azure/RDS-Templates/issues?q=is%3Aissue+is%3Aopen+label%3A4a-WVD-scaling-logicapps).
