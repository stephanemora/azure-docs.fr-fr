...
La fonctionnalité de protection contre la capture d’écran est configurée au niveau de l’hôte de session et appliquée sur le client. Seuls les clients qui prennent en charge cette fonctionnalité peuvent se connecter à la session à distance.
Les clients suivants prennent actuellement en charge la protection contre la capture d’écran :

* Le client Windows Desktop prend en charge la protection contre la capture d’écran uniquement sur les ordinateurs de bureau complets.
* Le client macOS version 10.7.0 ou antérieures prend en charge la protection contre la capture d’écran à la fois pour les bureaux RemoteApp et les bureaux complets.

Imaginons que l’utilisateur tente d’utiliser un client non pris en charge pour se connecter à l’hôte de session protégée. Dans ce cas, la connexion échoue avec l’erreur 0x1151.
