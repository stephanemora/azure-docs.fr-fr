...
Créez un **groupe de ressources** et un cluster AKS, puis utilisez votre clé pour chiffrer le disque de système d’exploitation. Les clés gérées par le client sont prises en charge uniquement dans les versions de Kubernetes ultérieures à la version 1.17. 
