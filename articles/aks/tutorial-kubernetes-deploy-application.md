...
Dans les tutoriels ultérieurs, cette application fait l’objet d’un scale-out et d’une mise à jour.
...
Remplacez *microsoft* par le nom de votre serveur de connexion ACR. Le nom de l’image figure à la ligne 60 du fichier manifeste. L’exemple ci-après indique le nom de l’image par défaut :
...
:::image type="content" source="./media/container-service-kubernetes-tutorials/azure-vote.png" alt-text="Capture d’écran montrant l’image conteneur Application de vote Azure en cours d’exécution dans un cluster AKS ouvert dans un navigateur web local" lightbox="./media/container-service-kubernetes-tutorials/azure-vote.png":::
