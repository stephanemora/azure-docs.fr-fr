...
> [!NOTE]
> Les clusters AKS (Azure Kubernetes Service) existants avec intégration d’Azure AD (Azure Active Directory) ne sont pas impactés par la nouvelle expérience d’Azure AD géré par AKS.
...
* Recherchez l’ID de locataire de votre compte Azure en accédant au portail Azure et en sélectionnant Azure Active Directory > Propriétés > ID de répertoire
...
Vous pouvez utiliser un groupe Azure AD existant ou en créer un. Vous avez besoin de l’ID objet de votre groupe Azure AD.
