...
* Aucune prise en charge des nœuds virtuels dans un cluster privé pour faire tourner des instances ACI (Application Centric Infrastructure) Cisco privées dans un réseau virtuel Azure privé.
