...
1. Dans la zone de filtre, entrez le nom du fournisseur d’attestation.
1. Sélectionnez le fournisseur d’attestation et accédez à la page Vue d’ensemble.
1. Sélectionnez **Certificats de signataire de stratégie** dans le menu de la ressource sur le côté gauche de la fenêtre ou dans le volet inférieur. Si vous êtes invité à sélectionner un certificat pour l’authentification, cliquez sur Annuler pour continuer.
...
1.  Dans la zone de filtre, entrez le nom du fournisseur d’attestation.
1.  Sélectionnez le fournisseur d’attestation et accédez à la page Vue d’ensemble.
1.  Sélectionnez **Stratégie** dans le menu de la ressource sur le côté gauche de la fenêtre ou dans le volet inférieur. Si vous êtes invité à sélectionner un certificat pour l’authentification, cliquez sur Annuler pour continuer.
