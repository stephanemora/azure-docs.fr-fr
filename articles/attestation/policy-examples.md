---
title: Exemples de stratégie Azure Attestation
description: Exemples de stratégie Azure Attestation.
...
## <a name="signed-policy-for-an-sgx-enclave-with-policyformatjwt"></a>Stratégie signée pour une enclave SGX avec PolicyFormat défini sur JWT
