...
ms.locfileid: "60000011"
---
# <a name="integrate-with-a-cicd-pipeline"></a>Intégrer avec un pipeline CI/CD

Vous pouvez améliorer la résilience de votre application contre la possibilité à distance de ne pas pouvoir accéder à Azure App Configuration. Pour ce faire, créez un package des données de configuration actuelles dans un fichier qui sera déployé avec l’application et chargé localement pendant son démarrage. Cette approche garantit que votre application contienne au moins les valeurs de paramètre par défaut. Ces valeurs sont remplacées par les modifications plus récentes dans un magasin de configuration d’application lorsqu’elles sont disponibles.
