...
| Commande | Notes |
|---|---|
| [az appconfig kv export](/cli/azure/appconfig/kv#az_appconfig_kv_export) | Exporte à partir d’une ressource de magasin App Configuration. |
