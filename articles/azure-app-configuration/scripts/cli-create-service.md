...
| [az appconfig create](/cli/azure/appconfig#az_appconfig_create) | Crée une ressource de magasin App Configuration. |
| [az appconfig credential list](/cli/azure/appconfig/credential#az_appconfig_credential_list) | Liste les clés d’accès d’un magasin App Configuration. |
