...
Pour suivre ce guide de démarrage rapide, installez [Java Development Kit (JDK)](https://docs.microsoft.com/java/azure/jdk) version 8 et [Apache Maven](https://maven.apache.org/) version 3.0 ou ultérieure.
