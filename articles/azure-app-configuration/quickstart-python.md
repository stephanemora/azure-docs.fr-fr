...
- Python 2.7 ou 3.6 ou version ultérieure : pour plus d’informations sur la configuration de Python sur Windows, consultez la [documentation de Python sur Windows](/windows/python/)
