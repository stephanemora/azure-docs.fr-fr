...
![Module OMSIngestionAPI](media/monitoring-runbook-datacollect/OMSIngestionAPI.png)
...
![Modifier un runbook](media/monitoring-runbook-datacollect/edit-runbook.png)
...
![Tester le runbook](media/monitoring-runbook-datacollect/test-runbook.png)
...
4. Vérifiez que la sortie n’affiche pas d’erreur dans la commande post pour Log Analytics.  Un message similaire à celui ci-dessous doit s’afficher.
    ...
    ![Sortie post](media/monitoring-runbook-datacollect/post-output.png)
...
![Sortie du journal](media/monitoring-runbook-datacollect/log-output.png)
...
![Publier le runbook](media/monitoring-runbook-datacollect/publish-runbook.png)
...
![Journalisation et suivi](media/monitoring-runbook-datacollect/logging.png)
...
![Planifier un runbook](media/monitoring-runbook-datacollect/schedule-runbook.png)
...
![Tâches](media/monitoring-runbook-datacollect/jobs.png)
...
5. Faites défiler vers le bas pour rechercher une entrée similaire à l’image ci-dessous.<br>![Détaillé](media/monitoring-runbook-datacollect/verbose.png)
...
- Intégrez votre runbook dans une [solution de gestion](monitoring-solutions-creating.md) à distribuer aux clients.
