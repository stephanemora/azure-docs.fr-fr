...
Cet article décrit les bonnes pratiques pour la [création d’un fichier de solution de gestion](monitoring-solutions-solution-file.md) dans Azure.  Ces informations seront mises à jour lorsque de meilleures pratiques supplémentaires seront identifiées.
...
- Configurez la solution pour qu’elle [contienne](monitoring-solutions-solution-file.md#solution-resource) la vue afin qu’elle soit supprimée si la solution est supprimée.
