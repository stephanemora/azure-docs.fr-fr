...
Pour plus d’informations sur l’activation d’Azure Monitor pour les conteneurs, consultez [Onboard Azure Monitor for containers](monitoring-container-insights-onboard.md) (Intégrer Azure Monitor pour les conteneurs).
...
![Exemple de tableau de bord multicluster dans Azure Monitor](./media/monitoring-container-insights-analyze/azmon-containers-multiview.png)
...
![Exemples de graphiques de performances sous l’onglet Cluster](./media/monitoring-container-insights-analyze/containers-cluster-perfview.png)
...
![Exemple du volet de propriétés des perspectives Kubernetes](./media/monitoring-container-insights-analyze/perspectives-preview-pane-01.png)
...
![Exemple utilisant le filtre pour affiner les résultats](./media/monitoring-container-insights-analyze/add-filter-option-01.png)
...
![Sélection de centile pour le filtrage des données](./media/monitoring-container-insights-analyze/containers-metric-percentile-filter.png)
...
![Exemple : cumul des conteneurs par nœud](./media/monitoring-container-insights-analyze/containers-nodes-containerstotal.png)
...
![Sélectionner l’affichage des contrôleurs](./media/monitoring-container-insights-analyze/containers-controllers-tab.png)
...
| Icône | Statut | 
|--------|-------------|
| ![Icône de statut en cours d’exécution prêt](./media/monitoring-container-insights-analyze/containers-ready-icon.png) | Running (Ready) (En cours d’exécution (Prêt))|
| ![Icône de statut en attente ou en pause](./media/monitoring-container-insights-analyze/containers-waiting-icon.png) | Waiting or Paused (En attente ou en pause)|
| ![Icône de statut de dernière exécution signalée](./media/monitoring-container-insights-analyze/containers-grey-icon.png) | Last reported running but hasn’t responded more than 30 minutes (Dernière exécution signalée, mais pas de réponse depuis plus de 30 minutes)|
| ![Icône d’état de réussite](./media/monitoring-container-insights-analyze/containers-green-icon.png) | Successfully stopped or failed to stop (Réussite ou échec de l’arrêt)|
...
![Sélectionner l’affichage des conteneurs](./media/monitoring-container-insights-analyze/containers-containers-tab.png)
...
| ![Icône de statut en attente ou en pause](./media/monitoring-container-insights-analyze/containers-waiting-icon.png) | Waiting or Paused (En attente ou en pause)|  
| ![Icône de statut de dernière exécution signalée](./media/monitoring-container-insights-analyze/containers-grey-icon.png) | Last reported running but hasn’t responded more than 30 minutes (Dernière exécution signalée, mais pas de réponse depuis plus de 30 minutes)|  
| ![Icône de statut Terminé](./media/monitoring-container-insights-analyze/containers-terminated-icon.png) | Successfully stopped or failed to stop (Réussite ou échec de l’arrêt)|  
| ![Icône de statut Échec](./media/monitoring-container-insights-analyze/containers-failed-icon.png) | Statut Échec |  
...
![Analyser des données dans Log Analytics](./media/monitoring-container-insights-analyze/container-health-log-search-example.png)   
