...
Quand un utilisateur [installe votre solution d’administration](monitoring-solutions.md#install-a-management-solution) par le biais de la Place de Marché Azure ou des modèles de démarrage rapide Azure, il est invité à sélectionner un [espace de travail Log Analytics et un compte Automation](monitoring-solutions.md#log-analytics-workspace-and-automation-account).  Ils sont utilisés pour remplir les valeurs de chacun des paramètres standard.  L’utilisateur n’est pas invité à fournir directement des valeurs pour les paramètres standard, mais il est invité à fournir une valeur pour tout paramètre supplémentaire.
...
- [Ressources Automation](monitoring-solutions-resources-automation.md#sample)
- [Ressources de recherche et d’alerte](monitoring-solutions-resources-searches-alerts.md#sample)


## <a name="next-steps"></a>Étapes suivantes
* [Ajoutez des alertes et des recherches enregistrées](monitoring-solutions-resources-searches-alerts.md) à votre solution de gestion.
* [Ajoutez des vues](monitoring-solutions-resources-views.md) à votre solution de gestion.
* [Ajoutez des runbooks et d’autres ressources Automation](monitoring-solutions-resources-automation.md) à votre solution de gestion.
