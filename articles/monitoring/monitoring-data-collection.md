...
![Vue d’ensemble d’Azure Monitor](media/monitoring-data-collection/overview.png)
...
![Vue d’ensemble des métriques](media/monitoring-data-collection/metrics-overview.png)
...
![Composants de Log Analytics](media/monitoring-data-collection/logs-overview.png)
