...
Les [solutions de gestion](monitoring-solutions.md) comprennent généralement un ou plusieurs affichages pour visualiser des données.  Cet article décrit comment exporter une vue créée par le [Concepteur de vues](../log-analytics/log-analytics-view-designer.md) et l’inclure dans une solution de gestion.  
...
Suivez les instructions du [Concepteur de vues de Log Analytics](../log-analytics/log-analytics-view-designer.md) pour exporter un affichage dans un fichier.  Le fichier exporté sera au format JSON avec les mêmes [éléments que le fichier solution](monitoring-solutions-solution-file.md).  
...
* Découvrez plus de détails sur la création de [solutions de gestion](monitoring-solutions-creating.md).
* Inclure [des runbooks Automation dans votre solution de gestion](monitoring-solutions-resources-automation.md).
