...
Oui. Consultez les modèles de démarrage rapide [Service Gestion des API Azure](https://azure.microsoft.com/resources/templates/101-azure-api-management-create/).
