...
9. Collez la commande dans la fenêtre (ou la commande) du terminal. Notez que la commande compte que le fichier d’environnement téléchargé soit présent dans le répertoire actif.
```console
