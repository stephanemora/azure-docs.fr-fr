...
|`name`|chaîne|Nom de l’API. Ne doit pas être vide. La longueur maximale est de 100 caractères.|  
...
|`path`|chaîne|URL relative identifiant exclusivement cette API et tous les chemins d’accès à ses ressources au sein de l’instance de service Gestion des API. Elle est ajoutée à l’URL de base du point de terminaison d’API spécifiée lors de la création de l’instance de service pour former l’URL publique de cette API.|  
...
|`Title`|chaîne|Titre de l’application.|  
...
|`Requirements`|chaîne|Description des conditions requises de l’application.|  
...
|`path`|chaîne|Chemin de l’opération.|  
...
|`Title`|chaîne|Titre du problème.|  
...
|Propriété|Type|Description|  
|--------------|----------|-----------------|  
|`Pattern`|chaîne|Terme de recherche actuel ; ou `null` en l’absence de terme de recherche.|  
...
|`name`|chaîne|Nom de l’opération. Ne doit pas être vide. La longueur maximale est de 100 caractères.|  
...
|`Title`|chaîne|Description de l’opération.|  
|`HttpMethod`|chaîne|Méthode HTTP de l’opération.|  
...
|`Title`|chaîne|Nom du produit. Ne doit pas être vide. La longueur maximale est de 100 caractères.|  
...
|`Terms`|chaîne|Conditions d’utilisation du produit. Les développeurs qui veulent s’abonner au produit devront consulter et accepter ces conditions pour pouvoir terminer le processus d’abonnement.|  
...
|`Password`|chaîne|Mot de passe du compte d’utilisateur.|  
