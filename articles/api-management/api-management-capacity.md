...
5. Choisissez une plage horaire dans la barre supérieure de la section.
    ...
    Vous pouvez définir une alerte Métrique vous permettant de savoir à quel moment un événement inattendu survient. Par exemple, recevez des notifications quand votre instance APIM a dépassé sa capacité maximale attendue pendant plus de 20 minutes.
