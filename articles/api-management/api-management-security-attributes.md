---
title: Attributs de sécurité de gestion des API Azure
...
---
# <a name="security-attributes-for-api-management"></a>Attributs de sécurité pour la gestion des API

Cet article décrit les attributs de sécurité intégrées à la gestion des API.
