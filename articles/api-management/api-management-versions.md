...
Le format d’une URL de demande d’API lorsque le contrôle de version est basé sur l’en-tête est le suivant : `https://{yourDomain}/{apiName}/{versionIdentifier}/{operationId}`.
