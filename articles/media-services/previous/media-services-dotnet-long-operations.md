...
Actuellement, les méthodes sans interrogation sont prises en charge par les classes suivantes :  **Channel**, **StreamingEndpoint** et **Program**.
