...
ms.locfileid: "49944122"
---
# <a name="use-azure-cli-to-create-an-azure-ad-app-and-configure-it-to-access-azure-media-services-api"></a>Utiliser Azure CLI pour créer une application Azure AD et configurez-la pour accéder à l’API Azure Media Services
