...
> [!NOTE]
>  Envisagez de passer à TLS 1.2, la version recommandée du protocole TLS.
...
## <a name="configure-the-newtek-tricaster-encoder"></a><a id="configure_tricaster_rtmp"/>Configurer l’encodeur NewTek TriCaster
