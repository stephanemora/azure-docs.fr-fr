...
3. Sélectionnez le bouton Incorporer ( **</>** ) qui s’affiche sous la vidéo.

    Après avoir sélectionné le bouton **Incorporer**, vous pouvez sélectionner le widget à incorporer dans votre application.
