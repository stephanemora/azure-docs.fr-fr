...
* [Personnalisation du modèle de marques à l’aide du site web Video Indexer](customize-brands-model-with-website.md)
* [Personnalisation du modèle de marques à l’aide de l’API Video Indexer](customize-brands-model-with-api.md)
...
* [Personnalisation des modèles de langue à l’aide de l’API Video Indexer](customize-language-model-with-api.md)
