...
2. Rechercher parmi toutes les vidéos de votre compte.
    ...
    Dans l’exemple suivant, nous la recherchons toutes les vidéos qui parlent sur la sécurité et dans lequel Satya s’affiche,
...
3. Rechercher les insights résumés de la vidéo.
    ...
    Dans l’exemple suivant, nous la recherchons « sécurisé » à l’intérieur de la vidéo sélectionnée.
...
4. Recherchez la répartition détaillée de la vidéo.
    ...
    Si vous souhaitez créer vos propres images en fonction de la vidéo que vous avez trouvé, appuyez sur la **modifier** bouton. Cette page montre vidéo, ainsi que ses insights en tant que filtres. Pour plus d’informations, voir [Afficher et modifier les insights de Video Indexer](video-indexer-view-edit.md). 

    Vous pouvez rechercher dans la vidéo pour afficher uniquement les lignes qui vous intéressez et utilisez les informations de côté pour filtrer les parties que vous souhaitez afficher. Lorsque vous avez terminé, vous pouvez afficher un aperçu votre élément et appuyez sur **publier** pour créer le nouvel élément apparaît dans votre galerie.
    
    Dans l’exemple suivant, nous avons recherché pour le texte « une réalité mixte ». Nous avons également appliqué des filtres supplémentaires, comme indiqué dans l’écran ci-dessous.
