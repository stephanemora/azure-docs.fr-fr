---
title: Forum Aux Questions (FAQ) Azure Media Services v3
...
Pour plus d’informations, consultez le [Guide de migration](migrate-v-2-v-3-migration-introduction.md).
...
Pour plus d’informations, consultez [Migrer vers Azure Media Services v3](migrate-v-2-v-3-migration-introduction.md).
