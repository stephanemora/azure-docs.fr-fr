---
titre : Stocker les événements Azure Media Services dans Azure Log Analytics : Description d’Azure Media Services : Découvrez comment stocker des événements de Azure Media Services dans Azure Log Analytics.
