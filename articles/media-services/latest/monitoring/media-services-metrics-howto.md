...
- [Créer, afficher et gérer des alertes de mesure à l’aide d’Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/alerts/alerts-metric.md).
