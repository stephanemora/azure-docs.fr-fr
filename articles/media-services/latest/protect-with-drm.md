---
title: Chiffrement DRM et octroi de licences avec Media Services
...
* Lisez la section intitulée [Concevoir un système de protection de contenu multi-DRM avec contrôle d’accès](architecture-design-multi-drm-system.md).
