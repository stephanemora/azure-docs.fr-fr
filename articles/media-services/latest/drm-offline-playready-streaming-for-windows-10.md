---
title: Configurer la diffusion en continu PlayReady en mode hors connexion
...
- [Diffusion en continu de FairPlay en mode hors connexion pour iOS](drm-offline-fairplay-for-ios-concept.md)
- [Diffusion en continu de Widevine en mode hors connexion pour Android](drm-offline-widevine-for-android.md)
...
## <a name="background-on-offline-mode-playback"></a>Lecture en arrière-plan en mode hors connexion
