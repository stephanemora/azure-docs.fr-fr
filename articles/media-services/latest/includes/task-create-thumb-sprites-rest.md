...
ms.locfileid: "101705463"
---
<!--Create a thumbnail sprites REST-->

La commande REST Azure suivante crée une transformation de sprite de miniatures. Remplacez les valeurs `subscriptionID`, `resourceGroup` et `accountName` par les valeurs que vous utilisez actuellement. 

Donnez un nom à votre transformation en définissant `transformName` ici.
