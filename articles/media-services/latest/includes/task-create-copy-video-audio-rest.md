...
ms.locfileid: "94974673"
---
<!--Create a basic audio transform REST-->

La commande REST Azure suivante vous permet de copier la vidéo et l’audio d’un endroit à un autre sans encodage supplémentaire. Remplacez les valeurs `subscriptionID`, `resourceGroup` et `accountName` par les valeurs que vous utilisez actuellement. Donnez un nom à votre transformation en définissant `transformName` ici.
