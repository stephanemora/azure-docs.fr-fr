...
Si vous ne savez pas comment obtenir votre ID de locataire et votre ID d’abonnement, consultez [Guide pratique pour trouver votre ID de locataire](how-to-set-azure-tenant.md) et [Rechercher votre ID de locataire](how-to-set-azure-tenant.md).
...
[Guide pratique pour créer une ressource](how-to-create-asset.md)
