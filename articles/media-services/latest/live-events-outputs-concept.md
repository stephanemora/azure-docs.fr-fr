...
* URL de redirection vers un microsite
    ...
    |Interface de ligne de commande|[--vanity-url](/cli/azure/ams/live-event#az-ams-live-event-create)|[--access-token](/cli/azure/ams/live-event#optional-parameters)|
