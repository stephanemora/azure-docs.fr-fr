---
title: Supervision des journaux de diagnostic avec Azure Monitor
...
- Consultez [Surveiller Media Services](monitoring/monitor-media-services.md).
...
* [Journaux de diagnostics Azure Monitor](../../azure-monitor/essentials/platform-logs-overview.md)
