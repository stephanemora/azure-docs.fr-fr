...
- `crossSiteAccessPolicies`: Utilisée pour spécifier des stratégies d’accès entre sites pour différents clients. Pour plus d’informations, consultez [Cross-domain policy file specification](https://www.adobe.com/devnet-docs/acrobatetk/tools/AppSec/CrossDomain_PolicyFile_Specification.pdf) et [Rendre un service disponible entre des limites de domaine](/previous-versions/azure/azure-services/gg185950(v=azure.100)). Les paramètres s’appliquent uniquement au format Smooth Streaming.
...
- [Mise à l’échelle du streaming avec un CDN](stream-scale-streaming-cdn-concept.md)
...
[Gérer les points de terminaison de streaming](stream-manage-streaming-endpoints-how-to.md)
