---
title: Collection de questions Azure Media Services v3
...
ms.locfileid: "114602876"
---
<!-- NOTE this file is temporary and a placeholder until the FAQ file update is completed. -->

# <a name="media-services-v3-questions-collection"></a>Collection de questions Media Services v3
...
Vous pouvez utiliser le [portail Azure](https://portal.azure.com/) pour gérer les événements en direct v3, voir des actifs multimédias et des travaux v3, obtenir des informations sur l’accès aux API, et chiffrer du contenu. <br/>Pour toutes les autres tâches de gestion (par exemple la gestion des transformations et des travaux, ou l’analyse de contenu v3), utilisez l’[interface CLI](/cli/azure/ams) ou un des [SDK](media-services-apis-overview.md#sdks) clients pris en charge.
...
Lors de l’utilisation de la pagination, vous devez toujours utiliser le lien suivant pour énumérer la collection et ne pas dépendre d’une taille de page particulière. Pour voir des détails et des exemples, consultez [Filtrage, tri, pagination](filter-order-page-entitites-how-to.md).
...
Vous pouvez utiliser un [encodeur live local](encode-recommended-on-premises-live-encoders.md) pour changer la vidéo source. De nombreuses applications offrent la possibilité de changer les sources, parmi lesquelles Telestream Wirecast, Switcher Studio (sur iOS) et OBS Studio (application gratuite).
...
* Gérer les [événements en direct](live-event-outputs-concept.md) dans Media Services v3. 
...
Pour toutes les autres tâches de gestion (par exemple, les [transformations et travaux](transform-jobs-concept.md) et la [protection de contenu](drm-content-protection-concept.md)), utilisez l’[API REST](/rest/api/media/), [Azure CLI](/cli/azure/ams) ou l’un des [kits de développement logiciel (SDK)](media-services-apis-overview.md#sdks) pris en charge.
