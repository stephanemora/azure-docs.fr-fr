...
Nous vous recommandons de vous familiariser avec les transformations personnalisées en lisant [Comment encoder avec une transformation -.NET personnalisée](encode-custom-presets-how-to.md).
