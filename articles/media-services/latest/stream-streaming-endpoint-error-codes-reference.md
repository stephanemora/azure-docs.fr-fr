---
title: Erreurs d’origine et de packaging Azure Media Services
...
ms.locfileid: "106281342"
---
# <a name="streaming-endpoint-origin-errors"></a>Erreurs (d’origine) du point de terminaison de streaming

Cette rubrique décrit les erreurs que vous pouvez recevoir du [service de point de terminaison de streaming](stream-streaming-endpoint-concept.md) Azure Media Services.
