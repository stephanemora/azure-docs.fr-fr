...
ms.locfileid: "106279508"
---
# <a name="media-services-job-error-codes"></a>Codes d’erreur de travaux de Media Services

[!INCLUDE [media services api v3 logo](./includes/v3-hr.md)]

Cette rubrique est liée à un document de référence REST pour la description détaillée des messages et codes d’erreur de [travaux](transform-jobs-concept.md).
...
- [Codes d’erreur du point de terminaison de streaming](stream-streaming-endpoint-error-codes-reference.md)
