---
title: Encoder avec une transformation personnalisée - REST
...
- [Créer un compte Media Services](./account-create-how-to.md). <br/>Veillez à mémoriser le nom du groupe de ressources et le nom du compte Media Services. 
- [Configurer Postman pour les appels d’API REST Azure Media Services](setup-postman-rest-how-to.md).<br/>Suivez la dernière étape de la rubrique [Obtenir un jeton Azure AD](setup-postman-rest-how-to.md#get-azure-ad-token). 
