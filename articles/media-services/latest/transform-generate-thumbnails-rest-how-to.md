---
title: Générer des miniatures à l’aide de Media Encoder Standard - REST
...
Nous vous recommandons de vous familiariser avec les transformations personnalisées en lisant [Comment encoder avec une transformation - REST](transform-custom-preset-rest-how-to.md).
...
[Générer des miniatures avec .NET](transform-generate-thumbnails-dotnet-how-to.md)