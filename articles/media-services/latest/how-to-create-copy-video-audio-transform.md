---
title: Créer une transformation CopyVideo CopyAudio
description: Créez une transformation CopyVideo CopyAudio à l’aide de l’API Media Services.
...
ms.locfileid: "105962358"
---
# <a name="create-a-copyvideo-copyaudio-transform"></a>Créer une transformation CopyVideo CopyAudio

[!INCLUDE [media services api v3 logo](./includes/v3-hr.md)]

Cet article explique comment créer une transformation `CopyVideo/CopyAudio`.
