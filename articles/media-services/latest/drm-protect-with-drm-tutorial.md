...
Vous pouvez utiliser Azure Media Services pour diffuser vos flux chiffrés avec des licences Microsoft PlayReady, Google Widevine ou Apple FairPlay. Pour une explication détaillée, consultez [Protection du contenu avec chiffrement dynamique](drm-content-protection-concept.md).
...
Cet article est basé sur l’exemple [Chiffrement avec DRM](https://github.com/Azure-Samples/media-services-v3-dotnet-tutorials/blob/main/AMSV3Tutorials/EncryptWithDRM).

L’exemple décrit dans cet article génère le résultat suivant :

![AMS avec contenu vidéo protégé par DRM dans le lecteur multimédia Azure](./media/drm-protect-with-drm-tutorial/ams_player.png)
...
* Consultez l’article [Présentation de la protection du contenu](drm-content-protection-concept.md).
...
* Configuration
    ...
    Les licences [PlayReady](drm-playready-license-template-concept.md) et [Widevine](drm-widevine-license-template-concept.md) sont configurées de sorte qu’elles peuvent être transmises par le service de remise des licences Media Services. Bien que cet exemple d’application ne configure pas la licence [FairPlay](drm-fairplay-license-overview.md), il contient une méthode que vous pouvez utiliser pour configurer FairPlay. Vous pouvez ajouter une configuration FairPlay comme autre option.
...
1. Créez un [localisateur de streaming](stream-streaming-locators-concept.md).
...
![Protéger avec DRM](./media/drm-protect-with-drm-tutorial/playready_encrypted_url.png)
...
> [Protéger avec AES-128](drm-playready-license-template-concept.md)
