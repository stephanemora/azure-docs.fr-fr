...
* Lisez [Comment encoder avec une transformation personnalisée – .NET](encode-custom-presets-how-to.md). Suivez les étapes de cet article pour configurer le .NET nécessaire à l’utilisation des transformations, puis revenez ici pour tester un exemple de présélection de superpositions.
