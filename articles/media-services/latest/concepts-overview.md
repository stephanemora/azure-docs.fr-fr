...
|Clients Player|Vous pouvez utiliser n’importe quel framework de lecteur qui prend en charge le protocole de streaming HLS ou DASH. De nombreux lecteurs commerciaux et open source sont disponibles sur le marché (Shaka, Hls.js, Video.js, Theo Player, Bitmovin Player, etc.) ainsi que la prise en charge du streaming au niveau natif des navigateurs et des systèmes d’exploitation pour HLS et DASH.  Le Lecteur multimédia Azure est également disponible pour lire des contenus multimédias diffusés en continu par Media Services sur une grande variété de navigateurs. Le Lecteur multimédia Azure utilise les standards du secteur, comme HTML5, Media Source Extensions (MSE) et Encrypted Media Extensions (EME), pour offrir une expérience de streaming adaptative. |[Présentation du lecteur multimédia Azure](player-use-azure-media-player-how-to.md)|
