...
> [!NOTE]
> Actuellement, vous pouvez utiliser le [Portail Azure](https://portal.azure.com/) pour gérer les [événements en direct](live-events-outputs-concept.md) Media Services v3, afficher (mais pas gérer) les [éléments multimédias](assets-concept.md) v3 et [obtenir des informations sur l’accès aux API](access-api-portal.md).
