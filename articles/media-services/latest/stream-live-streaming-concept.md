---
title: Vue d’ensemble du streaming en direct
...
Pour les clients qui souhaitent distribuer du contenu à un large public sur Internet, il est conseillé d’activer le CDN sur le [point de terminaison de streaming](stream-streaming-endpoint-concept.md).
...
Le filtrage dynamique permet de contrôler le nombre de pistes, de formats, de vitesses de transmission et de fenêtres de temps de présentation envoyés aux lecteurs. Pour plus d’informations, consultez [Filtres et manifestes dynamiques](filters-dynamic-manifest-concept.md).

## <a name="live-event-types"></a>Types d’événements en direct

Les [événements en direct](/rest/api/media/liveevents) sont chargés de la réception et du traitement des flux vidéo en direct. Un événement en direct peut être défini sur *Pass-through* (un encodeur live local envoie un flux à vitesse de transmission multiple) ou sur *Live Encoding* (un encodeur live local envoie un flux à vitesse de transmission unique). Pour plus d’informations sur le streaming en direct dans Media Services v3, consultez [Événements en direct et sorties en direct](live-event-outputs-concept.md).
...
Transcription en direct est une fonctionnalité que vous pouvez utiliser avec les événements en direct qui sont des encodages à transfert direct ou en temps réel. Pour en savoir plus, consultez [Transcription en direct](live-event-live-transcription-how-to.md). Lorsque cette fonctionnalité est activée, le service utilise la fonctionnalité de [reconnaissance vocale](../../cognitive-services/speech-service/speech-to-text.md) de Cognitive Services pour transcrire les paroles du fichier audio entrant en texte. Ce texte, accompagné de fichiers vidéo et audio dans les protocoles MPEG-DASH et HLS, est ensuite mis à disposition pour diffusion.
...
- [Points de terminaison de streaming](stream-streaming-endpoint-concept.md)
- [Événements en direct et sorties en direct](live-event-outputs-concept.md)
...
7. Créez un **localisateur de streaming** avec les [types intégrés de la stratégie de streaming](stream-streaming-policy-concept.md).
...
- [Encodeurs live recommandés](encode-recommended-on-premises-live-encoders.md)
- [Utiliser un magnétoscope numérique cloud](live-event-cloud-dvr-time-how-to.md)
- [Comparaison des fonctionnalités des types d’événements en direct](live-event-types-comparison-reference.md)
- [États et facturation](live-event-states-billing-concept.md)
- [Latence](live-event-latency-reference.md)

## <a name="live-streaming-questions"></a>Questions de streaming en direct

Consultez l’article sur les [questions de streaming en direct](questions-collection.md#live-streaming).
