---
title: Contrat de données d’extension HTTP – Azure
description: Dans cet article, vous allez apprendre à utiliser le protocole HTTP pour envoyer des messages entre le module Live Video Analytics et votre module d’IA ou de validation croisée (CV).
ms.topic: overview
ms.date: 09/14/2020
...
ms.locfileid: "88701923"
---
# <a name="http-extension-data-contract"></a>Contrat de données d’extension HTTP

Dans cet article, vous allez apprendre à utiliser le protocole HTTP pour envoyer des messages entre le module Live Video Analytics et votre module d’IA ou de validation croisée (CV).
...
![hiérarchie des classes](./media/http-data-contract/class-hierarchy.png)
