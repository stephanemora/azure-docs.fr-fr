...
* Invoquez GraphTopologyList comme indiqué dans la section précédente et vérifiez que vous pouvez maintenant voir la topologie de graphe « EVRtoAssetsOnMotionDetecion » dans la charge utile retournée.
