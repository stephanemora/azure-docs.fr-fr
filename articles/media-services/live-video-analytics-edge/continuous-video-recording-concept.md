...
![Enregistrement de vidéo continu](./media/continuous-video-recording/continuous-video-recording-overview.png)
...
>[!NOTE]
>Consultez [cet article](playback-recordings-how-to.md) pour connaître les effets de segmentLength sur la lecture.
