---
title: Contrat de données d’extension gRPC – Azure
description: Dans cet article, vous allez apprendre à utiliser le protocole gRPC pour envoyer des messages entre le module Live Video Analytics et votre extension personnalisée d’IA ou de validation croisée (CV).
ms.topic: overview
ms.date: 09/14/2020
...
ms.locfileid: "88687155"
---
# <a name="grpc-extension-data-contract"></a>Contrat de données d’extension gRPC

Dans cet article, vous allez apprendre à utiliser le protocole gRPC pour envoyer des messages entre le module Live Video Analytics et votre extension personnalisée d’IA ou de validation croisée (CV).
...
Dans une session unique : le client envoie un descripteur de flux multimédia, suivi d’images vidéo, au serveur sous la forme d’un message [protobuf](https://developers.google.com/protocol-buffers) via la session de flux gRPC. Le serveur valide le descripteur de flux, analyse l’image vidéo et retourne les résultats d’inférence sous la forme d’un message protobuf.

![Contrat d’extension gRPC](./media/data-contracts/grpc.png)
...
![Messages de protocole](./media/data-contracts/grpc2.png)
