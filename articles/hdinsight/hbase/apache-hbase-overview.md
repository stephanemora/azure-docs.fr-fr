...
|HBase en tant que plateforme|Les applications peuvent fonctionner par-dessus HBase, en l'utilisant comme banque de données. Phoenix, OpenTSDB, `Kiji` et Titan constituent quelques exemples. Les applications peuvent également s'intégrer à HBase. Exemples : [Apache Hive](https://hive.apache.org/), Apache Pig, [Solr](https://lucene.apache.org/solr/), Apache Storm, Apache Flume, [Apache Impala](https://impala.apache.org/), Apache Spark, `Ganglia` et Apache Drill.|
