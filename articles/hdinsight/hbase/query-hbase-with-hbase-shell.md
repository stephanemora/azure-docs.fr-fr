...
description: Apprenez à utiliser Apache HBase Shell pour exécuter des requêtes Apache HBase.
...
![Données tabulaires HBase HDInsight](./media/query-hbase-with-hbase-shell/hdinsight-hbase-contacts-tabular.png)

Dans HBase (une implémentation de [Cloud BigTable](https://cloud.google.com/bigtable/)), certaines données ont l’aspect suivant :

![Données bigtable HBase HDInsight](./media/query-hbase-with-hbase-shell/hdinsight-hbase-contacts-bigtable.png)
