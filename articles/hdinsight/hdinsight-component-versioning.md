...
| Apache Kafka | 1.1 |1.1, 1.0 * (Voir la remarque ci-dessous) | 0.10.0 | 0.9.0 |-|-|-|-|
...
- Intégration à Active Directory pour l’authentification.
    ...
    - [Configurer les clusters HDInsight joints à un domaine à l’aide d’Azure Active Directory Domain Services](./domain-joined/apache-domain-joined-configure-using-azure-adds.md)
