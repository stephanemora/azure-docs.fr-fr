...
| **Azure PowerShell** | Utilisez le paramètre `-SshPublicKey` de l’applet de commande `New-AzHdinsightCluster` et transmettez le contenu de la clé publique sous forme de chaîne.|
