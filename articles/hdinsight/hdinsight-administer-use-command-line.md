...
Découvrez comment utiliser [Azure Classic CLI](../cli-install-nodejs.md) pour gérer des clusters Apache Hadoop dans Azure HDInsight. L’interface Classic CLI est implémentée dans Node.js. Elle peut être utilisée sur toute plateforme prenant en charge Node.js, y compris Windows, Mac et Linux.
