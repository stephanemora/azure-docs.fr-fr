...
Si ce n’est déjà fait, suivez [ces instructions](./domain-joined/apache-domain-joined-configure-using-azure-adds.md) pour provisionner un nouveau cluster PSE.
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/manage-apache-ambari.png" alt-text="Gestion du tableau de bord Apache ambari":::
...
1. Dans la page de gestion, sélectionnez **Utilisateurs**.
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/apache-ambari-management-page-users.png" alt-text="Utilisateurs de la page de gestion Apache Ambari":::
...
1. Sur la page de gestion, sélectionnez le lien **Affichages** sous le titre de menu **Affichages**, à gauche.
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/apache-ambari-views-link.png" alt-text="Liens de l’affichage des vues Apache Ambari":::
...
2. Sur la page Affichages, développez la ligne **HIVE**. Par défaut, un affichage Hive est créé lorsque lors de l’ajout au cluster du service Hive. Vous pouvez également créer d’autres instances d’affichages Hive selon vos besoins. Sélectionnez un affichage Hive :
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/views-apache-hive-view.png" alt-text="Vues HDInsight – Vue Apache Hive":::
...
**Accorder une autorisation à ces utilisateurs** :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/hdi-add-user-to-view.png" alt-text="Accorder une autorisation à ces utilisateurs":::

**Accorder une autorisation à ces groupes** :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/add-group-to-view-permission.png" alt-text="Accorder une autorisation à ces groupes":::
...
1. Pour ajouter un utilisateur, appuyez sur le bouton **Ajouter un utilisateur**.
   ...
   * Commencez à taper le nom de l’utilisateur : une liste déroulante de noms déjà définis apparaît.
     ...
     :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-user-autocomplete.png" alt-text="La saisie semi-automatique des utilisateurs Apache Ambari":::
   ...
   * Pour enregistrer vos modifications, cochez la **case bleue**.
     ...
     :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/user-entered-permissions.png" alt-text="Octroi d’autorisations d’utilisateur Apache Ambari":::
...
1. Pour ajouter un groupe, appuyez sur le bouton **Ajouter un groupe**.
   ...
   * Pour enregistrer vos modifications, cochez la **case bleue**.
     ...
     :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-group-entered.png" alt-text="Octroi d’autorisations Apache Ambari":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/views-apache-tez-view.png" alt-text="Vues HDInsight – Vue Apache Tez":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/cluster-roles-menu-link.png" alt-text="Liens du menu Rôles Apache Ambari":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/roles-menu-permissions.png" alt-text="Autorisations - Liens du menu Rôles Apache Ambari":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-roles-block-view.png" alt-text="Vue de bloc de rôles Apache Ambari":::
...
* La catégorie Utilisateurs du mode Liste affiche la liste de tous les utilisateurs, ce qui permet de sélectionner un rôle pour chaque utilisateur dans la liste déroulante.
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/roles-list-view-users.png" alt-text="Vue de liste de rôles Apache Ambari – Utilisateurs":::
...
* La catégorie Groupes du mode Liste affiche tous les groupes, ainsi que le rôle affecté à chacun. Dans notre exemple, la liste des groupes est synchronisée à partir des groupes Azure Active Directory spécifiés dans la propriété **Accéder au groupe d’utilisateurs** des paramètres de domaine du cluster. Consultez [Créer un cluster HDInsight avec le Pack Sécurité Entreprise activé](./domain-joined/apache-domain-joined-configure-using-azure-adds.md#create-an-hdinsight-cluster-with-esp).
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/roles-list-view-groups.png" alt-text="Vue de liste de rôles Apache Ambari – Groupes":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-user-views-only.png" alt-text="Utilisateur Apache Ambari avec des vues uniquement":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/user-cluster-user-role.png" alt-text="Affichage du tableau de bord Apache Ambari":::
