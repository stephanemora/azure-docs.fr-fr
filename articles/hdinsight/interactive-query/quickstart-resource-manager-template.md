...
1. Entrez ou sélectionnez les valeurs suivantes :
    ...
    :::image type="content" source="./media/quickstart-resource-manager-template/resource-manager-template-hive.png" alt-text="Déployer un cluster HBase basé sur un modèle Resource Manager" border="true":::
