---
title: 'Démarrage rapide : Créer un cluster Interactive Query à l’aide d’un modèle - Azure HDInsight'
description: Ce guide de démarrage rapide montre comment utiliser un modèle Resource Manager pour créer un cluster Interactive Query dans Azure HDInsight.
...
ms.locfileid: "91542323"
---
# <a name="quickstart-create-interactive-query-cluster-in-azure-hdinsight-using-arm-template"></a>Démarrage rapide : Créer un cluster Interactive Query dans Azure HDInsight à l’aide d’un modèle Resource Manager

Dans ce guide de démarrage rapide, vous utilisez un modèle Resource Manager (Azure Resource Manager) pour créer un cluster [Interactive Query](./apache-interactive-query-get-started.md) dans Azure HDInsight. Le cluster Interactive Query (également appelé Apache Hive LLAP ou [Low Latency Analytical Processing](https://cwiki.apache.org/confluence/display/Hive/LLAP)) est un [type de cluster](../hdinsight-hadoop-provision-linux-clusters.md#cluster-type) Azure HDInsight.

[!INCLUDE [About Azure Resource Manager](../../../includes/resource-manager-quickstart-introduction.md)]

Si votre environnement remplit les prérequis et que vous êtes déjà familiarisé avec l’utilisation des modèles ARM, sélectionnez le bouton **Déployer sur Azure**. Le modèle s’ouvre dans le portail Azure.

[![Déployer sur Azure](../../media/template-deployments/deploy-to-azure.svg)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F101-hdinsight-interactive-hive%2Fazuredeploy.json)
...
Le modèle utilisé dans ce démarrage rapide est tiré des [modèles de démarrage rapide Azure](https://azure.microsoft.com/resources/templates/101-hdinsight-interactive-hive/).
...
1. Entrez ou sélectionnez les valeurs suivantes :
    ...
    ![Cluster HBase basé sur un modèle Resource Manager](./media/quickstart-resource-manager-template/resource-manager-template-hive.png)
...
![La capture d’écran montre un cluster HDInsight avec le groupe de ressources à supprimer.](./media/quickstart-resource-manager-template/azure-portal-delete-hive.png)
...
Dans ce guide de démarrage rapide, vous avez appris à créer un cluster Interactive Query dans HDInsight à l’aide d’un modèle Resource Manager. Dans l’article suivant, vous allez apprendre à utiliser Apache Zeppelin pour exécuter des requêtes Apache Hive.

> [!div class="nextstepaction"]
> [Exécuter des requêtes Apache Hive dans Azure HDInsight avec Apache Zeppelin](./hdinsight-connect-hive-zeppelin.md)
