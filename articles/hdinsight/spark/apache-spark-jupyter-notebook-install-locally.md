...
1. Entrez la commande `pip install sparkmagic==0.13.1` pour installer Spark Magic pour les clusters HDInsight version 3.6 et 4.0. Consultez également la [documentation sparkmagic](https://github.com/jupyter-incubator/sparkmagic#installation).
...
6. Vérifiez que vous pouvez utiliser Spark magic avec les noyaux. Effectuez ensuite les tâches suivantes.
    ...
    :::image type="content" source="./media/apache-spark-jupyter-notebook-install-locally/jupyter-kernels-notebook.png " alt-text="Noyaux disponibles dans le notebook Jupyter" border="true":::
