...
Vous devez plutôt utiliser le connecteur Spark-HBase. Pour savoir comment procéder, consultez [How to use Spark-HBase connector](/archive/blogs/azuredatalake/hdinsight-how-to-use-spark-hbase-connector).
