...
:::image type="content" source="./media/apache-spark-ipython-notebook-machine-learning/spark-machine-learning-understand-data.png " alt-text="Capture instantanée des données utilisées pour l’exemple de Machine Learning Spark" border="true":::
...
1. Vérifiez le document d’apprentissage pour contrôler votre progression dans l’application.
    ...
    :::image type="content" source="./media/apache-spark-ipython-notebook-machine-learning/spark-machine-learning-output-data.png " alt-text="Capture instantanée des données de sortie pour l’exemple de Machine Learning Spark" border="true":::
...
:::image type="content" source="./media/apache-spark-ipython-notebook-machine-learning/hdinsight-azure-portal-delete-cluster.png " alt-text="Le portail Azure supprime un cluster HDInsight" border="true":::
