...
Dans ce didacticiel, vous allez apprendre à utiliser Jupyter Notebook afin de créer une application de Machine Learning Apache Spark pour Azure HDInsight. 
