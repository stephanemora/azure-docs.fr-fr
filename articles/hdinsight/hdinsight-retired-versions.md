---
title: Versions de HDInsight mises hors service
...
Cet article vous présente les versions de HDInsight mises hors service.

## <a name="retired-version-list"></a>Liste des versions mises hors service

Le tableau suivant répertorie les versions de HDInsight mises hors service.
...
- [Composants et versions Apache pris en charge dans HDInsight](./hdinsight-component-versioning.md)
