...
* __Mono version number__ (Numéro de version de Mono) : la version de Mono à installer. La version doit être disponible à l’adresse [https://download.mono-project.com/repo/debian/dists/wheezy/snapshots/](https://download.mono-project.com/repo/debian/dists/wheezy/snapshots/).
