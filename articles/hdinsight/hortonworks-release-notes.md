---
title: Notes de publication Hortonworks associées aux versions d’Azure HDInsight
...
## <a name="current-versions"></a>Versions actuelles
...
* [Composants Apache Hadoop sur HDInsight](./hdinsight-component-versioning.md)
