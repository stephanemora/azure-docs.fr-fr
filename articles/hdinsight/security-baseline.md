...
Comment déployer Azure HDInsight dans un réseau virtuel et utiliser un groupe de sécurité réseau pour garantir la sécurité : https://docs.microsoft.com/azure/hdinsight/hdinsight-create-virtual-network
