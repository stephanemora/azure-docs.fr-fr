...
|[Étoile Presto pour Azure HDInsight](https://azuremarketplace.microsoft.com/marketplace/apps/starburst.starburst-presto) |Hadoop |Presto est un moteur de requête de le SQL de distribuée rapide et évolutif. Conçu pour séparer le calcul du stockage, Presto est parfait pour interroger des données dans les bases de données Azure Data Lake Storage, Stockage Blob Azure, SQL et NoSQL et autres sources de données. |
...
|[Trifacta Wrangler Enterprise](https://azuremarketplace.microsoft.com/marketplace/apps/trifacta.tr01) |Hadoop, Spark, HBase |Trifacta Wrangler Enterprise pour HDInsight prend en charge les données d’entreprise wrangling pour n’importe quelle échelle des données. Le coût d’exécution Trifacta sur Azure est une combinaison de coûts d’abonnement Trifacta ainsi que les coûts d’infrastructure Azure pour les machines virtuelles. |
