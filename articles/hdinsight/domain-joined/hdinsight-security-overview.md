...
:::image type="content" source="./media/hdinsight-security-overview/hdinsight-shared-responsibility.png" alt-text="Diagramme des responsabilités partagées HDInsight" border="false":::
