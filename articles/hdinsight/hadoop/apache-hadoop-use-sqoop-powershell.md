...
* Un cluster HDInsight, Azure SQL Server et la base de données tel que défini à partir de [créer un cluster et la base de données SQL](./hdinsight-use-sqoop.md#create-cluster-and-sql-database).
