...
Azure Synapse Analytics (anciennement SQL DW) est approprié pour stocker des résultats préparés. Vous pouvez utiliser Azure HDInsight pour exécuter ces services pour Azure Synapse Analytics.
