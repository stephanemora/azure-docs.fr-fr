---
title: Migrer des clusters Apache Hadoop locaux vers Azure HDInsight – meilleures pratiques concernant la migration de données
...
|**Quantité de données**|**Bande passante réseau**||||
|---|---|---|---|---|
|| **45 Mbits/s (T3)**|**100 Mbits/s**|**1 Gbit/s**|**10 Gbits/s**|
