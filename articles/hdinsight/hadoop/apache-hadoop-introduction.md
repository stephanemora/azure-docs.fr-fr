...
|Surveillance    | Azure HDInsight s’intègre aux [journaux Azure Monitor](../hdinsight-hadoop-oms-log-analytics-tutorial.md) pour fournir une interface unique permettant de superviser tous vos clusters.        |
