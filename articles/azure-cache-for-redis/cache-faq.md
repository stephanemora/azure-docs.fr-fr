...
* [Forum aux questions sur la planification](cache-planning-faq.md)
* [Forum aux questions sur le développement](cache-development-faq.md)
* [Questions fréquentes (FAQ) sur la gestion](cache-management-faq.md)
* [Forum aux questions sur la surveillance et le dépannage](cache-monitor-troubleshoot-faq.md)

## <a name="deprecated-cache-services"></a>Services de cache déconseillés
...
* Pour atteindre un public plus large, vous pouvez publier une question sur la [page Microsoft Q&R sur Azure Cache](/answers/topics/azure-cache-redis.html) et collaborer avec l’équipe Azure Cache et d’autres membres de la communauté.
...
* Vous pouvez également nous envoyer votre question à [azurecache@microsoft.com](mailto:azurecache@microsoft.com).