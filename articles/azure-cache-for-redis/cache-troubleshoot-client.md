---
title: Résoudre les problèmes du client Redis | Microsoft Docs
description: Découvrir comment résoudre les problèmes courants côté client liés à Azure Cache pour Redis
services: cache
documentationcenter: ''
author: yegu-ms
manager: maiye
