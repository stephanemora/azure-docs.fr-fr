...
La section **utilisation** du panneau **Vue d’ensemble** affiche les graphiques **Charge du serveur Redis**, **Utilisation de la mémoire**, **Bande passante réseau** et **Utilisation de l’UC**, et affiche également le **Niveau tarifaire** de l’instance de cache.
...
>[!NOTE]
>En plus d’archiver vos mesures de cache vers le stockage, vous pouvez également [les diffuser en continu vers un Hub d’événements ou les envoyer vers Log Analytics](../azure-monitor/platform/rest-api-walkthrough.md#retrieve-metric-values).
>
>
