---
title: Présentation du cache Azure pour Redis | Microsoft Docs
description: Découvrez le cache Azure pour Redis et ses usages courants.
services: cache
documentationcenter: ''
author: yegu-ms
manager: jhubbard
