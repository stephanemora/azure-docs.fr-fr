---
title: Supprimer les protocoles TLS 1.0 et 1.1 de l’utilisation avec Azure Cache pour Redis | Microsoft Docs
...
* **StackExchange.Redis :** Définissez `ssl=true` et `sslprotocls=tls12` dans la chaîne de connexion.
