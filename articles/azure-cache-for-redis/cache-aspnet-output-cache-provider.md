...
Configurez les attributs sur la gauche avec les valeurs de votre cache dans le Portail Microsoft Azure. En outre, configurez les autres valeurs souhaitées. Pour obtenir des instructions sur l’accès aux propriétés de votre cache, voir [Configurer les paramètres du Cache Azure pour Redis](cache-configure.md#configure-azure-cache-for-redis-settings).
