...
Cet article constitue un index des définitions de stratégie intégrées d’[Azure Policy](../governance/policy/overview.md) destiné à Azure Cache pour Redis. Pour obtenir des éléments intégrés d’Azure Policy destinés à d’autres services, consultez [Définitions intégrées d’Azure Policy](../governance/policy/samples/built-in-policies.md).
