...
New-AzRedisCache
   ...
   [<CommonParameters>]
```
Pour plus d’informations sur la création d’une instance de cache dans PowerShell, consultez la [documentation de référence d’Azure PowerShell](https://docs.microsoft.com/powershell/module/az.rediscache/new-azrediscache?view=azps-5.2.0). 
...
Import-AzRedisCache
      ...
      [<CommonParameters>]
```
Pour plus d’informations sur l’importation dans PowerShell, consultez la [documentation de référence d’Azure PowerShell](https://docs.microsoft.com/powershell/module/az.rediscache/import-azrediscache?view=azps-5.2.0). 
