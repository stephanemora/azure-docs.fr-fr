...
Si vous souhaitez passer directement au code, consultez le [démarrage rapide Python](https://github.com/Azure-Samples/azure-cache-redis-samples/tree/main/quickstart/python) sur GitHub.
