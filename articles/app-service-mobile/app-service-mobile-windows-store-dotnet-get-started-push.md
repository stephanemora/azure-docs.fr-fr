...
Vous devez soumettre votre application au Microsoft Store, puis configurer votre projet de serveur pour l’intégrer avec Windows Notification Services (WNS) pour envoyer des notifications push.
