...
* Un espace de travail Log Analytics, nécessaire pour activer la journalisation pour votre application logique. Si vous n’avez pas d’espace de travail, commencez par [créer votre espace de travail](/learn/quick-create-workspace.md)
