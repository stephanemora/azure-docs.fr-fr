...
Lorsque vous désactivez une application logique, aucune nouvelle exécution n’est instanciée. Tout en cours d’exécution et les exécutions en attente continuent jusqu'à ce qu’elles se terminent, qui peut prendre du temps.
