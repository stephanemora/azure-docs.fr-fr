---
title: Exemples d’opérations de données - Azure Logic Apps
description: Exemples de code pour les actions d’opérations de données dans Azure Logic Apps
services: logic-apps
