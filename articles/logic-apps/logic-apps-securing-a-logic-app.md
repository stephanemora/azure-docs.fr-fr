...
1. Dans le portail Azure, ouvrez l’application logique à laquelle vous souhaitez ajouter des restrictions d’adresse IP
2. Cliquez sur l’élément de menu **Configuration du contrôle d’accès** sous **Paramètres**
3. Spécifier la liste des plages d’adresses IP pour accéder au contenu
