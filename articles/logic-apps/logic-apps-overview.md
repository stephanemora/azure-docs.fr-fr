---
title: Automatiser les tâches pour l’intégration d’entreprise - Azure Logic Apps
...
![Concepteur Logic Apps - exemple d’application logique](./media/logic-apps-overview/azure-logic-apps-overview.png)
