...
* [Suivre les messages B2B dans Azure Log Analytics](logic-apps-track-b2b-messages-omsportal.md "En savoir plus sur les messages B2B dans Azure Log Analytics")
