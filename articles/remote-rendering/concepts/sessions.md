...
Vous pouvez [prolonger la durée du bail](../how-tos/session-rest-api.md#update-a-session) d’une session active si vous en avez besoin plus longtemps.
