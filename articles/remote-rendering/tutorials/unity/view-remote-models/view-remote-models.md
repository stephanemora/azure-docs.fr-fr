...
[Suivez les instructions](../../../how-tos/unity/install-remote-rendering-unity-package.md) pour ajouter le package Azure Remote Rendering à un projet Unity.
...
1. Ajoutez vos informations d’identification Azure Remote Rendering, votre domaine de compte et le domaine Remote Rendering au script du coordinateur :\
...
1. Définition d’un nom et ajout d’un [**WorldAnchor**](https://docs.unity3d.com/550/Documentation/ScriptReference/VR.WSA.WorldAnchor.html) pour faciliter la stabilisation.
