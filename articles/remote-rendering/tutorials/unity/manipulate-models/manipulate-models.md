...
1. Créez un script sous le nom **RemoteRayCaster** et remplacez son contenu par le code suivant :
    ...
    > [!NOTE]
    > Unity dispose d’une classe nommée [**RaycastHit**](https://docs.unity3d.com/ScriptReference/RaycastHit.html) et Azure Remote Rendering d’une classe nommée [**RayCastHit**](https://docs.microsoft.com/dotnet/api/microsoft.azure.remoterendering.raycasthit). Le **C** majuscule est une différence importante destinées à éviter les erreurs de compilation.
